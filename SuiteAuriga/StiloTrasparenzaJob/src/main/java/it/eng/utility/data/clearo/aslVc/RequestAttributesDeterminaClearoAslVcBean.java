...
public class RequestAttributesDeterminaClearoAslVcBean implements Serializable {

	private static final long serialVersionUID = 1L;
	
	private RequestFieldAnnoClearoAslVcBean field_anno;
	private RequestFieldMeseClearoAslVcBean field_mese;
	private RequestFieldNumeroDeterminaClearoAslVcBean field_numero_determina;
	private RequestFieldDataDeterminaClearoAslVcBean field_data_determina;
	...
	public RequestFieldNumeroDeterminaClearoAslVcBean getField_numero_determina() {
		return field_numero_determina;
	}
	
	public void setField_numero_determina(RequestFieldNumeroDeterminaClearoAslVcBean field_numero_determina) {
		this.field_numero_determina = field_numero_determina;
	}
	
	public RequestFieldDataDeterminaClearoAslVcBean getField_data_determina() {
		return field_data_determina;
	}
	
	public void setField_data_determina(RequestFieldDataDeterminaClearoAslVcBean field_data_determina) {
		this.field_data_determina = field_data_determina;
	}
	...
	public String toString() {
		return "RequestAttributesClearoAslVcBean [field_anno=" + field_anno + ", field_mese=" + field_mese
				+ ", field_numero_determina=" + field_numero_determina + ", field_data_determina="
				+ field_data_determina + ", field_oggetto=" + field_oggetto + ", field_decorrenza_dal="
				+ field_decorrenza_dal + ", field_decorrenza_al=" + field_decorrenza_al + ", field_art23_oggetto="
				+ field_art23_oggetto + ", field_art23_tipologia=" + field_art23_tipologia + ", field_art23_contenuto="
				+ field_art23_contenuto + ", field_art23_estremi=" + field_art23_estremi + ", field_art23_importo="
				+ field_art23_importo + ", field_art23_note=" + field_art23_note + "]";
	}
