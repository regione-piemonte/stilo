...
public class MIMEMessage {
	protected static final Logger LOGGER = Logger.getLogger(MIMEMessage.class.getName());

    MIMEConfig config;

    protected final InputStream in;
    protected final List<MIMEPart> partsList;
    protected final Map<String, MIMEPart> partsMap;
    protected final Iterator<MIMEEvent> it;
    protected boolean parsed;     // true when entire message is parsed
    protected MIMEPart currentPart;
    ...
    protected MIMEPart getDecodedCidPart(String cid) {
