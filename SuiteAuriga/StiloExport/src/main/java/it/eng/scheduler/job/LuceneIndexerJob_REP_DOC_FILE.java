...
@Named
public class LuceneIndexerJob_REP_DOC_FILE extends it.eng.job.luceneindexer.LuceneIndexerJob {
	...
	public String process()
		    throws Exception
		  {
			...
			input.getAttributes().put("LuceneIndexingCategory", "REP_DOC_FILE");
