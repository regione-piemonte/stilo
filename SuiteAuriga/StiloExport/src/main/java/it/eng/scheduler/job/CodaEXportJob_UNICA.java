...
@Named
public class CodaEXportJob_UNICA extends it.eng.job.codaEXport.CodaEXportJob_UNICA {

	
	public String process()
		    throws Exception
		  {
		    System.out.println("process CodaEXportJob_UNICA");
			if (super.getAttributes() == null) {
		      super.setAttributes((HashMap)SpringHelper.getMainApplicationContext().getBean("jobAttributes"));
		    }
			 System.out.println("process CodaEXportJob_UNICA jobAttributes");
			...
			input.setType("CodaEXportJob_UNICA");
