...
@Named
public class CodaEXportJob_GSA extends it.eng.job.codaEXport.CodaEXportJob_GSA {

	
	public String process()
		    throws Exception
		  {
		    System.out.println("process CodaEXportJob_GSA");
			if (super.getAttributes() == null) {
		      super.setAttributes((HashMap)SpringHelper.getMainApplicationContext().getBean("jobAttributes"));
		    }
			 System.out.println("process CodaEXportJob_GSA jobAttributes");
			...
			input.setType("CodaEXportJob_GSA");
