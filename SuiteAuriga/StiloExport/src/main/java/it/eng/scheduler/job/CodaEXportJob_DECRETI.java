...
@Named
public class CodaEXportJob_DECRETI extends it.eng.job.codaEXport.CodaEXportJob_DECRETI {
	...
	public String process()
		    throws Exception
		  {
			...
			if (super.getAttributes() == null) {
			 ...
			 System.out.println("process CodaEXportJob_DECRETI jobAttributes");
			...
			input.setType("CodaEXportJob_DECRETI");
