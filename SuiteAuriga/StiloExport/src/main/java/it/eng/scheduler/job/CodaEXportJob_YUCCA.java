...
@Named
public class CodaEXportJob_YUCCA extends it.eng.job.codaEXport.CodaEXportJob_YUCCA {

	
	public String process()
		    throws Exception
		  {
		    System.out.println("process CodaEXportJob_YUCCA");
			if (super.getAttributes() == null) {
		      super.setAttributes((HashMap)SpringHelper.getMainApplicationContext().getBean("jobAttributes"));
		    }
			 System.out.println("process CodaEXportJob_YUCCA jobAttributes");
			...
			input.setType("CodaEXportJob_YUCCA");
