...
@Named
public class CodaEXportJob_BDC extends it.eng.job.codaEXport.CodaEXportJob_BDC {

	
	public String process()
		    throws Exception
		  {
		    System.out.println("process CodaEXportJob_BDC");
			if (super.getAttributes() == null) {
		      super.setAttributes((HashMap)SpringHelper.getMainApplicationContext().getBean("jobAttributes"));
		    }
			 System.out.println("process CodaEXportJob_BDC jobAttributes");
			...
			input.setType("CodaEXportJob_BDC");
