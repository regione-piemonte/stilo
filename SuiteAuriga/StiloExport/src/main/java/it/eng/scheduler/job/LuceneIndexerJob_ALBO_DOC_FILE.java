...
@Named
public class LuceneIndexerJob_ALBO_DOC_FILE extends it.eng.job.luceneindexer.LuceneIndexerJob {
	...
	public String process()
		    throws Exception
		  {
			...
			input.getAttributes().put("LuceneIndexingCategory", "ALBO_DOC_FILE");
