...
@Named
public class CodaEXportJob_GAMBUDGET extends it.eng.job.codaEXport.CodaEXportJob_GAMBUDGET {

	
	public String process()
		    throws Exception
		  {
		    System.out.println("process CodaEXportJob_GAMBUDGET");
			if (super.getAttributes() == null) {
		      super.setAttributes((HashMap)SpringHelper.getMainApplicationContext().getBean("jobAttributes"));
		    }
			 System.out.println("process CodaEXportJob_GAMBUDGET jobAttributes");
			...
			input.setType("CodaEXportJob_GAMBUDGET");
