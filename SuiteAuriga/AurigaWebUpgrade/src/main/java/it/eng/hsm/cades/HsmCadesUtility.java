...
public class HsmCadesUtility extends HsmBaseUtility {
	...
	public static FirmaHsmBean firmaCadesVarticaleMultipla(FirmaHsmBean bean, HttpSession session) throws Exception {

		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		Date dataCorrente = null;
		dataCorrente = new Date();
		log.debug("firmaCadesVarticaleMultipla inizio " + formatter.format(dataCorrente));
		...
		try {
			...
			SignResponseBean signResponseBean = hsmClient.firmaCades(listaByteDaFirmare, signOption);
			...
			log.error("Errore in firma cades multipla verticale", e);
		}
		dataCorrente = new Date();
		log.debug("firmaCadesVarticaleMultipla fine " + formatter.format(dataCorrente));

		return bean;
	}

	public static FirmaHsmBean firmaCadesParallelaMultipla(FirmaHsmBean bean, HttpSession session) throws Exception {

		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		Date dataCorrente = null;
		dataCorrente = new Date();
		log.debug("firmaCadesParallelaMultipla inizio " + formatter.format(dataCorrente));
		...
		try {
			...
			SignResponseBean signResponseBean = hsmClient.firmaCadesParallela(listaByteDaFirmare, signOption);
			...
			log.error("Errore in firma cades multipla parallela", e);
		}
		dataCorrente = new Date();
		log.debug("firmaCadesParallelaMultipla fine " + formatter.format(dataCorrente));
