...
@Datasource(id="LoadFaseVisureInLavorazioneDataSource")
public class LoadFaseVisureInLavorazioneDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
