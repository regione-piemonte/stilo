...
public abstract class UoAbilitatePopup extends ModalWindow {

	protected UoAbilitatePopup window;
	...
	protected ListaUoAbilitateContenutiAmmTraspItem listaPrivilegiEntitaAbilitateItem;
	
	public UoAbilitatePopup(String titleIn, String iconIn) {

		super("uo_abilitate_popup", true);
		...
		listaPrivilegiEntitaAbilitateItem = new ListaUoAbilitateContenutiAmmTraspItem("listaPrivilegiEntitaAbilitate") {
		...
		formMain.setItems(listaPrivilegiEntitaAbilitateItem);
