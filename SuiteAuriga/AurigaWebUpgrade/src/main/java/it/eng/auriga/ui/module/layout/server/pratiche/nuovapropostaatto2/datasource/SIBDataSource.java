...
@Datasource(id = "SIBDataSource")
public class SIBDataSource extends AbstractFetchDataSource<DatiContabiliBean> {

	private static final Logger logger = Logger.getLogger(SIBDataSource.class);
	...
	*/	
	public NuovaPropostaAtto2CompletaBean creaProposta(NuovaPropostaAtto2CompletaBean bean) throws Exception {
	...
	*/
	public NuovaPropostaAtto2CompletaBean aggiornaAtto(NuovaPropostaAtto2CompletaBean bean) throws Exception {
...
//				throw new StoreException(errorMessage);			
	...
	public List<DatiContabiliBean> getListaDatiContabiliCorrente(NuovaPropostaAtto2CompletaBean bean) throws Exception {
	...
	public List<DatiContabiliBean> getListaDatiContabiliContoCapitale(NuovaPropostaAtto2CompletaBean bean) throws Exception {
	...
	private List<DatiContabiliBean> getListaDatiContabili(NuovaPropostaAtto2CompletaBean bean, String tipoSpesa) throws Exception {
		List<DatiContabiliBean> data = new ArrayList<DatiContabiliBean>();			
		ContabilitaSIBImpl lContabilitaSIBImpl = new ContabilitaSIBImpl(); 
