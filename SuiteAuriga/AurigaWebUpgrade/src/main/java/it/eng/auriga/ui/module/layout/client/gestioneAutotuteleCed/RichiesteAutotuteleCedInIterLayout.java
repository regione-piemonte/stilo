...
public class RichiesteAutotuteleCedInIterLayout extends CustomLayout {
	...
	public RichiesteAutotuteleCedInIterLayout(String nomeEntita) {
		this(nomeEntita, null, null, null);
	}

	public RichiesteAutotuteleCedInIterLayout(String nomeEntita, String finalita) {
		this(nomeEntita, finalita, null, null);
	}

	public RichiesteAutotuteleCedInIterLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola) {
		this(nomeEntita, finalita, flgSelezioneSingola, null);
	}

	public RichiesteAutotuteleCedInIterLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, new GWTRestDataSource("RichiesteAutotuteleCedInIterDatasource", "idProcedimento", FieldType.TEXT), 
				new RichiesteAutotuteleCedInIterFilter(nomeEntita), 
				new RichiesteAutotuteleCedInIterList(nomeEntita), 
				new RichiesteAutotuteleCedInIterDetail(nomeEntita), finalita, flgSelezioneSingola, showOnlyDetail);
