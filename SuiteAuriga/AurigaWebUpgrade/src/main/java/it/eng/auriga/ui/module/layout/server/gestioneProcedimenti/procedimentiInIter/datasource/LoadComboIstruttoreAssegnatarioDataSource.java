...
@Datasource(id="LoadComboIstruttoreAssegnatarioDataSource")
public class LoadComboIstruttoreAssegnatarioDataSource extends OptionFetchDataSource<UtenteBean>{
	...
	public PaginatorBean<UtenteBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		String altriParametri = "FLG_SOLO_ACCRED_IN_DOMINIO|*|1|*|SOLO_ACCRED_IN_APPL|*|TRIBUTI|*|STR_IN_COD_RAPIDO|*|" + codice + "|*|STR_IN_DES|*|" + cognomeNome + "|*|STR_IN_USERNAME|*|" + username + "|*|CI_TO_ADD|*|" + "" + "|*|CI_TO_EXCLUDE|*|";
