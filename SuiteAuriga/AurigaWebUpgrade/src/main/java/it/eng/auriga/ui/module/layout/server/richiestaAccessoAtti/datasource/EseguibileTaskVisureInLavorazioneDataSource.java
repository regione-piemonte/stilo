...
@Datasource(id="EseguibileTaskVisureInLavorazioneDataSource")
public class EseguibileTaskVisureInLavorazioneDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("INTERNAL_VALUE|*|CID|*|ID_PROCESS_TYPE|*|" + ParametriDBUtil.getParametroDB(getSession(),"ID_PROCESS_TYPE_VISURA_URBANISTICA") + "|*|CI_FASE_WF|*|" + idFase);
