...
@Datasource(id = "AnnullaArchiviazioneEmailDataSource")
public class AnnullaArchiviazioneEmailDataSource extends AbstractDataSource<ArchiviazioneEmailBean, ArchiviazioneEmailBean> {

	private static Logger mLogger = Logger.getLogger(AnnullaArchiviazioneEmailDataSource.class);
	...
	public ArchiviazioneEmailBean add(ArchiviazioneEmailBean bean) throws Exception {
		...
		DmpkIntMgoEmailAnnullaarchiviazioneemailBean input = new DmpkIntMgoEmailAnnullaarchiviazioneemailBean();
		...
		input.setFlgrilasciolockin(bean.getFlgRilascia());

		DmpkIntMgoEmailAnnullaarchiviazioneemail annullaArchiviaMail = new DmpkIntMgoEmailAnnullaarchiviazioneemail();

		StoreResultBean<DmpkIntMgoEmailAnnullaarchiviazioneemailBean> output = annullaArchiviaMail.execute(getLocale(), aurigaLoginBean, input);
