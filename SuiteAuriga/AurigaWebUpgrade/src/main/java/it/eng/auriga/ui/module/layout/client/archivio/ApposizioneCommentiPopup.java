...
public abstract class ApposizioneCommentiPopup extends Window {
	
	private ApposizioneCommentiPopup window;
	
	private DynamicForm form; 
	private TextAreaItem noteItem;
	
	public ApposizioneCommentiPopup(String titolo, String noteOld, String causaleAggNoteOld){
