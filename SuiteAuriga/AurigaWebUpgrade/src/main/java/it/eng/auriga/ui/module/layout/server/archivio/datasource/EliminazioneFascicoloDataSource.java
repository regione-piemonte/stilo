...
@Datasource(id = "EliminazioneFascicoloDataSource")
public class EliminazioneFascicoloDataSource extends AbstractDataSource<OperazioneMassivaArchivioBean, OperazioneMassivaArchivioBean>{	
