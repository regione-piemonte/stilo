...
public class ProposteOrganigrammaPersonaliLayout extends CustomLayout {

	protected MultiToolStripButton assegnaMultiButton;
	protected MultiToolStripButton presaInCaricoMultiButton;

	public ProposteOrganigrammaPersonaliLayout(String nomeEntita) {
		this(nomeEntita, null, null, null);
	}

	public ProposteOrganigrammaPersonaliLayout(String nomeEntita, String finalita) {
		this(nomeEntita, finalita, null, null);
	}

	public ProposteOrganigrammaPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola) {
		this(nomeEntita, finalita, flgSelezioneSingola, null);
	}

	public ProposteOrganigrammaPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, new GWTRestDataSource("ProposteOrganigrammaPersonaliDatasource", "idProcedimento", FieldType.TEXT), new ProposteOrganigrammaPersonaliFilter(nomeEntita), new ProposteOrganigrammaPersonaliList(
				nomeEntita), new ProposteOrganigrammaPersonaliDetail(nomeEntita), finalita, flgSelezioneSingola, showOnlyDetail);
