...
package it.eng.auriga.ui.module.layout.server.gestioneAtti.attipersonali.datasource;
...
@Datasource(id="AttiCompletiPersonaliDatasource")
public class AttiCompletiPersonaliDatasource extends AurigaAbstractFetchDatasource<AttiCompletiBean> {
...
//			HashSet<String> setNumColonneOrdinabili = new HashSet<String>(Arrays.asList("3","5","13","23","24","26","43","81","93"));
	...
	public String getNomeEntita() {
		return "atti_personali_completi";
	}
