...
@Datasource(id="EffettuatoTaskVisureInLavorazioneDataSource")
public class EffettuatoTaskVisureInLavorazioneDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("ATTIVITA_EVENTI_TIPO_PROC");
