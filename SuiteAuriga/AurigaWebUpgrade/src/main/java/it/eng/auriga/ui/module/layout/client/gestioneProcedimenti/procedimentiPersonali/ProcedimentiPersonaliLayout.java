...
public class ProcedimentiPersonaliLayout extends CustomLayout {
	...
	public ProcedimentiPersonaliLayout(String nomeEntita) {
		this(nomeEntita, null, null, null);
	}

	public ProcedimentiPersonaliLayout(String nomeEntita, String finalita) {
		this(nomeEntita, finalita, null, null);
	}

	public ProcedimentiPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola) {
		this(nomeEntita, finalita, flgSelezioneSingola, null);
	}

	public ProcedimentiPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, new GWTRestDataSource("ProcedimentiPersonaliDatasource", "idProcedimento", FieldType.TEXT), new ProcedimentiPersonaliFilter(nomeEntita), new ProcedimentiPersonaliList(
				nomeEntita), new ProcedimentiPersonaliDetail(nomeEntita), finalita, flgSelezioneSingola, showOnlyDetail);
