...
@Datasource(id="LoadComboClassificaFilterDataSource")
public class LoadComboClassificaFilterDataSource extends SelectDataSource<ClassificaBean>{
	
	private static Logger mLogger = Logger.getLogger(LoadComboClassificaFilterDataSource.class);	
	...
	public PaginatorBean<ClassificaBean> realFetch(AdvancedCriteria criteria,
		...
		if(!"".equals(descrizione) || !"".equals(indice)) {
			...
			lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("ID_USER_LAVORO|*|" + idUserLavoro + "|*|INDICE|*|" + indice + "|*|STR_IN_DES|*|" + descrizione + "|*|CI_TO_ADD|*|" + idClassifica);
