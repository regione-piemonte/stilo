...
@Datasource(id = "LoadComboGruppoUfficioLiquidatoreDataSource")
public class LoadComboGruppoUfficioLiquidatoreDataSource extends SelectDataSource<GruppoSoggettiBean> {
		@Override	
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("COD_RAPIDO|*|" + codiceRapidoGruppo + "|*|STR_IN_NOME|*|" + nomeGruppo + "|*|FLG_SOLO_LIQUIDATORI|*|1");		
