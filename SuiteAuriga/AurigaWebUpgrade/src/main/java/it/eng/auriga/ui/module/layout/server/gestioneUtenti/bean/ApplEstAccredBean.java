...
public class ApplEstAccredBean {
	...
	private String idUoCollegataUtente;
	private String descrizioneUoCollegataUtente;
	...
	public String getUoPerRegDoc() {
		return uoPerRegDoc;
	}

	public void setUoPerRegDoc(String uoPerRegDoc) {
		this.uoPerRegDoc = uoPerRegDoc;
	}
	...
	public String getIdUoCollegataUtente() {
		return idUoCollegataUtente;
	}

	public void setIdUoCollegataUtente(String idUoCollegataUtente) {
		this.idUoCollegataUtente = idUoCollegataUtente;
	}

	public String getDescrizioneUoCollegataUtente() {
		return descrizioneUoCollegataUtente;
	}

	public void setDescrizioneUoCollegataUtente(String descrizioneUoCollegataUtente) {
		this.descrizioneUoCollegataUtente = descrizioneUoCollegataUtente;
	}
}
