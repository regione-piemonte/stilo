...
public class ConvocazioneInfoXmlBean {
	...
	@XmlVariabile(nome="ShowEditorDettSedute", tipo=TipoVariabile.SEMPLICE)
	private Boolean showEditorDettSedute;
	
	@XmlVariabile(nome="DettSeduteHtml", tipo=TipoVariabile.SEMPLICE)
	private String dettSeduteHtml;
	
	/**
	 *  valori:  salvataggio - firma - invio_email 
	 */
	
	@XmlVariabile(nome = "AzioneDaFare", tipo = TipoVariabile.SEMPLICE)
	private String azioneDaFare;
	
	@XmlVariabile(nome="InvioConvocazione_EmailTo", tipo=TipoVariabile.SEMPLICE)
	private String invioConvocazioneEmailTo;
	
	@XmlVariabile(nome="InvioConvocazione_EmailCC", tipo=TipoVariabile.SEMPLICE)
	private String invioConvocazioneEmailCC;
	...
	public Boolean getShowEditorDettSedute() {
		return showEditorDettSedute;
	}

	public void setShowEditorDettSedute(Boolean showEditorDettSedute) {
		this.showEditorDettSedute = showEditorDettSedute;
	}

	public String getDettSeduteHtml() {
		return dettSeduteHtml;
	}

	public void setDettSeduteHtml(String dettSeduteHtml) {
		this.dettSeduteHtml = dettSeduteHtml;
	}
	...
	public String getInvioConvocazioneEmailTo() {
		return invioConvocazioneEmailTo;
	}

	public void setInvioConvocazioneEmailTo(String invioConvocazioneEmailTo) {
		this.invioConvocazioneEmailTo = invioConvocazioneEmailTo;
	}

	public String getInvioConvocazioneEmailCC() {
		return invioConvocazioneEmailCC;
	}

	public void setInvioConvocazioneEmailCC(String invioConvocazioneEmailCC) {
		this.invioConvocazioneEmailCC = invioConvocazioneEmailCC;
	}
