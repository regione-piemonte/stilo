...
package it.eng.auriga.ui.module.layout.client.gestioneTSO;
...
public class TSOPersonaliList extends CustomList {
	...
	public TSOPersonaliList(String nomeEntita) {
		super(nomeEntita);
		...
		documentoInizialeProcedimentoField = new ListGridField("documentoInizialeProcedimentoXOrd", I18NUtil.getMessages().tso_personali_list_documentoInizialeProcedimento());
		...
		dataPresentazioneField = new ListGridField("dataPresentazione", I18NUtil.getMessages().tso_personali_list_dataPresentazione());
		...
		inFaseProcedimentoField = new ListGridField("inFaseProcedimento", I18NUtil.getMessages().tso_personali_list_inFaseProcedimento());
		
		ultimoTaskProcedimentoField = new ListGridField("ultimoTaskProcedimento", I18NUtil.getMessages().tso_personali_list_ultimoTaskProcedimento());
		
		messaggioUltimoTaskProcedimentoField = new ListGridField("messaggioUltimoTaskProcedimento", I18NUtil.getMessages().tso_personali_list_messaggioUltimoTaskProcedimento());
		
		prossimeAttivitaField = new ListGridField("prossimeAttivita", I18NUtil.getMessages().tso_personali_list_prossimeAttivita());
		
		assegnatarioProcedimentoField = new ListGridField("assegnatarioProcedimento", I18NUtil.getMessages().tso_personali_list_assegnatarioProcedimento());
		
		esitoUltimaAttivitaField = new ListGridField("esitoUltimaAttivita", I18NUtil.getMessages().tso_personali_list_esitoUltimaAttivita());
		...
		dataCertificatoField = new ListGridField("dataCertificato", I18NUtil.getMessages().tso_personali_list_dataCertificato());
		...
		cognomeMedicoField = new ListGridField("cognomeMedico", I18NUtil.getMessages().tso_personali_list_cognomeMedico());
		
		nomeMedicoField = new ListGridField("nomeMedico", I18NUtil.getMessages().tso_personali_list_nomeMedico());
		
		contattiMedicoField = new ListGridField("contattiMedico", I18NUtil.getMessages().tso_personali_list_contattiMedico());
		
		cognomePazienteField = new ListGridField("cognomePaziente", I18NUtil.getMessages().tso_personali_list_cognomePaziente());
		
		nomePazienteField = new ListGridField("nomePaziente", I18NUtil.getMessages().tso_personali_list_nomePaziente());
		
		dataNascitaPazienteField  = new ListGridField("dataNascitaPaziente", I18NUtil.getMessages().tso_personali_list_dataNascitaPaziente());
		...
		minorePazienteField = new ListGridField("minorePaziente", I18NUtil.getMessages().tso_personali_list_minorePaziente());
		...
		luogoNascitaPazienteField = new ListGridField("luogoNascitaPaziente", I18NUtil.getMessages().tso_personali_list_luogoNascitaPaziente());
