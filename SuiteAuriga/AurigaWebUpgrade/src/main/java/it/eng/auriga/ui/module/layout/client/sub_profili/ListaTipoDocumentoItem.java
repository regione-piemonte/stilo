...
import it.eng.auriga.ui.module.layout.client.tipologieDocumentali.LookupTipologieDocumentaliPopup;
...
public class ListaTipoDocumentoItem extends GridItem {
	
	protected ListaTipoDocumentoItem instance = this;
	...
	public ListaTipoDocumentoItem(String name) {
		
		super(name, "sub_profili_lista_tipo_documento");
		...
		// Opzioni Abilitazioni a tipologie documentali		
		listaPrivilegiValueMap.put("A", I18NUtil.getMessages().sub_profili_abilitazioni_TD_A_value());
		listaPrivilegiValueMap.put("F", I18NUtil.getMessages().sub_profili_abilitazioni_TD_F_value());
		listaPrivilegiValueMap.put("P", I18NUtil.getMessages().sub_profili_abilitazioni_TD_P_value());
	...
	public List<ToolStripButton> buildCustomEditButtons() {
		...
		addButton.setPrefix("Aggiungi tipologia documentale");
		addButton.setPrompt("Aggiungi tipologia documentale");
		
		final String finalita = "sub_profili_lista_tipo_documento";
	...
	public void onClickAddButton(String finalita, Boolean flgSelezioneSingola) {
		LookupTipologieDocumentali lookupTipologieDocumentali = new LookupTipologieDocumentali(finalita, flgSelezioneSingola);
		lookupTipologieDocumentali.show();
	}
	
	
	public class LookupTipologieDocumentali extends LookupTipologieDocumentaliPopup {

		public LookupTipologieDocumentali(String finalita, Boolean flgSelezioneSingola) {
	...
	public void setValuesFromRecord(Record record) {
		...
		recordToInsert.setAttribute("idOggettoPriv",            record.getAttribute("idTipoDoc"));				
		recordToInsert.setAttribute("codiceOggettoPriv",        record.getAttribute("idTipoDoc"));
	...
	protected static GWTRestDataSource getLoadComboPrivilegiDatasource() {
		GWTRestDataSource loadComboPrivilegiDS = new GWTRestDataSource("LoadComboPrivilegiTipoDocumentoDataSource");
