...
public class CASAbstractTicketValidation extends AbstractCasFilter {
    ...
    public final void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        ...
        if (CommonUtils.isNotBlank(ticket)) {
            ...
            try {
            	 Cas20ServiceTicketValidator casValidator = new Cas20ServiceTicketValidator(CASAuthenticationFilter.casServerUrlPrefix);
            	 final Assertion assertion = casValidator.validate(
