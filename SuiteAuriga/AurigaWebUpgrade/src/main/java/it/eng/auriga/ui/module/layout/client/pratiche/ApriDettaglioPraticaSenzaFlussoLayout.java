...
public class ApriDettaglioPraticaSenzaFlussoLayout extends ModalWindow {

	private ApriDettaglioPraticaSenzaFlussoLayout _window;
	...
	public ApriDettaglioPraticaSenzaFlussoLayout(Record record, String title) {
		this(record, title, false);
	}
	
	public ApriDettaglioPraticaSenzaFlussoLayout(Record record, String title, final boolean isModificaTesto) {
									...
									public void onClick(MenuItemClickEvent event) {
										...
										if(codStato != null && !"".equals(codStato)) {
											if(flgGeneraFileUnione != null && "1".equals(flgGeneraFileUnione)) {
												...
												((NuovaPropostaAtto2CompletaDetail) detail).generaFileUnione(null, nomeFileUnione, nomeFileUnioneOmissis, impostazioniUnioneFile, new ServiceCallback<Record>() {
