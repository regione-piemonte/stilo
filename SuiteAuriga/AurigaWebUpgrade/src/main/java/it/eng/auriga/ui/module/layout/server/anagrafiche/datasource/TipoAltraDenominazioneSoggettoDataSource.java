...
@Datasource(id = "TipoAltraDenominazioneSoggettoDataSource")
public class TipoAltraDenominazioneSoggettoDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(TipoAltraDenominazioneSoggettoDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME_TABELLA|*|DMT_RUBRICA_SOGGETTI|*|NOME_COL_TABELLA|*|ALTRE_FORME_NOME.TIPO|*|ROWID|*|" + rowId + "|*|ID_USER_LAVORO|*|"  + idUserLavoro);
