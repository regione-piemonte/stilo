...
public class UfficioPrelievoCanvas extends ReplicableCanvas {
	...
	public UfficioPrelievoCanvas(UfficioPrelievoItem item) {
		super(item);
	}
	...
	public void disegna() {
		...
		organigrammaItem.setAttribute("obbligatorio", true);
		...
		lookupOrganigrammaButton.addIconClickHandler(new IconClickHandler() {
			...
			public void onIconClick(IconClickEvent event) {
				UfficioPrelievoLookupOrganigramma lookupOrganigrammaPopup = new UfficioPrelievoLookupOrganigramma(null);
...
//		mDynamicForm.setFields(idUoHiddenItem, codRapidoItem, lookupOrganigrammaButton, spacer, organigrammaItem);
	...
	public class UfficioPrelievoLookupOrganigramma extends LookupOrganigrammaPopup {

		public UfficioPrelievoLookupOrganigramma(Record record) {
			super(record, true, 1);
		}
