...
@Datasource(id = "LoadComboCircoscrizioniDataSource")
public class LoadComboCircoscrizioniDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(LoadComboCircoscrizioniDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|CIRCOSCRIZIONI");
