...
public abstract class LookupOrganigrammaContenutiAmmTraspPopup extends ModalWindow {
	
	private LookupOrganigrammaContenutiAmmTraspPopup _window;
	...
	public LookupOrganigrammaContenutiAmmTraspPopup(final Record filterValues, boolean flgSelezioneSingola) {
		this(filterValues, flgSelezioneSingola, null);
	}
	
	public LookupOrganigrammaContenutiAmmTraspPopup(final Record filterValues, boolean flgSelezioneSingola, Integer flgIncludiUtenti) {
