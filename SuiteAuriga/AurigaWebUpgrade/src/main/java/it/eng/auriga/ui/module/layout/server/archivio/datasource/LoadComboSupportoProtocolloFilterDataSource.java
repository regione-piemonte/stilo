...
@Datasource(id = "LoadComboSupportoProtocolloFilterDataSource")
public class LoadComboSupportoProtocolloFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(LoadComboSupportoProtocolloFilterDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|TIPO_SUPPORTO_FISICO_DOCUMENTO");
