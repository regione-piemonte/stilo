...
public abstract class FirmaMultiplaHashHybridWindow extends HybridWindow {

	private HybridEng mAppletEng;

	protected FirmaMultiplaHashHybridWindow _window;
	...
	public FirmaMultiplaHashHybridWindow(String appletTipoFirmaAtti, boolean firmaAvanzamentoIterAtti, boolean abilGestFirmaAllegatiFirmatiPIAtto, Map<String, Record> files, boolean pSkipCtrlBustaFirm, String jSessionId) {
		...
		lMapParams.put("fileInputProvider", "it.eng.areas.hybrid.module.cryptoLight.inputFileProvider.MultiHashFileInputProvider");
		...
		lMapParams.put("fileOutputProvider", "it.eng.areas.hybrid.module.cryptoLight.outputFileProvider.AurigaMultiHashFileOutputProvider");
		...
		lMapParams.put("commonNameProvider", "it.eng.areas.hybrid.module.cryptoLight.cnProvider.AurigaProxyCommonNameProvider");

		mAppletEng = new HybridEng("SignerAppletMulti", "SignerAppletMulti.jnlp", lMapParams, 357, 550, true, true, this,
				new String[] { "SignerAppletMulti" + getSignerAppletMultiJarVersion() + ".jar" }, "it.eng.client.applet.SmartCardApplet") {
	...
	public static native void callHybrid(JavaScriptObject lMapParams) /*-{
		$wnd.doSignerAppletMultiHash(lMapParams);
	}-*/;
	...
	private native void initCommonNameFunction(FirmaMultiplaHashHybridWindow firmaMultiplaHashWindow, String functionName) /*-{
		$wnd[functionName] = function(value) {
			firmaMultiplaHashWindow.@it.eng.auriga.ui.module.layout.client.firmamultiplahash.FirmaMultiplaHashHybridWindow::commonNameFunction(Ljava/lang/String;)(value);
		};
	}-*/;
	...
	private native void initCallBackAskForCloseFunction(FirmaMultiplaHashHybridWindow firmaMultiplaHashWindow, String functionName) /*-{
		$wnd[functionName] = function() {
			firmaMultiplaHashWindow.@it.eng.auriga.ui.module.layout.client.firmamultiplahash.FirmaMultiplaHashHybridWindow::callBackAskForCloseFunction()();
		};
	}-*/;
