...
@Datasource(id = "LoadComboClassificazionePortaleDataSource")
public class LoadComboClassificazionePortaleDataSource extends OptionFetchDataSource<SimpleKeyValueBean>{
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
        ...
        lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME|*|CLASSIF_PORTALE");
