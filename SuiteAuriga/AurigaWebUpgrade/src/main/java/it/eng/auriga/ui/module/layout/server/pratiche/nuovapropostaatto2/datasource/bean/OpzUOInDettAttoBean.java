...
public class OpzUOInDettAttoBean {
	
	//INPUT
	private String idUo;
	
	//OUTPUT
	private Boolean flgVistoRespUffVisibilita;
	private Boolean flgVistoRespUffEditabile;
	private Boolean flgVistoRespUffValoreDefault;
	private List<KeyValueBean> flgVistoRespUffValoriSelectScrivanie;
	private String flgVistoRespUffValoreDefaultSelectScrivanie;
	private Boolean flgVistoDirSup1Visibilita;
	private Boolean flgVistoDirSup1Editabile;
	private Boolean flgVistoDirSup1ValoreDefault;
	private List<KeyValueBean> flgVistoDirSup1ValoriSelectScrivanie;
	private String flgVistoDirSup1ValoreDefaultSelectScrivanie;
	private Boolean flgVistoDirSup2Visibilita;
	private Boolean flgVistoDirSup2Editabile;
	private Boolean flgVistoDirSup2ValoreDefault;
	...
	public Boolean getFlgVistoRespUffVisibilita() {
		return flgVistoRespUffVisibilita;
	}
	public void setFlgVistoRespUffVisibilita(Boolean flgVistoRespUffVisibilita) {
		this.flgVistoRespUffVisibilita = flgVistoRespUffVisibilita;
	}
	public Boolean getFlgVistoRespUffEditabile() {
		return flgVistoRespUffEditabile;
	}
	public void setFlgVistoRespUffEditabile(Boolean flgVistoRespUffEditabile) {
		this.flgVistoRespUffEditabile = flgVistoRespUffEditabile;
	}
	public Boolean getFlgVistoRespUffValoreDefault() {
		return flgVistoRespUffValoreDefault;
	}
	public void setFlgVistoRespUffValoreDefault(Boolean flgVistoRespUffValoreDefault) {
	...
	public Boolean getFlgVistoDirSup1Visibilita() {
		return flgVistoDirSup1Visibilita;
	}
	public void setFlgVistoDirSup1Visibilita(Boolean flgVistoDirSup1Visibilita) {
		this.flgVistoDirSup1Visibilita = flgVistoDirSup1Visibilita;
	}
	public Boolean getFlgVistoDirSup1Editabile() {
		return flgVistoDirSup1Editabile;
	}
	public void setFlgVistoDirSup1Editabile(Boolean flgVistoDirSup1Editabile) {
		this.flgVistoDirSup1Editabile = flgVistoDirSup1Editabile;
	}
	public Boolean getFlgVistoDirSup1ValoreDefault() {
		return flgVistoDirSup1ValoreDefault;
	}
	public void setFlgVistoDirSup1ValoreDefault(Boolean flgVistoDirSup1ValoreDefault) {
	...
	public Boolean getFlgVistoDirSup2Visibilita() {
		return flgVistoDirSup2Visibilita;
	}
	public void setFlgVistoDirSup2Visibilita(Boolean flgVistoDirSup2Visibilita) {
		this.flgVistoDirSup2Visibilita = flgVistoDirSup2Visibilita;
	}
	public Boolean getFlgVistoDirSup2Editabile() {
		return flgVistoDirSup2Editabile;
	}
	public void setFlgVistoDirSup2Editabile(Boolean flgVistoDirSup2Editabile) {
		this.flgVistoDirSup2Editabile = flgVistoDirSup2Editabile;
	}
	public Boolean getFlgVistoDirSup2ValoreDefault() {
		return flgVistoDirSup2ValoreDefault;
	}
	public void setFlgVistoDirSup2ValoreDefault(Boolean flgVistoDirSup2ValoreDefault) {
