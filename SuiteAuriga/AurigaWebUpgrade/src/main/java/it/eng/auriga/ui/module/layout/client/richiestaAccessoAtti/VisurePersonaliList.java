...
public class VisurePersonaliList extends CustomList {
	...
	public VisurePersonaliList(String nomeEntita) {
		...
		//estremiProcedimentoField = new ListGridField("estremiProcedimento",I18NUtil.getMessages().visure_personali_list_estremiProcedimentoField());             
		//estremiProcedimentoField.setWidth(100);
		
		dataAvvioProcedimentoField = new ListGridField("dataAvvioProcedimento",I18NUtil.getMessages().visure_personali_list_dataAvvioProcedimentoField());  dataAvvioProcedimentoField.setType(ListGridFieldType.DATE); dataAvvioProcedimentoField.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATE);
		dataAvvioProcedimentoField.setWidth(100);
		dataAvvioProcedimentoField.setType(ListGridFieldType.DATE);
		
		statoProcedimentoField = new ListGridField("statoProcedimento",I18NUtil.getMessages().visure_personali_list_statoProcedimentoField());
		statoProcedimentoField.setWidth(100);
		
		documentoInizialeProcedimentoField = new ListGridField("documentoInizialeProcedimento",I18NUtil.getMessages().visure_personali_list_documentoInizialeProcedimentoField());
		...
		inFaseProcedimentoField = new ListGridField("inFaseProcedimento",I18NUtil.getMessages().visure_personali_list_inFaseProcedimentoField());
		inFaseProcedimentoField.setWidth(100);
		inFaseProcedimentoField.setHidden(true);
		
		scadenzaTermineProcedimentoField = new ListGridField("scadenzaTermineProcedimento",I18NUtil.getMessages().visure_personali_list_scadenzaTermineProcedimentoField()); scadenzaTermineProcedimentoField.setType(ListGridFieldType.DATE);scadenzaTermineProcedimentoField.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATE);
		scadenzaTermineProcedimentoField.setWidth(100);
		scadenzaTermineProcedimentoField.setType(ListGridFieldType.DATE);
		
		flgScadenzaTermineProcedimentoField = new ListGridField("flgScadenzaTermineProcedimento",I18NUtil.getMessages().visure_personali_list_flgScadenzaTermineProcedimentoField());
		...
		flgScadenzaTermineProcedimentoField.setHoverCustomizer(new HoverCustomizer() {		
			...
			public String hoverHTML(Object value, ListGridRecord record, int rowNum, int colNum) {
				...
				if("1".equals(record.getAttribute("flgScadenzaTermineProcedimento"))) {
					return I18NUtil.getMessages().visure_personali_flgScadenzaTermineProcedimento_1_value();
				}				
				return null;
			}
		});
				
		ultimoTaskProcedimentoField = new ListGridField("ultimoTaskProcedimento",I18NUtil.getMessages().visure_personali_list_ultimoTaskProcedimentoField());
		ultimoTaskProcedimentoField.setWidth(100);
		
		messaggioUltimoTaskProcedimentoField = new ListGridField("messaggioUltimoTaskProcedimento",I18NUtil.getMessages().visure_personali_list_messaggioUltimoTaskProcedimentoField());
		messaggioUltimoTaskProcedimentoField.setWidth(100);	
		
		noteProcedimentoField = new ListGridField("noteProcedimento",I18NUtil.getMessages().visure_personali_list_noteProcedimentoField());
		noteProcedimentoField.setWidth(100);
		noteProcedimentoField.setHidden(true);
		
		prossimeAttivitaField = new ListGridField("prossimeAttivita",I18NUtil.getMessages().visure_personali_list_prossimeAttivitaField());
		prossimeAttivitaField.setWidth(100);
		prossimeAttivitaField.setHidden(true);
				
		richiedente = new ListGridField("richiedente",I18NUtil.getMessages().visure_personali_list_richiedenteField());
		
		tipoRichiedente = new ListGridField("tipoRichiedente",I18NUtil.getMessages().visure_personali_list_tipoRichiedenteField());
		...
		tipoRichiedente.setHoverCustomizer(new HoverCustomizer() {	
			...
			public String hoverHTML(Object value, ListGridRecord record, int rowNum, int colNum) {
				...
				if("E".equals(record.getAttribute("tipoRichiedente"))) {
					return I18NUtil.getMessages().visure_personali_flgTipoRichiedenteEsternovalue();
				} else if("I".equals(record.getAttribute("tipoRichiedente"))) {
					return I18NUtil.getMessages().visure_personali_flgTipoRichiedenteInternovalue();
				}				
				return null;
			}
		});
		
		respIstruttoria = new ListGridField("respIstruttoria",I18NUtil.getMessages().visure_personali_list_respIstruttoriaField());
		
		indirizzo = new ListGridField("indirizzo",I18NUtil.getMessages().visure_personali_list_indirizzoField());

		attiRichiesti = new ListGridField("attiRichiesti",I18NUtil.getMessages().visure_personali_list_attiRichiestiField());
		
		classificaAtti = new ListGridField("classificaAtti",I18NUtil.getMessages().visure_personali_list_classificaAttiField());
		
		archiviCoinvolti = new ListGridField("archiviCoinvolti",I18NUtil.getMessages().visure_personali_list_archiviCoinvoltiField());

		udc = new ListGridField("udc",I18NUtil.getMessages().visure_personali_list_udcField());
		
		appCittadella = new ListGridField("appCittadella",I18NUtil.getMessages().visure_personali_list_appCittadellaField());
		appCittadella.setType(ListGridFieldType.DATE);
		appCittadella.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATETIME);
		
		appBernina = new ListGridField("appBernina",I18NUtil.getMessages().visure_personali_list_appBerninaField());
		appBernina.setType(ListGridFieldType.DATE);
		appBernina.setDateFormatter(DateDisplayFormat.TOEUROPEANSHORTDATETIME);
		
		codPraticaSUE = new ListGridField("codPraticaSUE",I18NUtil.getMessages().visure_personali_list_codPraticaSUEField());
		
		tipologiaRichiedenteSUEField = new ListGridField("tipologiaRichiedenteSUE",I18NUtil.getMessages().visure_personali_list_tipologiaRichiedenteSUEField());
		
		motivazioneVisuraSUEField = new ListGridField("motivazioneVisuraSUE",I18NUtil.getMessages().visure_personali_list_motivazioneVisuraSUEField());
		
		richAttiDiFabbricaField = new ListGridField("richAttiDiFabbrica",I18NUtil.getMessages().visure_personali_list_richAttiDiFabbricaField());
...
//					return I18NUtil.getMessages().visure_personali_richAttiDiFabbrica_value();
//				}				
//				return null;
//			}
//		});
		
		fabbricatoAttiCostrFino1996Field = new ListGridField("fabbricatoAttiCostrFino1996",I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrFino1996Field());
		...
		fabbricatoAttiCostrFino1996Field.setHoverCustomizer(new HoverCustomizer() {		
			...
			public String hoverHTML(Object value, ListGridRecord record, int rowNum, int colNum) {
				...
				if("E".equals(record.getAttribute("fabbricatoAttiCostrFino1996"))) {
					return I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrFino1996Esternovalue();
				} else if("I".equals(record.getAttribute("fabbricatoAttiCostrFino1996"))) {
					return I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrFino1996Internovalue();
				} else if("EI".equals(record.getAttribute("fabbricatoAttiCostrFino1996"))) {
					return I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrFino1996EsternoInternovalue();
				}			
				return null;
			}
		});
		
		fabbricatoAttiCostrDa1997Field = new ListGridField("fabbricatoAttiCostrDa1997",I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrDa1997Field());
		...
		fabbricatoAttiCostrDa1997Field.setHoverCustomizer(new HoverCustomizer() {		
			...
			public String hoverHTML(Object value, ListGridRecord record, int rowNum, int colNum) {
				...
				if("E".equals(record.getAttribute("fabbricatoAttiCostrDa1997"))) {
					return I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrDa1997Esternovalue();
				} else if("I".equals(record.getAttribute("fabbricatoAttiCostrDa1997"))) {
					return I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrDa1997Internovalue();
				} else if("EI".equals(record.getAttribute("fabbricatoAttiCostrDa1997"))) {
					return I18NUtil.getMessages().visure_personali_list_fabbricatoAttiCostrDa1997EsternoInternovalue();
				}				
				return null;
			}
		});
		
//		richiestoCartaceoField  = new ListGridField("richiestoCartaceo",I18NUtil.getMessages().visure_personali_list_richiestoCartaceoField());
...
//					return I18NUtil.getMessages().visure_personali_list_richiestoCartaceo_value();
//				}				
//				return null;
//			}
//		});
		
		richModificheField = new ListGridField("richModifiche",I18NUtil.getMessages().visure_personali_list_richModificheField());
		
		ultimaAttivitaEsitoField = new ListGridField("ultimaAttivitaEsito", I18NUtil.getMessages().visure_personali_list_ultimaAttivitaEsito());
		...
		canaleArrivoField = new ListGridField("canaleArrivo", I18NUtil.getMessages().visure_personali_list_canaleArrivoField());
	...
	protected Canvas createFieldCanvas(String fieldName, final ListGridRecord record) {   			
		...
		if (fieldName.equals("buttons")) {	
			...
			folderButton.setPrompt(I18NUtil.getMessages().visure_personali_iconaFolderButton_prompt());
			...
			folderDetailButton.setPrompt(I18NUtil.getMessages().visure_personali_iconaFolderDetailButton_prompt());
	...
	private Menu createAltreOpMenu(final ListGridRecord listGridRecord, final Record detailRecord) {
		...
		MenuItem folderMenuItem = new MenuItem(I18NUtil.getMessages().visure_personali_iconaFolderButton_prompt(), "archivio/flgUdFolder/F.png");   
		...
		MenuItem folderDetailMenuItem = new MenuItem(I18NUtil.getMessages().visure_personali_iconaFolderDetailButton_prompt(), "buttons/detail.png");   
		...
		MenuItem fileRichiestaMenuItem = new MenuItem(I18NUtil.getMessages().visure_personali_fileRichiestaMenuItem_prompt(), "archivio/file.png");   
		...
		if(!isDisableRecordComponent()) {
			...
			if(folderButtonField == null) {
				...
				folderButtonField.setHoverCustomizer(new HoverCustomizer() {	
					...
					public String hoverHTML(Object value, ListGridRecord record, int rowNum,
						...
						return I18NUtil.getMessages().visure_personali_iconaFolderButton_prompt();
					}
				});		
			...
			if(folderDetailButtonField == null) {
				...
				folderDetailButtonField.setHoverCustomizer(new HoverCustomizer() {	
					...
					public String hoverHTML(Object value, ListGridRecord record, int rowNum,
						...
						return I18NUtil.getMessages().visure_personali_iconaFolderDetailButton_prompt();
					}
				});		
			...
			if(visualizzaIstanzaButtonField == null) {
				...
				visualizzaIstanzaButtonField.setHoverCustomizer(new HoverCustomizer() {	
					...
					public String hoverHTML(Object value, ListGridRecord record, int rowNum,
							int colNum) {
						if(isAbilToPreview(record)) {											
							return I18NUtil.getMessages().visure_personali_visualizzaIstanzaButton();
						}
						return null;
					}
				});		
			...
			if(fileRichiestaButtonField == null) {
				...
				fileRichiestaButtonField.setHoverCustomizer(new HoverCustomizer() {	
					...
					public String hoverHTML(Object value, ListGridRecord record, int rowNum,
							int colNum) {									
						return I18NUtil.getMessages().visure_personali_fileRichiestaMenuItem_prompt();
					}
				});		
...
//		}
	...
	private void buildTimbraAllegato(final ListGridRecord listRecord, final Record detailRecord, final int nroAllegato,
			Menu operazioniFileAllegatoSubmenu, InfoFileRecord lInfoFileRecord, final boolean allegatoIntegrale) {
	...
	public void timbraFileAllegato(Record detailRecord, int nroAllegato, boolean allegatoIntegrale) {
		String idUd = detailRecord.getAttributeAsString("idUd");
		final Record allegatoRecord = detailRecord.getAttributeAsRecordList("listaAllegati").get(nroAllegato);
