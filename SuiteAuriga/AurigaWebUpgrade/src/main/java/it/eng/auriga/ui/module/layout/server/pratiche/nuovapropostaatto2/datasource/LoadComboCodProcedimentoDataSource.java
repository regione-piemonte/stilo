...
@Datasource(id = "LoadComboCodProcedimentoDataSource")
public class LoadComboCodProcedimentoDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		String responsabileDiProcedimento = StringUtils.isNotBlank(getExtraparams().get("responsabileDiProcedimento")) ? getExtraparams().get("responsabileDiProcedimento") : "";
		if (responsabileDiProcedimento.startsWith("SV")) {
			responsabileDiProcedimento = responsabileDiProcedimento.substring(2);
		}
		
		DmpkLoadComboDmfn_load_comboBean lDmpkLoadComboDmfn_load_comboBean = new DmpkLoadComboDmfn_load_comboBean();
		lDmpkLoadComboDmfn_load_comboBean.setCodidconnectiontokenin(loginBean.getToken());
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("PROCEDIMENTO");
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("ID_USER_LAVORO|*|" + idUserLavoro + "|*|ID_SV_RDP|*|" + responsabileDiProcedimento);
...
//		lista = getTestData(responsabileDiProcedimento);
	...
	public List<SimpleKeyValueBean> getTestData(String responsabileDiProcedimento) {		
		List<SimpleKeyValueBean> lista = new ArrayList<SimpleKeyValueBean>();
		SimpleKeyValueBean lSimpleKeyValueBean1 = new SimpleKeyValueBean();
		lSimpleKeyValueBean1.setKey("001" + responsabileDiProcedimento);
		lSimpleKeyValueBean1.setValue("Procedimento 1 " + responsabileDiProcedimento);
		lista.add(lSimpleKeyValueBean1);
		SimpleKeyValueBean lSimpleKeyValueBean2 = new SimpleKeyValueBean();
		lSimpleKeyValueBean2.setKey("002" + responsabileDiProcedimento);
		lSimpleKeyValueBean2.setValue("Procedimento 2 " + responsabileDiProcedimento);
