...
@Datasource(id = "AssegnatoNotificatoADatasource")
public class AssegnatoNotificatoADatasource extends OptionFetchDataSource<AssegnatoNotificatoABean> {
	...
	public PaginatorBean<AssegnatoNotificatoABean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby)
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("ID_USER_LAVORO|*|" + idUserLavoro + "|*|FLG_NODO_TYPE|*|UO;SV|*|NRI_LIVELLI_UO|*|" + codice
