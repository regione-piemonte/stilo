...
public class VisualizzaDatiStatisticheCogitoLogWindow extends ModalWindow {
	...
	private VisualizzaDatiStatisticheCogitoLogList list;
	...
	public VisualizzaDatiStatisticheCogitoLogWindow(final Record pRecord, final String pTipoReport) {
		
		super("datiStatisticheCogitoLog", false);
		
		setTitle("Statistiche sui log cogito");
...
//		layoutListaRemoveField.setIsRemoveField(true);
		...
		list = new VisualizzaDatiStatisticheCogitoLogList("datiStatisticheCogitoLog", pRecord, pTipoReport);
	...
	protected void export(final String formatoExport) {
		...
		GWTRestService<Record, Record> lReportDatasource = new GWTRestService("ReportCogitoLogDatasource");
