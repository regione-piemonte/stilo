...
package it.eng.auriga.ui.module.layout.server.proposteOrganigramma.proposteOrgPersonali.datasource;
...
import it.eng.auriga.ui.module.layout.server.proposteOrganigramma.proposteOrgPersonali.bean.ProposteOrganigrammaPersonaliBean;
import it.eng.auriga.ui.module.layout.server.proposteOrganigramma.proposteOrgPersonali.bean.ProposteOrganigrammaPersonaliXmlBean;
...
@Datasource(id = "ProposteOrganigrammaPersonaliDatasource")
public class ProposteOrganigrammaPersonaliDatasource extends AbstractFetchDataSource<ProposteOrganigrammaPersonaliBean> {

	private static Logger mLogger = Logger.getLogger(ProposteOrganigrammaPersonaliDatasource.class);

	@Override
	public PaginatorBean<ProposteOrganigrammaPersonaliBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		ProposteOrganigrammaPersonaliBean filter = new ProposteOrganigrammaPersonaliBean(); 
		...
		List<ProposteOrganigrammaPersonaliXmlBean> lListResult = XmlListaUtility.recuperaLista(xmlOut, ProposteOrganigrammaPersonaliXmlBean.class);
		List<ProposteOrganigrammaPersonaliBean> lList = new ArrayList<ProposteOrganigrammaPersonaliBean>(lListResult.size());		
		for (ProposteOrganigrammaPersonaliXmlBean lProposteOrganigrammaPersonaliXmlBean : lListResult){
			ProposteOrganigrammaPersonaliBean lProposteOrganigrammaPersonaliBean = new ProposteOrganigrammaPersonaliBean();
			BeanUtilsBean2.getInstance().copyProperties(lProposteOrganigrammaPersonaliBean, lProposteOrganigrammaPersonaliXmlBean);
//			lProposteOrganigrammaPersonaliBean.setOggettoProcedimento(HtmlUtils.htmlEscape(lProposteOrganigrammaPersonaliBean.getOggettoProcedimento()));
			lProposteOrganigrammaPersonaliBean.setOggettoProcedimento(HtmlNormalizeUtil.getPlainXmlWithCarriageReturn(lProposteOrganigrammaPersonaliBean.getOggettoProcedimento()));			
			lList.add(lProposteOrganigrammaPersonaliBean);
		}
		
		return new PaginatorBean<ProposteOrganigrammaPersonaliBean>(lList);
	}
	...
	@Override
	public Map<String, ErrorBean> validate(ProposteOrganigrammaPersonaliBean bean) throws Exception {
		return null;
	}
	...
	@Override
	public ProposteOrganigrammaPersonaliBean get(ProposteOrganigrammaPersonaliBean bean) throws Exception {
		return bean;
	}

	@Override
	public ProposteOrganigrammaPersonaliBean add(ProposteOrganigrammaPersonaliBean bean) throws Exception {
		return bean;
	}

	@Override
	public ProposteOrganigrammaPersonaliBean remove(ProposteOrganigrammaPersonaliBean bean) throws Exception {
		return bean;
	}

	@Override
	public ProposteOrganigrammaPersonaliBean update(ProposteOrganigrammaPersonaliBean bean, ProposteOrganigrammaPersonaliBean oldvalue)
			throws Exception {
		return bean;
	}
