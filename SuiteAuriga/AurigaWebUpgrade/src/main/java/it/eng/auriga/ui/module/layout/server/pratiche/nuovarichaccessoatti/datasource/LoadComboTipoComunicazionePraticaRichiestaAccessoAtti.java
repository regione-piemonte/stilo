...
package it.eng.auriga.ui.module.layout.server.pratiche.nuovarichaccessoatti.datasource;
...
@Datasource(id="LoadComboTipoComunicazionePraticaRichiestaAccessoAtti")
public class LoadComboTipoComunicazionePraticaRichiestaAccessoAtti extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME|*|TIPO_COMUNICAZIONE_PRATICA_RICHIESTA_ACCESSO_ATTI");
