...
@Datasource(id="LoadComboProgrammazioneAcquistiDataSource")
public class LoadComboProgrammazioneAcquistiDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {

	private static Logger mLogger = Logger.getLogger(LoadComboProgrammazioneAcquistiDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME|*|TASK_RESULT_2_PROGRAMMAZIONE_ACQUISTI");
