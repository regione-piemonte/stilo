...
public class PresenzaVotoArgomentoWindow extends ModalWindow {
	
	protected PresenzaVotoArgomentoWindow window;
	protected PresenzaVotoArgomentoDetail detail;	
	protected ToolStrip detailToolStrip;

	public PresenzaVotoArgomentoWindow(String nomeEntita, String title, final Record record, String tipologiaSessione, String codCircoscrizione) {
		...
		detail = new PresenzaVotoArgomentoDetail(nomeEntita, tipologiaSessione, codCircoscrizione);	
		...
		setIcon("delibere/presenze_voti.png");	
	}
