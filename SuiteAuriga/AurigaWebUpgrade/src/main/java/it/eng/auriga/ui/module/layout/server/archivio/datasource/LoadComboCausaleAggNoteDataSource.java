...
@Datasource(id = "LoadComboCausaleAggNoteDataSource")
public class LoadComboCausaleAggNoteDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	@Override
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
        ...
        lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME|*|CAUSALE_AGG_NOTE|*|");
