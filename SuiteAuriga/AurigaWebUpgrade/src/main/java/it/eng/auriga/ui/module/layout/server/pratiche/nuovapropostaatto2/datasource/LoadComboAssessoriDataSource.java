...
@Datasource(id="LoadComboAssessoriDataSource")
public class LoadComboAssessoriDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("ASSESSORI");
