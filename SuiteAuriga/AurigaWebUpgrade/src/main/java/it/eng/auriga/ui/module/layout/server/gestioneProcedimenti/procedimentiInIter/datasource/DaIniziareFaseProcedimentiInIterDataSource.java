...
@Datasource(id = "DaIniziareFaseProcedimentiInIterDataSource")
public class DaIniziareFaseProcedimentiInIterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
