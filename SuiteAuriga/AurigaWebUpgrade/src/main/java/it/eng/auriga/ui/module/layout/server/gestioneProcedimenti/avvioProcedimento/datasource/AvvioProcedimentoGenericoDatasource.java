...
@Datasource(id = "AvvioProcedimentoGenericoDatasource")
public class AvvioProcedimentoGenericoDatasource extends AbstractServiceDataSource<AvvioProcedimentoInBean, AvvioProcedimentoOutBean>{

	private static Logger mLogger = Logger.getLogger(AvvioProcedimentoGenericoDatasource.class);
	@Override
	public AvvioProcedimentoOutBean call(AvvioProcedimentoInBean pInBean)
		...
		AvvioProcedimentoServiceOutBean lAvvioProcedimentoServiceOutBean = 
			lAvvioProcedimentoService.avviaprocgenerico(getLocale(), AurigaUserUtil.getLoginInfo(getSession()), lAvvioProcedimentoServiceInBean);
