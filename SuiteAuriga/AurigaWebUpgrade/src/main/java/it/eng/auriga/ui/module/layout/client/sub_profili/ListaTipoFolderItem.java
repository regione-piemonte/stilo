...
import it.eng.auriga.ui.module.layout.client.tipoFascicoliAggr.LookupTipoFascicoliAggregatiPopup;
...
public class ListaTipoFolderItem extends GridItem {
	
	protected ListaTipoFolderItem instance = this;	
	...
	public ListaTipoFolderItem(String name) {
		
		super(name, "sub_profili_lista_tipo_folder");
		...
		// Opzioni Abilitazioni a fascicoli/aggregati
		listaPrivilegiValueMap.put("A", I18NUtil.getMessages().sub_profili_abilitazioni_TF_A_value());
	...
	public List<ToolStripButton> buildCustomEditButtons() {
		...
		addButton.setPrefix("Aggiungi tipologie fascicoli");
		addButton.setPrompt("Aggiungi tipologie fascicoli");
		
		final String finalita = "sub_profili_lista_tipo_folder";
	...
	public void onClickAddButton(String finalita, Boolean flgSelezioneSingola) {
		LookupTipoFolder lookupTipoFolder = new LookupTipoFolder(finalita, flgSelezioneSingola);
		lookupTipoFolder.show();
	}
	
	
	public class LookupTipoFolder extends LookupTipoFascicoliAggregatiPopup {

		public LookupTipoFolder(String finalita, Boolean flgSelezioneSingola) {
	...
	public void setValuesFromRecord(Record record) {
		...
		recordToInsert.setAttribute("idOggettoPriv",            record.getAttribute("idFolderType"));				
		recordToInsert.setAttribute("codiceOggettoPriv",        record.getAttribute("idFolderType"));
	...
	protected static GWTRestDataSource getLoadComboPrivilegiDatasource() {
		GWTRestDataSource loadComboPrivilegiDS = new GWTRestDataSource("LoadComboPrivilegiTipoFolderDataSource");
