...
public class ItemLavorazioneMailBean {
	...
	// Decodifica codice dell'item
	@NumeroColonna(numero = "22")
	private String itemLavDesTag;
	...
	public String getItemLavDesTag() {
		return itemLavDesTag;
	}

	public void setItemLavDesTag(String itemLavDesTag) {
		this.itemLavDesTag = itemLavDesTag;
	}
}