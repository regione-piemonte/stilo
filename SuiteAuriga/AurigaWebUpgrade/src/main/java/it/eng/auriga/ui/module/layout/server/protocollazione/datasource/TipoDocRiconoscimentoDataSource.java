...
@Datasource(id = "TipoDocRiconoscimentoDataSource")
public class TipoDocRiconoscimentoDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		String tipoDocRiconoscimento = StringUtils.isNotBlank(getExtraparams().get("tipoDocRiconoscimento")) ? getExtraparams().get("tipoDocRiconoscimento") : "";
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|TIPO_DOCUMENTO_RICONOSCIMENTO|*|CI_TO_ADD|*|" + tipoDocRiconoscimento + "|*|ID_USER_LAVORO|*|"  + idUserLavoro);
