...
@Datasource(id = "LoadComboRegoleRegistrazioneAutomaticaEmailFilterDataSource")
public class LoadComboRegoleRegistrazioneAutomaticaEmailFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("REGOLE_PROT_AUTO_MAIL");		
