...
public class MezzoTrasmissioneDestinatarioBean {
	
    private String mezzoTrasmissioneDestinatario;
    private String indirizzoPECDestinatario;
    private String indirizzoPEODestinatario;
	...
	public String getIndirizzoPECDestinatario() {
		return indirizzoPECDestinatario;
	}
	public void setIndirizzoPECDestinatario(String indirizzoPECDestinatario) {
		this.indirizzoPECDestinatario = indirizzoPECDestinatario;
	}
	public String getIndirizzoPEODestinatario() {
		return indirizzoPEODestinatario;
	}
	public void setIndirizzoPEODestinatario(String indirizzoPEODestinatario) {
		this.indirizzoPEODestinatario = indirizzoPEODestinatario;
	}
