...
public class VisurePersonaliFilter extends ConfigurableFilter {

	private String lista;
	private Map<String, List<String>> toClear;

	public VisurePersonaliFilter(String lista) {
		super(lista);
		setWidth(750);
	}
	...
	public void createFilteredSelectItem(final FilterFieldBean pFilterFieldBean, DataSourceField pDataSourceField) {
		...
		for (FilterFieldBean lFilterFieldBean : Layout.getFilterConfig("visure_personali").getFields()){
