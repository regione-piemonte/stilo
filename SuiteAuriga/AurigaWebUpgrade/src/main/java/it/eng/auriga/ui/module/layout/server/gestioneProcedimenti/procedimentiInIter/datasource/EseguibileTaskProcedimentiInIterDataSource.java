...
@Datasource(id = "EseguibileTaskProcedimentiInIterDataSource")
public class EseguibileTaskProcedimentiInIterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("INTERNAL_VALUE|*|CID|*|ID_PROCESS_TYPE|*|" + idProcessType + "|*|CI_FASE_WF|*|" + idFase);
