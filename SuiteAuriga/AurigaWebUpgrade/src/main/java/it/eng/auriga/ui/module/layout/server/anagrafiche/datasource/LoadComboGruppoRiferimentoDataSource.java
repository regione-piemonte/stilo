...
@Datasource(id = "LoadComboGruppoRiferimentoDataSource")
public class LoadComboGruppoRiferimentoDataSource extends OptionFetchDataSource<SimpleKeyValueBean>{
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
        ...
        lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME|*|COD_GRUPPO_RIF");
