...
public class StampaEtichettaHybridWindow extends HybridWindow {
	...
	public StampaEtichettaHybridWindow(String title, String appletJarName, String nomeStampante, Record[] pRecordsEtichette, String numeroCopie, boolean attivaTimbraturaCartaceo, String nomePortaStampaPort, StampaEtichettaCallback returnCallback) {
		super(I18NUtil.getMessages().protocollazione_stampaEtichettaWindow_title(), "StampaEtichettaApplet.jar");
		...
		HybridEng lAppletEng = new HybridEng("StampaEtichettaApplet", "StampaEtichettaApplet.jnlp", lMapParams, 200, 200, true, true, this, new String[] {
				"StampaEtichettaApplet.jar", "lib/barcode4j-fop-ext-2.0.jar" }, "it.eng.applet.StampaEtichettaAppletOcx") {
	...
	public static native void callHybrid(JavaScriptObject lMapParams) /*-{
		$wnd.doStampaEtichette(lMapParams);
	}-*/;

	private native void initCallBack(StampaEtichettaHybridWindow pStampaEtichettaAppletWindow, String functionName) /*-{
		$wnd[functionName] = function() {
			return pStampaEtichettaAppletWindow.@it.eng.auriga.ui.module.layout.client.protocollazione.StampaEtichettaHybridWindow::closeWindow()();
		}
	}-*/;
