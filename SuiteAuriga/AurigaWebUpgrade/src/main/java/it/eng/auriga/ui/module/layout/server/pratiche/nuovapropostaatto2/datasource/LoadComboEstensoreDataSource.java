...
@Datasource(id="LoadComboEstensoreDataSource")
public class LoadComboEstensoreDataSource extends SelectDataSource<ScrivaniaOrganigrammaBean> {
	...
	public PaginatorBean<ScrivaniaOrganigrammaBean> realFetch(AdvancedCriteria criteria, Integer startRow,
		...
		String altriParamComboEstensori = ParametriDBUtil.getParametroDB(getSession(), "ALTRI_PARAM_COMBO_ESTENSORI");
