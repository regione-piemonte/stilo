...
public abstract class RegistraRepertorioEmailWindow extends ModalWindow {

	protected RegistraRepertorioEmailWindow _window;

	protected RepertorioDetailEntrata portletLayout;
	...
	public RegistraRepertorioEmailWindow(String pNomeEntita, Record pRecord, String pFlgTipoProv) {
		this(pNomeEntita, pRecord, pFlgTipoProv, false, null, null, null);
	}

	public RegistraRepertorioEmailWindow(String pNomeEntita, Record pRecord, String pFlgTipoProv, boolean isThereIdUdMail, Record recordMail, DettaglioPostaElettronica instanceDettaglioPostaElettronica, CustomLayout externalLayout) {
		...
		setTitle(I18NUtil.getMessages().registra_repertorio_email_window_title());
		setIcon("menu/repertorio_entrata.png");
		...
		portletLayout = ProtocollazioneUtil.buildRepertorioDetailEntrata(pRecord, null);
		if (isThereIdUdMail) {
