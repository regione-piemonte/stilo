...
@Datasource(id="LoadComboCodClassFascEdilizioDataSource")
public class LoadComboCodClassFascEdilizioDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|CLASIFF_FASC_EDILIZIO");		
