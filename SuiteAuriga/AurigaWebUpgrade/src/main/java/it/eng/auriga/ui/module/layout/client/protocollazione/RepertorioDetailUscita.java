...
public abstract class RepertorioDetailUscita extends ProtocollazioneDetailUscita {

	protected RepertorioDetailUscita _instance;

	private CheckboxItem annoPassatoItem;

	public RepertorioDetailUscita(String nomeEntita) {
	...
	public String getIconAltraNumerazione() {
		return "protocollazione/repertorio_uscita.png";
	}
