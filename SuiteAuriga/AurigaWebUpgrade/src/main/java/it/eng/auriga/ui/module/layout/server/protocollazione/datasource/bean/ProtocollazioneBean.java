...
import it.eng.document.function.bean.DatiIstanzeConcorrentiSUAADSPXmlBean;
...
//	private OpzioniTimbroDocBean opzioniTimbroOmissis;
	...
	private List<RelVsPraticheApplEsterneBean> listaRelVsPraticheApplEsterne;
	...
	private Boolean flgSegnaInvioMailExtraSistema;
	private Boolean flgInviataMailExtraSistema;
	...
	// ************* ABILITAZIONI ISTRUTTORIA PUBBL *************
	...
	private List<FirmatariIterFirmaBean> listaFirmatariIterFirma;
	private List<DestInvioCCBean> listaCoredattoriIterFirma;
	...
	private List<SelezionaUOBean> listaUoRegPostIterFirma;	
	private Boolean flgEmailAutoTermineIterFirmaReg;
	...
	// ************* REGISTRAZIONE MULTIPLA IN USCITA *************
	...
	public List<RelVsPraticheApplEsterneBean> getListaRelVsPraticheApplEsterne() {
		return listaRelVsPraticheApplEsterne;
	}

	public void setListaRelVsPraticheApplEsterne(List<RelVsPraticheApplEsterneBean> listaRelVsPraticheApplEsterne) {
		this.listaRelVsPraticheApplEsterne = listaRelVsPraticheApplEsterne;
	}
	...
	public Boolean getFlgSegnaInvioMailExtraSistema() {
	...
	public Boolean getFlgPregresso() {
		return flgPregresso;
	}

	public void setFlgPregresso(Boolean flgPregresso) {
	...
	public List<FirmatariIterFirmaBean> getListaFirmatariIterFirma() {
		return listaFirmatariIterFirma;
	}

	public void setListaFirmatariIterFirma(List<FirmatariIterFirmaBean> listaFirmatariIterFirma) {
		this.listaFirmatariIterFirma = listaFirmatariIterFirma;
	}
	
	public List<DestInvioCCBean> getListaCoredattoriIterFirma() {
		return listaCoredattoriIterFirma;
	}

	public void setListaCoredattoriIterFirma(List<DestInvioCCBean> listaCoredattoriIterFirma) {
		this.listaCoredattoriIterFirma = listaCoredattoriIterFirma;
	}
	...
	public List<SelezionaUOBean> getListaUoRegPostIterFirma() {
		return listaUoRegPostIterFirma;
	}

	public void setListaUoRegPostIterFirma(List<SelezionaUOBean> listaUoRegPostIterFirma) {
		this.listaUoRegPostIterFirma = listaUoRegPostIterFirma;
	}

	public Boolean getFlgEmailAutoTermineIterFirmaReg() {
		return flgEmailAutoTermineIterFirmaReg;
	}

	public void setFlgEmailAutoTermineIterFirmaReg(Boolean flgEmailAutoTermineIterFirmaReg) {
	...
	public Boolean getFlgInviataMailExtraSistema() {
		return flgInviataMailExtraSistema;
	}

	public void setFlgInviataMailExtraSistema(Boolean flgInviataMailExtraSistema) {
