...
package it.eng.auriga.ui.module.layout.server.proposteOrganigramma.proposteOrgInIter.datasource;
...
@Datasource(id = "LoadTipoProcOrganigrammaInIterDataSource")
public class LoadTipoProcOrganigrammaInIterDataSource extends OptionFetchDataSource<SelezionaProcedimentoBean> {
	...
	public PaginatorBean<SelezionaProcedimentoBean> fetch(AdvancedCriteria criteria,
		...
		String altriParametri = "ID_USER_LAVORO|*|" + idUserLavoro + "|*|FLG_SOLO_GESTIBILI|*|1|*|STR_IN_DES|*|" + nomeCriteria + "|*|CATEGORIA|*|REVISIONE_ORGANIGRAMMA";		
