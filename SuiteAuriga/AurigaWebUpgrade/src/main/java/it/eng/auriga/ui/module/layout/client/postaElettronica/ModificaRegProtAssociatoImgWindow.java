...
public class ModificaRegProtAssociatoImgWindow extends ModalWindow {

	private ModificaRegProtAssociatoImgWindow _window;

	private ProtocollazioneDetail portletLayout;

	public ModificaRegProtAssociatoImgWindow(Record record, String title, ServiceCallback<Record> afterUpdateCallback) {
		this(record, null, title, afterUpdateCallback);
	}
			
	public ModificaRegProtAssociatoImgWindow(Record record, String taskName, String title, ServiceCallback<Record> afterUpdateCallback) {

		super("modificaregprotassociatoimg", true);
