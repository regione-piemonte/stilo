 ...
 *
 */
public class AttiInLavorazioneFilter extends ConfigurableFilter {

	private Boolean showFilterSmistamentoAtti;
	
	public AttiInLavorazioneFilter(String lista,  Map<String, String> extraparam) {
	...
	public void createFilteredSelectItem(final FilterFieldBean filterFieldBean, DataSourceField dataSourceField) {
		...
		for (FilterFieldBean currentFieldFilterBean : Layout.getFilterConfig("atti_in_lavorazione").getFields()){
