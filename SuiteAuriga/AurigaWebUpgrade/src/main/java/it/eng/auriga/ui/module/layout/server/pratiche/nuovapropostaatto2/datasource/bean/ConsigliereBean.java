...
public class ConsigliereBean {
	...
	private Boolean flgConsigliereFirmaInSostSindaco;
	...
	public Boolean getFlgConsigliereFirmaInSostSindaco() {
		return flgConsigliereFirmaInSostSindaco;
	}

	public void setFlgConsigliereFirmaInSostSindaco(Boolean flgConsigliereFirmaInSostSindaco) {
		this.flgConsigliereFirmaInSostSindaco = flgConsigliereFirmaInSostSindaco;
	}
