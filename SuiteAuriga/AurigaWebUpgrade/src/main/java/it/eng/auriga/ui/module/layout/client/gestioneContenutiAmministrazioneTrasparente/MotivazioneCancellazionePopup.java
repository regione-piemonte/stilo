...
public abstract class MotivazioneCancellazionePopup extends ModalWindow {
	
	protected MotivazioneCancellazionePopup window;
	...
	public MotivazioneCancellazionePopup(String title) {
		
		super("motivazione_cancellazione_popup", true);
		window = this;
        setTitle(title);
		setAutoCenter(true);
