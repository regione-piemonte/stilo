...
@Datasource(id = "EffettuatoTaskProcedimentiInIterDataSource")
public class EffettuatoTaskProcedimentiInIterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
