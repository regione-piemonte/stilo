...
package it.eng.auriga.ui.module.layout.server.gestioneAtti.attiInLavorazione.datasource;
...
@Datasource(id="LoadComboInoltroRagioneriaDataDataSource")
public class LoadComboInoltroRagioneriaDataDataSource extends AbstractTreeDataSource<InoltroRagioneriaTreeNodeBean> {
	
	private static Logger mLogger = Logger.getLogger(LoadComboTipoAffidamentoDataSource.class);
	...
	public PaginatorBean<InoltroRagioneriaTreeNodeBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("FILTRO_ATTI_INOLTRO_RAG_X_DATA");
