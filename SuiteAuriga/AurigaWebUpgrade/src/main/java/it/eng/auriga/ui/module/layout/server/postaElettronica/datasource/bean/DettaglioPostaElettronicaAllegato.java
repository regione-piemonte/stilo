...
public class DettaglioPostaElettronicaAllegato {
	...
	private String pdfEditabile;
	@NumeroColonna(numero = "15")
	private String pdfConCommenti;
	...
	public String getPdfEditabile() {
		return pdfEditabile;
	}

	public String getPdfConCommenti() {
		return pdfConCommenti;
	}

	public void setPdfEditabile(String pdfEditabile) {
		this.pdfEditabile = pdfEditabile;
	}

	public void setPdfConCommenti(String pdfConCommenti) {
