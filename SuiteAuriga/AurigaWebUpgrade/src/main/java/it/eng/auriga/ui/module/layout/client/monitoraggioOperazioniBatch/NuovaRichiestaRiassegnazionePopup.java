...
package it.eng.auriga.ui.module.layout.client.monitoraggioOperazioniBatch;
...
public abstract class NuovaRichiestaRiassegnazionePopup extends ModalWindow {

	protected NuovaRichiestaRiassegnazionePopup _window;
	...
	public NuovaRichiestaRiassegnazionePopup() {

		super("nuova_richiesta_riassegnazione", true);

		_window = this;
		
		vm = new ValuesManager();		

		setTitle("Nuova richiesta di riassegnazione");
		...
		tipoOggettiRiassegnareItem = new SelectItem("tipoOggettoRiassegnare", setTitleAlign("Tipo di oggetti da riassegnare", 240, true));		
		LinkedHashMap<String, String> tipiOggRiassegnareValueMap = new LinkedHashMap<String, String>();
		if(Layout.isPrivilegioAttivo("ROM/M/SPM")) {
			tipiOggRiassegnareValueMap.put("M", "E-mail");
		}
		if(Layout.isPrivilegioAttivo("ROM/M/SPF")) {
			tipiOggRiassegnareValueMap.put("F", "Fascicoli");
		}
		if (Layout.isPrivilegioAttivo("ROM/M/SPD")) {
