...
package it.eng.auriga.ui.module.layout.server.gestioneTSO.datasource;
...
@Datasource(id="DaEffettuareTaskTSODataSource")
public class DaEffettuareTaskTSODataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("INTERNAL_VALUE|*|CID|*|ID_PROCESS_TYPE|*|" + ParametriDBUtil.getParametroDB(getSession(),"ID_PROCESS_TYPE_TSO"));
