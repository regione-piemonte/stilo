...
public class VisurePersonaliLayout extends CustomLayout {

	//protected MultiToolStripButton assegnaMultiButton;
	protected MultiToolStripButton impostaRespIstruttoria;

	public VisurePersonaliLayout(String nomeEntita) {
		this(nomeEntita, null, null, null);
	}

	public VisurePersonaliLayout(String nomeEntita, String finalita) {
		this(nomeEntita, finalita, null, null);
	}

	public VisurePersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola) {
		this(nomeEntita, finalita, flgSelezioneSingola, null);
	}

	public VisurePersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, new GWTRestDataSource("VisurePersonaliDatasource", "idProcedimento", FieldType.TEXT), 
				new VisurePersonaliFilter(nomeEntita), 
				new VisurePersonaliList(nomeEntita), 
				new VisurePersonaliDetail(nomeEntita), 
...
//		}
		if(impostaRespIstruttoria == null) {
			impostaRespIstruttoria = new MultiToolStripButton("protocollazione/flagSoggettiGruppo/O2.png", this, I18NUtil.getMessages().visure_personali_impostaRespIstruttoriaButtonMassivo(),
					false) {
