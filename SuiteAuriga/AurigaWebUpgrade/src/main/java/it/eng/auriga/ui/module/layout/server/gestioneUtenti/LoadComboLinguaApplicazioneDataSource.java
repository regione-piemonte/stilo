...
@Datasource(id = "LoadComboLinguaApplicazioneDataSource")
public class LoadComboLinguaApplicazioneDataSource extends AbstractFetchDataSource<LinguaBean> {
	@Override
	public PaginatorBean<LinguaBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("ID_USER_LAVORO|*|" + (AurigaUserUtil.getLoginInfo(getSession()).getIdUserLavoro() != null ? AurigaUserUtil.getLoginInfo(getSession()).getIdUserLavoro() : "") + "|*|DICTIONARY_ENTRY|*|LINGUA_APPLICAZIONE");
