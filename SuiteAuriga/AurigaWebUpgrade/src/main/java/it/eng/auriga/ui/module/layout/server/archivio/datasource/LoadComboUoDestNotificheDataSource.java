...
@Datasource(id = "LoadComboUoDestNotificheDataSource")
public class LoadComboUoDestNotificheDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		String flgUdFolder = getExtraparams().get("flgUdFolder") != null ? getExtraparams().get("flgUdFolder") : "";
		String idUdFolder = getExtraparams().get("idUdFolder") != null ? getExtraparams().get("idUdFolder") : "";		
		String altriParametriIn = getExtraparams().get("altriParametriIn") != null ? "|*|" + getExtraparams().get("altriParametriIn") : "";		
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("UO_DEST_NOT");
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("ID_USER_LAVORO|*|" + idUserLavoro + "|*|TIPO_OBJ|*|" + flgUdFolder + "|*|ID_OBJ|*|" + idUdFolder + altriParametriIn);
