...
@Datasource(id="LoadComboTipoPraticaRichiestaAccessoAtti")
public class LoadComboTipoPraticaRichiestaAccessoAtti extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME|*|TIPO_PRATICA_RICHIESTA_ACCESSO_ATTI");
