...
@Datasource(id = "LoadComboResponsabiliPEGDataSource")
public class LoadComboResponsabiliPEGDataSource extends SelectDataSource<ScrivaniaOrganigrammaBean> {
	...
	public PaginatorBean<ScrivaniaOrganigrammaBean> realFetch(AdvancedCriteria criteria, Integer startRow,
		...
		if(StringUtils.isNotBlank(getExtraparams().get("altriParamLoadCombo"))) {		
			...
			lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DES_RUOLO|*|$DIRIGENTE_CDC$|*|STR_IN_DES|*|" + descrizione + "|*|CI_TO_ADD|*|" + idSv);							
		}
