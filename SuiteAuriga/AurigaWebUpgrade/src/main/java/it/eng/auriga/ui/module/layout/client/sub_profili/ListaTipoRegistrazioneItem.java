...
import it.eng.auriga.ui.module.layout.client.registriNumerazione.LookupRegistriNumerazionePopup;
...
public class ListaTipoRegistrazioneItem extends GridItem {
	
	protected ListaTipoRegistrazioneItem instance = this;
	...
	public ListaTipoRegistrazioneItem(String name) {
		
		super(name, "sub_profili_lista_tipo_registrazione");
		...
		// Opzioni Abilitazioni a tipo di registrazione
		listaPrivilegiValueMap.put("A", I18NUtil.getMessages().sub_profili_abilitazioni_TR_A());
	...
	public List<ToolStripButton> buildCustomEditButtons() {
		...
		addButton.setPrefix("Aggiungi registro di numerazione");
		addButton.setPrompt("Aggiungi registro di numerazione");
	...
	public void onClickAddButton(String finalita, Boolean flgSelezioneSingola) {
		LookupRegistriNumerazione lookupRegistriNumerazione = new LookupRegistriNumerazione(finalita, flgSelezioneSingola);
		lookupRegistriNumerazione.show();
	}
	
	public class LookupRegistriNumerazione extends LookupRegistriNumerazionePopup {

		public LookupRegistriNumerazione(String finalita, Boolean flgSelezioneSingola) {
	...
	public void setValuesFromRecord(Record record) {
		...
		recordToInsert.setAttribute("idOggettoPriv",            record.getAttribute("idTipoRegNum"));	
		recordToInsert.setAttribute("codiceOggettoPriv",        record.getAttribute("idTipoRegNum"));
	...
	protected static GWTRestDataSource getLoadComboPrivilegiDatasource() {
		GWTRestDataSource loadComboPrivilegiDS = new GWTRestDataSource("LoadComboPrivilegiTipoRegistrazioneDataSource");
