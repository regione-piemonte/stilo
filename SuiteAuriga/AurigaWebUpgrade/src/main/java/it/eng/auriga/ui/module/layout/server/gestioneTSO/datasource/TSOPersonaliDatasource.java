...
@Datasource(id = "TSOPersonaliDatasource")
public class TSOPersonaliDatasource extends AurigaAbstractFetchDatasource<TSOBean> {

	private static Logger mLogger = Logger.getLogger(TSOPersonaliDatasource.class);
	
	@Override
	public String getNomeEntita() {
		return "tso_personali";
	}
