...
package it.eng.auriga.ui.module.layout.client.postainuscita;
...
public class PostaInUscitaRegistrazioneLayout extends CustomLayout {	
			
	public PostaInUscitaRegistrazioneLayout(GWTRestDataSource pGWTRestDataSource) {
		super("postainuscitaregistrazione", 
				pGWTRestDataSource,
				null,
				new PostaInUscitaRegistrazioneList("postainuscitaregistrazione") ,
	...
	private static CustomDetail switchDetailPostaElettronica(){
		...
		if(!AurigaLayout.getParametroDBAsBoolean("DETT_EMAIL_UNICO")) {
			...
			portletLayout = new CustomDetail("postainuscitaregistrazione");
		}
