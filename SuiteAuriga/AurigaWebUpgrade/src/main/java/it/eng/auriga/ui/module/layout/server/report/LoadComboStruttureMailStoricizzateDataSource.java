...
package it.eng.auriga.ui.module.layout.server.report;
...
@Datasource(id="LoadComboStruttureMailStoricizzateDataSource")
public class LoadComboStruttureMailStoricizzateDataSource extends AbstractFetchDataSource<AssegnatoNotificatoABean> {
	...
	public PaginatorBean<AssegnatoNotificatoABean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby)
		...
		String tipoAssegnatari = ParametriDBUtil.getParametroDB(getSession(), "TIPO_ASSEGNATARI_EMAIL");
		if (StringUtils.isBlank(tipoAssegnatari))
			tipoAssegnatari = "UO;SV";
		// Inizializzo l'INPUT
