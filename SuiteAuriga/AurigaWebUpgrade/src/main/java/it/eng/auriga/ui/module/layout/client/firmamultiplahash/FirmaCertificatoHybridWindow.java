...
public abstract class FirmaCertificatoHybridWindow extends HybridWindow {
	...
	public FirmaCertificatoHybridWindow(String appletTipoFirmaAtti, boolean firmaAvanzamentoIterAtti, boolean abilGestFirmaAllegatiFirmatiPIAtto, Map<String, Record> files, boolean pSkipCtrlBustaFirm, String pin, String firmatario, String alias, String metodoFirma, String jSessionId) {
