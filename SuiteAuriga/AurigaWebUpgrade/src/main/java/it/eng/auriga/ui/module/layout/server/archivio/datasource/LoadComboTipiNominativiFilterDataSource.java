...
@Datasource(id = "LoadComboTipiNominativiFilterDataSource")
public class LoadComboTipiNominativiFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(LoadComboTipiNominativiFilterDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|NATURA_REL_SOGG_EST_DOC|*|FLG_SELECT_MULTI|*|1");
