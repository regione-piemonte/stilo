...
public abstract class SezioneTreePopup extends ModalWindow {

	protected SezioneTreePopup window;
	...
	public SezioneTreePopup(CustomLayout layoutIn, Record recordIn, String titleIn, String iconIn) {

		super("sezione_tree_popup", true);
		...
		nomeItem = new TextItem("nome", "Nome sezione");
		nomeItem.setWidth(500);
		nomeItem.setColSpan(4);
		nomeItem.setStartRow(true);
		nomeItem.setRequired(true);
		
		formMain.setFields( nomeItem);

		nomeItem.setValue(recordIn.getAttribute("nome"));
		formMain.setValue("nome", recordIn.getAttribute("nome"));  
