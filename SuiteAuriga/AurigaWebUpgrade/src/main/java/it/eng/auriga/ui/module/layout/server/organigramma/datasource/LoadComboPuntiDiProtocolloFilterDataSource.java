...
@Datasource(id="LoadComboPuntiDiProtocolloFilterDataSource")
public class LoadComboPuntiDiProtocolloFilterDataSource extends OptionFetchDataSource<AssegnatoNotificatoABean> {

	@Override
	public PaginatorBean<AssegnatoNotificatoABean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow,
