...
@Datasource(id="LoadComboTipoSessioneOdgDataSource")
public class LoadComboTipoSessioneOdgDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|TIPO_SESSIONE_" + tipologiaSessione);
