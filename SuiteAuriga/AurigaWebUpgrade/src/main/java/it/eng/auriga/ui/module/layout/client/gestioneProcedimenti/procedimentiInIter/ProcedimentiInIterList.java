...
public class ProcedimentiInIterList extends CustomList{
	...
	public ProcedimentiInIterList(String nomeEntita) {
		...
		ultimaAttivitaField = new ListGridField("ultimaAttivita", I18NUtil.getMessages().procedimenti_in_iter_list_ultimaAttivitaField());
		ultimaAttivitaMessaggioField = new ListGridField("ultimaAttivitaMessaggio", I18NUtil.getMessages().procedimenti_in_iter_list_ultimaAttivitaMessaggioField());
		...
		ultimaAttivitaEsitoField = new ListGridField("ultimaAttivitaEsito", I18NUtil.getMessages().procedimenti_in_iter_list_ultimaAttivitaEsitoField());
		...
		assegnatarioIstruttoriaField = new ListGridField("assegnatarioIstruttoria", I18NUtil.getMessages().procedimenti_in_iter_list_assegnatarioIstruttoriaField());
		assegnatarioIstruttoriaField.setWidth(100);
				
		assegnatarioIstruttoriaPreIstruttoriaField = new ListGridField("assegnatarioIstruttoriaPreIstruttoria", I18NUtil.getMessages().procedimenti_in_iter_list_assegnatarioIstruttoriaPreIstruttoriaField());
		assegnatarioIstruttoriaPreIstruttoriaField.setWidth(100);
		
		denominazioneRichiedenteField = new ListGridField("denominazioneRichiedente", I18NUtil.getMessages().procedimenti_in_iter_list_denominazioneRichiedenteField());
		denominazioneRichiedenteField.setWidth(100);
		
		codFiscalePivaRichiedenteField = new ListGridField("codFiscalePivaRichiedente", I18NUtil.getMessages().procedimenti_in_iter_list_codFiscalePivaRichiedenteField());
