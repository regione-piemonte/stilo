...
public abstract class CambiaPrivilegiSubProfiliPopup extends Window {
	
	private CambiaPrivilegiSubProfiliPopup window;
	
	private DynamicForm form;
	protected SelectItem privilegiFunzioneItem;
	
	public CambiaPrivilegiSubProfiliPopup(){
		this(null, null);
	}	
	
	public CambiaPrivilegiSubProfiliPopup(String title, GWTRestDataSource loadComboPrivilegiDS){
