...
@Datasource(id = "LoadComboRdAeAttiCollegatiDataSource")
public class LoadComboRdAeAttiCollegatiDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(LoadComboRdAeAttiCollegatiDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|RDA_VS_ALTRI_ATTI");
