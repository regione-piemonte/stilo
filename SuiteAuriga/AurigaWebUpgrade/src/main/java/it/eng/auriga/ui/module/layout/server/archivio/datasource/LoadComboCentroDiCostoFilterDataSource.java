...
@Datasource(id = "LoadComboCentroDiCostoFilterDataSource")
public class LoadComboCentroDiCostoFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean>{

	private static Logger mLogger = Logger.getLogger(LoadComboCentroDiCostoFilterDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,Integer startRow, Integer endRow, List<OrderByBean> orderby)throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|CDC|*|ID_USER_LAVORO|*|" + idUserLavoro);
