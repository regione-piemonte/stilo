...
@Datasource(id="FlussiWorkflowDataSource")
public class FlussiWorkflowDataSource extends OptionFetchDataSource<SimpleKeyValueBean>{
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		String flgSoloValidi = getExtraparams().get("flgSoloValidi");
		
		DmpkLoadComboDmfn_load_combo lDmpkLoadComboDmfn_load_combo = new DmpkLoadComboDmfn_load_combo();
		DmpkLoadComboDmfn_load_comboBean lDmpkLoadComboDmfn_load_comboBean = new DmpkLoadComboDmfn_load_comboBean();
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("FLUSSI_WF");
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("INTERNAL_VALUE|*|CID|*|CI_TO_ADD|*|" + codTipoFlusso);
		lDmpkLoadComboDmfn_load_comboBean.setFlgsolovldin(flgSoloValidi != null && flgSoloValidi.equalsIgnoreCase("true") ? new BigDecimal(1) : null);
