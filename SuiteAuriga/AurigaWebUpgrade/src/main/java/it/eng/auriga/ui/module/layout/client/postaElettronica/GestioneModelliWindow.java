...
//		modelliPickListProperties.setCanRemoveRecords(true);
	...
	private void loadModello (ListGridRecord record) {
...
////	modelloSelectItem.setItemHoverFormatter(true, new FormItemHoverFormatter() {
////
////		@Override
////		public String getHoverHTML(FormItem item, DynamicForm form) {
////			return StringUtil.asHTML((String) modelloSelectItem.getValue());
////		}
////	});
//
