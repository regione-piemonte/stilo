 ...
 *
 */
@Datasource(id="ArchiviCoinvoltiSelectSelectDataSource")
public class ArchiviCoinvoltiSelectSelectDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
