...
@Datasource(id="LoadComboAttiProcedimentiFilterDataSource")
public class LoadComboAttiProcedimentiFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		if(StringUtils.isNotBlank(dictionaryEntry)) {
			...
			lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("ID_USER_LAVORO|*|" + idUserLavoro + "|*|NOME|*|" + dictionaryEntry);
