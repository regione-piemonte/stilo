...
import it.eng.client.DmpkCoreRemovefromfavourites;
...
@Datasource(id = "RimozioneDaPreferitiDataSource")
public class RimozioneDaPreferitiDataSource extends AbstractDataSource<OperazioneMassivaArchivioBean, OperazioneMassivaArchivioBean>{	
	...
	public OperazioneMassivaArchivioBean add(OperazioneMassivaArchivioBean bean) throws Exception {		
		...
		for(ArchivioBean udFolder : bean.getListaRecord()) {
			DmpkCoreRemovefromfavouritesBean input = new DmpkCoreRemovefromfavouritesBean();
			...
			DmpkCoreRemovefromfavourites dmpkCoreRemovefromfavourites = new DmpkCoreRemovefromfavourites();
			StoreResultBean<DmpkCoreRemovefromfavouritesBean> output = dmpkCoreRemovefromfavourites.execute(getLocale(),loginBean, input);
