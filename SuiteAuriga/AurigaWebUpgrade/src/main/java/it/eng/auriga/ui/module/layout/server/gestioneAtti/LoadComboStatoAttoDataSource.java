...
@Datasource(id="LoadComboStatoAttoDataSource")
public class LoadComboStatoAttoDataSource extends OptionFetchDataSource<SimpleKeyValueBean>{
	
	private static Logger mLogger = Logger.getLogger(LoadComboStatoAttoDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|STATO_DETT_UD");
