...
@Datasource(id = "CondGiuridicaSoggettoDataSource")
public class CondGiuridicaSoggettoDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {

	private static Logger log = Logger.getLogger(CondGiuridicaSoggettoDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("CONDIZIONE_GIURIDICA");		
