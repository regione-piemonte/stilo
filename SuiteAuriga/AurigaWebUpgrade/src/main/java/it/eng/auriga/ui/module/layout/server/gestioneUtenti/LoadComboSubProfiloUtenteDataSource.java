...
@Datasource(id="LoadComboSubProfiloUtenteDataSource")
public class LoadComboSubProfiloUtenteDataSource extends OptionFetchDataSource<SimpleKeyValueBean>{
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("GRUPPI_PRIVILEGI");		
