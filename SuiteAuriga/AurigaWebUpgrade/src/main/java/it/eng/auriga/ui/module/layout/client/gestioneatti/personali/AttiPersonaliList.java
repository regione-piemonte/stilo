...
/**
 * Definisce la lista dei campi per la vista sugli atti personali
 * 
 * @author massimo malvestio
 *
 */
public class AttiPersonaliList extends AttiList {
	...
	public AttiPersonaliList(String nomeEntita) {
	...
	private void buildTipoAtto() {
		tipoAtto = new ListGridField("tipoAtto", I18NUtil.getMessages().atti_personali_list_tipoAtto());
		tipoAtto.setWidth(100);
		tipoAtto.setAlign(Alignment.LEFT);
	}

	private void buildDataAvvio() {
		dataAvvio = new ListGridField("dataAvvio", I18NUtil.getMessages().atti_personali_list_dataAvvio());
	...
	private void buildNumeroProposta() {
		numeroProposta = new ListGridField("ordinamentoNumeroProposta", I18NUtil.getMessages().atti_personali_list_ordinamentoNumeroProposta());
	...
	private void buildNumeroAtto() {
		numeroAtto = new ListGridField("ordinamentoNumeroAtto", I18NUtil.getMessages().atti_personali_list_ordinamentoNumeroAtto());
	...
	private void buildInFase() {
		inFase = new ListGridField("inFase", I18NUtil.getMessages().atti_personali_list_inFase());
		inFase.setWidth(100);
		inFase.setAlign(Alignment.LEFT);
	}

	private void buildUltimaAttivita() {
		ultimaAttivita = new ListGridField("ultimaAttivita", I18NUtil.getMessages().atti_personali_list_ultimaAttivita());
		ultimaAttivita.setWidth(100);
		ultimaAttivita.setAlign(Alignment.LEFT);
	}
	
	private void buildUltimaAttivitaEsito() {
		ultimaAttivitaEsito = new ListGridField("ultimaAttivitaEsito", I18NUtil.getMessages().atti_personali_list_ultimaAttivitaEsito());
	...
	private void buildUltimaAttivitaMessaggio() {
		ultimaAttivitaMessaggio = new ListGridField("ultimaAttivitaMessaggio", I18NUtil.getMessages().atti_personali_list_ultimaAttivitaMessaggio());
		ultimaAttivitaMessaggio.setWidth(100);
		ultimaAttivitaMessaggio.setAlign(Alignment.LEFT);
	}

	private void buildDataProposta() {
		dataProposta = new ListGridField("dataProposta", I18NUtil.getMessages().atti_personali_list_dataProposta());
	...
	private void buildDataAtto() {
		dataAtto = new ListGridField("dataAtto", I18NUtil.getMessages().atti_personali_list_dataAtto());
	...
	private void buildOggetto() {
		oggetto = new ListGridField("oggetto", I18NUtil.getMessages().atti_personali_list_oggetto());
		oggetto.setWidth(100);
		oggetto.setAlign(Alignment.LEFT);
	}

	private void buildUnOrgProponente() {
		unOrgProponente = new ListGridField("unOrgProponente", I18NUtil.getMessages().atti_personali_list_unOrgProponente());
		unOrgProponente.setWidth(100);
		unOrgProponente.setAlign(Alignment.LEFT);
	}

	private void buildAvviatoDa() {
		avviatoDa = new ListGridField("avviatoDa", I18NUtil.getMessages().atti_personali_list_avviatoDa());
		avviatoDa.setWidth(100);
		avviatoDa.setAlign(Alignment.LEFT);
	}
	
	private void buildDataInvioVerificaContabile(){
		dataInvioVerificaContabile = new ListGridField("dataInvioVerificaContabile", I18NUtil.getMessages().atti_personali_list_dataInvioVerificaContabile());
	...
	private void builDataInvioFaseAppDirettori(){
		dataInvioFaseAppDirettori = new ListGridField("dataInvioFaseAppDirettori", I18NUtil.getMessages().atti_personali_list_dataInvioFaseAppDirettori());
	...
	private void buildProssimeAttivita() {
		prossimeAttivita = new ListGridField("prossimeAttivita", I18NUtil.getMessages().atti_personali_list_prossimeAttivita());
	...
	private void buildAssegnatario() {
		assegnatario = new ListGridField("assegnatario", I18NUtil.getMessages().atti_personali_list_assegnatario());
	}
	...
	private void buildDirigenteAdottante() {
		dirigenteAdottante = new ListGridField("dirigenteAdottante", I18NUtil.getMessages().atti_personali_list_dirigenteAdottante());
	}
	
	private void buildRespProcedimento() {
		respProcedimento = new ListGridField("respProcedimento", I18NUtil.getMessages().atti_personali_list_respProcedimento());
	}
	
	private void buildRUP() {
		rup = new ListGridField("rup", I18NUtil.getMessages().atti_personali_list_rup());
	}
	
	private void buildAltriRespInConcerto() {
		altriRespInConcerto = new ListGridField("altriRespInConcerto", I18NUtil.getMessages().atti_personali_list_altriRespInConcerto());
	}
	
	private void buildResponsabilePEG() {
		responsabilePEG = new ListGridField("responsabilePEG", I18NUtil.getMessages().atti_personali_list_responsabilePEG());
	}
	
	private void buildUoCompDefSpesa() {
		uoCompDefSpesa = new ListGridField("uoCompDefSpesa", I18NUtil.getMessages().atti_personali_list_uoCompDefSpesa());
	}
	
	private void buildCodiceCIG() {
		codiceCIG = new ListGridField("codiceCIG", I18NUtil.getMessages().atti_personali_list_codiceCIG());
	}
	
	private void buildEstensori() {
		estensori = new ListGridField("estensori", I18NUtil.getMessages().atti_personali_list_estensori());
	}
	...
	private void buildAssegnatarioUffAcquistiField() {
		assegnatarioUffAcquistiField = new ListGridField("assegnatarioUffAcquisti", I18NUtil.getMessages().atti_personali_completi_list_assegnatarioUffAcquisti());
	}
