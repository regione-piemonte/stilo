...
public class ProcedimentiPersonaliFilter extends ConfigurableFilter {

	private String lista;
	private Map<String, List<String>> toClear;

	public ProcedimentiPersonaliFilter(String lista) {
		super(lista);
		setWidth(750);
//		this.lista = lista;
...
//		}
	...
	public void createFilteredSelectItem(final FilterFieldBean pFilterFieldBean, DataSourceField pDataSourceField) {
		...
		for (FilterFieldBean lFilterFieldBean : Layout.getFilterConfig("procedimenti_personali").getFields()){
