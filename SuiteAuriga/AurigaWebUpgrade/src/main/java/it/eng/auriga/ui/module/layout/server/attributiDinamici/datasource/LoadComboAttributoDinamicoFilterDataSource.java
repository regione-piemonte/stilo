...
@Datasource(id = "LoadComboAttributoDinamicoFilterDataSource")
public class LoadComboAttributoDinamicoFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
