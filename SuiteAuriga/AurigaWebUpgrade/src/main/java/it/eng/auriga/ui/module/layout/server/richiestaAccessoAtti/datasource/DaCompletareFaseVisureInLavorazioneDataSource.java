...
@Datasource(id="DaCompletareFaseVisureInLavorazioneDataSource")
public class DaCompletareFaseVisureInLavorazioneDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
