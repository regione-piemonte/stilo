...
@Datasource(id = "LoadComboCodCategoriaFilterDatasource")
public class LoadComboCodCategoriaFilterDatasource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow,
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("COD_CATEGORIA");		
		lDmpkLoadComboDmfn_load_comboBean.setFlgsolovldin(null);
		lDmpkLoadComboDmfn_load_comboBean.setTsvldin(null);
//        lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("TARGET|*|UT");
