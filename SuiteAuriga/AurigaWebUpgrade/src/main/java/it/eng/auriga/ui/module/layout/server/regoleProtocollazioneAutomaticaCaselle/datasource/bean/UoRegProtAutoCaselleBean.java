...
public class UoRegProtAutoCaselleBean {
	...
	private Boolean flgAssDestinatario;
	private Boolean flgCcDestinatario;
	...
	public Boolean getFlgAssDestinatario() {
		return flgAssDestinatario;
	}
	public void setFlgAssDestinatario(Boolean flgAssDestinatario) {
		this.flgAssDestinatario = flgAssDestinatario;
	}
	public Boolean getFlgCcDestinatario() {
		return flgCcDestinatario;
	}
	public void setFlgCcDestinatario(Boolean flgCcDestinatario) {
		this.flgCcDestinatario = flgCcDestinatario;
	}
