...
@Datasource(id = "TipoContattoTelSoggettoDataSource")
public class TipoContattoTelSoggettoDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(TipoContattoTelSoggettoDataSource.class);
