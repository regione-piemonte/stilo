...
public abstract class RepertorioDetailEntrata extends ProtocollazioneDetailEntrata {

	protected RepertorioDetailEntrata _instance;

	private CheckboxItem annoPassatoItem;

	public RepertorioDetailEntrata(String nomeEntita) {
	...
	public String getIconAltraNumerazione() {
		return "protocollazione/repertorio_entrata.png";
	}
