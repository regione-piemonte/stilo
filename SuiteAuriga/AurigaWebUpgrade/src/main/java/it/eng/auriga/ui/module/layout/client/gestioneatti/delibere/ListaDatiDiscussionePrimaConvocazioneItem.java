...
public class ListaDatiDiscussionePrimaConvocazioneItem extends GridItem {
	
	private ListaDatiDiscussionePrimaConvocazioneItem instance = this;
	...
	public ListaDatiDiscussionePrimaConvocazioneItem(String name, String organoCollegiale, Boolean isEditabile) {
		super(name, "lista_dati_discussione_prima_convocazione");
	...
	public void setGridFields(ListGridField... fields) {		
		setGridFields("lista_dati_discussione_prima_convocazione", fields);
	}
	...
	public void onClickRefreshListButton() {
		...
		lGWTRestDataSource.call(lRecord, new ServiceCallback<Record>() {
			...
			public void execute(Record object) {
				RecordList recordList = object.getAttributeAsRecordList("listaDatiDiscPrimaConvPresenzeAppelloIniziale");
				setData(recordList);
			}
		});
	}
