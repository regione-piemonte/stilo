...
package it.eng.auriga.ui.module.layout.client.proposteOrganigramma.proposteOrgInIter;
...
public class ProposteOrganigrammaInIterFilter extends ConfigurableFilter {

	private String lista;
	private Map<String, List<String>> toClear;

	public ProposteOrganigrammaInIterFilter(String lista) {
		super(lista);
		setWidth(750);
	}
	...
	public void createFilteredSelectItem(final FilterFieldBean pFilterFieldBean, DataSourceField pDataSourceField) {
		...
		for (FilterFieldBean lFilterFieldBean : Layout.getFilterConfig("proposte_organigramma_in_iter").getFields()){
