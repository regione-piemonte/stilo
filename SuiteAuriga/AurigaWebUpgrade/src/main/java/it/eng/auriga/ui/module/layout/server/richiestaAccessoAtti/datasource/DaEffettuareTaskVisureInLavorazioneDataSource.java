...
@Datasource(id="DaEffettuareTaskVisureInLavorazioneDataSource")
public class DaEffettuareTaskVisureInLavorazioneDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
