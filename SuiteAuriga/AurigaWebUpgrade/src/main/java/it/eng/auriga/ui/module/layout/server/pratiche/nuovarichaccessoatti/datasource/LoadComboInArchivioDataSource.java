...
@Datasource(id="LoadComboInArchivioDataSource")
public class LoadComboInArchivioDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("NOME|*|ARCHIVIO_PRES_CARTACEO_PRATICA_RICHIESTA_ACCESSO_ATTI");
