...
package it.eng.auriga.ui.module.layout.server.common.filter.datasource;
...
@Datasource(id = "LoadComboValoriDizionarioMultiFilterDataSource")
public class LoadComboValoriDizionarioMultiFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		if(StringUtils.isNotBlank(dictionaryEntry)) {
			...
			lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("ID_USER_LAVORO|*|" + idUserLavoro + "|*|DICTIONARY_ENTRY|*|" + dictionaryEntry + "|*|FLG_SELECT_MULTI|*|1");
