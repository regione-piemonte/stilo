...
package it.eng.auriga.ui.module.layout.client.gestioneAutotuteleCed;
...
public class RichiesteAutotuteleCedPersonaliLayout extends CustomLayout {
	...
	public RichiesteAutotuteleCedPersonaliLayout(String nomeEntita) {
		this(nomeEntita, null, null, null);
	}

	public RichiesteAutotuteleCedPersonaliLayout(String nomeEntita, String finalita) {
		this(nomeEntita, finalita, null, null);
	}

	public RichiesteAutotuteleCedPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola) {
		this(nomeEntita, finalita, flgSelezioneSingola, null);
	}

	public RichiesteAutotuteleCedPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, new GWTRestDataSource("RichiesteAutotuteleCedPersonaliDatasource", "idProcedimento", FieldType.TEXT), 
				new RichiesteAutotuteleCedPersonaliFilter(nomeEntita), 
				new RichiesteAutotuteleCedPersonaliList(nomeEntita), 
				new RichiesteAutotuteleCedPersonaliDetail(nomeEntita), finalita, flgSelezioneSingola, showOnlyDetail);
		...
		if (togliDalLibroFirmaAttoMultiButton == null) {
			togliDalLibroFirmaAttoMultiButton = new MultiToolStripButton("attiInLavorazione/togliLibroFirma.png", this, "Togli dal libro firma", false) {
				...
				public void doSomething() {
					...
					try {
						lGwtRestDataSource.executecustom("togliDaLibroFirmaDaProcedimentiPersonali", record, new DSCallback() {
	...
	private void continuaMandaAlLibroFirmaAttoMultiButton(final RecordList listaRecord) {
		...
		GWTRestDataSource lGwtRestDataSource = new GWTRestDataSource("AzioniLibroFirmaDataSource");
		try {
			lGwtRestDataSource.executecustom("mandaALibroFirmaDaProcedimentiPersonali", record, new DSCallback() {
