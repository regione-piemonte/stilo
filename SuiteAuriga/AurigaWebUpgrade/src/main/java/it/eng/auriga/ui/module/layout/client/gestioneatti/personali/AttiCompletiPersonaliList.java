...
/**
 * Definisce la lista dei campi per la vista sugli atti personali completi
 * 
 * @author Dancrist
 *
 */
public class AttiCompletiPersonaliList extends AttiCompletiList {
	...
	public AttiCompletiPersonaliList(String nomeEntita) {
		...
		buildDataInvioApprovazioneazioneDG();
	...
	private void buildTipoAtto() {
		tipoAtto = new ListGridField("tipoAtto", I18NUtil.getMessages().atti_personali_completi_list_tipoAtto());
		tipoAtto.setWidth(100);
		tipoAtto.setAlign(Alignment.LEFT);
	}

	private void buildDataAvvio() {
		dataAvvio = new ListGridField("dataAvvio", I18NUtil.getMessages().atti_personali_completi_list_dataAvvio());
	...
	private void buildNumeroProposta() {
		numeroProposta = new ListGridField("ordinamentoNumeroProposta", I18NUtil.getMessages().atti_personali_completi_list_ordinamentoNumeroProposta());
	...
	private void buildNumeroAtto() {
		numeroAtto = new ListGridField("ordinamentoNumeroAtto", I18NUtil.getMessages().atti_personali_completi_list_ordinamentoNumeroAtto());
	...
	private void buildInFase() {
		inFase = new ListGridField("inFase", I18NUtil.getMessages().atti_personali_completi_list_inFase());
		inFase.setWidth(100);
		inFase.setAlign(Alignment.LEFT);
	}

	private void buildUltimaAttivita() {
		ultimaAttivita = new ListGridField("ultimaAttivita", I18NUtil.getMessages().atti_personali_completi_list_ultimaAttivita());
		ultimaAttivita.setWidth(100);
		ultimaAttivita.setAlign(Alignment.LEFT);
	}
	
	private void buildUltimaAttivitaEsito() {
		ultimaAttivitaEsito = new ListGridField("ultimaAttivitaEsito", I18NUtil.getMessages().atti_personali_completi_list_ultimaAttivitaEsito());
	...
	private void buildUltimaAttivitaMessaggio() {
		ultimaAttivitaMessaggio = new ListGridField("ultimaAttivitaMessaggio", I18NUtil.getMessages().atti_personali_completi_list_ultimaAttivitaMessaggio());
		ultimaAttivitaMessaggio.setWidth(100);
		ultimaAttivitaMessaggio.setAlign(Alignment.LEFT);
	}

	private void buildDataAtto() {
		dataAtto = new ListGridField("dataAtto", I18NUtil.getMessages().atti_personali_completi_list_dataAtto());
	...
	private void buildOggetto() {
		oggetto = new ListGridField("oggetto", I18NUtil.getMessages().atti_personali_completi_list_oggetto());
		oggetto.setWidth(100);
		oggetto.setAlign(Alignment.LEFT);
	}

	private void buildUnOrgProponente() {
		unOrgProponente = new ListGridField("unOrgProponente", I18NUtil.getMessages().atti_personali_completi_list_unOrgProponente());
	...
	private void buildUoCompetente() {
		uoCompetente = new ListGridField("uoCompetente", I18NUtil.getMessages().atti_personali_completi_list_uoCompetente());
	...
	private void buildAvviatoDa() {
		avviatoDa = new ListGridField("avviatoDa", I18NUtil.getMessages().atti_personali_completi_list_avviatoDa());
		avviatoDa.setWidth(100);
		avviatoDa.setAlign(Alignment.LEFT);
	}

	private void buildDataInvioVerificaContabile(){
		dataInvioVerificaContabile = new ListGridField("dataInvioVerificaContabile", I18NUtil.getMessages().atti_personali_completi_list_dataInvioVerificaContabile());
	...
	private void buildProssimeAttivita() {
		prossimeAttivita = new ListGridField("prossimeAttivita", I18NUtil.getMessages().atti_personali_completi_list_prossimeAttivita());
	...
	private void buildAssegnatario() {
		assegnatario = new ListGridField("assegnatario", I18NUtil.getMessages().atti_personali_completi_list_assegnatario());
	}
	...
	private void buildCodiceCIG() {
		codiceCIG = new ListGridField("codiceCIG", I18NUtil.getMessages().atti_personali_completi_list_codiceCIG());
	}
	
	private void buildNominativi() {
		nominativi = new ListGridField("nominativi", I18NUtil.getMessages().atti_personali_completi_list_nominativi());
	}
	
	private void buildParolaChiave() {
		parolaChiave = new ListGridField("parolaChiave", I18NUtil.getMessages().atti_personali_completi_list_parolaChiave());
	}
	
	private void buildIniziativa() {
		iniziativa = new ListGridField("iniziativa", I18NUtil.getMessages().atti_personali_completi_list_iniziativa());
	}
	
	private void buildFlgRilevanzaContabile() {
		flgRilevanzaContabile = new ListGridField("flgRilevanzaContabile", I18NUtil.getMessages().atti_personali_completi_list_flgRilevanzaContabile());
	...
	private void buildTipoDettaglio() {
		tipoDettaglio = new ListGridField("tipoDettaglio", I18NUtil.getMessages().atti_personali_completi_list_tipoDettaglio());
	}
	
	private void buildCodTipo() {
		codTipo = new ListGridField("codTipo", I18NUtil.getMessages().atti_personali_completi_list_codTipo());
	}
	
	private void buildFlgImmEseguibile() {
		flgImmEseguibile = new ListGridField("flgImmEseguibile", I18NUtil.getMessages().atti_personali_completi_list_flgImmEseguibile());
	...
	private void buildStato() {
		stato = new ListGridField("stato", I18NUtil.getMessages().atti_personali_completi_list_stato());
	}
	
	private void buildDataPrimoInoltroRagioneria(){
		dataPrimoInoltroRagioneria = new ListGridField("dataPrimoInoltroRagioneria", I18NUtil.getMessages().atti_personali_completi_list_dataPrimoInoltroRagioneria());
	...
	private void buildNroInoltriRagioneria() {
		nroInoltriRagioneria = new ListGridField("nroInoltriRagioneria", I18NUtil.getMessages().atti_personali_completi_list_nroInoltriRagioneria());
	}
	
	private void buildStatoRagioneria() {
		statoRagioneria = new ListGridField("statoRagioneria", I18NUtil.getMessages().atti_personali_completi_list_statoRagioneria());
	...
	private void buildCentroDiCosto() {
		centroDiCosto = new ListGridField("centroDiCosto", I18NUtil.getMessages().atti_personali_completi_list_centroDiCosto());		
		if(!AurigaLayout.isAttivoClienteCOTO()) {
	...
	private void buildDataScadenza(){
		dataScadenza = new ListGridField("dataScadenza", I18NUtil.getMessages().atti_personali_completi_list_dataScadenza());
	...
	private void buildOrdinativi() {
		ordinativi = new ListGridField("ordinativi", I18NUtil.getMessages().atti_personali_completi_list_ordinativi());		
		if(!AurigaLayout.getParametroDBAsBoolean("ATTIVO_ITER_LIQUIDAZIONI")) {
	...
	private void buildFlgVisionato() {
		flgVisionato = new ListGridField("flgVisionato", I18NUtil.getMessages().atti_personali_completi_list_flgVisionato());
	...
	private void buildTagApposti() {
		tagApposti = new ListGridField("tagApposti", I18NUtil.getMessages().atti_personali_completi_list_tagApposti());		
	}
	...
	private void buildNrAttoStruttura() {
		nrAttoStruttura = new ListGridField("nrAttoStruttura", I18NUtil.getMessages().atti_personali_list_nrAttoStruttura());
	}
	
	private void buildLiqContestuale() {
		nrLiqContestuale = new ListGridField("nrLiqContestuale", I18NUtil.getMessages().atti_personali_list_nrLiqContestuale());
	}
	
	private void buildDataInvioApprovazioneazioneDG(){
		
		dataInvioApprovazioneDG = new ListGridField("dataInvioApprovazioneDG", I18NUtil.getMessages().atti_personali_list_dataInvioApprovazioneDG());
	...
	private void buildFlgPresentiEmendamenti() {
		flgPresentiEmendamenti = new ListGridField("flgPresentiEmendamenti", I18NUtil.getMessages().atti_personali_list_flgPresentiEmendamenti());
	...
	private void buildProgrammazioneAcquistiField() {
		programmazioneAcquisti = new ListGridField("programmazioneAcquisti", I18NUtil.getMessages().atti_personali_list_programmazioneAcquisti());
	}
	
	private void buildCuiField() {
		cui = new ListGridField("cui", I18NUtil.getMessages().atti_personali_list_cui());
	}
	
	private void buildAssegnatarioUffAcquistiField() {
		assegnatarioUffAcquisti = new ListGridField("assegnatarioUffAcquisti", I18NUtil.getMessages().atti_personali_list_assegnatarioUffAcquisti());
	}
