...
@Datasource(id="LoadComboDichiarazioneVotiDataSource")
public class LoadComboDichiarazioneVotiDataSource extends AbstractFetchDataSource<DichiarazioneVotiSelectOdgXmlBean> {
	...
	public PaginatorBean<DichiarazioneVotiSelectOdgXmlBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("COMPONENTI_SEDUTA_COMMISSIONE");
