...
public abstract class FirmaCertificatoWindow extends AppletWindow {
	...
	public FirmaCertificatoWindow(String appletTipoFirmaAtti, boolean firmaAvanzamentoIterAtti, boolean abilGestFirmaAllegatiFirmatiPIAtto, Map<String, Record> files, boolean pSkipCtrlBustaFirm, String pin, String firmatario, String alias, String metodoFirma) {
