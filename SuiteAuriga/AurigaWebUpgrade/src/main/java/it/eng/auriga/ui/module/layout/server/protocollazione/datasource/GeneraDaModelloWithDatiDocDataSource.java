...
@Datasource(id = "GeneraDaModelloWithDatiDocDataSource")
public class GeneraDaModelloWithDatiDocDataSource extends AbstractDataSource<GeneraDaModelloBean, GeneraDaModelloBean> {

	private static Logger mLogger = Logger.getLogger(GeneraDaModelloWithDatiDocDataSource.class);
