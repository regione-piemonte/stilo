...
public class ProposteOrganigrammaPersonaliList extends CustomList {
...
//	private ListGridField flgPresenzaProcedimentiField;
	...
	public ProposteOrganigrammaPersonaliList(String nomeEntita) {
		super(nomeEntita);
		...
		estremiProcedimentoField                = new ListGridField("estremiProcedimento",              I18NUtil.getMessages().procedimenti_personali_list_estremiProcedimentoField());             
...
//		});
		...
		ultimoTaskProcedimentoField             = new ListGridField("ultimoTaskProcedimento",           I18NUtil.getMessages().procedimenti_personali_list_ultimaAttivitaField());
		messaggioUltimoTaskProcedimentoField    = new ListGridField("messaggioUltimoTaskProcedimento",  I18NUtil.getMessages().procedimenti_personali_list_ultimaAttivitaMessaggioField());
//		noteProcedimentoField                   = new ListGridField("noteProcedimento",                 I18NUtil.getMessages().procedimenti_personali_list_noteProcedimentoField());
//		nominativiProcedimentoField             = new ListGridField("nominativiProcedimento",           I18NUtil.getMessages().procedimenti_personali_list_nominativiProcedimentoField());
//		assegnatarioProcedimentoField           = new ListGridField("assegnatarioProcedimento",         I18NUtil.getMessages().procedimenti_personali_list_assegnatarioProcedimentoField());
...
//		dataPresentazioneProcedimentoField      = new ListGridField("dataPresentazione",                I18NUtil.getMessages().procedimenti_personali_list_dataPresentazioneField());      
...
//		tipiTributoField                        = new ListGridField("tipiTributo",                      I18NUtil.getMessages().procedimenti_personali_list_tipiTributoField());
//		anniTributoField                        = new ListGridField("anniTributo",                      I18NUtil.getMessages().procedimenti_personali_list_anniTributoField());
//		attiRiferimentoField                    = new ListGridField("attiRiferimento",                  I18NUtil.getMessages().procedimenti_personali_list_attiRiferimentoField());
		
//		flgPresenzaProcedimentiField = new ListGridField("flgPresenzaProcedimenti", I18NUtil.getMessages().procedimenti_personali_list_flgPresenzaProcedimentiField());
...
//					return I18NUtil.getMessages().procedimenti_personali_flgPresenzaProcedimenti_1_value();
//				}				
//				return null;
//			}
//		});
