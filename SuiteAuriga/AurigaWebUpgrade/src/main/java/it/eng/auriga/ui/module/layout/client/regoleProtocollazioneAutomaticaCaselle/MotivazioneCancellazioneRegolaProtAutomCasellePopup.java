...
public abstract class MotivazioneCancellazioneRegolaProtAutomCasellePopup extends ModalWindow {
	
	protected MotivazioneCancellazioneRegolaProtAutomCasellePopup window;
	...
	public MotivazioneCancellazioneRegolaProtAutomCasellePopup(String title) {
		
		super("motivazione_cancellazione_regola_protocollazione_auomatica_popup", true);
		window = this;
        setTitle(title);
		setAutoCenter(true);
		...
		setHeight(220);
		setWidth(530);
		setIcon("buttons/revoca_atto.png");
	...
	protected void createForm(){
		...
		// Motivazione
		motivazioneItem = new TextAreaItem("motivoCancellazione");		
