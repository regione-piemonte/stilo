...
@Datasource(id="LoadComboDelegatoConferenzaSedutaDataSource")
public class LoadComboDelegatoConferenzaSedutaDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(LoadComboDelegatoConferenzaSedutaDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("DELEGATI_CONFERENZA");
