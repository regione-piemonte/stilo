...
public abstract class AssegnazioneVisurePopup extends ModalWindow {
	
	protected AssegnazioneVisurePopup _window;
	...
	public AssegnazioneVisurePopup(RecordList recordList){
		
		super("assegnazione_visure", true);
		
		_window = this;
		
		Record record = (recordList.getLength() == 1) ? recordList.get(0) : null;
		String estremiProcedimento = (record != null && record.getAttribute("documentoInizialeProcedimento") != null) ? "visura SUE richiesta " + record.getAttribute("documentoInizialeProcedimento") : "";
		String title = null;
		...
		String listaIdProcessType = getListaIdProcessType(recordList);
