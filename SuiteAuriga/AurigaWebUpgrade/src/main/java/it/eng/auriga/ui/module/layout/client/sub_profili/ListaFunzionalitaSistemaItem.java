...
import it.eng.auriga.ui.module.layout.client.listaFunzionalita.LookupListaFunzionalitaPopup;
...
public class ListaFunzionalitaSistemaItem extends GridItem {
	
	protected ListaFunzionalitaSistemaItem instance = this;
	...
	public ListaFunzionalitaSistemaItem(String name) {
		
		super(name, "sub_profili_lista_funzionalita_sistema");
		...
		// Opzioni Abilitazioni a Funzionalità del sistema
		listaPrivilegiValueMap.put("FC", I18NUtil.getMessages().sub_profili_abilitazioni_F_FC_value());
		listaPrivilegiValueMap.put("M", I18NUtil.getMessages().sub_profili_abilitazioni_F_M_value());
		listaPrivilegiValueMap.put("I", I18NUtil.getMessages().sub_profili_abilitazioni_F_I_value());
	...
	public List<ToolStripButton> buildCustomEditButtons() {
		...
		addButton.setPrefix("Abilitazioni a funzioni");
		addButton.setPrompt("Abilitazioni a funzioni");
		
		final String finalita = "sub_profili_lista_funzionalita_sistema";
	...
	public void onClickAddButton(String finalita, Boolean flgSelezioneSingola) {
		LookupListaFunzionalita lookupListaFunzionalita = new LookupListaFunzionalita(finalita, flgSelezioneSingola);
		lookupListaFunzionalita.show();
	}
	
	public class LookupListaFunzionalita extends LookupListaFunzionalitaPopup {

		public LookupListaFunzionalita(String finalita, Boolean flgSelezioneSingola) {
	...
	public void setValuesFromRecord(Record record) {
		...
		recordToInsert.setAttribute("idOggettoPriv",            record.getAttribute("codice"));
		recordToInsert.setAttribute("codiceOggettoPriv",        record.getAttribute("codice"));
	...
	protected static GWTRestDataSource getLoadComboPrivilegiDatasource() {
		GWTRestDataSource loadComboPrivilegiDS = new GWTRestDataSource("LoadComboPrivilegiFunzionalitaSistemaDataSource");
