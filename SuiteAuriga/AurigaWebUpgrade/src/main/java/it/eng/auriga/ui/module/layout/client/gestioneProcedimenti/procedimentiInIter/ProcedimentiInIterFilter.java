...
public class ProcedimentiInIterFilter extends ConfigurableFilter {

	private String lista;
	private Map<String, List<String>> toClear;

	public ProcedimentiInIterFilter(String lista) {
		super(lista);
		setWidth(750);
	}
	...
	public void createFilteredSelectItem(final FilterFieldBean pFilterFieldBean, DataSourceField pDataSourceField) {
		...
		for (FilterFieldBean lFilterFieldBean : Layout.getFilterConfig("procedimenti_in_iter").getFields()){
