...
@Datasource(id="LoadComboTipologiaMotivazioneVisuraSUEInIterDataSource")
public class LoadComboTipologiaMotivazioneVisuraSUEInIterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|MOTIVO_RICH_VISURE_SUE|*|ID_USER_LAVORO|*|"  + idUserLavoro);
