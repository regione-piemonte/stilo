...
public class DichiarazioneDiVotoArgomentoWindow extends ModalWindow {
	
	protected DichiarazioneDiVotoArgomentoWindow window;
	protected DichiarazioneDiVotoArgomentoDetail detail;	
	protected ToolStrip detailToolStrip;

	public DichiarazioneDiVotoArgomentoWindow(String nomeEntita, String title, final Record record, String tipologiaSessione) {
		...
		detail = new DichiarazioneDiVotoArgomentoDetail(nomeEntita, tipologiaSessione, record.getAttributeAsString("idSeduta"));	
		...
		setIcon("delibere/dichiarazioni_di_voto.png");	
	}
	...
	public void saveData(Record record) {
		...
		record.setAttribute("flgPresenzeVotiIn", "V");
