...
@Datasource(id = "LoadComboRegistroTipoRifFilterDataSource")
public class LoadComboRegistroTipoRifFilterDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {
	
	private static Logger mLogger = Logger.getLogger(LoadComboRegistroTipoRifFilterDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|REGISTRO_TIPO_RIF_UD|*|ID_USER_LAVORO|*|"  + idUserLavoro);
