...
@Datasource(id="LoadComboUtenteRifAttoConsiglioDataSource")
public class LoadComboUtenteRifAttoConsiglioDataSource extends AbstractFetchDataSource<SimpleKeyValueBean> {
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria,
		...
		lDmpkLoadComboDmfn_load_comboBean.setTipocomboin("USER_RIF_ATTO_CONSIGLIO");
