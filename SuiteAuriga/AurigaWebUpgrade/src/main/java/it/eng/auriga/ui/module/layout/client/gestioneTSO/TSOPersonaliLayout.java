...
public class TSOPersonaliLayout extends CustomLayout {
	
	protected MultiToolStripButton assegnazioneMultiButton;

	public TSOPersonaliLayout(String nomeEntita) {
		this(nomeEntita, null, null, null);
	}

	public TSOPersonaliLayout(String nomeEntita, String finalita) {
		this(nomeEntita, finalita, null, null);
	}

	public TSOPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola) {
		this(nomeEntita, finalita, flgSelezioneSingola, null);
	}

	public TSOPersonaliLayout(String nomeEntita, String finalita, Boolean flgSelezioneSingola, Boolean showOnlyDetail) {
		super(nomeEntita, 
				new GWTRestDataSource("TSOPersonaliDatasource", "idProcedimento", FieldType.TEXT), 
				new TSOPersonaliFilter(nomeEntita),
				new TSOPersonaliList(nomeEntita), 
