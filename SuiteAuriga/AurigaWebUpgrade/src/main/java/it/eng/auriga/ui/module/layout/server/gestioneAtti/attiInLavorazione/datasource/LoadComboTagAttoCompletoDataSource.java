...
@Datasource(id="LoadComboTagAttoCompletoDataSource")
public class LoadComboTagAttoCompletoDataSource extends OptionFetchDataSource<TagItemLavorazioneBean> {
	...
	public PaginatorBean<TagItemLavorazioneBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		lDmpkLoadComboDmfn_load_comboBean.setAltriparametriin("DICTIONARY_ENTRY|*|TAG_ATTI|*|ID_USER_LAVORO|*|"  + idUserLavoro);
