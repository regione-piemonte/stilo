...
@Datasource(id = "LoadComboStatoDettFolderDataSource")
public class LoadComboStatoDettFolderDataSource extends OptionFetchDataSource<SimpleKeyValueBean> {

	private static Logger mLogger = Logger.getLogger(LoadComboStatoDettFolderDataSource.class);
	...
	public PaginatorBean<SimpleKeyValueBean> fetch(AdvancedCriteria criteria, Integer startRow, Integer endRow, List<OrderByBean> orderby) throws Exception {
		...
		String altriParametri = "NOME_TABELLA|*|DMT_FOLDER|*|NOME_COL_TABELLA|*|COD_STATO_DETT|*|ID_USER_LAVORO|*|" + idUserLavoro;
