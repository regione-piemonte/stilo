...
public abstract class LookupProcedimentiPopup extends ModalWindow {

	private LookupProcedimentiPopup _window;
	
	private AnagrafeProcedimentiLayout portletLayout;
	
	public LookupProcedimentiPopup(String finalita, Boolean flgSelezioneSingola) {
		
		super("lookup_tipo_processo_procedimento", true);
		
		setTitle(getWindowTitle());  	
		
		_window = this;
			
		portletLayout = new AnagrafeProcedimentiLayout(finalita, flgSelezioneSingola) {
        ...
        setIcon("menu/anagrafe_procedimenti.png");
	}
	
	public String getWindowTitle() {
		return I18NUtil.getMessages().anagrafe_procedimenti_lookupProcedimentiPopup_title();
	}
