...
public class OrganigrammaCanvas extends ReplicableCanvas {
	...
	private CheckboxItem flgIncludiScrivanieItem;
	private ReplicableCanvasForm mDynamicForm;

	public OrganigrammaCanvas(OrganigrammaItem item) {
		super(item);
	}
	...
	public void disegna() {
		...
		codRapidoItem.addChangedBlurHandler(new ChangedHandler() {
			...
			public void onChanged(ChangedEvent event) {
				...
				mDynamicForm.setValue("flgIncludiScrivanie", false);
		...
		SelectGWTRestDataSource organigrammaDS = ((OrganigrammaItem) getItem()).getOrganigrammaDataSource();
...
//				}								
		...
		flgIncludiSottoUOItem = new CheckboxItem("flgIncludiSottoUO", "sotto-UO");
		flgIncludiSottoUOItem.setColSpan(1);
		flgIncludiSottoUOItem.setWidth(50);
		flgIncludiSottoUOItem.setShowIfCondition(new FormItemIfFunction() {

			@Override
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				boolean showCheckIncludiSottoUO = ((OrganigrammaItem) getItem()).getShowCheckIncludi()
						&& ((OrganigrammaItem) getItem()).getTipoAssegnatari().contains("UO");
				return showCheckIncludiSottoUO && mDynamicForm.getValueAsString("typeNodo") != null && "UO".equals(mDynamicForm.getValueAsString("typeNodo"));
			}
		});

		flgIncludiScrivanieItem = new CheckboxItem("flgIncludiScrivanie", "scrivanie");
		flgIncludiScrivanieItem.setColSpan(1);
		flgIncludiScrivanieItem.setWidth(50);
		flgIncludiScrivanieItem.setShowIfCondition(new FormItemIfFunction() {

			@Override
			public boolean execute(FormItem item, Object value, DynamicForm form) {
				boolean showCheckIncludiScrivanie = ((OrganigrammaItem) getItem()).getShowCheckIncludi()
						&& ((OrganigrammaItem) getItem()).getTipoAssegnatari().contains("SV");
				return showCheckIncludiScrivanie && mDynamicForm.getValueAsString("typeNodo") != null && "UO".equals(mDynamicForm.getValueAsString("typeNodo"));
			}
		});
		...
		mDynamicForm.setFields(idUoHiddenItem, typeNodoHiddenItem, codRapidoItem, descrizioneHiddenItem, lookupOrganigrammaButton, spacer, organigrammaItem,
				flgIncludiSottoUOItem, flgIncludiScrivanieItem);

		mDynamicForm.setNumCols(16);
		mDynamicForm.setColWidths("10", "10", "10", "10", "10", "10", "10", "10", "10", "10", "10", "10", "10", "10", "*", "*");
	...
	public void editRecord(Record record) {
		...
		GWTRestDataSource organigrammaDS = (GWTRestDataSource) organigrammaItem.getOptionDataSource();
		if (record.getAttribute("organigramma") != null && !"".equals(record.getAttributeAsString("organigramma"))) {
			organigrammaDS.addParam("ciToAdd", record.getAttributeAsString("organigramma"));
		} else {
			organigrammaDS.addParam("ciToAdd", null);
		}
		organigrammaItem.setOptionDataSource(organigrammaDS);
	...
	public void setFormValuesFromRecord(Record record) {
		...
		mDynamicForm.setValue("descrizione", record.getAttribute("descrUoSvUt"));
	...
	public class OrganigrammaLookupOrganigramma extends LookupOrganigrammaPopup {
		...
		public OrganigrammaLookupOrganigramma(Record record) {
			super(record, true, ((OrganigrammaItem) getItem()).getFlgIncludiUtenti());
		}
