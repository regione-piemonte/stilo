...
public class SelectItem extends FormItem implements PickList, com.smartgwt.client.widgets.form.fields.events.HasDataArrivedHandlers {
	...
	private SelectItem _this = this;//TODO AURIGA
	...
	public static SelectItem getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if (existingObj instanceof SelectItem) {
            ...
            // return (SelectItem)existingObj;//TODO AURIGA
            //TODO AURIGA START
         	SelectItem ret = (SelectItem)existingObj;
         	TabletUtility.addTabletWorkAround(ret);
         	return ret;
         	//TODO AURIGA END
        } else
    ...
    public SelectItem(){
		...
		TabletUtility.addTabletWorkAround(this);//TODO AURIGA
    }
...
//------------------- end PickList -------
    ...
    //TODO AURIGA START
	public void setTabletMode(boolean mode) {
		setAttribute("tabletMode", mode);
	}

	public void setAltezzaSettata(boolean flag) {
		setAttribute("altezzaSettata", flag);
	}

	public boolean getAltezzaSettata() {
		return getAttributeAsBoolean("altezzaSettata");
	}

	public void setAltezzaPicklist(int altezza) {
		setAttribute("altezzaPicklist", altezza);
	}

	public int getAltezzaPicklist() {
		if (getAttribute("altezzaPicklist") != null) {
			return getAttributeAsInt("altezzaPicklist");
		} else {
			return 0;
		}
	}
	...
	public void setValueMap(Map valueMap) {
		super.setValueMap(valueMap != null ? valueMap : new HashMap());
		if ((TabletUtility.detectIfAndroidTablet()) && (valueMap != null)) {
			TabletUtility.resizeForAndroid(this, valueMap.size());
		}
	}
	...
	public void setValueMap(String... valueMap) {
		...
		if ((TabletUtility.detectIfAndroidTablet()) && (valueMap != null)) {
			TabletUtility.resizeForAndroid(this, valueMap.length);
		}
	}
	//TODO AURIGA END
