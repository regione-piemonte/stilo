...
<body id="body">
	...
	<%
	String nomeEntita = request.getParameter("nomeEntita") != null ? request.getParameter("nomeEntita") : "";
	String schema = request.getParameter("schema") != null ? request.getParameter("schema") : "";
	String useridappl = request.getParameter("userid") != null ? request.getParameter("userid") : "";
	String password = request.getParameter("password") != null ? request.getParameter("password") : "";
	String listaFatture = request.getParameter("listaFatture") != null ? request.getParameter("listaFatture") : "";
	String callbackUrl = request.getParameter("callbackUrl") != null ? request.getParameter("callbackUrl") : "";
	String closeCallbackUrl = request.getParameter("closeCallbackUrl") != null ? request.getParameter("closeCallbackUrl") : "";
	String showCloseButton = request.getParameter("showCloseButton") != null ? request.getParameter("showCloseButton") : "";
	%>
	var params = {
		schema:'<%=schema%>',
		useridappl:'<%=useridappl%>',
		password:'<%=password%>',
