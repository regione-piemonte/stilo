...
/**
 * DmvSocietaId generated by hbm2java
 */
@Embeddable
public class DmvSocietaId implements java.io.Serializable {

	private static final long serialVersionUID = 9020016315909156506L;
	...
	public DmvSocietaId(BigDecimal idSpAoo, String ciApplicazione, String ciIstanzaApplicazione) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DmvSocietaId))
			return false;
		DmvSocietaId castOther = (DmvSocietaId) other;
	...
	public String toString() {
		return String.format("DmvSocietaId [idSpAoo=%s, ciApplicazione=%s, ciIstanzaApplicazione=%s]", idSpAoo, ciApplicazione,
