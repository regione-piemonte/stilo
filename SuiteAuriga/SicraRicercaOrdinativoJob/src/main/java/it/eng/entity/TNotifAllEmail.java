...
@Entity
@Table(name = "T_NOTIF_ALL_EMAIL")
public class TNotifAllEmail implements Serializable {
	...
	public TNotifAllEmail() {
		
	}
	
	public TNotifAllEmail(BigDecimal idRichNotAll, String idRichNotifica, BigDecimal idSpAoo, 
