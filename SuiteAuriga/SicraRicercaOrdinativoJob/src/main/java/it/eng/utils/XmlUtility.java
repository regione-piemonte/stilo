...
public class XmlUtility {
	...
	public static Richiesta xmlToBean(String xml) {
		Richiesta result = new Richiesta();
		
		try {
			JAXBContext jaxbContext = JAXBContext.newInstance(Richiesta.class);
			
			StringReader reader = new StringReader(xml);
			
			Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
			result = (Richiesta) jaxbUnmarshaller.unmarshal(reader);
