 ...
 *
 */
@Job(type = "CodaEXportJob_ATM2BU")
@Named
public class CodaEXportJob_ATM2BU extends AbstractJob<String> {
	private static final String fruitore="ATM2BU";
	private static final String JOB_CLASS_NAME = CodaEXportJob_ATM2BU.class.getName();
