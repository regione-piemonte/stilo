...
public class StorageRetriever {
	...
	/**
	 * Esegue il retrieve del file dallo storage utilizzato. Se non è stato possibile ottenere questo file dallo storage allora viene stampata e successivamente
	 * lanciata un'eccezione a riguardo
	 * 
	 * @param uri
	 *            uri del file da prelevare
	 * @return il file desiderato nel caso sia andato tutto a buon fine
	 * @throws AurigaJobException
	 *             se non è stato possibile risolvere lo storage oppure se non è stato possibile ottenere tale file
	 */
	public static File retrieveFile(String uri) throws AurigaJobException {
		...
		try {
			...
			logger.error("Impossibile ricavare il file dallo storage: ", e);
	...
	/**
	 * Esegue il retrieve del file ma, al contrario del metodo precedente, in modo silenzioso. Se viene generato un errore perchè il file non viene trovato
	 * all'interno dello storage allora viene ritornato il valore null invece di stampare un eccezione
	 * 
	 * @param uri
	 *            uri del file da prelevare
	 * @return il file desiderato nel caso sia andato tutto a buon fine o null in caso contrario
	 * @throws AurigaJobException
	 *             se non è stato possibile risolvere lo storage
	 */
