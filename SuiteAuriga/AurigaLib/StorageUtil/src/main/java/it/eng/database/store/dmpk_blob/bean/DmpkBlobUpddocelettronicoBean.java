 ...
 */
@XmlRootElement
@XmlType(name = "DmpkBlobUpddocelettronicoBean")
public class DmpkBlobUpddocelettronicoBean extends StorageStoreBean implements Serializable{

	private static final String storeName = "DMPK_BLOB_UPDDOCELETTRONICO";
