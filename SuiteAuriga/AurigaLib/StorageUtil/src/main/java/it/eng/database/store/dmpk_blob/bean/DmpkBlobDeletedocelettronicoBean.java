 ...
 */
@XmlRootElement
@XmlType(name = "DmpkBlobDeletedocelettronicoBean")
public class DmpkBlobDeletedocelettronicoBean extends StorageStoreBean implements Serializable{

	private static final String storeName = "DMPK_BLOB_DELETEDOCELETTRONICO";
