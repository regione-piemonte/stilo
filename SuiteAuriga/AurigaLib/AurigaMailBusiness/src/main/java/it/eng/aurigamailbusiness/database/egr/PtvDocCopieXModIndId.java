...
/**
 * PtvDocCopieXModIndId generated by hbm2java
 */
@Embeddable
public class PtvDocCopieXModIndId implements java.io.Serializable {
	...
	public PtvDocCopieXModIndId() {
	}

	public PtvDocCopieXModIndId(int idDoc, String txtOgg, String flgTpProt,
			int uoAss, int uoInCarico, Date dtSped, BigDecimal idTitolazione,
			short nroAlleg) {
		this.idDoc = idDoc;
		this.txtOgg = txtOgg;
	...
	public PtvDocCopieXModIndId(int idDoc, String tpPtg, Short annoPtg,
			...
			int uoAss, int uoInCarico, Date dtSped, Integer idIndice,
			BigDecimal idTitolazione, String rifProv, Date dtProv,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PtvDocCopieXModIndId))
			return false;
		PtvDocCopieXModIndId castOther = (PtvDocCopieXModIndId) other;
