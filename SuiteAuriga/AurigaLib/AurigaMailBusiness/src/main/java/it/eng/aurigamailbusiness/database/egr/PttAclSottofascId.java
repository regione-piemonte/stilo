...
/**
 * PttAclSottofascId generated by hbm2java
 */
@Embeddable
public class PttAclSottofascId implements java.io.Serializable {

	private int idFascicolo;
	private int numSottofasc;

	public PttAclSottofascId() {
	}

	public PttAclSottofascId(int idFascicolo, int numSottofasc) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PttAclSottofascId))
			return false;
		PttAclSottofascId castOther = (PttAclSottofascId) other;
