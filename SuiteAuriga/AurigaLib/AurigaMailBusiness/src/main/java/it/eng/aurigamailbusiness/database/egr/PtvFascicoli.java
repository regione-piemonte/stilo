...
/**
 * PtvFascicoli generated by hbm2java
 */
@Entity
@Table(name = "PTV_FASCICOLI")
public class PtvFascicoli implements java.io.Serializable {

	private PtvFascicoliId id;

	public PtvFascicoli() {
	}

	public PtvFascicoli(PtvFascicoliId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "idIperfasc", column = @Column(name = "ID_IPERFASC", precision = 8, scale = 0)),
	...
	public PtvFascicoliId getId() {
		return this.id;
	}

	public void setId(PtvFascicoliId id) {
		this.id = id;
	}
