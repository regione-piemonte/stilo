...
/**
 * PtvFascDaVersare generated by hbm2java
 */
@Entity
@Table(name = "PTV_FASC_DA_VERSARE")
public class PtvFascDaVersare implements java.io.Serializable {

	private PtvFascDaVersareId id;

	public PtvFascDaVersare() {
	}

	public PtvFascDaVersare(PtvFascDaVersareId id) {
		this.id = id;
	}
	...
	public PtvFascDaVersareId getId() {
		return this.id;
	}

	public void setId(PtvFascDaVersareId id) {
		this.id = id;
	}
