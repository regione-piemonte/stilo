...
// Generated 11-dic-2019 10.07.10 by Hibernate Tools 3.4.0.CR1
...
/**
 * ThEmailMgo generated by hbm2java
 */
@Entity
@Table(name = "TH_EMAIL_MGO", uniqueConstraints = @UniqueConstraint(columnNames = { "MESSAGE_ID", "ID_CASELLA" }))
public class ThEmailMgo implements java.io.Serializable {

	private static final long serialVersionUID = -2702969687354612803L;
	...
	private Date tsStoricizzazione;

	public ThEmailMgo() {
	}

	public ThEmailMgo(String idEmail, String messageId, String idCasella, String categoria, long dimensione,
			String uriEmail, boolean flgUriRicevuta, boolean flgSpam, short nroAllegati, short nroAllegatiFirmati,
			boolean flgEmailFirmata, boolean flgNoAssocAuto, boolean flgRichConferma, boolean flgRichConfLettura,
			boolean flgInviataRisposta, boolean flgInoltrata, boolean flgNotifInteropEcc, boolean flgNotifInteropConf,
			boolean flgNotifInteropAgg, boolean flgNotifInteropAnn, Date tsIns, Date tsUltimoAgg) {
	...
	public ThEmailMgo(String idEmail, String messageId, String messageIdTrasporto, BigDecimal progrMsg,
			BigDecimal annoProgrMsg, String registroProgrMsg, BigDecimal progrBozza, Short annoProgrBozza, String idCasella,
			String flgIo, String categoria, long dimensione, String uriEmail, boolean flgUriRicevuta, boolean flgSpam,
			String flgStatoSpam, String flgRicevutaCbs, String statoConsolidamento, String statoInvio,
			String statoAccettazione, String statoConsegna, String statoLavorazione, Date tsAggStatoLavorazione,
			String idUtenteAggStatoLav, short nroAllegati, short nroAllegatiFirmati, boolean flgEmailFirmata,
			boolean flgNoAssocAuto, String accountMittente, String accountMittenteCtx, String oggetto,
			String oggettoCtx, String corpo, String corpoCtx, String avvertimenti, Date tsLock, String idUtenteLock,
			String idRecDizOperLock, boolean flgRichConferma, boolean flgRichConfLettura, Date tsRicezione,
			...
			boolean flgNotifInteropAnn, Long livPriorita, Date tsLettura, String siglaRegistroMitt, Integer numRegMitt,
			Short annoRegMitt, Date tsRegMitt, String oggettoRegMitt, String oggettoRegMittCtx, String codAzioneDaFare,
			String dettAzioneDaFare, String motivoEccezione, String messageIdRif, String errMessageRicPec,
			String nroRichiestaMassivaInvio, Date tsIns, String idUteIns, Date tsUltimoAgg,
			String idUteUltimoAgg, Date tsStoricizzazione) {
		this.idEmail = idEmail;
		this.messageId = messageId;
		...
		this.tsStoricizzazione = tsStoricizzazione;
	}
	...
	@Column(name = "ANNO_PROGR_MSG", precision = 4, scale = 0)
	...
	@Column(name = "ACCOUNT_MITTENTE", length = 1000)
	...
	@Column(name = "ACCOUNT_MITTENTE_CTX", length = 1000)
	...
	@Column(name = "TS_STORICIZZAZIONE")
	public Date getTsStoricizzazione() {
		return this.tsStoricizzazione;
	}

	public void setTsStoricizzazione(Date tsStoricizzazione) {
		this.tsStoricizzazione = tsStoricizzazione;
	}
