...
/**
 * PttDestIntRegId generated by hbm2java
 */
@Embeddable
public class PttDestIntRegId implements java.io.Serializable {

	private int idDoc;
	private short nroPosiz;

	public PttDestIntRegId() {
	}

	public PttDestIntRegId(int idDoc, short nroPosiz) {
		this.idDoc = idDoc;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PttDestIntRegId))
			return false;
		PttDestIntRegId castOther = (PttDestIntRegId) other;
