...
/**
 * PtvRepertorio generated by hbm2java
 */
@Entity
@Table(name = "PTV_REPERTORIO")
public class PtvRepertorio implements java.io.Serializable {

	private PtvRepertorioId id;

	public PtvRepertorio() {
	}

	public PtvRepertorio(PtvRepertorioId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "dtVersamento", column = @Column(name = "DT_VERSAMENTO", length = 7)),
			...
			@AttributeOverride(name = "uoAcc", column = @Column(name = "UO_ACC", precision = 8, scale = 0)),
			...
			@AttributeOverride(name = "uoConsult", column = @Column(name = "UO_CONSULT", precision = 8, scale = 0)),
			@AttributeOverride(name = "dtPrelievo", column = @Column(name = "DT_PRELIEVO", length = 7)),
			@AttributeOverride(name = "dtRestituzione", column = @Column(name = "DT_RESTITUZIONE", length = 7)),
			@AttributeOverride(name = "flgProcInterr", column = @Column(name = "FLG_PROC_INTERR", length = 1)) })
	public PtvRepertorioId getId() {
		return this.id;
	}

	public void setId(PtvRepertorioId id) {
		this.id = id;
	}
