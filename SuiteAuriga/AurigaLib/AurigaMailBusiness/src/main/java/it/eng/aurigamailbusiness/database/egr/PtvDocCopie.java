...
/**
 * PtvDocCopie generated by hbm2java
 */
@Entity
@Table(name = "PTV_DOC_COPIE")
public class PtvDocCopie implements java.io.Serializable {

	private PtvDocCopieId id;

	public PtvDocCopie() {
	}

	public PtvDocCopie(PtvDocCopieId id) {
		this.id = id;
	}
	...
	public PtvDocCopieId getId() {
		return this.id;
	}

	public void setId(PtvDocCopieId id) {
		this.id = id;
	}
