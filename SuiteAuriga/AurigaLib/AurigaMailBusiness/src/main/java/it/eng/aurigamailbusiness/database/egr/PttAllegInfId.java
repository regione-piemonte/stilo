...
/**
 * PttAllegInfId generated by hbm2java
 */
@Embeddable
public class PttAllegInfId implements java.io.Serializable {

	private int idDoc;
	private short numAlleg;

	public PttAllegInfId() {
	}

	public PttAllegInfId(int idDoc, short numAlleg) {
		this.idDoc = idDoc;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PttAllegInfId))
			return false;
		PttAllegInfId castOther = (PttAllegInfId) other;
