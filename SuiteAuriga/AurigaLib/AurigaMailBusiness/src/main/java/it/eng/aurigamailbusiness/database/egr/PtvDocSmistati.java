...
/**
 * PtvDocSmistati generated by hbm2java
 */
@Entity
@Table(name = "PTV_DOC_SMISTATI")
public class PtvDocSmistati implements java.io.Serializable {

	private PtvDocSmistatiId id;

	public PtvDocSmistati() {
	}

	public PtvDocSmistati(PtvDocSmistatiId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "uteSped", column = @Column(name = "UTE_SPED", nullable = false, precision = 6, scale = 0)),
	...
	public PtvDocSmistatiId getId() {
		return this.id;
	}

	public void setId(PtvDocSmistatiId id) {
		this.id = id;
	}
