...
/**
 * PtvDocCopieId generated by hbm2java
 */
@Embeddable
public class PtvDocCopieId implements java.io.Serializable {
	...
	public PtvDocCopieId() {
	}

	public PtvDocCopieId(int idDoc, String codEnte, String txtOgg,
			int uoInCarico, short nroAlleg) {
		this.idDoc = idDoc;
	...
	public PtvDocCopieId(int idDoc, String codEnte, String tpPtg,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PtvDocCopieId))
			return false;
		PtvDocCopieId castOther = (PtvDocCopieId) other;
