...
/**
 * PtvDocCopieXModInd generated by hbm2java
 */
@Entity
@Table(name = "PTV_DOC_COPIE_X_MOD_IND")
public class PtvDocCopieXModInd implements java.io.Serializable {

	private PtvDocCopieXModIndId id;

	public PtvDocCopieXModInd() {
	}

	public PtvDocCopieXModInd(PtvDocCopieXModIndId id) {
		this.id = id;
	}
	...
	public PtvDocCopieXModIndId getId() {
		return this.id;
	}

	public void setId(PtvDocCopieXModIndId id) {
		this.id = id;
	}
