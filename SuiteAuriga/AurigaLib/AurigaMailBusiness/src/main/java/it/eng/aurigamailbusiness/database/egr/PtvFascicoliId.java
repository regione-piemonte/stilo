...
/**
 * PtvFascicoliId generated by hbm2java
 */
@Embeddable
public class PtvFascicoliId implements java.io.Serializable {
	...
	public PtvFascicoliId() {
	}

	public PtvFascicoliId(int idFascicolo, String codEnte, short anno,
	...
	public PtvFascicoliId(int idFascicolo, String codEnte, short anno,
			...
			String note, Integer idIperfasc, String noteStoria, Integer idProc,
			int uoInCarico, Integer uoAcc, String flgAcc, String flgProcObbl) {
		this.idFascicolo = idFascicolo;
		this.codEnte = codEnte;
		this.anno = anno;
		this.idTitolazione = idTitolazione;
	...
	@Column(name = "ID_IPERFASC", precision = 8, scale = 0)
	public Integer getIdIperfasc() {
		return this.idIperfasc;
	}

	public void setIdIperfasc(Integer idIperfasc) {
		this.idIperfasc = idIperfasc;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PtvFascicoliId))
			return false;
		PtvFascicoliId castOther = (PtvFascicoliId) other;
		...
		return (this.getIdFascicolo() == castOther.getIdFascicolo())
				...
				&& ((this.getIdIperfasc() == castOther.getIdIperfasc()) || (this
						.getIdIperfasc() != null
						&& castOther.getIdIperfasc() != null && this
						.getIdIperfasc().equals(castOther.getIdIperfasc())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIdIperfasc() == null ? 0 : this.getIdIperfasc()
						.hashCode());
		result = 37
				* result
