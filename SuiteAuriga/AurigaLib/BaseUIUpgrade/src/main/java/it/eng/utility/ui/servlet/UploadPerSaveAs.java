...
@Controller
@RequestMapping("/UploadPerSaveAs")
public class UploadPerSaveAs  {

	private StorageService storageService;
	private static Logger logger = Logger.getLogger(UploadPerSaveAs.class);
	...
	public ResponseEntity<String> post(@RequestParam("idSelected") String idSelected,
		...
		try {
			...
			fileSavedPDF = StringEscapeUtils.escapeJava("automaticDownload('" +idSelected+"#"+lStrPath + "');");
