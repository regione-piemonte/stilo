...
public class ExtendedCustomItemFormField extends ExtendedFormItem {

	private CustomItem _owner;
	
	public ExtendedCustomItemFormField(String name, CustomItem lFilterCanvasItem){
		this(name, null, lFilterCanvasItem);
	}
	
	public ExtendedCustomItemFormField(String name, String title, CustomItem lFilterCanvasItem){
		super(name);
		...
		addChangedBlurHandler(new ChangedHandler() {			
			@Override
	...
	public ExtendedCustomItemFormField(FormItem lFormItem){
		super(lFormItem.getJsObj());
	}
	
	// ottavio
	public ExtendedCustomItemFormField(FormItem lFormItem, String title, CustomItem lFilterCanvasItem){
		super(lFormItem.getJsObj());
		if(title != null && !"".equals(title)) {
			setTitle(title);
		} else {
