...
/**
 * FormItem with {@link #addChangedBlurHandler(ChangedHandler)} event
 * 
 * @author Mihai Ile
 * 
 */
...
public class ExtendedFormItem extends FormItem {
	...
	public ExtendedFormItem() {
		super();
	}
	
	public ExtendedFormItem(String name) {		
		super(name);        
    }

    public ExtendedFormItem(JavaScriptObject jsObj) {    	
        super(jsObj);
    }
	...
	private class HandlerRegistrationExtended implements HandlerRegistration {
		...
		private final ExtendedFormItem extendedTextItem;

		public HandlerRegistrationExtended(ExtendedFormItem extendedTextItem, ChangedHandler handler) {
