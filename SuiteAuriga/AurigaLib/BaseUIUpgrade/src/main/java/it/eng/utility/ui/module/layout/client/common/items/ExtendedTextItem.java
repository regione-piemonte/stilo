...
public class ExtendedTextItem extends TextItem {
	...
	public ExtendedTextItem(String name) {
		super(name);
	}

	public ExtendedTextItem(String name, String title) {
		super(name, title);
	}
	...
	private class HandlerRegistrationExtended implements HandlerRegistration {
		...
		private final ExtendedTextItem extendedTextItem;

		public HandlerRegistrationExtended(ExtendedTextItem extendedTextItem, ChangedHandler handler) {
