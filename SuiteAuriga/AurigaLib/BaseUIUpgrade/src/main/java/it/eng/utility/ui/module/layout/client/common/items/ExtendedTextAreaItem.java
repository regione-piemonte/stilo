 ...
 * 
 */
public class ExtendedTextAreaItem extends TextAreaItem {
	...
	public ExtendedTextAreaItem() {
		super();
	}

	public ExtendedTextAreaItem(String name) {
		super(name);
	}

	public ExtendedTextAreaItem(String name, String title) {
		super(name, title);
	}
	...
	private class HandlerRegistrationExtended implements HandlerRegistration {
		...
		private final ExtendedTextAreaItem extendedTextItem;

		public HandlerRegistrationExtended(ExtendedTextAreaItem extendedTextItem, ChangedHandler handler) {
	...
	/**
	 * Add a changed handler fired when the component loses focus (similar to "onchage" from JavaScript).
	 * <p>
	 * Called when the component loses focus and the FormItem's value has been changed as the result of user interaction during the period that it had focus.
	 * 
	 * @param handler
	 *            the changed handler
	 */
	...
	/**
	 * If true, form items will be validated when each item's "changeBlur" handler is fired as well as when the entire form is submitted or validated.
	 * <p>
	 * 
