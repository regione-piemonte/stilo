...
public class ExtendedDateTimeItem extends com.smartgwt.client.widgets.form.fields.DateTimeItem{
	
	private ExtendedDateTimeItem instance;

	public ExtendedDateTimeItem() {
		instance = this;
//		this.setHeight(20);
		this.setWidth(130);
...
//        });
	...
	public ExtendedDateTimeItem(String name) {
		this();
	    setName(name);        
    }

    public ExtendedDateTimeItem(String name, String title) {
    	this();
        setName(name);
		setTitle(title);
    }
