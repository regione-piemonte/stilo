...
import java.util.Arrays;//TODO AURIGA
...
import com.google.gwt.core.client.Scheduler;//TODO AURIGA
import com.google.gwt.core.client.Scheduler.ScheduledCommand;//TODO AURIGA
...
import it.eng.utility.ui.module.layout.client.Layout;//TODO AURIGA
...
public class Window extends VLayout implements com.smartgwt.client.widgets.events.HasCloseClickHandlers, com.smartgwt.client.widgets.events.HasMaximizeClickHandlers, com.smartgwt.client.widgets.events.HasMinimizeClickHandlers, com.smartgwt.client.widgets.events.HasRestoreClickHandlers {
    ...
    public void setTitle(String title) {
        ...
        if (UserInterfaceFactory.isAttivaAccessibilita()){
 			setAttribute("title", "<span class=\"" + it.eng.utility.Styles.titlePortlet + "\"><h4>" + title + "</h4></span>", true);
 		} else {
 			setAttribute("title", "<span class=\"" + it.eng.utility.Styles.titlePortlet + "\">" + title + "</span>", true);
		}
		setAttribute("originalTitle", title, true);
		//TODO AURIGA END
    }
    ...
    public String getTitle()  {
    	// return getAttributeAsString("title");//TODO AURIGA
    	return getAttributeAsString("originalTitle");//TODO AURIGA
    }
		...
		if (Layout.getMessagebox() != null) {
			...
			if(errorslabel == null) {
				errorslabel = new Label(
						"<img src='images/message/error.png' height='14' width='14' style='display:block;' />");
		 		if (UserInterfaceFactory.isAttivaAccessibilita()){
		 			errorslabel.setTabIndex(-1);
					errorslabel.setCanFocus(false);
		 		}
				// errorslabel.setIcon("message/error.png");
				// errorslabel.setIconSize(12);
				errorslabel.setWidth(16);
				...
				errorslabel.setCanHover(true);
				errorslabel.addHoverHandler(new HoverHandler() {
	
					@Override
					public void onHover(HoverEvent event) {
						
						if (Layout.getMessagebox().getErrors().size() > 0) {
							StringBuffer buffer = new StringBuffer();
							buffer.append(
									"<div style=\"margin:5px;\"><img src=\"images/message/error.png\" height=\"20\" width=\"20\" align=\"absmiddle\" />&nbsp;&nbsp;<i>Ultimi messaggi di errore:</i></div>");
							buffer.append("<ul>");
							for (String error : Layout.getMessagebox().getErrors()) {
								buffer.append("<li>" + error + "</li>");
							}
							buffer.append("</ul>");
							errorslabel.setPrompt(buffer.toString());
						} else {
							errorslabel.setPrompt(
									"<div style=\"margin:5px;\"><img src=\"images/message/error.png\" height=\"20\" width=\"20\" align=\"absmiddle\" />&nbsp;&nbsp;<i>Non ci sono messaggi di errore</i></div>");
						}
					}
				});
			}
			...
			if(warningslabel == null) {
				warningslabel = new Label(
					"<img src='images/message/warning.png' height='14' width='14' style='display:block;' />");
				// warningslabel.setIcon("message/warning.png");
				// warningslabel.setIconSize(12);
		 		if (UserInterfaceFactory.isAttivaAccessibilita()){
		 			warningslabel.setTabIndex(-1);
					warningslabel.setCanFocus(false);
		 		}
				warningslabel.setWidth(16);
				...
				warningslabel.setCanHover(true);
				warningslabel.addHoverHandler(new HoverHandler() {
	
					@Override
					public void onHover(HoverEvent event) {
						
						if (Layout.getMessagebox().getWarnings().size() > 0) {
							StringBuffer buffer = new StringBuffer();
							buffer.append(
									"<div style=\"margin:5px;\"><img src=\"images/message/warning.png\" height=\"20\" width=\"20\" align=\"absmiddle\" />&nbsp;&nbsp;<i>Ultimi messaggi di warning:</i></div>");
							buffer.append("<ul>");
							for (String warn : Layout.getMessagebox().getWarnings()) {
								buffer.append("<li>" + warn + "</li>");
							}
							buffer.append("</ul>");
							warningslabel.setPrompt(buffer.toString());
						} else {
							warningslabel.setPrompt(
									"<div style=\"margin:5px;\"><img src=\"images/message/warning.png\" height=\"20\" width=\"20\" align=\"absmiddle\" />&nbsp;&nbsp;<i>Non ci sono messaggi di warning</i></div>");
						}
					}
				});
			}
			...
			if(infoslabel == null) {
				infoslabel = new Label(
					"<img src='images/message/information.png' height='14' width='14' style='display:block;' />");
				// infoslabel.setIcon("message/information.png");
				// infoslabel.setIconSize(12);
		 		if (UserInterfaceFactory.isAttivaAccessibilita()){
		 			infoslabel.setTabIndex(-1);
					infoslabel.setCanFocus(false);
		 		}
				infoslabel.setWidth(16);
				...
				infoslabel.setCanHover(true);
				infoslabel.addHoverHandler(new HoverHandler() {
	
					@Override
					public void onHover(HoverEvent event) {
						
						if (Layout.getMessagebox().getInfos().size() > 0) {
							StringBuffer buffer = new StringBuffer();
							buffer.append(
									"<div style=\"margin:5px;\"><img src=\"images/message/information.png\" height=\"20\" width=\"20\" align=\"absmiddle\" />&nbsp;&nbsp;<i>Ultimi messaggi informativi:</i></div>");
							buffer.append("<ul>");
							for (String info : Layout.getMessagebox().getInfos()) {
								buffer.append("<li>" + info + "</li>");
							}
							buffer.append("</ul>");
							infoslabel.setPrompt(buffer.toString());
						} else {
							infoslabel.setPrompt(
									"<div style=\"margin:5px;\"><img src=\"images/message/information.png\" height=\"20\" width=\"20\" align=\"absmiddle\" />&nbsp;&nbsp;<i>Non ci sono messaggi informativi</i></div>");
						}
					}
				});
			}
			...
			if (headerControls != null) {
				List<Object> headerControlsList = Arrays.asList(headerControls);
				List<Object> newHeaderControlsList = new ArrayList<Object>();
				int pos = -1;
				for (int i = 0; i < headerControlsList.size(); i++) {
					Object headerControl = headerControlsList.get(i);
					newHeaderControlsList.add(headerControl);
					if (headerControl instanceof HeaderControls) {
						String name = ((HeaderControls) headerControl).name();
						if (name != null && name.equals("HEADER_LABEL")) {
							pos = i;
						}
					}
				}
				newHeaderControlsList.add(pos + 1, errorslabel);
				newHeaderControlsList.add(pos + 2, warningslabel);
				newHeaderControlsList.add(pos + 3, infoslabel);
				setAttribute("headerControls", newHeaderControlsList.toArray(new Object[0]), false);
				return;
			}
		}
		//TODO AURIGA END
