...
public class FormItem extends RefDataClass implements com.smartgwt.client.widgets.form.fields.events.HasBlurHandlers, com.smartgwt.client.widgets.form.fields.events.HasChangeHandlers, com.smartgwt.client.widgets.form.fields.events.HasChangedHandlers, com.smartgwt.client.widgets.form.fields.events.HasClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasDoubleClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasEditorEnterHandlers, com.smartgwt.client.widgets.form.fields.events.HasEditorExitHandlers, com.smartgwt.client.widgets.form.fields.events.HasFocusHandlers, com.smartgwt.client.widgets.form.fields.events.HasIconClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasIconKeyPressHandlers, com.smartgwt.client.widgets.form.fields.events.HasItemHoverHandlers, com.smartgwt.client.widgets.form.fields.events.HasKeyDownHandlers, com.smartgwt.client.widgets.form.fields.events.HasKeyPressHandlers, com.smartgwt.client.widgets.form.fields.events.HasKeyUpHandlers, com.smartgwt.client.widgets.form.fields.events.HasPendingStatusChangedHandlers, com.smartgwt.client.widgets.form.fields.events.HasPickerIconClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasShowContextMenuHandlers, com.smartgwt.client.widgets.form.fields.events.HasTitleClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasTitleDoubleClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasTitleHoverHandlers, com.smartgwt.client.widgets.form.fields.events.HasValueHoverHandlers, com.smartgwt.client.widgets.form.fields.events.HasValueIconClickHandlers {
    ...
    public void setGlobalTabIndex(Integer globalTabIndex) {
    	...
    	if(it.eng.utility.ui.module.layout.client.Layout.isAttivoRefreshTabIndex()) {
	    	...
	    	if (globalTabIndex != null && globalTabIndex.intValue() <= 0) {
	    		if(globalTabIndex.intValue() == -1) {
	    			setCanFocus(UserInterfaceFactory.isAttivaAccessibilita());
	    		}     		
	    	} else {
				setAttribute("globalTabIndex", globalTabIndex);
			} 
     ...
     */
    private void setValidatorsOrig(Validator... validators) {
    ...
    //TODO AURIGA START    	
	 public void setValidators(Validator... validators) {
		if(UserInterfaceFactory.getParametroDBAsBoolean("ATTIVA_SCRIPT_VALIDATOR_FOR_TEXT_INPUT") && ((this instanceof TextItem) || (this instanceof TextAreaItem) || (this instanceof ComboBoxItem))) {
			...
			lCustomValidator.setErrorMessage("Valore non valido: non si possono inserire script");
			newValidators[validators.length] = lCustomValidator;
			setValidatorsOrig(newValidators);
    	} else { 	
    		setValidatorsOrig(validators);
    	}
    }
	//TODO AURIGA END    	
     ...
     */
    private native void redrawOrig() /*-{
        var self = this.@com.smartgwt.client.core.DataClass::getJsObj()();
        self.redraw();
    }-*/;
     ...
     */
    private native void redrawOrig(String reason) /*-{
        var self = this.@com.smartgwt.client.core.DataClass::getJsObj()();
        self.redraw(reason);
    }-*/;
     ...
     */
    private native Boolean validateOrig() /*-{
        var self = this.@com.smartgwt.client.core.DataClass::getJsObj()();
        if (!this.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) return null;
	...
	public Boolean validate() {
    	boolean valid = validateOrig();
//    	if(valid) {
//	    	if((this instanceof TextItem) || (this instanceof TextAreaItem) || (this instanceof ComboBoxItem)) {
//	    		if(getValue() != null && !"".equals((String) getValue())) {
//	    			RegExp regExp = RegExp.compile("<([A-Za-z][A-Za-z0-9]*)\\b[^>]*>(.*?)</\\1>");
//	    			if(regExp.test((String) getValue())) {
//	        			getForm().setFieldErrors(getName(), "Non si possono inserire tag html");
//						valid = false;						
//	        		}
//	        	}	
//	    	}    	
//    	}
    ...
    */
    ...
    //TODO AURIGA START    	
   	public String escapeHtml(String html) {
   		return StringUtil.asHTML(html);
   	}
   	
   	public native String encodeHtml(String html) /*-{
   	  return String(html).replace(/[^\w. ]/gi, function(c){
   	     return '&#' + c.charCodeAt(0) + ';';
   	  });
   	}-*/;
   	
   	public native String stripHtml(String html) /*-{
	    // Create a new temporal div element
    ...
    */
    private native void setItemHoverFormatterOrig(FormItemHoverFormatter hoverFormatter) /*-{
        var self = this.@com.smartgwt.client.core.DataClass::getJsObj()();
    ...
    public void setItemHoverFormatter(FormItemHoverFormatter hoverFormatter) {
		setItemHoverFormatter(false, hoverFormatter);
	}
     ...
     * Return null to suppress the hover canvas altogether.
     *
     * Per prevenire attacchi di cross-site scripting (XSS) bisogna fare in modo che nella stringa html 
	 * restituita dal metodo getHoverHTML dell'oggetto FormItemHoverFormatter venga fatto l'escape html
	 * per ogni input il cui valore è stato inserito direttamente dall'utente. In quel caso il parametro 
	 * isEscapedHtmlInInputText dovrà essere passato a true, altrimenti per i campi di tipo testuale il 
   	 * parametro hoverFormatter verrà ignorato.
     *
     * @param isEscapedHtmlInAllUserInput
     * @param hoverFormatter the hover formatter
     */
    public void setItemHoverFormatter(boolean isEscapedHtmlInAllUserInput, final FormItemHoverFormatter hoverFormatter) {   		
		if(isEscapedHtmlInAllUserInput) {
   			setItemHoverFormatterOrig(hoverFormatter);
   		} else if((this instanceof TextItem) || (this instanceof TextAreaItem) || (this instanceof ComboBoxItem)) {
   			/*
   			try {
        		setItemHoverFormatterOrig(new FormItemHoverFormatter() {
 				
	 				@Override
	 				public String getHoverHTML(FormItem item, DynamicForm form) {
	 					return escapeHtml(hoverFormatter.getHoverHTML(item, form));	 		        	
	 				}
	 			});
        	} catch(Exception e) {
        		e.getMessage();
     ...
     */
    private native void setItemTitleHoverFormatterOrig(FormItemHoverFormatter hoverFormatter) /*-{
        var self = this.@com.smartgwt.client.core.DataClass::getJsObj()();
    ...
    //TODO AURIGA START    	
   	public void setItemTitleHoverFormatter(final FormItemHoverFormatter hoverFormatter) {
   		// Per prevenire attacchi di cross-site scripting (XSS) lo disabilito
		/*
		try {
       		setItemTitleHoverFormatterOrig(new FormItemHoverFormatter() {
     ...
     * @see #valueClipped()
     */
    private native void setItemValueHoverFormatterOrig(FormItemHoverFormatter hoverFormatter) /*-{
         var self = this.@com.smartgwt.client.core.DataClass::getJsObj()();
    ...
    //TODO AURIGA START    	
   	public void setItemValueHoverFormatter(final FormItemHoverFormatter hoverFormatter) {   
   		// Per prevenire attacchi di cross-site scripting (XSS) lo disabilito
		/*
		try {
       		setItemValueHoverFormatterOrig(new FormItemHoverFormatter() {
