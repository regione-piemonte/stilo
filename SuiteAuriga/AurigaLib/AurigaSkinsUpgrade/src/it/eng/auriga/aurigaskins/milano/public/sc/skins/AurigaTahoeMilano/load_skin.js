...
//----------------------------------------
    ...
    isc.Page.setSkinDir("[ISOMORPHIC]/skins/AurigaTahoeMilano/")
	//isc.Page.setAppImgDir("[APP]/imagesTahoe")
...
//----------------------------------------
    ...
    var skinCssLoaded = isc.Page.loadStyleSheet("[SKIN]/skin_styles.css", theWindow, 
                                            "isc.FontLoader.loadCustomFonts()");
    var customCssLoaded = isc.Page.loadStyleSheet("[SKIN]/custom_styles.css", theWindow, 
    										"isc.FontLoader.loadCustomFonts()");
...
//  isc.Canvas.resizeControls(10);
    ...
    if (skinCssLoaded != null) isc.FontLoader.loadCustomFonts([
        "corbel", "corbel-bold", "calibri", "RobotoLight"
    ], skinCssLoaded);
    if (customCssLoaded != null) isc.FontLoader.loadCustomFonts([
        "corbel", "corbel-bold", "calibri", "RobotoLight"
    ], customCssLoaded);
