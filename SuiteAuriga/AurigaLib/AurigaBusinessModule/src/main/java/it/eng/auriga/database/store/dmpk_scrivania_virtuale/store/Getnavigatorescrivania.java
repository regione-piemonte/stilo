...
package it.eng.auriga.database.store.dmpk_scrivania_virtuale.store;

import it.eng.auriga.database.store.dmpk_scrivania_virtuale.bean.DmpkScrivaniaVirtualeGetnavigatorescrivaniaBean;
import it.eng.auriga.database.store.dmpk_scrivania_virtuale.store.impl.GetnavigatorescrivaniaImpl;
 ...
 */
@Service(name="DmpkScrivaniaVirtualeGetnavigatorescrivania")
public class Getnavigatorescrivania {
		
	private DmpkScrivaniaVirtualeGetnavigatorescrivaniaBean bean;
		  
	public void setBean(DmpkScrivaniaVirtualeGetnavigatorescrivaniaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkScrivaniaVirtualeGetnavigatorescrivaniaBean> execute(AurigaLoginBean lLoginBean, DmpkScrivaniaVirtualeGetnavigatorescrivaniaBean pBean) throws Exception{
	   final GetnavigatorescrivaniaImpl lGetnavigatorescrivania = new GetnavigatorescrivaniaImpl();
	   setBean(pBean);
	   lGetnavigatorescrivania.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetnavigatorescrivania.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkScrivaniaVirtualeGetnavigatorescrivaniaBean> result = new StoreResultBean<DmpkScrivaniaVirtualeGetnavigatorescrivaniaBean>();
