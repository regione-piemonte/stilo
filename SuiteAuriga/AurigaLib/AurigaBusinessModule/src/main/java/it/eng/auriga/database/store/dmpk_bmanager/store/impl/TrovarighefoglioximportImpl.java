...
public class TrovarighefoglioximportImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_BMANAGER.TROVARIGHEFOGLIOXIMPORT(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"righexmlout",15,Types.CLOB); 
