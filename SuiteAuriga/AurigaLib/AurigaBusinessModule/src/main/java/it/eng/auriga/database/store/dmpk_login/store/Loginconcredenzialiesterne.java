...
import it.eng.auriga.database.store.dmpk_login.store.impl.LoginconcredenzialiesterneImpl;
 ...
 */
@Service(name="DmpkLoginLoginconcredenzialiesterne")
public class Loginconcredenzialiesterne {
	...
	public StoreResultBean<DmpkLoginLoginconcredenzialiesterneBean> execute(AurigaLoginBean lLoginBean, DmpkLoginLoginconcredenzialiesterneBean pBean) throws Exception{
	   final LoginconcredenzialiesterneImpl lLoginconcredenzialiesterne = new LoginconcredenzialiesterneImpl();
	   setBean(pBean);
	   lLoginconcredenzialiesterne.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoginconcredenzialiesterne.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkLoginLoginconcredenzialiesterneBean> result = new StoreResultBean<DmpkLoginLoginconcredenzialiesterneBean>();
