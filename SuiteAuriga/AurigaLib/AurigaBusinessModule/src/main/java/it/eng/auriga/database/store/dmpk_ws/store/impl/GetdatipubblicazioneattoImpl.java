...
public class GetdatipubblicazioneattoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.GETDATIPUBBLICAZIONEATTO(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"urirelatepubblout",5,Types.CLOB); 
