...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.SpostacontenutosezImpl;
 ...
 */
@Service(name="DmpkAmmTraspSpostacontenutosez")
public class Spostacontenutosez {
		
	private DmpkAmmTraspSpostacontenutosezBean bean;
		  
	public void setBean(DmpkAmmTraspSpostacontenutosezBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspSpostacontenutosezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspSpostacontenutosezBean pBean) throws Exception{
	   final SpostacontenutosezImpl lSpostacontenutosez = new SpostacontenutosezImpl();
	   setBean(pBean);
	   lSpostacontenutosez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSpostacontenutosez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspSpostacontenutosezBean> result = new StoreResultBean<DmpkAmmTraspSpostacontenutosezBean>();
