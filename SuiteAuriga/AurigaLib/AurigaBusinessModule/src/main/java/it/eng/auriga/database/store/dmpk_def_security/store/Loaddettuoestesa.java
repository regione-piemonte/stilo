...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettuoestesaImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettuoestesa")
public class Loaddettuoestesa {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettuoestesaBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettuoestesaBean pBean) throws Exception{
	   final LoaddettuoestesaImpl lLoaddettuoestesa = new LoaddettuoestesaImpl();
	   setBean(pBean);
	   lLoaddettuoestesa.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettuoestesa.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettuoestesaBean> result = new StoreResultBean<DmpkDefSecurityLoaddettuoestesaBean>();
