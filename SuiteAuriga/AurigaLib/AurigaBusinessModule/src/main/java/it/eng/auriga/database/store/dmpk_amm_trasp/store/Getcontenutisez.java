...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.GetcontenutisezImpl;
 ...
 */
@Service(name="DmpkAmmTraspGetcontenutisez")
public class Getcontenutisez {
	...
	public StoreResultBean<DmpkAmmTraspGetcontenutisezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspGetcontenutisezBean pBean) throws Exception{
	   final GetcontenutisezImpl lGetcontenutisez = new GetcontenutisezImpl();
	   setBean(pBean);
	   lGetcontenutisez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetcontenutisez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspGetcontenutisezBean> result = new StoreResultBean<DmpkAmmTraspGetcontenutisezBean>();
