...
import it.eng.auriga.database.store.dmpk_gae.bean.DmpkGaeTrovasottoscrizioninotificaBean;
import it.eng.auriga.database.store.dmpk_gae.store.impl.TrovasottoscrizioninotificaImpl;
 ...
 */
@Service(name="DmpkGaeTrovasottoscrizioninotifica")
public class Trovasottoscrizioninotifica {
		
	private DmpkGaeTrovasottoscrizioninotificaBean bean;
		  
	public void setBean(DmpkGaeTrovasottoscrizioninotificaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkGaeTrovasottoscrizioninotificaBean> execute(AurigaLoginBean lLoginBean, DmpkGaeTrovasottoscrizioninotificaBean pBean) throws Exception{
	   final TrovasottoscrizioninotificaImpl lTrovasottoscrizioninotifica = new TrovasottoscrizioninotificaImpl();
	   setBean(pBean);
	   lTrovasottoscrizioninotifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovasottoscrizioninotifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkGaeTrovasottoscrizioninotificaBean> result = new StoreResultBean<DmpkGaeTrovasottoscrizioninotificaBean>();
