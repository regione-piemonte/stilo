 ...
 */
@Service(name="DmpkProcessesIuprocobj_ligth")
public class Iuprocobj_ligth {
		
	private DmpkProcessesIuprocobj_ligthBean bean;
		  
	public void setBean(DmpkProcessesIuprocobj_ligthBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesIuprocobj_ligthBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesIuprocobj_ligthBean pBean) throws Exception{
	   final Iuprocobj_ligthImpl lIuprocobj_ligth = new Iuprocobj_ligthImpl();
	   setBean(pBean);
	   lIuprocobj_ligth.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuprocobj_ligth.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesIuprocobj_ligthBean> result = new StoreResultBean<DmpkProcessesIuprocobj_ligthBean>();
