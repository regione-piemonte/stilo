...
public class LoadfirmevistiattoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_REPOSITORY_GUI.LOADFIRMEVISTIATTO(?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"estremiattoout",5,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"listafirmexmlout",6,Types.CLOB); 
