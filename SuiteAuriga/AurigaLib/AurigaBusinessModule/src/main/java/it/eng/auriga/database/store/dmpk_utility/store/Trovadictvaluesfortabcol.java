...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityTrovadictvaluesfortabcolBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovadictvaluesfortabcolImpl;
 ...
 */
@Service(name="DmpkUtilityTrovadictvaluesfortabcol")
public class Trovadictvaluesfortabcol {
		
	private DmpkUtilityTrovadictvaluesfortabcolBean bean;
		  
	public void setBean(DmpkUtilityTrovadictvaluesfortabcolBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityTrovadictvaluesfortabcolBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovadictvaluesfortabcolBean pBean) throws Exception{
	   final TrovadictvaluesfortabcolImpl lTrovadictvaluesfortabcol = new TrovadictvaluesfortabcolImpl();
	   setBean(pBean);
	   lTrovadictvaluesfortabcol.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadictvaluesfortabcol.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityTrovadictvaluesfortabcolBean> result = new StoreResultBean<DmpkUtilityTrovadictvaluesfortabcolBean>();
