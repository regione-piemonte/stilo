...
import it.eng.auriga.database.store.dmpk_doc_types.store.impl.DdoctypeImpl;
 ...
 */
@Service(name="DmpkDocTypesDdoctype")
public class Ddoctype {
		
	private DmpkDocTypesDdoctypeBean bean;
		  
	public void setBean(DmpkDocTypesDdoctypeBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDocTypesDdoctypeBean> execute(AurigaLoginBean lLoginBean, DmpkDocTypesDdoctypeBean pBean) throws Exception{
	   final DdoctypeImpl lDdoctype = new DdoctypeImpl();
	   setBean(pBean);
	   lDdoctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDdoctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDocTypesDdoctypeBean> result = new StoreResultBean<DmpkDocTypesDdoctypeBean>();
