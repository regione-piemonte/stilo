...
import it.eng.auriga.database.store.dmpk_statistiche.store.impl.RaffinacampattictrlregammImpl;
 ...
 */
@Service(name="DmpkStatisticheRaffinacampattictrlregamm")
public class Raffinacampattictrlregamm {
		
	private DmpkStatisticheRaffinacampattictrlregammBean bean;
		  
	public void setBean(DmpkStatisticheRaffinacampattictrlregammBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkStatisticheRaffinacampattictrlregammBean> execute(AurigaLoginBean lLoginBean, DmpkStatisticheRaffinacampattictrlregammBean pBean) throws Exception{
	   final RaffinacampattictrlregammImpl lRaffinacampattictrlregamm = new RaffinacampattictrlregammImpl();
	   setBean(pBean);
	   lRaffinacampattictrlregamm.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRaffinacampattictrlregamm.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkStatisticheRaffinacampattictrlregammBean> result = new StoreResultBean<DmpkStatisticheRaffinacampattictrlregammBean>();
