...
import it.eng.auriga.database.store.dmpk_int_portale_crm.store.impl.GestrichsbloccolimagibilitaImpl;
 ...
 */
@Service(name="DmpkIntPortaleCrmGestrichsbloccolimagibilita")
public class Gestrichsbloccolimagibilita {
		
	private DmpkIntPortaleCrmGestrichsbloccolimagibilitaBean bean;
		  
	public void setBean(DmpkIntPortaleCrmGestrichsbloccolimagibilitaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntPortaleCrmGestrichsbloccolimagibilitaBean> execute(AurigaLoginBean lLoginBean, DmpkIntPortaleCrmGestrichsbloccolimagibilitaBean pBean) throws Exception{
	   final GestrichsbloccolimagibilitaImpl lGestrichsbloccolimagibilita = new GestrichsbloccolimagibilitaImpl();
	   setBean(pBean);
	   lGestrichsbloccolimagibilita.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGestrichsbloccolimagibilita.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntPortaleCrmGestrichsbloccolimagibilitaBean> result = new StoreResultBean<DmpkIntPortaleCrmGestrichsbloccolimagibilitaBean>();
