...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.SetparametricasellaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailSetparametricasella")
public class Setparametricasella {
		
	private DmpkIntMgoEmailSetparametricasellaBean bean;
		  
	public void setBean(DmpkIntMgoEmailSetparametricasellaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailSetparametricasellaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailSetparametricasellaBean pBean) throws Exception{
	   final SetparametricasellaImpl lSetparametricasella = new SetparametricasellaImpl();
	   setBean(pBean);
	   lSetparametricasella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetparametricasella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailSetparametricasellaBean> result = new StoreResultBean<DmpkIntMgoEmailSetparametricasellaBean>();
