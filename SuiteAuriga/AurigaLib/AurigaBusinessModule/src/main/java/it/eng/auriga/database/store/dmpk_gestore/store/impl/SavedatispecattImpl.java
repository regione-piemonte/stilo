...
public class SavedatispecattImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_GESTORE.SAVEDATISPECATT(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"codesitoin",6,Types.VARCHAR,connection); 	
