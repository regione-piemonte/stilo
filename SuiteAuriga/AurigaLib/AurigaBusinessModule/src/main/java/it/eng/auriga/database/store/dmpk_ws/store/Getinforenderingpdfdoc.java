...
import it.eng.auriga.database.store.dmpk_ws.store.impl.GetinforenderingpdfdocImpl;
 ...
 */
@Service(name="DmpkWsGetinforenderingpdfdoc")
public class Getinforenderingpdfdoc {
	...
	public StoreResultBean<DmpkWsGetinforenderingpdfdocBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetinforenderingpdfdocBean pBean) throws Exception{
	   final GetinforenderingpdfdocImpl lGetinforenderingpdfdoc = new GetinforenderingpdfdocImpl();
	   setBean(pBean);
	   lGetinforenderingpdfdoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinforenderingpdfdoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetinforenderingpdfdocBean> result = new StoreResultBean<DmpkWsGetinforenderingpdfdocBean>();
