...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.IuclienteImpl;
 ...
 */
@Service(name="DmpkAnagraficaIucliente")
public class Iucliente {
	...
	public StoreResultBean<DmpkAnagraficaIuclienteBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaIuclienteBean pBean) throws Exception{
	   final IuclienteImpl lIucliente = new IuclienteImpl();
	   setBean(pBean);
	   lIucliente.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIucliente.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaIuclienteBean> result = new StoreResultBean<DmpkAnagraficaIuclienteBean>();
