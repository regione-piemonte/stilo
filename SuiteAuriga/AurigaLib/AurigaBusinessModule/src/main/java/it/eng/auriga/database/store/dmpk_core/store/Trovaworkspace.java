...
import it.eng.auriga.database.store.dmpk_core.store.impl.TrovaworkspaceImpl;
 ...
 */
@Service(name="DmpkCoreTrovaworkspace")
public class Trovaworkspace {
	...
	public StoreResultBean<DmpkCoreTrovaworkspaceBean> execute(AurigaLoginBean lLoginBean, DmpkCoreTrovaworkspaceBean pBean) throws Exception{
	   final TrovaworkspaceImpl lTrovaworkspace = new TrovaworkspaceImpl();
	   setBean(pBean);
	   lTrovaworkspace.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaworkspace.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreTrovaworkspaceBean> result = new StoreResultBean<DmpkCoreTrovaworkspaceBean>();
