...
import it.eng.auriga.database.store.dmpk_efact.store.impl.IulogregistrazioneconsensoImpl;
 ...
 */
@Service(name="DmpkEfactIulogregistrazioneconsenso")
public class Iulogregistrazioneconsenso {
	...
	public StoreResultBean<DmpkEfactIulogregistrazioneconsensoBean> execute(AurigaLoginBean lLoginBean, DmpkEfactIulogregistrazioneconsensoBean pBean) throws Exception{
	   final IulogregistrazioneconsensoImpl lIulogregistrazioneconsenso = new IulogregistrazioneconsensoImpl();
	   setBean(pBean);
	   lIulogregistrazioneconsenso.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIulogregistrazioneconsenso.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactIulogregistrazioneconsensoBean> result = new StoreResultBean<DmpkEfactIulogregistrazioneconsensoBean>();
