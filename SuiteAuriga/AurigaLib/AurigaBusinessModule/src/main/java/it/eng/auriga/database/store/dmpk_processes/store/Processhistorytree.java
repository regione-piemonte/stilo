...
import it.eng.auriga.database.store.dmpk_processes.store.impl.ProcesshistorytreeImpl;
 ...
 */
@Service(name="DmpkProcessesProcesshistorytree")
public class Processhistorytree {
	...
	public StoreResultBean<DmpkProcessesProcesshistorytreeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesProcesshistorytreeBean pBean) throws Exception{
	   final ProcesshistorytreeImpl lProcesshistorytree = new ProcesshistorytreeImpl();
	   setBean(pBean);
	   lProcesshistorytree.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lProcesshistorytree.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesProcesshistorytreeBean> result = new StoreResultBean<DmpkProcessesProcesshistorytreeBean>();
