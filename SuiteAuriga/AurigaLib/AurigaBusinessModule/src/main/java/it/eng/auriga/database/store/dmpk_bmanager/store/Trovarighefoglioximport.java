...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.TrovarighefoglioximportImpl;
 ...
 */
@Service(name="DmpkBmanagerTrovarighefoglioximport")
public class Trovarighefoglioximport {
		
	private DmpkBmanagerTrovarighefoglioximportBean bean;
		  
	public void setBean(DmpkBmanagerTrovarighefoglioximportBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerTrovarighefoglioximportBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerTrovarighefoglioximportBean pBean) throws Exception{
	   final TrovarighefoglioximportImpl lTrovarighefoglioximport = new TrovarighefoglioximportImpl();
	   setBean(pBean);
	   lTrovarighefoglioximport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovarighefoglioximport.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerTrovarighefoglioximportBean> result = new StoreResultBean<DmpkBmanagerTrovarighefoglioximportBean>();
