...
import it.eng.auriga.database.store.dmpk_core.store.impl.GetidnodoclassificaImpl;
 ...
 */
@Service(name="DmpkCoreGetidnodoclassifica")
public class Getidnodoclassifica {
		
	private DmpkCoreGetidnodoclassificaBean bean;
		  
	public void setBean(DmpkCoreGetidnodoclassificaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreGetidnodoclassificaBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetidnodoclassificaBean pBean) throws Exception{
	   final GetidnodoclassificaImpl lGetidnodoclassifica = new GetidnodoclassificaImpl();
	   setBean(pBean);
	   lGetidnodoclassifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetidnodoclassifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGetidnodoclassificaBean> result = new StoreResultBean<DmpkCoreGetidnodoclassificaBean>();
