 ...
 */
@Service(name="DmpkCoreToglida")
public class Toglida {
	...
	public StoreResultBean<DmpkCoreToglidaBean> execute(AurigaLoginBean lLoginBean, DmpkCoreToglidaBean pBean) throws Exception{
	   final ToglidaImpl lToglida = new ToglidaImpl();
	   setBean(pBean);
	   lToglida.setBean(bean);
       setCommit();
       setToken(lLoginBean);
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreToglidaBean> result = new StoreResultBean<DmpkCoreToglidaBean>();
