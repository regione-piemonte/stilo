...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.Addattore_proctyImpl;
 ...
 */
@Service(name="DmpkProcessTypesAddattore_procty")
public class Addattore_procty {
	...
	public StoreResultBean<DmpkProcessTypesAddattore_proctyBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesAddattore_proctyBean pBean) throws Exception{
	   final Addattore_proctyImpl lAddattore_procty = new Addattore_proctyImpl();
	   setBean(pBean);
	   lAddattore_procty.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddattore_procty.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesAddattore_proctyBean> result = new StoreResultBean<DmpkProcessTypesAddattore_proctyBean>();
