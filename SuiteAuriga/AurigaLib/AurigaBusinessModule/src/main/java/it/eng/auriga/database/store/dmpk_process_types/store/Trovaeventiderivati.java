...
import it.eng.auriga.database.store.dmpk_process_types.bean.DmpkProcessTypesTrovaeventiderivatiBean;
import it.eng.auriga.database.store.dmpk_process_types.store.impl.TrovaeventiderivatiImpl;
 ...
 */
@Service(name="DmpkProcessTypesTrovaeventiderivati")
public class Trovaeventiderivati {
		
	private DmpkProcessTypesTrovaeventiderivatiBean bean;
		  
	public void setBean(DmpkProcessTypesTrovaeventiderivatiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessTypesTrovaeventiderivatiBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesTrovaeventiderivatiBean pBean) throws Exception{
	   final TrovaeventiderivatiImpl lTrovaeventiderivati = new TrovaeventiderivatiImpl();
	   setBean(pBean);
	   lTrovaeventiderivati.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaeventiderivati.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesTrovaeventiderivatiBean> result = new StoreResultBean<DmpkProcessTypesTrovaeventiderivatiBean>();
