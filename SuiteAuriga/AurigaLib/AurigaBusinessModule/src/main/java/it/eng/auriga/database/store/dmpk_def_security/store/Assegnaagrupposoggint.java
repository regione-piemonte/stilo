...
import it.eng.auriga.database.store.dmpk_def_security.bean.DmpkDefSecurityAssegnaagrupposoggintBean;
import it.eng.auriga.database.store.dmpk_def_security.store.impl.AssegnaagrupposoggintImpl;
 ...
 */
@Service(name="DmpkDefSecurityAssegnaagrupposoggint")
public class Assegnaagrupposoggint {
		
	private DmpkDefSecurityAssegnaagrupposoggintBean bean;
		  
	public void setBean(DmpkDefSecurityAssegnaagrupposoggintBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityAssegnaagrupposoggintBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityAssegnaagrupposoggintBean pBean) throws Exception{
	   final AssegnaagrupposoggintImpl lAssegnaagrupposoggint = new AssegnaagrupposoggintImpl();
	   setBean(pBean);
	   lAssegnaagrupposoggint.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAssegnaagrupposoggint.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityAssegnaagrupposoggintBean> result = new StoreResultBean<DmpkDefSecurityAssegnaagrupposoggintBean>();
