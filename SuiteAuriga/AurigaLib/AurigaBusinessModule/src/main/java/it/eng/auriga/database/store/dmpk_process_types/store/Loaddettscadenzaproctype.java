...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.LoaddettscadenzaproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddettscadenzaproctype")
public class Loaddettscadenzaproctype {
		
	private DmpkProcessTypesLoaddettscadenzaproctypeBean bean;
		  
	public void setBean(DmpkProcessTypesLoaddettscadenzaproctypeBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessTypesLoaddettscadenzaproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddettscadenzaproctypeBean pBean) throws Exception{
	   final LoaddettscadenzaproctypeImpl lLoaddettscadenzaproctype = new LoaddettscadenzaproctypeImpl();
	   setBean(pBean);
	   lLoaddettscadenzaproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettscadenzaproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddettscadenzaproctypeBean> result = new StoreResultBean<DmpkProcessTypesLoaddettscadenzaproctypeBean>();
