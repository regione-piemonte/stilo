...
public class RiordinacontenutisezImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_AMM_TRASP.RIORDINACONTENUTISEZ(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"contenutidariordinarein",5,Types.CLOB,connection); 	
