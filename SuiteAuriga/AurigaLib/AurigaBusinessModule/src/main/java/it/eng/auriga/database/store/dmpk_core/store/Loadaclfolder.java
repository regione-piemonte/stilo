...
import it.eng.auriga.database.store.dmpk_core.store.impl.LoadaclfolderImpl;
 ...
 */
@Service(name="DmpkCoreLoadaclfolder")
public class Loadaclfolder {
	...
	public StoreResultBean<DmpkCoreLoadaclfolderBean> execute(AurigaLoginBean lLoginBean, DmpkCoreLoadaclfolderBean pBean) throws Exception{
	   final LoadaclfolderImpl lLoadaclfolder = new LoadaclfolderImpl();
	   setBean(pBean);
	   lLoadaclfolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadaclfolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreLoadaclfolderBean> result = new StoreResultBean<DmpkCoreLoadaclfolderBean>();
