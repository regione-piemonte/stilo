...
import it.eng.auriga.database.store.dmpk_wf.bean.DmpkWfFindtypeflussowfdaavviareBean;
import it.eng.auriga.database.store.dmpk_wf.store.impl.FindtypeflussowfdaavviareImpl;
 ...
 */
@Service(name="DmpkWfFindtypeflussowfdaavviare")
public class Findtypeflussowfdaavviare {
		
	private DmpkWfFindtypeflussowfdaavviareBean bean;
		  
	public void setBean(DmpkWfFindtypeflussowfdaavviareBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWfFindtypeflussowfdaavviareBean> execute(AurigaLoginBean lLoginBean, DmpkWfFindtypeflussowfdaavviareBean pBean) throws Exception{
	   final FindtypeflussowfdaavviareImpl lFindtypeflussowfdaavviare = new FindtypeflussowfdaavviareImpl();
	   setBean(pBean);
	   lFindtypeflussowfdaavviare.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lFindtypeflussowfdaavviare.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfFindtypeflussowfdaavviareBean> result = new StoreResultBean<DmpkWfFindtypeflussowfdaavviareBean>();
