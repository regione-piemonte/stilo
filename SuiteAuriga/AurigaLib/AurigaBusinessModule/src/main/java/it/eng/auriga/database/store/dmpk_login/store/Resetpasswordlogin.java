...
import it.eng.auriga.database.store.dmpk_login.store.impl.ResetpasswordloginImpl;
 ...
 */
@Service(name="DmpkLoginResetpasswordlogin")
public class Resetpasswordlogin {
	...
	public StoreResultBean<DmpkLoginResetpasswordloginBean> execute(AurigaLoginBean lLoginBean, DmpkLoginResetpasswordloginBean pBean) throws Exception{
	   final ResetpasswordloginImpl lResetpasswordlogin = new ResetpasswordloginImpl();
	   setBean(pBean);
	   lResetpasswordlogin.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lResetpasswordlogin.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkLoginResetpasswordloginBean> result = new StoreResultBean<DmpkLoginResetpasswordloginBean>();
