...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.GetdelegheuservsusersImpl;
 ...
 */
@Service(name="DmpkDefSecurityGetdelegheuservsusers")
public class Getdelegheuservsusers {
		
	private DmpkDefSecurityGetdelegheuservsusersBean bean;
		  
	public void setBean(DmpkDefSecurityGetdelegheuservsusersBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityGetdelegheuservsusersBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityGetdelegheuservsusersBean pBean) throws Exception{
	   final GetdelegheuservsusersImpl lGetdelegheuservsusers = new GetdelegheuservsusersImpl();
	   setBean(pBean);
	   lGetdelegheuservsusers.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdelegheuservsusers.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityGetdelegheuservsusersBean> result = new StoreResultBean<DmpkDefSecurityGetdelegheuservsusersBean>();
