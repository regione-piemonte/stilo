...
public class UpdateidmailnotificaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_EFACT.UPDATEIDMAILNOTIFICA(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idemailnotificain",5,Types.VARCHAR,connection); 	
