...
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovadoclottoingestImpl;
 ...
 */
@Service(name="DmpkEfactTrovadoclottoingest")
public class Trovadoclottoingest {
	...
	public StoreResultBean<DmpkEfactTrovadoclottoingestBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovadoclottoingestBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkEfactTrovadoclottoingestBean> result = new StoreResultBean<DmpkEfactTrovadoclottoingestBean>();
