...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportkpinestlemailforsoBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportkpinestlemailforsoImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportkpinestlemailforso")
public class Trovareportkpinestlemailforso {
		
	private DmpkEfactTrovareportkpinestlemailforsoBean bean;
		  
	public void setBean(DmpkEfactTrovareportkpinestlemailforsoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportkpinestlemailforsoBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportkpinestlemailforsoBean pBean) throws Exception{
	   final TrovareportkpinestlemailforsoImpl lTrovareportkpinestlemailforso = new TrovareportkpinestlemailforsoImpl();
	   setBean(pBean);
	   lTrovareportkpinestlemailforso.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportkpinestlemailforso.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportkpinestlemailforsoBean> result = new StoreResultBean<DmpkEfactTrovareportkpinestlemailforsoBean>();
