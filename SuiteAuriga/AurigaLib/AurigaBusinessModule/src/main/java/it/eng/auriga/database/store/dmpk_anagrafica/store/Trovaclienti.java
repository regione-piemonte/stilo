...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.TrovaclientiImpl;
 ...
 */
@Service(name="DmpkAnagraficaTrovaclienti")
public class Trovaclienti {
		
	private DmpkAnagraficaTrovaclientiBean bean;
		  
	public void setBean(DmpkAnagraficaTrovaclientiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAnagraficaTrovaclientiBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaTrovaclientiBean pBean) throws Exception{
	   final TrovaclientiImpl lTrovaclienti = new TrovaclientiImpl();
	   setBean(pBean);
	   lTrovaclienti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaclienti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaTrovaclientiBean> result = new StoreResultBean<DmpkAnagraficaTrovaclientiBean>();
