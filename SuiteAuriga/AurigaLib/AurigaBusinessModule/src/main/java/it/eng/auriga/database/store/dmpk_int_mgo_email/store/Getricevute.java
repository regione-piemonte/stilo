...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.GetricevuteImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailGetricevute")
public class Getricevute {
	...
	public StoreResultBean<DmpkIntMgoEmailGetricevuteBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailGetricevuteBean pBean) throws Exception{
	   final GetricevuteImpl lGetricevute = new GetricevuteImpl();
	   setBean(pBean);
	   lGetricevute.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetricevute.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailGetricevuteBean> result = new StoreResultBean<DmpkIntMgoEmailGetricevuteBean>();
