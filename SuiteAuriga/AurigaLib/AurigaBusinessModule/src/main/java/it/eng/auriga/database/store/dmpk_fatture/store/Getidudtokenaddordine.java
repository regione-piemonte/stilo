...
package it.eng.auriga.database.store.dmpk_fatture.store;

import it.eng.auriga.database.store.dmpk_fatture.bean.DmpkFattureGetidudtokenaddordineBean;
import it.eng.auriga.database.store.dmpk_fatture.store.impl.GetidudtokenaddordineImpl;
 ...
 */
@Service(name="DmpkFattureGetidudtokenaddordine")
public class Getidudtokenaddordine {
	...
	public StoreResultBean<DmpkFattureGetidudtokenaddordineBean> execute(AurigaLoginBean lLoginBean, DmpkFattureGetidudtokenaddordineBean pBean) throws Exception{
	   final GetidudtokenaddordineImpl lGetidudtokenaddordine = new GetidudtokenaddordineImpl();
	   setBean(pBean);
	   lGetidudtokenaddordine.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetidudtokenaddordine.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFattureGetidudtokenaddordineBean> result = new StoreResultBean<DmpkFattureGetidudtokenaddordineBean>();
