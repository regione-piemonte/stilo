...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.DcontenutosezImpl;
 ...
 */
@Service(name="DmpkAmmTraspDcontenutosez")
public class Dcontenutosez {
		
	private DmpkAmmTraspDcontenutosezBean bean;
		  
	public void setBean(DmpkAmmTraspDcontenutosezBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspDcontenutosezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspDcontenutosezBean pBean) throws Exception{
	   final DcontenutosezImpl lDcontenutosez = new DcontenutosezImpl();
	   setBean(pBean);
	   lDcontenutosez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDcontenutosez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspDcontenutosezBean> result = new StoreResultBean<DmpkAmmTraspDcontenutosezBean>();
