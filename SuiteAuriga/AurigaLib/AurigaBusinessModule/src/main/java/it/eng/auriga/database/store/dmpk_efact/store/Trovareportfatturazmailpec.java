...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturazmailpecBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturazmailpecImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturazmailpec")
public class Trovareportfatturazmailpec {
		
	private DmpkEfactTrovareportfatturazmailpecBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturazmailpecBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturazmailpecBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturazmailpecBean pBean) throws Exception{
	   final TrovareportfatturazmailpecImpl lTrovareportfatturazmailpec = new TrovareportfatturazmailpecImpl();
	   setBean(pBean);
	   lTrovareportfatturazmailpec.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturazmailpec.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturazmailpecBean> result = new StoreResultBean<DmpkEfactTrovareportfatturazmailpecBean>();
