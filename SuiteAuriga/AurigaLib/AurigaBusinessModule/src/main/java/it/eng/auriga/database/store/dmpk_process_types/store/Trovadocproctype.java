...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.TrovadocproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesTrovadocproctype")
public class Trovadocproctype {
	...
	public StoreResultBean<DmpkProcessTypesTrovadocproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesTrovadocproctypeBean pBean) throws Exception{
	   final TrovadocproctypeImpl lTrovadocproctype = new TrovadocproctypeImpl();
	   setBean(pBean);
	   lTrovadocproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadocproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesTrovadocproctypeBean> result = new StoreResultBean<DmpkProcessTypesTrovadocproctypeBean>();
