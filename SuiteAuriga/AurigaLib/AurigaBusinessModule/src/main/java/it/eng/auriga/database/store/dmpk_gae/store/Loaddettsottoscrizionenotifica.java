...
import it.eng.auriga.database.store.dmpk_gae.bean.DmpkGaeLoaddettsottoscrizionenotificaBean;
import it.eng.auriga.database.store.dmpk_gae.store.impl.LoaddettsottoscrizionenotificaImpl;
 ...
 */
@Service(name="DmpkGaeLoaddettsottoscrizionenotifica")
public class Loaddettsottoscrizionenotifica {
		
	private DmpkGaeLoaddettsottoscrizionenotificaBean bean;
		  
	public void setBean(DmpkGaeLoaddettsottoscrizionenotificaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkGaeLoaddettsottoscrizionenotificaBean> execute(AurigaLoginBean lLoginBean, DmpkGaeLoaddettsottoscrizionenotificaBean pBean) throws Exception{
	   final LoaddettsottoscrizionenotificaImpl lLoaddettsottoscrizionenotifica = new LoaddettsottoscrizionenotificaImpl();
	   setBean(pBean);
	   lLoaddettsottoscrizionenotifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettsottoscrizionenotifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkGaeLoaddettsottoscrizionenotificaBean> result = new StoreResultBean<DmpkGaeLoaddettsottoscrizionenotificaBean>();
