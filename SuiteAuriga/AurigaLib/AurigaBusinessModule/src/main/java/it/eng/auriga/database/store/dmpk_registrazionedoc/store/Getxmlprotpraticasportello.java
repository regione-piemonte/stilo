...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.GetxmlprotpraticasportelloImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocGetxmlprotpraticasportello")
public class Getxmlprotpraticasportello {
		
	private DmpkRegistrazionedocGetxmlprotpraticasportelloBean bean;
		  
	public void setBean(DmpkRegistrazionedocGetxmlprotpraticasportelloBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocGetxmlprotpraticasportelloBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocGetxmlprotpraticasportelloBean pBean) throws Exception{
	   final GetxmlprotpraticasportelloImpl lGetxmlprotpraticasportello = new GetxmlprotpraticasportelloImpl();
	   setBean(pBean);
	   lGetxmlprotpraticasportello.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetxmlprotpraticasportello.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocGetxmlprotpraticasportelloBean> result = new StoreResultBean<DmpkRegistrazionedocGetxmlprotpraticasportelloBean>();
