...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.GetlogcontenutosezImpl;
 ...
 */
@Service(name="DmpkAmmTraspGetlogcontenutosez")
public class Getlogcontenutosez {
		
	private DmpkAmmTraspGetlogcontenutosezBean bean;
		  
	public void setBean(DmpkAmmTraspGetlogcontenutosezBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspGetlogcontenutosezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspGetlogcontenutosezBean pBean) throws Exception{
	   final GetlogcontenutosezImpl lGetlogcontenutosez = new GetlogcontenutosezImpl();
	   setBean(pBean);
	   lGetlogcontenutosez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlogcontenutosez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspGetlogcontenutosezBean> result = new StoreResultBean<DmpkAmmTraspGetlogcontenutosezBean>();
