...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturazmaillinkBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturazmaillinkImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturazmaillink")
public class Trovareportfatturazmaillink {
		
	private DmpkEfactTrovareportfatturazmaillinkBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturazmaillinkBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturazmaillinkBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturazmaillinkBean pBean) throws Exception{
	   final TrovareportfatturazmaillinkImpl lTrovareportfatturazmaillink = new TrovareportfatturazmaillinkImpl();
	   setBean(pBean);
	   lTrovareportfatturazmaillink.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturazmaillink.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturazmaillinkBean> result = new StoreResultBean<DmpkEfactTrovareportfatturazmaillinkBean>();
