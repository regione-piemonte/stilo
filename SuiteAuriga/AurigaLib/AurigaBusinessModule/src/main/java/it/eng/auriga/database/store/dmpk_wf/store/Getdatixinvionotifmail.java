...
import it.eng.auriga.database.store.dmpk_wf.store.impl.GetdatixinvionotifmailImpl;
 ...
 */
@Service(name="DmpkWfGetdatixinvionotifmail")
public class Getdatixinvionotifmail {
		
	private DmpkWfGetdatixinvionotifmailBean bean;
		  
	public void setBean(DmpkWfGetdatixinvionotifmailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWfGetdatixinvionotifmailBean> execute(AurigaLoginBean lLoginBean, DmpkWfGetdatixinvionotifmailBean pBean) throws Exception{
	   final GetdatixinvionotifmailImpl lGetdatixinvionotifmail = new GetdatixinvionotifmailImpl();
	   setBean(pBean);
	   lGetdatixinvionotifmail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatixinvionotifmail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfGetdatixinvionotifmailBean> result = new StoreResultBean<DmpkWfGetdatixinvionotifmailBean>();
