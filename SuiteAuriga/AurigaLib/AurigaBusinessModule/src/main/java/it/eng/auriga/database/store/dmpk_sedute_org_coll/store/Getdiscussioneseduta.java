...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.GetdiscussionesedutaImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollGetdiscussioneseduta")
public class Getdiscussioneseduta {
	...
	public StoreResultBean<DmpkSeduteOrgCollGetdiscussionesedutaBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollGetdiscussionesedutaBean pBean) throws Exception{
	   final GetdiscussionesedutaImpl lGetdiscussioneseduta = new GetdiscussionesedutaImpl();
	   setBean(pBean);
	   lGetdiscussioneseduta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdiscussioneseduta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollGetdiscussionesedutaBean> result = new StoreResultBean<DmpkSeduteOrgCollGetdiscussionesedutaBean>();
