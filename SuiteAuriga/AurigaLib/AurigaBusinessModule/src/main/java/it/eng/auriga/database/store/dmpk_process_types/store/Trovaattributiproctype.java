...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.TrovaattributiproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesTrovaattributiproctype")
public class Trovaattributiproctype {
	...
	public StoreResultBean<DmpkProcessTypesTrovaattributiproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesTrovaattributiproctypeBean pBean) throws Exception{
	   final TrovaattributiproctypeImpl lTrovaattributiproctype = new TrovaattributiproctypeImpl();
	   setBean(pBean);
	   lTrovaattributiproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaattributiproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesTrovaattributiproctypeBean> result = new StoreResultBean<DmpkProcessTypesTrovaattributiproctypeBean>();
