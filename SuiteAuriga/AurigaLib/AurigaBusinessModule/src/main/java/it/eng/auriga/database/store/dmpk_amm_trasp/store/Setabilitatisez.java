...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.SetabilitatisezImpl;
 ...
 */
@Service(name="DmpkAmmTraspSetabilitatisez")
public class Setabilitatisez {
		
	private DmpkAmmTraspSetabilitatisezBean bean;
		  
	public void setBean(DmpkAmmTraspSetabilitatisezBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspSetabilitatisezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspSetabilitatisezBean pBean) throws Exception{
	   final SetabilitatisezImpl lSetabilitatisez = new SetabilitatisezImpl();
	   setBean(pBean);
	   lSetabilitatisez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetabilitatisez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspSetabilitatisezBean> result = new StoreResultBean<DmpkAmmTraspSetabilitatisezBean>();
