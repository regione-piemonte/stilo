...
import it.eng.auriga.database.store.dmpk_process_types.bean.DmpkProcessTypesLoaddettdoctypeproctyBean;
...
public class LoaddettdoctypeproctyImpl  {
		
	private DmpkProcessTypesLoaddettdoctypeproctyBean bean;
		  
	public void setBean(DmpkProcessTypesLoaddettdoctypeproctyBean bean){
		this.bean = bean;
	}
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESS_TYPES.LOADDETTDOCTYPEPROCTY(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"nomedoctypeout",7,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"nroposizioneout",8,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgaqcprodout",9,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"codruolodocout",10,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"maxnumdocsout",11,Types.DECIMAL); 
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlmodelliout",16,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlspecforaccessout",17,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"rowidout",18,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"bachsizeout",19,Types.INTEGER); 
