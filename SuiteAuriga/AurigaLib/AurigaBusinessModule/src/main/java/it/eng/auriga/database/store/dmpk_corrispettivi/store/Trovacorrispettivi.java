...
import it.eng.auriga.database.store.dmpk_corrispettivi.store.impl.TrovacorrispettiviImpl;
 ...
 */
@Service(name="DmpkCorrispettiviTrovacorrispettivi")
public class Trovacorrispettivi {
	...
	public StoreResultBean<DmpkCorrispettiviTrovacorrispettiviBean> execute(AurigaLoginBean lLoginBean, DmpkCorrispettiviTrovacorrispettiviBean pBean) throws Exception{
	   final TrovacorrispettiviImpl lTrovacorrispettivi = new TrovacorrispettiviImpl();
	   setBean(pBean);
	   lTrovacorrispettivi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovacorrispettivi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCorrispettiviTrovacorrispettiviBean> result = new StoreResultBean<DmpkCorrispettiviTrovacorrispettiviBean>();
