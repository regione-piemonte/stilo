...
import it.eng.auriga.database.store.dmpk_processes.bean.DmpkProcessesGetnoteBean;
import it.eng.auriga.database.store.dmpk_processes.store.impl.GetnoteImpl;
 ...
 */
@Service(name="DmpkProcessesGetnote")
public class Getnote {
		
	private DmpkProcessesGetnoteBean bean;
		  
	public void setBean(DmpkProcessesGetnoteBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesGetnoteBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesGetnoteBean pBean) throws Exception{
	   final GetnoteImpl lGetnote = new GetnoteImpl();
	   setBean(pBean);
	   lGetnote.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetnote.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesGetnoteBean> result = new StoreResultBean<DmpkProcessesGetnoteBean>();
