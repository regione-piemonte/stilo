...
public class AnnullamentoinvioImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_COLLABORATION.ANNULLAMENTOINVIO(?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idinviomovimentoin",6,Types.DECIMAL,connection); 	
