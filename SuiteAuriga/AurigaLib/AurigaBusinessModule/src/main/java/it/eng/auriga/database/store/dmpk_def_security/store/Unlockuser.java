...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.UnlockuserImpl;
 ...
 */
@Service(name="DmpkDefSecurityUnlockuser")
public class Unlockuser {
		
	private DmpkDefSecurityUnlockuserBean bean;
		  
	public void setBean(DmpkDefSecurityUnlockuserBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityUnlockuserBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityUnlockuserBean pBean) throws Exception{
	   final UnlockuserImpl lUnlockuser = new UnlockuserImpl();
	   setBean(pBean);
	   lUnlockuser.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUnlockuser.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityUnlockuserBean> result = new StoreResultBean<DmpkDefSecurityUnlockuserBean>();
