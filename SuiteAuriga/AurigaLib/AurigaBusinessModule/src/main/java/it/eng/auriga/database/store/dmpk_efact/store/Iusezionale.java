...
import it.eng.auriga.database.store.dmpk_efact.store.impl.IusezionaleImpl;
 ...
 */
@Service(name="DmpkEfactIusezionale")
public class Iusezionale {
	...
	public StoreResultBean<DmpkEfactIusezionaleBean> execute(AurigaLoginBean lLoginBean, DmpkEfactIusezionaleBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkEfactIusezionaleBean> result = new StoreResultBean<DmpkEfactIusezionaleBean>();
