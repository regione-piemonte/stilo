...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactIsdestinatarioinanagcheckBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.IsdestinatarioinanagcheckImpl;
 ...
 */
@Service(name="DmpkEfactIsdestinatarioinanagcheck")
public class Isdestinatarioinanagcheck {
		
	private DmpkEfactIsdestinatarioinanagcheckBean bean;
		  
	public void setBean(DmpkEfactIsdestinatarioinanagcheckBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactIsdestinatarioinanagcheckBean> execute(AurigaLoginBean lLoginBean, DmpkEfactIsdestinatarioinanagcheckBean pBean) throws Exception{
	   final IsdestinatarioinanagcheckImpl lIsdestinatarioinanagcheck = new IsdestinatarioinanagcheckImpl();
	   setBean(pBean);
	   lIsdestinatarioinanagcheck.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIsdestinatarioinanagcheck.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactIsdestinatarioinanagcheckBean> result = new StoreResultBean<DmpkEfactIsdestinatarioinanagcheckBean>();
