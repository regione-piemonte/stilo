...
import it.eng.auriga.database.store.dmpk_wf.store.impl.TrovafasiflussowfImpl;
 ...
 */
@Service(name="DmpkWfTrovafasiflussowf")
public class Trovafasiflussowf {
	...
	public StoreResultBean<DmpkWfTrovafasiflussowfBean> execute(AurigaLoginBean lLoginBean, DmpkWfTrovafasiflussowfBean pBean) throws Exception{
	   final TrovafasiflussowfImpl lTrovafasiflussowf = new TrovafasiflussowfImpl();
	   setBean(pBean);
	   lTrovafasiflussowf.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovafasiflussowf.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfTrovafasiflussowfBean> result = new StoreResultBean<DmpkWfTrovafasiflussowfBean>();
