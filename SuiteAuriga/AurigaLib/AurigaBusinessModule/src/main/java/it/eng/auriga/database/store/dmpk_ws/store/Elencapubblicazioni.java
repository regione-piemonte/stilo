...
import it.eng.auriga.database.store.dmpk_ws.store.impl.ElencapubblicazioniImpl;
 ...
 */
@Service(name="DmpkWsElencapubblicazioni")
public class Elencapubblicazioni {
		
	private DmpkWsElencapubblicazioniBean bean;
		  
	public void setBean(DmpkWsElencapubblicazioniBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsElencapubblicazioniBean> execute(AurigaLoginBean lLoginBean, DmpkWsElencapubblicazioniBean pBean) throws Exception{
	   final ElencapubblicazioniImpl lElencapubblicazioni = new ElencapubblicazioniImpl();
	   setBean(pBean);
	   lElencapubblicazioni.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lElencapubblicazioni.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsElencapubblicazioniBean> result = new StoreResultBean<DmpkWsElencapubblicazioniBean>();
