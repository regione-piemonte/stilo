...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.TrovaregoleregautoImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailTrovaregoleregauto")
public class Trovaregoleregauto {
		
	private DmpkIntMgoEmailTrovaregoleregautoBean bean;
		  
	public void setBean(DmpkIntMgoEmailTrovaregoleregautoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailTrovaregoleregautoBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailTrovaregoleregautoBean pBean) throws Exception{
	   final TrovaregoleregautoImpl lTrovaregoleregauto = new TrovaregoleregautoImpl();
	   setBean(pBean);
	   lTrovaregoleregauto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaregoleregauto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailTrovaregoleregautoBean> result = new StoreResultBean<DmpkIntMgoEmailTrovaregoleregautoBean>();
