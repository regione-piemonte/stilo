...
import it.eng.auriga.database.store.dmpk_ws.store.impl.GetdatiinviimailudImpl;
 ...
 */
@Service(name="DmpkWsGetdatiinviimailud")
public class Getdatiinviimailud {
		
	private DmpkWsGetdatiinviimailudBean bean;
		  
	public void setBean(DmpkWsGetdatiinviimailudBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsGetdatiinviimailudBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetdatiinviimailudBean pBean) throws Exception{
	   final GetdatiinviimailudImpl lGetdatiinviimailud = new GetdatiinviimailudImpl();
	   setBean(pBean);
	   lGetdatiinviimailud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatiinviimailud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetdatiinviimailudBean> result = new StoreResultBean<DmpkWsGetdatiinviimailudBean>();
