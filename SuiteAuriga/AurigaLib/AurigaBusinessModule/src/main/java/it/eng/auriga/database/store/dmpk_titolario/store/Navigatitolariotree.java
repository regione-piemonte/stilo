...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.NavigatitolariotreeImpl;
 ...
 */
@Service(name="DmpkTitolarioNavigatitolariotree")
public class Navigatitolariotree {
	...
	public StoreResultBean<DmpkTitolarioNavigatitolariotreeBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioNavigatitolariotreeBean pBean) throws Exception{
	   final NavigatitolariotreeImpl lNavigatitolariotree = new NavigatitolariotreeImpl();
	   setBean(pBean);
	   lNavigatitolariotree.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lNavigatitolariotree.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioNavigatitolariotreeBean> result = new StoreResultBean<DmpkTitolarioNavigatitolariotreeBean>();
