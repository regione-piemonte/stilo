...
import it.eng.auriga.database.store.dmpk_core.store.impl.UnlockdocImpl;
 ...
 */
@Service(name="DmpkCoreUnlockdoc")
public class Unlockdoc {
		
	private DmpkCoreUnlockdocBean bean;
		  
	public void setBean(DmpkCoreUnlockdocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreUnlockdocBean> execute(AurigaLoginBean lLoginBean, DmpkCoreUnlockdocBean pBean) throws Exception{
	   final UnlockdocImpl lUnlockdoc = new UnlockdocImpl();
	   setBean(pBean);
	   lUnlockdoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUnlockdoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreUnlockdocBean> result = new StoreResultBean<DmpkCoreUnlockdocBean>();
