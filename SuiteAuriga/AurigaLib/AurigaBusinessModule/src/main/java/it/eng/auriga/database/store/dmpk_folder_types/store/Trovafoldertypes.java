...
import it.eng.auriga.database.store.dmpk_folder_types.store.impl.TrovafoldertypesImpl;
 ...
 */
@Service(name="DmpkFolderTypesTrovafoldertypes")
public class Trovafoldertypes {
	...
	public StoreResultBean<DmpkFolderTypesTrovafoldertypesBean> execute(AurigaLoginBean lLoginBean, DmpkFolderTypesTrovafoldertypesBean pBean) throws Exception{
	   final TrovafoldertypesImpl lTrovafoldertypes = new TrovafoldertypesImpl();
	   setBean(pBean);
	   lTrovafoldertypes.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovafoldertypes.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFolderTypesTrovafoldertypesBean> result = new StoreResultBean<DmpkFolderTypesTrovafoldertypesBean>();
