...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreGetinheritedaclxudBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.GetinheritedaclxudImpl;
 ...
 */
@Service(name="DmpkCoreGetinheritedaclxud")
public class Getinheritedaclxud {
		
	private DmpkCoreGetinheritedaclxudBean bean;
		  
	public void setBean(DmpkCoreGetinheritedaclxudBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreGetinheritedaclxudBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetinheritedaclxudBean pBean) throws Exception{
	   final GetinheritedaclxudImpl lGetinheritedaclxud = new GetinheritedaclxudImpl();
	   setBean(pBean);
	   lGetinheritedaclxud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinheritedaclxud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGetinheritedaclxudBean> result = new StoreResultBean<DmpkCoreGetinheritedaclxudBean>();
