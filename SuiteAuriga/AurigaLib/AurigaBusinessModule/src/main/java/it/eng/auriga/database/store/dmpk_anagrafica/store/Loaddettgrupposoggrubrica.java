...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.LoaddettgrupposoggrubricaImpl;
 ...
 */
@Service(name="DmpkAnagraficaLoaddettgrupposoggrubrica")
public class Loaddettgrupposoggrubrica {
	...
	public StoreResultBean<DmpkAnagraficaLoaddettgrupposoggrubricaBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaLoaddettgrupposoggrubricaBean pBean) throws Exception{
	   final LoaddettgrupposoggrubricaImpl lLoaddettgrupposoggrubrica = new LoaddettgrupposoggrubricaImpl();
	   setBean(pBean);
	   lLoaddettgrupposoggrubrica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettgrupposoggrubrica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaLoaddettgrupposoggrubricaBean> result = new StoreResultBean<DmpkAnagraficaLoaddettgrupposoggrubricaBean>();
