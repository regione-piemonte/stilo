...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreSetstartingrootnodeBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.SetstartingrootnodeImpl;
 ...
 */
@Service(name="DmpkCoreSetstartingrootnode")
public class Setstartingrootnode {
		
	private DmpkCoreSetstartingrootnodeBean bean;
		  
	public void setBean(DmpkCoreSetstartingrootnodeBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreSetstartingrootnodeBean> execute(AurigaLoginBean lLoginBean, DmpkCoreSetstartingrootnodeBean pBean) throws Exception{
	   final SetstartingrootnodeImpl lSetstartingrootnode = new SetstartingrootnodeImpl();
	   setBean(pBean);
	   lSetstartingrootnode.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetstartingrootnode.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreSetstartingrootnodeBean> result = new StoreResultBean<DmpkCoreSetstartingrootnodeBean>();
