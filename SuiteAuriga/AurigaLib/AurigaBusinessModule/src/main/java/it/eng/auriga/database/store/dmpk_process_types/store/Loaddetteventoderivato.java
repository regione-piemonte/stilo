...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.LoaddetteventoderivatoImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddetteventoderivato")
public class Loaddetteventoderivato {
	...
	public StoreResultBean<DmpkProcessTypesLoaddetteventoderivatoBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddetteventoderivatoBean pBean) throws Exception{
	   final LoaddetteventoderivatoImpl lLoaddetteventoderivato = new LoaddetteventoderivatoImpl();
	   setBean(pBean);
	   lLoaddetteventoderivato.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddetteventoderivato.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddetteventoderivatoBean> result = new StoreResultBean<DmpkProcessTypesLoaddetteventoderivatoBean>();
