...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovasezionaliBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovasezionaliImpl;
 ...
 */
@Service(name="DmpkEfactTrovasezionali")
public class Trovasezionali {
		
	private DmpkEfactTrovasezionaliBean bean;
		  
	public void setBean(DmpkEfactTrovasezionaliBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovasezionaliBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovasezionaliBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkEfactTrovasezionaliBean> result = new StoreResultBean<DmpkEfactTrovasezionaliBean>();
