...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.LoaddetteventtypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddetteventtype")
public class Loaddetteventtype {
	...
	public StoreResultBean<DmpkProcessTypesLoaddetteventtypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddetteventtypeBean pBean) throws Exception{
	   final LoaddetteventtypeImpl lLoaddetteventtype = new LoaddetteventtypeImpl();
	   setBean(pBean);
	   lLoaddetteventtype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddetteventtype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddetteventtypeBean> result = new StoreResultBean<DmpkProcessTypesLoaddetteventtypeBean>();
