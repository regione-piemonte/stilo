...
import it.eng.auriga.database.store.dmpk_formati_el_ammessi.store.impl.TrovaformatielImpl;
 ...
 */
@Service(name="DmpkFormatiElAmmessiTrovaformatiel")
public class Trovaformatiel {
	...
	public StoreResultBean<DmpkFormatiElAmmessiTrovaformatielBean> execute(AurigaLoginBean lLoginBean, DmpkFormatiElAmmessiTrovaformatielBean pBean) throws Exception{
	   final TrovaformatielImpl lTrovaformatiel = new TrovaformatielImpl();
	   setBean(pBean);
	   lTrovaformatiel.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaformatiel.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFormatiElAmmessiTrovaformatielBean> result = new StoreResultBean<DmpkFormatiElAmmessiTrovaformatielBean>();
