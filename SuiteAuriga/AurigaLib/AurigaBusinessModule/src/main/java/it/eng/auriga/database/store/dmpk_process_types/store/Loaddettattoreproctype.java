...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.LoaddettattoreproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddettattoreproctype")
public class Loaddettattoreproctype {
	...
	public StoreResultBean<DmpkProcessTypesLoaddettattoreproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddettattoreproctypeBean pBean) throws Exception{
	   final LoaddettattoreproctypeImpl lLoaddettattoreproctype = new LoaddettattoreproctypeImpl();
	   setBean(pBean);
	   lLoaddettattoreproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettattoreproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddettattoreproctypeBean> result = new StoreResultBean<DmpkProcessTypesLoaddettattoreproctypeBean>();
