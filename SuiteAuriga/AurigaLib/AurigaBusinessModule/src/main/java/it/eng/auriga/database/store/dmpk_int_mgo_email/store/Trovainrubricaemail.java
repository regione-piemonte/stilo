...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.TrovainrubricaemailImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailTrovainrubricaemail")
public class Trovainrubricaemail {
		
	private DmpkIntMgoEmailTrovainrubricaemailBean bean;
		  
	public void setBean(DmpkIntMgoEmailTrovainrubricaemailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailTrovainrubricaemailBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailTrovainrubricaemailBean pBean) throws Exception{
	   final TrovainrubricaemailImpl lTrovainrubricaemail = new TrovainrubricaemailImpl();
	   setBean(pBean);
	   lTrovainrubricaemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovainrubricaemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailTrovainrubricaemailBean> result = new StoreResultBean<DmpkIntMgoEmailTrovainrubricaemailBean>();
