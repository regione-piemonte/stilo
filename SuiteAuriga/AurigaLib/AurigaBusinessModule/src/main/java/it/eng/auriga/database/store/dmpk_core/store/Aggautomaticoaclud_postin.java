...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreAggautomaticoaclud_postinBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.Aggautomaticoaclud_postinImpl;
 ...
 */
@Service(name="DmpkCoreAggautomaticoaclud_postin")
public class Aggautomaticoaclud_postin {
		
	private DmpkCoreAggautomaticoaclud_postinBean bean;
		  
	public void setBean(DmpkCoreAggautomaticoaclud_postinBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreAggautomaticoaclud_postinBean> execute(AurigaLoginBean lLoginBean, DmpkCoreAggautomaticoaclud_postinBean pBean) throws Exception{
	   final Aggautomaticoaclud_postinImpl lAggautomaticoaclud_postin = new Aggautomaticoaclud_postinImpl();
	   setBean(pBean);
	   lAggautomaticoaclud_postin.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAggautomaticoaclud_postin.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreAggautomaticoaclud_postinBean> result = new StoreResultBean<DmpkCoreAggautomaticoaclud_postinBean>();
