...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityGetinfolivelliforguiBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.GetinfolivelliforguiImpl;
 ...
 */
@Service(name="DmpkUtilityGetinfolivelliforgui")
public class Getinfolivelliforgui {
		
	private DmpkUtilityGetinfolivelliforguiBean bean;
		  
	public void setBean(DmpkUtilityGetinfolivelliforguiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityGetinfolivelliforguiBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityGetinfolivelliforguiBean pBean) throws Exception{
	   final GetinfolivelliforguiImpl lGetinfolivelliforgui = new GetinfolivelliforguiImpl();
	   setBean(pBean);
	   lGetinfolivelliforgui.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinfolivelliforgui.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityGetinfolivelliforguiBean> result = new StoreResultBean<DmpkUtilityGetinfolivelliforguiBean>();
