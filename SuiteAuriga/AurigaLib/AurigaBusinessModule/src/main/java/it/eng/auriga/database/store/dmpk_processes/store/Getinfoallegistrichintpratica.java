...
import it.eng.auriga.database.store.dmpk_processes.store.impl.GetinfoallegistrichintpraticaImpl;
 ...
 */
@Service(name="DmpkProcessesGetinfoallegistrichintpratica")
public class Getinfoallegistrichintpratica {
		
	private DmpkProcessesGetinfoallegistrichintpraticaBean bean;
		  
	public void setBean(DmpkProcessesGetinfoallegistrichintpraticaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesGetinfoallegistrichintpraticaBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesGetinfoallegistrichintpraticaBean pBean) throws Exception{
	   final GetinfoallegistrichintpraticaImpl lGetinfoallegistrichintpratica = new GetinfoallegistrichintpraticaImpl();
	   setBean(pBean);
	   lGetinfoallegistrichintpratica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinfoallegistrichintpratica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesGetinfoallegistrichintpraticaBean> result = new StoreResultBean<DmpkProcessesGetinfoallegistrichintpraticaBean>();
