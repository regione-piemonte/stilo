...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.AnnarchiviasedutaImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollAnnarchiviaseduta")
public class Annarchiviaseduta {
		
	private DmpkSeduteOrgCollAnnarchiviasedutaBean bean;
		  
	public void setBean(DmpkSeduteOrgCollAnnarchiviasedutaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkSeduteOrgCollAnnarchiviasedutaBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollAnnarchiviasedutaBean pBean) throws Exception{
	   final AnnarchiviasedutaImpl lAnnarchiviaseduta = new AnnarchiviasedutaImpl();
	   setBean(pBean);
	   lAnnarchiviaseduta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAnnarchiviaseduta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollAnnarchiviasedutaBean> result = new StoreResultBean<DmpkSeduteOrgCollAnnarchiviasedutaBean>();
