...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.LoaddettpianoclassifImpl;
 ...
 */
@Service(name="DmpkTitolarioLoaddettpianoclassif")
public class Loaddettpianoclassif {
	...
	public StoreResultBean<DmpkTitolarioLoaddettpianoclassifBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioLoaddettpianoclassifBean pBean) throws Exception{
	   final LoaddettpianoclassifImpl lLoaddettpianoclassif = new LoaddettpianoclassifImpl();
	   setBean(pBean);
	   lLoaddettpianoclassif.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettpianoclassif.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioLoaddettpianoclassifBean> result = new StoreResultBean<DmpkTitolarioLoaddettpianoclassifBean>();
