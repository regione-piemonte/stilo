...
import it.eng.auriga.database.store.dmpk_core.store.impl.SetvisionatoImpl;
 ...
 */
@Service(name="DmpkCoreSetvisionato")
public class Setvisionato {
	...
	public StoreResultBean<DmpkCoreSetvisionatoBean> execute(AurigaLoginBean lLoginBean, DmpkCoreSetvisionatoBean pBean) throws Exception{
	   final SetvisionatoImpl lSetvisionato = new SetvisionatoImpl();
	   setBean(pBean);
	   lSetvisionato.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetvisionato.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreSetvisionatoBean> result = new StoreResultBean<DmpkCoreSetvisionatoBean>();
