...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetcompgruppoassdestudImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetcompgruppoassdestud")
public class Getcompgruppoassdestud {
	...
	public StoreResultBean<DmpkRepositoryGuiGetcompgruppoassdestudBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetcompgruppoassdestudBean pBean) throws Exception{
	   final GetcompgruppoassdestudImpl lGetcompgruppoassdestud = new GetcompgruppoassdestudImpl();
	   setBean(pBean);
	   lGetcompgruppoassdestud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetcompgruppoassdestud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetcompgruppoassdestudBean> result = new StoreResultBean<DmpkRepositoryGuiGetcompgruppoassdestudBean>();
