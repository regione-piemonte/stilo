...
public class ScollegapuntiprotocolloImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DEF_SECURITY.SCOLLEGAPUNTIPROTOCOLLO(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"xmluoin",4,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"xmlpuntiprotin",5,Types.CLOB,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"esitiout",6,Types.CLOB); 
