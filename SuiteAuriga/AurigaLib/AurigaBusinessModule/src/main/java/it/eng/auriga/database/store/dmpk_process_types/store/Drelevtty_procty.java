...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.Drelevtty_proctyImpl;
 ...
 */
@Service(name="DmpkProcessTypesDrelevtty_procty")
public class Drelevtty_procty {
		
	private DmpkProcessTypesDrelevtty_proctyBean bean;
		  
	public void setBean(DmpkProcessTypesDrelevtty_proctyBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessTypesDrelevtty_proctyBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesDrelevtty_proctyBean pBean) throws Exception{
	   final Drelevtty_proctyImpl lDrelevtty_procty = new Drelevtty_proctyImpl();
	   setBean(pBean);
	   lDrelevtty_procty.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDrelevtty_procty.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesDrelevtty_proctyBean> result = new StoreResultBean<DmpkProcessTypesDrelevtty_proctyBean>();
