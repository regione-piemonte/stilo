...
import it.eng.auriga.database.store.dmpk_ruoli_amm.store.impl.DruoloammImpl;
 ...
 */
@Service(name="DmpkRuoliAmmDruoloamm")
public class Druoloamm {
		
	private DmpkRuoliAmmDruoloammBean bean;
		  
	public void setBean(DmpkRuoliAmmDruoloammBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRuoliAmmDruoloammBean> execute(AurigaLoginBean lLoginBean, DmpkRuoliAmmDruoloammBean pBean) throws Exception{
	   final DruoloammImpl lDruoloamm = new DruoloammImpl();
	   setBean(pBean);
	   lDruoloamm.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDruoloamm.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRuoliAmmDruoloammBean> result = new StoreResultBean<DmpkRuoliAmmDruoloammBean>();
