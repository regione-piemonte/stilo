...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.GetbarcodedacapofilapraticaImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocGetbarcodedacapofilapratica")
public class Getbarcodedacapofilapratica {
		
	private DmpkRegistrazionedocGetbarcodedacapofilapraticaBean bean;
		  
	public void setBean(DmpkRegistrazionedocGetbarcodedacapofilapraticaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocGetbarcodedacapofilapraticaBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocGetbarcodedacapofilapraticaBean pBean) throws Exception{
	   final GetbarcodedacapofilapraticaImpl lGetbarcodedacapofilapratica = new GetbarcodedacapofilapraticaImpl();
	   setBean(pBean);
	   lGetbarcodedacapofilapratica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetbarcodedacapofilapratica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocGetbarcodedacapofilapraticaBean> result = new StoreResultBean<DmpkRegistrazionedocGetbarcodedacapofilapraticaBean>();
