...
import it.eng.auriga.database.store.dmpk_core.store.impl.GetlivpathexnodoImpl;
 ...
 */
@Service(name="DmpkCoreGetlivpathexnodo")
public class Getlivpathexnodo {
		
	private DmpkCoreGetlivpathexnodoBean bean;
		  
	public void setBean(DmpkCoreGetlivpathexnodoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreGetlivpathexnodoBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetlivpathexnodoBean pBean) throws Exception{
	   final GetlivpathexnodoImpl lGetlivpathexnodo = new GetlivpathexnodoImpl();
	   setBean(pBean);
	   lGetlivpathexnodo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlivpathexnodo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGetlivpathexnodoBean> result = new StoreResultBean<DmpkCoreGetlivpathexnodoBean>();
