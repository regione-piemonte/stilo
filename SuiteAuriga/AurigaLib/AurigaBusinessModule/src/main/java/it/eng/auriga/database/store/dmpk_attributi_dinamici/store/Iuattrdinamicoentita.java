...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.IuattrdinamicoentitaImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciIuattrdinamicoentita")
public class Iuattrdinamicoentita {
	...
	public StoreResultBean<DmpkAttributiDinamiciIuattrdinamicoentitaBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciIuattrdinamicoentitaBean pBean) throws Exception{
	   final IuattrdinamicoentitaImpl lIuattrdinamicoentita = new IuattrdinamicoentitaImpl();
	   setBean(pBean);
	   lIuattrdinamicoentita.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuattrdinamicoentita.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciIuattrdinamicoentitaBean> result = new StoreResultBean<DmpkAttributiDinamiciIuattrdinamicoentitaBean>();
