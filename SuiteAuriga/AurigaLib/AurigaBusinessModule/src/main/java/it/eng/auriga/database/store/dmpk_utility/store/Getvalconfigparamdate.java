...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityGetvalconfigparamdateBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.GetvalconfigparamdateImpl;
 ...
 */
@Service(name="DmpkUtilityGetvalconfigparamdate")
public class Getvalconfigparamdate {
		
	private DmpkUtilityGetvalconfigparamdateBean bean;
		  
	public void setBean(DmpkUtilityGetvalconfigparamdateBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityGetvalconfigparamdateBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityGetvalconfigparamdateBean pBean) throws Exception{
	   final GetvalconfigparamdateImpl lGetvalconfigparamdate = new GetvalconfigparamdateImpl();
	   setBean(pBean);
	   lGetvalconfigparamdate.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetvalconfigparamdate.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityGetvalconfigparamdateBean> result = new StoreResultBean<DmpkUtilityGetvalconfigparamdateBean>();
