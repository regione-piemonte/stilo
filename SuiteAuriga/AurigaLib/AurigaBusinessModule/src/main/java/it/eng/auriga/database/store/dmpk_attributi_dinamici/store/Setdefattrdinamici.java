...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.bean.DmpkAttributiDinamiciSetdefattrdinamiciBean;
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.SetdefattrdinamiciImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciSetdefattrdinamici")
public class Setdefattrdinamici {
		
	private DmpkAttributiDinamiciSetdefattrdinamiciBean bean;
		  
	public void setBean(DmpkAttributiDinamiciSetdefattrdinamiciBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAttributiDinamiciSetdefattrdinamiciBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciSetdefattrdinamiciBean pBean) throws Exception{
	   final SetdefattrdinamiciImpl lSetdefattrdinamici = new SetdefattrdinamiciImpl();
	   setBean(pBean);
	   lSetdefattrdinamici.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetdefattrdinamici.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciSetdefattrdinamiciBean> result = new StoreResultBean<DmpkAttributiDinamiciSetdefattrdinamiciBean>();
