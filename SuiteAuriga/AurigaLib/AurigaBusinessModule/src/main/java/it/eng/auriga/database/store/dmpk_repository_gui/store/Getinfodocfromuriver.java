...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetinfodocfromuriverImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetinfodocfromuriver")
public class Getinfodocfromuriver {
		
	private DmpkRepositoryGuiGetinfodocfromuriverBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetinfodocfromuriverBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetinfodocfromuriverBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetinfodocfromuriverBean pBean) throws Exception{
	   final GetinfodocfromuriverImpl lGetinfodocfromuriver = new GetinfodocfromuriverImpl();
	   setBean(pBean);
	   lGetinfodocfromuriver.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinfodocfromuriver.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetinfodocfromuriverBean> result = new StoreResultBean<DmpkRepositoryGuiGetinfodocfromuriverBean>();
