...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.TrovabatchImpl;
 ...
 */
@Service(name="DmpkBmanagerTrovabatch")
public class Trovabatch {
	...
	public StoreResultBean<DmpkBmanagerTrovabatchBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerTrovabatchBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkBmanagerTrovabatchBean> result = new StoreResultBean<DmpkBmanagerTrovabatchBean>();
