...
import it.eng.auriga.database.store.dmpk_core.store.impl.UnlockudImpl;
 ...
 */
@Service(name="DmpkCoreUnlockud")
public class Unlockud {
		
	private DmpkCoreUnlockudBean bean;
		  
	public void setBean(DmpkCoreUnlockudBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreUnlockudBean> execute(AurigaLoginBean lLoginBean, DmpkCoreUnlockudBean pBean) throws Exception{
	   final UnlockudImpl lUnlockud = new UnlockudImpl();
	   setBean(pBean);
	   lUnlockud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUnlockud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreUnlockudBean> result = new StoreResultBean<DmpkCoreUnlockudBean>();
