...
import it.eng.auriga.database.store.dmpk_ws.store.impl.RicercaattiperprogettollppImpl;
 ...
 */
@Service(name="DmpkWsRicercaattiperprogettollpp")
public class Ricercaattiperprogettollpp {
		
	private DmpkWsRicercaattiperprogettollppBean bean;
		  
	public void setBean(DmpkWsRicercaattiperprogettollppBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsRicercaattiperprogettollppBean> execute(AurigaLoginBean lLoginBean, DmpkWsRicercaattiperprogettollppBean pBean) throws Exception{
	   final RicercaattiperprogettollppImpl lRicercaattiperprogettollpp = new RicercaattiperprogettollppImpl();
	   setBean(pBean);
	   lRicercaattiperprogettollpp.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRicercaattiperprogettollpp.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsRicercaattiperprogettollppBean> result = new StoreResultBean<DmpkWsRicercaattiperprogettollppBean>();
