...
import it.eng.auriga.database.store.dmpk_modelli_doc.bean.DmpkModelliDocTrovamodellixtipodocBean;
import it.eng.auriga.database.store.dmpk_modelli_doc.store.impl.TrovamodellixtipodocImpl;
 ...
 */
@Service(name="DmpkModelliDocTrovamodellixtipodoc")
public class Trovamodellixtipodoc {
		
	private DmpkModelliDocTrovamodellixtipodocBean bean;
		  
	public void setBean(DmpkModelliDocTrovamodellixtipodocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkModelliDocTrovamodellixtipodocBean> execute(AurigaLoginBean lLoginBean, DmpkModelliDocTrovamodellixtipodocBean pBean) throws Exception{
	   final TrovamodellixtipodocImpl lTrovamodellixtipodoc = new TrovamodellixtipodocImpl();
	   setBean(pBean);
	   lTrovamodellixtipodoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovamodellixtipodoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkModelliDocTrovamodellixtipodocBean> result = new StoreResultBean<DmpkModelliDocTrovamodellixtipodocBean>();
