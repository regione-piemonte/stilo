...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.IuattributoproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesIuattributoproctype")
public class Iuattributoproctype {
	...
	public StoreResultBean<DmpkProcessTypesIuattributoproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesIuattributoproctypeBean pBean) throws Exception{
	   final IuattributoproctypeImpl lIuattributoproctype = new IuattributoproctypeImpl();
	   setBean(pBean);
	   lIuattributoproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuattributoproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesIuattributoproctypeBean> result = new StoreResultBean<DmpkProcessTypesIuattributoproctypeBean>();
