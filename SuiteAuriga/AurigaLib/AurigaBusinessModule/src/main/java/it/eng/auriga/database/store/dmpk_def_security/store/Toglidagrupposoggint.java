...
import it.eng.auriga.database.store.dmpk_def_security.bean.DmpkDefSecurityToglidagrupposoggintBean;
import it.eng.auriga.database.store.dmpk_def_security.store.impl.ToglidagrupposoggintImpl;
 ...
 */
@Service(name="DmpkDefSecurityToglidagrupposoggint")
public class Toglidagrupposoggint {
		
	private DmpkDefSecurityToglidagrupposoggintBean bean;
		  
	public void setBean(DmpkDefSecurityToglidagrupposoggintBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityToglidagrupposoggintBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityToglidagrupposoggintBean pBean) throws Exception{
	   final ToglidagrupposoggintImpl lToglidagrupposoggint = new ToglidagrupposoggintImpl();
	   setBean(pBean);
	   lToglidagrupposoggint.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lToglidagrupposoggint.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityToglidagrupposoggintBean> result = new StoreResultBean<DmpkDefSecurityToglidagrupposoggintBean>();
