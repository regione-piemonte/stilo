...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.DclassificaImpl;
 ...
 */
@Service(name="DmpkTitolarioDclassifica")
public class Dclassifica {
		
	private DmpkTitolarioDclassificaBean bean;
		  
	public void setBean(DmpkTitolarioDclassificaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkTitolarioDclassificaBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioDclassificaBean pBean) throws Exception{
	   final DclassificaImpl lDclassifica = new DclassificaImpl();
	   setBean(pBean);
	   lDclassifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDclassifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioDclassificaBean> result = new StoreResultBean<DmpkTitolarioDclassificaBean>();
