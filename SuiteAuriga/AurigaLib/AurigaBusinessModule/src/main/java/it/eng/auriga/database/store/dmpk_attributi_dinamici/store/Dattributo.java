...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.DattributoImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciDattributo")
public class Dattributo {
		
	private DmpkAttributiDinamiciDattributoBean bean;
		  
	public void setBean(DmpkAttributiDinamiciDattributoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAttributiDinamiciDattributoBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciDattributoBean pBean) throws Exception{
	   final DattributoImpl lDattributo = new DattributoImpl();
	   setBean(pBean);
	   lDattributo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDattributo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciDattributoBean> result = new StoreResultBean<DmpkAttributiDinamiciDattributoBean>();
