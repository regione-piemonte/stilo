...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.DsoggettoImpl;
 ...
 */
@Service(name="DmpkAnagraficaDsoggetto")
public class Dsoggetto {
		
	private DmpkAnagraficaDsoggettoBean bean;
		  
	public void setBean(DmpkAnagraficaDsoggettoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAnagraficaDsoggettoBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaDsoggettoBean pBean) throws Exception{
	   final DsoggettoImpl lDsoggetto = new DsoggettoImpl();
	   setBean(pBean);
	   lDsoggetto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDsoggetto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaDsoggettoBean> result = new StoreResultBean<DmpkAnagraficaDsoggettoBean>();
