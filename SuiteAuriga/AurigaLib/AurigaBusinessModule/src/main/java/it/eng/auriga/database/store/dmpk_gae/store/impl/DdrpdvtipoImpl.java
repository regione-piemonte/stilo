...
public class DdrpdvtipoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_GAE.DDRPDVTIPO(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idpdvtipoin",4,Types.VARCHAR,connection); 	
