...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.LoaddettprocesstypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddettprocesstype")
public class Loaddettprocesstype {
	...
	public StoreResultBean<DmpkProcessTypesLoaddettprocesstypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddettprocesstypeBean pBean) throws Exception{
	   final LoaddettprocesstypeImpl lLoaddettprocesstype = new LoaddettprocesstypeImpl();
	   setBean(pBean);
	   lLoaddettprocesstype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettprocesstype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddettprocesstypeBean> result = new StoreResultBean<DmpkProcessTypesLoaddettprocesstypeBean>();
