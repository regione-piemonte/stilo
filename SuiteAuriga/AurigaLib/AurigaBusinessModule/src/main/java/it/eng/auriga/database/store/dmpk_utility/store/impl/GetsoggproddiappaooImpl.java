...
public class GetsoggproddiappaooImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.GETSOGGPRODDIAPPAOO(?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idaooin",2,Types.DECIMAL,connection); 	
