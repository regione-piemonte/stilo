...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.TrovaintitolarioImpl;
 ...
 */
@Service(name="DmpkTitolarioTrovaintitolario")
public class Trovaintitolario {
	...
	public StoreResultBean<DmpkTitolarioTrovaintitolarioBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioTrovaintitolarioBean pBean) throws Exception{
	   final TrovaintitolarioImpl lTrovaintitolario = new TrovaintitolarioImpl();
	   setBean(pBean);
	   lTrovaintitolario.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaintitolario.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioTrovaintitolarioBean> result = new StoreResultBean<DmpkTitolarioTrovaintitolarioBean>();
