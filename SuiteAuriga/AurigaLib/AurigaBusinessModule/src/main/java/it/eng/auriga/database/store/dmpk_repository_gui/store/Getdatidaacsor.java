...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetdatidaacsorImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetdatidaacsor")
public class Getdatidaacsor {
		
	private DmpkRepositoryGuiGetdatidaacsorBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetdatidaacsorBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetdatidaacsorBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetdatidaacsorBean pBean) throws Exception{
	   final GetdatidaacsorImpl lGetdatidaacsor = new GetdatidaacsorImpl();
	   setBean(pBean);
	   lGetdatidaacsor.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatidaacsor.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetdatidaacsorBean> result = new StoreResultBean<DmpkRepositoryGuiGetdatidaacsorBean>();
