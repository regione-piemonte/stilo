...
public class NewforumthreadImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.NEWFORUMTHREAD(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"attrfolderxmlout",4,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"attrdocprimarioxmlout",5,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"docattachxmlout",6,Types.CLOB); 
