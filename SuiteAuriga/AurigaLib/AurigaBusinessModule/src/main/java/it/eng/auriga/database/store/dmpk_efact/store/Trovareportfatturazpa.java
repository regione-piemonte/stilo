...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturazpaBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturazpaImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturazpa")
public class Trovareportfatturazpa {
		
	private DmpkEfactTrovareportfatturazpaBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturazpaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturazpaBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturazpaBean pBean) throws Exception{
	   final TrovareportfatturazpaImpl lTrovareportfatturazpa = new TrovareportfatturazpaImpl();
	   setBean(pBean);
	   lTrovareportfatturazpa.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturazpa.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturazpaBean> result = new StoreResultBean<DmpkEfactTrovareportfatturazpaBean>();
