...
public class LoadacludImpl  {
		
	private DmpkCoreLoadacludBean bean;
		  
	public void setBean(DmpkCoreLoadacludBean bean){
		this.bean = bean;
	}
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.LOADACLUD(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"flgtipooggereditadaout",7,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"idoggereditadaout",8,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"desoggereditadaout",9,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgtipooggpossibileereddaout",10,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"idoggpossibileereddaout",11,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"desoggpossibileereddaout",12,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"aclxmlout",13,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"listadocudxmlout",14,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgabilupdout",15,Types.INTEGER); 
