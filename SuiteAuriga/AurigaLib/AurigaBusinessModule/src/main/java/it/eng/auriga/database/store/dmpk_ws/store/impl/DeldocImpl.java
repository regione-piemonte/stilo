...
public class DeldocImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.DELDOC(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"flgtipotargetout",4,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"iduddocout",5,Types.DECIMAL); 
