...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityGetvalconfigparamtextBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.GetvalconfigparamtextImpl;
 ...
 */
@Service(name="DmpkUtilityGetvalconfigparamtext")
public class Getvalconfigparamtext {
		
	private DmpkUtilityGetvalconfigparamtextBean bean;
		  
	public void setBean(DmpkUtilityGetvalconfigparamtextBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityGetvalconfigparamtextBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityGetvalconfigparamtextBean pBean) throws Exception{
	   final GetvalconfigparamtextImpl lGetvalconfigparamtext = new GetvalconfigparamtextImpl();
	   setBean(pBean);
	   lGetvalconfigparamtext.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetvalconfigparamtext.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityGetvalconfigparamtextBean> result = new StoreResultBean<DmpkUtilityGetvalconfigparamtextBean>();
