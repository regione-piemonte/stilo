...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.IuprofiloImpl;
 ...
 */
@Service(name="DmpkDefSecurityIuprofilo")
public class Iuprofilo {
	...
	public StoreResultBean<DmpkDefSecurityIuprofiloBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityIuprofiloBean pBean) throws Exception{
	   final IuprofiloImpl lIuprofilo = new IuprofiloImpl();
	   setBean(pBean);
	   lIuprofilo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuprofilo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityIuprofiloBean> result = new StoreResultBean<DmpkDefSecurityIuprofiloBean>();
