...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.RichiestaaccessodocImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocRichiestaaccessodoc")
public class Richiestaaccessodoc {
	...
	public StoreResultBean<DmpkRegistrazionedocRichiestaaccessodocBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocRichiestaaccessodocBean pBean) throws Exception{
	   final RichiestaaccessodocImpl lRichiestaaccessodoc = new RichiestaaccessodocImpl();
	   setBean(pBean);
	   lRichiestaaccessodoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRichiestaaccessodoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocRichiestaaccessodocBean> result = new StoreResultBean<DmpkRegistrazionedocRichiestaaccessodocBean>();
