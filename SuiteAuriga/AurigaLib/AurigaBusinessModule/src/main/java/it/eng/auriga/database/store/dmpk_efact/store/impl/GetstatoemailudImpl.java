...
public class GetstatoemailudImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_EFACT.GETSTATOEMAILUD(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"statoconsolidamentoout",5,Types.VARCHAR); 
