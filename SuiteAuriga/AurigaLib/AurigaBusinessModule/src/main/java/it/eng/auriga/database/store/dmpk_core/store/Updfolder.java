 ...
 */
@Service(name="DmpkCoreUpdfolder")
public class Updfolder {
	...
	public StoreResultBean<DmpkCoreUpdfolderBean> execute(AurigaLoginBean lLoginBean, DmpkCoreUpdfolderBean pBean) throws Exception{
