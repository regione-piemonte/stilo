...
public class Getdatiprocxatt_jImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESSES.GETDATIPROCXATT_J(?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmldatiprocout",3,Types.CLOB); 
