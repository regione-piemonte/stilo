...
public class DriferimentobancarioImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_EFACT.DRIFERIMENTOBANCARIO(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idriferimentoin",4,Types.VARCHAR,connection); 	
