...
import it.eng.auriga.database.store.dmpk_core_2.store.impl.TrovadocinlibrofirmaImpl;
 ...
 */
@Service(name="DmpkCore2Trovadocinlibrofirma")
public class Trovadocinlibrofirma {
	...
	public StoreResultBean<DmpkCore2TrovadocinlibrofirmaBean> execute(AurigaLoginBean lLoginBean, DmpkCore2TrovadocinlibrofirmaBean pBean) throws Exception{
	   final TrovadocinlibrofirmaImpl lTrovadocinlibrofirma = new TrovadocinlibrofirmaImpl();
	   setBean(pBean);
	   lTrovadocinlibrofirma.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadocinlibrofirma.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCore2TrovadocinlibrofirmaBean> result = new StoreResultBean<DmpkCore2TrovadocinlibrofirmaBean>();
