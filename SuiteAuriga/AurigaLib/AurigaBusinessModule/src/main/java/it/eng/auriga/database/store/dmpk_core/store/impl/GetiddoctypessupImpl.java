...
public class GetiddoctypessupImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.GETIDDOCTYPESSUP(?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"iddoctypein",2,Types.DECIMAL,connection); 	
