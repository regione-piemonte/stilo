...
import it.eng.auriga.database.store.dmpk_formati_el_ammessi.store.impl.IuformatoelImpl;
 ...
 */
@Service(name="DmpkFormatiElAmmessiIuformatoel")
public class Iuformatoel {
	...
	public StoreResultBean<DmpkFormatiElAmmessiIuformatoelBean> execute(AurigaLoginBean lLoginBean, DmpkFormatiElAmmessiIuformatoelBean pBean) throws Exception{
	   final IuformatoelImpl lIuformatoel = new IuformatoelImpl();
	   setBean(pBean);
	   lIuformatoel.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuformatoel.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFormatiElAmmessiIuformatoelBean> result = new StoreResultBean<DmpkFormatiElAmmessiIuformatoelBean>();
