...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.GettimbrospecxtipoImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocGettimbrospecxtipo")
public class Gettimbrospecxtipo {
		
	private DmpkRegistrazionedocGettimbrospecxtipoBean bean;
		  
	public void setBean(DmpkRegistrazionedocGettimbrospecxtipoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocGettimbrospecxtipoBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocGettimbrospecxtipoBean pBean) throws Exception{
	   final GettimbrospecxtipoImpl lGettimbrospecxtipo = new GettimbrospecxtipoImpl();
	   setBean(pBean);
	   lGettimbrospecxtipo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGettimbrospecxtipo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocGettimbrospecxtipoBean> result = new StoreResultBean<DmpkRegistrazionedocGettimbrospecxtipoBean>();
