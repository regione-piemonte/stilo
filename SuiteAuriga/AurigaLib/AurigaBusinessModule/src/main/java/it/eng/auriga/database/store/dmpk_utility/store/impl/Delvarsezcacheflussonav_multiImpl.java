...
public class Delvarsezcacheflussonav_multiImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.DELVARSEZCACHEFLUSSONAV_MULTI(?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"nomivariabiliin",4,Types.CLOB,connection); 	
