...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.GetdaticonttabellaImpl;
 ...
 */
@Service(name="DmpkAmmTraspGetdaticonttabella")
public class Getdaticonttabella {
	...
	public StoreResultBean<DmpkAmmTraspGetdaticonttabellaBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspGetdaticonttabellaBean pBean) throws Exception{
	   final GetdaticonttabellaImpl lGetdaticonttabella = new GetdaticonttabellaImpl();
	   setBean(pBean);
	   lGetdaticonttabella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdaticonttabella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspGetdaticonttabellaBean> result = new StoreResultBean<DmpkAmmTraspGetdaticonttabellaBean>();
