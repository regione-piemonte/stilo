...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.ColleganotificaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailColleganotifica")
public class Colleganotifica {
		
	private DmpkIntMgoEmailColleganotificaBean bean;
		  
	public void setBean(DmpkIntMgoEmailColleganotificaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailColleganotificaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailColleganotificaBean pBean) throws Exception{
	   final ColleganotificaImpl lColleganotifica = new ColleganotificaImpl();
	   setBean(pBean);
	   lColleganotifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lColleganotifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailColleganotificaBean> result = new StoreResultBean<DmpkIntMgoEmailColleganotificaBean>();
