...
import it.eng.auriga.database.store.dmpk_spatial.store.impl.TrovastatinazionaliImpl;
 ...
 */
@Service(name="DmpkSpatialTrovastatinazionali")
public class Trovastatinazionali {
	...
	public StoreResultBean<DmpkSpatialTrovastatinazionaliBean> execute(AurigaLoginBean lLoginBean, DmpkSpatialTrovastatinazionaliBean pBean) throws Exception{
	   final TrovastatinazionaliImpl lTrovastatinazionali = new TrovastatinazionaliImpl();
	   setBean(pBean);
	   lTrovastatinazionali.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovastatinazionali.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSpatialTrovastatinazionaliBean> result = new StoreResultBean<DmpkSpatialTrovastatinazionaliBean>();
