...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.LoaddettclassificaImpl;
 ...
 */
@Service(name="DmpkTitolarioLoaddettclassifica")
public class Loaddettclassifica {
	...
	public StoreResultBean<DmpkTitolarioLoaddettclassificaBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioLoaddettclassificaBean pBean) throws Exception{
	   final LoaddettclassificaImpl lLoaddettclassifica = new LoaddettclassificaImpl();
	   setBean(pBean);
	   lLoaddettclassifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettclassifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioLoaddettclassificaBean> result = new StoreResultBean<DmpkTitolarioLoaddettclassificaBean>();
