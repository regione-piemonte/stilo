...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.UpdrigafoglioximportImpl;
 ...
 */
@Service(name="DmpkBmanagerUpdrigafoglioximport")
public class Updrigafoglioximport {
		
	private DmpkBmanagerUpdrigafoglioximportBean bean;
		  
	public void setBean(DmpkBmanagerUpdrigafoglioximportBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerUpdrigafoglioximportBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerUpdrigafoglioximportBean pBean) throws Exception{
	   final UpdrigafoglioximportImpl lUpdrigafoglioximport = new UpdrigafoglioximportImpl();
	   setBean(pBean);
	   lUpdrigafoglioximport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUpdrigafoglioximport.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerUpdrigafoglioximportBean> result = new StoreResultBean<DmpkBmanagerUpdrigafoglioximportBean>();
