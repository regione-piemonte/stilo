...
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovamodoggettiImpl;
 ...
 */
@Service(name="DmpkUtilityTrovamodoggetti")
public class Trovamodoggetti {
	...
	public StoreResultBean<DmpkUtilityTrovamodoggettiBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovamodoggettiBean pBean) throws Exception{
	   final TrovamodoggettiImpl lTrovamodoggetti = new TrovamodoggettiImpl();
	   setBean(pBean);
	   lTrovamodoggetti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovamodoggetti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityTrovamodoggettiBean> result = new StoreResultBean<DmpkUtilityTrovamodoggettiBean>();
