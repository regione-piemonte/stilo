...
import it.eng.auriga.database.store.dmpk_ws.store.impl.RicercadoccontabiliImpl;
 ...
 */
@Service(name="DmpkWsRicercadoccontabili")
public class Ricercadoccontabili {
		
	private DmpkWsRicercadoccontabiliBean bean;
		  
	public void setBean(DmpkWsRicercadoccontabiliBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsRicercadoccontabiliBean> execute(AurigaLoginBean lLoginBean, DmpkWsRicercadoccontabiliBean pBean) throws Exception{
	   final RicercadoccontabiliImpl lRicercadoccontabili = new RicercadoccontabiliImpl();
	   setBean(pBean);
	   lRicercadoccontabili.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRicercadoccontabili.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsRicercadoccontabiliBean> result = new StoreResultBean<DmpkWsRicercadoccontabiliBean>();
