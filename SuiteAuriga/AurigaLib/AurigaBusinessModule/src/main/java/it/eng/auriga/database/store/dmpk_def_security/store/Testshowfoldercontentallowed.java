...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TestshowfoldercontentallowedImpl;
 ...
 */
@Service(name="DmpkDefSecurityTestshowfoldercontentallowed")
public class Testshowfoldercontentallowed {
	...
	public StoreResultBean<DmpkDefSecurityTestshowfoldercontentallowedBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTestshowfoldercontentallowedBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkDefSecurityTestshowfoldercontentallowedBean> result = new StoreResultBean<DmpkDefSecurityTestshowfoldercontentallowedBean>();
