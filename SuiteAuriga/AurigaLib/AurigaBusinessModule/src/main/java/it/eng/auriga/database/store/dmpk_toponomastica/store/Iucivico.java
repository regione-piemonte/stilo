...
import it.eng.auriga.database.store.dmpk_toponomastica.store.impl.IucivicoImpl;
 ...
 */
@Service(name="DmpkToponomasticaIucivico")
public class Iucivico {
	...
	public StoreResultBean<DmpkToponomasticaIucivicoBean> execute(AurigaLoginBean lLoginBean, DmpkToponomasticaIucivicoBean pBean) throws Exception{
	   final IucivicoImpl lIucivico = new IucivicoImpl();
	   setBean(pBean);
	   lIucivico.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIucivico.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkToponomasticaIucivicoBean> result = new StoreResultBean<DmpkToponomasticaIucivicoBean>();
