...
import it.eng.auriga.database.store.dmpk_titolario.bean.DmpkTitolarioDpianoclassifBean;
import it.eng.auriga.database.store.dmpk_titolario.store.impl.DpianoclassifImpl;
 ...
 */
@Service(name="DmpkTitolarioDpianoclassif")
public class Dpianoclassif {
		
	private DmpkTitolarioDpianoclassifBean bean;
		  
	public void setBean(DmpkTitolarioDpianoclassifBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkTitolarioDpianoclassifBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioDpianoclassifBean pBean) throws Exception{
	   final DpianoclassifImpl lDpianoclassif = new DpianoclassifImpl();
	   setBean(pBean);
	   lDpianoclassif.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDpianoclassif.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioDpianoclassifBean> result = new StoreResultBean<DmpkTitolarioDpianoclassifBean>();
