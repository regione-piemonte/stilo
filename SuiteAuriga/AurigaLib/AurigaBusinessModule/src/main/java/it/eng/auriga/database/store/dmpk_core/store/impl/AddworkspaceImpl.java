...
public class AddworkspaceImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.ADDWORKSPACE(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"attributixmlin",4,Types.CLOB,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"idworkspaceout",5,Types.DECIMAL); 
