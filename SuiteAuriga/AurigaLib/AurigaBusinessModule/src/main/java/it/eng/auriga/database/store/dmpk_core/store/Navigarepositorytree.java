...
import it.eng.auriga.database.store.dmpk_core.store.impl.NavigarepositorytreeImpl;
 ...
 */
@Service(name="DmpkCoreNavigarepositorytree")
public class Navigarepositorytree {
	...
	public StoreResultBean<DmpkCoreNavigarepositorytreeBean> execute(AurigaLoginBean lLoginBean, DmpkCoreNavigarepositorytreeBean pBean) throws Exception{
	   final NavigarepositorytreeImpl lNavigarepositorytree = new NavigarepositorytreeImpl();
	   setBean(pBean);
	   lNavigarepositorytree.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lNavigarepositorytree.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreNavigarepositorytreeBean> result = new StoreResultBean<DmpkCoreNavigarepositorytreeBean>();
