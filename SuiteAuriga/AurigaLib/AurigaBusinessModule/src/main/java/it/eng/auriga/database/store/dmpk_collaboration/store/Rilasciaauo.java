...
import it.eng.auriga.database.store.dmpk_collaboration.store.impl.RilasciaauoImpl;
 ...
 */
@Service(name="DmpkCollaborationRilasciaauo")
public class Rilasciaauo {
		
	private DmpkCollaborationRilasciaauoBean bean;
		  
	public void setBean(DmpkCollaborationRilasciaauoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCollaborationRilasciaauoBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationRilasciaauoBean pBean) throws Exception{
	   final RilasciaauoImpl lRilasciaauo = new RilasciaauoImpl();
	   setBean(pBean);
	   lRilasciaauo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRilasciaauo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCollaborationRilasciaauoBean> result = new StoreResultBean<DmpkCollaborationRilasciaauoBean>();
