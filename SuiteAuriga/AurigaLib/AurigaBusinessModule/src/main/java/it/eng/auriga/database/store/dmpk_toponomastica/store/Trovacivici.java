...
import it.eng.auriga.database.store.dmpk_toponomastica.store.impl.TrovaciviciImpl;
 ...
 */
@Service(name="DmpkToponomasticaTrovacivici")
public class Trovacivici {
		
	private DmpkToponomasticaTrovaciviciBean bean;
		  
	public void setBean(DmpkToponomasticaTrovaciviciBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkToponomasticaTrovaciviciBean> execute(AurigaLoginBean lLoginBean, DmpkToponomasticaTrovaciviciBean pBean) throws Exception{
	   final TrovaciviciImpl lTrovacivici = new TrovaciviciImpl();
	   setBean(pBean);
	   lTrovacivici.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovacivici.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkToponomasticaTrovaciviciBean> result = new StoreResultBean<DmpkToponomasticaTrovaciviciBean>();
