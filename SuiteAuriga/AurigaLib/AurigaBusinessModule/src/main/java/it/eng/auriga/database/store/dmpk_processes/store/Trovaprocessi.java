...
import it.eng.auriga.database.store.dmpk_processes.store.impl.TrovaprocessiImpl;
 ...
 */
@Service(name="DmpkProcessesTrovaprocessi")
public class Trovaprocessi {
	...
	public StoreResultBean<DmpkProcessesTrovaprocessiBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesTrovaprocessiBean pBean) throws Exception{
	   final TrovaprocessiImpl lTrovaprocessi = new TrovaprocessiImpl();
	   setBean(pBean);
	   lTrovaprocessi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaprocessi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesTrovaprocessiBean> result = new StoreResultBean<DmpkProcessesTrovaprocessiBean>();
