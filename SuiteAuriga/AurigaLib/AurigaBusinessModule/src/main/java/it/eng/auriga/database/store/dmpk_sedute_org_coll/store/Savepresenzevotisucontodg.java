...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.SavepresenzevotisucontodgImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollSavepresenzevotisucontodg")
public class Savepresenzevotisucontodg {
	...
	public StoreResultBean<DmpkSeduteOrgCollSavepresenzevotisucontodgBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollSavepresenzevotisucontodgBean pBean) throws Exception{
	   final SavepresenzevotisucontodgImpl lSavepresenzevotisucontodg = new SavepresenzevotisucontodgImpl();
	   setBean(pBean);
	   lSavepresenzevotisucontodg.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSavepresenzevotisucontodg.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollSavepresenzevotisucontodgBean> result = new StoreResultBean<DmpkSeduteOrgCollSavepresenzevotisucontodgBean>();
