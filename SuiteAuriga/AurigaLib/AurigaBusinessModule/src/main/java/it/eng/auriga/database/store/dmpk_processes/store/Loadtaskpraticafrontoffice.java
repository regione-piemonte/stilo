...
import it.eng.auriga.database.store.dmpk_processes.bean.DmpkProcessesLoadtaskpraticafrontofficeBean;
import it.eng.auriga.database.store.dmpk_processes.store.impl.LoadtaskpraticafrontofficeImpl;
 ...
 */
@Service(name="DmpkProcessesLoadtaskpraticafrontoffice")
public class Loadtaskpraticafrontoffice {
		
	private DmpkProcessesLoadtaskpraticafrontofficeBean bean;
		  
	public void setBean(DmpkProcessesLoadtaskpraticafrontofficeBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesLoadtaskpraticafrontofficeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesLoadtaskpraticafrontofficeBean pBean) throws Exception{
	   final LoadtaskpraticafrontofficeImpl lLoadtaskpraticafrontoffice = new LoadtaskpraticafrontofficeImpl();
	   setBean(pBean);
	   lLoadtaskpraticafrontoffice.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadtaskpraticafrontoffice.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesLoadtaskpraticafrontofficeBean> result = new StoreResultBean<DmpkProcessesLoadtaskpraticafrontofficeBean>();
