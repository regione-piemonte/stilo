...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.IuattoreproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesIuattoreproctype")
public class Iuattoreproctype {
	...
	public StoreResultBean<DmpkProcessTypesIuattoreproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesIuattoreproctypeBean pBean) throws Exception{
	   final IuattoreproctypeImpl lIuattoreproctype = new IuattoreproctypeImpl();
	   setBean(pBean);
	   lIuattoreproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuattoreproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesIuattoreproctypeBean> result = new StoreResultBean<DmpkProcessTypesIuattoreproctypeBean>();
