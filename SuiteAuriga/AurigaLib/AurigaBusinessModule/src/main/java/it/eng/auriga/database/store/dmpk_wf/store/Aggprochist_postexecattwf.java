 ...
 */
@Service(name="DmpkWfAggprochist_postexecattwf")
public class Aggprochist_postexecattwf {
		
	private DmpkWfAggprochist_postexecattwfBean bean;
		  
	public void setBean(DmpkWfAggprochist_postexecattwfBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWfAggprochist_postexecattwfBean> execute(AurigaLoginBean lLoginBean, DmpkWfAggprochist_postexecattwfBean pBean) throws Exception{
	   final Aggprochist_postexecattwfImpl lAggprochist_postexecattwf = new Aggprochist_postexecattwfImpl();
	   setBean(pBean);
	   lAggprochist_postexecattwf.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAggprochist_postexecattwf.execute(paramConnection);
				}
			});
