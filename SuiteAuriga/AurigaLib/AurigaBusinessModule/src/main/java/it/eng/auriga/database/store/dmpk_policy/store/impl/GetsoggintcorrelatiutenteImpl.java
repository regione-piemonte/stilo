...
public class GetsoggintcorrelatiutenteImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_POLICY.GETSOGGINTCORRELATIUTENTE(?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgtpsoggin",4,Types.VARCHAR,connection); 	
