...
public class IucogitologImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"iduoin",6,Types.DECIMAL,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tsiniziochiamatain",7,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tsfinechiamatain",8,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"nrilivellirestituitein",9,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"nrilivellisceltain",10,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"errmsgcogitoin",11,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"idudin",12,Types.DECIMAL,connection); 	
