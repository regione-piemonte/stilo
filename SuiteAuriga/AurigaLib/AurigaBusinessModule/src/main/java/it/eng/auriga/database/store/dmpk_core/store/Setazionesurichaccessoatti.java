...
import it.eng.auriga.database.store.dmpk_core.store.impl.SetazionesurichaccessoattiImpl;
 ...
 */
@Service(name="DmpkCoreSetazionesurichaccessoatti")
public class Setazionesurichaccessoatti {
		
	private DmpkCoreSetazionesurichaccessoattiBean bean;
		  
	public void setBean(DmpkCoreSetazionesurichaccessoattiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreSetazionesurichaccessoattiBean> execute(AurigaLoginBean lLoginBean, DmpkCoreSetazionesurichaccessoattiBean pBean) throws Exception{
	   final SetazionesurichaccessoattiImpl lSetazionesurichaccessoatti = new SetazionesurichaccessoattiImpl();
	   setBean(pBean);
	   lSetazionesurichaccessoatti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetazionesurichaccessoatti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreSetazionesurichaccessoattiBean> result = new StoreResultBean<DmpkCoreSetazionesurichaccessoattiBean>();
