...
public class GetdisplaynameverdocImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.GETDISPLAYNAMEVERDOC(?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"displaynameverout",6,Types.VARCHAR); 
