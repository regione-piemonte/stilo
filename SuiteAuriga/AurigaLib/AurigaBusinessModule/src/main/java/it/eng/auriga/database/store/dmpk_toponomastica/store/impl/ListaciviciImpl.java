...
public class ListaciviciImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_TOPONOMASTICA.LISTACIVICI(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"civicoin",8,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"idprocin",9,Types.DECIMAL,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"flgabilins",20,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgabilupd",21,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgabildel",22,Types.INTEGER); 
