...
public class DrecelencoalboImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_ELENCHI_ALBI.DRECELENCOALBO(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idrecelencoalboin",4,Types.DECIMAL,connection); 	
