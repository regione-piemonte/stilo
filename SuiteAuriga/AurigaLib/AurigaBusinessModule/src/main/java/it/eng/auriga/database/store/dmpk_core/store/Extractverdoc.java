 ...
 */
@Service(name="DmpkCoreExtractverdoc")
public class Extractverdoc {
	...
	public StoreResultBean<DmpkCoreExtractverdocBean> execute(AurigaLoginBean lLoginBean, DmpkCoreExtractverdocBean pBean) throws Exception{
	   final ExtractverdocImpl lExtractverdoc = new ExtractverdocImpl();
	   setBean(pBean);
	   lExtractverdoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreExtractverdocBean> result = new StoreResultBean<DmpkCoreExtractverdocBean>();
