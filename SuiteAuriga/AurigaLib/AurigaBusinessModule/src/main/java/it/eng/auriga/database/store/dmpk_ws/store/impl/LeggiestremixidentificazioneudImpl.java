...
public class LeggiestremixidentificazioneudImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.LEGGIESTREMIXIDENTIFICAZIONEUD(?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"idudout",4,Types.DECIMAL); 
