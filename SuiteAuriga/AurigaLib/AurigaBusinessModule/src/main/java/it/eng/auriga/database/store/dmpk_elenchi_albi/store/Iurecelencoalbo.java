...
package it.eng.auriga.database.store.dmpk_elenchi_albi.store;

import it.eng.auriga.database.store.dmpk_elenchi_albi.bean.DmpkElenchiAlbiIurecelencoalboBean;
import it.eng.auriga.database.store.dmpk_elenchi_albi.store.impl.IurecelencoalboImpl;
 ...
 */
@Service(name="DmpkElenchiAlbiIurecelencoalbo")
public class Iurecelencoalbo {
		
	private DmpkElenchiAlbiIurecelencoalboBean bean;
		  
	public void setBean(DmpkElenchiAlbiIurecelencoalboBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkElenchiAlbiIurecelencoalboBean> execute(AurigaLoginBean lLoginBean, DmpkElenchiAlbiIurecelencoalboBean pBean) throws Exception{
	   final IurecelencoalboImpl lIurecelencoalbo = new IurecelencoalboImpl();
	   setBean(pBean);
	   lIurecelencoalbo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIurecelencoalbo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkElenchiAlbiIurecelencoalboBean> result = new StoreResultBean<DmpkElenchiAlbiIurecelencoalboBean>();
