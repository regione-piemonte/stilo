...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.StamparegistroImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocStamparegistro")
public class Stamparegistro {
	...
	public StoreResultBean<DmpkRegistrazionedocStamparegistroBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocStamparegistroBean pBean) throws Exception{
	   final StamparegistroImpl lStamparegistro = new StamparegistroImpl();
	   setBean(pBean);
	   lStamparegistro.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lStamparegistro.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocStamparegistroBean> result = new StoreResultBean<DmpkRegistrazionedocStamparegistroBean>();
