...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.IuregolaregautoImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailIuregolaregauto")
public class Iuregolaregauto {
	...
	public StoreResultBean<DmpkIntMgoEmailIuregolaregautoBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailIuregolaregautoBean pBean) throws Exception{
	   final IuregolaregautoImpl lIuregolaregauto = new IuregolaregautoImpl();
	   setBean(pBean);
	   lIuregolaregauto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuregolaregauto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailIuregolaregautoBean> result = new StoreResultBean<DmpkIntMgoEmailIuregolaregautoBean>();
