 ...
 */
@Service(name="DmpkWfStartflussowfforprocess")
public class Startflussowfforprocess {
	...
	public StoreResultBean<DmpkWfStartflussowfforprocessBean> execute(AurigaLoginBean lLoginBean, DmpkWfStartflussowfforprocessBean pBean) throws Exception{
	   final StartflussowfforprocessImpl lStartflussowfforprocess = new StartflussowfforprocessImpl();
	   setBean(pBean);
	   lStartflussowfforprocess.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lStartflussowfforprocess.execute(paramConnection);
				}
			});
