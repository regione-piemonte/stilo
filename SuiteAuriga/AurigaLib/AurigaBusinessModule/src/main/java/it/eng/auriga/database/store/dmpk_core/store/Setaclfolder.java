...
import it.eng.auriga.database.store.dmpk_core.store.impl.SetaclfolderImpl;
 ...
 */
@Service(name="DmpkCoreSetaclfolder")
public class Setaclfolder {
	...
	public StoreResultBean<DmpkCoreSetaclfolderBean> execute(AurigaLoginBean lLoginBean, DmpkCoreSetaclfolderBean pBean) throws Exception{
	   final SetaclfolderImpl lSetaclfolder = new SetaclfolderImpl();
	   setBean(pBean);
	   lSetaclfolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetaclfolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreSetaclfolderBean> result = new StoreResultBean<DmpkCoreSetaclfolderBean>();
