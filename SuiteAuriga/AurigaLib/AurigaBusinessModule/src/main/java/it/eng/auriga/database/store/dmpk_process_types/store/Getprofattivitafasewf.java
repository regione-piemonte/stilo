...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.GetprofattivitafasewfImpl;
 ...
 */
@Service(name="DmpkProcessTypesGetprofattivitafasewf")
public class Getprofattivitafasewf {
	...
	public StoreResultBean<DmpkProcessTypesGetprofattivitafasewfBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesGetprofattivitafasewfBean pBean) throws Exception{
	   final GetprofattivitafasewfImpl lGetprofattivitafasewf = new GetprofattivitafasewfImpl();
	   setBean(pBean);
	   lGetprofattivitafasewf.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetprofattivitafasewf.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesGetprofattivitafasewfBean> result = new StoreResultBean<DmpkProcessTypesGetprofattivitafasewfBean>();
