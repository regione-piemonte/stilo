...
import it.eng.auriga.database.store.dmpk_tipi_reg_num_ud.store.impl.IutiporegnumImpl;
 ...
 */
@Service(name="DmpkTipiRegNumUdIutiporegnum")
public class Iutiporegnum {
	...
	public StoreResultBean<DmpkTipiRegNumUdIutiporegnumBean> execute(AurigaLoginBean lLoginBean, DmpkTipiRegNumUdIutiporegnumBean pBean) throws Exception{
	   final IutiporegnumImpl lIutiporegnum = new IutiporegnumImpl();
	   setBean(pBean);
	   lIutiporegnum.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIutiporegnum.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTipiRegNumUdIutiporegnumBean> result = new StoreResultBean<DmpkTipiRegNumUdIutiporegnumBean>();
