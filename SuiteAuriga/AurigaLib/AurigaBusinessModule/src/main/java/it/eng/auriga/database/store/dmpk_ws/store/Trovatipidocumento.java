...
import it.eng.auriga.database.store.dmpk_ws.store.impl.TrovatipidocumentoImpl;
 ...
 */
@Service(name="DmpkWsTrovatipidocumento")
public class Trovatipidocumento {
		
	private DmpkWsTrovatipidocumentoBean bean;
		  
	public void setBean(DmpkWsTrovatipidocumentoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsTrovatipidocumentoBean> execute(AurigaLoginBean lLoginBean, DmpkWsTrovatipidocumentoBean pBean) throws Exception{
	   final TrovatipidocumentoImpl lTrovatipidocumento = new TrovatipidocumentoImpl();
	   setBean(pBean);
	   lTrovatipidocumento.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovatipidocumento.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsTrovatipidocumentoBean> result = new StoreResultBean<DmpkWsTrovatipidocumentoBean>();
