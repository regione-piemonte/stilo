...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.AccreditauserindominiologonImpl;
 ...
 */
@Service(name="DmpkDefSecurityAccreditauserindominiologon")
public class Accreditauserindominiologon {
		
	private DmpkDefSecurityAccreditauserindominiologonBean bean;
		  
	public void setBean(DmpkDefSecurityAccreditauserindominiologonBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityAccreditauserindominiologonBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityAccreditauserindominiologonBean pBean) throws Exception{
	   final AccreditauserindominiologonImpl lAccreditauserindominiologon = new AccreditauserindominiologonImpl();
	   setBean(pBean);
	   lAccreditauserindominiologon.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAccreditauserindominiologon.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityAccreditauserindominiologonBean> result = new StoreResultBean<DmpkDefSecurityAccreditauserindominiologonBean>();
