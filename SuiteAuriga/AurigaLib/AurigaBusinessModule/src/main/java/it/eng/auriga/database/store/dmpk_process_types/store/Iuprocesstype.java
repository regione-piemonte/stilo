...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.IuprocesstypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesIuprocesstype")
public class Iuprocesstype {
	...
	public StoreResultBean<DmpkProcessTypesIuprocesstypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesIuprocesstypeBean pBean) throws Exception{
	   final IuprocesstypeImpl lIuprocesstype = new IuprocesstypeImpl();
	   setBean(pBean);
	   lIuprocesstype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuprocesstype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesIuprocesstypeBean> result = new StoreResultBean<DmpkProcessTypesIuprocesstypeBean>();
