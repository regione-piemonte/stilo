...
import it.eng.auriga.database.store.dmpk_credential_vault.store.impl.GetconntokenImpl;
 ...
 */
@Service(name="DmpkCredentialVaultGetconntoken")
public class Getconntoken {
	...
	public StoreResultBean<DmpkCredentialVaultGetconntokenBean> execute(AurigaLoginBean lLoginBean, DmpkCredentialVaultGetconntokenBean pBean) throws Exception{
	   final GetconntokenImpl lGetconntoken = new GetconntokenImpl();
	   setBean(pBean);
	   lGetconntoken.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetconntoken.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCredentialVaultGetconntokenBean> result = new StoreResultBean<DmpkCredentialVaultGetconntokenBean>();
