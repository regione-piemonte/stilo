...
import it.eng.auriga.database.store.dmpk_ws.store.impl.TrovatipifolderImpl;
 ...
 */
@Service(name="DmpkWsTrovatipifolder")
public class Trovatipifolder {
		
	private DmpkWsTrovatipifolderBean bean;
		  
	public void setBean(DmpkWsTrovatipifolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsTrovatipifolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsTrovatipifolderBean pBean) throws Exception{
	   final TrovatipifolderImpl lTrovatipifolder = new TrovatipifolderImpl();
	   setBean(pBean);
	   lTrovatipifolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovatipifolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsTrovatipifolderBean> result = new StoreResultBean<DmpkWsTrovatipifolderBean>();
