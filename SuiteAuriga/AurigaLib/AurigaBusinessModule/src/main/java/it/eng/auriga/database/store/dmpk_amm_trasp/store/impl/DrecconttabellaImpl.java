...
public class DrecconttabellaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_AMM_TRASP.DRECCONTTABELLA(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"rectodeletein",5,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"motivoin",6,Types.VARCHAR,connection); 	
