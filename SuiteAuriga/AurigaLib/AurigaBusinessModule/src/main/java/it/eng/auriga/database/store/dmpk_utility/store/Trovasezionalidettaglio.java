...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityTrovasezionalidettaglioBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovasezionalidettaglioImpl;
 ...
 */
@Service(name="DmpkUtilityTrovasezionalidettaglio")
public class Trovasezionalidettaglio {
		
	private DmpkUtilityTrovasezionalidettaglioBean bean;
		  
	public void setBean(DmpkUtilityTrovasezionalidettaglioBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityTrovasezionalidettaglioBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovasezionalidettaglioBean pBean) throws Exception{
	   final TrovasezionalidettaglioImpl lTrovasezionalidettaglio = new TrovasezionalidettaglioImpl();
	   setBean(pBean);
	   lTrovasezionalidettaglio.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovasezionalidettaglio.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityTrovasezionalidettaglioBean> result = new StoreResultBean<DmpkUtilityTrovasezionalidettaglioBean>();
