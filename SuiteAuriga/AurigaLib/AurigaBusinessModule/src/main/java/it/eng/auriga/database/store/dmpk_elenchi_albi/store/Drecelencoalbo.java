...
import it.eng.auriga.database.store.dmpk_elenchi_albi.store.impl.DrecelencoalboImpl;
 ...
 */
@Service(name="DmpkElenchiAlbiDrecelencoalbo")
public class Drecelencoalbo {
		
	private DmpkElenchiAlbiDrecelencoalboBean bean;
		  
	public void setBean(DmpkElenchiAlbiDrecelencoalboBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkElenchiAlbiDrecelencoalboBean> execute(AurigaLoginBean lLoginBean, DmpkElenchiAlbiDrecelencoalboBean pBean) throws Exception{
	   final DrecelencoalboImpl lDrecelencoalbo = new DrecelencoalboImpl();
	   setBean(pBean);
	   lDrecelencoalbo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDrecelencoalbo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkElenchiAlbiDrecelencoalboBean> result = new StoreResultBean<DmpkElenchiAlbiDrecelencoalboBean>();
