...
import it.eng.auriga.database.store.dmpk_fatture.store.impl.GetidudtokenaddfatturaImpl;
 ...
 */
@Service(name="DmpkFattureGetidudtokenaddfattura")
public class Getidudtokenaddfattura {
	...
	public StoreResultBean<DmpkFattureGetidudtokenaddfatturaBean> execute(AurigaLoginBean lLoginBean, DmpkFattureGetidudtokenaddfatturaBean pBean) throws Exception{
	   final GetidudtokenaddfatturaImpl lGetidudtokenaddfattura = new GetidudtokenaddfatturaImpl();
	   setBean(pBean);
	   lGetidudtokenaddfattura.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetidudtokenaddfattura.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFattureGetidudtokenaddfatturaBean> result = new StoreResultBean<DmpkFattureGetidudtokenaddfatturaBean>();
