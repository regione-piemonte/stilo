...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.GetflgheaderrifnormativisezImpl;
 ...
 */
@Service(name="DmpkAmmTraspGetflgheaderrifnormativisez")
public class Getflgheaderrifnormativisez {
		
	private DmpkAmmTraspGetflgheaderrifnormativisezBean bean;
		  
	public void setBean(DmpkAmmTraspGetflgheaderrifnormativisezBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspGetflgheaderrifnormativisezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspGetflgheaderrifnormativisezBean pBean) throws Exception{
	   final GetflgheaderrifnormativisezImpl lGetflgheaderrifnormativisez = new GetflgheaderrifnormativisezImpl();
	   setBean(pBean);
	   lGetflgheaderrifnormativisez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetflgheaderrifnormativisez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspGetflgheaderrifnormativisezBean> result = new StoreResultBean<DmpkAmmTraspGetflgheaderrifnormativisezBean>();
