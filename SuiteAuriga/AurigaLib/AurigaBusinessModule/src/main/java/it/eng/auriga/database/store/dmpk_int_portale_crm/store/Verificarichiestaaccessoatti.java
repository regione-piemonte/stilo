...
import it.eng.auriga.database.store.dmpk_int_portale_crm.store.impl.VerificarichiestaaccessoattiImpl;
 ...
 */
@Service(name="DmpkIntPortaleCrmVerificarichiestaaccessoatti")
public class Verificarichiestaaccessoatti {
		
	private DmpkIntPortaleCrmVerificarichiestaaccessoattiBean bean;
		  
	public void setBean(DmpkIntPortaleCrmVerificarichiestaaccessoattiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntPortaleCrmVerificarichiestaaccessoattiBean> execute(AurigaLoginBean lLoginBean, DmpkIntPortaleCrmVerificarichiestaaccessoattiBean pBean) throws Exception{
	   final VerificarichiestaaccessoattiImpl lVerificarichiestaaccessoatti = new VerificarichiestaaccessoattiImpl();
	   setBean(pBean);
	   lVerificarichiestaaccessoatti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lVerificarichiestaaccessoatti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntPortaleCrmVerificarichiestaaccessoattiBean> result = new StoreResultBean<DmpkIntPortaleCrmVerificarichiestaaccessoattiBean>();
