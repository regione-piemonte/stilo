...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.SaveconvocazionesedutaImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollSaveconvocazioneseduta")
public class Saveconvocazioneseduta {
	...
	public StoreResultBean<DmpkSeduteOrgCollSaveconvocazionesedutaBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollSaveconvocazionesedutaBean pBean) throws Exception{
	   final SaveconvocazionesedutaImpl lSaveconvocazioneseduta = new SaveconvocazionesedutaImpl();
	   setBean(pBean);
	   lSaveconvocazioneseduta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSaveconvocazioneseduta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollSaveconvocazionesedutaBean> result = new StoreResultBean<DmpkSeduteOrgCollSaveconvocazionesedutaBean>();
