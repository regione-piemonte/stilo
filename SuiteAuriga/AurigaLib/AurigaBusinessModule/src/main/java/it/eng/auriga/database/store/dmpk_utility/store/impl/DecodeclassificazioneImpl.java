...
public class DecodeclassificazioneImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.DECODECLASSIFICAZIONE(?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"tipodecodificain",4,Types.VARCHAR,connection); 	
