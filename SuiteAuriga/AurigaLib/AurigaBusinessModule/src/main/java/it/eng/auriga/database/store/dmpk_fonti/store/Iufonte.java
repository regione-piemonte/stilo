 ...
 */
@Service(name="DmpkFontiIufonte")
public class Iufonte {
	...
	public StoreResultBean<DmpkFontiIufonteBean> execute(AurigaLoginBean lLoginBean, DmpkFontiIufonteBean pBean) throws Exception{
	   final IufonteImpl lIufonte = new IufonteImpl();
	   setBean(pBean);
	   lIufonte.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIufonte.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFontiIufonteBean> result = new StoreResultBean<DmpkFontiIufonteBean>();
