...
import it.eng.auriga.database.store.dmpk_processes.store.impl.SetsogginterniImpl;
 ...
 */
@Service(name="DmpkProcessesSetsogginterni")
public class Setsogginterni {
		
	private DmpkProcessesSetsogginterniBean bean;
		  
	public void setBean(DmpkProcessesSetsogginterniBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesSetsogginterniBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesSetsogginterniBean pBean) throws Exception{
	   final SetsogginterniImpl lSetsogginterni = new SetsogginterniImpl();
	   setBean(pBean);
	   lSetsogginterni.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetsogginterni.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesSetsogginterniBean> result = new StoreResultBean<DmpkProcessesSetsogginterniBean>();
