...
public class DgrupposoggrubricaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_ANAGRAFICA.DGRUPPOSOGGRUBRICA(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"callingfuncin",13,Types.VARCHAR,connection); 	
