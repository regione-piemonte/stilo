...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.TestshowfoldercontentallowedImpl;
 ...
 */
@Service(name="DmpkTitolarioTestshowfoldercontentallowed")
public class Testshowfoldercontentallowed {
		
	private DmpkTitolarioTestshowfoldercontentallowedBean bean;
		  
	public void setBean(DmpkTitolarioTestshowfoldercontentallowedBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkTitolarioTestshowfoldercontentallowedBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioTestshowfoldercontentallowedBean pBean) throws Exception{
	   final TestshowfoldercontentallowedImpl lTestshowfoldercontentallowed = new TestshowfoldercontentallowedImpl();
	   setBean(pBean);
	   lTestshowfoldercontentallowed.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTestshowfoldercontentallowed.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioTestshowfoldercontentallowedBean> result = new StoreResultBean<DmpkTitolarioTestshowfoldercontentallowedBean>();
