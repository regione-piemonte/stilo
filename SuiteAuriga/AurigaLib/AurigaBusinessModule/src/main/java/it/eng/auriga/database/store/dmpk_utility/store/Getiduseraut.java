...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityGetiduserautBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.GetiduserautImpl;
 ...
 */
@Service(name="DmpkUtilityGetiduseraut")
public class Getiduseraut {
		
	private DmpkUtilityGetiduserautBean bean;
		  
	public void setBean(DmpkUtilityGetiduserautBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityGetiduserautBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityGetiduserautBean pBean) throws Exception{
	   final GetiduserautImpl lGetiduseraut = new GetiduserautImpl();
	   setBean(pBean);
	   lGetiduseraut.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetiduseraut.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityGetiduserautBean> result = new StoreResultBean<DmpkUtilityGetiduserautBean>();
