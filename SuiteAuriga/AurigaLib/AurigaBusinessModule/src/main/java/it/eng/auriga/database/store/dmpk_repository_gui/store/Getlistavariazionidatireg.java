...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetlistavariazionidatiregImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetlistavariazionidatireg")
public class Getlistavariazionidatireg {
		
	private DmpkRepositoryGuiGetlistavariazionidatiregBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetlistavariazionidatiregBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetlistavariazionidatiregBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetlistavariazionidatiregBean pBean) throws Exception{
	   final GetlistavariazionidatiregImpl lGetlistavariazionidatireg = new GetlistavariazionidatiregImpl();
	   setBean(pBean);
	   lGetlistavariazionidatireg.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlistavariazionidatireg.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetlistavariazionidatiregBean> result = new StoreResultBean<DmpkRepositoryGuiGetlistavariazionidatiregBean>();
