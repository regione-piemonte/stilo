...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.LoaddettcontenutosezImpl;
 ...
 */
@Service(name="DmpkAmmTraspLoaddettcontenutosez")
public class Loaddettcontenutosez {
	...
	public StoreResultBean<DmpkAmmTraspLoaddettcontenutosezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspLoaddettcontenutosezBean pBean) throws Exception{
	   final LoaddettcontenutosezImpl lLoaddettcontenutosez = new LoaddettcontenutosezImpl();
	   setBean(pBean);
	   lLoaddettcontenutosez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettcontenutosez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspLoaddettcontenutosezBean> result = new StoreResultBean<DmpkAmmTraspLoaddettcontenutosezBean>();
