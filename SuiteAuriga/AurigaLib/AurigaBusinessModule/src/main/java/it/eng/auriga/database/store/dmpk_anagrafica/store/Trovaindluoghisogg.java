...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.TrovaindluoghisoggImpl;
 ...
 */
@Service(name="DmpkAnagraficaTrovaindluoghisogg")
public class Trovaindluoghisogg {
	...
	public StoreResultBean<DmpkAnagraficaTrovaindluoghisoggBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaTrovaindluoghisoggBean pBean) throws Exception{
	   final TrovaindluoghisoggImpl lTrovaindluoghisogg = new TrovaindluoghisoggImpl();
	   setBean(pBean);
	   lTrovaindluoghisogg.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaindluoghisogg.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaTrovaindluoghisoggBean> result = new StoreResultBean<DmpkAnagraficaTrovaindluoghisoggBean>();
