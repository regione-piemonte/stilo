...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.IueventtypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesIueventtype")
public class Iueventtype {
	...
	public StoreResultBean<DmpkProcessTypesIueventtypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesIueventtypeBean pBean) throws Exception{
	   final IueventtypeImpl lIueventtype = new IueventtypeImpl();
	   setBean(pBean);
	   lIueventtype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIueventtype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesIueventtypeBean> result = new StoreResultBean<DmpkProcessTypesIueventtypeBean>();
