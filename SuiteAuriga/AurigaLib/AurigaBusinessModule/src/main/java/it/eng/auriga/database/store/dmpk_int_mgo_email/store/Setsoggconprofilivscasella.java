...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.SetsoggconprofilivscasellaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailSetsoggconprofilivscasella")
public class Setsoggconprofilivscasella {
	...
	public StoreResultBean<DmpkIntMgoEmailSetsoggconprofilivscasellaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailSetsoggconprofilivscasellaBean pBean) throws Exception{
	   final SetsoggconprofilivscasellaImpl lSetsoggconprofilivscasella = new SetsoggconprofilivscasellaImpl();
	   setBean(pBean);
	   lSetsoggconprofilivscasella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetsoggconprofilivscasella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailSetsoggconprofilivscasellaBean> result = new StoreResultBean<DmpkIntMgoEmailSetsoggconprofilivscasellaBean>();
