...
import it.eng.auriga.database.store.dmpk_gestore.store.impl.Load_warningImpl;
 ...
 */
@Service(name="DmpkGestoreLoad_warning")
public class Load_warning {
	...
	public StoreResultBean<DmpkGestoreLoad_warningBean> execute(AurigaLoginBean lLoginBean, DmpkGestoreLoad_warningBean pBean) throws Exception{
	   final Load_warningImpl lLoad_warning = new Load_warningImpl();
	   setBean(pBean);
	   lLoad_warning.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoad_warning.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkGestoreLoad_warningBean> result = new StoreResultBean<DmpkGestoreLoad_warningBean>();
