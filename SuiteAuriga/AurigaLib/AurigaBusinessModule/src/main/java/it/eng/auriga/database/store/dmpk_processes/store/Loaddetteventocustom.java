...
import it.eng.auriga.database.store.dmpk_processes.store.impl.LoaddetteventocustomImpl;
 ...
 */
@Service(name="DmpkProcessesLoaddetteventocustom")
public class Loaddetteventocustom {
	...
	public StoreResultBean<DmpkProcessesLoaddetteventocustomBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesLoaddetteventocustomBean pBean) throws Exception{
	   final LoaddetteventocustomImpl lLoaddetteventocustom = new LoaddetteventocustomImpl();
	   setBean(pBean);
	   lLoaddetteventocustom.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddetteventocustom.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesLoaddetteventocustomBean> result = new StoreResultBean<DmpkProcessesLoaddetteventocustomBean>();
