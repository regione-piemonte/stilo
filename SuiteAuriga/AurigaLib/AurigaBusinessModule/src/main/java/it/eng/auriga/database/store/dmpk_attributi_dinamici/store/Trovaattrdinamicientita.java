...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.TrovaattrdinamicientitaImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciTrovaattrdinamicientita")
public class Trovaattrdinamicientita {
	...
	public StoreResultBean<DmpkAttributiDinamiciTrovaattrdinamicientitaBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciTrovaattrdinamicientitaBean pBean) throws Exception{
	   final TrovaattrdinamicientitaImpl lTrovaattrdinamicientita = new TrovaattrdinamicientitaImpl();
	   setBean(pBean);
	   lTrovaattrdinamicientita.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaattrdinamicientita.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciTrovaattrdinamicientitaBean> result = new StoreResultBean<DmpkAttributiDinamiciTrovaattrdinamicientitaBean>();
