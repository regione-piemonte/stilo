...
public class SetsezcacheflussonavImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.SETSEZCACHEFLUSSONAV(?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"variabiliin",4,Types.CLOB,connection); 	
