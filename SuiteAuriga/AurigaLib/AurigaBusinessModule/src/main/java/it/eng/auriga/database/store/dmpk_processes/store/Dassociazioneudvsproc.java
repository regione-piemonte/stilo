...
import it.eng.auriga.database.store.dmpk_processes.store.impl.DassociazioneudvsprocImpl;
 ...
 */
@Service(name="DmpkProcessesDassociazioneudvsproc")
public class Dassociazioneudvsproc {
		
	private DmpkProcessesDassociazioneudvsprocBean bean;
		  
	public void setBean(DmpkProcessesDassociazioneudvsprocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesDassociazioneudvsprocBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesDassociazioneudvsprocBean pBean) throws Exception{
	   final DassociazioneudvsprocImpl lDassociazioneudvsproc = new DassociazioneudvsprocImpl();
	   setBean(pBean);
	   lDassociazioneudvsproc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDassociazioneudvsproc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesDassociazioneudvsprocBean> result = new StoreResultBean<DmpkProcessesDassociazioneudvsprocBean>();
