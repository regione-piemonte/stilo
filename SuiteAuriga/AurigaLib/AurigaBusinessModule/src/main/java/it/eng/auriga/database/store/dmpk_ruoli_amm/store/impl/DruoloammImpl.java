...
public class DruoloammImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_RUOLI_AMM.DRUOLOAMM(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idruoloin",4,Types.DECIMAL,connection); 	
