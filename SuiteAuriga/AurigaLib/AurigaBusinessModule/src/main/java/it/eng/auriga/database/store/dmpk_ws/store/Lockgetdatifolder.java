...
import it.eng.auriga.database.store.dmpk_ws.store.impl.LockgetdatifolderImpl;
 ...
 */
@Service(name="DmpkWsLockgetdatifolder")
public class Lockgetdatifolder {
		
	private DmpkWsLockgetdatifolderBean bean;
		  
	public void setBean(DmpkWsLockgetdatifolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsLockgetdatifolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsLockgetdatifolderBean pBean) throws Exception{
	   final LockgetdatifolderImpl lLockgetdatifolder = new LockgetdatifolderImpl();
	   setBean(pBean);
	   lLockgetdatifolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLockgetdatifolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsLockgetdatifolderBean> result = new StoreResultBean<DmpkWsLockgetdatifolderBean>();
