...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturazutentiBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturazutentiImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturazutenti")
public class Trovareportfatturazutenti {
		
	private DmpkEfactTrovareportfatturazutentiBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturazutentiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturazutentiBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturazutentiBean pBean) throws Exception{
	   final TrovareportfatturazutentiImpl lTrovareportfatturazutenti = new TrovareportfatturazutentiImpl();
	   setBean(pBean);
	   lTrovareportfatturazutenti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturazutenti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturazutentiBean> result = new StoreResultBean<DmpkEfactTrovareportfatturazutentiBean>();
