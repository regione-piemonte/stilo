...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.PreparainvionotificaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailPreparainvionotifica")
public class Preparainvionotifica {
	...
	public StoreResultBean<DmpkIntMgoEmailPreparainvionotificaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailPreparainvionotificaBean pBean) throws Exception{
	   final PreparainvionotificaImpl lPreparainvionotifica = new PreparainvionotificaImpl();
	   setBean(pBean);
	   lPreparainvionotifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lPreparainvionotifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailPreparainvionotificaBean> result = new StoreResultBean<DmpkIntMgoEmailPreparainvionotificaBean>();
