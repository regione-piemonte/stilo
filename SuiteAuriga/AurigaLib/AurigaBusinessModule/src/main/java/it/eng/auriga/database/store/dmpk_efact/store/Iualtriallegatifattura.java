...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactIualtriallegatifatturaBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.IualtriallegatifatturaImpl;
 ...
 */
@Service(name="DmpkEfactIualtriallegatifattura")
public class Iualtriallegatifattura {
		
	private DmpkEfactIualtriallegatifatturaBean bean;
		  
	public void setBean(DmpkEfactIualtriallegatifatturaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactIualtriallegatifatturaBean> execute(AurigaLoginBean lLoginBean, DmpkEfactIualtriallegatifatturaBean pBean) throws Exception{
	   final IualtriallegatifatturaImpl lIualtriallegatifattura = new IualtriallegatifatturaImpl();
	   setBean(pBean);
	   lIualtriallegatifattura.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIualtriallegatifattura.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactIualtriallegatifatturaBean> result = new StoreResultBean<DmpkEfactIualtriallegatifatturaBean>();
