...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.AggdestinvioinrubricaemailImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailAggdestinvioinrubricaemail")
public class Aggdestinvioinrubricaemail {
		
	private DmpkIntMgoEmailAggdestinvioinrubricaemailBean bean;
		  
	public void setBean(DmpkIntMgoEmailAggdestinvioinrubricaemailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailAggdestinvioinrubricaemailBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailAggdestinvioinrubricaemailBean pBean) throws Exception{
	   final AggdestinvioinrubricaemailImpl lAggdestinvioinrubricaemail = new AggdestinvioinrubricaemailImpl();
	   setBean(pBean);
	   lAggdestinvioinrubricaemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAggdestinvioinrubricaemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailAggdestinvioinrubricaemailBean> result = new StoreResultBean<DmpkIntMgoEmailAggdestinvioinrubricaemailBean>();
