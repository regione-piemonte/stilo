...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.ExplodetreenodeImpl;
 ...
 */
@Service(name="DmpkDefSecurityExplodetreenode")
public class Explodetreenode {
		
	private DmpkDefSecurityExplodetreenodeBean bean;
		  
	public void setBean(DmpkDefSecurityExplodetreenodeBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityExplodetreenodeBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityExplodetreenodeBean pBean) throws Exception{
	   final ExplodetreenodeImpl lExplodetreenode = new ExplodetreenodeImpl();
	   setBean(pBean);
	   lExplodetreenode.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lExplodetreenode.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityExplodetreenodeBean> result = new StoreResultBean<DmpkDefSecurityExplodetreenodeBean>();
