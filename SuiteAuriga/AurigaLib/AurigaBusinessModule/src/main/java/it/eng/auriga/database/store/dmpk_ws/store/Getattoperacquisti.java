...
import it.eng.auriga.database.store.dmpk_ws.store.impl.GetattoperacquistiImpl;
 ...
 */
@Service(name="DmpkWsGetattoperacquisti")
public class Getattoperacquisti {
		
	private DmpkWsGetattoperacquistiBean bean;
		  
	public void setBean(DmpkWsGetattoperacquistiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsGetattoperacquistiBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetattoperacquistiBean pBean) throws Exception{
	   final GetattoperacquistiImpl lGetattoperacquisti = new GetattoperacquistiImpl();
	   setBean(pBean);
	   lGetattoperacquisti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetattoperacquisti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetattoperacquistiBean> result = new StoreResultBean<DmpkWsGetattoperacquistiBean>();
