...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.IueventoderivatoImpl;
 ...
 */
@Service(name="DmpkProcessTypesIueventoderivato")
public class Iueventoderivato {
	...
	public StoreResultBean<DmpkProcessTypesIueventoderivatoBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesIueventoderivatoBean pBean) throws Exception{
	   final IueventoderivatoImpl lIueventoderivato = new IueventoderivatoImpl();
	   setBean(pBean);
	   lIueventoderivato.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIueventoderivato.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesIueventoderivatoBean> result = new StoreResultBean<DmpkProcessTypesIueventoderivatoBean>();
