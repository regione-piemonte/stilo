...
import it.eng.auriga.database.store.dmpk_wf.store.impl.GetdatinuovoiterattocomecopiaImpl;
 ...
 */
@Service(name="DmpkWfGetdatinuovoiterattocomecopia")
public class Getdatinuovoiterattocomecopia {
	...
	public StoreResultBean<DmpkWfGetdatinuovoiterattocomecopiaBean> execute(AurigaLoginBean lLoginBean, DmpkWfGetdatinuovoiterattocomecopiaBean pBean) throws Exception{
	   final GetdatinuovoiterattocomecopiaImpl lGetdatinuovoiterattocomecopia = new GetdatinuovoiterattocomecopiaImpl();
	   setBean(pBean);
	   lGetdatinuovoiterattocomecopia.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatinuovoiterattocomecopia.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfGetdatinuovoiterattocomecopiaBean> result = new StoreResultBean<DmpkWfGetdatinuovoiterattocomecopiaBean>();
