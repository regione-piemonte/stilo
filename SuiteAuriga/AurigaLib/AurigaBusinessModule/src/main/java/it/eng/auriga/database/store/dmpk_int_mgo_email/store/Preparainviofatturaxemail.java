...
import it.eng.auriga.database.store.dmpk_int_mgo_email.bean.DmpkIntMgoEmailPreparainviofatturaxemailBean;
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.PreparainviofatturaxemailImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailPreparainviofatturaxemail")
public class Preparainviofatturaxemail {
		
	private DmpkIntMgoEmailPreparainviofatturaxemailBean bean;
		  
	public void setBean(DmpkIntMgoEmailPreparainviofatturaxemailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailPreparainviofatturaxemailBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailPreparainviofatturaxemailBean pBean) throws Exception{
	   final PreparainviofatturaxemailImpl lPreparainviofatturaxemail = new PreparainviofatturaxemailImpl();
	   setBean(pBean);
	   lPreparainviofatturaxemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lPreparainviofatturaxemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailPreparainviofatturaxemailBean> result = new StoreResultBean<DmpkIntMgoEmailPreparainviofatturaxemailBean>();
