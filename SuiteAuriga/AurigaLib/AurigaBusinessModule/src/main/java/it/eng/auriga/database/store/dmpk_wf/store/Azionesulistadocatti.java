...
import it.eng.auriga.database.store.dmpk_wf.store.impl.AzionesulistadocattiImpl;
 ...
 */
@Service(name="DmpkWfAzionesulistadocatti")
public class Azionesulistadocatti {
		
	private DmpkWfAzionesulistadocattiBean bean;
		  
	public void setBean(DmpkWfAzionesulistadocattiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWfAzionesulistadocattiBean> execute(AurigaLoginBean lLoginBean, DmpkWfAzionesulistadocattiBean pBean) throws Exception{
	   final AzionesulistadocattiImpl lAzionesulistadocatti = new AzionesulistadocattiImpl();
	   setBean(pBean);
	   lAzionesulistadocatti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAzionesulistadocatti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfAzionesulistadocattiBean> result = new StoreResultBean<DmpkWfAzionesulistadocattiBean>();
