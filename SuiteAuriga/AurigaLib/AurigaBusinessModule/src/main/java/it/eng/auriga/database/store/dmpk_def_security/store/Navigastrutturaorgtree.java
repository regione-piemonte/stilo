...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.NavigastrutturaorgtreeImpl;
 ...
 */
@Service(name="DmpkDefSecurityNavigastrutturaorgtree")
public class Navigastrutturaorgtree {
	...
	public StoreResultBean<DmpkDefSecurityNavigastrutturaorgtreeBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityNavigastrutturaorgtreeBean pBean) throws Exception{
	   final NavigastrutturaorgtreeImpl lNavigastrutturaorgtree = new NavigastrutturaorgtreeImpl();
	   setBean(pBean);
	   lNavigastrutturaorgtree.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lNavigastrutturaorgtree.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityNavigastrutturaorgtreeBean> result = new StoreResultBean<DmpkDefSecurityNavigastrutturaorgtreeBean>();
