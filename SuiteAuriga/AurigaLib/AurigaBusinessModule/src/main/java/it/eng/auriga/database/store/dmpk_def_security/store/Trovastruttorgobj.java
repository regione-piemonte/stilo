...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TrovastruttorgobjImpl;
 ...
 */
@Service(name="DmpkDefSecurityTrovastruttorgobj")
public class Trovastruttorgobj {
	...
	public StoreResultBean<DmpkDefSecurityTrovastruttorgobjBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTrovastruttorgobjBean pBean) throws Exception{
	   final TrovastruttorgobjImpl lTrovastruttorgobj = new TrovastruttorgobjImpl();
	   setBean(pBean);
	   lTrovastruttorgobj.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovastruttorgobj.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTrovastruttorgobjBean> result = new StoreResultBean<DmpkDefSecurityTrovastruttorgobjBean>();
