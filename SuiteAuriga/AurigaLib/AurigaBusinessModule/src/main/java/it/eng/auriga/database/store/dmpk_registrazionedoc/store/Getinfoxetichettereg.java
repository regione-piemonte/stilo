...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.GetinfoxetichetteregImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocGetinfoxetichettereg")
public class Getinfoxetichettereg {
		
	private DmpkRegistrazionedocGetinfoxetichetteregBean bean;
		  
	public void setBean(DmpkRegistrazionedocGetinfoxetichetteregBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocGetinfoxetichetteregBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocGetinfoxetichetteregBean pBean) throws Exception{
	   final GetinfoxetichetteregImpl lGetinfoxetichettereg = new GetinfoxetichetteregImpl();
	   setBean(pBean);
	   lGetinfoxetichettereg.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinfoxetichettereg.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocGetinfoxetichetteregBean> result = new StoreResultBean<DmpkRegistrazionedocGetinfoxetichetteregBean>();
