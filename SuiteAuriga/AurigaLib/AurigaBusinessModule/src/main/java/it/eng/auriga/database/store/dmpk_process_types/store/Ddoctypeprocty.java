...
import it.eng.auriga.database.store.dmpk_process_types.bean.DmpkProcessTypesDdoctypeproctyBean;
import it.eng.auriga.database.store.dmpk_process_types.store.impl.DdoctypeproctyImpl;
 ...
 */
@Service(name="DmpkProcessTypesDdoctypeprocty")
public class Ddoctypeprocty {
		
	private DmpkProcessTypesDdoctypeproctyBean bean;
		  
	public void setBean(DmpkProcessTypesDdoctypeproctyBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessTypesDdoctypeproctyBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesDdoctypeproctyBean pBean) throws Exception{
	   final DdoctypeproctyImpl lDdoctypeprocty = new DdoctypeproctyImpl();
	   setBean(pBean);
	   lDdoctypeprocty.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDdoctypeprocty.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesDdoctypeproctyBean> result = new StoreResultBean<DmpkProcessTypesDdoctypeproctyBean>();
