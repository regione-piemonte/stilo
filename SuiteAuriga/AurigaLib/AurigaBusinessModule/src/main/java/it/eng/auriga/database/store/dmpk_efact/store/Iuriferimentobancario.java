...
import it.eng.auriga.database.store.dmpk_efact.store.impl.IuriferimentobancarioImpl;
 ...
 */
@Service(name="DmpkEfactIuriferimentobancario")
public class Iuriferimentobancario {
	...
	public StoreResultBean<DmpkEfactIuriferimentobancarioBean> execute(AurigaLoginBean lLoginBean, DmpkEfactIuriferimentobancarioBean pBean) throws Exception{
	   final IuriferimentobancarioImpl lIuriferimentobancario = new IuriferimentobancarioImpl();
	   setBean(pBean);
	   lIuriferimentobancario.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuriferimentobancario.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactIuriferimentobancarioBean> result = new StoreResultBean<DmpkEfactIuriferimentobancarioBean>();
