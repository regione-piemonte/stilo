...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetudcollegateImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetudcollegate")
public class Getudcollegate {
		
	private DmpkRepositoryGuiGetudcollegateBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetudcollegateBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetudcollegateBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetudcollegateBean pBean) throws Exception{
	   final GetudcollegateImpl lGetudcollegate = new GetudcollegateImpl();
	   setBean(pBean);
	   lGetudcollegate.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetudcollegate.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetudcollegateBean> result = new StoreResultBean<DmpkRepositoryGuiGetudcollegateBean>();
