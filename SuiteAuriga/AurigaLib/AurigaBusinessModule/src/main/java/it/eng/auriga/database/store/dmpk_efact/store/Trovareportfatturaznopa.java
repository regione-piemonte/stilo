...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturaznopaBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturaznopaImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturaznopa")
public class Trovareportfatturaznopa {
		
	private DmpkEfactTrovareportfatturaznopaBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturaznopaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturaznopaBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturaznopaBean pBean) throws Exception{
	   final TrovareportfatturaznopaImpl lTrovareportfatturaznopa = new TrovareportfatturaznopaImpl();
	   setBean(pBean);
	   lTrovareportfatturaznopa.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturaznopa.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturaznopaBean> result = new StoreResultBean<DmpkEfactTrovareportfatturaznopaBean>();
