 ...
 */
@Service(name="DmpkProcessesSetobjprocessfor")
public class Setobjprocessfor {
		
	private DmpkProcessesSetobjprocessforBean bean;
		  
	public void setBean(DmpkProcessesSetobjprocessforBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesSetobjprocessforBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesSetobjprocessforBean pBean) throws Exception{
	   final SetobjprocessforImpl lSetobjprocessfor = new SetobjprocessforImpl();
	   setBean(pBean);
	   lSetobjprocessfor.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetobjprocessfor.execute(paramConnection);
				}
			});
