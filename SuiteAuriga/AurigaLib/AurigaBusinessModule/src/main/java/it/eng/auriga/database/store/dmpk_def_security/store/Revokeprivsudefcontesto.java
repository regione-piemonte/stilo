...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.RevokeprivsudefcontestoImpl;
 ...
 */
@Service(name="DmpkDefSecurityRevokeprivsudefcontesto")
public class Revokeprivsudefcontesto {
	...
	public StoreResultBean<DmpkDefSecurityRevokeprivsudefcontestoBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityRevokeprivsudefcontestoBean pBean) throws Exception{
	   final RevokeprivsudefcontestoImpl lRevokeprivsudefcontesto = new RevokeprivsudefcontestoImpl();
	   setBean(pBean);
	   lRevokeprivsudefcontesto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRevokeprivsudefcontesto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityRevokeprivsudefcontestoBean> result = new StoreResultBean<DmpkDefSecurityRevokeprivsudefcontestoBean>();
