...
import it.eng.auriga.database.store.dmpk_core.store.impl.GetprofilodocxcontainerImpl;
 ...
 */
@Service(name="DmpkCoreGetprofilodocxcontainer")
public class Getprofilodocxcontainer {
	...
	public StoreResultBean<DmpkCoreGetprofilodocxcontainerBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetprofilodocxcontainerBean pBean) throws Exception{
	   final GetprofilodocxcontainerImpl lGetprofilodocxcontainer = new GetprofilodocxcontainerImpl();
	   setBean(pBean);
	   lGetprofilodocxcontainer.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetprofilodocxcontainer.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGetprofilodocxcontainerBean> result = new StoreResultBean<DmpkCoreGetprofilodocxcontainerBean>();
