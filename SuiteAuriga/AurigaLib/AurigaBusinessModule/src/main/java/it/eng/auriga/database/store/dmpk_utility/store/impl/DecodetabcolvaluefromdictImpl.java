...
public class DecodetabcolvaluefromdictImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.DECODETABCOLVALUEFROMDICT(?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"codicein",6,Types.VARCHAR,connection); 	
