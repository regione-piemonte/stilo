...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.AssociapuntiprotocolloImpl;
 ...
 */
@Service(name="DmpkDefSecurityAssociapuntiprotocollo")
public class Associapuntiprotocollo {
		
	private DmpkDefSecurityAssociapuntiprotocolloBean bean;
		  
	public void setBean(DmpkDefSecurityAssociapuntiprotocolloBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityAssociapuntiprotocolloBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityAssociapuntiprotocolloBean pBean) throws Exception{
	   final AssociapuntiprotocolloImpl lAssociapuntiprotocollo = new AssociapuntiprotocolloImpl();
	   setBean(pBean);
	   lAssociapuntiprotocollo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAssociapuntiprotocollo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityAssociapuntiprotocolloBean> result = new StoreResultBean<DmpkDefSecurityAssociapuntiprotocolloBean>();
