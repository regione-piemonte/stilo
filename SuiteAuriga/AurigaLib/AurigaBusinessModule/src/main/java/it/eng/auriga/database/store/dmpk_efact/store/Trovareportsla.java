...
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportslaImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportsla")
public class Trovareportsla {
	...
	public StoreResultBean<DmpkEfactTrovareportslaBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportslaBean pBean) throws Exception{
	   final TrovareportslaImpl lTrovareportsla = new TrovareportslaImpl();
	   setBean(pBean);
	   lTrovareportsla.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportsla.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportslaBean> result = new StoreResultBean<DmpkEfactTrovareportslaBean>();
