...
import it.eng.auriga.database.store.dmpk_processes.store.impl.TrovaprocessudImpl;
 ...
 */
@Service(name="DmpkProcessesTrovaprocessud")
public class Trovaprocessud {
	...
	public StoreResultBean<DmpkProcessesTrovaprocessudBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesTrovaprocessudBean pBean) throws Exception{
	   final TrovaprocessudImpl lTrovaprocessud = new TrovaprocessudImpl();
	   setBean(pBean);
	   lTrovaprocessud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaprocessud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesTrovaprocessudBean> result = new StoreResultBean<DmpkProcessesTrovaprocessudBean>();
