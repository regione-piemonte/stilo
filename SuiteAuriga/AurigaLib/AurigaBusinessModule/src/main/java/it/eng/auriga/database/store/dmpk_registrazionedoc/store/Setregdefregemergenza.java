...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.SetregdefregemergenzaImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocSetregdefregemergenza")
public class Setregdefregemergenza {
		
	private DmpkRegistrazionedocSetregdefregemergenzaBean bean;
		  
	public void setBean(DmpkRegistrazionedocSetregdefregemergenzaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocSetregdefregemergenzaBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocSetregdefregemergenzaBean pBean) throws Exception{
	   final SetregdefregemergenzaImpl lSetregdefregemergenza = new SetregdefregemergenzaImpl();
	   setBean(pBean);
	   lSetregdefregemergenza.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetregdefregemergenza.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocSetregdefregemergenzaBean> result = new StoreResultBean<DmpkRegistrazionedocSetregdefregemergenzaBean>();
