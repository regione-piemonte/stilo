...
import it.eng.auriga.database.store.dmpk_core.store.impl.RemovefromfavouritesImpl;
 ...
 */
@Service(name="DmpkCoreRemovefromfavourites")
public class Removefromfavourites {
	...
	public StoreResultBean<DmpkCoreRemovefromfavouritesBean> execute(AurigaLoginBean lLoginBean, DmpkCoreRemovefromfavouritesBean pBean) throws Exception{
	   final RemovefromfavouritesImpl lRemovefromfavourites = new RemovefromfavouritesImpl();
	   setBean(pBean);
	   lRemovefromfavourites.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRemovefromfavourites.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreRemovefromfavouritesBean> result = new StoreResultBean<DmpkCoreRemovefromfavouritesBean>();
