...
public class ToglidagrupposoggintImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DEF_SECURITY.TOGLIDAGRUPPOSOGGINT(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"membridatoglierexmlin",6,Types.CLOB,connection); 	
