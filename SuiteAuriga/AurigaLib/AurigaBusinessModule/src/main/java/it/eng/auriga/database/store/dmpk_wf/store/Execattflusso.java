 ...
 */
@Service(name="DmpkWfExecattflusso")
public class Execattflusso {
	...
	public StoreResultBean<DmpkWfExecattflussoBean> execute(AurigaLoginBean lLoginBean, DmpkWfExecattflussoBean pBean) throws Exception{
	   final ExecattflussoImpl lExecattflusso = new ExecattflussoImpl();
	   setBean(pBean);
	   lExecattflusso.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lExecattflusso.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfExecattflussoBean> result = new StoreResultBean<DmpkWfExecattflussoBean>();
