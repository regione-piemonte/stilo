...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityFindproctypedaavviareBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.FindproctypedaavviareImpl;
 ...
 */
@Service(name="DmpkUtilityFindproctypedaavviare")
public class Findproctypedaavviare {
		
	private DmpkUtilityFindproctypedaavviareBean bean;
		  
	public void setBean(DmpkUtilityFindproctypedaavviareBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityFindproctypedaavviareBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityFindproctypedaavviareBean pBean) throws Exception{
	   final FindproctypedaavviareImpl lFindproctypedaavviare = new FindproctypedaavviareImpl();
	   setBean(pBean);
	   lFindproctypedaavviare.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lFindproctypedaavviare.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityFindproctypedaavviareBean> result = new StoreResultBean<DmpkUtilityFindproctypedaavviareBean>();
