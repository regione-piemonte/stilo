...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.GetetichetteconinddestImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocGetetichetteconinddest")
public class Getetichetteconinddest {
		
	private DmpkRegistrazionedocGetetichetteconinddestBean bean;
		  
	public void setBean(DmpkRegistrazionedocGetetichetteconinddestBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocGetetichetteconinddestBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocGetetichetteconinddestBean pBean) throws Exception{
	   final GetetichetteconinddestImpl lGetetichetteconinddest = new GetetichetteconinddestImpl();
	   setBean(pBean);
	   lGetetichetteconinddest.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetetichetteconinddest.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocGetetichetteconinddestBean> result = new StoreResultBean<DmpkRegistrazionedocGetetichetteconinddestBean>();
