...
public class DclassificaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_TITOLARIO.DCLASSIFICA(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idclassificazioneinin",4,Types.DECIMAL,connection); 	
