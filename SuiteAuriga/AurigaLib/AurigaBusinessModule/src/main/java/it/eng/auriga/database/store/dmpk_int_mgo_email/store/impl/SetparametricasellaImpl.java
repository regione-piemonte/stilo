...
public class SetparametricasellaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_MGO_EMAIL.SETPARAMETRICASELLA(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"xmlparametriin",5,Types.CLOB,connection); 	
