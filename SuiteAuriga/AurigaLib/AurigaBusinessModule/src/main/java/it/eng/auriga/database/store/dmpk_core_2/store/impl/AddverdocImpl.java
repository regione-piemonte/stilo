...
public class AddverdocImpl  {
	...
	public void execute(Connection connection) throws SQLException {
	    try{
			...
			CallableStatement call = connection.prepareCall("{? = call DMPK_CORE_2.ADDVERDOC(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"attributiverxmlin",5,Types.CLOB,connection); 	
