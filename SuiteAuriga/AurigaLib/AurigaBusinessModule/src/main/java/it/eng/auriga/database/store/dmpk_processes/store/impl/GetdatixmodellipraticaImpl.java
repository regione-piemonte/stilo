...
public class GetdatixmodellipraticaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESSES.GETDATIXMODELLIPRATICA(?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"datimodellixmlout",5,Types.CLOB); 
