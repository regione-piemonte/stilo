 ...
 */
@Service(name="DmpkCoreUpdverdoc")
public class Updverdoc {
		
	private DmpkCoreUpdverdocBean bean;
		  
	public void setBean(DmpkCoreUpdverdocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreUpdverdocBean> execute(AurigaLoginBean lLoginBean, DmpkCoreUpdverdocBean pBean) throws Exception{
	   final UpdverdocImpl lUpdverdoc = new UpdverdocImpl();
	   setBean(pBean);
	   lUpdverdoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUpdverdoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreUpdverdocBean> result = new StoreResultBean<DmpkCoreUpdverdocBean>();
