...
import it.eng.auriga.database.store.dmpk_tipi_reg_num_ud.store.impl.TrovatipiregnumImpl;
 ...
 */
@Service(name="DmpkTipiRegNumUdTrovatipiregnum")
public class Trovatipiregnum {
	...
	public StoreResultBean<DmpkTipiRegNumUdTrovatipiregnumBean> execute(AurigaLoginBean lLoginBean, DmpkTipiRegNumUdTrovatipiregnumBean pBean) throws Exception{
	   final TrovatipiregnumImpl lTrovatipiregnum = new TrovatipiregnumImpl();
	   setBean(pBean);
	   lTrovatipiregnum.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovatipiregnum.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTipiRegNumUdTrovatipiregnumBean> result = new StoreResultBean<DmpkTipiRegNumUdTrovatipiregnumBean>();
