...
public class FindfoldertypeImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.FINDFOLDERTYPE(?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idfoldertypein",3,Types.DECIMAL,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"nomefoldertypein",4,Types.VARCHAR,connection); 	
