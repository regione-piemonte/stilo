 ...
 */
@Service(name="DmpkBmanagerIufoglioximport")
public class Iufoglioximport {
	...
	public StoreResultBean<DmpkBmanagerIufoglioximportBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerIufoglioximportBean pBean) throws Exception{
	   final IufoglioximportImpl lIufoglioximport = new IufoglioximportImpl();
	   setBean(pBean);
	   lIufoglioximport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkBmanagerIufoglioximportBean> result = new StoreResultBean<DmpkBmanagerIufoglioximportBean>();
