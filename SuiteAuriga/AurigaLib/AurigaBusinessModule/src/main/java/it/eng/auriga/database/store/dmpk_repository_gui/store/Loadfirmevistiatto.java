...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.LoadfirmevistiattoImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiLoadfirmevistiatto")
public class Loadfirmevistiatto {
		
	private DmpkRepositoryGuiLoadfirmevistiattoBean bean;
		  
	public void setBean(DmpkRepositoryGuiLoadfirmevistiattoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiLoadfirmevistiattoBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiLoadfirmevistiattoBean pBean) throws Exception{
	   final LoadfirmevistiattoImpl lLoadfirmevistiatto = new LoadfirmevistiattoImpl();
	   setBean(pBean);
	   lLoadfirmevistiatto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadfirmevistiatto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiLoadfirmevistiattoBean> result = new StoreResultBean<DmpkRepositoryGuiLoadfirmevistiattoBean>();
