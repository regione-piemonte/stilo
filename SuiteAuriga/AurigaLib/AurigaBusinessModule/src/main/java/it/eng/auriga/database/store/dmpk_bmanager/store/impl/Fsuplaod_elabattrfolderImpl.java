...
public class Fsuplaod_elabattrfolderImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_BMANAGER.FSUPLAOD_ELABATTRFOLDER(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlattrtosetout",5,Types.CLOB); 
