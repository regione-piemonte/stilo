...
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportsladettaglioImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportsladettaglio")
public class Trovareportsladettaglio {
	...
	public StoreResultBean<DmpkEfactTrovareportsladettaglioBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportsladettaglioBean pBean) throws Exception{
	   final TrovareportsladettaglioImpl lTrovareportsladettaglio = new TrovareportsladettaglioImpl();
	   setBean(pBean);
	   lTrovareportsladettaglio.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportsladettaglio.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportsladettaglioBean> result = new StoreResultBean<DmpkEfactTrovareportsladettaglioBean>();
