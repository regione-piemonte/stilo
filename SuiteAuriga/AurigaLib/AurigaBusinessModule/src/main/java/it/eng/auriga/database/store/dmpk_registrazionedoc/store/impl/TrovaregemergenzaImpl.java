...
public class TrovaregemergenzaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_REGISTRAZIONEDOC.TROVAREGEMERGENZA(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"filtrixmlin",4,Types.CLOB,connection); 	
