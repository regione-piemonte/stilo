 ...
 */
@Service(name="DmpkCoreDel_ud_doc_ver")
public class Del_ud_doc_ver {
	...
	public StoreResultBean<DmpkCoreDel_ud_doc_verBean> execute(AurigaLoginBean lLoginBean, DmpkCoreDel_ud_doc_verBean pBean) throws Exception{
	   final Del_ud_doc_verImpl lDel_ud_doc_ver = new Del_ud_doc_verImpl();
	   setBean(pBean);
	   lDel_ud_doc_ver.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDel_ud_doc_ver.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreDel_ud_doc_verBean> result = new StoreResultBean<DmpkCoreDel_ud_doc_verBean>();
