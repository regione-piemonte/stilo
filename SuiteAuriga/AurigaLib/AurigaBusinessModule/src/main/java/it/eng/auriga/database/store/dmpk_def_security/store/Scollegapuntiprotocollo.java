...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.ScollegapuntiprotocolloImpl;
 ...
 */
@Service(name="DmpkDefSecurityScollegapuntiprotocollo")
public class Scollegapuntiprotocollo {
		
	private DmpkDefSecurityScollegapuntiprotocolloBean bean;
		  
	public void setBean(DmpkDefSecurityScollegapuntiprotocolloBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityScollegapuntiprotocolloBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityScollegapuntiprotocolloBean pBean) throws Exception{
	   final ScollegapuntiprotocolloImpl lScollegapuntiprotocollo = new ScollegapuntiprotocolloImpl();
	   setBean(pBean);
	   lScollegapuntiprotocollo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lScollegapuntiprotocollo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityScollegapuntiprotocolloBean> result = new StoreResultBean<DmpkDefSecurityScollegapuntiprotocolloBean>();
