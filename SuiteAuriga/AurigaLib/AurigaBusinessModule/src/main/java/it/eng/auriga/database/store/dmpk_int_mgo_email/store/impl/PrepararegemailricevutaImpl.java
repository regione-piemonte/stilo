...
public class PrepararegemailricevutaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_MGO_EMAIL.PREPARAREGEMAILRICEVUTA(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmldatiudout",6,Types.CLOB); 
