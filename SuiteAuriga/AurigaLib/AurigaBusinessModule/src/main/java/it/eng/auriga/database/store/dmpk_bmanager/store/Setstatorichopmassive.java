...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.SetstatorichopmassiveImpl;
 ...
 */
@Service(name="DmpkBmanagerSetstatorichopmassive")
public class Setstatorichopmassive {
		
	private DmpkBmanagerSetstatorichopmassiveBean bean;
		  
	public void setBean(DmpkBmanagerSetstatorichopmassiveBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerSetstatorichopmassiveBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerSetstatorichopmassiveBean pBean) throws Exception{
	   final SetstatorichopmassiveImpl lSetstatorichopmassive = new SetstatorichopmassiveImpl();
	   setBean(pBean);
	   lSetstatorichopmassive.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetstatorichopmassive.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerSetstatorichopmassiveBean> result = new StoreResultBean<DmpkBmanagerSetstatorichopmassiveBean>();
