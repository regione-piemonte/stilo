...
public class UpdrigafoglioximportImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_BMANAGER.UPDRIGAFOGLIOXIMPORT(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"valcolonnein",6,Types.CLOB,connection); 	
