...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.TrovarichinvioemailImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailTrovarichinvioemail")
public class Trovarichinvioemail {
		
	private DmpkIntMgoEmailTrovarichinvioemailBean bean;
		  
	public void setBean(DmpkIntMgoEmailTrovarichinvioemailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailTrovarichinvioemailBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailTrovarichinvioemailBean pBean) throws Exception{
	   final TrovarichinvioemailImpl lTrovarichinvioemail = new TrovarichinvioemailImpl();
	   setBean(pBean);
	   lTrovarichinvioemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovarichinvioemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailTrovarichinvioemailBean> result = new StoreResultBean<DmpkIntMgoEmailTrovarichinvioemailBean>();
