...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityConverttofmtstdtimestampBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.ConverttofmtstdtimestampImpl;
 ...
 */
@Service(name="DmpkUtilityConverttofmtstdtimestamp")
public class Converttofmtstdtimestamp {
		
	private DmpkUtilityConverttofmtstdtimestampBean bean;
		  
	public void setBean(DmpkUtilityConverttofmtstdtimestampBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityConverttofmtstdtimestampBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityConverttofmtstdtimestampBean pBean) throws Exception{
	   final ConverttofmtstdtimestampImpl lConverttofmtstdtimestamp = new ConverttofmtstdtimestampImpl();
	   setBean(pBean);
	   lConverttofmtstdtimestamp.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lConverttofmtstdtimestamp.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityConverttofmtstdtimestampBean> result = new StoreResultBean<DmpkUtilityConverttofmtstdtimestampBean>();
