...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.TrovagruppisoggrubricaImpl;
 ...
 */
@Service(name="DmpkAnagraficaTrovagruppisoggrubrica")
public class Trovagruppisoggrubrica {
	...
	public StoreResultBean<DmpkAnagraficaTrovagruppisoggrubricaBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaTrovagruppisoggrubricaBean pBean) throws Exception{
	   final TrovagruppisoggrubricaImpl lTrovagruppisoggrubrica = new TrovagruppisoggrubricaImpl();
	   setBean(pBean);
	   lTrovagruppisoggrubrica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovagruppisoggrubrica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaTrovagruppisoggrubricaBean> result = new StoreResultBean<DmpkAnagraficaTrovagruppisoggrubricaBean>();
