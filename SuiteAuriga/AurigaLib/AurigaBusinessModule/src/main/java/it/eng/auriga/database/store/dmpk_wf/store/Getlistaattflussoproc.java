...
import it.eng.auriga.database.store.dmpk_wf.store.impl.GetlistaattflussoprocImpl;
 ...
 */
@Service(name="DmpkWfGetlistaattflussoproc")
public class Getlistaattflussoproc {
	...
	public StoreResultBean<DmpkWfGetlistaattflussoprocBean> execute(AurigaLoginBean lLoginBean, DmpkWfGetlistaattflussoprocBean pBean) throws Exception{
	   final GetlistaattflussoprocImpl lGetlistaattflussoproc = new GetlistaattflussoprocImpl();
	   setBean(pBean);
	   lGetlistaattflussoproc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlistaattflussoproc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfGetlistaattflussoprocBean> result = new StoreResultBean<DmpkWfGetlistaattflussoprocBean>();
