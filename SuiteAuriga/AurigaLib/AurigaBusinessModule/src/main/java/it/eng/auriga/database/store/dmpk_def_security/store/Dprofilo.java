...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.DprofiloImpl;
 ...
 */
@Service(name="DmpkDefSecurityDprofilo")
public class Dprofilo {
		
	private DmpkDefSecurityDprofiloBean bean;
		  
	public void setBean(DmpkDefSecurityDprofiloBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityDprofiloBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityDprofiloBean pBean) throws Exception{
	   final DprofiloImpl lDprofilo = new DprofiloImpl();
	   setBean(pBean);
	   lDprofilo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDprofilo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityDprofiloBean> result = new StoreResultBean<DmpkDefSecurityDprofiloBean>();
