...
package it.eng.auriga.database.store.dmpk_amm_trasp.store;

import it.eng.auriga.database.store.dmpk_amm_trasp.bean.DmpkAmmTraspRiordinarecconttabellaBean;
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.RiordinarecconttabellaImpl;
 ...
 */
@Service(name="DmpkAmmTraspRiordinarecconttabella")
public class Riordinarecconttabella {
		
	private DmpkAmmTraspRiordinarecconttabellaBean bean;
		  
	public void setBean(DmpkAmmTraspRiordinarecconttabellaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspRiordinarecconttabellaBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspRiordinarecconttabellaBean pBean) throws Exception{
	   final RiordinarecconttabellaImpl lRiordinarecconttabella = new RiordinarecconttabellaImpl();
	   setBean(pBean);
	   lRiordinarecconttabella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRiordinarecconttabella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspRiordinarecconttabellaBean> result = new StoreResultBean<DmpkAmmTraspRiordinarecconttabellaBean>();
