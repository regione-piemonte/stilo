...
import it.eng.auriga.database.store.dmpk_login.store.impl.CambiopasswordImpl;
 ...
 */
@Service(name="DmpkLoginCambiopassword")
public class Cambiopassword {
		
	private DmpkLoginCambiopasswordBean bean;
		  
	public void setBean(DmpkLoginCambiopasswordBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkLoginCambiopasswordBean> execute(AurigaLoginBean lLoginBean, DmpkLoginCambiopasswordBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkLoginCambiopasswordBean> result = new StoreResultBean<DmpkLoginCambiopasswordBean>();
