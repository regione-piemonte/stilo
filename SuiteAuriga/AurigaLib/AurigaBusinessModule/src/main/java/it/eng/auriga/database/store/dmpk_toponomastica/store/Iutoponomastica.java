...
import it.eng.auriga.database.store.dmpk_toponomastica.store.impl.IutoponomasticaImpl;
 ...
 */
@Service(name="DmpkToponomasticaIutoponomastica")
public class Iutoponomastica {
	...
	public StoreResultBean<DmpkToponomasticaIutoponomasticaBean> execute(AurigaLoginBean lLoginBean, DmpkToponomasticaIutoponomasticaBean pBean) throws Exception{
	   final IutoponomasticaImpl lIutoponomastica = new IutoponomasticaImpl();
	   setBean(pBean);
	   lIutoponomastica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIutoponomastica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkToponomasticaIutoponomasticaBean> result = new StoreResultBean<DmpkToponomasticaIutoponomasticaBean>();
