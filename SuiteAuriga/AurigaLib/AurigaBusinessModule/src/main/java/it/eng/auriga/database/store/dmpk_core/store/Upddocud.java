 ...
 */
@Service(name="DmpkCoreUpddocud")
public class Upddocud {
	...
	public StoreResultBean<DmpkCoreUpddocudBean> execute(AurigaLoginBean lLoginBean, DmpkCoreUpddocudBean pBean) throws Exception{
	   final UpddocudImpl lUpddocud = new UpddocudImpl();
	   setBean(pBean);
	   lUpddocud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
