...
import it.eng.auriga.database.store.dmpk_ws.store.impl.GetestremifolderImpl;
 ...
 */
@Service(name="DmpkWsGetestremifolder")
public class Getestremifolder {
		
	private DmpkWsGetestremifolderBean bean;
		  
	public void setBean(DmpkWsGetestremifolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsGetestremifolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetestremifolderBean pBean) throws Exception{
	   final GetestremifolderImpl lGetestremifolder = new GetestremifolderImpl();
	   setBean(pBean);
	   lGetestremifolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetestremifolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetestremifolderBean> result = new StoreResultBean<DmpkWsGetestremifolderBean>();
