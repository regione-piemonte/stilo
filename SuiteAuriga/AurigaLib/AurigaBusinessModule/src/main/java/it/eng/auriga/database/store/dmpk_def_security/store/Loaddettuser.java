...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettuserImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettuser")
public class Loaddettuser {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettuserBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettuserBean pBean) throws Exception{
	   final LoaddettuserImpl lLoaddettuser = new LoaddettuserImpl();
	   setBean(pBean);
	   lLoaddettuser.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettuser.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettuserBean> result = new StoreResultBean<DmpkDefSecurityLoaddettuserBean>();
