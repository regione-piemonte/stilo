...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.TrovaprocesstypesImpl;
 ...
 */
@Service(name="DmpkProcessTypesTrovaprocesstypes")
public class Trovaprocesstypes {
	...
	public StoreResultBean<DmpkProcessTypesTrovaprocesstypesBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesTrovaprocesstypesBean pBean) throws Exception{
	   final TrovaprocesstypesImpl lTrovaprocesstypes = new TrovaprocesstypesImpl();
	   setBean(pBean);
	   lTrovaprocesstypes.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaprocesstypes.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesTrovaprocesstypesBean> result = new StoreResultBean<DmpkProcessTypesTrovaprocesstypesBean>();
