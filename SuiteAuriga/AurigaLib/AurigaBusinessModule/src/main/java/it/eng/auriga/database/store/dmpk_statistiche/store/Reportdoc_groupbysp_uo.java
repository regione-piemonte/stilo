...
import it.eng.auriga.database.store.dmpk_statistiche.store.impl.Reportdoc_groupbysp_uoImpl;
 ...
 */
@Service(name="DmpkStatisticheReportdoc_groupbysp_uo")
public class Reportdoc_groupbysp_uo {
	...
	public StoreResultBean<DmpkStatisticheReportdoc_groupbysp_uoBean> execute(AurigaLoginBean lLoginBean, DmpkStatisticheReportdoc_groupbysp_uoBean pBean) throws Exception{
	   final Reportdoc_groupbysp_uoImpl lReportdoc_groupbysp_uo = new Reportdoc_groupbysp_uoImpl();
	   setBean(pBean);
	   lReportdoc_groupbysp_uo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lReportdoc_groupbysp_uo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkStatisticheReportdoc_groupbysp_uoBean> result = new StoreResultBean<DmpkStatisticheReportdoc_groupbysp_uoBean>();
