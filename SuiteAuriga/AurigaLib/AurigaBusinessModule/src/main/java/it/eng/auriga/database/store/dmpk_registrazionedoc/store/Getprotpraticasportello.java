...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.GetprotpraticasportelloImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocGetprotpraticasportello")
public class Getprotpraticasportello {
		
	private DmpkRegistrazionedocGetprotpraticasportelloBean bean;
		  
	public void setBean(DmpkRegistrazionedocGetprotpraticasportelloBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocGetprotpraticasportelloBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocGetprotpraticasportelloBean pBean) throws Exception{
	   final GetprotpraticasportelloImpl lGetprotpraticasportello = new GetprotpraticasportelloImpl();
	   setBean(pBean);
	   lGetprotpraticasportello.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetprotpraticasportello.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocGetprotpraticasportelloBean> result = new StoreResultBean<DmpkRegistrazionedocGetprotpraticasportelloBean>();
