...
public class OperprelievosufascarchivioImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.OPERPRELIEVOSUFASCARCHIVIO(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"codoperazionein",5,Types.VARCHAR,connection); 	
