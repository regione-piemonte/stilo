...
import it.eng.auriga.database.store.dmpk_core.store.impl.TestshowfoldercontentallowedImpl;
 ...
 */
@Service(name="DmpkCoreTestshowfoldercontentallowed")
public class Testshowfoldercontentallowed {
		
	private DmpkCoreTestshowfoldercontentallowedBean bean;
		  
	public void setBean(DmpkCoreTestshowfoldercontentallowedBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreTestshowfoldercontentallowedBean> execute(AurigaLoginBean lLoginBean, DmpkCoreTestshowfoldercontentallowedBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreTestshowfoldercontentallowedBean> result = new StoreResultBean<DmpkCoreTestshowfoldercontentallowedBean>();
