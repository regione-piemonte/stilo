...
import it.eng.auriga.database.store.dmpk_utility.store.impl.Findud_outputImpl;
 ...
 */
@Service(name="DmpkUtilityFindud_output")
public class Findud_output {
	...
	public StoreResultBean<DmpkUtilityFindud_outputBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityFindud_outputBean pBean) throws Exception{
	   final Findud_outputImpl lFindud_output = new Findud_outputImpl();
	   setBean(pBean);
	   lFindud_output.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lFindud_output.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityFindud_outputBean> result = new StoreResultBean<DmpkUtilityFindud_outputBean>();
