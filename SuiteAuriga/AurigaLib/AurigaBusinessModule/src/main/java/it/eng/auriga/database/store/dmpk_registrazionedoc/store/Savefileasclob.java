 ...
 */
@Service(name="DmpkRegistrazionedocSavefileasclob")
public class Savefileasclob {
		
	private DmpkRegistrazionedocSavefileasclobBean bean;
		  
	public void setBean(DmpkRegistrazionedocSavefileasclobBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocSavefileasclobBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocSavefileasclobBean pBean) throws Exception{
	   final SavefileasclobImpl lSavefileasclob = new SavefileasclobImpl();
	   setBean(pBean);
	   lSavefileasclob.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSavefileasclob.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocSavefileasclobBean> result = new StoreResultBean<DmpkRegistrazionedocSavefileasclobBean>();
