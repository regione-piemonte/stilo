...
import it.eng.auriga.database.store.dmpk_wf.store.impl.Call_execattImpl;
 ...
 */
@Service(name="DmpkWfCall_execatt")
public class Call_execatt {
		
	private DmpkWfCall_execattBean bean;
		  
	public void setBean(DmpkWfCall_execattBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWfCall_execattBean> execute(AurigaLoginBean lLoginBean, DmpkWfCall_execattBean pBean) throws Exception{
	   final Call_execattImpl lCall_execatt = new Call_execattImpl();
	   setBean(pBean);
	   lCall_execatt.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCall_execatt.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfCall_execattBean> result = new StoreResultBean<DmpkWfCall_execattBean>();
