...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettuserestesaImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettuserestesa")
public class Loaddettuserestesa {
		
	private DmpkDefSecurityLoaddettuserestesaBean bean;
		  
	public void setBean(DmpkDefSecurityLoaddettuserestesaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityLoaddettuserestesaBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettuserestesaBean pBean) throws Exception{
	   final LoaddettuserestesaImpl lLoaddettuserestesa = new LoaddettuserestesaImpl();
	   setBean(pBean);
	   lLoaddettuserestesa.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettuserestesa.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettuserestesaBean> result = new StoreResultBean<DmpkDefSecurityLoaddettuserestesaBean>();
