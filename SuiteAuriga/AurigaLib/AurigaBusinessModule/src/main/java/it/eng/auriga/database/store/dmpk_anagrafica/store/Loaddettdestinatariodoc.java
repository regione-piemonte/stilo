...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.LoaddettdestinatariodocImpl;
 ...
 */
@Service(name="DmpkAnagraficaLoaddettdestinatariodoc")
public class Loaddettdestinatariodoc {
	...
	public StoreResultBean<DmpkAnagraficaLoaddettdestinatariodocBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaLoaddettdestinatariodocBean pBean) throws Exception{
	   final LoaddettdestinatariodocImpl lLoaddettdestinatariodoc = new LoaddettdestinatariodocImpl();
	   setBean(pBean);
	   lLoaddettdestinatariodoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettdestinatariodoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaLoaddettdestinatariodocBean> result = new StoreResultBean<DmpkAnagraficaLoaddettdestinatariodocBean>();
