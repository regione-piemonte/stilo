...
import it.eng.auriga.database.store.dmpk_processes.store.impl.Ctrldispcapcontabilerda_adspImpl;
 ...
 */
@Service(name="DmpkProcessesCtrldispcapcontabilerda_adsp")
public class Ctrldispcapcontabilerda_adsp {
		
	private DmpkProcessesCtrldispcapcontabilerda_adspBean bean;
		  
	public void setBean(DmpkProcessesCtrldispcapcontabilerda_adspBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesCtrldispcapcontabilerda_adspBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesCtrldispcapcontabilerda_adspBean pBean) throws Exception{
	   final Ctrldispcapcontabilerda_adspImpl lCtrldispcapcontabilerda_adsp = new Ctrldispcapcontabilerda_adspImpl();
	   setBean(pBean);
	   lCtrldispcapcontabilerda_adsp.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCtrldispcapcontabilerda_adsp.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesCtrldispcapcontabilerda_adspBean> result = new StoreResultBean<DmpkProcessesCtrldispcapcontabilerda_adspBean>();
