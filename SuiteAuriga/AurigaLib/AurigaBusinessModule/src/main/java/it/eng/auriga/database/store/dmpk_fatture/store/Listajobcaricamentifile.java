...
import it.eng.auriga.database.store.dmpk_fatture.store.impl.ListajobcaricamentifileImpl;
 ...
 */
@Service(name="DmpkFattureListajobcaricamentifile")
public class Listajobcaricamentifile {
	...
	public StoreResultBean<DmpkFattureListajobcaricamentifileBean> execute(AurigaLoginBean lLoginBean, DmpkFattureListajobcaricamentifileBean pBean) throws Exception{
	   final ListajobcaricamentifileImpl lListajobcaricamentifile = new ListajobcaricamentifileImpl();
	   setBean(pBean);
	   lListajobcaricamentifile.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lListajobcaricamentifile.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFattureListajobcaricamentifileBean> result = new StoreResultBean<DmpkFattureListajobcaricamentifileBean>();
