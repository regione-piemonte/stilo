...
public class Set_xImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMO_COORDINATE.SET_X(?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"x",3,Types.DECIMAL,connection); 	
