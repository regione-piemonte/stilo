...
import it.eng.auriga.database.store.dmpk_utility.store.impl.DdatopograficoImpl;
 ...
 */
@Service(name="DmpkUtilityDdatopografico")
public class Ddatopografico {
		
	private DmpkUtilityDdatopograficoBean bean;
		  
	public void setBean(DmpkUtilityDdatopograficoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityDdatopograficoBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityDdatopograficoBean pBean) throws Exception{
	   final DdatopograficoImpl lDdatopografico = new DdatopograficoImpl();
	   setBean(pBean);
	   lDdatopografico.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDdatopografico.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityDdatopograficoBean> result = new StoreResultBean<DmpkUtilityDdatopograficoBean>();
