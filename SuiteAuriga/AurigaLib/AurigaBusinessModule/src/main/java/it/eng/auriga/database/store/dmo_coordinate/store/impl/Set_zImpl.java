...
public class Set_zImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMO_COORDINATE.SET_Z(?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"z",3,Types.DECIMAL,connection); 	
