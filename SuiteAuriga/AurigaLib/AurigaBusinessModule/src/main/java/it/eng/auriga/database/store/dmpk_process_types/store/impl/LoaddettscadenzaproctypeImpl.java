...
public class LoaddettscadenzaproctypeImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESS_TYPES.LOADDETTSCADENZAPROCTYPE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"flgscadpuntualeperiodoout",7,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"descrizioneio",8,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"durataout",9,Types.DECIMAL); 
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"annotazioniout",12,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flglockedout",13,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlstartout",14,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlendout",15,Types.CLOB); 
