...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactDsezionaleBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.DsezionaleImpl;
 ...
 */
@Service(name="DmpkEfactDsezionale")
public class Dsezionale {
		
	private DmpkEfactDsezionaleBean bean;
		  
	public void setBean(DmpkEfactDsezionaleBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactDsezionaleBean> execute(AurigaLoginBean lLoginBean, DmpkEfactDsezionaleBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkEfactDsezionaleBean> result = new StoreResultBean<DmpkEfactDsezionaleBean>();
