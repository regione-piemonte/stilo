...
import it.eng.auriga.database.store.dmpk_dizionario.store.impl.TrovadictvaluesfordictentryImpl;
 ...
 */
@Service(name="DmpkDizionarioTrovadictvaluesfordictentry")
public class Trovadictvaluesfordictentry {
		
	private DmpkDizionarioTrovadictvaluesfordictentryBean bean;
		  
	public void setBean(DmpkDizionarioTrovadictvaluesfordictentryBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDizionarioTrovadictvaluesfordictentryBean> execute(AurigaLoginBean lLoginBean, DmpkDizionarioTrovadictvaluesfordictentryBean pBean) throws Exception{
	   final TrovadictvaluesfordictentryImpl lTrovadictvaluesfordictentry = new TrovadictvaluesfordictentryImpl();
	   setBean(pBean);
	   lTrovadictvaluesfordictentry.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadictvaluesfordictentry.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDizionarioTrovadictvaluesfordictentryBean> result = new StoreResultBean<DmpkDizionarioTrovadictvaluesfordictentryBean>();
