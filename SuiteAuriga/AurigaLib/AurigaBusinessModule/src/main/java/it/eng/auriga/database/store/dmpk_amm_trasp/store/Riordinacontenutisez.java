...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.RiordinacontenutisezImpl;
 ...
 */
@Service(name="DmpkAmmTraspRiordinacontenutisez")
public class Riordinacontenutisez {
		
	private DmpkAmmTraspRiordinacontenutisezBean bean;
		  
	public void setBean(DmpkAmmTraspRiordinacontenutisezBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspRiordinacontenutisezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspRiordinacontenutisezBean pBean) throws Exception{
	   final RiordinacontenutisezImpl lRiordinacontenutisez = new RiordinacontenutisezImpl();
	   setBean(pBean);
	   lRiordinacontenutisez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRiordinacontenutisez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspRiordinacontenutisezBean> result = new StoreResultBean<DmpkAmmTraspRiordinacontenutisezBean>();
