...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.DmembrogrupposoggintImpl;
 ...
 */
@Service(name="DmpkDefSecurityDmembrogrupposoggint")
public class Dmembrogrupposoggint {
	...
	public StoreResultBean<DmpkDefSecurityDmembrogrupposoggintBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityDmembrogrupposoggintBean pBean) throws Exception{
	   final DmembrogrupposoggintImpl lDmembrogrupposoggint = new DmembrogrupposoggintImpl();
	   setBean(pBean);
	   lDmembrogrupposoggint.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDmembrogrupposoggint.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityDmembrogrupposoggintBean> result = new StoreResultBean<DmpkDefSecurityDmembrogrupposoggintBean>();
