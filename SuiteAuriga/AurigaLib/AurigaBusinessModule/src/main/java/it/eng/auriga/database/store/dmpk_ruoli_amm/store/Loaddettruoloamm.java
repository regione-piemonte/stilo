...
import it.eng.auriga.database.store.dmpk_ruoli_amm.store.impl.LoaddettruoloammImpl;
 ...
 */
@Service(name="DmpkRuoliAmmLoaddettruoloamm")
public class Loaddettruoloamm {
	...
	public StoreResultBean<DmpkRuoliAmmLoaddettruoloammBean> execute(AurigaLoginBean lLoginBean, DmpkRuoliAmmLoaddettruoloammBean pBean) throws Exception{
	   final LoaddettruoloammImpl lLoaddettruoloamm = new LoaddettruoloammImpl();
	   setBean(pBean);
	   lLoaddettruoloamm.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettruoloamm.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRuoliAmmLoaddettruoloammBean> result = new StoreResultBean<DmpkRuoliAmmLoaddettruoloammBean>();
