...
package it.eng.auriga.database.store.dmpk_load_combo.store;

import it.eng.auriga.database.store.dmpk_load_combo.bean.DmpkLoadComboDmfn_load_comboBean;
import it.eng.auriga.database.store.dmpk_load_combo.store.impl.Dmfn_load_comboImpl;
 ...
 */
@Service(name="DmpkLoadComboDmfn_load_combo")
public class Dmfn_load_combo {
	...
	public StoreResultBean<DmpkLoadComboDmfn_load_comboBean> execute(AurigaLoginBean lLoginBean, DmpkLoadComboDmfn_load_comboBean pBean) throws Exception{
	   final Dmfn_load_comboImpl lDmfn_load_combo = new Dmfn_load_comboImpl();
	   setBean(pBean);
	   lDmfn_load_combo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDmfn_load_combo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkLoadComboDmfn_load_comboBean> result = new StoreResultBean<DmpkLoadComboDmfn_load_comboBean>();
