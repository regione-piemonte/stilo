...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityCtrldatisogginternoBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.CtrldatisogginternoImpl;
 ...
 */
@Service(name="DmpkUtilityCtrldatisogginterno")
public class Ctrldatisogginterno {
		
	private DmpkUtilityCtrldatisogginternoBean bean;
		  
	public void setBean(DmpkUtilityCtrldatisogginternoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityCtrldatisogginternoBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityCtrldatisogginternoBean pBean) throws Exception{
	   final CtrldatisogginternoImpl lCtrldatisogginterno = new CtrldatisogginternoImpl();
	   setBean(pBean);
	   lCtrldatisogginterno.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCtrldatisogginterno.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityCtrldatisogginternoBean> result = new StoreResultBean<DmpkUtilityCtrldatisogginternoBean>();
