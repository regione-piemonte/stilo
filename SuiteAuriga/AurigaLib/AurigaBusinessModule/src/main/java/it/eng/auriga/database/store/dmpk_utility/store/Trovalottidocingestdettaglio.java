...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityTrovalottidocingestdettaglioBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovalottidocingestdettaglioImpl;
 ...
 */
@Service(name="DmpkUtilityTrovalottidocingestdettaglio")
public class Trovalottidocingestdettaglio {
		
	private DmpkUtilityTrovalottidocingestdettaglioBean bean;
		  
	public void setBean(DmpkUtilityTrovalottidocingestdettaglioBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityTrovalottidocingestdettaglioBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovalottidocingestdettaglioBean pBean) throws Exception{
	   final TrovalottidocingestdettaglioImpl lTrovalottidocingestdettaglio = new TrovalottidocingestdettaglioImpl();
	   setBean(pBean);
	   lTrovalottidocingestdettaglio.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovalottidocingestdettaglio.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityTrovalottidocingestdettaglioBean> result = new StoreResultBean<DmpkUtilityTrovalottidocingestdettaglioBean>();
