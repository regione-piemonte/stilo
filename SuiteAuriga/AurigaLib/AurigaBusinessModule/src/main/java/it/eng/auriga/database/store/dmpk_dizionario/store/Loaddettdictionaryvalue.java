...
import it.eng.auriga.database.store.dmpk_dizionario.store.impl.LoaddettdictionaryvalueImpl;
 ...
 */
@Service(name="DmpkDizionarioLoaddettdictionaryvalue")
public class Loaddettdictionaryvalue {
	...
	public StoreResultBean<DmpkDizionarioLoaddettdictionaryvalueBean> execute(AurigaLoginBean lLoginBean, DmpkDizionarioLoaddettdictionaryvalueBean pBean) throws Exception{
	   final LoaddettdictionaryvalueImpl lLoaddettdictionaryvalue = new LoaddettdictionaryvalueImpl();
	   setBean(pBean);
	   lLoaddettdictionaryvalue.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettdictionaryvalue.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDizionarioLoaddettdictionaryvalueBean> result = new StoreResultBean<DmpkDizionarioLoaddettdictionaryvalueBean>();
