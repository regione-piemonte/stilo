...
public class Getparametriconfig_jImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_LOGIN.GETPARAMETRICONFIG_J(?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlparametriout",4,Types.CLOB); 
