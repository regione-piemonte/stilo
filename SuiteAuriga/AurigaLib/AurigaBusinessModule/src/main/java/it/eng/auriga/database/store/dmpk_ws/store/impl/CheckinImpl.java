...
public class CheckinImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.CHECKIN(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"nroversioneestrattaout",5,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgverificafirmafileout",6,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"attributiverxmlout",7,Types.CLOB); 
