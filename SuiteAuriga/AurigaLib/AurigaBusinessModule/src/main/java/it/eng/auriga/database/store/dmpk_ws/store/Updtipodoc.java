...
import it.eng.auriga.database.store.dmpk_ws.store.impl.UpdtipodocImpl;
 ...
 */
@Service(name="DmpkWsUpdtipodoc")
public class Updtipodoc {
		
	private DmpkWsUpdtipodocBean bean;
		  
	public void setBean(DmpkWsUpdtipodocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsUpdtipodocBean> execute(AurigaLoginBean lLoginBean, DmpkWsUpdtipodocBean pBean) throws Exception{
	   final UpdtipodocImpl lUpdtipodoc = new UpdtipodocImpl();
	   setBean(pBean);
	   lUpdtipodoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUpdtipodoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsUpdtipodocBean> result = new StoreResultBean<DmpkWsUpdtipodocBean>();
