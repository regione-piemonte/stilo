...
import it.eng.auriga.database.store.dmpk_core.store.impl.VistadocumentoImpl;
 ...
 */
@Service(name="DmpkCoreVistadocumento")
public class Vistadocumento {
		
	private DmpkCoreVistadocumentoBean bean;
		  
	public void setBean(DmpkCoreVistadocumentoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreVistadocumentoBean> execute(AurigaLoginBean lLoginBean, DmpkCoreVistadocumentoBean pBean) throws Exception{
	   final VistadocumentoImpl lVistadocumento = new VistadocumentoImpl();
	   setBean(pBean);
	   lVistadocumento.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lVistadocumento.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreVistadocumentoBean> result = new StoreResultBean<DmpkCoreVistadocumentoBean>();
