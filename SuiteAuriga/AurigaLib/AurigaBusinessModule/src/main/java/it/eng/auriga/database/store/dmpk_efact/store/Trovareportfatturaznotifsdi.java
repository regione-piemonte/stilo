...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturaznotifsdiBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturaznotifsdiImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturaznotifsdi")
public class Trovareportfatturaznotifsdi {
		
	private DmpkEfactTrovareportfatturaznotifsdiBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturaznotifsdiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturaznotifsdiBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturaznotifsdiBean pBean) throws Exception{
	   final TrovareportfatturaznotifsdiImpl lTrovareportfatturaznotifsdi = new TrovareportfatturaznotifsdiImpl();
	   setBean(pBean);
	   lTrovareportfatturaznotifsdi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturaznotifsdi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturaznotifsdiBean> result = new StoreResultBean<DmpkEfactTrovareportfatturaznotifsdiBean>();
