...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.LoadrigafoglioximportImpl;
 ...
 */
@Service(name="DmpkBmanagerLoadrigafoglioximport")
public class Loadrigafoglioximport {
	...
	public StoreResultBean<DmpkBmanagerLoadrigafoglioximportBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerLoadrigafoglioximportBean pBean) throws Exception{
	   final LoadrigafoglioximportImpl lLoadrigafoglioximport = new LoadrigafoglioximportImpl();
	   setBean(pBean);
	   lLoadrigafoglioximport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadrigafoglioximport.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerLoadrigafoglioximportBean> result = new StoreResultBean<DmpkBmanagerLoadrigafoglioximportBean>();
