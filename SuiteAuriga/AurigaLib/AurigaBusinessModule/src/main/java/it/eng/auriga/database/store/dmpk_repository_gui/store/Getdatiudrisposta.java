...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetdatiudrispostaImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetdatiudrisposta")
public class Getdatiudrisposta {
		
	private DmpkRepositoryGuiGetdatiudrispostaBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetdatiudrispostaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetdatiudrispostaBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetdatiudrispostaBean pBean) throws Exception{
	   final GetdatiudrispostaImpl lGetdatiudrisposta = new GetdatiudrispostaImpl();
	   setBean(pBean);
	   lGetdatiudrisposta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatiudrisposta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetdatiudrispostaBean> result = new StoreResultBean<DmpkRepositoryGuiGetdatiudrispostaBean>();
