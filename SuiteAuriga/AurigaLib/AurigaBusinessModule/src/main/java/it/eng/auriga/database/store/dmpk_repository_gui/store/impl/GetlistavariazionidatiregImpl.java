...
public class GetlistavariazionidatiregImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_REPOSITORY_GUI.GETLISTAVARIAZIONIDATIREG(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"listavariazioniout",5,Types.CLOB); 
