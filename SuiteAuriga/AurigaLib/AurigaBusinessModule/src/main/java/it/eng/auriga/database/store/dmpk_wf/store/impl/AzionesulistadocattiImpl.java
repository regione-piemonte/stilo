...
public class AzionesulistadocattiImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WF.AZIONESULISTADOCATTI(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"listapropattiin",5,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"xmldettazionein",6,Types.CLOB,connection); 	
