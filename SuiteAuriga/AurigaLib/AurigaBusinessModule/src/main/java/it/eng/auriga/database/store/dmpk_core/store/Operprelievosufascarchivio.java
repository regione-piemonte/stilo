...
import it.eng.auriga.database.store.dmpk_core.store.impl.OperprelievosufascarchivioImpl;
 ...
 */
@Service(name="DmpkCoreOperprelievosufascarchivio")
public class Operprelievosufascarchivio {
		
	private DmpkCoreOperprelievosufascarchivioBean bean;
		  
	public void setBean(DmpkCoreOperprelievosufascarchivioBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreOperprelievosufascarchivioBean> execute(AurigaLoginBean lLoginBean, DmpkCoreOperprelievosufascarchivioBean pBean) throws Exception{
	   final OperprelievosufascarchivioImpl lOperprelievosufascarchivio = new OperprelievosufascarchivioImpl();
	   setBean(pBean);
	   lOperprelievosufascarchivio.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lOperprelievosufascarchivio.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreOperprelievosufascarchivioBean> result = new StoreResultBean<DmpkCoreOperprelievosufascarchivioBean>();
