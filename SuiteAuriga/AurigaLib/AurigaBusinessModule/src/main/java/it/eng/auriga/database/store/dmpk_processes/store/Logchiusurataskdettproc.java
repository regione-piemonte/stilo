...
import it.eng.auriga.database.store.dmpk_processes.store.impl.LogchiusurataskdettprocImpl;
 ...
 */
@Service(name="DmpkProcessesLogchiusurataskdettproc")
public class Logchiusurataskdettproc {
		
	private DmpkProcessesLogchiusurataskdettprocBean bean;
		  
	public void setBean(DmpkProcessesLogchiusurataskdettprocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesLogchiusurataskdettprocBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesLogchiusurataskdettprocBean pBean) throws Exception{
	   final LogchiusurataskdettprocImpl lLogchiusurataskdettproc = new LogchiusurataskdettprocImpl();
	   setBean(pBean);
	   lLogchiusurataskdettproc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLogchiusurataskdettproc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesLogchiusurataskdettprocBean> result = new StoreResultBean<DmpkProcessesLogchiusurataskdettprocBean>();
