...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreAggautomaticoaclfld_postinBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.Aggautomaticoaclfld_postinImpl;
 ...
 */
@Service(name="DmpkCoreAggautomaticoaclfld_postin")
public class Aggautomaticoaclfld_postin {
		
	private DmpkCoreAggautomaticoaclfld_postinBean bean;
		  
	public void setBean(DmpkCoreAggautomaticoaclfld_postinBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreAggautomaticoaclfld_postinBean> execute(AurigaLoginBean lLoginBean, DmpkCoreAggautomaticoaclfld_postinBean pBean) throws Exception{
	   final Aggautomaticoaclfld_postinImpl lAggautomaticoaclfld_postin = new Aggautomaticoaclfld_postinImpl();
	   setBean(pBean);
	   lAggautomaticoaclfld_postin.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAggautomaticoaclfld_postin.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreAggautomaticoaclfld_postinBean> result = new StoreResultBean<DmpkCoreAggautomaticoaclfld_postinBean>();
