...
package it.eng.auriga.database.store.dmpk_spatial.store;

import it.eng.auriga.database.store.dmpk_spatial.bean.DmpkSpatialTrovacomuniitalianiBean;
import it.eng.auriga.database.store.dmpk_spatial.store.impl.TrovacomuniitalianiImpl;
 ...
 */
@Service(name="DmpkSpatialTrovacomuniitaliani")
public class Trovacomuniitaliani {
	...
	public StoreResultBean<DmpkSpatialTrovacomuniitalianiBean> execute(AurigaLoginBean lLoginBean, DmpkSpatialTrovacomuniitalianiBean pBean) throws Exception{
	   final TrovacomuniitalianiImpl lTrovacomuniitaliani = new TrovacomuniitalianiImpl();
	   setBean(pBean);
	   lTrovacomuniitaliani.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovacomuniitaliani.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSpatialTrovacomuniitalianiBean> result = new StoreResultBean<DmpkSpatialTrovacomuniitalianiBean>();
