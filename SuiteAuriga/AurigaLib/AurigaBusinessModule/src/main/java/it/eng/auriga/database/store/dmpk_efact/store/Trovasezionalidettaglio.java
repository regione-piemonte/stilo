...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovasezionalidettaglioBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovasezionalidettaglioImpl;
 ...
 */
@Service(name="DmpkEfactTrovasezionalidettaglio")
public class Trovasezionalidettaglio {
		
	private DmpkEfactTrovasezionalidettaglioBean bean;
		  
	public void setBean(DmpkEfactTrovasezionalidettaglioBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovasezionalidettaglioBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovasezionalidettaglioBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkEfactTrovasezionalidettaglioBean> result = new StoreResultBean<DmpkEfactTrovasezionalidettaglioBean>();
