...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.GetlogsedutaImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollGetlogseduta")
public class Getlogseduta {
		
	private DmpkSeduteOrgCollGetlogsedutaBean bean;
		  
	public void setBean(DmpkSeduteOrgCollGetlogsedutaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkSeduteOrgCollGetlogsedutaBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollGetlogsedutaBean pBean) throws Exception{
	   final GetlogsedutaImpl lGetlogseduta = new GetlogsedutaImpl();
	   setBean(pBean);
	   lGetlogseduta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlogseduta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollGetlogsedutaBean> result = new StoreResultBean<DmpkSeduteOrgCollGetlogsedutaBean>();
