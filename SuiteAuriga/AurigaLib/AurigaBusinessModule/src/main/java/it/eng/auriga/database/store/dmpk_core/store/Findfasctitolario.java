...
import it.eng.auriga.database.store.dmpk_core.store.impl.FindfasctitolarioImpl;
 ...
 */
@Service(name="DmpkCoreFindfasctitolario")
public class Findfasctitolario {
	...
	public StoreResultBean<DmpkCoreFindfasctitolarioBean> execute(AurigaLoginBean lLoginBean, DmpkCoreFindfasctitolarioBean pBean) throws Exception{
	   final FindfasctitolarioImpl lFindfasctitolario = new FindfasctitolarioImpl();
	   setBean(pBean);
	   lFindfasctitolario.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lFindfasctitolario.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreFindfasctitolarioBean> result = new StoreResultBean<DmpkCoreFindfasctitolarioBean>();
