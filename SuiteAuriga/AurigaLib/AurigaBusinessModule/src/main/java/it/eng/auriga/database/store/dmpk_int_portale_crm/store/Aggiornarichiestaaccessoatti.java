...
import it.eng.auriga.database.store.dmpk_int_portale_crm.store.impl.AggiornarichiestaaccessoattiImpl;
 ...
 */
@Service(name="DmpkIntPortaleCrmAggiornarichiestaaccessoatti")
public class Aggiornarichiestaaccessoatti {
		
	private DmpkIntPortaleCrmAggiornarichiestaaccessoattiBean bean;
		  
	public void setBean(DmpkIntPortaleCrmAggiornarichiestaaccessoattiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntPortaleCrmAggiornarichiestaaccessoattiBean> execute(AurigaLoginBean lLoginBean, DmpkIntPortaleCrmAggiornarichiestaaccessoattiBean pBean) throws Exception{
	   final AggiornarichiestaaccessoattiImpl lAggiornarichiestaaccessoatti = new AggiornarichiestaaccessoattiImpl();
	   setBean(pBean);
	   lAggiornarichiestaaccessoatti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAggiornarichiestaaccessoatti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntPortaleCrmAggiornarichiestaaccessoattiBean> result = new StoreResultBean<DmpkIntPortaleCrmAggiornarichiestaaccessoattiBean>();
