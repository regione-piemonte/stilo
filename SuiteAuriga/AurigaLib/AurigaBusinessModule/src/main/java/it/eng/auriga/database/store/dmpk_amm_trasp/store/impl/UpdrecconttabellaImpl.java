...
public class UpdrecconttabellaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_AMM_TRASP.UPDRECCONTTABELLA(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idrigain",5,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"valorirectoupdin",6,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tspubbldalin",7,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tspubblalin",8,Types.VARCHAR,connection); 	
