...
public class FindproctypeImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.FINDPROCTYPE(?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"nomeprocesstypein",4,Types.VARCHAR,connection); 	
