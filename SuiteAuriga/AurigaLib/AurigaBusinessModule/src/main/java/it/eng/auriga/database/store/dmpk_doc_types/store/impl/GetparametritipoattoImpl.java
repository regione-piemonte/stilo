...
public class GetparametritipoattoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DOC_TYPES.GETPARAMETRITIPOATTO(?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"opzionitipoattoin",5,Types.CLOB,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"parametritipoattoout",6,Types.CLOB); 
