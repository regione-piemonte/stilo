...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.PreparaemailnotassinvioccImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailPreparaemailnotassinviocc")
public class Preparaemailnotassinviocc {
	...
	public StoreResultBean<DmpkIntMgoEmailPreparaemailnotassinvioccBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailPreparaemailnotassinvioccBean pBean) throws Exception{
	   final PreparaemailnotassinvioccImpl lPreparaemailnotassinviocc = new PreparaemailnotassinvioccImpl();
	   setBean(pBean);
	   lPreparaemailnotassinviocc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lPreparaemailnotassinviocc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailPreparaemailnotassinvioccBean> result = new StoreResultBean<DmpkIntMgoEmailPreparaemailnotassinvioccBean>();
