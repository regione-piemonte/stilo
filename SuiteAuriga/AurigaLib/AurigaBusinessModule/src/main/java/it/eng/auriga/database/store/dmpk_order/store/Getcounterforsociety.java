...
import it.eng.auriga.database.store.dmpk_order.bean.DmpkOrderGetcounterforsocietyBean;
import it.eng.auriga.database.store.dmpk_order.store.impl.GetcounterforsocietyImpl;
 ...
 */
@Service(name="DmpkOrderGetcounterforsociety")
public class Getcounterforsociety {
		
	private DmpkOrderGetcounterforsocietyBean bean;
		  
	public void setBean(DmpkOrderGetcounterforsocietyBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkOrderGetcounterforsocietyBean> execute(AurigaLoginBean lLoginBean, DmpkOrderGetcounterforsocietyBean pBean) throws Exception{
	   final GetcounterforsocietyImpl lGetcounterforsociety = new GetcounterforsocietyImpl();
	   setBean(pBean);
	   lGetcounterforsociety.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetcounterforsociety.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkOrderGetcounterforsocietyBean> result = new StoreResultBean<DmpkOrderGetcounterforsocietyBean>();
