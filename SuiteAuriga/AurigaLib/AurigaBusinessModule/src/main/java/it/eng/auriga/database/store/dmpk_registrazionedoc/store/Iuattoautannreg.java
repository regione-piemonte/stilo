...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.IuattoautannregImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocIuattoautannreg")
public class Iuattoautannreg {
	...
	public StoreResultBean<DmpkRegistrazionedocIuattoautannregBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocIuattoautannregBean pBean) throws Exception{
	   final IuattoautannregImpl lIuattoautannreg = new IuattoautannregImpl();
	   setBean(pBean);
	   lIuattoautannreg.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuattoautannreg.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocIuattoautannregBean> result = new StoreResultBean<DmpkRegistrazionedocIuattoautannregBean>();
