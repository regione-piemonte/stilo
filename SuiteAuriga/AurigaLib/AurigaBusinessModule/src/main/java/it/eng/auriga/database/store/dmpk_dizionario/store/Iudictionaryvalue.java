...
import it.eng.auriga.database.store.dmpk_dizionario.store.impl.IudictionaryvalueImpl;
 ...
 */
@Service(name="DmpkDizionarioIudictionaryvalue")
public class Iudictionaryvalue {
	...
	public StoreResultBean<DmpkDizionarioIudictionaryvalueBean> execute(AurigaLoginBean lLoginBean, DmpkDizionarioIudictionaryvalueBean pBean) throws Exception{
	   final IudictionaryvalueImpl lIudictionaryvalue = new IudictionaryvalueImpl();
	   setBean(pBean);
	   lIudictionaryvalue.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIudictionaryvalue.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDizionarioIudictionaryvalueBean> result = new StoreResultBean<DmpkDizionarioIudictionaryvalueBean>();
