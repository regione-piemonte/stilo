...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.TrovaregemergenzaImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocTrovaregemergenza")
public class Trovaregemergenza {
		
	private DmpkRegistrazionedocTrovaregemergenzaBean bean;
		  
	public void setBean(DmpkRegistrazionedocTrovaregemergenzaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocTrovaregemergenzaBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocTrovaregemergenzaBean pBean) throws Exception{
	   final TrovaregemergenzaImpl lTrovaregemergenza = new TrovaregemergenzaImpl();
	   setBean(pBean);
	   lTrovaregemergenza.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaregemergenza.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocTrovaregemergenzaBean> result = new StoreResultBean<DmpkRegistrazionedocTrovaregemergenzaBean>();
