...
import it.eng.auriga.database.store.dmpk_corrispettivi.bean.DmpkCorrispettiviTrovadettagliopuntovenditaBean;
import it.eng.auriga.database.store.dmpk_corrispettivi.store.impl.TrovadettagliopuntovenditaImpl;
 ...
 */
@Service(name="DmpkCorrispettiviTrovadettagliopuntovendita")
public class Trovadettagliopuntovendita {
		
	private DmpkCorrispettiviTrovadettagliopuntovenditaBean bean;
		  
	public void setBean(DmpkCorrispettiviTrovadettagliopuntovenditaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCorrispettiviTrovadettagliopuntovenditaBean> execute(AurigaLoginBean lLoginBean, DmpkCorrispettiviTrovadettagliopuntovenditaBean pBean) throws Exception{
	   final TrovadettagliopuntovenditaImpl lTrovadettagliopuntovendita = new TrovadettagliopuntovenditaImpl();
	   setBean(pBean);
	   lTrovadettagliopuntovendita.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadettagliopuntovendita.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCorrispettiviTrovadettagliopuntovenditaBean> result = new StoreResultBean<DmpkCorrispettiviTrovadettagliopuntovenditaBean>();
