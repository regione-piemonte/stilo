...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TrovausersImpl;
 ...
 */
@Service(name="DmpkDefSecurityTrovausers")
public class Trovausers {
	...
	public StoreResultBean<DmpkDefSecurityTrovausersBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTrovausersBean pBean) throws Exception{
	   final TrovausersImpl lTrovausers = new TrovausersImpl();
	   setBean(pBean);
	   lTrovausers.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovausers.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTrovausersBean> result = new StoreResultBean<DmpkDefSecurityTrovausersBean>();
