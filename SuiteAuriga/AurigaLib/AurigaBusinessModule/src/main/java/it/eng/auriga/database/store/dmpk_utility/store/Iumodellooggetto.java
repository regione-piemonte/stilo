...
import it.eng.auriga.database.store.dmpk_utility.store.impl.IumodellooggettoImpl;
 ...
 */
@Service(name="DmpkUtilityIumodellooggetto")
public class Iumodellooggetto {
	...
	public StoreResultBean<DmpkUtilityIumodellooggettoBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityIumodellooggettoBean pBean) throws Exception{
	   final IumodellooggettoImpl lIumodellooggetto = new IumodellooggettoImpl();
	   setBean(pBean);
	   lIumodellooggetto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIumodellooggetto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityIumodellooggettoBean> result = new StoreResultBean<DmpkUtilityIumodellooggettoBean>();
