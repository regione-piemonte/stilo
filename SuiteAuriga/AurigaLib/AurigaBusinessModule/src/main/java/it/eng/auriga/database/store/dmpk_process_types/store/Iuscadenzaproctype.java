...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.IuscadenzaproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesIuscadenzaproctype")
public class Iuscadenzaproctype {
	...
	public StoreResultBean<DmpkProcessTypesIuscadenzaproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesIuscadenzaproctypeBean pBean) throws Exception{
	   final IuscadenzaproctypeImpl lIuscadenzaproctype = new IuscadenzaproctypeImpl();
	   setBean(pBean);
	   lIuscadenzaproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuscadenzaproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesIuscadenzaproctypeBean> result = new StoreResultBean<DmpkProcessTypesIuscadenzaproctypeBean>();
