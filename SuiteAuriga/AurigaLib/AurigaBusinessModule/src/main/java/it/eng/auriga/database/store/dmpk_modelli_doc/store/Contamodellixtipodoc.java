...
import it.eng.auriga.database.store.dmpk_modelli_doc.store.impl.ContamodellixtipodocImpl;
 ...
 */
@Service(name="DmpkModelliDocContamodellixtipodoc")
public class Contamodellixtipodoc {
	...
	public StoreResultBean<DmpkModelliDocContamodellixtipodocBean> execute(AurigaLoginBean lLoginBean, DmpkModelliDocContamodellixtipodocBean pBean) throws Exception{
	   final ContamodellixtipodocImpl lContamodellixtipodoc = new ContamodellixtipodocImpl();
	   setBean(pBean);
	   lContamodellixtipodoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lContamodellixtipodoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkModelliDocContamodellixtipodocBean> result = new StoreResultBean<DmpkModelliDocContamodellixtipodocBean>();
