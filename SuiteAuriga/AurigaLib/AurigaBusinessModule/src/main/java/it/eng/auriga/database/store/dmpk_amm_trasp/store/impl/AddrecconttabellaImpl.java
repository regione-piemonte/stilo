...
public class AddrecconttabellaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_AMM_TRASP.ADDRECCONTTABELLA(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"valorirectoaddin",5,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tspubbldalin",6,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tspubblalin",7,Types.VARCHAR,connection); 	
