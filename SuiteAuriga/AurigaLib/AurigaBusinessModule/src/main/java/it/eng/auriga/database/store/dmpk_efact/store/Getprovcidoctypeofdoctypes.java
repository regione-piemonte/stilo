...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactGetprovcidoctypeofdoctypesBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.GetprovcidoctypeofdoctypesImpl;
 ...
 */
@Service(name="DmpkEfactGetprovcidoctypeofdoctypes")
public class Getprovcidoctypeofdoctypes {
		
	private DmpkEfactGetprovcidoctypeofdoctypesBean bean;
		  
	public void setBean(DmpkEfactGetprovcidoctypeofdoctypesBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactGetprovcidoctypeofdoctypesBean> execute(AurigaLoginBean lLoginBean, DmpkEfactGetprovcidoctypeofdoctypesBean pBean) throws Exception{
	   final GetprovcidoctypeofdoctypesImpl lGetprovcidoctypeofdoctypes = new GetprovcidoctypeofdoctypesImpl();
	   setBean(pBean);
	   lGetprovcidoctypeofdoctypes.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetprovcidoctypeofdoctypes.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactGetprovcidoctypeofdoctypesBean> result = new StoreResultBean<DmpkEfactGetprovcidoctypeofdoctypesBean>();
