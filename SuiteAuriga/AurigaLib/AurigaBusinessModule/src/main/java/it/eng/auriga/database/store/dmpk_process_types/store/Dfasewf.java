...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.DfasewfImpl;
 ...
 */
@Service(name="DmpkProcessTypesDfasewf")
public class Dfasewf {
		
	private DmpkProcessTypesDfasewfBean bean;
		  
	public void setBean(DmpkProcessTypesDfasewfBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessTypesDfasewfBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesDfasewfBean pBean) throws Exception{
	   final DfasewfImpl lDfasewf = new DfasewfImpl();
	   setBean(pBean);
	   lDfasewf.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDfasewf.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesDfasewfBean> result = new StoreResultBean<DmpkProcessTypesDfasewfBean>();
