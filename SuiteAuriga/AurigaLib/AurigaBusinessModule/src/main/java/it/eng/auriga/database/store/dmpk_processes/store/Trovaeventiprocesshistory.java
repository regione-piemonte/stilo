...
import it.eng.auriga.database.store.dmpk_processes.store.impl.TrovaeventiprocesshistoryImpl;
 ...
 */
@Service(name="DmpkProcessesTrovaeventiprocesshistory")
public class Trovaeventiprocesshistory {
	...
	public StoreResultBean<DmpkProcessesTrovaeventiprocesshistoryBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesTrovaeventiprocesshistoryBean pBean) throws Exception{
	   final TrovaeventiprocesshistoryImpl lTrovaeventiprocesshistory = new TrovaeventiprocesshistoryImpl();
	   setBean(pBean);
	   lTrovaeventiprocesshistory.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaeventiprocesshistory.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesTrovaeventiprocesshistoryBean> result = new StoreResultBean<DmpkProcessesTrovaeventiprocesshistoryBean>();
