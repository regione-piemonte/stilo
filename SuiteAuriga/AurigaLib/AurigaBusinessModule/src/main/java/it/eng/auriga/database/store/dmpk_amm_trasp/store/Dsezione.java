...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.DsezioneImpl;
 ...
 */
@Service(name="DmpkAmmTraspDsezione")
public class Dsezione {
		
	private DmpkAmmTraspDsezioneBean bean;
		  
	public void setBean(DmpkAmmTraspDsezioneBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspDsezioneBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspDsezioneBean pBean) throws Exception{
	   final DsezioneImpl lDsezione = new DsezioneImpl();
	   setBean(pBean);
	   lDsezione.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDsezione.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspDsezioneBean> result = new StoreResultBean<DmpkAmmTraspDsezioneBean>();
