...
public class DaltriallegatifatturaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_EFACT.DALTRIALLEGATIFATTURA(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idkeyin",4,Types.DECIMAL,connection); 	
