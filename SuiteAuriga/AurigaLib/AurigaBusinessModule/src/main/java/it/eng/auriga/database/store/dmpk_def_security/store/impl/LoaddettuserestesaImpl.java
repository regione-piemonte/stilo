...
public class LoaddettuserestesaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DEF_SECURITY.LOADDETTUSERESTESA(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"daticlientiout",33,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"bachsizeout",34,Types.INTEGER); 
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"codrapidoout",39,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"codfiscaleout",40,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"accountdeflockedout",41,Types.INTEGER); 
