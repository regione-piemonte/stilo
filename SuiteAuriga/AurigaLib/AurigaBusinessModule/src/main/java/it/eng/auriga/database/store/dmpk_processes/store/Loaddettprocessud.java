...
import it.eng.auriga.database.store.dmpk_processes.store.impl.LoaddettprocessudImpl;
 ...
 */
@Service(name="DmpkProcessesLoaddettprocessud")
public class Loaddettprocessud {
	...
	public StoreResultBean<DmpkProcessesLoaddettprocessudBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesLoaddettprocessudBean pBean) throws Exception{
	   final LoaddettprocessudImpl lLoaddettprocessud = new LoaddettprocessudImpl();
	   setBean(pBean);
	   lLoaddettprocessud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettprocessud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesLoaddettprocessudBean> result = new StoreResultBean<DmpkProcessesLoaddettprocessudBean>();
