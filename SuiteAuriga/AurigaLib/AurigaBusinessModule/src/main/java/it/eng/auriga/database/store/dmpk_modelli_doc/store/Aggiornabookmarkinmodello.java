...
package it.eng.auriga.database.store.dmpk_modelli_doc.store;

import it.eng.auriga.database.store.dmpk_modelli_doc.bean.DmpkModelliDocAggiornabookmarkinmodelloBean;
import it.eng.auriga.database.store.dmpk_modelli_doc.store.impl.AggiornabookmarkinmodelloImpl;
 ...
 */
@Service(name="DmpkModelliDocAggiornabookmarkinmodello")
public class Aggiornabookmarkinmodello {
		
	private DmpkModelliDocAggiornabookmarkinmodelloBean bean;
		  
	public void setBean(DmpkModelliDocAggiornabookmarkinmodelloBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkModelliDocAggiornabookmarkinmodelloBean> execute(AurigaLoginBean lLoginBean, DmpkModelliDocAggiornabookmarkinmodelloBean pBean) throws Exception{
	   final AggiornabookmarkinmodelloImpl lAggiornabookmarkinmodello = new AggiornabookmarkinmodelloImpl();
	   setBean(pBean);
	   lAggiornabookmarkinmodello.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAggiornabookmarkinmodello.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkModelliDocAggiornabookmarkinmodelloBean> result = new StoreResultBean<DmpkModelliDocAggiornabookmarkinmodelloBean>();
