...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.IugrupposoggrubricaImpl;
 ...
 */
@Service(name="DmpkAnagraficaIugrupposoggrubrica")
public class Iugrupposoggrubrica {
	...
	public StoreResultBean<DmpkAnagraficaIugrupposoggrubricaBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaIugrupposoggrubricaBean pBean) throws Exception{
	   final IugrupposoggrubricaImpl lIugrupposoggrubrica = new IugrupposoggrubricaImpl();
	   setBean(pBean);
	   lIugrupposoggrubrica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIugrupposoggrubrica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaIugrupposoggrubricaBean> result = new StoreResultBean<DmpkAnagraficaIugrupposoggrubricaBean>();
