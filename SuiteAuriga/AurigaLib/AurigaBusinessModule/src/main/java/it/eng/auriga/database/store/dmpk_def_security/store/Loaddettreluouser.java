...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettreluouserImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettreluouser")
public class Loaddettreluouser {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettreluouserBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettreluouserBean pBean) throws Exception{
	   final LoaddettreluouserImpl lLoaddettreluouser = new LoaddettreluouserImpl();
	   setBean(pBean);
	   lLoaddettreluouser.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettreluouser.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettreluouserBean> result = new StoreResultBean<DmpkDefSecurityLoaddettreluouserBean>();
