...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactIudocumentolottoeventiBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.IudocumentolottoeventiImpl;
 ...
 */
@Service(name="DmpkEfactIudocumentolottoeventi")
public class Iudocumentolottoeventi {
		
	private DmpkEfactIudocumentolottoeventiBean bean;
		  
	public void setBean(DmpkEfactIudocumentolottoeventiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactIudocumentolottoeventiBean> execute(AurigaLoginBean lLoginBean, DmpkEfactIudocumentolottoeventiBean pBean) throws Exception{
	   final IudocumentolottoeventiImpl lIudocumentolottoeventi = new IudocumentolottoeventiImpl();
	   setBean(pBean);
	   lIudocumentolottoeventi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIudocumentolottoeventi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactIudocumentolottoeventiBean> result = new StoreResultBean<DmpkEfactIudocumentolottoeventiBean>();
