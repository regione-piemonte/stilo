 ...
 */
@Service(name="DmpkCollaborationAnnullamentonotifica")
public class Annullamentonotifica {
	...
	public StoreResultBean<DmpkCollaborationAnnullamentonotificaBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationAnnullamentonotificaBean pBean) throws Exception{
	   final AnnullamentonotificaImpl lAnnullamentonotifica = new AnnullamentonotificaImpl();
	   setBean(pBean);
	   lAnnullamentonotifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAnnullamentonotifica.execute(paramConnection);
				}
			});
