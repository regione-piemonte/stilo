...
import it.eng.auriga.database.store.dmpk_ws.store.impl.TrovautentiImpl;
 ...
 */
@Service(name="DmpkWsTrovautenti")
public class Trovautenti {
		
	private DmpkWsTrovautentiBean bean;
		  
	public void setBean(DmpkWsTrovautentiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsTrovautentiBean> execute(AurigaLoginBean lLoginBean, DmpkWsTrovautentiBean pBean) throws Exception{
	   final TrovautentiImpl lTrovautenti = new TrovautentiImpl();
	   setBean(pBean);
	   lTrovautenti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovautenti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsTrovautentiBean> result = new StoreResultBean<DmpkWsTrovautentiBean>();
