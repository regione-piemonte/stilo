...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.MovepostazioneutenteImpl;
 ...
 */
@Service(name="DmpkDefSecurityMovepostazioneutente")
public class Movepostazioneutente {
	...
	public StoreResultBean<DmpkDefSecurityMovepostazioneutenteBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityMovepostazioneutenteBean pBean) throws Exception{
	   final MovepostazioneutenteImpl lMovepostazioneutente = new MovepostazioneutenteImpl();
	   setBean(pBean);
	   lMovepostazioneutente.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lMovepostazioneutente.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityMovepostazioneutenteBean> result = new StoreResultBean<DmpkDefSecurityMovepostazioneutenteBean>();
