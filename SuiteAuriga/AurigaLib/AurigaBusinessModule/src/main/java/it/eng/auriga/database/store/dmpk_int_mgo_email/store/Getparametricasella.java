...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.GetparametricasellaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailGetparametricasella")
public class Getparametricasella {
		
	private DmpkIntMgoEmailGetparametricasellaBean bean;
		  
	public void setBean(DmpkIntMgoEmailGetparametricasellaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailGetparametricasellaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailGetparametricasellaBean pBean) throws Exception{
	   final GetparametricasellaImpl lGetparametricasella = new GetparametricasellaImpl();
	   setBean(pBean);
	   lGetparametricasella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetparametricasella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailGetparametricasellaBean> result = new StoreResultBean<DmpkIntMgoEmailGetparametricasellaBean>();
