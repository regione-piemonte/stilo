...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactDaltriallegatifatturaBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.DaltriallegatifatturaImpl;
 ...
 */
@Service(name="DmpkEfactDaltriallegatifattura")
public class Daltriallegatifattura {
		
	private DmpkEfactDaltriallegatifatturaBean bean;
		  
	public void setBean(DmpkEfactDaltriallegatifatturaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactDaltriallegatifatturaBean> execute(AurigaLoginBean lLoginBean, DmpkEfactDaltriallegatifatturaBean pBean) throws Exception{
	   final DaltriallegatifatturaImpl lDaltriallegatifattura = new DaltriallegatifatturaImpl();
	   setBean(pBean);
	   lDaltriallegatifattura.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDaltriallegatifattura.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactDaltriallegatifatturaBean> result = new StoreResultBean<DmpkEfactDaltriallegatifatturaBean>();
