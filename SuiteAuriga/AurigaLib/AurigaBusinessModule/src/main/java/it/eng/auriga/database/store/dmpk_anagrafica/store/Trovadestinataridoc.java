...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.TrovadestinataridocImpl;
 ...
 */
@Service(name="DmpkAnagraficaTrovadestinataridoc")
public class Trovadestinataridoc {
	...
	public StoreResultBean<DmpkAnagraficaTrovadestinataridocBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaTrovadestinataridocBean pBean) throws Exception{
	   final TrovadestinataridocImpl lTrovadestinataridoc = new TrovadestinataridocImpl();
	   setBean(pBean);
	   lTrovadestinataridoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadestinataridoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaTrovadestinataridocBean> result = new StoreResultBean<DmpkAnagraficaTrovadestinataridocBean>();
