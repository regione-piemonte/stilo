...
import it.eng.auriga.database.store.dmpk_folder_types.store.impl.IufoldertypeImpl;
 ...
 */
@Service(name="DmpkFolderTypesIufoldertype")
public class Iufoldertype {
	...
	public StoreResultBean<DmpkFolderTypesIufoldertypeBean> execute(AurigaLoginBean lLoginBean, DmpkFolderTypesIufoldertypeBean pBean) throws Exception{
	   final IufoldertypeImpl lIufoldertype = new IufoldertypeImpl();
	   setBean(pBean);
	   lIufoldertype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIufoldertype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFolderTypesIufoldertypeBean> result = new StoreResultBean<DmpkFolderTypesIufoldertypeBean>();
