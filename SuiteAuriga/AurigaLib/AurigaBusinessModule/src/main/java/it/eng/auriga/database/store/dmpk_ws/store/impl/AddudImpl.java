...
public class AddudImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.ADDUD(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"docattachxmlout",4,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"regnumdarichasistestout",5,Types.CLOB); 
