...
import it.eng.auriga.database.store.dmpk_collaboration.store.impl.GetinviinotificheannullabiliImpl;
 ...
 */
@Service(name="DmpkCollaborationGetinviinotificheannullabili")
public class Getinviinotificheannullabili {
		
	private DmpkCollaborationGetinviinotificheannullabiliBean bean;
		  
	public void setBean(DmpkCollaborationGetinviinotificheannullabiliBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCollaborationGetinviinotificheannullabiliBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationGetinviinotificheannullabiliBean pBean) throws Exception{
	   final GetinviinotificheannullabiliImpl lGetinviinotificheannullabili = new GetinviinotificheannullabiliImpl();
	   setBean(pBean);
	   lGetinviinotificheannullabili.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinviinotificheannullabili.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCollaborationGetinviinotificheannullabiliBean> result = new StoreResultBean<DmpkCollaborationGetinviinotificheannullabiliBean>();
