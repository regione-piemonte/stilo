...
import it.eng.auriga.database.store.dmpk_gae.bean.DmpkGaeIusottoscrizionenotificamailBean;
import it.eng.auriga.database.store.dmpk_gae.store.impl.IusottoscrizionenotificamailImpl;
 ...
 */
@Service(name="DmpkGaeIusottoscrizionenotificamail")
public class Iusottoscrizionenotificamail {
		
	private DmpkGaeIusottoscrizionenotificamailBean bean;
		  
	public void setBean(DmpkGaeIusottoscrizionenotificamailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkGaeIusottoscrizionenotificamailBean> execute(AurigaLoginBean lLoginBean, DmpkGaeIusottoscrizionenotificamailBean pBean) throws Exception{
	   final IusottoscrizionenotificamailImpl lIusottoscrizionenotificamail = new IusottoscrizionenotificamailImpl();
	   setBean(pBean);
	   lIusottoscrizionenotificamail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIusottoscrizionenotificamail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkGaeIusottoscrizionenotificamailBean> result = new StoreResultBean<DmpkGaeIusottoscrizionenotificamailBean>();
