...
public class GetidorganigrammaspaooImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DEF_SECURITY.GETIDORGANIGRAMMASPAOO(?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"tsrifin",3,Types.TIMESTAMP,connection); 	
