...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.InsrichopmassiveImpl;
 ...
 */
@Service(name="DmpkBmanagerInsrichopmassive")
public class Insrichopmassive {
	...
	public StoreResultBean<DmpkBmanagerInsrichopmassiveBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerInsrichopmassiveBean pBean) throws Exception{
	   final InsrichopmassiveImpl lInsrichopmassive = new InsrichopmassiveImpl();
	   setBean(pBean);
	   lInsrichopmassive.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lInsrichopmassive.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerInsrichopmassiveBean> result = new StoreResultBean<DmpkBmanagerInsrichopmassiveBean>();
