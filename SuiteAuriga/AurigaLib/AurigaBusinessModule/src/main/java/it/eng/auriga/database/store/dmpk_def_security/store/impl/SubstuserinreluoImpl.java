...
public class SubstuserinreluoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgprimarioconruoloin",15,Types.INTEGER,connection); 	
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgaccessodoclimsvin",22,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgregistrazioneein",23,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgregistrazioneuiin",24,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flggestattiin",25,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgvispropattiiniterin",26,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flggestattiallin",27,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"listaidproctygestattiin",28,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgvispropattiallin",29,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"listaidproctyvispropattiin",30,Types.VARCHAR,connection); 	
