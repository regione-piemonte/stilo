...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactGetlistaoperazionilottoBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.GetlistaoperazionilottoImpl;
 ...
 */
@Service(name="DmpkEfactGetlistaoperazionilotto")
public class Getlistaoperazionilotto {
		
	private DmpkEfactGetlistaoperazionilottoBean bean;
		  
	public void setBean(DmpkEfactGetlistaoperazionilottoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactGetlistaoperazionilottoBean> execute(AurigaLoginBean lLoginBean, DmpkEfactGetlistaoperazionilottoBean pBean) throws Exception{
	   final GetlistaoperazionilottoImpl lGetlistaoperazionilotto = new GetlistaoperazionilottoImpl();
	   setBean(pBean);
	   lGetlistaoperazionilotto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlistaoperazionilotto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactGetlistaoperazionilottoBean> result = new StoreResultBean<DmpkEfactGetlistaoperazionilottoBean>();
