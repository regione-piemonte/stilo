...
public class AnnullaassegnazioneemailImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_MGO_EMAIL.ANNULLAASSEGNAZIONEEMAIL(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idassemailtoannin",5,Types.VARCHAR,connection); 	
