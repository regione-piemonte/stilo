...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TrovafunzioniImpl;
 ...
 */
@Service(name="DmpkDefSecurityTrovafunzioni")
public class Trovafunzioni {
	...
	public StoreResultBean<DmpkDefSecurityTrovafunzioniBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTrovafunzioniBean pBean) throws Exception{
	   final TrovafunzioniImpl lTrovafunzioni = new TrovafunzioniImpl();
	   setBean(pBean);
	   lTrovafunzioni.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovafunzioni.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTrovafunzioniBean> result = new StoreResultBean<DmpkDefSecurityTrovafunzioniBean>();
