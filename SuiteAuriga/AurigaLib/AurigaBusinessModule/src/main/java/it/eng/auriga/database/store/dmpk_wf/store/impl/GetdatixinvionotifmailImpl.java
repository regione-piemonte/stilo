...
public class GetdatixinvionotifmailImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WF.GETDATIXINVIONOTIFMAIL(?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"mailinfoxmlout",6,Types.CLOB); 
