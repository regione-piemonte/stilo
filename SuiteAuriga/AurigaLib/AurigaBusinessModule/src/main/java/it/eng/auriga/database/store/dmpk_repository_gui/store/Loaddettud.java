...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.LoaddettudImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiLoaddettud")
public class Loaddettud {
	...
	public StoreResultBean<DmpkRepositoryGuiLoaddettudBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiLoaddettudBean pBean) throws Exception{
	   final LoaddettudImpl lLoaddettud = new LoaddettudImpl();
	   setBean(pBean);
	   lLoaddettud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiLoaddettudBean> result = new StoreResultBean<DmpkRepositoryGuiLoaddettudBean>();
