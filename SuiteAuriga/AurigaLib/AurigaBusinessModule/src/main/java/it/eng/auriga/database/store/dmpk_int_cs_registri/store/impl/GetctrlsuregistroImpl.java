...
public class GetctrlsuregistroImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_CS_REGISTRI.GETCTRLSUREGISTRO(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"mimetypeout",4,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgrichfirmaout",5,Types.INTEGER); 
