...
import it.eng.auriga.database.store.dmpk_utility.store.impl.IuintopograficoImpl;
 ...
 */
@Service(name="DmpkUtilityIuintopografico")
public class Iuintopografico {
	...
	public StoreResultBean<DmpkUtilityIuintopograficoBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityIuintopograficoBean pBean) throws Exception{
	   final IuintopograficoImpl lIuintopografico = new IuintopograficoImpl();
	   setBean(pBean);
	   lIuintopografico.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuintopografico.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityIuintopograficoBean> result = new StoreResultBean<DmpkUtilityIuintopograficoBean>();
