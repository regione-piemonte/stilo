...
import it.eng.auriga.database.store.dmpk_ws.store.impl.RicercaagibilitadaportaleImpl;
 ...
 */
@Service(name="DmpkWsRicercaagibilitadaportale")
public class Ricercaagibilitadaportale {
	...
	public StoreResultBean<DmpkWsRicercaagibilitadaportaleBean> execute(AurigaLoginBean lLoginBean, DmpkWsRicercaagibilitadaportaleBean pBean) throws Exception{
	   final RicercaagibilitadaportaleImpl lRicercaagibilitadaportale = new RicercaagibilitadaportaleImpl();
	   setBean(pBean);
	   lRicercaagibilitadaportale.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRicercaagibilitadaportale.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsRicercaagibilitadaportaleBean> result = new StoreResultBean<DmpkWsRicercaagibilitadaportaleBean>();
	...
	protected void setToken(AurigaLoginBean pLoginBean) {
		bean.setConntokenout(pLoginBean.getToken());
	}
