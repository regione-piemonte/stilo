...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.PrepararegdefregemergenzaImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocPrepararegdefregemergenza")
public class Prepararegdefregemergenza {
		
	private DmpkRegistrazionedocPrepararegdefregemergenzaBean bean;
		  
	public void setBean(DmpkRegistrazionedocPrepararegdefregemergenzaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocPrepararegdefregemergenzaBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocPrepararegdefregemergenzaBean pBean) throws Exception{
	   final PrepararegdefregemergenzaImpl lPrepararegdefregemergenza = new PrepararegdefregemergenzaImpl();
	   setBean(pBean);
	   lPrepararegdefregemergenza.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lPrepararegdefregemergenza.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocPrepararegdefregemergenzaBean> result = new StoreResultBean<DmpkRegistrazionedocPrepararegdefregemergenzaBean>();
