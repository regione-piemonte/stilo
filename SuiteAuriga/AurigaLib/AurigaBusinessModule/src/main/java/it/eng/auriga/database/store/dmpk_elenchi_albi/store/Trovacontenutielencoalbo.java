 ...
 */
@Service(name="DmpkElenchiAlbiTrovacontenutielencoalbo")
public class Trovacontenutielencoalbo {
	...
	public StoreResultBean<DmpkElenchiAlbiTrovacontenutielencoalboBean> execute(AurigaLoginBean lLoginBean, DmpkElenchiAlbiTrovacontenutielencoalboBean pBean) throws Exception{
	   final TrovacontenutielencoalboImpl lTrovacontenutielencoalbo = new TrovacontenutielencoalboImpl();
	   setBean(pBean);
	   lTrovacontenutielencoalbo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovacontenutielencoalbo.execute(paramConnection);
				}
			});
