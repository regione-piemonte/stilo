...
public class TrovaeventtypesImpl  {
		
	private DmpkProcessTypesTrovaeventtypesBean bean;
		  
	public void setBean(DmpkProcessTypesTrovaeventtypesBean bean){
		this.bean = bean;
	}
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESS_TYPES.TROVAEVENTTYPES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"ideventtypeio",5,Types.DECIMAL,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"deseventio",6,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"categoriaio",7,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgdurativoio",8,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgvldxtuttiprocammio",9,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"idprocesstypeio",10,Types.DECIMAL,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"nomeprocesstypeio",11,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"idprocessio",12,Types.DECIMAL,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgmodterminiprocio",13,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgassociatotipodocio",14,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"iddoctypeio",15,Types.DECIMAL,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"nomedoctypeio",16,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"ciproveventtypeio",17,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"codapplicazioneio",18,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"codistapplicazioneio",19,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flginclannullatiio",20,Types.DECIMAL,connection); 	
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgesclevtattprocin",39,Types.INTEGER,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"ideventtypeio",5,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"deseventio",6,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"categoriaio",7,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgdurativoio",8,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgvldxtuttiprocammio",9,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"idprocesstypeio",10,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"nomeprocesstypeio",11,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"idprocessio",12,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgmodterminiprocio",13,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgassociatotipodocio",14,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"iddoctypeio",15,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"nomedoctypeio",16,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"ciproveventtypeio",17,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"codapplicazioneio",18,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"codistapplicazioneio",19,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flginclannullatiio",20,Types.DECIMAL); 
