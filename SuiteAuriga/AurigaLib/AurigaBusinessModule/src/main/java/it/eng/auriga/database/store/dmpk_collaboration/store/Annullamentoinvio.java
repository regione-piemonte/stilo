 ...
 */
@Service(name="DmpkCollaborationAnnullamentoinvio")
public class Annullamentoinvio {
		
	private DmpkCollaborationAnnullamentoinvioBean bean;
		  
	public void setBean(DmpkCollaborationAnnullamentoinvioBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCollaborationAnnullamentoinvioBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationAnnullamentoinvioBean pBean) throws Exception{
	   final AnnullamentoinvioImpl lAnnullamentoinvio = new AnnullamentoinvioImpl();
	   setBean(pBean);
	   lAnnullamentoinvio.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAnnullamentoinvio.execute(paramConnection);
				}
			});
