...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.IudoctypeproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesIudoctypeproctype")
public class Iudoctypeproctype {
	...
	public StoreResultBean<DmpkProcessTypesIudoctypeproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesIudoctypeproctypeBean pBean) throws Exception{
	   final IudoctypeproctypeImpl lIudoctypeproctype = new IudoctypeproctypeImpl();
	   setBean(pBean);
	   lIudoctypeproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIudoctypeproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesIudoctypeproctypeBean> result = new StoreResultBean<DmpkProcessTypesIudoctypeproctypeBean>();
