...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreGetinheritedaclxfolderBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.GetinheritedaclxfolderImpl;
 ...
 */
@Service(name="DmpkCoreGetinheritedaclxfolder")
public class Getinheritedaclxfolder {
		
	private DmpkCoreGetinheritedaclxfolderBean bean;
		  
	public void setBean(DmpkCoreGetinheritedaclxfolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreGetinheritedaclxfolderBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetinheritedaclxfolderBean pBean) throws Exception{
	   final GetinheritedaclxfolderImpl lGetinheritedaclxfolder = new GetinheritedaclxfolderImpl();
	   setBean(pBean);
	   lGetinheritedaclxfolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinheritedaclxfolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGetinheritedaclxfolderBean> result = new StoreResultBean<DmpkCoreGetinheritedaclxfolderBean>();
