...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.DclienteImpl;
 ...
 */
@Service(name="DmpkAnagraficaDcliente")
public class Dcliente {
	...
	public StoreResultBean<DmpkAnagraficaDclienteBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaDclienteBean pBean) throws Exception{
	   final DclienteImpl lDcliente = new DclienteImpl();
	   setBean(pBean);
	   lDcliente.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDcliente.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaDclienteBean> result = new StoreResultBean<DmpkAnagraficaDclienteBean>();
