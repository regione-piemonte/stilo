...
import it.eng.auriga.database.store.dmpk_ws.bean.DmpkWsGetpossibilidestosservazsuudBean;
import it.eng.auriga.database.store.dmpk_ws.store.impl.GetpossibilidestosservazsuudImpl;
 ...
 */
@Service(name="DmpkWsGetpossibilidestosservazsuud")
public class Getpossibilidestosservazsuud {
		
	private DmpkWsGetpossibilidestosservazsuudBean bean;
		  
	public void setBean(DmpkWsGetpossibilidestosservazsuudBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsGetpossibilidestosservazsuudBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetpossibilidestosservazsuudBean pBean) throws Exception{
	   final GetpossibilidestosservazsuudImpl lGetpossibilidestosservazsuud = new GetpossibilidestosservazsuudImpl();
	   setBean(pBean);
	   lGetpossibilidestosservazsuud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetpossibilidestosservazsuud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetpossibilidestosservazsuudBean> result = new StoreResultBean<DmpkWsGetpossibilidestosservazsuudBean>();
