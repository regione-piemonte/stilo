...
import it.eng.auriga.database.store.dmpk_processes.store.impl.IusoggettoesternoImpl;
 ...
 */
@Service(name="DmpkProcessesIusoggettoesterno")
public class Iusoggettoesterno {
	...
	public StoreResultBean<DmpkProcessesIusoggettoesternoBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesIusoggettoesternoBean pBean) throws Exception{
	   final IusoggettoesternoImpl lIusoggettoesterno = new IusoggettoesternoImpl();
	   setBean(pBean);
	   lIusoggettoesterno.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIusoggettoesterno.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesIusoggettoesternoBean> result = new StoreResultBean<DmpkProcessesIusoggettoesternoBean>();
