...
import it.eng.auriga.database.store.dmpk_ws.store.impl.AddtipofolderImpl;
 ...
 */
@Service(name="DmpkWsAddtipofolder")
public class Addtipofolder {
		
	private DmpkWsAddtipofolderBean bean;
		  
	public void setBean(DmpkWsAddtipofolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsAddtipofolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsAddtipofolderBean pBean) throws Exception{
	   final AddtipofolderImpl lAddtipofolder = new AddtipofolderImpl();
	   setBean(pBean);
	   lAddtipofolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddtipofolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsAddtipofolderBean> result = new StoreResultBean<DmpkWsAddtipofolderBean>();
