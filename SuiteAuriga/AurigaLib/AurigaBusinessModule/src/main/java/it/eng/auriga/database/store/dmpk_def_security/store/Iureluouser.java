 ...
 */
@Service(name="DmpkDefSecurityIureluouser")
public class Iureluouser {
	...
	public StoreResultBean<DmpkDefSecurityIureluouserBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityIureluouserBean pBean) throws Exception{
	   final IureluouserImpl lIureluouser = new IureluouserImpl();
	   setBean(pBean);
	   lIureluouser.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIureluouser.execute(paramConnection);
				}
			});
