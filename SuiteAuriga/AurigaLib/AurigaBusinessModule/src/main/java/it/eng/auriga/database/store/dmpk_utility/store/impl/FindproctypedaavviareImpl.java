...
public class FindproctypedaavviareImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.FINDPROCTYPEDAAVVIARE(?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"nomeprocesstypein",5,Types.VARCHAR,connection); 	
