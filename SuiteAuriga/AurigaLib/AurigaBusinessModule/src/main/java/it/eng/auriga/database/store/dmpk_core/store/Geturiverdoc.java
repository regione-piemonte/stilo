...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreGeturiverdocBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.GeturiverdocImpl;
 ...
 */
@Service(name="DmpkCoreGeturiverdoc")
public class Geturiverdoc {
		
	private DmpkCoreGeturiverdocBean bean;
		  
	public void setBean(DmpkCoreGeturiverdocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreGeturiverdocBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGeturiverdocBean pBean) throws Exception{
	   final GeturiverdocImpl lGeturiverdoc = new GeturiverdocImpl();
	   setBean(pBean);
	   lGeturiverdoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGeturiverdoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGeturiverdocBean> result = new StoreResultBean<DmpkCoreGeturiverdocBean>();
