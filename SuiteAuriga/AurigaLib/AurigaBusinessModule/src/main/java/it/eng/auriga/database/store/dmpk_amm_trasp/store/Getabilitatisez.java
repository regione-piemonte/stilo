...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.GetabilitatisezImpl;
 ...
 */
@Service(name="DmpkAmmTraspGetabilitatisez")
public class Getabilitatisez {
		
	private DmpkAmmTraspGetabilitatisezBean bean;
		  
	public void setBean(DmpkAmmTraspGetabilitatisezBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspGetabilitatisezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspGetabilitatisezBean pBean) throws Exception{
	   final GetabilitatisezImpl lGetabilitatisez = new GetabilitatisezImpl();
	   setBean(pBean);
	   lGetabilitatisez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetabilitatisez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspGetabilitatisezBean> result = new StoreResultBean<DmpkAmmTraspGetabilitatisezBean>();
