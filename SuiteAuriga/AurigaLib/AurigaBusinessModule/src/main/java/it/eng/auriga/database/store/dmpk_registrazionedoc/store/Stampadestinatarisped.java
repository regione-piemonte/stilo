...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.StampadestinatarispedImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocStampadestinatarisped")
public class Stampadestinatarisped {
	...
	public StoreResultBean<DmpkRegistrazionedocStampadestinatarispedBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocStampadestinatarispedBean pBean) throws Exception{
	   final StampadestinatarispedImpl lStampadestinatarisped = new StampadestinatarispedImpl();
	   setBean(pBean);
	   lStampadestinatarisped.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lStampadestinatarisped.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocStampadestinatarispedBean> result = new StoreResultBean<DmpkRegistrazionedocStampadestinatarispedBean>();
