...
import it.eng.auriga.database.store.dmpk_processes.store.impl.IuprocobjImpl;
 ...
 */
@Service(name="DmpkProcessesIuprocobj")
public class Iuprocobj {
	...
	public StoreResultBean<DmpkProcessesIuprocobjBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesIuprocobjBean pBean) throws Exception{
	   final IuprocobjImpl lIuprocobj = new IuprocobjImpl();
	   setBean(pBean);
	   lIuprocobj.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuprocobj.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesIuprocobjBean> result = new StoreResultBean<DmpkProcessesIuprocobjBean>();
