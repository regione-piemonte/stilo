 ...
 */
@Service(name="DmpkProcessesIueventocustom")
public class Iueventocustom {
	...
	public StoreResultBean<DmpkProcessesIueventocustomBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesIueventocustomBean pBean) throws Exception{
	   final IueventocustomImpl lIueventocustom = new IueventocustomImpl();
	   setBean(pBean);
	   lIueventocustom.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIueventocustom.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesIueventocustomBean> result = new StoreResultBean<DmpkProcessesIueventocustomBean>();
