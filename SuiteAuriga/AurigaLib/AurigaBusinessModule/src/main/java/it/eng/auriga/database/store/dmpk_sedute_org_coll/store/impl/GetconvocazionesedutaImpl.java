...
public class GetconvocazionesedutaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_SEDUTE_ORG_COLL.GETCONVOCAZIONESEDUTA(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"convocazioneinfoout",15,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"argomentiodgout",16,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"presenzeout",17,Types.CLOB); 
