...
public class GettaskinstidinflowImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WF.GETTASKINSTIDINFLOW(?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"ciflussowfin",2,Types.VARCHAR,connection); 	
