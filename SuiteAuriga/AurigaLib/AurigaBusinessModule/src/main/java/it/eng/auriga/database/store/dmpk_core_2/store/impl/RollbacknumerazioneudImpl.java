...
public class RollbacknumerazioneudImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE_2.ROLLBACKNUMERAZIONEUD(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"codcategorianumin",5,Types.VARCHAR,connection); 	
