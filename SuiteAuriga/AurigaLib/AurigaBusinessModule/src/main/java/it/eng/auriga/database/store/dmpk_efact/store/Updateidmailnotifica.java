...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactUpdateidmailnotificaBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.UpdateidmailnotificaImpl;
 ...
 */
@Service(name="DmpkEfactUpdateidmailnotifica")
public class Updateidmailnotifica {
		
	private DmpkEfactUpdateidmailnotificaBean bean;
		  
	public void setBean(DmpkEfactUpdateidmailnotificaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactUpdateidmailnotificaBean> execute(AurigaLoginBean lLoginBean, DmpkEfactUpdateidmailnotificaBean pBean) throws Exception{
	   final UpdateidmailnotificaImpl lUpdateidmailnotifica = new UpdateidmailnotificaImpl();
	   setBean(pBean);
	   lUpdateidmailnotifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUpdateidmailnotifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactUpdateidmailnotificaBean> result = new StoreResultBean<DmpkEfactUpdateidmailnotificaBean>();
