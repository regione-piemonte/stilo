...
import it.eng.auriga.database.store.dmpk_corrispettivi.bean.DmpkCorrispettiviGettipoinvioBean;
import it.eng.auriga.database.store.dmpk_corrispettivi.store.impl.GettipoinvioImpl;
 ...
 */
@Service(name="DmpkCorrispettiviGettipoinvio")
public class Gettipoinvio {
		
	private DmpkCorrispettiviGettipoinvioBean bean;
		  
	public void setBean(DmpkCorrispettiviGettipoinvioBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCorrispettiviGettipoinvioBean> execute(AurigaLoginBean lLoginBean, DmpkCorrispettiviGettipoinvioBean pBean) throws Exception{
	   final GettipoinvioImpl lGettipoinvio = new GettipoinvioImpl();
	   setBean(pBean);
	   lGettipoinvio.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGettipoinvio.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCorrispettiviGettipoinvioBean> result = new StoreResultBean<DmpkCorrispettiviGettipoinvioBean>();
