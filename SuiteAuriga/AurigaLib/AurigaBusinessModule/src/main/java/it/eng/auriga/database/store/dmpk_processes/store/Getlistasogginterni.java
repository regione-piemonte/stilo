...
import it.eng.auriga.database.store.dmpk_processes.bean.DmpkProcessesGetlistasogginterniBean;
import it.eng.auriga.database.store.dmpk_processes.store.impl.GetlistasogginterniImpl;
 ...
 */
@Service(name="DmpkProcessesGetlistasogginterni")
public class Getlistasogginterni {
		
	private DmpkProcessesGetlistasogginterniBean bean;
		  
	public void setBean(DmpkProcessesGetlistasogginterniBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesGetlistasogginterniBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesGetlistasogginterniBean pBean) throws Exception{
	   final GetlistasogginterniImpl lGetlistasogginterni = new GetlistasogginterniImpl();
	   setBean(pBean);
	   lGetlistasogginterni.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlistasogginterni.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesGetlistasogginterniBean> result = new StoreResultBean<DmpkProcessesGetlistasogginterniBean>();
