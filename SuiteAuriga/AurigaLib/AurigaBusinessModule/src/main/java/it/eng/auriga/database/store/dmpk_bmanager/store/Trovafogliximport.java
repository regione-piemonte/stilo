...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.TrovafogliximportImpl;
 ...
 */
@Service(name="DmpkBmanagerTrovafogliximport")
public class Trovafogliximport {
		
	private DmpkBmanagerTrovafogliximportBean bean;
		  
	public void setBean(DmpkBmanagerTrovafogliximportBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerTrovafogliximportBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerTrovafogliximportBean pBean) throws Exception{
	   final TrovafogliximportImpl lTrovafogliximport = new TrovafogliximportImpl();
	   setBean(pBean);
	   lTrovafogliximport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovafogliximport.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerTrovafogliximportBean> result = new StoreResultBean<DmpkBmanagerTrovafogliximportBean>();
