...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityRegconntokenusageBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.RegconntokenusageImpl;
 ...
 */
@Service(name="DmpkUtilityRegconntokenusage")
public class Regconntokenusage {
		
	private DmpkUtilityRegconntokenusageBean bean;
		  
	public void setBean(DmpkUtilityRegconntokenusageBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityRegconntokenusageBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityRegconntokenusageBean pBean) throws Exception{
	   final RegconntokenusageImpl lRegconntokenusage = new RegconntokenusageImpl();
	   setBean(pBean);
	   lRegconntokenusage.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRegconntokenusage.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityRegconntokenusageBean> result = new StoreResultBean<DmpkUtilityRegconntokenusageBean>();
