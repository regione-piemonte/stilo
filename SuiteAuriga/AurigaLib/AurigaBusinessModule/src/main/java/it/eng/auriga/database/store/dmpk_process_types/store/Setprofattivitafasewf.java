...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.SetprofattivitafasewfImpl;
 ...
 */
@Service(name="DmpkProcessTypesSetprofattivitafasewf")
public class Setprofattivitafasewf {
	...
	public StoreResultBean<DmpkProcessTypesSetprofattivitafasewfBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesSetprofattivitafasewfBean pBean) throws Exception{
	   final SetprofattivitafasewfImpl lSetprofattivitafasewf = new SetprofattivitafasewfImpl();
	   setBean(pBean);
	   lSetprofattivitafasewf.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetprofattivitafasewf.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesSetprofattivitafasewfBean> result = new StoreResultBean<DmpkProcessTypesSetprofattivitafasewfBean>();
