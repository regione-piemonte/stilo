...
import it.eng.auriga.database.store.dmpk_processes.bean.DmpkProcessesLoaddettsoggesternoprocBean;
import it.eng.auriga.database.store.dmpk_processes.store.impl.LoaddettsoggesternoprocImpl;
 ...
 */
@Service(name="DmpkProcessesLoaddettsoggesternoproc")
public class Loaddettsoggesternoproc {
		
	private DmpkProcessesLoaddettsoggesternoprocBean bean;
		  
	public void setBean(DmpkProcessesLoaddettsoggesternoprocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesLoaddettsoggesternoprocBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesLoaddettsoggesternoprocBean pBean) throws Exception{
	   final LoaddettsoggesternoprocImpl lLoaddettsoggesternoproc = new LoaddettsoggesternoprocImpl();
	   setBean(pBean);
	   lLoaddettsoggesternoproc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettsoggesternoproc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesLoaddettsoggesternoprocBean> result = new StoreResultBean<DmpkProcessesLoaddettsoggesternoprocBean>();
