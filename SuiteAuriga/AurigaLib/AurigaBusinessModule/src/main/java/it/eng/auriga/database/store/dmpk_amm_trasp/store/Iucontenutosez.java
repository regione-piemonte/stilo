...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.IucontenutosezImpl;
 ...
 */
@Service(name="DmpkAmmTraspIucontenutosez")
public class Iucontenutosez {
	...
	public StoreResultBean<DmpkAmmTraspIucontenutosezBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspIucontenutosezBean pBean) throws Exception{
	   final IucontenutosezImpl lIucontenutosez = new IucontenutosezImpl();
	   setBean(pBean);
	   lIucontenutosez.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIucontenutosez.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspIucontenutosezBean> result = new StoreResultBean<DmpkAmmTraspIucontenutosezBean>();
