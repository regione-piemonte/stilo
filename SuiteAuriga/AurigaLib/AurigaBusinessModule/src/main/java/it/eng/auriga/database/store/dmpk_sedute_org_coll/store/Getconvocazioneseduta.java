...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.GetconvocazionesedutaImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollGetconvocazioneseduta")
public class Getconvocazioneseduta {
		
	private DmpkSeduteOrgCollGetconvocazionesedutaBean bean;
		  
	public void setBean(DmpkSeduteOrgCollGetconvocazionesedutaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkSeduteOrgCollGetconvocazionesedutaBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollGetconvocazionesedutaBean pBean) throws Exception{
	   final GetconvocazionesedutaImpl lGetconvocazioneseduta = new GetconvocazionesedutaImpl();
	   setBean(pBean);
	   lGetconvocazioneseduta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetconvocazioneseduta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollGetconvocazionesedutaBean> result = new StoreResultBean<DmpkSeduteOrgCollGetconvocazionesedutaBean>();
