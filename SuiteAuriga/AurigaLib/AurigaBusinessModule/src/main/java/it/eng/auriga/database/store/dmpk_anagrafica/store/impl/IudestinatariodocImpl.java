...
public class IudestinatariodocImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_ANAGRAFICA.IUDESTINATARIODOC(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"ciprovdestdocin",29,Types.VARCHAR,connection); 	
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgmodutenzeassociatein",42,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"utenzeassociatein",43,Types.CLOB,connection); 	
