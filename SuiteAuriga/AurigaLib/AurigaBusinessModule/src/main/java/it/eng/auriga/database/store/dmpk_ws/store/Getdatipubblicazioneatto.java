...
import it.eng.auriga.database.store.dmpk_ws.store.impl.GetdatipubblicazioneattoImpl;
 ...
 */
@Service(name="DmpkWsGetdatipubblicazioneatto")
public class Getdatipubblicazioneatto {
		
	private DmpkWsGetdatipubblicazioneattoBean bean;
		  
	public void setBean(DmpkWsGetdatipubblicazioneattoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsGetdatipubblicazioneattoBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetdatipubblicazioneattoBean pBean) throws Exception{
	   final GetdatipubblicazioneattoImpl lGetdatipubblicazioneatto = new GetdatipubblicazioneattoImpl();
	   setBean(pBean);
	   lGetdatipubblicazioneatto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatipubblicazioneatto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetdatipubblicazioneattoBean> result = new StoreResultBean<DmpkWsGetdatipubblicazioneattoBean>();
