...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetlogudfascxguimodprotImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetlogudfascxguimodprot")
public class Getlogudfascxguimodprot {
		
	private DmpkRepositoryGuiGetlogudfascxguimodprotBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetlogudfascxguimodprotBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetlogudfascxguimodprotBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetlogudfascxguimodprotBean pBean) throws Exception{
	   final GetlogudfascxguimodprotImpl lGetlogudfascxguimodprot = new GetlogudfascxguimodprotImpl();
	   setBean(pBean);
	   lGetlogudfascxguimodprot.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlogudfascxguimodprot.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetlogudfascxguimodprotBean> result = new StoreResultBean<DmpkRepositoryGuiGetlogudfascxguimodprotBean>();
