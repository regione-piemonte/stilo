...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactGetinfoapplicazionefromudBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.GetinfoapplicazionefromudImpl;
 ...
 */
@Service(name="DmpkEfactGetinfoapplicazionefromud")
public class Getinfoapplicazionefromud {
		
	private DmpkEfactGetinfoapplicazionefromudBean bean;
		  
	public void setBean(DmpkEfactGetinfoapplicazionefromudBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactGetinfoapplicazionefromudBean> execute(AurigaLoginBean lLoginBean, DmpkEfactGetinfoapplicazionefromudBean pBean) throws Exception{
	   final GetinfoapplicazionefromudImpl lGetinfoapplicazionefromud = new GetinfoapplicazionefromudImpl();
	   setBean(pBean);
	   lGetinfoapplicazionefromud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetinfoapplicazionefromud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactGetinfoapplicazionefromudBean> result = new StoreResultBean<DmpkEfactGetinfoapplicazionefromudBean>();
