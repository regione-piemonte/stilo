...
import it.eng.auriga.database.store.dmpk_statistiche.store.impl.TrovaregolecampionamentoattiImpl;
 ...
 */
@Service(name="DmpkStatisticheTrovaregolecampionamentoatti")
public class Trovaregolecampionamentoatti {
		
	private DmpkStatisticheTrovaregolecampionamentoattiBean bean;
		  
	public void setBean(DmpkStatisticheTrovaregolecampionamentoattiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkStatisticheTrovaregolecampionamentoattiBean> execute(AurigaLoginBean lLoginBean, DmpkStatisticheTrovaregolecampionamentoattiBean pBean) throws Exception{
	   final TrovaregolecampionamentoattiImpl lTrovaregolecampionamentoatti = new TrovaregolecampionamentoattiImpl();
	   setBean(pBean);
	   lTrovaregolecampionamentoatti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaregolecampionamentoatti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkStatisticheTrovaregolecampionamentoattiBean> result = new StoreResultBean<DmpkStatisticheTrovaregolecampionamentoattiBean>();
