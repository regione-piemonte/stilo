...
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovalogImpl;
 ...
 */
@Service(name="DmpkUtilityTrovalog")
public class Trovalog {
		
	private DmpkUtilityTrovalogBean bean;
		  
	public void setBean(DmpkUtilityTrovalogBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityTrovalogBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovalogBean pBean) throws Exception{
	   final TrovalogImpl lTrovalog = new TrovalogImpl();
	   setBean(pBean);
	   lTrovalog.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovalog.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityTrovalogBean> result = new StoreResultBean<DmpkUtilityTrovalogBean>();
