...
public class ContacontenitoriudImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.CONTACONTENITORIUD(?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgtipocontenitorein",3,Types.VARCHAR,connection); 	
