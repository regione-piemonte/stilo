...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.IusezioneImpl;
 ...
 */
@Service(name="DmpkAmmTraspIusezione")
public class Iusezione {
	...
	public StoreResultBean<DmpkAmmTraspIusezioneBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspIusezioneBean pBean) throws Exception{
	   final IusezioneImpl lIusezione = new IusezioneImpl();
	   setBean(pBean);
	   lIusezione.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIusezione.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspIusezioneBean> result = new StoreResultBean<DmpkAmmTraspIusezioneBean>();
