...
import it.eng.auriga.database.store.dmpk_int_portale_crm.store.impl.TrovarichsbloccolimagibilitaImpl;
 ...
 */
@Service(name="DmpkIntPortaleCrmTrovarichsbloccolimagibilita")
public class Trovarichsbloccolimagibilita {
		
	private DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean bean;
		  
	public void setBean(DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean> execute(AurigaLoginBean lLoginBean, DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean pBean) throws Exception{
	   final TrovarichsbloccolimagibilitaImpl lTrovarichsbloccolimagibilita = new TrovarichsbloccolimagibilitaImpl();
	   setBean(pBean);
	   lTrovarichsbloccolimagibilita.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovarichsbloccolimagibilita.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean> result = new StoreResultBean<DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean>();
