...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovadocdetaillist_bdbBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.Trovadocdetaillist_bdbImpl;
 ...
 */
@Service(name="DmpkEfactTrovadocdetaillist_bdb")
public class Trovadocdetaillist_bdb {
		
	private DmpkEfactTrovadocdetaillist_bdbBean bean;
		  
	public void setBean(DmpkEfactTrovadocdetaillist_bdbBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovadocdetaillist_bdbBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovadocdetaillist_bdbBean pBean) throws Exception{
	   final Trovadocdetaillist_bdbImpl lTrovadocdetaillist_bdb = new Trovadocdetaillist_bdbImpl();
	   setBean(pBean);
	   lTrovadocdetaillist_bdb.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadocdetaillist_bdb.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovadocdetaillist_bdbBean> result = new StoreResultBean<DmpkEfactTrovadocdetaillist_bdbBean>();
