...
public class GetlistrelatedobjincontainerImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.GETLISTRELATEDOBJINCONTAINER(?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgobjtypein",4,Types.VARCHAR,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"relatedobjxmlout",6,Types.CLOB); 
