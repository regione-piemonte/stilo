...
public class SetstatorichopmassiveImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_BMANAGER.SETSTATORICHOPMASSIVE(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"xmlrichopmassivein",4,Types.CLOB,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"esitiout",9,Types.CLOB); 
