...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.GetdatireportImpl;
 ...
 */
@Service(name="DmpkAmmTraspGetdatireport")
public class Getdatireport {
		
	private DmpkAmmTraspGetdatireportBean bean;
		  
	public void setBean(DmpkAmmTraspGetdatireportBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspGetdatireportBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspGetdatireportBean pBean) throws Exception{
	   final GetdatireportImpl lGetdatireport = new GetdatireportImpl();
	   setBean(pBean);
	   lGetdatireport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatireport.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspGetdatireportBean> result = new StoreResultBean<DmpkAmmTraspGetdatireportBean>();
