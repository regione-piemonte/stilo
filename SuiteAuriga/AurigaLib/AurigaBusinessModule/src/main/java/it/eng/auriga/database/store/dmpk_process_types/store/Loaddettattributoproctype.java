...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.LoaddettattributoproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddettattributoproctype")
public class Loaddettattributoproctype {
	...
	public StoreResultBean<DmpkProcessTypesLoaddettattributoproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddettattributoproctypeBean pBean) throws Exception{
	   final LoaddettattributoproctypeImpl lLoaddettattributoproctype = new LoaddettattributoproctypeImpl();
	   setBean(pBean);
	   lLoaddettattributoproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettattributoproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddettattributoproctypeBean> result = new StoreResultBean<DmpkProcessTypesLoaddettattributoproctypeBean>();
