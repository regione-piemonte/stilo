...
import it.eng.auriga.database.store.dmpk_processes.store.impl.GetdatixmodellipraticaImpl;
 ...
 */
@Service(name="DmpkProcessesGetdatixmodellipratica")
public class Getdatixmodellipratica {
		
	private DmpkProcessesGetdatixmodellipraticaBean bean;
		  
	public void setBean(DmpkProcessesGetdatixmodellipraticaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesGetdatixmodellipraticaBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesGetdatixmodellipraticaBean pBean) throws Exception{
	   final GetdatixmodellipraticaImpl lGetdatixmodellipratica = new GetdatixmodellipraticaImpl();
	   setBean(pBean);
	   lGetdatixmodellipratica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdatixmodellipratica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesGetdatixmodellipraticaBean> result = new StoreResultBean<DmpkProcessesGetdatixmodellipraticaBean>();
