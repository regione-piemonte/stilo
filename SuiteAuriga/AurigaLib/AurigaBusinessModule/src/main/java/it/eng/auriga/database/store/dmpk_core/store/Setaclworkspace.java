...
import it.eng.auriga.database.store.dmpk_core.store.impl.SetaclworkspaceImpl;
 ...
 */
@Service(name="DmpkCoreSetaclworkspace")
public class Setaclworkspace {
	...
	public StoreResultBean<DmpkCoreSetaclworkspaceBean> execute(AurigaLoginBean lLoginBean, DmpkCoreSetaclworkspaceBean pBean) throws Exception{
	   final SetaclworkspaceImpl lSetaclworkspace = new SetaclworkspaceImpl();
	   setBean(pBean);
	   lSetaclworkspace.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetaclworkspace.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreSetaclworkspaceBean> result = new StoreResultBean<DmpkCoreSetaclworkspaceBean>();
