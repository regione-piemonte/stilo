...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.GrantprivsudefcontestoImpl;
 ...
 */
@Service(name="DmpkDefSecurityGrantprivsudefcontesto")
public class Grantprivsudefcontesto {
	...
	public StoreResultBean<DmpkDefSecurityGrantprivsudefcontestoBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityGrantprivsudefcontestoBean pBean) throws Exception{
	   final GrantprivsudefcontestoImpl lGrantprivsudefcontesto = new GrantprivsudefcontestoImpl();
	   setBean(pBean);
	   lGrantprivsudefcontesto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGrantprivsudefcontesto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityGrantprivsudefcontestoBean> result = new StoreResultBean<DmpkDefSecurityGrantprivsudefcontestoBean>();
