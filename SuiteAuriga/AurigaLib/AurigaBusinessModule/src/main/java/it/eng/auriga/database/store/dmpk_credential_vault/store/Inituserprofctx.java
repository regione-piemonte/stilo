...
import it.eng.auriga.database.store.dmpk_credential_vault.bean.DmpkCredentialVaultInituserprofctxBean;
import it.eng.auriga.database.store.dmpk_credential_vault.store.impl.InituserprofctxImpl;
 ...
 */
@Service(name="DmpkCredentialVaultInituserprofctx")
public class Inituserprofctx {
		
	private DmpkCredentialVaultInituserprofctxBean bean;
		  
	public void setBean(DmpkCredentialVaultInituserprofctxBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCredentialVaultInituserprofctxBean> execute(AurigaLoginBean lLoginBean, DmpkCredentialVaultInituserprofctxBean pBean) throws Exception{
	   final InituserprofctxImpl lInituserprofctx = new InituserprofctxImpl();
	   setBean(pBean);
	   lInituserprofctx.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lInituserprofctx.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCredentialVaultInituserprofctxBean> result = new StoreResultBean<DmpkCredentialVaultInituserprofctxBean>();
