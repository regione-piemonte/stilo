...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.GetabilazioniinteropImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailGetabilazioniinterop")
public class Getabilazioniinterop {
	...
	public StoreResultBean<DmpkIntMgoEmailGetabilazioniinteropBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailGetabilazioniinteropBean pBean) throws Exception{
	   final GetabilazioniinteropImpl lGetabilazioniinterop = new GetabilazioniinteropImpl();
	   setBean(pBean);
	   lGetabilazioniinterop.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetabilazioniinterop.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailGetabilazioniinteropBean> result = new StoreResultBean<DmpkIntMgoEmailGetabilazioniinteropBean>();
