...
public class UpddocudImpl  {
		
	private DmpkCoreUpddocudBean bean;
		  
	public void setBean(DmpkCoreUpddocudBean bean){
		this.bean = bean;
	}
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.UPDDOCUD(?,?,?,?,?,?,?,?,?,?,?)}");			
