 ...
 */
@Service(name="DmpkWsGetfileudtoupdxrectrl")
public class Getfileudtoupdxrectrl {
		
	private DmpkWsGetfileudtoupdxrectrlBean bean;
		  
	public void setBean(DmpkWsGetfileudtoupdxrectrlBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsGetfileudtoupdxrectrlBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetfileudtoupdxrectrlBean pBean) throws Exception{
	   final GetfileudtoupdxrectrlImpl lGetfileudtoupdxrectrl = new GetfileudtoupdxrectrlImpl();
	   setBean(pBean);
	   lGetfileudtoupdxrectrl.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetfileudtoupdxrectrl.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetfileudtoupdxrectrlBean> result = new StoreResultBean<DmpkWsGetfileudtoupdxrectrlBean>();
