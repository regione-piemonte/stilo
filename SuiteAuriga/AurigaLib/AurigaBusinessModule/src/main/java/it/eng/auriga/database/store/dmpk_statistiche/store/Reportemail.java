...
import it.eng.auriga.database.store.dmpk_statistiche.store.impl.ReportemailImpl;
 ...
 */
@Service(name="DmpkStatisticheReportemail")
public class Reportemail {
	...
	public StoreResultBean<DmpkStatisticheReportemailBean> execute(AurigaLoginBean lLoginBean, DmpkStatisticheReportemailBean pBean) throws Exception{
	   final ReportemailImpl lReportemail = new ReportemailImpl();
	   setBean(pBean);
	   lReportemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lReportemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkStatisticheReportemailBean> result = new StoreResultBean<DmpkStatisticheReportemailBean>();
