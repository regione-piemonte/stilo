...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.DgrupposoggrubricaImpl;
 ...
 */
@Service(name="DmpkAnagraficaDgrupposoggrubrica")
public class Dgrupposoggrubrica {
		
	private DmpkAnagraficaDgrupposoggrubricaBean bean;
		  
	public void setBean(DmpkAnagraficaDgrupposoggrubricaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAnagraficaDgrupposoggrubricaBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaDgrupposoggrubricaBean pBean) throws Exception{
	   final DgrupposoggrubricaImpl lDgrupposoggrubrica = new DgrupposoggrubricaImpl();
	   setBean(pBean);
	   lDgrupposoggrubrica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDgrupposoggrubrica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaDgrupposoggrubricaBean> result = new StoreResultBean<DmpkAnagraficaDgrupposoggrubricaBean>();
