...
public class AggdestinvioinrubricaemailImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_MGO_EMAIL.AGGDESTINVIOINRUBRICAEMAIL(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"xmldestinviomailin",5,Types.CLOB,connection); 	
