...
import it.eng.auriga.database.store.dmpk_efact.store.impl.IuemaildestfpImpl;
 ...
 */
@Service(name="DmpkEfactIuemaildestfp")
public class Iuemaildestfp {
	...
	public StoreResultBean<DmpkEfactIuemaildestfpBean> execute(AurigaLoginBean lLoginBean, DmpkEfactIuemaildestfpBean pBean) throws Exception{
	   final IuemaildestfpImpl lIuemaildestfp = new IuemaildestfpImpl();
	   setBean(pBean);
	   lIuemaildestfp.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuemaildestfp.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactIuemaildestfpBean> result = new StoreResultBean<DmpkEfactIuemaildestfpBean>();
