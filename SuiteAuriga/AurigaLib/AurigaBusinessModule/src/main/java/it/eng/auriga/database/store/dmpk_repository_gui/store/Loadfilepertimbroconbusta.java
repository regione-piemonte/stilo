...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.LoadfilepertimbroconbustaImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiLoadfilepertimbroconbusta")
public class Loadfilepertimbroconbusta {
		
	private DmpkRepositoryGuiLoadfilepertimbroconbustaBean bean;
		  
	public void setBean(DmpkRepositoryGuiLoadfilepertimbroconbustaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiLoadfilepertimbroconbustaBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiLoadfilepertimbroconbustaBean pBean) throws Exception{
	   final LoadfilepertimbroconbustaImpl lLoadfilepertimbroconbusta = new LoadfilepertimbroconbustaImpl();
	   setBean(pBean);
	   lLoadfilepertimbroconbusta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadfilepertimbroconbusta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiLoadfilepertimbroconbustaBean> result = new StoreResultBean<DmpkRepositoryGuiLoadfilepertimbroconbustaBean>();
