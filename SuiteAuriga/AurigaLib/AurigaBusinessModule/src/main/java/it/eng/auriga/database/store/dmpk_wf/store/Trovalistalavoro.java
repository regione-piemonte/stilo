...
import it.eng.auriga.database.store.dmpk_wf.store.impl.TrovalistalavoroImpl;
 ...
 */
@Service(name="DmpkWfTrovalistalavoro")
public class Trovalistalavoro {
	...
	public StoreResultBean<DmpkWfTrovalistalavoroBean> execute(AurigaLoginBean lLoginBean, DmpkWfTrovalistalavoroBean pBean) throws Exception{
	   final TrovalistalavoroImpl lTrovalistalavoro = new TrovalistalavoroImpl();
	   setBean(pBean);
	   lTrovalistalavoro.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovalistalavoro.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfTrovalistalavoroBean> result = new StoreResultBean<DmpkWfTrovalistalavoroBean>();
