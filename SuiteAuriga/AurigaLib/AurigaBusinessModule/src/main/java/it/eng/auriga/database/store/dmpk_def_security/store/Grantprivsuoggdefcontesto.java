...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.GrantprivsuoggdefcontestoImpl;
 ...
 */
@Service(name="DmpkDefSecurityGrantprivsuoggdefcontesto")
public class Grantprivsuoggdefcontesto {
	...
	public StoreResultBean<DmpkDefSecurityGrantprivsuoggdefcontestoBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityGrantprivsuoggdefcontestoBean pBean) throws Exception{
	   final GrantprivsuoggdefcontestoImpl lGrantprivsuoggdefcontesto = new GrantprivsuoggdefcontestoImpl();
	   setBean(pBean);
	   lGrantprivsuoggdefcontesto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGrantprivsuoggdefcontesto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityGrantprivsuoggdefcontestoBean> result = new StoreResultBean<DmpkDefSecurityGrantprivsuoggdefcontestoBean>();
