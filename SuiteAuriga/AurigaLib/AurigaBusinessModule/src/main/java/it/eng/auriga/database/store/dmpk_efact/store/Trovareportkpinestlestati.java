...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportkpinestlestatiBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportkpinestlestatiImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportkpinestlestati")
public class Trovareportkpinestlestati {
		
	private DmpkEfactTrovareportkpinestlestatiBean bean;
		  
	public void setBean(DmpkEfactTrovareportkpinestlestatiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportkpinestlestatiBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportkpinestlestatiBean pBean) throws Exception{
	   final TrovareportkpinestlestatiImpl lTrovareportkpinestlestati = new TrovareportkpinestlestatiImpl();
	   setBean(pBean);
	   lTrovareportkpinestlestati.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportkpinestlestati.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportkpinestlestatiBean> result = new StoreResultBean<DmpkEfactTrovareportkpinestlestatiBean>();
