...
import it.eng.auriga.database.store.dmpk_doc_types.store.impl.TrovadoctypesImpl;
 ...
 */
@Service(name="DmpkDocTypesTrovadoctypes")
public class Trovadoctypes {
	...
	public StoreResultBean<DmpkDocTypesTrovadoctypesBean> execute(AurigaLoginBean lLoginBean, DmpkDocTypesTrovadoctypesBean pBean) throws Exception{
	   final TrovadoctypesImpl lTrovadoctypes = new TrovadoctypesImpl();
	   setBean(pBean);
	   lTrovadoctypes.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadoctypes.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDocTypesTrovadoctypesBean> result = new StoreResultBean<DmpkDocTypesTrovadoctypesBean>();
