...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.AccreditauserinapplestImpl;
 ...
 */
@Service(name="DmpkDefSecurityAccreditauserinapplest")
public class Accreditauserinapplest {
	...
	public StoreResultBean<DmpkDefSecurityAccreditauserinapplestBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityAccreditauserinapplestBean pBean) throws Exception{
	   final AccreditauserinapplestImpl lAccreditauserinapplest = new AccreditauserinapplestImpl();
	   setBean(pBean);
	   lAccreditauserinapplest.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAccreditauserinapplest.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityAccreditauserinapplestBean> result = new StoreResultBean<DmpkDefSecurityAccreditauserinapplestBean>();
