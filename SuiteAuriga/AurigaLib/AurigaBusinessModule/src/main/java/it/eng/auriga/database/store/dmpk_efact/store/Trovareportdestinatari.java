...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportdestinatariBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportdestinatariImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportdestinatari")
public class Trovareportdestinatari {
		
	private DmpkEfactTrovareportdestinatariBean bean;
		  
	public void setBean(DmpkEfactTrovareportdestinatariBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportdestinatariBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportdestinatariBean pBean) throws Exception{
	   final TrovareportdestinatariImpl lTrovareportdestinatari = new TrovareportdestinatariImpl();
	   setBean(pBean);
	   lTrovareportdestinatari.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportdestinatari.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportdestinatariBean> result = new StoreResultBean<DmpkEfactTrovareportdestinatariBean>();
