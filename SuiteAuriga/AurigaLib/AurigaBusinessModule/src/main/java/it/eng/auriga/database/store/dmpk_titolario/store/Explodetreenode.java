...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.ExplodetreenodeImpl;
 ...
 */
@Service(name="DmpkTitolarioExplodetreenode")
public class Explodetreenode {
	...
	public StoreResultBean<DmpkTitolarioExplodetreenodeBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioExplodetreenodeBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkTitolarioExplodetreenodeBean> result = new StoreResultBean<DmpkTitolarioExplodetreenodeBean>();
