...
import it.eng.auriga.database.store.dmpk_scrivania_virtuale.store.impl.GetcontenutinodofuncImpl;
 ...
 */
@Service(name="DmpkScrivaniaVirtualeGetcontenutinodofunc")
public class Getcontenutinodofunc {
		
	private DmpkScrivaniaVirtualeGetcontenutinodofuncBean bean;
		  
	public void setBean(DmpkScrivaniaVirtualeGetcontenutinodofuncBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkScrivaniaVirtualeGetcontenutinodofuncBean> execute(AurigaLoginBean lLoginBean, DmpkScrivaniaVirtualeGetcontenutinodofuncBean pBean) throws Exception{
	   final GetcontenutinodofuncImpl lGetcontenutinodofunc = new GetcontenutinodofuncImpl();
	   setBean(pBean);
	   lGetcontenutinodofunc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetcontenutinodofunc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkScrivaniaVirtualeGetcontenutinodofuncBean> result = new StoreResultBean<DmpkScrivaniaVirtualeGetcontenutinodofuncBean>();
