...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.Loaddettevtty_proctyImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddettevtty_procty")
public class Loaddettevtty_procty {
		
	private DmpkProcessTypesLoaddettevtty_proctyBean bean;
		  
	public void setBean(DmpkProcessTypesLoaddettevtty_proctyBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessTypesLoaddettevtty_proctyBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddettevtty_proctyBean pBean) throws Exception{
	   final Loaddettevtty_proctyImpl lLoaddettevtty_procty = new Loaddettevtty_proctyImpl();
	   setBean(pBean);
	   lLoaddettevtty_procty.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettevtty_procty.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddettevtty_proctyBean> result = new StoreResultBean<DmpkProcessTypesLoaddettevtty_proctyBean>();
