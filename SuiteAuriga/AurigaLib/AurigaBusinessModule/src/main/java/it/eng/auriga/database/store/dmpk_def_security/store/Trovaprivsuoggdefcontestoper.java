...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TrovaprivsuoggdefcontestoperImpl;
 ...
 */
@Service(name="DmpkDefSecurityTrovaprivsuoggdefcontestoper")
public class Trovaprivsuoggdefcontestoper {
	...
	public StoreResultBean<DmpkDefSecurityTrovaprivsuoggdefcontestoperBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTrovaprivsuoggdefcontestoperBean pBean) throws Exception{
	   final TrovaprivsuoggdefcontestoperImpl lTrovaprivsuoggdefcontestoper = new TrovaprivsuoggdefcontestoperImpl();
	   setBean(pBean);
	   lTrovaprivsuoggdefcontestoper.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaprivsuoggdefcontestoper.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTrovaprivsuoggdefcontestoperBean> result = new StoreResultBean<DmpkDefSecurityTrovaprivsuoggdefcontestoperBean>();
