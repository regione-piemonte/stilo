...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.TrovaattoriproctypeImpl;
 ...
 */
@Service(name="DmpkProcessTypesTrovaattoriproctype")
public class Trovaattoriproctype {
	...
	public StoreResultBean<DmpkProcessTypesTrovaattoriproctypeBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesTrovaattoriproctypeBean pBean) throws Exception{
	   final TrovaattoriproctypeImpl lTrovaattoriproctype = new TrovaattoriproctypeImpl();
	   setBean(pBean);
	   lTrovaattoriproctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaattoriproctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesTrovaattoriproctypeBean> result = new StoreResultBean<DmpkProcessTypesTrovaattoriproctypeBean>();
