...
import it.eng.auriga.database.store.dmpk_ws.store.impl.TrovasoggettirubricaImpl;
 ...
 */
@Service(name="DmpkWsTrovasoggettirubrica")
public class Trovasoggettirubrica {
		
	private DmpkWsTrovasoggettirubricaBean bean;
		  
	public void setBean(DmpkWsTrovasoggettirubricaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsTrovasoggettirubricaBean> execute(AurigaLoginBean lLoginBean, DmpkWsTrovasoggettirubricaBean pBean) throws Exception{
	   final TrovasoggettirubricaImpl lTrovasoggettirubrica = new TrovasoggettirubricaImpl();
	   setBean(pBean);
	   lTrovasoggettirubrica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovasoggettirubrica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsTrovasoggettirubricaBean> result = new StoreResultBean<DmpkWsTrovasoggettirubricaBean>();
