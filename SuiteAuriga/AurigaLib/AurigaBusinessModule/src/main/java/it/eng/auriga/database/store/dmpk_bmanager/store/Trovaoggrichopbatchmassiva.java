...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.TrovaoggrichopbatchmassivaImpl;
 ...
 */
@Service(name="DmpkBmanagerTrovaoggrichopbatchmassiva")
public class Trovaoggrichopbatchmassiva {
		
	private DmpkBmanagerTrovaoggrichopbatchmassivaBean bean;
		  
	public void setBean(DmpkBmanagerTrovaoggrichopbatchmassivaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerTrovaoggrichopbatchmassivaBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerTrovaoggrichopbatchmassivaBean pBean) throws Exception{
	   final TrovaoggrichopbatchmassivaImpl lTrovaoggrichopbatchmassiva = new TrovaoggrichopbatchmassivaImpl();
	   setBean(pBean);
	   lTrovaoggrichopbatchmassiva.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaoggrichopbatchmassiva.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerTrovaoggrichopbatchmassivaBean> result = new StoreResultBean<DmpkBmanagerTrovaoggrichopbatchmassivaBean>();
