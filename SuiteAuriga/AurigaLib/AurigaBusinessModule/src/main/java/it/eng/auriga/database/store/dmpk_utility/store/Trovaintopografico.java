...
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovaintopograficoImpl;
 ...
 */
@Service(name="DmpkUtilityTrovaintopografico")
public class Trovaintopografico {
	...
	public StoreResultBean<DmpkUtilityTrovaintopograficoBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovaintopograficoBean pBean) throws Exception{
	   final TrovaintopograficoImpl lTrovaintopografico = new TrovaintopograficoImpl();
	   setBean(pBean);
	   lTrovaintopografico.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaintopografico.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityTrovaintopograficoBean> result = new StoreResultBean<DmpkUtilityTrovaintopograficoBean>();
