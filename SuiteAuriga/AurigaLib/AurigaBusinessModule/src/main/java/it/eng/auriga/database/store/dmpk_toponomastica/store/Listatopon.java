...
import it.eng.auriga.database.store.dmpk_toponomastica.store.impl.ListatoponImpl;
 ...
 */
@Service(name="DmpkToponomasticaListatopon")
public class Listatopon {
	...
	public StoreResultBean<DmpkToponomasticaListatoponBean> execute(AurigaLoginBean lLoginBean, DmpkToponomasticaListatoponBean pBean) throws Exception{
	   final ListatoponImpl lListatopon = new ListatoponImpl();
	   setBean(pBean);
	   lListatopon.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lListatopon.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkToponomasticaListatoponBean> result = new StoreResultBean<DmpkToponomasticaListatoponBean>();
