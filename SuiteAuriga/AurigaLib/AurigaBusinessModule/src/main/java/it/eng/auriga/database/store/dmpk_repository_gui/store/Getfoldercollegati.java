...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetfoldercollegatiImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetfoldercollegati")
public class Getfoldercollegati {
		
	private DmpkRepositoryGuiGetfoldercollegatiBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetfoldercollegatiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetfoldercollegatiBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetfoldercollegatiBean pBean) throws Exception{
	   final GetfoldercollegatiImpl lGetfoldercollegati = new GetfoldercollegatiImpl();
	   setBean(pBean);
	   lGetfoldercollegati.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetfoldercollegati.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetfoldercollegatiBean> result = new StoreResultBean<DmpkRepositoryGuiGetfoldercollegatiBean>();
