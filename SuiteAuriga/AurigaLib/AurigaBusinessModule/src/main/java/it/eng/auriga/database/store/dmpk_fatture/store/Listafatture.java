...
import it.eng.auriga.database.store.dmpk_fatture.store.impl.ListafattureImpl;
 ...
 */
@Service(name="DmpkFattureListafatture")
public class Listafatture {
	...
	public StoreResultBean<DmpkFattureListafattureBean> execute(AurigaLoginBean lLoginBean, DmpkFattureListafattureBean pBean) throws Exception{
	   final ListafattureImpl lListafatture = new ListafattureImpl();
	   setBean(pBean);
	   lListafatture.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lListafatture.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFattureListafattureBean> result = new StoreResultBean<DmpkFattureListafattureBean>();
