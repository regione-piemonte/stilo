...
import it.eng.auriga.database.store.dmpk_int_cs.store.impl.TrovaitempdvImpl;
 ...
 */
@Service(name="DmpkIntCsTrovaitempdv")
public class Trovaitempdv {
		
	private DmpkIntCsTrovaitempdvBean bean;
		  
	public void setBean(DmpkIntCsTrovaitempdvBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntCsTrovaitempdvBean> execute(AurigaLoginBean lLoginBean, DmpkIntCsTrovaitempdvBean pBean) throws Exception{
	   final TrovaitempdvImpl lTrovaitempdv = new TrovaitempdvImpl();
	   setBean(pBean);
	   lTrovaitempdv.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaitempdv.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntCsTrovaitempdvBean> result = new StoreResultBean<DmpkIntCsTrovaitempdvBean>();
