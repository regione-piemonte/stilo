...
import it.eng.auriga.database.store.dmpk_processes.store.impl.GetopzuoindettattoImpl;
 ...
 */
@Service(name="DmpkProcessesGetopzuoindettatto")
public class Getopzuoindettatto {
		
	private DmpkProcessesGetopzuoindettattoBean bean;
		  
	public void setBean(DmpkProcessesGetopzuoindettattoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessesGetopzuoindettattoBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesGetopzuoindettattoBean pBean) throws Exception{
	   final GetopzuoindettattoImpl lGetopzuoindettatto = new GetopzuoindettattoImpl();
	   setBean(pBean);
	   lGetopzuoindettatto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetopzuoindettatto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessesGetopzuoindettattoBean> result = new StoreResultBean<DmpkProcessesGetopzuoindettattoBean>();
