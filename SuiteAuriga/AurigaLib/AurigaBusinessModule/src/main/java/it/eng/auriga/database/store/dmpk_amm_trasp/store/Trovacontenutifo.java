...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.TrovacontenutifoImpl;
 ...
 */
@Service(name="DmpkAmmTraspTrovacontenutifo")
public class Trovacontenutifo {
	...
	public StoreResultBean<DmpkAmmTraspTrovacontenutifoBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspTrovacontenutifoBean pBean) throws Exception{
	   final TrovacontenutifoImpl lTrovacontenutifo = new TrovacontenutifoImpl();
	   setBean(pBean);
	   lTrovacontenutifo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovacontenutifo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspTrovacontenutifoBean> result = new StoreResultBean<DmpkAmmTraspTrovacontenutifoBean>();
