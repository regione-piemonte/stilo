...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettgruppoprivilegiImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettgruppoprivilegi")
public class Loaddettgruppoprivilegi {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettgruppoprivilegiBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettgruppoprivilegiBean pBean) throws Exception{
	   final LoaddettgruppoprivilegiImpl lLoaddettgruppoprivilegi = new LoaddettgruppoprivilegiImpl();
	   setBean(pBean);
	   lLoaddettgruppoprivilegi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettgruppoprivilegi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettgruppoprivilegiBean> result = new StoreResultBean<DmpkDefSecurityLoaddettgruppoprivilegiBean>();
