...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.GetdettcontdoccomplessoImpl;
 ...
 */
@Service(name="DmpkAmmTraspGetdettcontdoccomplesso")
public class Getdettcontdoccomplesso {
	...
	public StoreResultBean<DmpkAmmTraspGetdettcontdoccomplessoBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspGetdettcontdoccomplessoBean pBean) throws Exception{
	   final GetdettcontdoccomplessoImpl lGetdettcontdoccomplesso = new GetdettcontdoccomplessoImpl();
	   setBean(pBean);
	   lGetdettcontdoccomplesso.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdettcontdoccomplesso.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspGetdettcontdoccomplessoBean> result = new StoreResultBean<DmpkAmmTraspGetdettcontdoccomplessoBean>();
