...
public class ExtractfileudImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.EXTRACTFILEUD(?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"iddoctoextractout",5,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"nrovertoextractout",6,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgvertimbrataout",7,Types.DECIMAL); 
