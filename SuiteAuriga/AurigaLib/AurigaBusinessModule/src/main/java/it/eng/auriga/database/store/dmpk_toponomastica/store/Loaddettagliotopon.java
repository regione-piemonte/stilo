...
import it.eng.auriga.database.store.dmpk_toponomastica.store.impl.LoaddettagliotoponImpl;
 ...
 */
@Service(name="DmpkToponomasticaLoaddettagliotopon")
public class Loaddettagliotopon {
	...
	public StoreResultBean<DmpkToponomasticaLoaddettagliotoponBean> execute(AurigaLoginBean lLoginBean, DmpkToponomasticaLoaddettagliotoponBean pBean) throws Exception{
	   final LoaddettagliotoponImpl lLoaddettagliotopon = new LoaddettagliotoponImpl();
	   setBean(pBean);
	   lLoaddettagliotopon.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettagliotopon.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkToponomasticaLoaddettagliotoponBean> result = new StoreResultBean<DmpkToponomasticaLoaddettagliotoponBean>();
