...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.LoaddettsoggettoImpl;
 ...
 */
@Service(name="DmpkAnagraficaLoaddettsoggetto")
public class Loaddettsoggetto {
	...
	public StoreResultBean<DmpkAnagraficaLoaddettsoggettoBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaLoaddettsoggettoBean pBean) throws Exception{
	   final LoaddettsoggettoImpl lLoaddettsoggetto = new LoaddettsoggettoImpl();
	   setBean(pBean);
	   lLoaddettsoggetto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettsoggetto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaLoaddettsoggettoBean> result = new StoreResultBean<DmpkAnagraficaLoaddettsoggettoBean>();
