...
import it.eng.auriga.database.store.dmpk_tipi_reg_num_ud.store.impl.LoaddetttiporegnumImpl;
 ...
 */
@Service(name="DmpkTipiRegNumUdLoaddetttiporegnum")
public class Loaddetttiporegnum {
	...
	public StoreResultBean<DmpkTipiRegNumUdLoaddetttiporegnumBean> execute(AurigaLoginBean lLoginBean, DmpkTipiRegNumUdLoaddetttiporegnumBean pBean) throws Exception{
	   final LoaddetttiporegnumImpl lLoaddetttiporegnum = new LoaddetttiporegnumImpl();
	   setBean(pBean);
	   lLoaddetttiporegnum.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddetttiporegnum.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTipiRegNumUdLoaddetttiporegnumBean> result = new StoreResultBean<DmpkTipiRegNumUdLoaddetttiporegnumBean>();
