...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.LoaddettdoctypeproctyImpl;
 ...
 */
@Service(name="DmpkProcessTypesLoaddettdoctypeprocty")
public class Loaddettdoctypeprocty {
	...
	public StoreResultBean<DmpkProcessTypesLoaddettdoctypeproctyBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesLoaddettdoctypeproctyBean pBean) throws Exception{
	   final LoaddettdoctypeproctyImpl lLoaddettdoctypeprocty = new LoaddettdoctypeproctyImpl();
	   setBean(pBean);
	   lLoaddettdoctypeprocty.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettdoctypeprocty.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesLoaddettdoctypeproctyBean> result = new StoreResultBean<DmpkProcessTypesLoaddettdoctypeproctyBean>();
