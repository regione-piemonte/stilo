...
public class ReginiziorecrdvImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_CS.REGINIZIORECRDV(?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"labelpdvin",8,Types.VARCHAR,connection); 	
