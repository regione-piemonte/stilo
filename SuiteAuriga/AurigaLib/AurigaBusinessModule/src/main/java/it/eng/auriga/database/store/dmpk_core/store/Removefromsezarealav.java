...
import it.eng.auriga.database.store.dmpk_core.store.impl.RemovefromsezarealavImpl;
 ...
 */
@Service(name="DmpkCoreRemovefromsezarealav")
public class Removefromsezarealav {
		
	private DmpkCoreRemovefromsezarealavBean bean;
		  
	public void setBean(DmpkCoreRemovefromsezarealavBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreRemovefromsezarealavBean> execute(AurigaLoginBean lLoginBean, DmpkCoreRemovefromsezarealavBean pBean) throws Exception{
	   final RemovefromsezarealavImpl lRemovefromsezarealav = new RemovefromsezarealavImpl();
	   setBean(pBean);
	   lRemovefromsezarealav.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRemovefromsezarealav.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreRemovefromsezarealavBean> result = new StoreResultBean<DmpkCoreRemovefromsezarealavBean>();
