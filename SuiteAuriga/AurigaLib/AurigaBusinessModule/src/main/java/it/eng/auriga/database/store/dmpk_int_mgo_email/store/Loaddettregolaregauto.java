...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.LoaddettregolaregautoImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailLoaddettregolaregauto")
public class Loaddettregolaregauto {
	...
	public StoreResultBean<DmpkIntMgoEmailLoaddettregolaregautoBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailLoaddettregolaregautoBean pBean) throws Exception{
	   final LoaddettregolaregautoImpl lLoaddettregolaregauto = new LoaddettregolaregautoImpl();
	   setBean(pBean);
	   lLoaddettregolaregauto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettregolaregauto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailLoaddettregolaregautoBean> result = new StoreResultBean<DmpkIntMgoEmailLoaddettregolaregautoBean>();
