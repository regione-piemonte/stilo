...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportlottibucatiBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportlottibucatiImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportlottibucati")
public class Trovareportlottibucati {
		
	private DmpkEfactTrovareportlottibucatiBean bean;
		  
	public void setBean(DmpkEfactTrovareportlottibucatiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportlottibucatiBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportlottibucatiBean pBean) throws Exception{
	   final TrovareportlottibucatiImpl lTrovareportlottibucati = new TrovareportlottibucatiImpl();
	   setBean(pBean);
	   lTrovareportlottibucati.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportlottibucati.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportlottibucatiBean> result = new StoreResultBean<DmpkEfactTrovareportlottibucatiBean>();
