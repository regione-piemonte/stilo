...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreGetdefaultlibraryBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.GetdefaultlibraryImpl;
 ...
 */
@Service(name="DmpkCoreGetdefaultlibrary")
public class Getdefaultlibrary {
		
	private DmpkCoreGetdefaultlibraryBean bean;
		  
	public void setBean(DmpkCoreGetdefaultlibraryBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreGetdefaultlibraryBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetdefaultlibraryBean pBean) throws Exception{
	   final GetdefaultlibraryImpl lGetdefaultlibrary = new GetdefaultlibraryImpl();
	   setBean(pBean);
	   lGetdefaultlibrary.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdefaultlibrary.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGetdefaultlibraryBean> result = new StoreResultBean<DmpkCoreGetdefaultlibraryBean>();
