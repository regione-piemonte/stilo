...
public class GetfileudtoupdxrectrlImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.GETFILEUDTOUPDXRECTRL(?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"listadocrectrlin",4,Types.CLOB); 
