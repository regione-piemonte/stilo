...
public class DeltipodocImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.DELTIPODOC(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"idtipodocout",4,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgtipodelout",5,Types.VARCHAR); 
