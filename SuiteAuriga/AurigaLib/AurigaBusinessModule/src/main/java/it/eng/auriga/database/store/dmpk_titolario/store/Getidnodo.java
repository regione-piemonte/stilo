...
import it.eng.auriga.database.store.dmpk_titolario.bean.DmpkTitolarioGetidnodoBean;
import it.eng.auriga.database.store.dmpk_titolario.store.impl.GetidnodoImpl;
 ...
 */
@Service(name="DmpkTitolarioGetidnodo")
public class Getidnodo {
		
	private DmpkTitolarioGetidnodoBean bean;
		  
	public void setBean(DmpkTitolarioGetidnodoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkTitolarioGetidnodoBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioGetidnodoBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkTitolarioGetidnodoBean> result = new StoreResultBean<DmpkTitolarioGetidnodoBean>();
