...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.bean.DmpkAttributiDinamiciGetxmlvaloriattrdinamiciBean;
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.GetxmlvaloriattrdinamiciImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciGetxmlvaloriattrdinamici")
public class Getxmlvaloriattrdinamici {
		
	private DmpkAttributiDinamiciGetxmlvaloriattrdinamiciBean bean;
		  
	public void setBean(DmpkAttributiDinamiciGetxmlvaloriattrdinamiciBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAttributiDinamiciGetxmlvaloriattrdinamiciBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciGetxmlvaloriattrdinamiciBean pBean) throws Exception{
	   final GetxmlvaloriattrdinamiciImpl lGetxmlvaloriattrdinamici = new GetxmlvaloriattrdinamiciImpl();
	   setBean(pBean);
	   lGetxmlvaloriattrdinamici.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetxmlvaloriattrdinamici.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciGetxmlvaloriattrdinamiciBean> result = new StoreResultBean<DmpkAttributiDinamiciGetxmlvaloriattrdinamiciBean>();
