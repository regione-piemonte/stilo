...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.IuapplicazioneesternaImpl;
 ...
 */
@Service(name="DmpkDefSecurityIuapplicazioneesterna")
public class Iuapplicazioneesterna {
	...
	public StoreResultBean<DmpkDefSecurityIuapplicazioneesternaBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityIuapplicazioneesternaBean pBean) throws Exception{
	   final IuapplicazioneesternaImpl lIuapplicazioneesterna = new IuapplicazioneesternaImpl();
	   setBean(pBean);
	   lIuapplicazioneesterna.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuapplicazioneesterna.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityIuapplicazioneesternaBean> result = new StoreResultBean<DmpkDefSecurityIuapplicazioneesternaBean>();
