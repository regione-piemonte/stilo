...
public class GetfoldercollegatiImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_REPOSITORY_GUI.GETFOLDERCOLLEGATI(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"listarelazionivsfolderout",5,Types.CLOB); 
