...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreGetidnodoBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.GetidnodoImpl;
 ...
 */
@Service(name="DmpkCoreGetidnodo")
public class Getidnodo {
		
	private DmpkCoreGetidnodoBean bean;
		  
	public void setBean(DmpkCoreGetidnodoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreGetidnodoBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetidnodoBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreGetidnodoBean> result = new StoreResultBean<DmpkCoreGetidnodoBean>();
