...
package it.eng.auriga.database.store.dmpk_tipi_reg_num_ud.store.impl;
...
public class DtiporegnumImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_TIPI_REG_NUM_UD.DTIPOREGNUM(?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idtiporennumin",4,Types.DECIMAL,connection); 	
