 ...
 */
@Service(name="DmpkCoreAddfolder")
public class Addfolder {
		
	private DmpkCoreAddfolderBean bean;
		  
	public void setBean(DmpkCoreAddfolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreAddfolderBean> execute(AurigaLoginBean lLoginBean, DmpkCoreAddfolderBean pBean) throws Exception{
