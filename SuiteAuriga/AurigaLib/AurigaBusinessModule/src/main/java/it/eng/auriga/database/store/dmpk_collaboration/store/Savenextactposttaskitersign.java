...
import it.eng.auriga.database.store.dmpk_collaboration.store.impl.SavenextactposttaskitersignImpl;
 ...
 */
@Service(name="DmpkCollaborationSavenextactposttaskitersign")
public class Savenextactposttaskitersign {
		
	private DmpkCollaborationSavenextactposttaskitersignBean bean;
		  
	public void setBean(DmpkCollaborationSavenextactposttaskitersignBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCollaborationSavenextactposttaskitersignBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationSavenextactposttaskitersignBean pBean) throws Exception{
	   final SavenextactposttaskitersignImpl lSavenextactposttaskitersign = new SavenextactposttaskitersignImpl();
	   setBean(pBean);
	   lSavenextactposttaskitersign.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSavenextactposttaskitersign.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCollaborationSavenextactposttaskitersignBean> result = new StoreResultBean<DmpkCollaborationSavenextactposttaskitersignBean>();
