...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.IusoggettoImpl;
 ...
 */
@Service(name="DmpkAnagraficaIusoggetto")
public class Iusoggetto {
	...
	public StoreResultBean<DmpkAnagraficaIusoggettoBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaIusoggettoBean pBean) throws Exception{
	   final IusoggettoImpl lIusoggetto = new IusoggettoImpl();
	   setBean(pBean);
	   lIusoggetto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIusoggetto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaIusoggettoBean> result = new StoreResultBean<DmpkAnagraficaIusoggettoBean>();
