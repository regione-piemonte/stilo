...
package it.eng.auriga.database.store.dmpk_folder_types.store.impl;
...
public class DfoldertypeImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_FOLDER_TYPES.DFOLDERTYPE(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idfoldertypein",4,Types.DECIMAL,connection); 	
