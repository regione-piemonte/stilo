...
public class Getattrdinxricerca_jImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_ATTRIBUTI_DINAMICI.GETATTRDINXRICERCA_J(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"attribtabout",6,Types.CLOB); 
