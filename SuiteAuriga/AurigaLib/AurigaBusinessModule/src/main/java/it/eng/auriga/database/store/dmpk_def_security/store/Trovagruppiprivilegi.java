...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TrovagruppiprivilegiImpl;
 ...
 */
@Service(name="DmpkDefSecurityTrovagruppiprivilegi")
public class Trovagruppiprivilegi {
	...
	public StoreResultBean<DmpkDefSecurityTrovagruppiprivilegiBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTrovagruppiprivilegiBean pBean) throws Exception{
	   final TrovagruppiprivilegiImpl lTrovagruppiprivilegi = new TrovagruppiprivilegiImpl();
	   setBean(pBean);
	   lTrovagruppiprivilegi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovagruppiprivilegi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTrovagruppiprivilegiBean> result = new StoreResultBean<DmpkDefSecurityTrovagruppiprivilegiBean>();
