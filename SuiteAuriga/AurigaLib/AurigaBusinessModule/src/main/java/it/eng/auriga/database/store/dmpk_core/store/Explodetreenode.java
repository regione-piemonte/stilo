...
import it.eng.auriga.database.store.dmpk_core.store.impl.ExplodetreenodeImpl;
 ...
 */
@Service(name="DmpkCoreExplodetreenode")
public class Explodetreenode {
	...
	public StoreResultBean<DmpkCoreExplodetreenodeBean> execute(AurigaLoginBean lLoginBean, DmpkCoreExplodetreenodeBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreExplodetreenodeBean> result = new StoreResultBean<DmpkCoreExplodetreenodeBean>();
