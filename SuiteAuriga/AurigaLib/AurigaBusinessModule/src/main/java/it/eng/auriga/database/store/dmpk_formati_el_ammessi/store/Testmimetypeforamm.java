...
import it.eng.auriga.database.store.dmpk_formati_el_ammessi.store.impl.TestmimetypeforammImpl;
 ...
 */
@Service(name="DmpkFormatiElAmmessiTestmimetypeforamm")
public class Testmimetypeforamm {
		
	private DmpkFormatiElAmmessiTestmimetypeforammBean bean;
		  
	public void setBean(DmpkFormatiElAmmessiTestmimetypeforammBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkFormatiElAmmessiTestmimetypeforammBean> execute(AurigaLoginBean lLoginBean, DmpkFormatiElAmmessiTestmimetypeforammBean pBean) throws Exception{
	   final TestmimetypeforammImpl lTestmimetypeforamm = new TestmimetypeforammImpl();
	   setBean(pBean);
	   lTestmimetypeforamm.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTestmimetypeforamm.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFormatiElAmmessiTestmimetypeforammBean> result = new StoreResultBean<DmpkFormatiElAmmessiTestmimetypeforammBean>();
