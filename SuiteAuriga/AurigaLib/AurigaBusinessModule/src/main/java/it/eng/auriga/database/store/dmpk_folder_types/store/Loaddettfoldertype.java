...
import it.eng.auriga.database.store.dmpk_folder_types.store.impl.LoaddettfoldertypeImpl;
 ...
 */
@Service(name="DmpkFolderTypesLoaddettfoldertype")
public class Loaddettfoldertype {
	...
	public StoreResultBean<DmpkFolderTypesLoaddettfoldertypeBean> execute(AurigaLoginBean lLoginBean, DmpkFolderTypesLoaddettfoldertypeBean pBean) throws Exception{
	   final LoaddettfoldertypeImpl lLoaddettfoldertype = new LoaddettfoldertypeImpl();
	   setBean(pBean);
	   lLoaddettfoldertype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettfoldertype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFolderTypesLoaddettfoldertypeBean> result = new StoreResultBean<DmpkFolderTypesLoaddettfoldertypeBean>();
