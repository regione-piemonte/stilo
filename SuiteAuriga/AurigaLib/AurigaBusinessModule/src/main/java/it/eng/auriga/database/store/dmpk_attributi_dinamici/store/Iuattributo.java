...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.IuattributoImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciIuattributo")
public class Iuattributo {
	...
	public StoreResultBean<DmpkAttributiDinamiciIuattributoBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciIuattributoBean pBean) throws Exception{
	   final IuattributoImpl lIuattributo = new IuattributoImpl();
	   setBean(pBean);
	   lIuattributo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuattributo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciIuattributoBean> result = new StoreResultBean<DmpkAttributiDinamiciIuattributoBean>();
