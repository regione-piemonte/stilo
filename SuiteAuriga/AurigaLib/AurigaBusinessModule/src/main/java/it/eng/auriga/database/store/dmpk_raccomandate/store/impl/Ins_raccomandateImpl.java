...
public class Ins_raccomandateImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"v_nro_lettera",19,Types.DECIMAL,connection);
			util.settingParameterOnStore(call,bean,wrapperBean,"v_data_raccomandata",20,Types.TIMESTAMP,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"v_idricevuta",21,Types.DECIMAL,connection); 	
