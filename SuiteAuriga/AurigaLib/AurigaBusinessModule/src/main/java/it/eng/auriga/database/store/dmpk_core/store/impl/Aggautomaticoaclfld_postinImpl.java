...
public class Aggautomaticoaclfld_postinImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.AGGAUTOMATICOACLFLD_POSTIN(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flginvionotificain",5,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tsinvionotificain",6,Types.VARCHAR,connection); 	
