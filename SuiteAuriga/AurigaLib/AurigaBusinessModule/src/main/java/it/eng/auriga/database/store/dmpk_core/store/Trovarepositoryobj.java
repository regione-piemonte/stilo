...
import it.eng.auriga.database.store.dmpk_core.store.impl.TrovarepositoryobjImpl;
 ...
 */
@Service(name="DmpkCoreTrovarepositoryobj")
public class Trovarepositoryobj {
	...
	public StoreResultBean<DmpkCoreTrovarepositoryobjBean> execute(AurigaLoginBean lLoginBean, DmpkCoreTrovarepositoryobjBean pBean) throws Exception{
	   final TrovarepositoryobjImpl lTrovarepositoryobj = new TrovarepositoryobjImpl();
	   setBean(pBean);
	   lTrovarepositoryobj.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovarepositoryobj.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreTrovarepositoryobjBean> result = new StoreResultBean<DmpkCoreTrovarepositoryobjBean>();
