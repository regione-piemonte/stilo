...
import it.eng.auriga.database.store.dmpk_registrazionedoc.store.impl.VerificaregduplicataImpl;
 ...
 */
@Service(name="DmpkRegistrazionedocVerificaregduplicata")
public class Verificaregduplicata {
		
	private DmpkRegistrazionedocVerificaregduplicataBean bean;
		  
	public void setBean(DmpkRegistrazionedocVerificaregduplicataBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRegistrazionedocVerificaregduplicataBean> execute(AurigaLoginBean lLoginBean, DmpkRegistrazionedocVerificaregduplicataBean pBean) throws Exception{
	   final VerificaregduplicataImpl lVerificaregduplicata = new VerificaregduplicataImpl();
	   setBean(pBean);
	   lVerificaregduplicata.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lVerificaregduplicata.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRegistrazionedocVerificaregduplicataBean> result = new StoreResultBean<DmpkRegistrazionedocVerificaregduplicataBean>();
