...
public class GetudcollegateImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_REPOSITORY_GUI.GETUDCOLLEGATE(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"listarelazionivsudout",5,Types.CLOB); 
