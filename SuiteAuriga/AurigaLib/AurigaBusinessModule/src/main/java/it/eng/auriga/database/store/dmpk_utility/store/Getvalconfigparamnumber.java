...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityGetvalconfigparamnumberBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.GetvalconfigparamnumberImpl;
 ...
 */
@Service(name="DmpkUtilityGetvalconfigparamnumber")
public class Getvalconfigparamnumber {
		
	private DmpkUtilityGetvalconfigparamnumberBean bean;
		  
	public void setBean(DmpkUtilityGetvalconfigparamnumberBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityGetvalconfigparamnumberBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityGetvalconfigparamnumberBean pBean) throws Exception{
	   final GetvalconfigparamnumberImpl lGetvalconfigparamnumber = new GetvalconfigparamnumberImpl();
	   setBean(pBean);
	   lGetvalconfigparamnumber.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetvalconfigparamnumber.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityGetvalconfigparamnumberBean> result = new StoreResultBean<DmpkUtilityGetvalconfigparamnumberBean>();
