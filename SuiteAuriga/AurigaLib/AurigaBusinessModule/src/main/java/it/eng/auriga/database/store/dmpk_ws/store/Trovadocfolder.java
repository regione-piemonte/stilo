...
import it.eng.auriga.database.store.dmpk_ws.store.impl.TrovadocfolderImpl;
 ...
 */
@Service(name="DmpkWsTrovadocfolder")
public class Trovadocfolder {
	...
	public StoreResultBean<DmpkWsTrovadocfolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsTrovadocfolderBean pBean) throws Exception{
	   final TrovadocfolderImpl lTrovadocfolder = new TrovadocfolderImpl();
	   setBean(pBean);
	   lTrovadocfolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadocfolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsTrovadocfolderBean> result = new StoreResultBean<DmpkWsTrovadocfolderBean>();
