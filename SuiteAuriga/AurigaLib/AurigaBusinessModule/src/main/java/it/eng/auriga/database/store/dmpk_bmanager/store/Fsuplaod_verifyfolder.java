...
import it.eng.auriga.database.store.dmpk_bmanager.bean.DmpkBmanagerFsuplaod_verifyfolderBean;
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.Fsuplaod_verifyfolderImpl;
 ...
 */
@Service(name="DmpkBmanagerFsuplaod_verifyfolder")
public class Fsuplaod_verifyfolder {
		
	private DmpkBmanagerFsuplaod_verifyfolderBean bean;
		  
	public void setBean(DmpkBmanagerFsuplaod_verifyfolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerFsuplaod_verifyfolderBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerFsuplaod_verifyfolderBean pBean) throws Exception{
	   final Fsuplaod_verifyfolderImpl lFsuplaod_verifyfolder = new Fsuplaod_verifyfolderImpl();
	   setBean(pBean);
	   lFsuplaod_verifyfolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lFsuplaod_verifyfolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerFsuplaod_verifyfolderBean> result = new StoreResultBean<DmpkBmanagerFsuplaod_verifyfolderBean>();
