...
public class DelverdocImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.DELVERDOC(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"nroprogrverout",5,Types.INTEGER); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgtipodelout",6,Types.VARCHAR); 
