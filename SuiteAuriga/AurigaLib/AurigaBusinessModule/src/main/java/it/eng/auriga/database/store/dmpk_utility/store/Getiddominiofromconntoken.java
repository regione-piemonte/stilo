...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityGetiddominiofromconntokenBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.GetiddominiofromconntokenImpl;
 ...
 */
@Service(name="DmpkUtilityGetiddominiofromconntoken")
public class Getiddominiofromconntoken {
		
	private DmpkUtilityGetiddominiofromconntokenBean bean;
		  
	public void setBean(DmpkUtilityGetiddominiofromconntokenBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityGetiddominiofromconntokenBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityGetiddominiofromconntokenBean pBean) throws Exception{
	   final GetiddominiofromconntokenImpl lGetiddominiofromconntoken = new GetiddominiofromconntokenImpl();
	   setBean(pBean);
	   lGetiddominiofromconntoken.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetiddominiofromconntoken.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityGetiddominiofromconntokenBean> result = new StoreResultBean<DmpkUtilityGetiddominiofromconntokenBean>();
