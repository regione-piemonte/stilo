...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.CreacasellacomecopiaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailCreacasellacomecopia")
public class Creacasellacomecopia {
		
	private DmpkIntMgoEmailCreacasellacomecopiaBean bean;
		  
	public void setBean(DmpkIntMgoEmailCreacasellacomecopiaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailCreacasellacomecopiaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailCreacasellacomecopiaBean pBean) throws Exception{
	   final CreacasellacomecopiaImpl lCreacasellacomecopia = new CreacasellacomecopiaImpl();
	   setBean(pBean);
	   lCreacasellacomecopia.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCreacasellacomecopia.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailCreacasellacomecopiaBean> result = new StoreResultBean<DmpkIntMgoEmailCreacasellacomecopiaBean>();
