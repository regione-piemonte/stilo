...
import it.eng.auriga.database.store.dmpk_utility.store.impl.GetoggettodamodelloImpl;
 ...
 */
@Service(name="DmpkUtilityGetoggettodamodello")
public class Getoggettodamodello {
	...
	public StoreResultBean<DmpkUtilityGetoggettodamodelloBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityGetoggettodamodelloBean pBean) throws Exception{
	   final GetoggettodamodelloImpl lGetoggettodamodello = new GetoggettodamodelloImpl();
	   setBean(pBean);
	   lGetoggettodamodello.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetoggettodamodello.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityGetoggettodamodelloBean> result = new StoreResultBean<DmpkUtilityGetoggettodamodelloBean>();
