 ...
 */
@Service(name="DmpkBmanagerCaricacontfoglioximport")
public class Caricacontfoglioximport {
		
	private DmpkBmanagerCaricacontfoglioximportBean bean;
		  
	public void setBean(DmpkBmanagerCaricacontfoglioximportBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerCaricacontfoglioximportBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerCaricacontfoglioximportBean pBean) throws Exception{
	   final CaricacontfoglioximportImpl lCaricacontfoglioximport = new CaricacontfoglioximportImpl();
	   setBean(pBean);
	   lCaricacontfoglioximport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkBmanagerCaricacontfoglioximportBean> result = new StoreResultBean<DmpkBmanagerCaricacontfoglioximportBean>();
