...
import it.eng.auriga.database.store.dmpk_statistiche.store.impl.CreacampioneattiImpl;
 ...
 */
@Service(name="DmpkStatisticheCreacampioneatti")
public class Creacampioneatti {
		
	private DmpkStatisticheCreacampioneattiBean bean;
		  
	public void setBean(DmpkStatisticheCreacampioneattiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkStatisticheCreacampioneattiBean> execute(AurigaLoginBean lLoginBean, DmpkStatisticheCreacampioneattiBean pBean) throws Exception{
	   final CreacampioneattiImpl lCreacampioneatti = new CreacampioneattiImpl();
	   setBean(pBean);
	   lCreacampioneatti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCreacampioneatti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkStatisticheCreacampioneattiBean> result = new StoreResultBean<DmpkStatisticheCreacampioneattiBean>();
