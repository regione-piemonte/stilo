...
public class VerificaquadraturapuntivenditaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORRISPETTIVI.VERIFICAQUADRATURAPUNTIVENDITA(?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"esitoquadraturaout",6,Types.INTEGER); 
