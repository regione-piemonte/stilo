...
import it.eng.auriga.database.store.dmpk_utility.store.impl.DmodellooggettoImpl;
 ...
 */
@Service(name="DmpkUtilityDmodellooggetto")
public class Dmodellooggetto {
		
	private DmpkUtilityDmodellooggettoBean bean;
		  
	public void setBean(DmpkUtilityDmodellooggettoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityDmodellooggettoBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityDmodellooggettoBean pBean) throws Exception{
	   final DmodellooggettoImpl lDmodellooggetto = new DmodellooggettoImpl();
	   setBean(pBean);
	   lDmodellooggetto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDmodellooggetto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityDmodellooggettoBean> result = new StoreResultBean<DmpkUtilityDmodellooggettoBean>();
