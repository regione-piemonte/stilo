...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovalottidocingestBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovalottidocingestImpl;
 ...
 */
@Service(name="DmpkEfactTrovalottidocingest")
public class Trovalottidocingest {
		
	private DmpkEfactTrovalottidocingestBean bean;
		  
	public void setBean(DmpkEfactTrovalottidocingestBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovalottidocingestBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovalottidocingestBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkEfactTrovalottidocingestBean> result = new StoreResultBean<DmpkEfactTrovalottidocingestBean>();
