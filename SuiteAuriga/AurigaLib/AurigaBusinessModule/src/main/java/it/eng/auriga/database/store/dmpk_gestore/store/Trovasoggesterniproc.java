...
import it.eng.auriga.database.store.dmpk_gestore.bean.DmpkGestoreTrovasoggesterniprocBean;
import it.eng.auriga.database.store.dmpk_gestore.store.impl.TrovasoggesterniprocImpl;
 ...
 */
@Service(name="DmpkGestoreTrovasoggesterniproc")
public class Trovasoggesterniproc {
		
	private DmpkGestoreTrovasoggesterniprocBean bean;
		  
	public void setBean(DmpkGestoreTrovasoggesterniprocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkGestoreTrovasoggesterniprocBean> execute(AurigaLoginBean lLoginBean, DmpkGestoreTrovasoggesterniprocBean pBean) throws Exception{
	   final TrovasoggesterniprocImpl lTrovasoggesterniproc = new TrovasoggesterniprocImpl();
	   setBean(pBean);
	   lTrovasoggesterniproc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovasoggesterniproc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkGestoreTrovasoggesterniprocBean> result = new StoreResultBean<DmpkGestoreTrovasoggesterniprocBean>();
