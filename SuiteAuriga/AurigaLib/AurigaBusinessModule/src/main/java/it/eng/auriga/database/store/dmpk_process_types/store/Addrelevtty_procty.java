...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.Addrelevtty_proctyImpl;
 ...
 */
@Service(name="DmpkProcessTypesAddrelevtty_procty")
public class Addrelevtty_procty {
		
	private DmpkProcessTypesAddrelevtty_proctyBean bean;
		  
	public void setBean(DmpkProcessTypesAddrelevtty_proctyBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkProcessTypesAddrelevtty_proctyBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesAddrelevtty_proctyBean pBean) throws Exception{
	   final Addrelevtty_proctyImpl lAddrelevtty_procty = new Addrelevtty_proctyImpl();
	   setBean(pBean);
	   lAddrelevtty_procty.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddrelevtty_procty.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesAddrelevtty_proctyBean> result = new StoreResultBean<DmpkProcessTypesAddrelevtty_proctyBean>();
