...
public class To_datetimexmltagImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.TO_DATETIMEXMLTAG(?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"datain",2,Types.TIMESTAMP,connection); 	
