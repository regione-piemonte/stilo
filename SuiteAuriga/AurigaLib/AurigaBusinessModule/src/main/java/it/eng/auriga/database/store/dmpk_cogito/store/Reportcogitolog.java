...
package it.eng.auriga.database.store.dmpk_cogito.store;

import it.eng.auriga.database.store.dmpk_cogito.bean.DmpkCogitoReportcogitologBean;
import it.eng.auriga.database.store.dmpk_cogito.store.impl.ReportcogitologImpl;
 ...
 */
@Service(name="DmpkCogitoReportcogitolog")
public class Reportcogitolog {
	...
	public StoreResultBean<DmpkCogitoReportcogitologBean> execute(AurigaLoginBean lLoginBean, DmpkCogitoReportcogitologBean pBean) throws Exception{
	   final ReportcogitologImpl lReportcogitolog = new ReportcogitologImpl();
	   setBean(pBean);
	   lReportcogitolog.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lReportcogitolog.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCogitoReportcogitologBean> result = new StoreResultBean<DmpkCogitoReportcogitologBean>();
