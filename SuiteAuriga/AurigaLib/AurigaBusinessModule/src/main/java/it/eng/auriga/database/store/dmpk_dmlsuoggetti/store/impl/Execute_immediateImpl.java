...
public class Execute_immediateImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DMLSUOGGETTI.EXECUTE_IMMEDIATE(?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"cmdstrin",2,Types.VARCHAR,connection); 	
