...
public class CaricacontfoglioximportImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_BMANAGER.CARICACONTFOGLIOXIMPORT(?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"xmldettcolonnein",5,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"xmlcontenutiin",6,Types.CLOB,connection); 	
