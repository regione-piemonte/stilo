...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.CtrlstartendscadImpl;
 ...
 */
@Service(name="DmpkProcessTypesCtrlstartendscad")
public class Ctrlstartendscad {
	...
	public StoreResultBean<DmpkProcessTypesCtrlstartendscadBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesCtrlstartendscadBean pBean) throws Exception{
	   final CtrlstartendscadImpl lCtrlstartendscad = new CtrlstartendscadImpl();
	   setBean(pBean);
	   lCtrlstartendscad.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCtrlstartendscad.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesCtrlstartendscadBean> result = new StoreResultBean<DmpkProcessTypesCtrlstartendscadBean>();
