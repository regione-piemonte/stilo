...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.IuemailImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailIuemail")
public class Iuemail {
		
	private DmpkIntMgoEmailIuemailBean bean;
		  
	public void setBean(DmpkIntMgoEmailIuemailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailIuemailBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailIuemailBean pBean) throws Exception{
	   final IuemailImpl lIuemail = new IuemailImpl();
	   setBean(pBean);
	   lIuemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailIuemailBean> result = new StoreResultBean<DmpkIntMgoEmailIuemailBean>();
