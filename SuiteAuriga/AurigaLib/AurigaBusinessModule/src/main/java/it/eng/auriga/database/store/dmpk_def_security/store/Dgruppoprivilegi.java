...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.DgruppoprivilegiImpl;
 ...
 */
@Service(name="DmpkDefSecurityDgruppoprivilegi")
public class Dgruppoprivilegi {
		
	private DmpkDefSecurityDgruppoprivilegiBean bean;
		  
	public void setBean(DmpkDefSecurityDgruppoprivilegiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityDgruppoprivilegiBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityDgruppoprivilegiBean pBean) throws Exception{
	   final DgruppoprivilegiImpl lDgruppoprivilegi = new DgruppoprivilegiImpl();
	   setBean(pBean);
	   lDgruppoprivilegi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDgruppoprivilegi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityDgruppoprivilegiBean> result = new StoreResultBean<DmpkDefSecurityDgruppoprivilegiBean>();
