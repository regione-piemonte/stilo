...
import it.eng.auriga.database.store.dmpk_def_security.bean.DmpkDefSecurityIumembrogrupposoggintBean;
import it.eng.auriga.database.store.dmpk_def_security.store.impl.IumembrogrupposoggintImpl;
 ...
 */
@Service(name="DmpkDefSecurityIumembrogrupposoggint")
public class Iumembrogrupposoggint {
		
	private DmpkDefSecurityIumembrogrupposoggintBean bean;
		  
	public void setBean(DmpkDefSecurityIumembrogrupposoggintBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityIumembrogrupposoggintBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityIumembrogrupposoggintBean pBean) throws Exception{
	   final IumembrogrupposoggintImpl lIumembrogrupposoggint = new IumembrogrupposoggintImpl();
	   setBean(pBean);
	   lIumembrogrupposoggint.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIumembrogrupposoggint.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityIumembrogrupposoggintBean> result = new StoreResultBean<DmpkDefSecurityIumembrogrupposoggintBean>();
