...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettgrupposoggintImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettgrupposoggint")
public class Loaddettgrupposoggint {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettgrupposoggintBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettgrupposoggintBean pBean) throws Exception{
	   final LoaddettgrupposoggintImpl lLoaddettgrupposoggint = new LoaddettgrupposoggintImpl();
	   setBean(pBean);
	   lLoaddettgrupposoggint.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettgrupposoggint.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettgrupposoggintBean> result = new StoreResultBean<DmpkDefSecurityLoaddettgrupposoggintBean>();
