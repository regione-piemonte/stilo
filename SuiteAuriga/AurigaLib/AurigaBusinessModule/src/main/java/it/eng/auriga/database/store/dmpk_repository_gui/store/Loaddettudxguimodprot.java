 ...
 */
@Service(name="DmpkRepositoryGuiLoaddettudxguimodprot")
public class Loaddettudxguimodprot {
	...
	public StoreResultBean<DmpkRepositoryGuiLoaddettudxguimodprotBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiLoaddettudxguimodprotBean pBean) throws Exception{
	   final LoaddettudxguimodprotImpl lLoaddettudxguimodprot = new LoaddettudxguimodprotImpl();
	   setBean(pBean);
	   lLoaddettudxguimodprot.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettudxguimodprot.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiLoaddettudxguimodprotBean> result = new StoreResultBean<DmpkRepositoryGuiLoaddettudxguimodprotBean>();
