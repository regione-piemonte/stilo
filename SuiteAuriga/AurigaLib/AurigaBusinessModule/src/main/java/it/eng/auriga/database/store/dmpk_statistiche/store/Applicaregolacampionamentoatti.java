...
package it.eng.auriga.database.store.dmpk_statistiche.store;

import it.eng.auriga.database.store.dmpk_statistiche.bean.DmpkStatisticheApplicaregolacampionamentoattiBean;
import it.eng.auriga.database.store.dmpk_statistiche.store.impl.ApplicaregolacampionamentoattiImpl;
 ...
 */
@Service(name="DmpkStatisticheApplicaregolacampionamentoatti")
public class Applicaregolacampionamentoatti {
		
	private DmpkStatisticheApplicaregolacampionamentoattiBean bean;
		  
	public void setBean(DmpkStatisticheApplicaregolacampionamentoattiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkStatisticheApplicaregolacampionamentoattiBean> execute(AurigaLoginBean lLoginBean, DmpkStatisticheApplicaregolacampionamentoattiBean pBean) throws Exception{
	   final ApplicaregolacampionamentoattiImpl lApplicaregolacampionamentoatti = new ApplicaregolacampionamentoattiImpl();
	   setBean(pBean);
	   lApplicaregolacampionamentoatti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lApplicaregolacampionamentoatti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkStatisticheApplicaregolacampionamentoattiBean> result = new StoreResultBean<DmpkStatisticheApplicaregolacampionamentoattiBean>();
