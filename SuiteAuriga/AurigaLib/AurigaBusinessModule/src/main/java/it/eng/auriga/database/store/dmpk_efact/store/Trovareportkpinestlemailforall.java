...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportkpinestlemailforallBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportkpinestlemailforallImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportkpinestlemailforall")
public class Trovareportkpinestlemailforall {
		
	private DmpkEfactTrovareportkpinestlemailforallBean bean;
		  
	public void setBean(DmpkEfactTrovareportkpinestlemailforallBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportkpinestlemailforallBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportkpinestlemailforallBean pBean) throws Exception{
	   final TrovareportkpinestlemailforallImpl lTrovareportkpinestlemailforall = new TrovareportkpinestlemailforallImpl();
	   setBean(pBean);
	   lTrovareportkpinestlemailforall.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportkpinestlemailforall.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportkpinestlemailforallBean> result = new StoreResultBean<DmpkEfactTrovareportkpinestlemailforallBean>();
