...
public class GetpathImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_CORE.GETPATH(?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"viaidfolderin",5,Types.DECIMAL,connection); 	
