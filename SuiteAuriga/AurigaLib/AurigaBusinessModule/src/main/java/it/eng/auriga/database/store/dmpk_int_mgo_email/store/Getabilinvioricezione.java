...
import it.eng.auriga.database.store.dmpk_int_mgo_email.bean.DmpkIntMgoEmailGetabilinvioricezioneBean;
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.GetabilinvioricezioneImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailGetabilinvioricezione")
public class Getabilinvioricezione {
		
	private DmpkIntMgoEmailGetabilinvioricezioneBean bean;
		  
	public void setBean(DmpkIntMgoEmailGetabilinvioricezioneBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailGetabilinvioricezioneBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailGetabilinvioricezioneBean pBean) throws Exception{
	   final GetabilinvioricezioneImpl lGetabilinvioricezione = new GetabilinvioricezioneImpl();
	   setBean(pBean);
	   lGetabilinvioricezione.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetabilinvioricezione.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailGetabilinvioricezioneBean> result = new StoreResultBean<DmpkIntMgoEmailGetabilinvioricezioneBean>();
