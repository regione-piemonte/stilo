...
import it.eng.auriga.database.store.dmpk_ws.store.impl.DeltipodocImpl;
 ...
 */
@Service(name="DmpkWsDeltipodoc")
public class Deltipodoc {
		
	private DmpkWsDeltipodocBean bean;
		  
	public void setBean(DmpkWsDeltipodocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsDeltipodocBean> execute(AurigaLoginBean lLoginBean, DmpkWsDeltipodocBean pBean) throws Exception{
	   final DeltipodocImpl lDeltipodoc = new DeltipodocImpl();
	   setBean(pBean);
	   lDeltipodoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDeltipodoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsDeltipodocBean> result = new StoreResultBean<DmpkWsDeltipodocBean>();
