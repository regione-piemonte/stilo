...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.ReinviaemailImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailReinviaemail")
public class Reinviaemail {
		
	private DmpkIntMgoEmailReinviaemailBean bean;
		  
	public void setBean(DmpkIntMgoEmailReinviaemailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailReinviaemailBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailReinviaemailBean pBean) throws Exception{
	   final ReinviaemailImpl lReinviaemail = new ReinviaemailImpl();
	   setBean(pBean);
	   lReinviaemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lReinviaemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailReinviaemailBean> result = new StoreResultBean<DmpkIntMgoEmailReinviaemailBean>();
