...
public class RiordinarecconttabellaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_AMM_TRASP.RIORDINARECCONTTABELLA(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"recorddariordinarein",5,Types.CLOB,connection); 	
