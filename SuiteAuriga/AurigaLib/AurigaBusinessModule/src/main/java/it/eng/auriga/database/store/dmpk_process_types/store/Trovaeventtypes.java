...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.TrovaeventtypesImpl;
 ...
 */
@Service(name="DmpkProcessTypesTrovaeventtypes")
public class Trovaeventtypes {
	...
	public StoreResultBean<DmpkProcessTypesTrovaeventtypesBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesTrovaeventtypesBean pBean) throws Exception{
	   final TrovaeventtypesImpl lTrovaeventtypes = new TrovaeventtypesImpl();
	   setBean(pBean);
	   lTrovaeventtypes.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaeventtypes.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesTrovaeventtypesBean> result = new StoreResultBean<DmpkProcessTypesTrovaeventtypesBean>();
