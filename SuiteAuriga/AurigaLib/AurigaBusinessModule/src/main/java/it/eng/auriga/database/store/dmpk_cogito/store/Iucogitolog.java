...
import it.eng.auriga.database.store.dmpk_cogito.store.impl.IucogitologImpl;
 ...
 */
@Service(name="DmpkCogitoIucogitolog")
public class Iucogitolog {
	...
	public StoreResultBean<DmpkCogitoIucogitologBean> execute(AurigaLoginBean lLoginBean, DmpkCogitoIucogitologBean pBean) throws Exception{
	   final IucogitologImpl lIucogitolog = new IucogitologImpl();
	   setBean(pBean);
	   lIucogitolog.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIucogitolog.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCogitoIucogitologBean> result = new StoreResultBean<DmpkCogitoIucogitologBean>();
