...
public class TrovaoggrichopbatchmassivaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_BMANAGER.TROVAOGGRICHOPBATCHMASSIVA(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idrichiestaopmassivain",4,Types.VARCHAR,connection); 	
