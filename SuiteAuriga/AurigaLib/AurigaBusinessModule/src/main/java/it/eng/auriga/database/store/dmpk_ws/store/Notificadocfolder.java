...
import it.eng.auriga.database.store.dmpk_ws.store.impl.NotificadocfolderImpl;
 ...
 */
@Service(name="DmpkWsNotificadocfolder")
public class Notificadocfolder {
	...
	public StoreResultBean<DmpkWsNotificadocfolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsNotificadocfolderBean pBean) throws Exception{
	   final NotificadocfolderImpl lNotificadocfolder = new NotificadocfolderImpl();
	   setBean(pBean);
	   lNotificadocfolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lNotificadocfolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsNotificadocfolderBean> result = new StoreResultBean<DmpkWsNotificadocfolderBean>();
