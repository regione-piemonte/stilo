...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.LoaddettfascxguimodprotImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiLoaddettfascxguimodprot")
public class Loaddettfascxguimodprot {
		
	private DmpkRepositoryGuiLoaddettfascxguimodprotBean bean;
		  
	public void setBean(DmpkRepositoryGuiLoaddettfascxguimodprotBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiLoaddettfascxguimodprotBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiLoaddettfascxguimodprotBean pBean) throws Exception{
	   final LoaddettfascxguimodprotImpl lLoaddettfascxguimodprot = new LoaddettfascxguimodprotImpl();
	   setBean(pBean);
	   lLoaddettfascxguimodprot.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettfascxguimodprot.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiLoaddettfascxguimodprotBean> result = new StoreResultBean<DmpkRepositoryGuiLoaddettfascxguimodprotBean>();
