...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettprofiloImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettprofilo")
public class Loaddettprofilo {
		
	private DmpkDefSecurityLoaddettprofiloBean bean;
		  
	public void setBean(DmpkDefSecurityLoaddettprofiloBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityLoaddettprofiloBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettprofiloBean pBean) throws Exception{
	   final LoaddettprofiloImpl lLoaddettprofilo = new LoaddettprofiloImpl();
	   setBean(pBean);
	   lLoaddettprofilo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettprofilo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettprofiloBean> result = new StoreResultBean<DmpkDefSecurityLoaddettprofiloBean>();
