...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetlistaemendamentiImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetlistaemendamenti")
public class Getlistaemendamenti {
		
	private DmpkRepositoryGuiGetlistaemendamentiBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetlistaemendamentiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetlistaemendamentiBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetlistaemendamentiBean pBean) throws Exception{
	   final GetlistaemendamentiImpl lGetlistaemendamenti = new GetlistaemendamentiImpl();
	   setBean(pBean);
	   lGetlistaemendamenti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlistaemendamenti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetlistaemendamentiBean> result = new StoreResultBean<DmpkRepositoryGuiGetlistaemendamentiBean>();
