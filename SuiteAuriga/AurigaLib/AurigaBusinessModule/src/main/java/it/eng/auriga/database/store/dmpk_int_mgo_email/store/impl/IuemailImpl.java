...
public class IuemailImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_MGO_EMAIL.IUEMAIL(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"datiemailin",4,Types.CLOB,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"idemailio",5,Types.VARCHAR,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"idemailio",5,Types.VARCHAR); 
