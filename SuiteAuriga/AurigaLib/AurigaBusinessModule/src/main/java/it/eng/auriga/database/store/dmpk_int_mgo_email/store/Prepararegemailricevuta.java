...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.PrepararegemailricevutaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailPrepararegemailricevuta")
public class Prepararegemailricevuta {
		
	private DmpkIntMgoEmailPrepararegemailricevutaBean bean;
		  
	public void setBean(DmpkIntMgoEmailPrepararegemailricevutaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailPrepararegemailricevutaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailPrepararegemailricevutaBean pBean) throws Exception{
	   final PrepararegemailricevutaImpl lPrepararegemailricevuta = new PrepararegemailricevutaImpl();
	   setBean(pBean);
	   lPrepararegemailricevuta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lPrepararegemailricevuta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailPrepararegemailricevutaBean> result = new StoreResultBean<DmpkIntMgoEmailPrepararegemailricevutaBean>();
