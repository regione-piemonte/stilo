...
import it.eng.auriga.database.store.dmpk_ws.store.impl.DeltipofolderImpl;
 ...
 */
@Service(name="DmpkWsDeltipofolder")
public class Deltipofolder {
		
	private DmpkWsDeltipofolderBean bean;
		  
	public void setBean(DmpkWsDeltipofolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsDeltipofolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsDeltipofolderBean pBean) throws Exception{
	   final DeltipofolderImpl lDeltipofolder = new DeltipofolderImpl();
	   setBean(pBean);
	   lDeltipofolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDeltipofolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsDeltipofolderBean> result = new StoreResultBean<DmpkWsDeltipofolderBean>();
