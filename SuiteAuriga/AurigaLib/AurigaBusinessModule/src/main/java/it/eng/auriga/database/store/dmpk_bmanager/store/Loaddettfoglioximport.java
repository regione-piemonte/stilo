...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.LoaddettfoglioximportImpl;
 ...
 */
@Service(name="DmpkBmanagerLoaddettfoglioximport")
public class Loaddettfoglioximport {
	...
	public StoreResultBean<DmpkBmanagerLoaddettfoglioximportBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerLoaddettfoglioximportBean pBean) throws Exception{
	   final LoaddettfoglioximportImpl lLoaddettfoglioximport = new LoaddettfoglioximportImpl();
	   setBean(pBean);
	   lLoaddettfoglioximport.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettfoglioximport.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerLoaddettfoglioximportBean> result = new StoreResultBean<DmpkBmanagerLoaddettfoglioximportBean>();
