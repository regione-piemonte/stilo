...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.AddrecconttabellaImpl;
 ...
 */
@Service(name="DmpkAmmTraspAddrecconttabella")
public class Addrecconttabella {
		
	private DmpkAmmTraspAddrecconttabellaBean bean;
		  
	public void setBean(DmpkAmmTraspAddrecconttabellaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspAddrecconttabellaBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspAddrecconttabellaBean pBean) throws Exception{
	   final AddrecconttabellaImpl lAddrecconttabella = new AddrecconttabellaImpl();
	   setBean(pBean);
	   lAddrecconttabella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddrecconttabella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspAddrecconttabellaBean> result = new StoreResultBean<DmpkAmmTraspAddrecconttabellaBean>();
