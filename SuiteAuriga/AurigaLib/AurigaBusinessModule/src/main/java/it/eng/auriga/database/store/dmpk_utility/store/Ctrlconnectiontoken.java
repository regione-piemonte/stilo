...
import it.eng.auriga.database.store.dmpk_utility.store.impl.CtrlconnectiontokenImpl;
 ...
 */
@Service(name="DmpkUtilityCtrlconnectiontoken")
public class Ctrlconnectiontoken {
	...
	public StoreResultBean<DmpkUtilityCtrlconnectiontokenBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityCtrlconnectiontokenBean pBean) throws Exception{
	   final CtrlconnectiontokenImpl lCtrlconnectiontoken = new CtrlconnectiontokenImpl();
	   setBean(pBean);
	   lCtrlconnectiontoken.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCtrlconnectiontoken.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityCtrlconnectiontokenBean> result = new StoreResultBean<DmpkUtilityCtrlconnectiontokenBean>();
