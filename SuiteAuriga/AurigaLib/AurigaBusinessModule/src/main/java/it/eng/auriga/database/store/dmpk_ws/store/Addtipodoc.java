...
import it.eng.auriga.database.store.dmpk_ws.store.impl.AddtipodocImpl;
 ...
 */
@Service(name="DmpkWsAddtipodoc")
public class Addtipodoc {
		
	private DmpkWsAddtipodocBean bean;
		  
	public void setBean(DmpkWsAddtipodocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsAddtipodocBean> execute(AurigaLoginBean lLoginBean, DmpkWsAddtipodocBean pBean) throws Exception{
	   final AddtipodocImpl lAddtipodoc = new AddtipodocImpl();
	   setBean(pBean);
	   lAddtipodoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddtipodoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsAddtipodocBean> result = new StoreResultBean<DmpkWsAddtipodocBean>();
