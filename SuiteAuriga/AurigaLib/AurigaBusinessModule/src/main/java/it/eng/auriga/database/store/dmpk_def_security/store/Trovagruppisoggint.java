...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TrovagruppisoggintImpl;
 ...
 */
@Service(name="DmpkDefSecurityTrovagruppisoggint")
public class Trovagruppisoggint {
	...
	public StoreResultBean<DmpkDefSecurityTrovagruppisoggintBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTrovagruppisoggintBean pBean) throws Exception{
	   final TrovagruppisoggintImpl lTrovagruppisoggint = new TrovagruppisoggintImpl();
	   setBean(pBean);
	   lTrovagruppisoggint.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovagruppisoggint.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTrovagruppisoggintBean> result = new StoreResultBean<DmpkDefSecurityTrovagruppisoggintBean>();
