...
import it.eng.auriga.database.store.dmpk_titolario.bean.DmpkTitolarioTrovapianiclassifBean;
import it.eng.auriga.database.store.dmpk_titolario.store.impl.TrovapianiclassifImpl;
 ...
 */
@Service(name="DmpkTitolarioTrovapianiclassif")
public class Trovapianiclassif {
		
	private DmpkTitolarioTrovapianiclassifBean bean;
		  
	public void setBean(DmpkTitolarioTrovapianiclassifBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkTitolarioTrovapianiclassifBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioTrovapianiclassifBean pBean) throws Exception{
	   final TrovapianiclassifImpl lTrovapianiclassif = new TrovapianiclassifImpl();
	   setBean(pBean);
	   lTrovapianiclassif.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovapianiclassif.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioTrovapianiclassifBean> result = new StoreResultBean<DmpkTitolarioTrovapianiclassifBean>();
