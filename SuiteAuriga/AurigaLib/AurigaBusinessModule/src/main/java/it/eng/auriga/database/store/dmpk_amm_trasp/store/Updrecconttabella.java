...
import it.eng.auriga.database.store.dmpk_amm_trasp.store.impl.UpdrecconttabellaImpl;
 ...
 */
@Service(name="DmpkAmmTraspUpdrecconttabella")
public class Updrecconttabella {
		
	private DmpkAmmTraspUpdrecconttabellaBean bean;
		  
	public void setBean(DmpkAmmTraspUpdrecconttabellaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAmmTraspUpdrecconttabellaBean> execute(AurigaLoginBean lLoginBean, DmpkAmmTraspUpdrecconttabellaBean pBean) throws Exception{
	   final UpdrecconttabellaImpl lUpdrecconttabella = new UpdrecconttabellaImpl();
	   setBean(pBean);
	   lUpdrecconttabella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUpdrecconttabella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAmmTraspUpdrecconttabellaBean> result = new StoreResultBean<DmpkAmmTraspUpdrecconttabellaBean>();
