...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.IupianoclassifImpl;
 ...
 */
@Service(name="DmpkTitolarioIupianoclassif")
public class Iupianoclassif {
	...
	public StoreResultBean<DmpkTitolarioIupianoclassifBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioIupianoclassifBean pBean) throws Exception{
	   final IupianoclassifImpl lIupianoclassif = new IupianoclassifImpl();
	   setBean(pBean);
	   lIupianoclassif.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIupianoclassif.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioIupianoclassifBean> result = new StoreResultBean<DmpkTitolarioIupianoclassifBean>();
