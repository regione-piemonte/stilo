...
import it.eng.auriga.database.store.dmpk_process_types.store.impl.Addreldocty_proctyImpl;
 ...
 */
@Service(name="DmpkProcessTypesAddreldocty_procty")
public class Addreldocty_procty {
	...
	public StoreResultBean<DmpkProcessTypesAddreldocty_proctyBean> execute(AurigaLoginBean lLoginBean, DmpkProcessTypesAddreldocty_proctyBean pBean) throws Exception{
	   final Addreldocty_proctyImpl lAddreldocty_procty = new Addreldocty_proctyImpl();
	   setBean(pBean);
	   lAddreldocty_procty.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddreldocty_procty.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkProcessTypesAddreldocty_proctyBean> result = new StoreResultBean<DmpkProcessTypesAddreldocty_proctyBean>();
