...
public class DsoggettoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_ANAGRAFICA.DSOGGETTO(?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idsoggrubrin",4,Types.DECIMAL,connection); 	
