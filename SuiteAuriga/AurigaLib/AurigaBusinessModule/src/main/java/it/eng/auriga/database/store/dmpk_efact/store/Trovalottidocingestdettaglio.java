...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovalottidocingestdettaglioBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovalottidocingestdettaglioImpl;
 ...
 */
@Service(name="DmpkEfactTrovalottidocingestdettaglio")
public class Trovalottidocingestdettaglio {
		
	private DmpkEfactTrovalottidocingestdettaglioBean bean;
		  
	public void setBean(DmpkEfactTrovalottidocingestdettaglioBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovalottidocingestdettaglioBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovalottidocingestdettaglioBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkEfactTrovalottidocingestdettaglioBean> result = new StoreResultBean<DmpkEfactTrovalottidocingestdettaglioBean>();
