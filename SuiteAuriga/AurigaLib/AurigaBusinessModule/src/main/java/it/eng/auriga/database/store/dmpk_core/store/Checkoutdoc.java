...
import it.eng.auriga.database.store.dmpk_core.store.impl.CheckoutdocImpl;
 ...
 */
@Service(name="DmpkCoreCheckoutdoc")
public class Checkoutdoc {
		
	private DmpkCoreCheckoutdocBean bean;
		  
	public void setBean(DmpkCoreCheckoutdocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreCheckoutdocBean> execute(AurigaLoginBean lLoginBean, DmpkCoreCheckoutdocBean pBean) throws Exception{
	   final CheckoutdocImpl lCheckoutdoc = new CheckoutdocImpl();
	   setBean(pBean);
	   lCheckoutdoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCheckoutdoc.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreCheckoutdocBean> result = new StoreResultBean<DmpkCoreCheckoutdocBean>();
