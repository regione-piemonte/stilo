...
package it.eng.auriga.database.store.dmpk_formati_el_ammessi.store;

import it.eng.auriga.database.store.dmpk_formati_el_ammessi.bean.DmpkFormatiElAmmessiLoaddettformatoelBean;
import it.eng.auriga.database.store.dmpk_formati_el_ammessi.store.impl.LoaddettformatoelImpl;
 ...
 */
@Service(name="DmpkFormatiElAmmessiLoaddettformatoel")
public class Loaddettformatoel {
	...
	public StoreResultBean<DmpkFormatiElAmmessiLoaddettformatoelBean> execute(AurigaLoginBean lLoginBean, DmpkFormatiElAmmessiLoaddettformatoelBean pBean) throws Exception{
	   final LoaddettformatoelImpl lLoaddettformatoel = new LoaddettformatoelImpl();
	   setBean(pBean);
	   lLoaddettformatoel.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettformatoel.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkFormatiElAmmessiLoaddettformatoelBean> result = new StoreResultBean<DmpkFormatiElAmmessiLoaddettformatoelBean>();
