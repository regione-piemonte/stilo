...
import it.eng.auriga.database.store.dmpk_core.store.impl.FindudImpl;
...
public class Findud {
	...
	public StoreResultBean<DmpkCoreFindudBean> execute(AurigaLoginBean lLoginBean, DmpkCoreFindudBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreFindudBean> result = new StoreResultBean<DmpkCoreFindudBean>();
