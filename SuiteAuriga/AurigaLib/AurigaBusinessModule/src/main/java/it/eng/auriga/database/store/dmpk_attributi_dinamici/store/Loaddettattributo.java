...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.LoaddettattributoImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciLoaddettattributo")
public class Loaddettattributo {
	...
	public StoreResultBean<DmpkAttributiDinamiciLoaddettattributoBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciLoaddettattributoBean pBean) throws Exception{
	   final LoaddettattributoImpl lLoaddettattributo = new LoaddettattributoImpl();
	   setBean(pBean);
	   lLoaddettattributo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettattributo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciLoaddettattributoBean> result = new StoreResultBean<DmpkAttributiDinamiciLoaddettattributoBean>();
