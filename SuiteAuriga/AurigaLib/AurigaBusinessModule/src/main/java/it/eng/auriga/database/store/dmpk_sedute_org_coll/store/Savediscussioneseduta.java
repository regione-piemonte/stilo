...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.SavediscussionesedutaImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollSavediscussioneseduta")
public class Savediscussioneseduta {
	...
	public StoreResultBean<DmpkSeduteOrgCollSavediscussionesedutaBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollSavediscussionesedutaBean pBean) throws Exception{
	   final SavediscussionesedutaImpl lSavediscussioneseduta = new SavediscussionesedutaImpl();
	   setBean(pBean);
	   lSavediscussioneseduta.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSavediscussioneseduta.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollSavediscussionesedutaBean> result = new StoreResultBean<DmpkSeduteOrgCollSavediscussionesedutaBean>();
