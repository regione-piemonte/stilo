...
import it.eng.auriga.database.store.dmpk_collaboration.store.impl.RestituzioneImpl;
 ...
 */
@Service(name="DmpkCollaborationRestituzione")
public class Restituzione {
	...
	public StoreResultBean<DmpkCollaborationRestituzioneBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationRestituzioneBean pBean) throws Exception{
	   final RestituzioneImpl lRestituzione = new RestituzioneImpl();
	   setBean(pBean);
	   lRestituzione.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRestituzione.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCollaborationRestituzioneBean> result = new StoreResultBean<DmpkCollaborationRestituzioneBean>();
