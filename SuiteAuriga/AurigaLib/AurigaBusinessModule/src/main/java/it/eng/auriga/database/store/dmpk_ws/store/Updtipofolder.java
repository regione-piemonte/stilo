...
import it.eng.auriga.database.store.dmpk_ws.store.impl.UpdtipofolderImpl;
 ...
 */
@Service(name="DmpkWsUpdtipofolder")
public class Updtipofolder {
		
	private DmpkWsUpdtipofolderBean bean;
		  
	public void setBean(DmpkWsUpdtipofolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsUpdtipofolderBean> execute(AurigaLoginBean lLoginBean, DmpkWsUpdtipofolderBean pBean) throws Exception{
	   final UpdtipofolderImpl lUpdtipofolder = new UpdtipofolderImpl();
	   setBean(pBean);
	   lUpdtipofolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUpdtipofolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsUpdtipofolderBean> result = new StoreResultBean<DmpkWsUpdtipofolderBean>();
