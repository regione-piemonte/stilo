...
public class GetvarcacheflussonavImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.GETVARCACHEFLUSSONAV(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"valoreout",5,Types.VARCHAR); 
