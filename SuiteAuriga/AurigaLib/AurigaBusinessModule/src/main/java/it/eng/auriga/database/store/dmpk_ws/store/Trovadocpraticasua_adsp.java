...
import it.eng.auriga.database.store.dmpk_ws.store.impl.Trovadocpraticasua_adspImpl;
 ...
 */
@Service(name="DmpkWsTrovadocpraticasua_adsp")
public class Trovadocpraticasua_adsp {
		
	private DmpkWsTrovadocpraticasua_adspBean bean;
		  
	public void setBean(DmpkWsTrovadocpraticasua_adspBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsTrovadocpraticasua_adspBean> execute(AurigaLoginBean lLoginBean, DmpkWsTrovadocpraticasua_adspBean pBean) throws Exception{
	   final Trovadocpraticasua_adspImpl lTrovadocpraticasua_adsp = new Trovadocpraticasua_adspImpl();
	   setBean(pBean);
	   lTrovadocpraticasua_adsp.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadocpraticasua_adsp.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsTrovadocpraticasua_adspBean> result = new StoreResultBean<DmpkWsTrovadocpraticasua_adspBean>();
