...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.IugruppoprivilegiImpl;
 ...
 */
@Service(name="DmpkDefSecurityIugruppoprivilegi")
public class Iugruppoprivilegi {
	...
	public StoreResultBean<DmpkDefSecurityIugruppoprivilegiBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityIugruppoprivilegiBean pBean) throws Exception{
	   final IugruppoprivilegiImpl lIugruppoprivilegi = new IugruppoprivilegiImpl();
	   setBean(pBean);
	   lIugruppoprivilegi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIugruppoprivilegi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityIugruppoprivilegiBean> result = new StoreResultBean<DmpkDefSecurityIugruppoprivilegiBean>();
