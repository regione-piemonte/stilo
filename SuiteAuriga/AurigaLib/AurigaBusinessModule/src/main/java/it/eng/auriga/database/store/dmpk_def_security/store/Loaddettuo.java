...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettuoImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettuo")
public class Loaddettuo {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettuoBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettuoBean pBean) throws Exception{
	   final LoaddettuoImpl lLoaddettuo = new LoaddettuoImpl();
	   setBean(pBean);
	   lLoaddettuo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettuo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettuoBean> result = new StoreResultBean<DmpkDefSecurityLoaddettuoBean>();
