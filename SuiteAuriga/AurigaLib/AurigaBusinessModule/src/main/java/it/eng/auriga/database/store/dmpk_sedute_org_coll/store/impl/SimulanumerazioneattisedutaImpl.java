...
public class SimulanumerazioneattisedutaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_SEDUTE_ORG_COLL.SIMULANUMERAZIONEATTISEDUTA(?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"argomentiodgio",5,Types.CLOB,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"argomentiodgio",5,Types.CLOB); 
