...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.LoadattrdinamiciImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciLoadattrdinamici")
public class Loadattrdinamici {
	...
	public StoreResultBean<DmpkAttributiDinamiciLoadattrdinamiciBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciLoadattrdinamiciBean pBean) throws Exception{
	   final LoadattrdinamiciImpl lLoadattrdinamici = new LoadattrdinamiciImpl();
	   setBean(pBean);
	   lLoadattrdinamici.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadattrdinamici.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciLoadattrdinamiciBean> result = new StoreResultBean<DmpkAttributiDinamiciLoadattrdinamiciBean>();
