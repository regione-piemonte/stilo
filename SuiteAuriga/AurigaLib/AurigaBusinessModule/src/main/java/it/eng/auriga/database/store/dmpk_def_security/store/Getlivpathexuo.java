...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.GetlivpathexuoImpl;
 ...
 */
@Service(name="DmpkDefSecurityGetlivpathexuo")
public class Getlivpathexuo {
	...
	public StoreResultBean<DmpkDefSecurityGetlivpathexuoBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityGetlivpathexuoBean pBean) throws Exception{
	   final GetlivpathexuoImpl lGetlivpathexuo = new GetlivpathexuoImpl();
	   setBean(pBean);
	   lGetlivpathexuo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetlivpathexuo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityGetlivpathexuoBean> result = new StoreResultBean<DmpkDefSecurityGetlivpathexuoBean>();
