...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.TrovasoggettiImpl;
 ...
 */
@Service(name="DmpkAnagraficaTrovasoggetti")
public class Trovasoggetti {
	...
	public StoreResultBean<DmpkAnagraficaTrovasoggettiBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaTrovasoggettiBean pBean) throws Exception{
	   final TrovasoggettiImpl lTrovasoggetti = new TrovasoggettiImpl();
	   setBean(pBean);
	   lTrovasoggetti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovasoggetti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaTrovasoggettiBean> result = new StoreResultBean<DmpkAnagraficaTrovasoggettiBean>();
