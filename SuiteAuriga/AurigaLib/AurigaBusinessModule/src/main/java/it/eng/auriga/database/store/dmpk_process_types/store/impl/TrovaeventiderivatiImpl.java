...
public class TrovaeventiderivatiImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESS_TYPES.TROVAEVENTIDERIVATI(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"ideventtypein",4,Types.DECIMAL,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"deseventtypeout",6,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"nomeprocesstypeout",7,Types.VARCHAR); 
