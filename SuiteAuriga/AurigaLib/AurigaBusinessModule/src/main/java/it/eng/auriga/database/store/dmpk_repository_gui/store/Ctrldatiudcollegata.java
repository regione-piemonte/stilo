...
import it.eng.auriga.database.store.dmpk_repository_gui.bean.DmpkRepositoryGuiCtrldatiudcollegataBean;
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.CtrldatiudcollegataImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiCtrldatiudcollegata")
public class Ctrldatiudcollegata {
		
	private DmpkRepositoryGuiCtrldatiudcollegataBean bean;
		  
	public void setBean(DmpkRepositoryGuiCtrldatiudcollegataBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiCtrldatiudcollegataBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiCtrldatiudcollegataBean pBean) throws Exception{
	   final CtrldatiudcollegataImpl lCtrldatiudcollegata = new CtrldatiudcollegataImpl();
	   setBean(pBean);
	   lCtrldatiudcollegata.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCtrldatiudcollegata.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiCtrldatiudcollegataBean> result = new StoreResultBean<DmpkRepositoryGuiCtrldatiudcollegataBean>();
