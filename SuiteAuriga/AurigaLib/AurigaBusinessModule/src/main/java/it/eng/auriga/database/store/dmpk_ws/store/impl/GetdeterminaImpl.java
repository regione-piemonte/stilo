...
public class GetdeterminaImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_WS.GETDETERMINA(?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"xmlrequestin",3,Types.CLOB,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlresponseout",4,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"listafileout",5,Types.CLOB); 
