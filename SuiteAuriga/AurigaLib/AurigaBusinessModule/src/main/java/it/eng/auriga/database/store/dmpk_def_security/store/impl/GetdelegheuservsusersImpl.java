...
public class GetdelegheuservsusersImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DEF_SECURITY.GETDELEGHEUSERVSUSERS(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmldelegheout",7,Types.CLOB); 
