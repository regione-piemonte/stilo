...
public class DsoggettoesternoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESSES.DSOGGETTOESTERNO(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"idsoggesternoin",5,Types.DECIMAL,connection); 	
