...
import it.eng.auriga.database.store.dmpk_utility.store.impl.FinddictionaryvalueImpl;
 ...
 */
@Service(name="DmpkUtilityFinddictionaryvalue")
public class Finddictionaryvalue {
	...
	public StoreResultBean<DmpkUtilityFinddictionaryvalueBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityFinddictionaryvalueBean pBean) throws Exception{
	   final FinddictionaryvalueImpl lFinddictionaryvalue = new FinddictionaryvalueImpl();
	   setBean(pBean);
	   lFinddictionaryvalue.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lFinddictionaryvalue.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityFinddictionaryvalueBean> result = new StoreResultBean<DmpkUtilityFinddictionaryvalueBean>();
