...
public class Adddoc {
	...
	public StoreResultBean<DmpkCoreAdddocBean> execute(AurigaLoginBean lLoginBean, DmpkCoreAdddocBean pBean) throws Exception{
	   final AdddocImpl lAdddoc = new AdddocImpl();
	   setBean(pBean);
	   lAdddoc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
