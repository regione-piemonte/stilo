...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.TrovaattributidefinitiImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciTrovaattributidefiniti")
public class Trovaattributidefiniti {
	...
	public StoreResultBean<DmpkAttributiDinamiciTrovaattributidefinitiBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciTrovaattributidefinitiBean pBean) throws Exception{
	   final TrovaattributidefinitiImpl lTrovaattributidefiniti = new TrovaattributidefinitiImpl();
	   setBean(pBean);
	   lTrovaattributidefiniti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaattributidefiniti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciTrovaattributidefinitiBean> result = new StoreResultBean<DmpkAttributiDinamiciTrovaattributidefinitiBean>();
