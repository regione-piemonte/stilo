...
import it.eng.auriga.database.store.dmpk_ws.store.impl.LeggiestremixidentificazioneudImpl;
 ...
 */
@Service(name="DmpkWsLeggiestremixidentificazioneud")
public class Leggiestremixidentificazioneud {
		
	private DmpkWsLeggiestremixidentificazioneudBean bean;
		  
	public void setBean(DmpkWsLeggiestremixidentificazioneudBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsLeggiestremixidentificazioneudBean> execute(AurigaLoginBean lLoginBean, DmpkWsLeggiestremixidentificazioneudBean pBean) throws Exception{
	   final LeggiestremixidentificazioneudImpl lLeggiestremixidentificazioneud = new LeggiestremixidentificazioneudImpl();
	   setBean(pBean);
	   lLeggiestremixidentificazioneud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLeggiestremixidentificazioneud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsLeggiestremixidentificazioneudBean> result = new StoreResultBean<DmpkWsLeggiestremixidentificazioneudBean>();
