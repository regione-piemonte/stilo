...
import it.eng.auriga.database.store.dmpk_core.store.impl.GetprofiloworkspacexcontainerImpl;
 ...
 */
@Service(name="DmpkCoreGetprofiloworkspacexcontainer")
public class Getprofiloworkspacexcontainer {
	...
	public StoreResultBean<DmpkCoreGetprofiloworkspacexcontainerBean> execute(AurigaLoginBean lLoginBean, DmpkCoreGetprofiloworkspacexcontainerBean pBean) throws Exception{
	   final GetprofiloworkspacexcontainerImpl lGetprofiloworkspacexcontainer = new GetprofiloworkspacexcontainerImpl();
	   setBean(pBean);
	   lGetprofiloworkspacexcontainer.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetprofiloworkspacexcontainer.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreGetprofiloworkspacexcontainerBean> result = new StoreResultBean<DmpkCoreGetprofiloworkspacexcontainerBean>();
