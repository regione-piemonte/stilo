...
import it.eng.auriga.database.store.dmpk_wf.store.impl.TrovaattfasecorrflussoImpl;
 ...
 */
@Service(name="DmpkWfTrovaattfasecorrflusso")
public class Trovaattfasecorrflusso {
	...
	public StoreResultBean<DmpkWfTrovaattfasecorrflussoBean> execute(AurigaLoginBean lLoginBean, DmpkWfTrovaattfasecorrflussoBean pBean) throws Exception{
	   final TrovaattfasecorrflussoImpl lTrovaattfasecorrflusso = new TrovaattfasecorrflussoImpl();
	   setBean(pBean);
	   lTrovaattfasecorrflusso.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaattfasecorrflusso.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfTrovaattfasecorrflussoBean> result = new StoreResultBean<DmpkWfTrovaattfasecorrflussoBean>();
