...
import it.eng.auriga.database.store.dmpk_core.store.impl.SetregnumudImpl;
 ...
 */
@Service(name="DmpkCoreSetregnumud")
public class Setregnumud {
		
	private DmpkCoreSetregnumudBean bean;
		  
	public void setBean(DmpkCoreSetregnumudBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreSetregnumudBean> execute(AurigaLoginBean lLoginBean, DmpkCoreSetregnumudBean pBean) throws Exception{
	   final SetregnumudImpl lSetregnumud = new SetregnumudImpl();
	   setBean(pBean);
	   lSetregnumud.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lSetregnumud.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreSetregnumudBean> result = new StoreResultBean<DmpkCoreSetregnumudBean>();
