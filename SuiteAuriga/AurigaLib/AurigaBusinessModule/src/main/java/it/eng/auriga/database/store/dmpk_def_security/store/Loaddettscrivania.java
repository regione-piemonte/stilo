...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettscrivaniaImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettscrivania")
public class Loaddettscrivania {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettscrivaniaBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettscrivaniaBean pBean) throws Exception{
	   final LoaddettscrivaniaImpl lLoaddettscrivania = new LoaddettscrivaniaImpl();
	   setBean(pBean);
	   lLoaddettscrivania.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettscrivania.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettscrivaniaBean> result = new StoreResultBean<DmpkDefSecurityLoaddettscrivaniaBean>();
