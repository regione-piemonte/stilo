...
public class Testabiluo_modtoponImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_TOPONOMASTICA.TESTABILUO_MODTOPON(?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"ciidspaooin",2,Types.DECIMAL,connection); 	
