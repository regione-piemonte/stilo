...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.bean.DmpkAttributiDinamiciDattrdinamicoentitaBean;
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.DattrdinamicoentitaImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciDattrdinamicoentita")
public class Dattrdinamicoentita {
		
	private DmpkAttributiDinamiciDattrdinamicoentitaBean bean;
		  
	public void setBean(DmpkAttributiDinamiciDattrdinamicoentitaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkAttributiDinamiciDattrdinamicoentitaBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciDattrdinamicoentitaBean pBean) throws Exception{
	   final DattrdinamicoentitaImpl lDattrdinamicoentita = new DattrdinamicoentitaImpl();
	   setBean(pBean);
	   lDattrdinamicoentita.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lDattrdinamicoentita.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciDattrdinamicoentitaBean> result = new StoreResultBean<DmpkAttributiDinamiciDattrdinamicoentitaBean>();
