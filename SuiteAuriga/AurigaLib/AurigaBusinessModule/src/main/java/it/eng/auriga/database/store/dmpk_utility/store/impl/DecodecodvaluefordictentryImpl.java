...
public class DecodecodvaluefordictentryImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.DECODECODVALUEFORDICTENTRY(?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"codicein",5,Types.VARCHAR,connection); 	
