...
import it.eng.auriga.database.store.dmpk_gae.bean.DmpkGaeIupdvtipoBean;
import it.eng.auriga.database.store.dmpk_gae.store.impl.IupdvtipoImpl;
 ...
 */
@Service(name="DmpkGaeIupdvtipo")
public class Iupdvtipo {
		
	private DmpkGaeIupdvtipoBean bean;
		  
	public void setBean(DmpkGaeIupdvtipoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkGaeIupdvtipoBean> execute(AurigaLoginBean lLoginBean, DmpkGaeIupdvtipoBean pBean) throws Exception{
	   final IupdvtipoImpl lIupdvtipo = new IupdvtipoImpl();
	   setBean(pBean);
	   lIupdvtipo.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIupdvtipo.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkGaeIupdvtipoBean> result = new StoreResultBean<DmpkGaeIupdvtipoBean>();
