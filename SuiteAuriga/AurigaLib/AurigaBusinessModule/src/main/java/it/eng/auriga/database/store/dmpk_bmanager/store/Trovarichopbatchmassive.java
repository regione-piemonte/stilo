...
import it.eng.auriga.database.store.dmpk_bmanager.store.impl.TrovarichopbatchmassiveImpl;
 ...
 */
@Service(name="DmpkBmanagerTrovarichopbatchmassive")
public class Trovarichopbatchmassive {
		
	private DmpkBmanagerTrovarichopbatchmassiveBean bean;
		  
	public void setBean(DmpkBmanagerTrovarichopbatchmassiveBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkBmanagerTrovarichopbatchmassiveBean> execute(AurigaLoginBean lLoginBean, DmpkBmanagerTrovarichopbatchmassiveBean pBean) throws Exception{
	   final TrovarichopbatchmassiveImpl lTrovarichopbatchmassive = new TrovarichopbatchmassiveImpl();
	   setBean(pBean);
	   lTrovarichopbatchmassive.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovarichopbatchmassive.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkBmanagerTrovarichopbatchmassiveBean> result = new StoreResultBean<DmpkBmanagerTrovarichopbatchmassiveBean>();
