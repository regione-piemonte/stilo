 ...
 */
@Service(name="DmpkCollaborationInvio")
public class Invio {
	...
	public StoreResultBean<DmpkCollaborationInvioBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationInvioBean pBean) throws Exception{
	   final InvioImpl lInvio = new InvioImpl();
	   setBean(pBean);
	   lInvio.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lInvio.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCollaborationInvioBean> result = new StoreResultBean<DmpkCollaborationInvioBean>();
