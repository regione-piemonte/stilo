...
import it.eng.auriga.database.store.dmpk_core.store.impl.DelfolderImpl;
 ...
 */
@Service(name="DmpkCoreDelfolder")
public class Delfolder {
	...
	public StoreResultBean<DmpkCoreDelfolderBean> execute(AurigaLoginBean lLoginBean, DmpkCoreDelfolderBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreDelfolderBean> result = new StoreResultBean<DmpkCoreDelfolderBean>();
