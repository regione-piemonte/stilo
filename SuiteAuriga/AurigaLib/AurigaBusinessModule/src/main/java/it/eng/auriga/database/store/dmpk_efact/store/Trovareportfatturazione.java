...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturazioneBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturazioneImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturazione")
public class Trovareportfatturazione {
		
	private DmpkEfactTrovareportfatturazioneBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturazioneBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturazioneBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturazioneBean pBean) throws Exception{
	   final TrovareportfatturazioneImpl lTrovareportfatturazione = new TrovareportfatturazioneImpl();
	   setBean(pBean);
	   lTrovareportfatturazione.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturazione.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturazioneBean> result = new StoreResultBean<DmpkEfactTrovareportfatturazioneBean>();
