...
import it.eng.auriga.database.store.dmpk_efact.bean.DmpkEfactTrovareportfatturazmailpdfBean;
import it.eng.auriga.database.store.dmpk_efact.store.impl.TrovareportfatturazmailpdfImpl;
 ...
 */
@Service(name="DmpkEfactTrovareportfatturazmailpdf")
public class Trovareportfatturazmailpdf {
		
	private DmpkEfactTrovareportfatturazmailpdfBean bean;
		  
	public void setBean(DmpkEfactTrovareportfatturazmailpdfBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkEfactTrovareportfatturazmailpdfBean> execute(AurigaLoginBean lLoginBean, DmpkEfactTrovareportfatturazmailpdfBean pBean) throws Exception{
	   final TrovareportfatturazmailpdfImpl lTrovareportfatturazmailpdf = new TrovareportfatturazmailpdfImpl();
	   setBean(pBean);
	   lTrovareportfatturazmailpdf.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovareportfatturazmailpdf.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkEfactTrovareportfatturazmailpdfBean> result = new StoreResultBean<DmpkEfactTrovareportfatturazmailpdfBean>();
