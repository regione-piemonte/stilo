...
import it.eng.auriga.database.store.dmpk_ws.store.impl.AddupdprivilegiImpl;
 ...
 */
@Service(name="DmpkWsAddupdprivilegi")
public class Addupdprivilegi {
		
	private DmpkWsAddupdprivilegiBean bean;
		  
	public void setBean(DmpkWsAddupdprivilegiBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsAddupdprivilegiBean> execute(AurigaLoginBean lLoginBean, DmpkWsAddupdprivilegiBean pBean) throws Exception{
	   final AddupdprivilegiImpl lAddupdprivilegi = new AddupdprivilegiImpl();
	   setBean(pBean);
	   lAddupdprivilegi.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddupdprivilegi.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsAddupdprivilegiBean> result = new StoreResultBean<DmpkWsAddupdprivilegiBean>();
