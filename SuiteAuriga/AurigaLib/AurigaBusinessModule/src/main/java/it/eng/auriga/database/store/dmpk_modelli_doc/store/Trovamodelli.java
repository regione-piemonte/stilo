...
import it.eng.auriga.database.store.dmpk_modelli_doc.store.impl.TrovamodelliImpl;
 ...
 */
@Service(name="DmpkModelliDocTrovamodelli")
public class Trovamodelli {
	...
	public StoreResultBean<DmpkModelliDocTrovamodelliBean> execute(AurigaLoginBean lLoginBean, DmpkModelliDocTrovamodelliBean pBean) throws Exception{
	   final TrovamodelliImpl lTrovamodelli = new TrovamodelliImpl();
	   setBean(pBean);
	   lTrovamodelli.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovamodelli.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkModelliDocTrovamodelliBean> result = new StoreResultBean<DmpkModelliDocTrovamodelliBean>();
