...
package it.eng.auriga.database.store.dmpk_repository_gui.store;

import it.eng.auriga.database.store.dmpk_repository_gui.bean.DmpkRepositoryGuiCtrldatifoldercollegatoBean;
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.CtrldatifoldercollegatoImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiCtrldatifoldercollegato")
public class Ctrldatifoldercollegato {
		
	private DmpkRepositoryGuiCtrldatifoldercollegatoBean bean;
		  
	public void setBean(DmpkRepositoryGuiCtrldatifoldercollegatoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiCtrldatifoldercollegatoBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiCtrldatifoldercollegatoBean pBean) throws Exception{
	   final CtrldatifoldercollegatoImpl lCtrldatifoldercollegato = new CtrldatifoldercollegatoImpl();
	   setBean(pBean);
	   lCtrldatifoldercollegato.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCtrldatifoldercollegato.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiCtrldatifoldercollegatoBean> result = new StoreResultBean<DmpkRepositoryGuiCtrldatifoldercollegatoBean>();
