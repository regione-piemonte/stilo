...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreCheckpathxaddricorsivaBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.CheckpathxaddricorsivaImpl;
 ...
 */
@Service(name="DmpkCoreCheckpathxaddricorsiva")
public class Checkpathxaddricorsiva {
		
	private DmpkCoreCheckpathxaddricorsivaBean bean;
		  
	public void setBean(DmpkCoreCheckpathxaddricorsivaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreCheckpathxaddricorsivaBean> execute(AurigaLoginBean lLoginBean, DmpkCoreCheckpathxaddricorsivaBean pBean) throws Exception{
	   final CheckpathxaddricorsivaImpl lCheckpathxaddricorsiva = new CheckpathxaddricorsivaImpl();
	   setBean(pBean);
	   lCheckpathxaddricorsiva.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCheckpathxaddricorsiva.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreCheckpathxaddricorsivaBean> result = new StoreResultBean<DmpkCoreCheckpathxaddricorsivaBean>();
