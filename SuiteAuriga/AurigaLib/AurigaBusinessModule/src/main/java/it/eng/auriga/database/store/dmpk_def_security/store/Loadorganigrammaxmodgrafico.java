...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoadorganigrammaxmodgraficoImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoadorganigrammaxmodgrafico")
public class Loadorganigrammaxmodgrafico {
		
	private DmpkDefSecurityLoadorganigrammaxmodgraficoBean bean;
		  
	public void setBean(DmpkDefSecurityLoadorganigrammaxmodgraficoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityLoadorganigrammaxmodgraficoBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoadorganigrammaxmodgraficoBean pBean) throws Exception{
	   final LoadorganigrammaxmodgraficoImpl lLoadorganigrammaxmodgrafico = new LoadorganigrammaxmodgraficoImpl();
	   setBean(pBean);
	   lLoadorganigrammaxmodgrafico.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadorganigrammaxmodgrafico.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoadorganigrammaxmodgraficoBean> result = new StoreResultBean<DmpkDefSecurityLoadorganigrammaxmodgraficoBean>();
