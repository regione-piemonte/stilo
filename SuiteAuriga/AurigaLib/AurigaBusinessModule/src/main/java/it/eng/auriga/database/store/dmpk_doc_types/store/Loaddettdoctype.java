...
import it.eng.auriga.database.store.dmpk_doc_types.store.impl.LoaddettdoctypeImpl;
 ...
 */
@Service(name="DmpkDocTypesLoaddettdoctype")
public class Loaddettdoctype {
	...
	public StoreResultBean<DmpkDocTypesLoaddettdoctypeBean> execute(AurigaLoginBean lLoginBean, DmpkDocTypesLoaddettdoctypeBean pBean) throws Exception{
	   final LoaddettdoctypeImpl lLoaddettdoctype = new LoaddettdoctypeImpl();
	   setBean(pBean);
	   lLoaddettdoctype.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettdoctype.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDocTypesLoaddettdoctypeBean> result = new StoreResultBean<DmpkDocTypesLoaddettdoctypeBean>();
