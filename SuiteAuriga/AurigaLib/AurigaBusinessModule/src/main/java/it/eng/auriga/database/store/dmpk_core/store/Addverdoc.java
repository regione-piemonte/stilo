 ...
 */
@Service(name="DmpkCoreAddverdoc")
public class Addverdoc {
		
	private DmpkCoreAddverdocBean bean;
		  
	public void setBean(DmpkCoreAddverdocBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreAddverdocBean> execute(AurigaLoginBean lLoginBean, DmpkCoreAddverdocBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkCoreAddverdocBean> result = new StoreResultBean<DmpkCoreAddverdocBean>();
