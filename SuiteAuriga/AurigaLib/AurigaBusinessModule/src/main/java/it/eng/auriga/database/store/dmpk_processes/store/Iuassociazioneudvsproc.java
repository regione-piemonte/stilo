 ...
 */
@Service(name="DmpkProcessesIuassociazioneudvsproc")
public class Iuassociazioneudvsproc {
	...
	public StoreResultBean<DmpkProcessesIuassociazioneudvsprocBean> execute(AurigaLoginBean lLoginBean, DmpkProcessesIuassociazioneudvsprocBean pBean) throws Exception{
	   final IuassociazioneudvsprocImpl lIuassociazioneudvsproc = new IuassociazioneudvsprocImpl();
	   setBean(pBean);
	   lIuassociazioneudvsproc.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuassociazioneudvsproc.execute(paramConnection);
				}
			});
