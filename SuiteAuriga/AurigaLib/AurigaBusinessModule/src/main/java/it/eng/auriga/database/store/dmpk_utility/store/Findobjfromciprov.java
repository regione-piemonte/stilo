...
import it.eng.auriga.database.store.dmpk_utility.store.impl.FindobjfromciprovImpl;
 ...
 */
@Service(name="DmpkUtilityFindobjfromciprov")
public class Findobjfromciprov {
	...
	public StoreResultBean<DmpkUtilityFindobjfromciprovBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityFindobjfromciprovBean pBean) throws Exception{
	   final FindobjfromciprovImpl lFindobjfromciprov = new FindobjfromciprovImpl();
	   setBean(pBean);
	   lFindobjfromciprov.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lFindobjfromciprov.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityFindobjfromciprovBean> result = new StoreResultBean<DmpkUtilityFindobjfromciprovBean>();
