...
import it.eng.auriga.database.store.dmpk_core.store.impl.UnlockfolderImpl;
 ...
 */
@Service(name="DmpkCoreUnlockfolder")
public class Unlockfolder {
		
	private DmpkCoreUnlockfolderBean bean;
		  
	public void setBean(DmpkCoreUnlockfolderBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreUnlockfolderBean> execute(AurigaLoginBean lLoginBean, DmpkCoreUnlockfolderBean pBean) throws Exception{
	   final UnlockfolderImpl lUnlockfolder = new UnlockfolderImpl();
	   setBean(pBean);
	   lUnlockfolder.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUnlockfolder.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreUnlockfolderBean> result = new StoreResultBean<DmpkCoreUnlockfolderBean>();
