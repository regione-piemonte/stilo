...
import it.eng.auriga.database.store.dmpk_sedute_org_coll.store.impl.GetfileargsedutaxdownloadImpl;
 ...
 */
@Service(name="DmpkSeduteOrgCollGetfileargsedutaxdownload")
public class Getfileargsedutaxdownload {
	...
	public StoreResultBean<DmpkSeduteOrgCollGetfileargsedutaxdownloadBean> execute(AurigaLoginBean lLoginBean, DmpkSeduteOrgCollGetfileargsedutaxdownloadBean pBean) throws Exception{
	   final GetfileargsedutaxdownloadImpl lGetfileargsedutaxdownload = new GetfileargsedutaxdownloadImpl();
	   setBean(pBean);
	   lGetfileargsedutaxdownload.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetfileargsedutaxdownload.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkSeduteOrgCollGetfileargsedutaxdownloadBean> result = new StoreResultBean<DmpkSeduteOrgCollGetfileargsedutaxdownloadBean>();
