...
import it.eng.auriga.database.store.dmpk_wf.store.impl.TrovaflussiwftypesImpl;
 ...
 */
@Service(name="DmpkWfTrovaflussiwftypes")
public class Trovaflussiwftypes {
	...
	public StoreResultBean<DmpkWfTrovaflussiwftypesBean> execute(AurigaLoginBean lLoginBean, DmpkWfTrovaflussiwftypesBean pBean) throws Exception{
	   final TrovaflussiwftypesImpl lTrovaflussiwftypes = new TrovaflussiwftypesImpl();
	   setBean(pBean);
	   lTrovaflussiwftypes.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaflussiwftypes.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfTrovaflussiwftypesBean> result = new StoreResultBean<DmpkWfTrovaflussiwftypesBean>();
