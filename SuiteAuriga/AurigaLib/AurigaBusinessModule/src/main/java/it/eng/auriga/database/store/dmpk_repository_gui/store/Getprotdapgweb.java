...
import it.eng.auriga.database.store.dmpk_repository_gui.store.impl.GetprotdapgwebImpl;
 ...
 */
@Service(name="DmpkRepositoryGuiGetprotdapgweb")
public class Getprotdapgweb {
		
	private DmpkRepositoryGuiGetprotdapgwebBean bean;
		  
	public void setBean(DmpkRepositoryGuiGetprotdapgwebBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkRepositoryGuiGetprotdapgwebBean> execute(AurigaLoginBean lLoginBean, DmpkRepositoryGuiGetprotdapgwebBean pBean) throws Exception{
	   final GetprotdapgwebImpl lGetprotdapgweb = new GetprotdapgwebImpl();
	   setBean(pBean);
	   lGetprotdapgweb.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetprotdapgweb.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkRepositoryGuiGetprotdapgwebBean> result = new StoreResultBean<DmpkRepositoryGuiGetprotdapgwebBean>();
