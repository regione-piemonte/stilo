...
import it.eng.auriga.database.store.dmpk_core.store.impl.AddtofavouritesImpl;
 ...
 */
@Service(name="DmpkCoreAddtofavourites")
public class Addtofavourites {
		
	private DmpkCoreAddtofavouritesBean bean;
		  
	public void setBean(DmpkCoreAddtofavouritesBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreAddtofavouritesBean> execute(AurigaLoginBean lLoginBean, DmpkCoreAddtofavouritesBean pBean) throws Exception{
	   final AddtofavouritesImpl lAddtofavourites = new AddtofavouritesImpl();
	   setBean(pBean);
	   lAddtofavourites.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAddtofavourites.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreAddtofavouritesBean> result = new StoreResultBean<DmpkCoreAddtofavouritesBean>();
