...
public class SetvarcacheflussonavImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_UTILITY.SETVARCACHEFLUSSONAV(?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"valorein",5,Types.VARCHAR,connection); 	
