...
import it.eng.auriga.database.store.dmpk_wf.store.impl.TrovaattflussowfImpl;
 ...
 */
@Service(name="DmpkWfTrovaattflussowf")
public class Trovaattflussowf {
	...
	public StoreResultBean<DmpkWfTrovaattflussowfBean> execute(AurigaLoginBean lLoginBean, DmpkWfTrovaattflussowfBean pBean) throws Exception{
	   final TrovaattflussowfImpl lTrovaattflussowf = new TrovaattflussowfImpl();
	   setBean(pBean);
	   lTrovaattflussowf.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaattflussowf.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWfTrovaattflussowfBean> result = new StoreResultBean<DmpkWfTrovaattflussowfBean>();
