...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.IuindluogosoggImpl;
 ...
 */
@Service(name="DmpkAnagraficaIuindluogosogg")
public class Iuindluogosogg {
	...
	public StoreResultBean<DmpkAnagraficaIuindluogosoggBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaIuindluogosoggBean pBean) throws Exception{
	   final IuindluogosoggImpl lIuindluogosogg = new IuindluogosoggImpl();
	   setBean(pBean);
	   lIuindluogosogg.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuindluogosogg.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaIuindluogosoggBean> result = new StoreResultBean<DmpkAnagraficaIuindluogosoggBean>();
