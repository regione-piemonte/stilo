...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.PreparainvioricevutaregxemailImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailPreparainvioricevutaregxemail")
public class Preparainvioricevutaregxemail {
		
	private DmpkIntMgoEmailPreparainvioricevutaregxemailBean bean;
		  
	public void setBean(DmpkIntMgoEmailPreparainvioricevutaregxemailBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailPreparainvioricevutaregxemailBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailPreparainvioricevutaregxemailBean pBean) throws Exception{
	   final PreparainvioricevutaregxemailImpl lPreparainvioricevutaregxemail = new PreparainvioricevutaregxemailImpl();
	   setBean(pBean);
	   lPreparainvioricevutaregxemail.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lPreparainvioricevutaregxemail.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailPreparainvioricevutaregxemailBean> result = new StoreResultBean<DmpkIntMgoEmailPreparainvioricevutaregxemailBean>();
