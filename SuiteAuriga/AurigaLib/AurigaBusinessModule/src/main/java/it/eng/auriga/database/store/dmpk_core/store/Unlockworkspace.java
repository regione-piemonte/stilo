...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreUnlockworkspaceBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.UnlockworkspaceImpl;
 ...
 */
@Service(name="DmpkCoreUnlockworkspace")
public class Unlockworkspace {
		
	private DmpkCoreUnlockworkspaceBean bean;
		  
	public void setBean(DmpkCoreUnlockworkspaceBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreUnlockworkspaceBean> execute(AurigaLoginBean lLoginBean, DmpkCoreUnlockworkspaceBean pBean) throws Exception{
	   final UnlockworkspaceImpl lUnlockworkspace = new UnlockworkspaceImpl();
	   setBean(pBean);
	   lUnlockworkspace.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lUnlockworkspace.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreUnlockworkspaceBean> result = new StoreResultBean<DmpkCoreUnlockworkspaceBean>();
