...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TrovaapplicazioneesternaImpl;
 ...
 */
@Service(name="DmpkDefSecurityTrovaapplicazioneesterna")
public class Trovaapplicazioneesterna {
	...
	public StoreResultBean<DmpkDefSecurityTrovaapplicazioneesternaBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTrovaapplicazioneesternaBean pBean) throws Exception{
	   final TrovaapplicazioneesternaImpl lTrovaapplicazioneesterna = new TrovaapplicazioneesternaImpl();
	   setBean(pBean);
	   lTrovaapplicazioneesterna.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovaapplicazioneesterna.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTrovaapplicazioneesternaBean> result = new StoreResultBean<DmpkDefSecurityTrovaapplicazioneesternaBean>();
