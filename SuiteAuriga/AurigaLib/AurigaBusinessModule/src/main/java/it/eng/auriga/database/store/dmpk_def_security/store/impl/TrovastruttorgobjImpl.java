...
public class TrovastruttorgobjImpl  {
		
	private DmpkDefSecurityTrovastruttorgobjBean bean;
		  
	public void setBean(DmpkDefSecurityTrovastruttorgobjBean bean){
		this.bean = bean;
	}
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_DEF_SECURITY.TROVASTRUTTORGOBJ(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"flgobjtypeio",8,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"cercainuoio",9,Types.DECIMAL,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"flgcercainsubuoio",10,Types.INTEGER,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"tsrifin",11,Types.VARCHAR,connection); 	
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"tyobjxfinalitain",32,Types.VARCHAR,connection); 	
			util.settingParameterOnStore(call,bean,wrapperBean,"idobjxfinalitain",33,Types.VARCHAR,connection); 	
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"flgobjtypeio",8,Types.VARCHAR); 
			util.settinParameterOnBean(call,bean,wrapperBean,"cercainuoio",9,Types.DECIMAL); 
			util.settinParameterOnBean(call,bean,wrapperBean,"flgcercainsubuoio",10,Types.INTEGER); 
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"percorsoricercaxmlout",26,Types.CLOB); 
			util.settinParameterOnBean(call,bean,wrapperBean,"dettaglicercainuoout",27,Types.CLOB); 
