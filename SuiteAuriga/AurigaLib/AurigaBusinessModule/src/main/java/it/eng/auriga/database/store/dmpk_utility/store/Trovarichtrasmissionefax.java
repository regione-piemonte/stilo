...
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovarichtrasmissionefaxImpl;
 ...
 */
@Service(name="DmpkUtilityTrovarichtrasmissionefax")
public class Trovarichtrasmissionefax {
	...
	public StoreResultBean<DmpkUtilityTrovarichtrasmissionefaxBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovarichtrasmissionefaxBean pBean) throws Exception{
	   ...
	   Session session = null;
		try {
			...
			StoreResultBean<DmpkUtilityTrovarichtrasmissionefaxBean> result = new StoreResultBean<DmpkUtilityTrovarichtrasmissionefaxBean>();
