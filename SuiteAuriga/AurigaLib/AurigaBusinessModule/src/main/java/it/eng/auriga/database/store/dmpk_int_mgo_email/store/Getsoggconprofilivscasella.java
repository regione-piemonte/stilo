...
import it.eng.auriga.database.store.dmpk_int_mgo_email.store.impl.GetsoggconprofilivscasellaImpl;
 ...
 */
@Service(name="DmpkIntMgoEmailGetsoggconprofilivscasella")
public class Getsoggconprofilivscasella {
		
	private DmpkIntMgoEmailGetsoggconprofilivscasellaBean bean;
		  
	public void setBean(DmpkIntMgoEmailGetsoggconprofilivscasellaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkIntMgoEmailGetsoggconprofilivscasellaBean> execute(AurigaLoginBean lLoginBean, DmpkIntMgoEmailGetsoggconprofilivscasellaBean pBean) throws Exception{
	   final GetsoggconprofilivscasellaImpl lGetsoggconprofilivscasella = new GetsoggconprofilivscasellaImpl();
	   setBean(pBean);
	   lGetsoggconprofilivscasella.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetsoggconprofilivscasella.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkIntMgoEmailGetsoggconprofilivscasellaBean> result = new StoreResultBean<DmpkIntMgoEmailGetsoggconprofilivscasellaBean>();
