...
public class Trovadocdetaillist_bdbImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_EFACT.TROVADOCDETAILLIST_BDB(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");			
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"filtriin",4,Types.CLOB,connection); 	
			...
			util.settingParameterOnStore(call,bean,wrapperBean,"rigatagnamein",19,Types.VARCHAR,connection); 	
