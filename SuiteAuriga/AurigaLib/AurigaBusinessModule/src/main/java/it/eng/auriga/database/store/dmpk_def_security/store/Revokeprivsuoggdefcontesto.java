...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.RevokeprivsuoggdefcontestoImpl;
 ...
 */
@Service(name="DmpkDefSecurityRevokeprivsuoggdefcontesto")
public class Revokeprivsuoggdefcontesto {
	...
	public StoreResultBean<DmpkDefSecurityRevokeprivsuoggdefcontestoBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityRevokeprivsuoggdefcontestoBean pBean) throws Exception{
	   final RevokeprivsuoggdefcontestoImpl lRevokeprivsuoggdefcontesto = new RevokeprivsuoggdefcontestoImpl();
	   setBean(pBean);
	   lRevokeprivsuoggdefcontesto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRevokeprivsuoggdefcontesto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityRevokeprivsuoggdefcontestoBean> result = new StoreResultBean<DmpkDefSecurityRevokeprivsuoggdefcontestoBean>();
