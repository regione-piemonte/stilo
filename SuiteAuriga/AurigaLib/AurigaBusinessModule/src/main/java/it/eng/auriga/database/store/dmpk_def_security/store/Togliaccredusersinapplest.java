...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.TogliaccredusersinapplestImpl;
 ...
 */
@Service(name="DmpkDefSecurityTogliaccredusersinapplest")
public class Togliaccredusersinapplest {
		
	private DmpkDefSecurityTogliaccredusersinapplestBean bean;
		  
	public void setBean(DmpkDefSecurityTogliaccredusersinapplestBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDefSecurityTogliaccredusersinapplestBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityTogliaccredusersinapplestBean pBean) throws Exception{
	   final TogliaccredusersinapplestImpl lTogliaccredusersinapplest = new TogliaccredusersinapplestImpl();
	   setBean(pBean);
	   lTogliaccredusersinapplest.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTogliaccredusersinapplest.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityTogliaccredusersinapplestBean> result = new StoreResultBean<DmpkDefSecurityTogliaccredusersinapplestBean>();
