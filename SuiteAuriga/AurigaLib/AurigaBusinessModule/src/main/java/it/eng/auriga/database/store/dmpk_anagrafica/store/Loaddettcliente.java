...
import it.eng.auriga.database.store.dmpk_anagrafica.store.impl.LoaddettclienteImpl;
 ...
 */
@Service(name="DmpkAnagraficaLoaddettcliente")
public class Loaddettcliente {
	...
	public StoreResultBean<DmpkAnagraficaLoaddettclienteBean> execute(AurigaLoginBean lLoginBean, DmpkAnagraficaLoaddettclienteBean pBean) throws Exception{
	   final LoaddettclienteImpl lLoaddettcliente = new LoaddettclienteImpl();
	   setBean(pBean);
	   lLoaddettcliente.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettcliente.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAnagraficaLoaddettclienteBean> result = new StoreResultBean<DmpkAnagraficaLoaddettclienteBean>();
