...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.LoaddettapplicazioneesternaImpl;
 ...
 */
@Service(name="DmpkDefSecurityLoaddettapplicazioneesterna")
public class Loaddettapplicazioneesterna {
	...
	public StoreResultBean<DmpkDefSecurityLoaddettapplicazioneesternaBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityLoaddettapplicazioneesternaBean pBean) throws Exception{
	   final LoaddettapplicazioneesternaImpl lLoaddettapplicazioneesterna = new LoaddettapplicazioneesternaImpl();
	   setBean(pBean);
	   lLoaddettapplicazioneesterna.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoaddettapplicazioneesterna.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityLoaddettapplicazioneesternaBean> result = new StoreResultBean<DmpkDefSecurityLoaddettapplicazioneesternaBean>();
