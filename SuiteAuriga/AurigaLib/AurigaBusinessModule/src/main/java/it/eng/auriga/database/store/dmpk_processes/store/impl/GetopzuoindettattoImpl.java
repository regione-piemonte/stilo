...
public class GetopzuoindettattoImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_PROCESSES.GETOPZUOINDETTATTO(?,?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"xmlopzout",5,Types.CLOB); 
