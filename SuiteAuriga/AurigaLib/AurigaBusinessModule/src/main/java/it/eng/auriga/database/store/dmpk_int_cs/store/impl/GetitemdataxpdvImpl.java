...
public class GetitemdataxpdvImpl  {
	...
	public void execute(Connection connection) throws SQLException {
		...
		try{
			...
			call = connection.prepareCall("{? = call DMPK_INT_CS.GETITEMDATAXPDV(?,?,?,?,?,?)}");			
			...
			util.settinParameterOnBean(call,bean,wrapperBean,"itemdataxmlout",4,Types.CLOB); 
