 ...
 */
@Service(name="DmpkWsGetdetermina")
public class Getdetermina {
		
	private DmpkWsGetdeterminaBean bean;
		  
	public void setBean(DmpkWsGetdeterminaBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkWsGetdeterminaBean> execute(AurigaLoginBean lLoginBean, DmpkWsGetdeterminaBean pBean) throws Exception{
	   final GetdeterminaImpl lGetdetermina = new GetdeterminaImpl();
	   setBean(pBean);
	   lGetdetermina.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetdetermina.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkWsGetdeterminaBean> result = new StoreResultBean<DmpkWsGetdeterminaBean>();
