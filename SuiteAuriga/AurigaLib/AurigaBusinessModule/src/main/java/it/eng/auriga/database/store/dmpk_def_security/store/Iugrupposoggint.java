...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.IugrupposoggintImpl;
 ...
 */
@Service(name="DmpkDefSecurityIugrupposoggint")
public class Iugrupposoggint {
	...
	public StoreResultBean<DmpkDefSecurityIugrupposoggintBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityIugrupposoggintBean pBean) throws Exception{
	   final IugrupposoggintImpl lIugrupposoggint = new IugrupposoggintImpl();
	   setBean(pBean);
	   lIugrupposoggint.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIugrupposoggint.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityIugrupposoggintBean> result = new StoreResultBean<DmpkDefSecurityIugrupposoggintBean>();
