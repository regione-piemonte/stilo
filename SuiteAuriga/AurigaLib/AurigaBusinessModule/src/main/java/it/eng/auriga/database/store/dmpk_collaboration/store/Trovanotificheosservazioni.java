...
import it.eng.auriga.database.store.dmpk_collaboration.store.impl.TrovanotificheosservazioniImpl;
 ...
 */
@Service(name="DmpkCollaborationTrovanotificheosservazioni")
public class Trovanotificheosservazioni {
	...
	public StoreResultBean<DmpkCollaborationTrovanotificheosservazioniBean> execute(AurigaLoginBean lLoginBean, DmpkCollaborationTrovanotificheosservazioniBean pBean) throws Exception{
	   final TrovanotificheosservazioniImpl lTrovanotificheosservazioni = new TrovanotificheosservazioniImpl();
	   setBean(pBean);
	   lTrovanotificheosservazioni.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovanotificheosservazioni.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCollaborationTrovanotificheosservazioniBean> result = new StoreResultBean<DmpkCollaborationTrovanotificheosservazioniBean>();
