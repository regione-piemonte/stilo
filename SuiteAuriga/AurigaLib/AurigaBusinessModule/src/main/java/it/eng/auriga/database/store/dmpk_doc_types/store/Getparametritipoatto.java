...
package it.eng.auriga.database.store.dmpk_doc_types.store;

import it.eng.auriga.database.store.dmpk_doc_types.bean.DmpkDocTypesGetparametritipoattoBean;
import it.eng.auriga.database.store.dmpk_doc_types.store.impl.GetparametritipoattoImpl;
 ...
 */
@Service(name="DmpkDocTypesGetparametritipoatto")
public class Getparametritipoatto {
		
	private DmpkDocTypesGetparametritipoattoBean bean;
		  
	public void setBean(DmpkDocTypesGetparametritipoattoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkDocTypesGetparametritipoattoBean> execute(AurigaLoginBean lLoginBean, DmpkDocTypesGetparametritipoattoBean pBean) throws Exception{
	   final GetparametritipoattoImpl lGetparametritipoatto = new GetparametritipoattoImpl();
	   setBean(pBean);
	   lGetparametritipoatto.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lGetparametritipoatto.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDocTypesGetparametritipoattoBean> result = new StoreResultBean<DmpkDocTypesGetparametritipoattoBean>();
