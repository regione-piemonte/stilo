...
import it.eng.auriga.database.store.dmpk_statistiche.store.impl.VerificacampioniattictrlregammImpl;
 ...
 */
@Service(name="DmpkStatisticheVerificacampioniattictrlregamm")
public class Verificacampioniattictrlregamm {
		
	private DmpkStatisticheVerificacampioniattictrlregammBean bean;
		  
	public void setBean(DmpkStatisticheVerificacampioniattictrlregammBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkStatisticheVerificacampioniattictrlregammBean> execute(AurigaLoginBean lLoginBean, DmpkStatisticheVerificacampioniattictrlregammBean pBean) throws Exception{
	   final VerificacampioniattictrlregammImpl lVerificacampioniattictrlregamm = new VerificacampioniattictrlregammImpl();
	   setBean(pBean);
	   lVerificacampioniattictrlregamm.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lVerificacampioniattictrlregamm.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkStatisticheVerificacampioniattictrlregammBean> result = new StoreResultBean<DmpkStatisticheVerificacampioniattictrlregammBean>();
