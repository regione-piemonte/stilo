...
import it.eng.auriga.database.store.dmpk_login.store.impl.LogindaportletImpl;
 ...
 */
@Service(name="DmpkLoginLogindaportlet")
public class Logindaportlet {
	...
	public StoreResultBean<DmpkLoginLogindaportletBean> execute(AurigaLoginBean lLoginBean, DmpkLoginLogindaportletBean pBean) throws Exception{
	   final LogindaportletImpl lLogindaportlet = new LogindaportletImpl();
	   setBean(pBean);
	   lLogindaportlet.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLogindaportlet.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkLoginLogindaportletBean> result = new StoreResultBean<DmpkLoginLogindaportletBean>();
