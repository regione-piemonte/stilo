...
import it.eng.auriga.database.store.dmpk_utility.store.impl.TrovadelutentevsutentiImpl;
 ...
 */
@Service(name="DmpkUtilityTrovadelutentevsutenti")
public class Trovadelutentevsutenti {
	...
	public StoreResultBean<DmpkUtilityTrovadelutentevsutentiBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityTrovadelutentevsutentiBean pBean) throws Exception{
	   final TrovadelutentevsutentiImpl lTrovadelutentevsutenti = new TrovadelutentevsutentiImpl();
	   setBean(pBean);
	   lTrovadelutentevsutenti.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lTrovadelutentevsutenti.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityTrovadelutentevsutentiBean> result = new StoreResultBean<DmpkUtilityTrovadelutentevsutentiBean>();
