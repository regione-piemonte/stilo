...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.CambiopasswordImpl;
 ...
 */
@Service(name="DmpkDefSecurityCambiopassword")
public class Cambiopassword {
	...
	public StoreResultBean<DmpkDefSecurityCambiopasswordBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityCambiopasswordBean pBean) throws Exception{
	   final CambiopasswordImpl lCambiopassword = new CambiopasswordImpl();
	   setBean(pBean);
	   lCambiopassword.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lCambiopassword.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityCambiopasswordBean> result = new StoreResultBean<DmpkDefSecurityCambiopasswordBean>();
