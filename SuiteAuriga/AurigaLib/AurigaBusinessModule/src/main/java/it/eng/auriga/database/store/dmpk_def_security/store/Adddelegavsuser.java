...
import it.eng.auriga.database.store.dmpk_def_security.store.impl.AdddelegavsuserImpl;
 ...
 */
@Service(name="DmpkDefSecurityAdddelegavsuser")
public class Adddelegavsuser {
	...
	public StoreResultBean<DmpkDefSecurityAdddelegavsuserBean> execute(AurigaLoginBean lLoginBean, DmpkDefSecurityAdddelegavsuserBean pBean) throws Exception{
	   final AdddelegavsuserImpl lAdddelegavsuser = new AdddelegavsuserImpl();
	   setBean(pBean);
	   lAdddelegavsuser.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lAdddelegavsuser.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkDefSecurityAdddelegavsuserBean> result = new StoreResultBean<DmpkDefSecurityAdddelegavsuserBean>();
