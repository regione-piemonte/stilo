...
import it.eng.auriga.database.store.dmpk_core.bean.DmpkCoreRecovertosezarealavBean;
import it.eng.auriga.database.store.dmpk_core.store.impl.RecovertosezarealavImpl;
 ...
 */
@Service(name="DmpkCoreRecovertosezarealav")
public class Recovertosezarealav {
		
	private DmpkCoreRecovertosezarealavBean bean;
		  
	public void setBean(DmpkCoreRecovertosezarealavBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkCoreRecovertosezarealavBean> execute(AurigaLoginBean lLoginBean, DmpkCoreRecovertosezarealavBean pBean) throws Exception{
	   final RecovertosezarealavImpl lRecovertosezarealav = new RecovertosezarealavImpl();
	   setBean(pBean);
	   lRecovertosezarealav.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lRecovertosezarealav.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkCoreRecovertosezarealavBean> result = new StoreResultBean<DmpkCoreRecovertosezarealavBean>();
