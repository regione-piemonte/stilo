...
import it.eng.auriga.database.store.dmpk_attributi_dinamici.store.impl.LoadattrdinamicolistaImpl;
 ...
 */
@Service(name="DmpkAttributiDinamiciLoadattrdinamicolista")
public class Loadattrdinamicolista {
	...
	public StoreResultBean<DmpkAttributiDinamiciLoadattrdinamicolistaBean> execute(AurigaLoginBean lLoginBean, DmpkAttributiDinamiciLoadattrdinamicolistaBean pBean) throws Exception{
	   final LoadattrdinamicolistaImpl lLoadattrdinamicolista = new LoadattrdinamicolistaImpl();
	   setBean(pBean);
	   lLoadattrdinamicolista.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lLoadattrdinamicolista.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkAttributiDinamiciLoadattrdinamicolistaBean> result = new StoreResultBean<DmpkAttributiDinamiciLoadattrdinamicolistaBean>();
