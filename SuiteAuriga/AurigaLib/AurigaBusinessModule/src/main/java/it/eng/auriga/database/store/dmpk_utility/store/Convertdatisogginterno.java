...
import it.eng.auriga.database.store.dmpk_utility.bean.DmpkUtilityConvertdatisogginternoBean;
import it.eng.auriga.database.store.dmpk_utility.store.impl.ConvertdatisogginternoImpl;
 ...
 */
@Service(name="DmpkUtilityConvertdatisogginterno")
public class Convertdatisogginterno {
		
	private DmpkUtilityConvertdatisogginternoBean bean;
		  
	public void setBean(DmpkUtilityConvertdatisogginternoBean bean){
		this.bean = bean;
	}
	
	@Operation(name="execute")
	public StoreResultBean<DmpkUtilityConvertdatisogginternoBean> execute(AurigaLoginBean lLoginBean, DmpkUtilityConvertdatisogginternoBean pBean) throws Exception{
	   final ConvertdatisogginternoImpl lConvertdatisogginterno = new ConvertdatisogginternoImpl();
	   setBean(pBean);
	   lConvertdatisogginterno.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lConvertdatisogginterno.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkUtilityConvertdatisogginternoBean> result = new StoreResultBean<DmpkUtilityConvertdatisogginternoBean>();
