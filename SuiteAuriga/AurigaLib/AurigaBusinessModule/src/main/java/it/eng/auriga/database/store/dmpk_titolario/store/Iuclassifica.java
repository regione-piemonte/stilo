...
import it.eng.auriga.database.store.dmpk_titolario.store.impl.IuclassificaImpl;
 ...
 */
@Service(name="DmpkTitolarioIuclassifica")
public class Iuclassifica {
	...
	public StoreResultBean<DmpkTitolarioIuclassificaBean> execute(AurigaLoginBean lLoginBean, DmpkTitolarioIuclassificaBean pBean) throws Exception{
	   final IuclassificaImpl lIuclassifica = new IuclassificaImpl();
	   setBean(pBean);
	   lIuclassifica.setBean(bean);
       setCommit();
       setToken(lLoginBean);
		...
		try {
			...
			session.doWork(new Work() {
				...
				public void execute(Connection paramConnection) throws SQLException {
					...
					lIuclassifica.execute(paramConnection);
				}
			});
			StoreResultBean<DmpkTitolarioIuclassificaBean> result = new StoreResultBean<DmpkTitolarioIuclassificaBean>();
