...
public class StampaCertificazioneBean {
	...
	private List<FirmatarioExtBean> firmatari;
	...
	public List<FirmatarioExtBean> getFirmatari() {
		return firmatari;
	}

	public void setFirmatari(List<FirmatarioExtBean> firmatari) {
	...
	public class FirmatarioExtBean {
