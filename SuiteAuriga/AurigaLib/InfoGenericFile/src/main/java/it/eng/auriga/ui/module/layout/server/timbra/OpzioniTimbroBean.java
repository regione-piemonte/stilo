...
public class OpzioniTimbroBean {
	...
	public void setMoreLines(boolean moreLines) {
	...
	public String getTipoTimbro() {
		return tipoTimbro;
	}

	public void setTipoTimbro(String tipoTimbro) {
		this.tipoTimbro = tipoTimbro;
	}
	...
	public Boolean getFlgVersionePubblicabile() {
