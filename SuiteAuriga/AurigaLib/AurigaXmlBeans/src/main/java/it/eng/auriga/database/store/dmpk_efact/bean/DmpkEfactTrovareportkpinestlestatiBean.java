 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportkpinestlestatiBean")
public class DmpkEfactTrovareportkpinestlestatiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTKPINESTLESTATI";
