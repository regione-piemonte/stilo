 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovasezionaliBean")
public class DmpkEfactTrovasezionaliBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVASEZIONALI";
