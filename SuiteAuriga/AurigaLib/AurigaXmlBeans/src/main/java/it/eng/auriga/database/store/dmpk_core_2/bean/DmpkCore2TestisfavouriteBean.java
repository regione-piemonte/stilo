 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2TestisfavouriteBean")
public class DmpkCore2TestisfavouriteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_TESTISFAVOURITE";
