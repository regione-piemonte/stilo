 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfGetdesfasecorrenteBean")
public class DmpkWfGetdesfasecorrenteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_GETDESFASECORRENTE";
