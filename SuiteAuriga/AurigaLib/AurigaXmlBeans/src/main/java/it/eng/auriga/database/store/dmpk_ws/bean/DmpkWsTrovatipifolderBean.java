 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovatipifolderBean")
public class DmpkWsTrovatipifolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVATIPIFOLDER";
