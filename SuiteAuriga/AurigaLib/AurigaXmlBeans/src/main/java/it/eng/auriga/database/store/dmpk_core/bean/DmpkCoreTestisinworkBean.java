 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTestisinworkBean")
public class DmpkCoreTestisinworkBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TESTISINWORK";
