 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetmaindataverdocBean")
public class DmpkCore2GetmaindataverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETMAINDATAVERDOC";
