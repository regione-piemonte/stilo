 ...
 */
@XmlRootElement
@XmlType(name = "DmoProcessSoggGetlivelliuoBean")
public class DmoProcessSoggGetlivelliuoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_PROCESS_SOGG_GETLIVELLIUO";
