 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetnrolastverdocBean")
public class DmpkCore2GetnrolastverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETNROLASTVERDOC";
