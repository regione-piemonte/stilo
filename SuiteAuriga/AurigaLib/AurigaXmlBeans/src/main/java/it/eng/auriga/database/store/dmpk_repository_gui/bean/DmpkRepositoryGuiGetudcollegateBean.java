 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRepositoryGuiGetudcollegateBean")
public class DmpkRepositoryGuiGetudcollegateBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REPOSITORY_GUI_GETUDCOLLEGATE";
