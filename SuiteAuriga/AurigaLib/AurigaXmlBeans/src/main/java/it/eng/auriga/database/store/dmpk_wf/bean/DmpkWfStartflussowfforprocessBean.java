 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfStartflussowfforprocessBean")
public class DmpkWfStartflussowfforprocessBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_STARTFLUSSOWFFORPROCESS";
