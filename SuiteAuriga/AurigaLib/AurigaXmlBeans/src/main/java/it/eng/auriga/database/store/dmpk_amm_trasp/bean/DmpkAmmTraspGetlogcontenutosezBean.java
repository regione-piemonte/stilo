 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAmmTraspGetlogcontenutosezBean")
public class DmpkAmmTraspGetlogcontenutosezBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_AMM_TRASP_GETLOGCONTENUTOSEZ";
