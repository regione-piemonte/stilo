 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfCtrlexecatt_bysoggBean")
public class DmpkWfCtrlexecatt_bysoggBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_CTRLEXECATT_BYSOGG";
