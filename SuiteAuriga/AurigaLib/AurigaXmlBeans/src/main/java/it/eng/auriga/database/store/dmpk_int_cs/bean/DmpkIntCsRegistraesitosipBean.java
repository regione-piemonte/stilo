 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntCsRegistraesitosipBean")
public class DmpkIntCsRegistraesitosipBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_CS_REGISTRAESITOSIP";
