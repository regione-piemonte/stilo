 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreLoadaclworkspaceBean")
public class DmpkCoreLoadaclworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_LOADACLWORKSPACE";
