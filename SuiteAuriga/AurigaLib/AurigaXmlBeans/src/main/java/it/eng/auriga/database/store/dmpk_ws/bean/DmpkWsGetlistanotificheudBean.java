 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetlistanotificheudBean")
public class DmpkWsGetlistanotificheudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETLISTANOTIFICHEUD";
