 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreFindudBean")
public class DmpkCoreFindudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_FINDUD";
