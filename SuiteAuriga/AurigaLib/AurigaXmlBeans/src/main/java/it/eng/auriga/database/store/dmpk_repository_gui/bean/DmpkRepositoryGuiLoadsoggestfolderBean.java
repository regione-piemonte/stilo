 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRepositoryGuiLoadsoggestfolderBean")
public class DmpkRepositoryGuiLoadsoggestfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REPOSITORY_GUI_LOADSOGGESTFOLDER";
