 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRepositoryGuiGetcompgruppoassdestudBean")
public class DmpkRepositoryGuiGetcompgruppoassdestudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REPOSITORY_GUI_GETCOMPGRUPPOASSDESTUD";
	...
	private java.lang.String flgassdestin;
	private java.math.BigDecimal idgrupposoggestin;
    ...
    public java.lang.String getFlgassdestin(){return flgassdestin;}
    public java.math.BigDecimal getIdgrupposoggestin(){return idgrupposoggestin;}
    ...
    public void setFlgassdestin(java.lang.String value){this.flgassdestin=value;}
    public void setIdgrupposoggestin(java.math.BigDecimal value){this.idgrupposoggestin=value;}
