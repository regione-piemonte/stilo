 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityTrovadoclottoingestBean")
public class DmpkUtilityTrovadoclottoingestBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_TROVADOCLOTTOINGEST";
