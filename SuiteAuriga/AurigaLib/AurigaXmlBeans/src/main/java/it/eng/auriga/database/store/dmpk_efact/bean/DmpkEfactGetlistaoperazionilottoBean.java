 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactGetlistaoperazionilottoBean")
public class DmpkEfactGetlistaoperazionilottoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_GETLISTAOPERAZIONILOTTO";
