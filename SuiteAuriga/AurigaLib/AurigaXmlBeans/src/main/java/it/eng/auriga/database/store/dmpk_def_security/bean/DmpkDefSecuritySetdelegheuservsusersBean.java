 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecuritySetdelegheuservsusersBean")
public class DmpkDefSecuritySetdelegheuservsusersBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_SETDELEGHEUSERVSUSERS";
