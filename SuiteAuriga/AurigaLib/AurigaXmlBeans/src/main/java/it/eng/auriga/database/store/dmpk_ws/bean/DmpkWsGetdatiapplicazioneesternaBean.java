 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetdatiapplicazioneesternaBean")
public class DmpkWsGetdatiapplicazioneesternaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETDATIAPPLICAZIONEESTERNA";
