 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2TrovadocinlibrofirmaBean")
public class DmpkCore2TrovadocinlibrofirmaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_TROVADOCINLIBROFIRMA";
