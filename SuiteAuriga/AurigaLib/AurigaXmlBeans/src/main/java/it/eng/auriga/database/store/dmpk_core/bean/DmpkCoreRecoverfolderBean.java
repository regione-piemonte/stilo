 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreRecoverfolderBean")
public class DmpkCoreRecoverfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_RECOVERFOLDER";
