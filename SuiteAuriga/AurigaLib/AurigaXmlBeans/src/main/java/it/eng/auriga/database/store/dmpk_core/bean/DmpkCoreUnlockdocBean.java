 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreUnlockdocBean")
public class DmpkCoreUnlockdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_UNLOCKDOC";
