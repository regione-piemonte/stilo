 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailPreparainviofatturaxemailBean")
public class DmpkIntMgoEmailPreparainviofatturaxemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_PREPARAINVIOFATTURAXEMAIL";
