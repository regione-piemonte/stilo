 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovarichtrasmissionefaxBean")
public class DmpkWsTrovarichtrasmissionefaxBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVARICHTRASMISSIONEFAX";
