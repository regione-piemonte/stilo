 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeTrovapdvtipoBean")
public class DmpkGaeTrovapdvtipoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_TROVAPDVTIPO";
