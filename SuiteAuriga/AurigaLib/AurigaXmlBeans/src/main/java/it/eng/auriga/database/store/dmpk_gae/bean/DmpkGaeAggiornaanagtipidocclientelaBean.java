 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeAggiornaanagtipidocclientelaBean")
public class DmpkGaeAggiornaanagtipidocclientelaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_AGGIORNAANAGTIPIDOCCLIENTELA";
