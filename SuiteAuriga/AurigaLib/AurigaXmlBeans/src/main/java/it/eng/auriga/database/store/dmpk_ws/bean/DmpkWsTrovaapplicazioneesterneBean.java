 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovaapplicazioneesterneBean")
public class DmpkWsTrovaapplicazioneesterneBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVAAPPLICAZIONEESTERNE";
