...
package it.eng.auriga.ui.module.layout.server.controlliLegittimita;
...
public class EstraiCampioneXmlBeanDeserializationHelper extends DeserializationHelper {

	protected String idNode;

	public EstraiCampioneXmlBeanDeserializationHelper(Map<String, String> remapConditions) {
	...
	public void remapValues(Object obj, Riga riga) throws Exception {
		...
		EstraiCampioneXmlBean bean = (EstraiCampioneXmlBean) obj;
