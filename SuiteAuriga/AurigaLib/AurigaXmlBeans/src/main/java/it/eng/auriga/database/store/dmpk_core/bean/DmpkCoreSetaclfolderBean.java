 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreSetaclfolderBean")
public class DmpkCoreSetaclfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_SETACLFOLDER";
