 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreSetacludBean")
public class DmpkCoreSetacludBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_SETACLUD";
