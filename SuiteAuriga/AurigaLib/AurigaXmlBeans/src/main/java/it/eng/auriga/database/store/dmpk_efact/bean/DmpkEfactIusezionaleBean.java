 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactIusezionaleBean")
public class DmpkEfactIusezionaleBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_IUSEZIONALE";
