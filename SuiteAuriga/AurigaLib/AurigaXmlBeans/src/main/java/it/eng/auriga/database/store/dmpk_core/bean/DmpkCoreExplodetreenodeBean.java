 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreExplodetreenodeBean")
public class DmpkCoreExplodetreenodeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_EXPLODETREENODE";
