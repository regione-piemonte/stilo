 ...
 */
@XmlRootElement
@XmlType(name = "DmpkPolicyTestvisibinchiarodocBean")
public class DmpkPolicyTestvisibinchiarodocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_POLICY_TESTVISIBINCHIARODOC";
