 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAnagraficaTrovaclientiBean")
public class DmpkAnagraficaTrovaclientiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ANAGRAFICA_TROVACLIENTI";
