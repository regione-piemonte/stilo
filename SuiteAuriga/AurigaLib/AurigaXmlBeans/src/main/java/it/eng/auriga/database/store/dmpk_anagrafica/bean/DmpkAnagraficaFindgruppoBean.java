 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAnagraficaFindgruppoBean")
public class DmpkAnagraficaFindgruppoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ANAGRAFICA_FINDGRUPPO";
