 ...
 */
@XmlRootElement
@XmlType(name = "DmpkStatisticheReportemailBean")
public class DmpkStatisticheReportemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_STATISTICHE_REPORTEMAIL";
