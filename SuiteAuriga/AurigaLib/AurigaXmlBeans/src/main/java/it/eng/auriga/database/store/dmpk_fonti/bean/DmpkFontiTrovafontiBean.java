 ...
 */
@XmlRootElement
@XmlType(name = "DmpkFontiTrovafontiBean")
public class DmpkFontiTrovafontiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_FONTI_TROVAFONTI";
