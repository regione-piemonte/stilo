 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRegistrazionedocEliminazionerichannregBean")
public class DmpkRegistrazionedocEliminazionerichannregBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REGISTRAZIONEDOC_ELIMINAZIONERICHANNREG";
