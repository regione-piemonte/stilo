...
package it.eng.sinadoc.database.store.dmpk_load_combo_sinapoli.bean;
 ...
 */
@XmlRootElement
@XmlType(name = "DmpkLoadComboSinapoliDmfn_load_combo_sinapoliBean")
public class DmpkLoadComboSinapoliDmfn_load_combo_sinapoliBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_LOAD_COMBO_SINAPOLI_DMFN_LOAD_COMBO_SINAPOLI";
