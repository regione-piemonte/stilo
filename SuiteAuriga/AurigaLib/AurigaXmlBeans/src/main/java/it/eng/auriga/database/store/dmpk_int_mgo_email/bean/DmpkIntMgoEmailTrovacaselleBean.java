 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailTrovacaselleBean")
public class DmpkIntMgoEmailTrovacaselleBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_TROVACASELLE";
