 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2LoadacludBean")
public class DmpkCore2LoadacludBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_LOADACLUD";
