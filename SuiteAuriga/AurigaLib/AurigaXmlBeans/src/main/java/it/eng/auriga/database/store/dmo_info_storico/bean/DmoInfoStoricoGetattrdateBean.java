 ...
 */
@XmlRootElement
@XmlType(name = "DmoInfoStoricoGetattrdateBean")
public class DmoInfoStoricoGetattrdateBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_INFO_STORICO_GETATTRDATE";
