 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGeturiverdocBean")
public class DmpkCoreGeturiverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETURIVERDOC";
