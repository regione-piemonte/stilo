 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreDelworkspaceBean")
public class DmpkCoreDelworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_DELWORKSPACE";
