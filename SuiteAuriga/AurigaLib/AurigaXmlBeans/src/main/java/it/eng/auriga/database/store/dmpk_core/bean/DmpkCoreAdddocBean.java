 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreAdddocBean")
public class DmpkCoreAdddocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_ADDDOC";
