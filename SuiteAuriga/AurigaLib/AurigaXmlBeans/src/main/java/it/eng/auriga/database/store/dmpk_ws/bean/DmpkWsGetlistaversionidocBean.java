 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetlistaversionidocBean")
public class DmpkWsGetlistaversionidocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETLISTAVERSIONIDOC";
