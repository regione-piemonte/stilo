 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactDsezionaleBean")
public class DmpkEfactDsezionaleBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_DSEZIONALE";
