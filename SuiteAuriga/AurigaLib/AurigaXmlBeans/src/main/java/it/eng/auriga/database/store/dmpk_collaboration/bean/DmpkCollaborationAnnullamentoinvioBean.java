 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCollaborationAnnullamentoinvioBean")
public class DmpkCollaborationAnnullamentoinvioBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_COLLABORATION_ANNULLAMENTOINVIO";
	...
	private java.math.BigDecimal idinviomovimentoin;
    ...
    public java.math.BigDecimal getIdinviomovimentoin(){return idinviomovimentoin;}
    ...
    public void setIdinviomovimentoin(java.math.BigDecimal value){this.idinviomovimentoin=value;}
