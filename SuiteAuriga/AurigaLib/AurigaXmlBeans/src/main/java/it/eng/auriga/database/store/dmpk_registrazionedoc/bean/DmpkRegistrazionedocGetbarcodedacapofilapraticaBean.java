 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRegistrazionedocGetbarcodedacapofilapraticaBean")
public class DmpkRegistrazionedocGetbarcodedacapofilapraticaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REGISTRAZIONEDOC_GETBARCODEDACAPOFILAPRATICA";
