 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovautentiBean")
public class DmpkWsTrovautentiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVAUTENTI";
