 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovadoclottoingestBean")
public class DmpkEfactTrovadoclottoingestBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVADOCLOTTOINGEST";
