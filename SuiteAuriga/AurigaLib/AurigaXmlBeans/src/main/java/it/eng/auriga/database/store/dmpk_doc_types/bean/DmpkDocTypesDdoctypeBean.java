 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDocTypesDdoctypeBean")
public class DmpkDocTypesDdoctypeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DOC_TYPES_DDOCTYPE";
