 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfDecodeattivitaBean")
public class DmpkWfDecodeattivitaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_DECODEATTIVITA";
