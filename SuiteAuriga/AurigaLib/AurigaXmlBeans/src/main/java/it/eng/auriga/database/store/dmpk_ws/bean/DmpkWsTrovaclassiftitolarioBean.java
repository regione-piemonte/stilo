 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovaclassiftitolarioBean")
public class DmpkWsTrovaclassiftitolarioBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVACLASSIFTITOLARIO";
