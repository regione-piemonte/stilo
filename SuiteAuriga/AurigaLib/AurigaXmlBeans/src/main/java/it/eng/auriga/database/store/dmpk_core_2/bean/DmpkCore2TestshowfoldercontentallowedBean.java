 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2TestshowfoldercontentallowedBean")
public class DmpkCore2TestshowfoldercontentallowedBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_TESTSHOWFOLDERCONTENTALLOWED";
