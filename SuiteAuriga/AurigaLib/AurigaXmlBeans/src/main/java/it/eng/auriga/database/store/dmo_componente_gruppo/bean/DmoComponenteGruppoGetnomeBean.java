 ...
 */
@XmlRootElement
@XmlType(name = "DmoComponenteGruppoGetnomeBean")
public class DmoComponenteGruppoGetnomeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_COMPONENTE_GRUPPO_GETNOME";
