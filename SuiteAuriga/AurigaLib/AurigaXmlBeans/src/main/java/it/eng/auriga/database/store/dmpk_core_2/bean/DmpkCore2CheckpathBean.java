 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2CheckpathBean")
public class DmpkCore2CheckpathBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_CHECKPATH";
