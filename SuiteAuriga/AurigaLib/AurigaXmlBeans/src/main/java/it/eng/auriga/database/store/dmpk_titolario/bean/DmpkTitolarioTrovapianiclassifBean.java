 ...
 */
@XmlRootElement
@XmlType(name = "DmpkTitolarioTrovapianiclassifBean")
public class DmpkTitolarioTrovapianiclassifBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TITOLARIO_TROVAPIANICLASSIF";
