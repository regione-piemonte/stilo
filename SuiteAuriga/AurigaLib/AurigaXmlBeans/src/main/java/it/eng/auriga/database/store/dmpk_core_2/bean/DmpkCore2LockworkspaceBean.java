 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2LockworkspaceBean")
public class DmpkCore2LockworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_LOCKWORKSPACE";
