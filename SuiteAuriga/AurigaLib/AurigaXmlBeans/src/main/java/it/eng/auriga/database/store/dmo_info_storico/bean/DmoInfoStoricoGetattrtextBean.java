 ...
 */
@XmlRootElement
@XmlType(name = "DmoInfoStoricoGetattrtextBean")
public class DmoInfoStoricoGetattrtextBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_INFO_STORICO_GETATTRTEXT";
