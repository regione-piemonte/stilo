 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessesLoadprocobjtreeBean")
public class DmpkProcessesLoadprocobjtreeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESSES_LOADPROCOBJTREE";
