 ...
 */
@XmlRootElement
@XmlType(name = "DmpkLoginLogin_oldBean")
public class DmpkLoginLogin_oldBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_LOGIN_LOGIN_OLD";
