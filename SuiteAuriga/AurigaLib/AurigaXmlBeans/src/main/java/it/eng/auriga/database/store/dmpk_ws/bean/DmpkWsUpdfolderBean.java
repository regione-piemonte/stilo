 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsUpdfolderBean")
public class DmpkWsUpdfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_UPDFOLDER";
