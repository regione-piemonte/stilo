 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRegistrazionedocGeneraprogressivoBean")
public class DmpkRegistrazionedocGeneraprogressivoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REGISTRAZIONEDOC_GENERAPROGRESSIVO";
