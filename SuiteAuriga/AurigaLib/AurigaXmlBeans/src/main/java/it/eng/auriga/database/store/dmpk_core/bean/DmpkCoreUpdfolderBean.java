 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreUpdfolderBean")
public class DmpkCoreUpdfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_UPDFOLDER";
