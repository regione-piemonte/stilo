 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreFindnodoarchivioBean")
public class DmpkCoreFindnodoarchivioBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_FINDNODOARCHIVIO";
