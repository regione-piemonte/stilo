 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessTypesDfasewfBean")
public class DmpkProcessTypesDfasewfBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESS_TYPES_DFASEWF";
