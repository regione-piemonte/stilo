 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityIuprofiloBean")
public class DmpkDefSecurityIuprofiloBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_IUPROFILO";
