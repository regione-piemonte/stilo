 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreRimuoviuddabozzeBean")
public class DmpkCoreRimuoviuddabozzeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_RIMUOVIUDDABOZZE";
