 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetprofilodocxcontainerBean")
public class DmpkCoreGetprofilodocxcontainerBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETPROFILODOCXCONTAINER";
