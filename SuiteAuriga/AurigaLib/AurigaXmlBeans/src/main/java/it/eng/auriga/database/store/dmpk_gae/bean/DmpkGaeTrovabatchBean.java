 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeTrovabatchBean")
public class DmpkGaeTrovabatchBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_TROVABATCH";
