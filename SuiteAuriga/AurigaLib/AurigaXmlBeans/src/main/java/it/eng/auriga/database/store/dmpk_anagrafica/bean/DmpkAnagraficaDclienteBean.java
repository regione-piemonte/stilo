 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAnagraficaDclienteBean")
public class DmpkAnagraficaDclienteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ANAGRAFICA_DCLIENTE";
	...
	private java.math.BigDecimal idclientein;
    ...
    public java.math.BigDecimal getIdclientein(){return idclientein;}
    ...
    public void setIdclientein(java.math.BigDecimal value){this.idclientein=value;}
