 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovaclienticc_bdbBean")
public class DmpkEfactTrovaclienticc_bdbBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVACLIENTICC_BDB";
