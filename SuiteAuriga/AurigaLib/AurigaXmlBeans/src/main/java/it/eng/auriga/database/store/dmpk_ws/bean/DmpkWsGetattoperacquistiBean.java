 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetattoperacquistiBean")
public class DmpkWsGetattoperacquistiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETATTOPERACQUISTI";
