 ...
 */
@XmlRootElement
@XmlType(name = "DmpkPolicyTestprofdocgrantaccessBean")
public class DmpkPolicyTestprofdocgrantaccessBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_POLICY_TESTPROFDOCGRANTACCESS";
