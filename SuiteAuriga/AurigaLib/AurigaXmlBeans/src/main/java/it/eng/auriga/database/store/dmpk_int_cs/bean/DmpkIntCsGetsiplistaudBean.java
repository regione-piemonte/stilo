 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntCsGetsiplistaudBean")
public class DmpkIntCsGetsiplistaudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_CS_GETSIPLISTAUD";
