 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2DelfolderBean")
public class DmpkCore2DelfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_DELFOLDER";
