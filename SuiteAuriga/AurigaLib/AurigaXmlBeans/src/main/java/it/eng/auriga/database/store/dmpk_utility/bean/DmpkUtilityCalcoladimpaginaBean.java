 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityCalcoladimpaginaBean")
public class DmpkUtilityCalcoladimpaginaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_CALCOLADIMPAGINA";
