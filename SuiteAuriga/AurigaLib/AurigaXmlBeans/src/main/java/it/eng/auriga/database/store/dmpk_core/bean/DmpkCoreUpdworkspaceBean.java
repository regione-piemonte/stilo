 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreUpdworkspaceBean")
public class DmpkCoreUpdworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_UPDWORKSPACE";
