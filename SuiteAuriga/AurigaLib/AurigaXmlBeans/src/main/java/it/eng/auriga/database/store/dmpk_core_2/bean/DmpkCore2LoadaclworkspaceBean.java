 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2LoadaclworkspaceBean")
public class DmpkCore2LoadaclworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_LOADACLWORKSPACE";
