 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityDecodeuoBean")
public class DmpkUtilityDecodeuoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_DECODEUO";
