 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturazioneBean")
public class DmpkEfactTrovareportfatturazioneBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZIONE";
