 ...
 */
@XmlRootElement
@XmlType(name = "DmpkPolicyTestaclworkspacegrantaccessBean")
public class DmpkPolicyTestaclworkspacegrantaccessBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_POLICY_TESTACLWORKSPACEGRANTACCESS";
