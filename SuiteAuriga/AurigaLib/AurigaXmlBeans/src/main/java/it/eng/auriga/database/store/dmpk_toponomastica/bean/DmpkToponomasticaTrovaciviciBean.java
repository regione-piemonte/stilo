 ...
 */
@XmlRootElement
@XmlType(name = "DmpkToponomasticaTrovaciviciBean")
public class DmpkToponomasticaTrovaciviciBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TOPONOMASTICA_TROVACIVICI";
