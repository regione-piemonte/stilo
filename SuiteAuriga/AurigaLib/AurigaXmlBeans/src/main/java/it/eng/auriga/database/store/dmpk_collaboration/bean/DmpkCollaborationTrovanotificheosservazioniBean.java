 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCollaborationTrovanotificheosservazioniBean")
public class DmpkCollaborationTrovanotificheosservazioniBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_COLLABORATION_TROVANOTIFICHEOSSERVAZIONI";
	...
	private java.lang.String flgtypeobjrifin;
	private java.math.BigDecimal idobjrifin;
    ...
    public java.lang.String getFlgtypeobjrifin(){return flgtypeobjrifin;}
    public java.math.BigDecimal getIdobjrifin(){return idobjrifin;}
    ...
    public void setFlgtypeobjrifin(java.lang.String value){this.flgtypeobjrifin=value;}
    public void setIdobjrifin(java.math.BigDecimal value){this.idobjrifin=value;}
