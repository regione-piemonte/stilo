 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactIulottoeventiBean")
public class DmpkEfactIulottoeventiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_IULOTTOEVENTI";
