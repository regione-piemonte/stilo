...
package it.eng.eiifact.ui.module.layout.server.fatture.datasource.bean;
...
@XmlRootElement
public class DocumentoLottoEventiXmlBean implements Serializable {
	...
	@XmlVariabile(nome = "#IdDocLotto", tipo = TipoVariabile.SEMPLICE)
