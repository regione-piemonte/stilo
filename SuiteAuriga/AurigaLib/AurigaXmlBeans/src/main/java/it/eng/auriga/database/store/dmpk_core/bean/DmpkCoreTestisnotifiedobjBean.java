 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTestisnotifiedobjBean")
public class DmpkCoreTestisnotifiedobjBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TESTISNOTIFIEDOBJ";
