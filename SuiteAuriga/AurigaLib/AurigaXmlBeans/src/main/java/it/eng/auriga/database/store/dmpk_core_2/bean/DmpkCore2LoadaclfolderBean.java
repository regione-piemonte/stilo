 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2LoadaclfolderBean")
public class DmpkCore2LoadaclfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_LOADACLFOLDER";
