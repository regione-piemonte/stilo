 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailTrovaregoleregautoBean")
public class DmpkIntMgoEmailTrovaregoleregautoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_TROVAREGOLEREGAUTO";
