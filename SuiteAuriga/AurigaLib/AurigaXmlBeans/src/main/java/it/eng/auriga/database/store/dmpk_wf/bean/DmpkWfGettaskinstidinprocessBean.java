 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfGettaskinstidinprocessBean")
public class DmpkWfGettaskinstidinprocessBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_GETTASKINSTIDINPROCESS";
