 ...
 */
@XmlRootElement
@XmlType(name = "DmpkElenchiAlbiTrovacontenutielencoalboBean")
public class DmpkElenchiAlbiTrovacontenutielencoalboBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ELENCHI_ALBI_TROVACONTENUTIELENCOALBO";
