 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetresponseaddupdudBean")
public class DmpkWsGetresponseaddupdudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETRESPONSEADDUPDUD";
