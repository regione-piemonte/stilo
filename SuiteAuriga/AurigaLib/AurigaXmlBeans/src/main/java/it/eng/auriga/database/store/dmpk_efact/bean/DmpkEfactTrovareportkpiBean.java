 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportkpiBean")
public class DmpkEfactTrovareportkpiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTKPI";
