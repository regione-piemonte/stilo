 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreRecoverworkspaceBean")
public class DmpkCoreRecoverworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_RECOVERWORKSPACE";
