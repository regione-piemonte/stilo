 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTestisintrashBean")
public class DmpkCoreTestisintrashBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TESTISINTRASH";
