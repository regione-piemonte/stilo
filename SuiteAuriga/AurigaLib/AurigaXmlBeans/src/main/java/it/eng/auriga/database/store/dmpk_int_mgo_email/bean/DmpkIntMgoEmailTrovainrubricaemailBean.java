 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailTrovainrubricaemailBean")
public class DmpkIntMgoEmailTrovainrubricaemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_TROVAINRUBRICAEMAIL";
