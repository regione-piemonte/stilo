 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsElencapubblicazioniBean")
public class DmpkWsElencapubblicazioniBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_ELENCAPUBBLICAZIONI";
