 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityFindproctypedaavviareBean")
public class DmpkUtilityFindproctypedaavviareBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_FINDPROCTYPEDAAVVIARE";
