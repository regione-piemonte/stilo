 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportkpinestlemailforallBean")
public class DmpkEfactTrovareportkpinestlemailforallBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTKPINESTLEMAILFORALL";
