 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2ContacontenitoriudBean")
public class DmpkCore2ContacontenitoriudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_CONTACONTENITORIUD";
