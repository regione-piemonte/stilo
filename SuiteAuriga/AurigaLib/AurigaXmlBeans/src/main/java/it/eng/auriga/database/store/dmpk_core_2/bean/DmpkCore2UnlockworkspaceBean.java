 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2UnlockworkspaceBean")
public class DmpkCore2UnlockworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_UNLOCKWORKSPACE";
