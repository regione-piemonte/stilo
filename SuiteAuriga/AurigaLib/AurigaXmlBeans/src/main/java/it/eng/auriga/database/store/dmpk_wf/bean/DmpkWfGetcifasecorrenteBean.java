 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfGetcifasecorrenteBean")
public class DmpkWfGetcifasecorrenteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_GETCIFASECORRENTE";
