 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2RecoverfolderBean")
public class DmpkCore2RecoverfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_RECOVERFOLDER";
