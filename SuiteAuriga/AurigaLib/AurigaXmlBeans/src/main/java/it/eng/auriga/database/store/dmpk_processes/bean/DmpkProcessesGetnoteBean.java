 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessesGetnoteBean")
public class DmpkProcessesGetnoteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESSES_GETNOTE";
