 ...
 */
@XmlRootElement
@XmlType(name = "DmpkModelliDocFindmodelliBean")
public class DmpkModelliDocFindmodelliBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_MODELLI_DOC_FINDMODELLI";
