 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRegistrazionedocTrovaregemergenzaBean")
public class DmpkRegistrazionedocTrovaregemergenzaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REGISTRAZIONEDOC_TROVAREGEMERGENZA";
	...
	private java.lang.String filtrixmlin;
    ...
    public java.lang.String getFiltrixmlin(){return filtrixmlin;}
    ...
    public void setFiltrixmlin(java.lang.String value){this.filtrixmlin=value;}
