...
@XmlRootElement
public class ContabilitaAdspRichiesteContabiliResponse implements Serializable {
	...
	public String getImImpPren() {
		return imImpPren;
	}

	public void setImImpPren(String imImpPren) {
	...
	public String getImRicOri() {
		return imRicOri;
	}

	public void setImRicOri(String imRicOri) {
		this.imRicOri = imRicOri;
	}
	
	public String getAttribuzione() {
		return attribuzione;
	}

	public void setAttribuzione(String attribuzione) {
		this.attribuzione = attribuzione;
	}
	
	@Override
	public String toString() {
		return "ContabilitaAdspRichiesteContabiliResponse [idraggrupp=" + idraggrupp + ", rigaAttim=" + rigaAttim
				+ ", es=" + es + ", capitoloParte1=" + capitoloParte1 + ", capitoloParte2=" + capitoloParte2
				+ ", descrizioneVoce=" + descrizioneVoce + ", progkeyvb=" + progkeyvb + ", cup=" + cup + ", cig=" + cig
				+ ", annoEse=" + annoEse + ", nImpeg=" + nImpeg + ", imImpPren=" + imImpPren + ", desImp=" + desImp
				+ ", codiceOpera=" + codiceOpera + ", progimpacc=" + progimpacc + ", ragioneSociale=" + ragioneSociale
				+ ", codiceFiscale=" + codiceFiscale + ", partitaIva=" + partitaIva + ", aliasAssRic=" + aliasAssRic
				+ ", progSogg=" + progSogg + ", liv1pf=" + liv1pf + ", liv2pf=" + liv2pf + ", liv3pf=" + liv3pf
				+ ", liv4pf=" + liv4pf + ", liv5pf=" + liv5pf + ", missione=" + missione + ", programma=" + programma
				+ ", cofog1=" + cofog1 + ", cofog2=" + cofog2 + ", datainserImp=" + datainserImp + ", imRicOri="
				+ imRicOri + ", attribuzione=" + attribuzione + "]";
	}
