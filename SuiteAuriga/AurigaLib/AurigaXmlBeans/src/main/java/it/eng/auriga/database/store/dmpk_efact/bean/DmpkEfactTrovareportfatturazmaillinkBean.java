 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturazmaillinkBean")
public class DmpkEfactTrovareportfatturazmaillinkBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZMAILLINK";
