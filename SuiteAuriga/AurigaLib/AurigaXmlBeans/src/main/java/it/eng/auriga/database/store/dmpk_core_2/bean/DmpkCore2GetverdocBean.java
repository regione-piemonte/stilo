 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetverdocBean")
public class DmpkCore2GetverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETVERDOC";
