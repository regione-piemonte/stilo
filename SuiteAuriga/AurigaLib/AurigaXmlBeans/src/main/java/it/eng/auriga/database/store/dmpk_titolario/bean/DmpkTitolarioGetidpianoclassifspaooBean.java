 ...
 */
@XmlRootElement
@XmlType(name = "DmpkTitolarioGetidpianoclassifspaooBean")
public class DmpkTitolarioGetidpianoclassifspaooBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TITOLARIO_GETIDPIANOCLASSIFSPAOO";
