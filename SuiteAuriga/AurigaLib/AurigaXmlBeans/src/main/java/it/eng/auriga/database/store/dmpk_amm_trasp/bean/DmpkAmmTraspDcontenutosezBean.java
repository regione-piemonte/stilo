 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAmmTraspDcontenutosezBean")
public class DmpkAmmTraspDcontenutosezBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_AMM_TRASP_DCONTENUTOSEZ";
