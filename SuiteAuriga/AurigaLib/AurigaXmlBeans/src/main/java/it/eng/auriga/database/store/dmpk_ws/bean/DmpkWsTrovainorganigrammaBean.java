 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovainorganigrammaBean")
public class DmpkWsTrovainorganigrammaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVAINORGANIGRAMMA";
