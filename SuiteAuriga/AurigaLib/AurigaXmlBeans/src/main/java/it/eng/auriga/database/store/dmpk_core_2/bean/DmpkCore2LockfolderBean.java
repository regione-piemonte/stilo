 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2LockfolderBean")
public class DmpkCore2LockfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_LOCKFOLDER";
