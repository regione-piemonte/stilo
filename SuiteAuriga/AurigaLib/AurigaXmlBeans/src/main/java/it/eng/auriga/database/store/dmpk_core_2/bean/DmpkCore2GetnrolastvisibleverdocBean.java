 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetnrolastvisibleverdocBean")
public class DmpkCore2GetnrolastvisibleverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETNROLASTVISIBLEVERDOC";
