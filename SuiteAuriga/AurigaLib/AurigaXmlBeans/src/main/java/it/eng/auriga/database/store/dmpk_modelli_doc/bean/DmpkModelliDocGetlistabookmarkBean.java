 ...
 */
@XmlRootElement
@XmlType(name = "DmpkModelliDocGetlistabookmarkBean")
public class DmpkModelliDocGetlistabookmarkBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_MODELLI_DOC_GETLISTABOOKMARK";
