 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityUnlockuserBean")
public class DmpkDefSecurityUnlockuserBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_UNLOCKUSER";
