 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityPrepararigaxmlstd_clobBean")
public class DmpkUtilityPrepararigaxmlstd_clobBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_PREPARARIGAXMLSTD_CLOB";
