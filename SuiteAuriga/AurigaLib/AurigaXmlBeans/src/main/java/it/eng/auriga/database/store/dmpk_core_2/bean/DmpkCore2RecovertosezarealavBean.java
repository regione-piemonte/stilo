 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2RecovertosezarealavBean")
public class DmpkCore2RecovertosezarealavBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_RECOVERTOSEZAREALAV";
