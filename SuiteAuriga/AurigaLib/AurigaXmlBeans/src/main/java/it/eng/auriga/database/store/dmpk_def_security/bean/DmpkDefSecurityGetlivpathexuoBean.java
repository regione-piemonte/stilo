 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityGetlivpathexuoBean")
public class DmpkDefSecurityGetlivpathexuoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_GETLIVPATHEXUO";
