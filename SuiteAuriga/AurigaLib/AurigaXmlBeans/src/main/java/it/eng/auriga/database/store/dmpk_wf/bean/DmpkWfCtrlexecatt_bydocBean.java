 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfCtrlexecatt_bydocBean")
public class DmpkWfCtrlexecatt_bydocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_CTRLEXECATT_BYDOC";
