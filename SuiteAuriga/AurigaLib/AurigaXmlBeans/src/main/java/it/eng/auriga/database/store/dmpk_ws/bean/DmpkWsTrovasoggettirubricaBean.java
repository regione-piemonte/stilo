 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovasoggettirubricaBean")
public class DmpkWsTrovasoggettirubricaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVASOGGETTIRUBRICA";
