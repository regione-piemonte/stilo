...
public class DocumentoNespressoXmlBean {
	...
	private String denominazioneDestinatarioSpedMerce;
   ...
   public String getTipoInvioEmail() {
	...
	public String getDenominazioneDestinatarioSpedMerce() {
		return denominazioneDestinatarioSpedMerce;
	}

	public void setDenominazioneDestinatarioSpedMerce(
			String denominazioneDestinatarioSpedMerce) {
		this.denominazioneDestinatarioSpedMerce = denominazioneDestinatarioSpedMerce;
	}

	public String getNomeUtenteLock() {
		return nomeUtenteLock;
	}

	public void setNomeUtenteLock(String nomeUtenteLock) {
		this.nomeUtenteLock = nomeUtenteLock;
	}
