 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessTypesDattributoproctypeBean")
public class DmpkProcessTypesDattributoproctypeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESS_TYPES_DATTRIBUTOPROCTYPE";
