 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityDprofiloBean")
public class DmpkDefSecurityDprofiloBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_DPROFILO";
