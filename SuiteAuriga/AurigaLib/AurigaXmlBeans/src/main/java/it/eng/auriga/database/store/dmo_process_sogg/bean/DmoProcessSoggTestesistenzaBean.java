 ...
 */
@XmlRootElement
@XmlType(name = "DmoProcessSoggTestesistenzaBean")
public class DmoProcessSoggTestesistenzaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_PROCESS_SOGG_TESTESISTENZA";
