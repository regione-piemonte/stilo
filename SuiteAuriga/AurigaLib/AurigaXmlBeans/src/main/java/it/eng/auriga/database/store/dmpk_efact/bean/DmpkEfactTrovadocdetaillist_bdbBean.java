 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovadocdetaillist_bdbBean")
public class DmpkEfactTrovadocdetaillist_bdbBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVADOCDETAILLIST_BDB";
