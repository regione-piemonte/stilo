 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2SetattrnomestdocxindexerBean")
public class DmpkCore2SetattrnomestdocxindexerBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_SETATTRNOMESTDOCXINDEXER";
