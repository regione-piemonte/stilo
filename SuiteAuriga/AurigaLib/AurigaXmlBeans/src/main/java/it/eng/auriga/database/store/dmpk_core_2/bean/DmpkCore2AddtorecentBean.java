 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2AddtorecentBean")
public class DmpkCore2AddtorecentBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_ADDTORECENT";
