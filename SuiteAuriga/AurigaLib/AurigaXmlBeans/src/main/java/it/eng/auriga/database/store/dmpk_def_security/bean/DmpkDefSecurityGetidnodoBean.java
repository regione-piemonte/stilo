 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityGetidnodoBean")
public class DmpkDefSecurityGetidnodoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_GETIDNODO";
