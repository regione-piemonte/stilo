 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntCsTrovapdvBean")
public class DmpkIntCsTrovapdvBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_CS_TROVAPDV";
