 ...
 */
@XmlRootElement
@XmlType(name = "DmpkModelliDocTrovamodellixtipodocBean")
public class DmpkModelliDocTrovamodellixtipodocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_MODELLI_DOC_TROVAMODELLIXTIPODOC";
