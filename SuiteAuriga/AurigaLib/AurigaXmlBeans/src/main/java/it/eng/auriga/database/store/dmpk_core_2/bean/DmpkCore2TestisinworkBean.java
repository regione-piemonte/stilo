 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2TestisinworkBean")
public class DmpkCore2TestisinworkBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_TESTISINWORK";
