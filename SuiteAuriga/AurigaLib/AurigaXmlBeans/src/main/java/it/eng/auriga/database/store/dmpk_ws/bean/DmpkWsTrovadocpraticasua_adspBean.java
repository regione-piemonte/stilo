 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovadocpraticasua_adspBean")
public class DmpkWsTrovadocpraticasua_adspBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVADOCPRATICASUA_ADSP";
