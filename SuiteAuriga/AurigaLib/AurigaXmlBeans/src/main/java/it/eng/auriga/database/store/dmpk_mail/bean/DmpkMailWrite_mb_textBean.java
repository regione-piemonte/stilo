 ...
 */
@XmlRootElement
@XmlType(name = "DmpkMailWrite_mb_textBean")
public class DmpkMailWrite_mb_textBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_MAIL_WRITE_MB_TEXT";
