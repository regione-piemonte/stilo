 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreContaoggomonimiinfolderBean")
public class DmpkCoreContaoggomonimiinfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_CONTAOGGOMONIMIINFOLDER";
