 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityGetestremiregnumud_jBean")
public class DmpkUtilityGetestremiregnumud_jBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_GETESTREMIREGNUMUD_J";
