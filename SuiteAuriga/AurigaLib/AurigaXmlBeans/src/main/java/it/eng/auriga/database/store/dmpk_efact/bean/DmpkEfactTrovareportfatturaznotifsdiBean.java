 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturaznotifsdiBean")
public class DmpkEfactTrovareportfatturaznotifsdiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZNOTIFSDI";
