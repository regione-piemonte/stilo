 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportdestinatariBean")
public class DmpkEfactTrovareportdestinatariBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTDESTINATARI";
