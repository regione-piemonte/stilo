 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityDapplicazioneesternaBean")
public class DmpkDefSecurityDapplicazioneesternaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_DAPPLICAZIONEESTERNA";
