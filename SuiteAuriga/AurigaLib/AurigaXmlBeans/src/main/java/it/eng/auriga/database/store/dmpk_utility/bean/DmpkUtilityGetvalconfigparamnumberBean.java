 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityGetvalconfigparamnumberBean")
public class DmpkUtilityGetvalconfigparamnumberBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_GETVALCONFIGPARAMNUMBER";
