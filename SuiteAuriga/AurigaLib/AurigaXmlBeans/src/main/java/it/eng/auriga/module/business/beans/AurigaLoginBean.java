...
public class AurigaLoginBean implements Serializable {
	...
	private SpecializzazioneBean specializzazioneBean;
	...
	public void setSpecializzazioneBean(SpecializzazioneBean specializzazioneBean) {
		this.specializzazioneBean = specializzazioneBean;
	}

	public SpecializzazioneBean getSpecializzazioneBean() {
