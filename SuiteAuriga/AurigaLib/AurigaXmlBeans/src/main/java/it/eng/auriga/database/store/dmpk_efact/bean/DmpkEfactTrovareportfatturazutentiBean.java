 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturazutentiBean")
public class DmpkEfactTrovareportfatturazutentiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZUTENTI";
