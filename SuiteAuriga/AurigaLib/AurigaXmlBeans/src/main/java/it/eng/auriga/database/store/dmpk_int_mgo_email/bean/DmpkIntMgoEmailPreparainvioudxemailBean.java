 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailPreparainvioudxemailBean")
public class DmpkIntMgoEmailPreparainvioudxemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_PREPARAINVIOUDXEMAIL";
