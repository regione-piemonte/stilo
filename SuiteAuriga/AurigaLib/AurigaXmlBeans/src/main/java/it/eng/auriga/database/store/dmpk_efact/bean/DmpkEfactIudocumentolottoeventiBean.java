 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactIudocumentolottoeventiBean")
public class DmpkEfactIudocumentolottoeventiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_IUDOCUMENTOLOTTOEVENTI";
