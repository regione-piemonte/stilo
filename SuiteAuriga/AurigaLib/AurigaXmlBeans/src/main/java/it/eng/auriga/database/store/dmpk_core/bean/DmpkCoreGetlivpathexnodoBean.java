 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetlivpathexnodoBean")
public class DmpkCoreGetlivpathexnodoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETLIVPATHEXNODO";
