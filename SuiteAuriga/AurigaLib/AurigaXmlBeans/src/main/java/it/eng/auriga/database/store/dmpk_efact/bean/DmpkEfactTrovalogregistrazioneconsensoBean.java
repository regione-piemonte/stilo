 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovalogregistrazioneconsensoBean")
public class DmpkEfactTrovalogregistrazioneconsensoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVALOGREGISTRAZIONECONSENSO";
