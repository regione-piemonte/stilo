 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetlistrelatedobjincontainerBean")
public class DmpkCore2GetlistrelatedobjincontainerBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETLISTRELATEDOBJINCONTAINER";
