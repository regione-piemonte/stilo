 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreFindlibraryBean")
public class DmpkCoreFindlibraryBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_FINDLIBRARY";
