 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGestoreSavedatispecattBean")
public class DmpkGestoreSavedatispecattBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GESTORE_SAVEDATISPECATT";
