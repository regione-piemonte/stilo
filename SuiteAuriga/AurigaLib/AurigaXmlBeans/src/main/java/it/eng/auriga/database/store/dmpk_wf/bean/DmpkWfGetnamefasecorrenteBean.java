 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfGetnamefasecorrenteBean")
public class DmpkWfGetnamefasecorrenteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_GETNAMEFASECORRENTE";
