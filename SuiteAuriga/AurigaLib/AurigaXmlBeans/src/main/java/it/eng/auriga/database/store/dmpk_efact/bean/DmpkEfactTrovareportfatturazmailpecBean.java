 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturazmailpecBean")
public class DmpkEfactTrovareportfatturazmailpecBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZMAILPEC";
