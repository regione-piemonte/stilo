 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailDregolaregautoBean")
public class DmpkIntMgoEmailDregolaregautoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_DREGOLAREGAUTO";
