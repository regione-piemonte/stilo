 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2TestisinnewsBean")
public class DmpkCore2TestisinnewsBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_TESTISINNEWS";
	...
	private java.util.Date tsinnewsdaout;
    ...
    public java.util.Date getTsinnewsdaout(){return tsinnewsdaout;}
    ...
    public void setTsinnewsdaout(java.util.Date value){this.tsinnewsdaout=value;}
