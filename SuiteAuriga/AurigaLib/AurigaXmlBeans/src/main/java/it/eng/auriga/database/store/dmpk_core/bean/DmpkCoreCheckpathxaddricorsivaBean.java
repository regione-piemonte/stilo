 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreCheckpathxaddricorsivaBean")
public class DmpkCoreCheckpathxaddricorsivaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_CHECKPATHXADDRICORSIVA";
