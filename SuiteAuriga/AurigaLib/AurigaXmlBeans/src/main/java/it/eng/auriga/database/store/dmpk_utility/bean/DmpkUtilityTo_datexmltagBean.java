 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityTo_datexmltagBean")
public class DmpkUtilityTo_datexmltagBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_TO_DATEXMLTAG";
