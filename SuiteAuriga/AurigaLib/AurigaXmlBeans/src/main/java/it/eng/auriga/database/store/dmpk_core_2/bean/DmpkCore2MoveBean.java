 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2MoveBean")
public class DmpkCore2MoveBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_MOVE";
