 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetverdocBean")
public class DmpkCoreGetverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETVERDOC";
