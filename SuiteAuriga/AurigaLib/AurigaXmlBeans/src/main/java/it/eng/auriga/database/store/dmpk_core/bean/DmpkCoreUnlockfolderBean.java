 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreUnlockfolderBean")
public class DmpkCoreUnlockfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_UNLOCKFOLDER";
