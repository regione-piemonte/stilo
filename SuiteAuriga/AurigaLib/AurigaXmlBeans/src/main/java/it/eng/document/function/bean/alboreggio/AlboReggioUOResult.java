...
@XmlRootElement
public class AlboReggioUOResult implements Serializable {
	...
	public AlboReggioUO[] getPayload() {
		return payload;
	}

	public void setPayload(AlboReggioUO[] payload) {
