 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreCtrlpresenzaregnumsuudBean")
public class DmpkCoreCtrlpresenzaregnumsuudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_CTRLPRESENZAREGNUMSUUD";
