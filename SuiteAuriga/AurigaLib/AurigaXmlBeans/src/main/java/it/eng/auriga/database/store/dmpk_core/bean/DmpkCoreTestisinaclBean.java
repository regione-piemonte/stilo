 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTestisinaclBean")
public class DmpkCoreTestisinaclBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TESTISINACL";
