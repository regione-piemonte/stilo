 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2Del_ud_doc_verBean")
public class DmpkCore2Del_ud_doc_verBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_DEL_UD_DOC_VER";
