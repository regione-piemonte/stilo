 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetfileudtoupdxrectrlBean")
public class DmpkWsGetfileudtoupdxrectrlBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETFILEUDTOUPDXRECTRL";
