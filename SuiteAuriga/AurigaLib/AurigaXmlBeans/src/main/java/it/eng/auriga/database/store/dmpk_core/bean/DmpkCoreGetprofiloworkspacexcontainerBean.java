 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetprofiloworkspacexcontainerBean")
public class DmpkCoreGetprofiloworkspacexcontainerBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETPROFILOWORKSPACEXCONTAINER";
