 ...
 */
@XmlRootElement
@XmlType(name = "DmpkStatisticheTrovaregolecampionamentoattiBean")
public class DmpkStatisticheTrovaregolecampionamentoattiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_STATISTICHE_TROVAREGOLECAMPIONAMENTOATTI";
