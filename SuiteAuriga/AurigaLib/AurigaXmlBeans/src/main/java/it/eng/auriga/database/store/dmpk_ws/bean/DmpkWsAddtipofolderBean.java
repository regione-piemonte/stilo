 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsAddtipofolderBean")
public class DmpkWsAddtipofolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_ADDTIPOFOLDER";
