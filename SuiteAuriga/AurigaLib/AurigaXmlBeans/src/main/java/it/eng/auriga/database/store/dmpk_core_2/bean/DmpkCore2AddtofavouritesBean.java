 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2AddtofavouritesBean")
public class DmpkCore2AddtofavouritesBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_ADDTOFAVOURITES";
