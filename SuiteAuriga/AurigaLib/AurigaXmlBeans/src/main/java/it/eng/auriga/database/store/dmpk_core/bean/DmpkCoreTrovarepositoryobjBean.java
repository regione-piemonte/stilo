 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTrovarepositoryobjBean")
public class DmpkCoreTrovarepositoryobjBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TROVAREPOSITORYOBJ";
