 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetprofilofolderxcontainerBean")
public class DmpkCoreGetprofilofolderxcontainerBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETPROFILOFOLDERXCONTAINER";
