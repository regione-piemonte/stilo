 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreRecovertosezarealavBean")
public class DmpkCoreRecovertosezarealavBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_RECOVERTOSEZAREALAV";
