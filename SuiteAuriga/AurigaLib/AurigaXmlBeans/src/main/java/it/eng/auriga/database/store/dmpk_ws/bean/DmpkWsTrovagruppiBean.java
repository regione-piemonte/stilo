 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovagruppiBean")
public class DmpkWsTrovagruppiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVAGRUPPI";
