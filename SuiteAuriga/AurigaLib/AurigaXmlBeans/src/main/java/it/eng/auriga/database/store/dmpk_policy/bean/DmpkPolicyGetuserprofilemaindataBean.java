 ...
 */
@XmlRootElement
@XmlType(name = "DmpkPolicyGetuserprofilemaindataBean")
public class DmpkPolicyGetuserprofilemaindataBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_POLICY_GETUSERPROFILEMAINDATA";
