 ...
 */
@XmlRootElement
@XmlType(name = "DmpkPolicyGetruoliutenteBean")
public class DmpkPolicyGetruoliutenteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_POLICY_GETRUOLIUTENTE";
