 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovatipidocumentoBean")
public class DmpkWsTrovatipidocumentoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVATIPIDOCUMENTO";
