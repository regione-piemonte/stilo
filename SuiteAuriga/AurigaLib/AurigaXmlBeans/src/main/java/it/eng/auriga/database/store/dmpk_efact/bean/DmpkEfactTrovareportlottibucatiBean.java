 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportlottibucatiBean")
public class DmpkEfactTrovareportlottibucatiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTLOTTIBUCATI";
