 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetcontainerforaddverBean")
public class DmpkCoreGetcontainerforaddverBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETCONTAINERFORADDVER";
