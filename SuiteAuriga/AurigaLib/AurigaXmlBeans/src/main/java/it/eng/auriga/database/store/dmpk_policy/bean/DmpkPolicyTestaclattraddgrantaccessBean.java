 ...
 */
@XmlRootElement
@XmlType(name = "DmpkPolicyTestaclattraddgrantaccessBean")
public class DmpkPolicyTestaclattraddgrantaccessBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_POLICY_TESTACLATTRADDGRANTACCESS";
