...
package it.eng.auriga.database.store.dmo_soggetto_interno.bean;
 ...
 */
@XmlRootElement
@XmlType(name = "DmoSoggettoInternoGetdessoggettointernoBean")
public class DmoSoggettoInternoGetdessoggettointernoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_SOGGETTO_INTERNO_GETDESSOGGETTOINTERNO";
