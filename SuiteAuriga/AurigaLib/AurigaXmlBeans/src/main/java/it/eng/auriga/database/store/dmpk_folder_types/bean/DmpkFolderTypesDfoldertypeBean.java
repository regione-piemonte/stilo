...
package it.eng.auriga.database.store.dmpk_folder_types.bean;
 ...
 */
@XmlRootElement
@XmlType(name = "DmpkFolderTypesDfoldertypeBean")
public class DmpkFolderTypesDfoldertypeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_FOLDER_TYPES_DFOLDERTYPE";
