 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2RecoverworkspaceBean")
public class DmpkCore2RecoverworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_RECOVERWORKSPACE";
