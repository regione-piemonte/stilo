 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2UpdworkspaceBean")
public class DmpkCore2UpdworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_UPDWORKSPACE";
