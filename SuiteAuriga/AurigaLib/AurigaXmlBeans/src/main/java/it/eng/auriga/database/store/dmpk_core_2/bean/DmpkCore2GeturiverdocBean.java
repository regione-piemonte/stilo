 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GeturiverdocBean")
public class DmpkCore2GeturiverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETURIVERDOC";
