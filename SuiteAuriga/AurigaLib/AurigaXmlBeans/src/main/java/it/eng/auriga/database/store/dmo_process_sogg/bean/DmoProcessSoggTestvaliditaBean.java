 ...
 */
@XmlRootElement
@XmlType(name = "DmoProcessSoggTestvaliditaBean")
public class DmoProcessSoggTestvaliditaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_PROCESS_SOGG_TESTVALIDITA";
