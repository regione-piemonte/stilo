 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeTrovalottibatchBean")
public class DmpkGaeTrovalottibatchBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_TROVALOTTIBATCH";
