 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2AddfolderBean")
public class DmpkCore2AddfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_ADDFOLDER";
