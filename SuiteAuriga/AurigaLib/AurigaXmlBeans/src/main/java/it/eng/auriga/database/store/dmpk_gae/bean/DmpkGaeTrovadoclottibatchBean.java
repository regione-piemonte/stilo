 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeTrovadoclottibatchBean")
public class DmpkGaeTrovadoclottibatchBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_TROVADOCLOTTIBATCH";
