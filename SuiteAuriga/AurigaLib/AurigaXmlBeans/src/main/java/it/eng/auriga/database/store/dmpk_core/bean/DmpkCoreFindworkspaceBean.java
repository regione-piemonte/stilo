 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreFindworkspaceBean")
public class DmpkCoreFindworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_FINDWORKSPACE";
