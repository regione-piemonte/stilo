 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityGetdelegheuservsusersBean")
public class DmpkDefSecurityGetdelegheuservsusersBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_GETDELEGHEUSERVSUSERS";
