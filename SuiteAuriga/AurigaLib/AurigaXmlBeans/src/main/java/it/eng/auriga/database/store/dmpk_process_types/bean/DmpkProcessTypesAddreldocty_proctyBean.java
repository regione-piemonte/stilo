 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessTypesAddreldocty_proctyBean")
public class DmpkProcessTypesAddreldocty_proctyBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESS_TYPES_ADDRELDOCTY_PROCTY";
