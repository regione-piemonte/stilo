 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetlistdocversionBean")
public class DmpkCoreGetlistdocversionBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETLISTDOCVERSION";
