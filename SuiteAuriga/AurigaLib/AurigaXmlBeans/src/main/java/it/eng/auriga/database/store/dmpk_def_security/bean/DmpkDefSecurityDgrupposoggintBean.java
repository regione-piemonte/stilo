 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityDgrupposoggintBean")
public class DmpkDefSecurityDgrupposoggintBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_DGRUPPOSOGGINT";
