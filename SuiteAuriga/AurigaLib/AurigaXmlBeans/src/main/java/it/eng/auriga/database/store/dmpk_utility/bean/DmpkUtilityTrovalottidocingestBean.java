 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityTrovalottidocingestBean")
public class DmpkUtilityTrovalottidocingestBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_TROVALOTTIDOCINGEST";
