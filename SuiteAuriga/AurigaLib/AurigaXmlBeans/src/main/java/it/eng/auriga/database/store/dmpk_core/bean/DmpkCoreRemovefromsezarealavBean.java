 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreRemovefromsezarealavBean")
public class DmpkCoreRemovefromsezarealavBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_REMOVEFROMSEZAREALAV";
