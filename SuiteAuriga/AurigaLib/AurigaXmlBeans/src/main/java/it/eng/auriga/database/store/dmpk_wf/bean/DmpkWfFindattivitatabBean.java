 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfFindattivitatabBean")
public class DmpkWfFindattivitatabBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_FINDATTIVITATAB";
