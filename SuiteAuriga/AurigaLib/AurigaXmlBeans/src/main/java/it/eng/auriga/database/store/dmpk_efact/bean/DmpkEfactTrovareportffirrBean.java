 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportffirrBean")
public class DmpkEfactTrovareportffirrBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFFIRR";
