 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2SetaclworkspaceBean")
public class DmpkCore2SetaclworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_SETACLWORKSPACE";
