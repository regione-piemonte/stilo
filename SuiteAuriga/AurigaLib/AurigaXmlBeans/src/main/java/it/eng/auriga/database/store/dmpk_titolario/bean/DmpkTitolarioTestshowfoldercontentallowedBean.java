 ...
 */
@XmlRootElement
@XmlType(name = "DmpkTitolarioTestshowfoldercontentallowedBean")
public class DmpkTitolarioTestshowfoldercontentallowedBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TITOLARIO_TESTSHOWFOLDERCONTENTALLOWED";
