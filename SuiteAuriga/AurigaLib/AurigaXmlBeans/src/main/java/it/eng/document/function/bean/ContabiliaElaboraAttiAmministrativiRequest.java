...
@XmlRootElement
public class ContabiliaElaboraAttiAmministrativiRequest implements Serializable {
	...
	public String toString() {
		return "ContabiliaElaboraAttiAmministrativiRequest [annoAttoProposta=" + annoAttoProposta
				+ ", numeroAttoProposta=" + numeroAttoProposta + ", tipoAttoProposta=" + tipoAttoProposta
				+ ", annoAttoDefinitivo=" + annoAttoDefinitivo + ", numeroAttoDefinitivo=" + numeroAttoDefinitivo
				+ ", tipoAttoDefinitivo=" + tipoAttoDefinitivo + ", centroResponsabilita=" + centroResponsabilita
				+ ", centroCosto=" + centroCosto + ", dataCreazione=" + dataCreazione + ", dataProposta=" + dataProposta
				+ ", dataApprovazione=" + dataApprovazione + ", dataEsecutivita=" + dataEsecutivita + ", oggetto="
				+ oggetto + ", note=" + note + ", identificativo=" + identificativo + ", dirigenteResponsabile="
				+ dirigenteResponsabile + ", trasparenza=" + trasparenza + ", idSpAoo=" + idSpAoo + "]";
	}
