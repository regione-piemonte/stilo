 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTestappartenenzaafolderBean")
public class DmpkCoreTestappartenenzaafolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TESTAPPARTENENZAAFOLDER";
