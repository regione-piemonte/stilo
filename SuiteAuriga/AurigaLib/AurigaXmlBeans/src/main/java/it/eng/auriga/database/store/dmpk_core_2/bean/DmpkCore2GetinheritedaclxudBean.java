 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetinheritedaclxudBean")
public class DmpkCore2GetinheritedaclxudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETINHERITEDACLXUD";
