 ...
 */
@XmlRootElement
@XmlType(name = "DmoComponenteGruppoGetlivelliuoBean")
public class DmoComponenteGruppoGetlivelliuoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_COMPONENTE_GRUPPO_GETLIVELLIUO";
