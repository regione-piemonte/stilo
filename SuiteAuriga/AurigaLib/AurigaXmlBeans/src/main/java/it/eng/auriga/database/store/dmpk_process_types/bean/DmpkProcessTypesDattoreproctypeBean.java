 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessTypesDattoreproctypeBean")
public class DmpkProcessTypesDattoreproctypeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESS_TYPES_DATTOREPROCTYPE";
