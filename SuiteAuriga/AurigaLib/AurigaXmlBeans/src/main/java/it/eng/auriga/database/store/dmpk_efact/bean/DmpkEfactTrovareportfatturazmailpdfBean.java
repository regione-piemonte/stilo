 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturazmailpdfBean")
public class DmpkEfactTrovareportfatturazmailpdfBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZMAILPDF";
