 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreDelfolderBean")
public class DmpkCoreDelfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_DELFOLDER";
