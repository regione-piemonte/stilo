 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAmmTraspGetflgheaderrifnormativisezBean")
public class DmpkAmmTraspGetflgheaderrifnormativisezBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_AMM_TRASP_GETFLGHEADERRIFNORMATIVISEZ";
