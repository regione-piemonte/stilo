 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreSetaclworkspaceBean")
public class DmpkCoreSetaclworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_SETACLWORKSPACE";
