 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetidfoldertypegenBean")
public class DmpkCoreGetidfoldertypegenBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETIDFOLDERTYPEGEN";
