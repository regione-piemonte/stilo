 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeTrovasottoscrizioninotificaBean")
public class DmpkGaeTrovasottoscrizioninotificaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_TROVASOTTOSCRIZIONINOTIFICA";
