 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeAggiornaanagrafetipologiedocBean")
public class DmpkGaeAggiornaanagrafetipologiedocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_AGGIORNAANAGRAFETIPOLOGIEDOC";
