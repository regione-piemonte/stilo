 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovalottidocingestBean")
public class DmpkEfactTrovalottidocingestBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVALOTTIDOCINGEST";
