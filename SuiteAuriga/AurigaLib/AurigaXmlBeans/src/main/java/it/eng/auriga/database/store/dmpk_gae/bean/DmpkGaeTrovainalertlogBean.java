 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeTrovainalertlogBean")
public class DmpkGaeTrovainalertlogBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_TROVAINALERTLOG";
