 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTestisinnewsBean")
public class DmpkCoreTestisinnewsBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TESTISINNEWS";
