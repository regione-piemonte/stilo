 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAttributiDinamiciGetattrrowidBean")
public class DmpkAttributiDinamiciGetattrrowidBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ATTRIBUTI_DINAMICI_GETATTRROWID";
