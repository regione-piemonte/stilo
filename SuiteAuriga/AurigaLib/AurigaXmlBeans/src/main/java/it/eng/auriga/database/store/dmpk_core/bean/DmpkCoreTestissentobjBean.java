 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTestissentobjBean")
public class DmpkCoreTestissentobjBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TESTISSENTOBJ";
