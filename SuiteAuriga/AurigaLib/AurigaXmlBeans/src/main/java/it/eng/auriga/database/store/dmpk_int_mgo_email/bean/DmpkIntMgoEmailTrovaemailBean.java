 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailTrovaemailBean")
public class DmpkIntMgoEmailTrovaemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_TROVAEMAIL";
