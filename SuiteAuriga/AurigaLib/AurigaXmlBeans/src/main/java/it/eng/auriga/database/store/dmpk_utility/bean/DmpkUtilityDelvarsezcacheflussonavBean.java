 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityDelvarsezcacheflussonavBean")
public class DmpkUtilityDelvarsezcacheflussonavBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_DELVARSEZCACHEFLUSSONAV";
