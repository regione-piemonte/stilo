 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2UpddocudBean")
public class DmpkCore2UpddocudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_UPDDOCUD";
