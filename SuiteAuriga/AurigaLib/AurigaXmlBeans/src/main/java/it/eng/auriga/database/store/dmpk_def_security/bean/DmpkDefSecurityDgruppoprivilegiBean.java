 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityDgruppoprivilegiBean")
public class DmpkDefSecurityDgruppoprivilegiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_DGRUPPOPRIVILEGI";
	...
	private java.math.BigDecimal idgruppoprivin;
    ...
    public java.math.BigDecimal getIdgruppoprivin(){return idgruppoprivin;}
    ...
    public void setIdgruppoprivin(java.math.BigDecimal value){this.idgruppoprivin=value;}
