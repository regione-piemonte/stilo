 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessesIusoggettoesternoBean")
public class DmpkProcessesIusoggettoesternoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESSES_IUSOGGETTOESTERNO";
