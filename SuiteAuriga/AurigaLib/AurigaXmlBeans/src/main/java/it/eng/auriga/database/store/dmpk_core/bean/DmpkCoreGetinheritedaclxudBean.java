 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetinheritedaclxudBean")
public class DmpkCoreGetinheritedaclxudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETINHERITEDACLXUD";
