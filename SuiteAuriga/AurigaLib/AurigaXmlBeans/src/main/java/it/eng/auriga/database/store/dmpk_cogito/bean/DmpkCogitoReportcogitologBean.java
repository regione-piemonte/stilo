 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCogitoReportcogitologBean")
public class DmpkCogitoReportcogitologBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_COGITO_REPORTCOGITOLOG";
