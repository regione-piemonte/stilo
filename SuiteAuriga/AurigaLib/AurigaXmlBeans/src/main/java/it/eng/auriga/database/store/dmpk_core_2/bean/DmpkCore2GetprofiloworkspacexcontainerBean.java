 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetprofiloworkspacexcontainerBean")
public class DmpkCore2GetprofiloworkspacexcontainerBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETPROFILOWORKSPACEXCONTAINER";
