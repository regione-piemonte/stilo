 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetregnumdateudBean")
public class DmpkCore2GetregnumdateudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETREGNUMDATEUD";
