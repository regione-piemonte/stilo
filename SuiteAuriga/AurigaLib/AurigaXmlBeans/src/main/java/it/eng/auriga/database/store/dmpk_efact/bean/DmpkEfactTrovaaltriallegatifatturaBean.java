 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovaaltriallegatifatturaBean")
public class DmpkEfactTrovaaltriallegatifatturaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAALTRIALLEGATIFATTURA";
