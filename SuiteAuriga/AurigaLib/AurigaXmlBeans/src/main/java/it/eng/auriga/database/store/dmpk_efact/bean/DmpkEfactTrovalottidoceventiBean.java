 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovalottidoceventiBean")
public class DmpkEfactTrovalottidoceventiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVALOTTIDOCEVENTI";
