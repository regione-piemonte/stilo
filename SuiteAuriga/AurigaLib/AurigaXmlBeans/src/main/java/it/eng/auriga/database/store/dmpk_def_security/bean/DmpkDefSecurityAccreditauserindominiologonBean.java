 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityAccreditauserindominiologonBean")
public class DmpkDefSecurityAccreditauserindominiologonBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_ACCREDITAUSERINDOMINIOLOGON";
