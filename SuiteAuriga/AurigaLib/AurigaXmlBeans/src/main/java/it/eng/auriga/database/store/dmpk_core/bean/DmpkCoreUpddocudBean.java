 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreUpddocudBean")
public class DmpkCoreUpddocudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_UPDDOCUD";
