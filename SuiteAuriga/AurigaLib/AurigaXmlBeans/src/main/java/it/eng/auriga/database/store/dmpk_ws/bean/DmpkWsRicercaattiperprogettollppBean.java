 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsRicercaattiperprogettollppBean")
public class DmpkWsRicercaattiperprogettollppBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_RICERCAATTIPERPROGETTOLLPP";
