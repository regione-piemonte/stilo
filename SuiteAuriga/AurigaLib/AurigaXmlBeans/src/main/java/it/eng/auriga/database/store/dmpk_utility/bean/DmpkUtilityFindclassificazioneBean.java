 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityFindclassificazioneBean")
public class DmpkUtilityFindclassificazioneBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_FINDCLASSIFICAZIONE";
