...
package it.eng.document.function.bean.amministrazionetrasparente;
...
@XmlRootElement
public class XmlContenutiRicercaResultOutBean {
	...
	private String dtInizioPubbl;
	
	@NumeroColonna(numero = "21")
	private String dtFinePubbl;;
	
	@NumeroColonna(numero = "25")
	private String idSezioneAppartenenza;
	
	@NumeroColonna(numero = "26")
	private String nomeSezioneAppartenenza;
	...
	public String getDtInizioPubbl() {
		return dtInizioPubbl;
	}

	public void setDtInizioPubbl(String dtInizioPubbl) {
		this.dtInizioPubbl = dtInizioPubbl;
	}

	public String getDtFinePubbl() {
		return dtFinePubbl;
	}

	public void setDtFinePubbl(String dtFinePubbl) {
		this.dtFinePubbl = dtFinePubbl;
	}

	public String getIdSezioneAppartenenza() {
		return idSezioneAppartenenza;
	}

	public void setIdSezioneAppartenenza(String idSezioneAppartenenza) {
		this.idSezioneAppartenenza = idSezioneAppartenenza;
	}

	public String getNomeSezioneAppartenenza() {
		return nomeSezioneAppartenenza;
	}

	public void setNomeSezioneAppartenenza(String nomeSezioneAppartenenza) {
		this.nomeSezioneAppartenenza = nomeSezioneAppartenenza;
	}
