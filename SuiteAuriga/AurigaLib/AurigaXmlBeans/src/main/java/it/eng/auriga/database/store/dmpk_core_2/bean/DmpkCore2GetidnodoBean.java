 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetidnodoBean")
public class DmpkCore2GetidnodoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETIDNODO";
