 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreRecover_ud_doc_verBean")
public class DmpkCoreRecover_ud_doc_verBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_RECOVER_UD_DOC_VER";
