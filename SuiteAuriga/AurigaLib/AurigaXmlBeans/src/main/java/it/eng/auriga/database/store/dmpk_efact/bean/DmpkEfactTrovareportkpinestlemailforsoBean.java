 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportkpinestlemailforsoBean")
public class DmpkEfactTrovareportkpinestlemailforsoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTKPINESTLEMAILFORSO";
