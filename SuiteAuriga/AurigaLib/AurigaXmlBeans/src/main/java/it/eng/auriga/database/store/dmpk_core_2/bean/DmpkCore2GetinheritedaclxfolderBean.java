 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetinheritedaclxfolderBean")
public class DmpkCore2GetinheritedaclxfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETINHERITEDACLXFOLDER";
