 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRegistrazionedocAnnullaregBean")
public class DmpkRegistrazionedocAnnullaregBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REGISTRAZIONEDOC_ANNULLAREG";
