 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfFindtypesflussiwfBean")
public class DmpkWfFindtypesflussiwfBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_FINDTYPESFLUSSIWF";
