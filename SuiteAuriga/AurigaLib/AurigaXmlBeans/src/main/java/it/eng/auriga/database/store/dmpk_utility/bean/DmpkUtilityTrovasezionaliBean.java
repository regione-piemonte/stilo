 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityTrovasezionaliBean")
public class DmpkUtilityTrovasezionaliBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_TROVASEZIONALI";
