 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovariferimentibancariBean")
public class DmpkEfactTrovariferimentibancariBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVARIFERIMENTIBANCARI";
