 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean")
public class DmpkIntPortaleCrmTrovarichsbloccolimagibilitaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_PORTALE_CRM_TROVARICHSBLOCCOLIMAGIBILITA";
