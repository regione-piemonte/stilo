...
@XmlRootElement
public class CreaModContrattoAlgInBean extends CreaModDocumentoInBean {
	...
	@XmlVariabile(nome="DATA_SOTTOSCRIZIONE_CONTRATTO_Doc", tipo=TipoVariabile.SEMPLICE)
	private Date dataStipulaContratto;
	
	// Luogo sottoscrizione contratto
	@XmlVariabile(nome="LUOGO_SOTTOSCRIZIONE_CONTRATTO_Doc", tipo=TipoVariabile.SEMPLICE)
	private String comunePuntoVenditaSottoscrizioneContratto;	
	
	// Nome venditore
	@XmlVariabile(nome="NOME_COGNOME_VENDITORE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeCognomeVenditore;
	
	@XmlVariabile(nome="CODICE_VENDITORE_NETA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codiceVenditoreNETA;
	
	@XmlVariabile(nome="CODICE_PROFILO_VENDITORE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codiceProfiloVenditore;
	
	@XmlVariabile(nome="CODICE_PROVENIENZA_PV_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codProvenienzaPV;	
	
	
	@XmlVariabile(nome="TICKET_REGISTRAZIONE_NETA_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="ID_PV_SELEZIONATO_Doc", tipo=TipoVariabile.SEMPLICE)
	private String idPuntoVenditaSelezionato;
	
	@XmlVariabile(nome="NOME_PV_SELEZIONATO_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomePuntoVenditaSelezionato;
	
	@XmlVariabile(nome="NOME_COMUNE_PV_SELEZIONATO_Doc", tipo=TipoVariabile.SEMPLICE)
	private String comunePuntoVenditaSelezionato;

	@XmlVariabile(nome="COD_ISTAT_COMUNE_PV_SELEZIONATO_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codIstatComunePuntoVenditaSelezionato;
	
	@XmlVariabile(nome = "CATEGORIA_SOCIO_PV_SELEZIONATO_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="COD_TIPOLOGIA_FORNITURA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String tipologiaFornitura;	
	
	@XmlVariabile(nome="TIPOLOGIA_FORNITURA_Doc", tipo=TipoVariabile.SEMPLICE)	
	...
	@XmlVariabile(nome="TIPOLOGIA_OFFERTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeTipologiaOfferta;
	
	@XmlVariabile(nome="COD_TIPOLOGIA_OFFERTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String tipologiaOfferta;
	
	@XmlVariabile(nome="TIPOLOGIA_PROMOZIONE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeTipologiaPromozione;
	
	@XmlVariabile(nome="COD_TIPOLOGIA_PROMOZIONE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String tipologiaPromozione;

	@XmlVariabile(nome="MESE_RIF_TIPOLOGIA_OFFERTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String meseRifTipologiaOffertaForm;
	
	@XmlVariabile(nome="OFFERTA_MONO_BIORARIA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeTipologiaOffertaBiOrario;

	@XmlVariabile(nome="FLG_ENERGIA_VERDE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgAdesioneEnergiaVerde;

	@XmlVariabile(nome="COD_CRITTOGRAFATO_PROMO_AMICO_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="NRO_CARTA_SOCIO_COOP_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="NOME_CLIENTE_Doc", tipo = TipoVariabile.SEMPLICE)
	private String nomeCliente;
	
	@XmlVariabile(nome="COGNOME_CLIENTE_Doc", tipo = TipoVariabile.SEMPLICE)
	private String cognomeCliente;

	@XmlVariabile(nome="DES_CLIENTE_Doc", tipo = TipoVariabile.SEMPLICE)
	private String desCliente;

	@XmlVariabile(nome="LABEL_SOCIO_COOP_CLIENTE_Doc", tipo = TipoVariabile.SEMPLICE)
	private String labelSocioCoopDatiClienteForm;
	
	
	@XmlVariabile(nome="SOCIO_COOP_CLIENTE_Doc", tipo = TipoVariabile.SEMPLICE)
	private String flgSocioCoopCliente;

	@XmlVariabile(nome="STATO_NASCITA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeStatoNascitaCliente;
	
	@XmlVariabile(nome="COD_STATO_NASCITA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String statoNascitaCliente;
	
	@XmlVariabile(nome="COMUNE_NASCITA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeComuneNascitaCliente;

	@XmlVariabile(nome="COD_COMUNE_NASCITA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String comuneNascitaCliente;

	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DT_NASCITA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private Date dataNascitaCliente;
	
	@XmlVariabile(nome="SESSO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String sessoCliente;
	
	@XmlVariabile(nome="EMAIL_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String emailCliente;

	@XmlVariabile(nome="CELL_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String cellulareCliente;

	@XmlVariabile(nome="TIPO_DOCUMENTO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeTipoDocumentoCliente;
		
	@XmlVariabile(nome="COD_TIPO_DOCUMENTO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String tipoDocumentoCliente;

	@XmlVariabile(nome="NRO_DOCUMENTO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String numeroDocumentoCliente;
		
	@XmlVariabile(nome="ENTE_RILASCIO_DOCUMENTO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String enteRilascioDocumentoCliente;
	
	// Scadenza Documento	
	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DATA_SCADENZA_DOCUMENTO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private Date dataScadenzaDocumentoCliente;
	
     // Residenza
	@XmlVariabile(nome="COD_STATO_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String statoResidenzaCliente;	

	@XmlVariabile(nome="NOME_STATO_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeStatoResidenzaCliente;	

	@XmlVariabile(nome="COD_ISTAT_COMUNE_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String comuneResidenzaCliente;
	
	@XmlVariabile(nome="NOME_COMUNE_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeComuneResidenzaCliente;

	@XmlVariabile(nome="COD_ISTAT_REGIONE_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codIstatRegioneResidenzaCliente;

	@XmlVariabile(nome="DESC_REGIONE_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String descRegioneResidenzaCliente;

	@XmlVariabile(nome="DESC_PROVINCIA_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String descProvinciaResidenzaCliente;

	
	@XmlVariabile(nome="COD_COMUNE_ALG_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codComuneAlgResidenzaCliente;	
	
	@XmlVariabile(nome="INDIRIZZO_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String indirizzoResidenzaCliente;

	@XmlVariabile(nome="CIVICO_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String civicoResidenzaCliente;
	
	@XmlVariabile(nome="INTERNO_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String internoResidenzaCliente;
	
	@XmlVariabile(nome="APPENDICI_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String appendiciResidenzaCliente;

	@XmlVariabile(nome="CAP_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String capResidenzaCliente;

	@XmlVariabile(nome="CITTA_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String cittaResidenzaCliente;

	@XmlVariabile(nome="PROVINCIA_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String provinciaResidenzaCliente;
	
	@XmlVariabile(nome="FLG_DOMICILIO_UGUALE_RESIDENZA_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String flgDomicilioUgualeResidenzaDatiClienteForm;
	
	 // Domicilio
	@XmlVariabile(nome="COD_STATO_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String statoDomicilioCliente;	

	@XmlVariabile(nome="NOME_STATO_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeStatoDomicilioCliente;	

	@XmlVariabile(nome="COD_ISTAT_COMUNE_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String comuneDomicilioCliente;
	
	@XmlVariabile(nome="NOME_COMUNE_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeComuneDomicilioCliente;
	
	@XmlVariabile(nome="COD_ISTAT_REGIONE_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
    private String codIstatRegioneDomicilioCliente;

	@XmlVariabile(nome="DESC_REGIONE_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String descRegioneDomicilioCliente;

	@XmlVariabile(nome="DESC_PROVINCIA_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String descProvinciaDomicilioCliente;

	

	
	@XmlVariabile(nome="COD_COMUNE_ALG_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codComuneAlgDomicilioCliente;		
	
	@XmlVariabile(nome="INDIRIZZO_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String indirizzoDomicilioCliente;

	@XmlVariabile(nome="CIVICO_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String civicoDomicilioCliente;
	
	@XmlVariabile(nome="INTERNO_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String internoDomicilioCliente;
	
	@XmlVariabile(nome="APPENDICI_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String appendiciDomicilioCliente;
	
	@XmlVariabile(nome="CAP_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String capDomicilioCliente;
	
	@XmlVariabile(nome="CITTA_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String cittaDomicilioCliente;
	
	@XmlVariabile(nome="PROVINCIA_DOMICILIO_CLIENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="POD_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String podEE;

	@XmlVariabile(nome="FLG_DOMESTICO_RESIDENTE_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgDomensticoNonResidenteEE;

	@XmlVariabile(nome="POTENZA_DISPONIBILE_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String potenzaDisponibileEE;

	@XmlVariabile(nome="VALORE_POTENZA_IMPEGNATA_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String valorePotenzaImpegnataEE;

	@XmlVariabile(nome="POTENZA_IMPEGNATA_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String potenzaImpegnataEE;

	@XmlVariabile(nome="CONSUMO_ANNUO_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String consumoAnnuoEE;
	
	@XmlVariabile(nome="FLG_MERCATO_LIBERO_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgMercatoLiberoEE;

	@XmlVariabile(nome="FORNITORE_PRECEDENTE_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeFornitorePrecedenteEE;

	@XmlVariabile(nome="COD_FORNITORE_PRECEDENTE_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String fornitorePrecedenteEE;

	@XmlVariabile(nome="FLG_SERVIZIO_TUTELA_EE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgServizioTutelaEE;

	@XmlVariabile(nome="PDR_GAS_Doc", tipo=TipoVariabile.SEMPLICE)
	private String pdrGAS;

	@XmlVariabile(nome="CONSUMO_ANNUO_GAS_Doc", tipo=TipoVariabile.SEMPLICE)
	private String consumoAnnuoGAS;

	@XmlVariabile(nome="FLG_MERCATO_LIBERO_GAS_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgMercatoLiberoGAS;

	@XmlVariabile(nome="FORNITORE_PRECEDENTE_GAS_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeFornitorePrecedenteGAS;

	@XmlVariabile(nome="COD_FORNITORE_PRECEDENTE_GAS_Doc", tipo=TipoVariabile.SEMPLICE)
	private String fornitorePrecedenteGAS;

	@XmlVariabile(nome="FLG_SERVIZIO_TUTELA_GAS_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="FLG_MODALITA_RICEZIONE_DOCUMENTI_Doc", tipo=TipoVariabile.SEMPLICE)
	private String tipologiaModalitaRicezione;
	
	@XmlVariabile(nome="INDIRIZZO_EMAIL_RICEZIONE_DOCUMENTI_Doc", tipo=TipoVariabile.SEMPLICE)
	private String indirizzoEmailModalitaRicezione;
	
	@XmlVariabile(nome="COD_STATO_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String statoRicezionePosta;	

	@XmlVariabile(nome="NOME_STATO_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeStatoRicezionePosta;	

	@XmlVariabile(nome="COD_ISTAT_COMUNE_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String comuneRicezionePosta;
	
	@XmlVariabile(nome="NOME_COMUNE_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeComuneRicezionePosta;
	

	@XmlVariabile(nome="COD_ISTAT_REGIONE_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codIstatRegioneRicezionePosta;

	@XmlVariabile(nome="DESC_REGIONE_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String descRegioneRicezionePosta;

	@XmlVariabile(nome="DESC_PROVINCIA_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String descProvinciaRicezionePosta;

	@XmlVariabile(nome="INDIRIZZO_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String indirizzoRicezionePosta;

	@XmlVariabile(nome="CIVICO_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String civicoRicezionePosta;
	
	@XmlVariabile(nome="INTERNO_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String internoRicezionePosta;
	
	@XmlVariabile(nome="APPENDICI_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String appendiciRicezionePosta;
	
	@XmlVariabile(nome="CAP_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String capRicezionePosta;
	
	@XmlVariabile(nome="CITTA_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	private String cittaRicezionePosta;

	@XmlVariabile(nome="PROVINCIA_RICEZIONE_POSTA_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="MODALITA_PAGAMENTO_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nomeModalitaPagamento;
	
	@XmlVariabile(nome="COD_MODALITA_PAGAMENTO_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String modalitaPagamento;
	
	// Modalita' LIBRETTO SOCIO COOP
	@XmlVariabile(nome="NRO_LIBRETTO_SOCIO_COOP_Doc", tipo=TipoVariabile.SEMPLICE)		
	private String numeroLibrettoSocioCoop;
	
	@XmlVariabile(nome="INTESTATARIO_LIBRETTO_SOCIO_COOP_Doc", tipo=TipoVariabile.SEMPLICE)			
	private String intestatarioLibrettoSocioCoop;

	// Modalita' CONTO CORRENTE	
	@XmlVariabile(nome="CODICE_IBA_CONTO_CORRENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String codiceIBANContoCorrente;
	
	@XmlVariabile(nome="INTESTATARIO_CONTO_CORRENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	private String intestatarioContoCorrente;
	
	@XmlVariabile(nome="CF_INTESTATARIO_CONTO_CORRENTE_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="FLG_NOTA1_INFORMATIVA_PRIVACY_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgNota1InformativaPrivacyForm;
	
	@XmlVariabile(nome="FLG_NOTA2_INFORMATIVA_PRIVACY_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgNota2InformativaPrivacyForm;
	
	@XmlVariabile(nome="FLG_NOTA3_INFORMATIVA_PRIVACY_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgNota3InformativaPrivacyForm;
	
	@XmlVariabile(nome="FLG_NOTA4_INFORMATIVA_PRIVACY_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgNota4InformativaPrivacyForm;
	
	@XmlVariabile(nome="FLG_NOTA5_INFORMATIVA_PRIVACY_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgNota5InformativaPrivacyForm;
	
	@XmlVariabile(nome="FLG_NOTA6_INFORMATIVA_PRIVACY_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flgNota6InformativaPrivacyForm;
	
	@XmlVariabile(nome="FLG_NOTA7_INFORMATIVA_PRIVACY_Doc", tipo=TipoVariabile.SEMPLICE)
	...
	@XmlVariabile(nome="FLG_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String flgDatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="COGN_NOME_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nominativoClienteDatiCatastaliForm;
	
	@XmlVariabile(nome="COD_FISCALE_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String codiceFiscaleClienteDatiCatastaliForm;
	
	@XmlVariabile(nome="COD_ISTAT_COMUNE_NASCITA_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String comuneNascitaClienteDatiCatastaliForm;

	@XmlVariabile(nome="NOME_COMUNE_NASCITA_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nomeComuneNascitaClienteDatiCatastaliForm;

	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DATA_NASCITA_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private Date dataNascitaClienteDatiCatastaliForm;
	
	@XmlVariabile(nome="COD_ISTAT_COMUNE_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String comuneResidenzaClienteDatiCatastaliForm;
	
	@XmlVariabile(nome="NOME_COMUNE_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nomeComuneResidenzaClienteDatiCatastaliForm;
	
	@XmlVariabile(nome="INDIRIZZO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String viaResidenzaClienteDatiCatastaliForm;
	
	@XmlVariabile(nome="NRO_CIVICO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String civicoResidenzaClienteDatiCatastaliForm;
	
	// check 1
	@XmlVariabile(nome="FLG_PROP_IMMOBILE_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String flg1DatiCatastaliImmobileForm;
	
	// check 2
	@XmlVariabile(nome="FLG_INTESTATARIO_LOC_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String flg2DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="COD_ISTAT_COMUNE_REG_CONTRATTO_LOC_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String agenziaEntrateFlg2DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="NOME_COMUNE_REG_CONTRATTO_LOC_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nomeAgenziaEntrateFlg2DatiCatastaliImmobileForm;
	
	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DT_REG_CONTRATTO_LOC_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private Date dataRegistrazioneFlg2DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="NRO_REG_CONTRATTO_LOC_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String numeroRegistrazioneFlg2DatiCatastaliImmobileForm;
		
	// check 3
	@XmlVariabile(nome="FLG_INTESTATARIO_LOC_ERP_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String flg3DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="NRO_CONTRATTO_ERP_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String numeroContrattoConsegnaAbitazioneDatiCatastaliImmobileForm;
		
	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DT_CONTRATTO_ERP_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private Date dataContrattoConsegnaAbitazioneDatiCatastaliImmobileForm;
	
	// check 4
	@XmlVariabile(nome="FLG_COMODATARIO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String flg4DatiCatastaliImmobileForm;

	@XmlVariabile(nome="COD_ISTAT_COMUNE_REG_CONTRATTO_COM_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String agenziaEntrateFlg4DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="NOME_COMUNE_REG_CONTRATTO_COM_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nomeAgenziaEntrateFlg4DatiCatastaliImmobileForm;
	
	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DT_REG_CONTRATTO_COM_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private Date dataRegistrazioneFlg4DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="NRO_REG_CONTRATTO_COM_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String numeroRegistrazioneFlg4DatiCatastaliImmobileForm;
	 
	// check 5
	@XmlVariabile(nome="FLG_LEGITTIMO_TITOLO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)
	private String flg5DatiCatastaliImmobileForm;

	@XmlVariabile(nome="LEGITTIMO_TITOLO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String tipoTitoloDetenzioneDatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="N_ATTO_LEGITTIMO_TITOLO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String attoAcquisizioneDatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="COD_ISTAT_COMUNE_REG_ATTO_LEG_TIT_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String agenziaEntrateFlg5DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="NOME_COMUNE_REG_ATTO_LEG_TIT_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nomeAgenziaEntrateFlg5DatiCatastaliImmobileForm;
	
	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DT_REG_ATTO_LEG_TIT_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private Date dataRegistrazioneFlg5DatiCatastaliImmobileForm;
	
	@XmlVariabile(nome="N_REG_ATTO_LEG_TIT_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	...
	@XmlVariabile(nome="COD_COMUNE_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE) 
	private String codComuneCatastoClienteDatiCatastaliForm;

	// Tipo catasto
	@XmlVariabile(nome="TIPO_CATASTO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String tipoCatastoClienteDatiCatastaliForm;

	@XmlVariabile(nome="NOME_TIPO_CATASTO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String nomeTipoCatastoClienteDatiCatastaliForm;

	// Sezione catasto
	@XmlVariabile(nome="SEZIONE_CATASTO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String sezioneCatastoClienteDatiCatastaliForm;
			
	// Foglio catasto
	@XmlVariabile(nome="FOGLIO_CATASTO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String foglioCatastoClienteDatiCatastaliForm;
			
	// Numero sub catasto
	@XmlVariabile(nome="SUB_CATASTO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	private String subAlternoCatastoClienteDatiCatastaliForm;
			
	// Numero particella
	@XmlVariabile(nome="NRO_PART_CATASTO_DATI_CATASTALI_Doc", tipo=TipoVariabile.SEMPLICE)	
	...
	@TipoData(tipo = Tipo.DATA_SENZA_ORA)
	@XmlVariabile(nome="DATA_FIRMA_ALLEGATOC_Doc", tipo=TipoVariabile.SEMPLICE)
	private Date dataConsegnaContrattoAllegatoC;
	
	@XmlVariabile(nome="ORA_FIRMA_ALLEGATOC_Doc", tipo=TipoVariabile.SEMPLICE)
	private String oraConsegnaContrattoAllegatoC;
	
	@XmlVariabile(nome="NOME_COGNOME_VENDITORE_ALLEGATOC_Doc", tipo=TipoVariabile.SEMPLICE)
	private String nomeCognomeVenditoreAllegatoC;	
	
	@XmlVariabile(nome="FLG_CLIENTE_CONTATTATO_ALLEGATOC_Doc", tipo=TipoVariabile.SEMPLICE)
