 ...
 */
@XmlRootElement
@XmlType(name = "DmpkTitolarioCreafolderpianoclassifBean")
public class DmpkTitolarioCreafolderpianoclassifBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TITOLARIO_CREAFOLDERPIANOCLASSIF";
