 ...
 */
@XmlRootElement
@XmlType(name = "DmpkBmanagerTrovarichopbatchmassiveBean")
public class DmpkBmanagerTrovarichopbatchmassiveBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_BMANAGER_TROVARICHOPBATCHMASSIVE";
