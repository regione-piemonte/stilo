 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRepositoryGuiGetdatiudrispostaBean")
public class DmpkRepositoryGuiGetdatiudrispostaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_REPOSITORY_GUI_GETDATIUDRISPOSTA";
