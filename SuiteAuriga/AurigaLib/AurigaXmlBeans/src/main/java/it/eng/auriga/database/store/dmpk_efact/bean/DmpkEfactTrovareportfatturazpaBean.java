 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturazpaBean")
public class DmpkEfactTrovareportfatturazpaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZPA";
