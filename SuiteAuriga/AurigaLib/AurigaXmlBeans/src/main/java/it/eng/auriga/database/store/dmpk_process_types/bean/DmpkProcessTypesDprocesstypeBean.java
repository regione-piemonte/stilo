 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessTypesDprocesstypeBean")
public class DmpkProcessTypesDprocesstypeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESS_TYPES_DPROCESSTYPE";
