 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityDuserBean")
public class DmpkDefSecurityDuserBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_DUSER";
