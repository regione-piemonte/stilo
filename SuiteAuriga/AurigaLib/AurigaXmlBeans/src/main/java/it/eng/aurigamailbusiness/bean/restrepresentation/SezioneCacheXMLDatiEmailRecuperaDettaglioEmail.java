...
import it.eng.aurigamailbusiness.bean.restrepresentation.row.RigaAllegatoEmail;
import it.eng.aurigamailbusiness.bean.restrepresentation.row.RigaDestinatarioEmail;
import it.eng.aurigamailbusiness.bean.restrepresentation.row.RigaEmailCollegata;
import it.eng.aurigamailbusiness.bean.restrepresentation.row.RigaEmailPrecedente;
import it.eng.aurigamailbusiness.bean.restrepresentation.row.RigaEstremiDocEmail;
import it.eng.aurigamailbusiness.bean.restrepresentation.row.RigaIdEmailInoltrata;
import it.eng.aurigamailbusiness.bean.restrepresentation.row.RigaItemLavorazioneEmail;
import it.eng.document.TipoData;
import it.eng.document.TipoData.Tipo;
import it.eng.document.XmlVariabile;
import it.eng.document.XmlVariabile.TipoVariabile;

@XmlRootElement(name="dettaglioEmail")
public class SezioneCacheXMLDatiEmailRecuperaDettaglioEmail {
	...
	private String dataLock; //DataUtenteAssegnatario
	@XmlVariabile(nome = "OrarioLock", tipo = TipoVariabile.SEMPLICE)
	private String orarioLock; //OrarioUtenteAssegnatario
	...
	private List<RigaDestinatarioEmail> listaDestinatariPrincipali;
	...
	private List<RigaDestinatarioEmail> listaDestinatariCC;
	@XmlVariabile(nome = "@DestinatariCCN", tipo = TipoVariabile.LISTA)
	private List<RigaDestinatarioEmail> listaDestinatariCCN;
	@XmlVariabile(nome = "EmailPredecessore.ProgrMsg", tipo = TipoVariabile.SEMPLICE)
	private String emailPredecessoreProgrMsg;
	...
	private List<RigaEstremiDocEmail> listaEmailPredecessoreEstremiDocTrasmessi;
	@XmlVariabile(nome = "@EstremiDocTrasmessi", tipo = TipoVariabile.LISTA)
	private List<RigaEstremiDocEmail> listaEstremiDocTrasmessi;
	@XmlVariabile(nome = "@EstremiDocDerivati", tipo = TipoVariabile.LISTA)
	private List<RigaEstremiDocEmail> listaEstremiDocDerivati;
	@XmlVariabile(nome = "@Allegati", tipo = TipoVariabile.LISTA)
	private List<RigaAllegatoEmail> listaAllegati;
	@XmlVariabile(nome = "@ItemLavorazione", tipo = TipoVariabile.LISTA)
	private List<RigaItemLavorazioneEmail> listaItemLavorazione;
	@XmlVariabile(nome = "@EmailSuccessiveCollegate", tipo = TipoVariabile.LISTA)
	private List<RigaEmailCollegata> listaEmailSuccessiveCollegate;
	...
	private Date tsIns; //tsIns

	@XmlVariabile(nome = "@EmailPrecedentiCollegate", tipo = TipoVariabile.LISTA)
	private List<RigaEmailPrecedente> listaEmailPrecedentiCollegate;
	...
	private List<RigaIdEmailInoltrata> listaIdEmailInoltrate;
	...
	public List<RigaDestinatarioEmail> getListaDestinatariPrincipali() {
		return listaDestinatariPrincipali;
	}

	public void setListaDestinatariPrincipali(List<RigaDestinatarioEmail> listaDestinatariPrincipali) {
	...
	public List<RigaDestinatarioEmail> getListaDestinatariCC() {
		return listaDestinatariCC;
	}

	public void setListaDestinatariCC(List<RigaDestinatarioEmail> listaDestinatariCC) {
		this.listaDestinatariCC = listaDestinatariCC;
	}

	public List<RigaDestinatarioEmail> getListaDestinatariCCN() {
		return listaDestinatariCCN;
	}

	public void setListaDestinatariCCN(List<RigaDestinatarioEmail> listaDestinatariCCN) {
	...
	public List<RigaEstremiDocEmail> getListaEmailPredecessoreEstremiDocTrasmessi() {
		return listaEmailPredecessoreEstremiDocTrasmessi;
	}

	public void setListaEmailPredecessoreEstremiDocTrasmessi(List<RigaEstremiDocEmail> listaEmailPredecessoreEstremiDocTrasmessi) {
		this.listaEmailPredecessoreEstremiDocTrasmessi = listaEmailPredecessoreEstremiDocTrasmessi;
	}

	public List<RigaEstremiDocEmail> getListaEstremiDocTrasmessi() {
		return listaEstremiDocTrasmessi;
	}

	public void setListaEstremiDocTrasmessi(List<RigaEstremiDocEmail> listaEstremiDocTrasmessi) {
		this.listaEstremiDocTrasmessi = listaEstremiDocTrasmessi;
	}

	public List<RigaEstremiDocEmail> getListaEstremiDocDerivati() {
		return listaEstremiDocDerivati;
	}

	public void setListaEstremiDocDerivati(List<RigaEstremiDocEmail> listaEstremiDocDerivati) {
		this.listaEstremiDocDerivati = listaEstremiDocDerivati;
	}

	public List<RigaAllegatoEmail> getListaAllegati() {
		return listaAllegati;
	}

	public void setListaAllegati(List<RigaAllegatoEmail> listaAllegati) {
		this.listaAllegati = listaAllegati;
	}

	public List<RigaItemLavorazioneEmail> getListaItemLavorazione() {
		return listaItemLavorazione;
	}

	public void setListaItemLavorazione(List<RigaItemLavorazioneEmail> listaItemLavorazione) {
		this.listaItemLavorazione = listaItemLavorazione;
	}

	public List<RigaEmailCollegata> getListaEmailSuccessiveCollegate() {
		return listaEmailSuccessiveCollegate;
	}

	public void setListaEmailSuccessiveCollegate(List<RigaEmailCollegata> listaEmailSuccessiveCollegate) {
	...
	public void setTsIns(Date tsInsRegistrazione) {
		this.tsIns = tsInsRegistrazione;
	}

	public String getEmailPredecessoreProgrMsg() {
		return emailPredecessoreProgrMsg;
	}

	public void setEmailPredecessoreProgrMsg(String emailPredecessoreId) {
		this.emailPredecessoreProgrMsg = emailPredecessoreId;
	}
	...
	public List<RigaEmailPrecedente> getListaEmailPrecedentiCollegate() {
		return listaEmailPrecedentiCollegate;
	}

	public void setListaEmailPrecedentiCollegate(List<RigaEmailPrecedente> listaEmailPrecedentiCollegate) {
	...
	public void setDataLock(String dataUtenteAssegnatario) {
		this.dataLock = dataUtenteAssegnatario;
	}
	...
	public void setOrarioLock(String orarioUtenteAssegnatario) {
		this.orarioLock = orarioUtenteAssegnatario;
	}
	...
	public List<RigaIdEmailInoltrata> getListaIdEmailInoltrate() {
		return listaIdEmailInoltrate;
	}

	public void setListaIdEmailInoltrate(List<RigaIdEmailInoltrata> idEmailInoltrate) {
		this.listaIdEmailInoltrate = idEmailInoltrate;
	}
