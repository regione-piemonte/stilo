 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityDdatopograficoBean")
public class DmpkUtilityDdatopograficoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_DDATOPOGRAFICO";
