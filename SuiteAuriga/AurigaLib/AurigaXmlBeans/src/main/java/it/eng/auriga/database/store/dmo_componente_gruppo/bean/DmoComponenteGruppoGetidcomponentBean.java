 ...
 */
@XmlRootElement
@XmlType(name = "DmoComponenteGruppoGetidcomponentBean")
public class DmoComponenteGruppoGetidcomponentBean extends StoreBean implements Serializable{

	private static final String storeName = "DMO_COMPONENTE_GRUPPO_GETIDCOMPONENT";
