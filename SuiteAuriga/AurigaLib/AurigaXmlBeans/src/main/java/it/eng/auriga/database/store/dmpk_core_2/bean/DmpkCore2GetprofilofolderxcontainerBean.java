 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetprofilofolderxcontainerBean")
public class DmpkCore2GetprofilofolderxcontainerBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETPROFILOFOLDERXCONTAINER";
