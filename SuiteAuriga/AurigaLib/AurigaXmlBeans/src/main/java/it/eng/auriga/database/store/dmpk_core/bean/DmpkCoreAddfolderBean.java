 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreAddfolderBean")
public class DmpkCoreAddfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_ADDFOLDER";
