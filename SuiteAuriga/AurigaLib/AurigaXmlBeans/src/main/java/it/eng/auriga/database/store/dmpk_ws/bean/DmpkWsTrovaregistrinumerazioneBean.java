 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsTrovaregistrinumerazioneBean")
public class DmpkWsTrovaregistrinumerazioneBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_TROVAREGISTRINUMERAZIONE";
