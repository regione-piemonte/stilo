 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetdatiudBean")
public class DmpkWsGetdatiudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETDATIUD";
