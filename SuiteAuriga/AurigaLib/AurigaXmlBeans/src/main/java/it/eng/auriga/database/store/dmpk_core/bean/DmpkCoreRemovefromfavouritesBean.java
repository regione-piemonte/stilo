 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreRemovefromfavouritesBean")
public class DmpkCoreRemovefromfavouritesBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_REMOVEFROMFAVOURITES";
