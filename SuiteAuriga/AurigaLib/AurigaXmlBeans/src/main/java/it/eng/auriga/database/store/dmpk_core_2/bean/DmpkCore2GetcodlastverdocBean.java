 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetcodlastverdocBean")
public class DmpkCore2GetcodlastverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETCODLASTVERDOC";
