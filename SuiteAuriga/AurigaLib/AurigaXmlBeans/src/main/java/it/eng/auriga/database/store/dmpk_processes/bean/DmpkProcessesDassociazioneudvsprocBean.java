 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessesDassociazioneudvsprocBean")
public class DmpkProcessesDassociazioneudvsprocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESSES_DASSOCIAZIONEUDVSPROC";
