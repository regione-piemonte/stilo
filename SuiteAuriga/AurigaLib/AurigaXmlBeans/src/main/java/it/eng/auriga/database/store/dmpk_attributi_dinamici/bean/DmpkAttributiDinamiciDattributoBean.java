 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAttributiDinamiciDattributoBean")
public class DmpkAttributiDinamiciDattributoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ATTRIBUTI_DINAMICI_DATTRIBUTO";
