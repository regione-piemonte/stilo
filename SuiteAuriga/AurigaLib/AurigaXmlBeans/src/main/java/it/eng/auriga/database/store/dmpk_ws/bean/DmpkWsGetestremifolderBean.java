 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetestremifolderBean")
public class DmpkWsGetestremifolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETESTREMIFOLDER";
