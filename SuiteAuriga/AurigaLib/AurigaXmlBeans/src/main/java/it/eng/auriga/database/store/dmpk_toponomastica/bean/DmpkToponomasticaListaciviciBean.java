 ...
 */
@XmlRootElement
@XmlType(name = "DmpkToponomasticaListaciviciBean")
public class DmpkToponomasticaListaciviciBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TOPONOMASTICA_LISTACIVICI";
	...
	private java.math.BigDecimal idprocin;
    ...
    public java.math.BigDecimal getIdprocin(){return idprocin;}
    ...
    public void setIdprocin(java.math.BigDecimal value){this.idprocin=value;}
