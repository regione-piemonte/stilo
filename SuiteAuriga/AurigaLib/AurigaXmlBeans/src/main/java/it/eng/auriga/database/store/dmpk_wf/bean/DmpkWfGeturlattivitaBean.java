 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWfGeturlattivitaBean")
public class DmpkWfGeturlattivitaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WF_GETURLATTIVITA";
