 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityGetlistaiduosuperioriBean")
public class DmpkUtilityGetlistaiduosuperioriBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_GETLISTAIDUOSUPERIORI";
