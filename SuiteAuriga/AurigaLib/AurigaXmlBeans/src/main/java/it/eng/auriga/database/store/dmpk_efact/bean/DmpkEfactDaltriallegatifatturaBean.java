 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactDaltriallegatifatturaBean")
public class DmpkEfactDaltriallegatifatturaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_DALTRIALLEGATIFATTURA";
	...
	private java.math.BigDecimal idkeyin;
    ...
    public java.math.BigDecimal getIdkeyin(){return idkeyin;}
    ...
    public void setIdkeyin(java.math.BigDecimal value){this.idkeyin=value;}
