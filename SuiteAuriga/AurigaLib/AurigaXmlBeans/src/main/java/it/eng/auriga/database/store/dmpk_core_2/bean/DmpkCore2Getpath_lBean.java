 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2Getpath_lBean")
public class DmpkCore2Getpath_lBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETPATH_L";
