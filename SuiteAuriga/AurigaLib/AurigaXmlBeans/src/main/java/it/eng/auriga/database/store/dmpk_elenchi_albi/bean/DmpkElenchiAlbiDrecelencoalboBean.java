 ...
 */
@XmlRootElement
@XmlType(name = "DmpkElenchiAlbiDrecelencoalboBean")
public class DmpkElenchiAlbiDrecelencoalboBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ELENCHI_ALBI_DRECELENCOALBO";
