 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetpathBean")
public class DmpkCore2GetpathBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETPATH";
