 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2Recover_ud_doc_verBean")
public class DmpkCore2Recover_ud_doc_verBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_RECOVER_UD_DOC_VER";
