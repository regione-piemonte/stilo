 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreNavigarepositorytreeBean")
public class DmpkCoreNavigarepositorytreeBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_NAVIGAREPOSITORYTREE";
