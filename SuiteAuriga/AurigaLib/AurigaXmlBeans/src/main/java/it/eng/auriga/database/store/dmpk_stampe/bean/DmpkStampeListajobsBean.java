 ...
 */
@XmlRootElement
@XmlType(name = "DmpkStampeListajobsBean")
public class DmpkStampeListajobsBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_STAMPE_LISTAJOBS";
