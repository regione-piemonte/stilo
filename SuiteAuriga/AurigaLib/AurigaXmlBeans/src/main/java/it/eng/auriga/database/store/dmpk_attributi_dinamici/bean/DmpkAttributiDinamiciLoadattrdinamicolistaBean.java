 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAttributiDinamiciLoadattrdinamicolistaBean")
public class DmpkAttributiDinamiciLoadattrdinamicolistaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_ATTRIBUTI_DINAMICI_LOADATTRDINAMICOLISTA";
