 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovareportfatturaznopaBean")
public class DmpkEfactTrovareportfatturaznopaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAREPORTFATTURAZNOPA";
