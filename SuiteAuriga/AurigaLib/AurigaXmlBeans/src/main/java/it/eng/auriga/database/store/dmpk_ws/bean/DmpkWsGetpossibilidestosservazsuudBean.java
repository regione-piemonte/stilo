 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetpossibilidestosservazsuudBean")
public class DmpkWsGetpossibilidestosservazsuudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETPOSSIBILIDESTOSSERVAZSUUD";
