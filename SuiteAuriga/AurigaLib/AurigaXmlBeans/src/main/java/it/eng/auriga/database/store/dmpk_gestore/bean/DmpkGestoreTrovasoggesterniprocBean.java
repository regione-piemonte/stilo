 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGestoreTrovasoggesterniprocBean")
public class DmpkGestoreTrovasoggesterniprocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GESTORE_TROVASOGGESTERNIPROC";
