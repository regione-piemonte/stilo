 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityGetstoricoattrdateBean")
public class DmpkUtilityGetstoricoattrdateBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_GETSTORICOATTRDATE";
