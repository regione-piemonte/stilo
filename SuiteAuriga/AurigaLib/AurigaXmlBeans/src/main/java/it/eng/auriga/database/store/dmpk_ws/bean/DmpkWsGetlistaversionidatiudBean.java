 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsGetlistaversionidatiudBean")
public class DmpkWsGetlistaversionidatiudBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_GETLISTAVERSIONIDATIUD";
