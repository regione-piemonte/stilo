 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreLoaddettworkspaceBean")
public class DmpkCoreLoaddettworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_LOADDETTWORKSPACE";
