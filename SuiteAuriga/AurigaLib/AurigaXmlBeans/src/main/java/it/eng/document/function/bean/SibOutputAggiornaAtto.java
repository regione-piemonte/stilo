...
@XmlRootElement
public class SibOutputAggiornaAtto implements Serializable {

	private static final long serialVersionUID = 1L;

	private List<SibInputAggiornaAtto> list;
	private boolean ok;
	private String messaggio;
	private boolean timeout;
	private boolean rispostaNonRicevuta;

	public List<SibInputAggiornaAtto> getList() {
		return list;
	}

	public void setList(List<SibInputAggiornaAtto> list) {
		this.list = list;
	}
