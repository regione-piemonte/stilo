 ...
 */
@XmlRootElement
@XmlType(name = "DmpkLoginLoadinfolisteBean")
public class DmpkLoginLoadinfolisteBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_LOGIN_LOADINFOLISTE";
