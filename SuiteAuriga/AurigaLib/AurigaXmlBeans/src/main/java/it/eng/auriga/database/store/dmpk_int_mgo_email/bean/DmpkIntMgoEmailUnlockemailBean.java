 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailUnlockemailBean")
public class DmpkIntMgoEmailUnlockemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_UNLOCKEMAIL";
