 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilitySetvarcacheflussonavBean")
public class DmpkUtilitySetvarcacheflussonavBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_SETVARCACHEFLUSSONAV";
