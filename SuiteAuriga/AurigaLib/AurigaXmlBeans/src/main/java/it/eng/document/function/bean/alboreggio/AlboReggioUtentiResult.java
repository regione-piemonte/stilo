...
@XmlRootElement
public class AlboReggioUtentiResult implements Serializable {
	...
	private AlboReggioUtente[] payload;
	...
	public AlboReggioUtente[] getPayload() {
		return payload;
	}

	public void setPayload(AlboReggioUtente[] payload) {
