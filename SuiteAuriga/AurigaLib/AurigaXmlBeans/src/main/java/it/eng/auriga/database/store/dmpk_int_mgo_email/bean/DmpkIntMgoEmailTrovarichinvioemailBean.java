 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntMgoEmailTrovarichinvioemailBean")
public class DmpkIntMgoEmailTrovarichinvioemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_MGO_EMAIL_TROVARICHINVIOEMAIL";
