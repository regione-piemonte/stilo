 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetdefaultlibraryBean")
public class DmpkCoreGetdefaultlibraryBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETDEFAULTLIBRARY";
