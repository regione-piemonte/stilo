 ...
 */
@XmlRootElement
@XmlType(name = "DmpkTitolarioDpianoclassifBean")
public class DmpkTitolarioDpianoclassifBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TITOLARIO_DPIANOCLASSIF";
