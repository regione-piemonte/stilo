 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2RemovefromfavouritesBean")
public class DmpkCore2RemovefromfavouritesBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_REMOVEFROMFAVOURITES";
