 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovafatturaeventiBean")
public class DmpkEfactTrovafatturaeventiBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAFATTURAEVENTI";
