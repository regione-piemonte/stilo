 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2GetidlibraryBean")
public class DmpkCore2GetidlibraryBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_GETIDLIBRARY";
