 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetinheritedaclxfolderBean")
public class DmpkCoreGetinheritedaclxfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETINHERITEDACLXFOLDER";
