 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsRicercadoccontabiliBean")
public class DmpkWsRicercadoccontabiliBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_RICERCADOCCONTABILI";
