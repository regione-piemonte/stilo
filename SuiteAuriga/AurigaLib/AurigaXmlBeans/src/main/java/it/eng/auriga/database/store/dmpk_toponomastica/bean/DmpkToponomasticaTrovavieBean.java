 ...
 */
@XmlRootElement
@XmlType(name = "DmpkToponomasticaTrovavieBean")
public class DmpkToponomasticaTrovavieBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_TOPONOMASTICA_TROVAVIE";
