 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetidnodoBean")
public class DmpkCoreGetidnodoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETIDNODO";
