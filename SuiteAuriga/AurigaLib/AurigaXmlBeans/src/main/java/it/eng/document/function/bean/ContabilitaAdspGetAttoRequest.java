...
@XmlRootElement
public class ContabilitaAdspGetAttoRequest implements Serializable {
	...
	public String toString() {
		return "ContabilitaAdspGetAttoRequest [token=" + token + ", codiceFiscaleOp=" + codiceFiscaleOp + ", progAtto="
				+ progAtto + "]";
	}
