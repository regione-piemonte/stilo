 ...
 */
@XmlRootElement
@XmlType(name = "DmpkAmmTraspDsezioneBean")
public class DmpkAmmTraspDsezioneBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_AMM_TRASP_DSEZIONE";
