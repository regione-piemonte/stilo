 ...
 */
@XmlRootElement
@XmlType(name = "DmpkLoginGetusernamemailBean")
public class DmpkLoginGetusernamemailBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_LOGIN_GETUSERNAMEMAIL";
