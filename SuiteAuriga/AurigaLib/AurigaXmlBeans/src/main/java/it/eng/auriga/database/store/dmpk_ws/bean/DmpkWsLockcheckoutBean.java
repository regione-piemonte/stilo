 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsLockcheckoutBean")
public class DmpkWsLockcheckoutBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_LOCKCHECKOUT";
