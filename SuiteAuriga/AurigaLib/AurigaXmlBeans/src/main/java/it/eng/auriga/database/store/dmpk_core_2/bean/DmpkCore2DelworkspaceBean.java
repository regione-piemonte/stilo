 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2DelworkspaceBean")
public class DmpkCore2DelworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_DELWORKSPACE";
