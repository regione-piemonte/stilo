 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityDsezionaleBean")
public class DmpkUtilityDsezionaleBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_DSEZIONALE";
	...
	private java.math.BigDecimal idsezionalein;
    ...
    public java.math.BigDecimal getIdsezionalein(){return idsezionalein;}
    ...
    public void setIdsezionalein(java.math.BigDecimal value){this.idsezionalein=value;}
