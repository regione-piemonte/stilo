 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2AdddocBean")
public class DmpkCore2AdddocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_ADDDOC";
