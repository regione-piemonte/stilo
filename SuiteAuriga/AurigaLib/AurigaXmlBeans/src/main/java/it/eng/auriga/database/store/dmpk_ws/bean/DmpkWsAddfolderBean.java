 ...
 */
@XmlRootElement
@XmlType(name = "DmpkWsAddfolderBean")
public class DmpkWsAddfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_WS_ADDFOLDER";
