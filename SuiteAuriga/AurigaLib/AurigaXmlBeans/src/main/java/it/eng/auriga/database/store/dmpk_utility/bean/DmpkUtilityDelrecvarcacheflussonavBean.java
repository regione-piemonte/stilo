 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityDelrecvarcacheflussonavBean")
public class DmpkUtilityDelrecvarcacheflussonavBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_DELRECVARCACHEFLUSSONAV";
