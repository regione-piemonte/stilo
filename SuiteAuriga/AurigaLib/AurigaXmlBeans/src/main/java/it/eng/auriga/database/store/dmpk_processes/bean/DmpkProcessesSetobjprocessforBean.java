 ...
 */
@XmlRootElement
@XmlType(name = "DmpkProcessesSetobjprocessforBean")
public class DmpkProcessesSetobjprocessforBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_PROCESSES_SETOBJPROCESSFOR";
