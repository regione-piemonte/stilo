 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityGetstoricoattrtextBean")
public class DmpkUtilityGetstoricoattrtextBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_GETSTORICOATTRTEXT";
