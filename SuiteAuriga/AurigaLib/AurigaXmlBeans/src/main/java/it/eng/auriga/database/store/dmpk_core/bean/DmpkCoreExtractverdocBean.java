 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreExtractverdocBean")
public class DmpkCoreExtractverdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_EXTRACTVERDOC";
