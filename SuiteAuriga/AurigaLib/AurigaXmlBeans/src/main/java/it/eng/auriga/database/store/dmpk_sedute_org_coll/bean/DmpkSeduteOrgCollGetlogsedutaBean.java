 ...
 */
@XmlRootElement
@XmlType(name = "DmpkSeduteOrgCollGetlogsedutaBean")
public class DmpkSeduteOrgCollGetlogsedutaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_SEDUTE_ORG_COLL_GETLOGSEDUTA";
