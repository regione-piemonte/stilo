 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityCtrldatisoggesternoBean")
public class DmpkUtilityCtrldatisoggesternoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_CTRLDATISOGGESTERNO";
