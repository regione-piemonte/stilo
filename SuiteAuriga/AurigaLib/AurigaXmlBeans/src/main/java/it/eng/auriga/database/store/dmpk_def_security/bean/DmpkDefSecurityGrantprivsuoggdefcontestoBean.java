 ...
 */
@XmlRootElement
@XmlType(name = "DmpkDefSecurityGrantprivsuoggdefcontestoBean")
public class DmpkDefSecurityGrantprivsuoggdefcontestoBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_DEF_SECURITY_GRANTPRIVSUOGGDEFCONTESTO";
