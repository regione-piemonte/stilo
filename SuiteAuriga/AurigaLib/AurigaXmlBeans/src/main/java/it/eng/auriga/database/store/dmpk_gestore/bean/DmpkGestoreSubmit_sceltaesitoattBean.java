 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGestoreSubmit_sceltaesitoattBean")
public class DmpkGestoreSubmit_sceltaesitoattBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GESTORE_SUBMIT_SCELTAESITOATT";
