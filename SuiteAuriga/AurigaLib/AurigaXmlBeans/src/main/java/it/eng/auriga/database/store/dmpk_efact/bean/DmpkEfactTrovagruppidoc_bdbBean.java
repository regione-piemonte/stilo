 ...
 */
@XmlRootElement
@XmlType(name = "DmpkEfactTrovagruppidoc_bdbBean")
public class DmpkEfactTrovagruppidoc_bdbBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_EFACT_TROVAGRUPPIDOC_BDB";
