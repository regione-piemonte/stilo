...
@XmlRootElement
public class ContabilitaAdspUpdateRicRequest implements Serializable {
	...
	public String toString() {
		return "ContabilitaAdspUpdateRicRequest [token=" + token + ", codiceFiscaleOp=" + codiceFiscaleOp
				...
				+ progSogg + ", cig=" + cig + ", desCig=" + desCig + ", motivoNoCig=" + motivoNoCig + ", importo="
				+ importo + ", annoEse=" + annoEse + ", provenImporto=" + provenImporto + "]";
	}
