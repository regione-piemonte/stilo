...
package it.eng.auriga.database.store.dmpk_formati_el_ammessi.bean;
 ...
 */
@XmlRootElement
@XmlType(name = "DmpkFormatiElAmmessiDformatoelBean")
public class DmpkFormatiElAmmessiDformatoelBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_FORMATI_EL_AMMESSI_DFORMATOEL";
