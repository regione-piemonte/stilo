 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2UnlockdocBean")
public class DmpkCore2UnlockdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_UNLOCKDOC";
