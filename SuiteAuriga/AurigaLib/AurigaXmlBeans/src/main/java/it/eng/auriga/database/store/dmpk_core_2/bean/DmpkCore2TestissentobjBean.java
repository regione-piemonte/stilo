 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2TestissentobjBean")
public class DmpkCore2TestissentobjBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_TESTISSENTOBJ";
