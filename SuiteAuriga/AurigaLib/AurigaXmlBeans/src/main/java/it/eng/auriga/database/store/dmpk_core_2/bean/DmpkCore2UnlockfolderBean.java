 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCore2UnlockfolderBean")
public class DmpkCore2UnlockfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_2_UNLOCKFOLDER";
