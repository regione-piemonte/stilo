 ...
 */
@XmlRootElement
@XmlType(name = "DmpkModelliDocDmodelloBean")
public class DmpkModelliDocDmodelloBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_MODELLI_DOC_DMODELLO";
