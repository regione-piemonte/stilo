 ...
 */
@XmlRootElement
@XmlType(name = "DmpkRuoliAmmDruoloammBean")
public class DmpkRuoliAmmDruoloammBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_RUOLI_AMM_DRUOLOAMM";
