 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreUnlockworkspaceBean")
public class DmpkCoreUnlockworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_UNLOCKWORKSPACE";
