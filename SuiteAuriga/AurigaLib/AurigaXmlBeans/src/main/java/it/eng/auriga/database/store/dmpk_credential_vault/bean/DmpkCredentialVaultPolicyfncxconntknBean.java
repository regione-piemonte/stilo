 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCredentialVaultPolicyfncxconntknBean")
public class DmpkCredentialVaultPolicyfncxconntknBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CREDENTIAL_VAULT_POLICYFNCXCONNTKN";
