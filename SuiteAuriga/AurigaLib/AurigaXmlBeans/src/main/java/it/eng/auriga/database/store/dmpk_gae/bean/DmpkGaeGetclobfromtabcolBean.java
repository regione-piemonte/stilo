 ...
 */
@XmlRootElement
@XmlType(name = "DmpkGaeGetclobfromtabcolBean")
public class DmpkGaeGetclobfromtabcolBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_GAE_GETCLOBFROMTABCOL";
