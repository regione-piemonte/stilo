 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreTrovaworkspaceBean")
public class DmpkCoreTrovaworkspaceBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TROVAWORKSPACE";
