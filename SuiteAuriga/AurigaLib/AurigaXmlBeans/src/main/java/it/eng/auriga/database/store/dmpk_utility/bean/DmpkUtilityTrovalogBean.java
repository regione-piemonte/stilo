 ...
 */
@XmlRootElement
@XmlType(name = "DmpkUtilityTrovalogBean")
public class DmpkUtilityTrovalogBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_UTILITY_TROVALOG";
