 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreCheckoutdocBean")
public class DmpkCoreCheckoutdocBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_CHECKOUTDOC";
