 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreGetlivpathexfolderBean")
public class DmpkCoreGetlivpathexfolderBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_GETLIVPATHEXFOLDER";
