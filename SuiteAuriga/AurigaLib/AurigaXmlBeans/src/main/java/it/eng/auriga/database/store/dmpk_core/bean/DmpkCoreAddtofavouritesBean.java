 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreAddtofavouritesBean")
public class DmpkCoreAddtofavouritesBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_ADDTOFAVOURITES";
