 ...
 */
@XmlRootElement
@XmlType(name = "DmpkIntCsTrovaitempdvBean")
public class DmpkIntCsTrovaitempdvBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_INT_CS_TROVAITEMPDV";
