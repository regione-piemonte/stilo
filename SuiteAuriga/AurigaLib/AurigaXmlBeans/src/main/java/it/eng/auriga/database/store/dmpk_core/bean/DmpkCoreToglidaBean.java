 ...
 */
@XmlRootElement
@XmlType(name = "DmpkCoreToglidaBean")
public class DmpkCoreToglidaBean extends StoreBean implements Serializable{

	private static final String storeName = "DMPK_CORE_TOGLIDA";
