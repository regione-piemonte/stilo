...
public class LogErrori {
	...
	{			
		...
		//Inserisco il codice e il messaggio di errore nella mappa che a stata creata
	...
	public static int getMaximumErrorCode()
	{
		...
		{
			/*
			 * Se il codice di errore di questa entry a maggiore di quello massimo attuale
