...
//	private static Logger log = LogManager.getLogger(GestioneTerminazioneProgramma.class);
...
//		 * Inizialmente infatti il chiamante non potraa terminare ma dovraa aspettare
