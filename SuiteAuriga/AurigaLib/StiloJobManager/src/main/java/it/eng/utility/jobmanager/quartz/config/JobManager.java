...
public class JobManager {
	 ...
	 * startWithScheduler = true allora verra avviato rispettando la schedulazione indicata nel file di configurazione
	 * startWithScheduler = false allora verra avviato immediatamente ignorando la schedulazione inserita 
