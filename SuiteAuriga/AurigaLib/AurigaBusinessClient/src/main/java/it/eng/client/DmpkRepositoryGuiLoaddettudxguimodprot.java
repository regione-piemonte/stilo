 ...
 */
public class DmpkRepositoryGuiLoaddettudxguimodprot {
		
	private static final String SERVICE_NAME = "DmpkRepositoryGuiLoaddettudxguimodprot";	
	private static Logger mLogger = Logger.getLogger(DmpkRepositoryGuiLoaddettudxguimodprot.class);
