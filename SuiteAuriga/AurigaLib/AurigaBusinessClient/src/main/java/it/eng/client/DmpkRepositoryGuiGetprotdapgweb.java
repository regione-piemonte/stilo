 ...
 */
public class DmpkRepositoryGuiGetprotdapgweb {
		
	private static final String SERVICE_NAME = "DmpkRepositoryGuiGetprotdapgweb";	
	private static Logger mLogger = Logger.getLogger(DmpkRepositoryGuiGetprotdapgweb.class);
