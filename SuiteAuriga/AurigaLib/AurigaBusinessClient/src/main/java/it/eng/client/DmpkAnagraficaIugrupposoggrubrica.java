 ...
 */
public class DmpkAnagraficaIugrupposoggrubrica {
		
	private static final String SERVICE_NAME = "DmpkAnagraficaIugrupposoggrubrica";	
	private static Logger mLogger = Logger.getLogger(DmpkAnagraficaIugrupposoggrubrica.class);
