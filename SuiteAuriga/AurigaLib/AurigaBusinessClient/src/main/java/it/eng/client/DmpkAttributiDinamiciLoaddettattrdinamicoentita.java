 ...
 */
public class DmpkAttributiDinamiciLoaddettattrdinamicoentita {
		
	private static final String SERVICE_NAME = "DmpkAttributiDinamiciLoaddettattrdinamicoentita";	
	private static Logger mLogger = Logger.getLogger(DmpkAttributiDinamiciLoaddettattrdinamicoentita.class);
