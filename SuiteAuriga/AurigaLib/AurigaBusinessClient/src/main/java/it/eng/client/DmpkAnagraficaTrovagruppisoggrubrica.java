 ...
 */
public class DmpkAnagraficaTrovagruppisoggrubrica {
		
	private static final String SERVICE_NAME = "DmpkAnagraficaTrovagruppisoggrubrica";	
	private static Logger mLogger = Logger.getLogger(DmpkAnagraficaTrovagruppisoggrubrica.class);
