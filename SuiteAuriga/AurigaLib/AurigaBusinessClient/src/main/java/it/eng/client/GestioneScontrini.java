 ...
 */
public class GestioneScontrini {
		
	private static final String SERVICE_NAME = "GestioneScontrini";	
	...
	private BusinessType type = AurigaBusinessClientConfig.getInstance().getBusinesstype();  	
	 ...
	 //it.eng.document.function.bean.CreaModDocumentoOutBean 
  	 public it.eng.document.function.bean.CreaModDocumentoOutBean  creascontrino(Locale locale,it.eng.auriga.module.business.beans.AurigaLoginBean var2,it.eng.document.function.bean.CreaModFatturaScontrinoNespressoInBean var3,it.eng.document.function.bean.FilePrimarioBean var4,it.eng.document.function.bean.AllegatiBean var5) throws Exception {
		mLogger.debug("URL vale " + url);
		mLogger.debug("BusinessType vale " + type.name());
  	  	Type   outputType =	new TypeToken<it.eng.document.function.bean.CreaModDocumentoOutBean>() {}.getType();
  	  	return (it.eng.document.function.bean.CreaModDocumentoOutBean)FactoryBusiness.getBusiness(type).call(url, locale,it.eng.document.function.bean.CreaModDocumentoOutBean.class,outputType, SERVICE_NAME, "creaScontrino", var2,var3,var4,var5);
	 } 
	 //it.eng.document.function.bean.CreaModDocumentoOutBean 
