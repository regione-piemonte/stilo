 ...
 */
public class DmpkAttributiDinamiciGetxmlvaloriattrdinamici {
		
	private static final String SERVICE_NAME = "DmpkAttributiDinamiciGetxmlvaloriattrdinamici";	
	private static Logger mLogger = Logger.getLogger(DmpkAttributiDinamiciGetxmlvaloriattrdinamici.class);
