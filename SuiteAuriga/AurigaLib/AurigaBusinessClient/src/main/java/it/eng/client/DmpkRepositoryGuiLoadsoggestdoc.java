 ...
 */
public class DmpkRepositoryGuiLoadsoggestdoc {
		
	private static final String SERVICE_NAME = "DmpkRepositoryGuiLoadsoggestdoc";	
	private static Logger mLogger = Logger.getLogger(DmpkRepositoryGuiLoadsoggestdoc.class);
