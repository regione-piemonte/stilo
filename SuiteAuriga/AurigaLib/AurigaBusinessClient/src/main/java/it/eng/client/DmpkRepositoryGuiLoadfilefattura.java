 ...
 */
public class DmpkRepositoryGuiLoadfilefattura {
		
	private static final String SERVICE_NAME = "DmpkRepositoryGuiLoadfilefattura";	
	private static Logger mLogger = Logger.getLogger(DmpkRepositoryGuiLoadfilefattura.class);
