 ...
 */
public class DmpkAnagraficaTrovaindluoghisogg {
		
	private static final String SERVICE_NAME = "DmpkAnagraficaTrovaindluoghisogg";	
	private static Logger mLogger = Logger.getLogger(DmpkAnagraficaTrovaindluoghisogg.class);
