 ...
 */
public class DmpkRepositoryGuiGetlogudfascxguimodprot {
		
	private static final String SERVICE_NAME = "DmpkRepositoryGuiGetlogudfascxguimodprot";	
	private static Logger mLogger = Logger.getLogger(DmpkRepositoryGuiGetlogudfascxguimodprot.class);
