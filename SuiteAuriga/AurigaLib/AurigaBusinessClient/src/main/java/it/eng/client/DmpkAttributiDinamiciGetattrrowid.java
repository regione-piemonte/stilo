 ...
 */
public class DmpkAttributiDinamiciGetattrrowid {
		
	private static final String SERVICE_NAME = "DmpkAttributiDinamiciGetattrrowid";	
	private static Logger mLogger = Logger.getLogger(DmpkAttributiDinamiciGetattrrowid.class);
