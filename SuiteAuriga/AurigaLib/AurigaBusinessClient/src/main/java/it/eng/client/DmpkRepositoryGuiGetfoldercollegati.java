 ...
 */
public class DmpkRepositoryGuiGetfoldercollegati {
		
	private static final String SERVICE_NAME = "DmpkRepositoryGuiGetfoldercollegati";	
	private static Logger mLogger = Logger.getLogger(DmpkRepositoryGuiGetfoldercollegati.class);
