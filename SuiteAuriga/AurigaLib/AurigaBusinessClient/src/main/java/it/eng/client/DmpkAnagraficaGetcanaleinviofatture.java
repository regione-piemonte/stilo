 ...
 */
public class DmpkAnagraficaGetcanaleinviofatture {
		
	private static final String SERVICE_NAME = "DmpkAnagraficaGetcanaleinviofatture";	
	private static Logger mLogger = Logger.getLogger(DmpkAnagraficaGetcanaleinviofatture.class);
