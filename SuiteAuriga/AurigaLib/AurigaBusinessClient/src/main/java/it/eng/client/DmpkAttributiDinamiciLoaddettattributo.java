 ...
 */
public class DmpkAttributiDinamiciLoaddettattributo {
		
	private static final String SERVICE_NAME = "DmpkAttributiDinamiciLoaddettattributo";	
	private static Logger mLogger = Logger.getLogger(DmpkAttributiDinamiciLoaddettattributo.class);
