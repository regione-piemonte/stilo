 ...
 */
public class DmpkFormatiElAmmessiTestmimetypeforamm {
		
	private static final String SERVICE_NAME = "DmpkFormatiElAmmessiTestmimetypeforamm";	
	private static Logger mLogger = Logger.getLogger(DmpkFormatiElAmmessiTestmimetypeforamm.class);
