...
public class TMimetypeFmtDigId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2866617591659890469L;
	...
	public boolean equals(Object other) {
		...
		return ((this.getIdDigFormat() == castOther.getIdDigFormat())
				|| (this.getIdDigFormat() != null && castOther.getIdDigFormat() != null && this.getIdDigFormat().equals(castOther.getIdDigFormat())))
				&& ((this.getMimetype() == castOther.getMimetype())
						|| (this.getMimetype() != null && castOther.getMimetype() != null && this.getMimetype().equals(castOther.getMimetype())));
	}

	public int hashCode() {
		int result = 17;

		result = 37 * result + (getIdDigFormat() == null ? 0 : this.getIdDigFormat().hashCode());
