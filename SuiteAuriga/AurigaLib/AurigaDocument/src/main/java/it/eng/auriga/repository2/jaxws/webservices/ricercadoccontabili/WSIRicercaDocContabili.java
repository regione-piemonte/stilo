...
package it.eng.auriga.repository2.jaxws.webservices.ricercadoccontabili;
 ...
 *
 */
@WebService(targetNamespace = "http://ricercadoccontabili.webservices.repository2.auriga.eng.it")
@SOAPBinding(style = SOAPBinding.Style.DOCUMENT, use=SOAPBinding.Use.LITERAL, parameterStyle = SOAPBinding.ParameterStyle.BARE)
public interface WSIRicercaDocContabili{
	@WebMethod
