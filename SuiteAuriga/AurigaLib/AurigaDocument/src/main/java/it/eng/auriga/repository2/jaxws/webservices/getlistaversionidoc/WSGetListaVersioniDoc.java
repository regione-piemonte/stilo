...
@WebService(targetNamespace = "http://getlistaversionidoc.webservices.repository2.auriga.eng.it",  endpointInterface="it.eng.auriga.repository2.jaxws.webservices.getlistaversionidoc.WSIGetListaVersioniDoc", name = "WSGetListaVersioniDoc")
@MTOM(enabled = true, threshold = 0)

public class WSGetListaVersioniDoc extends JAXWSAbstractAurigaService implements WSIGetListaVersioniDoc{

    private final String K_SAVEPOINTNAME = "INIZIO_WSGetListaVersioniDoc";
   
    static Logger aLogger = Logger.getLogger(WSGetListaVersioniDoc.class.getName());    
    
    public WSGetListaVersioniDoc() {
	super();
    ...
    try {
        ...
        aLogger.error("WSGetListaVersioniDoc: " + excptn.getMessage(), excptn);
	...
	finally
	{
	    ...
	    aLogger.info("Fine WSGetListaVersioniDoc serviceImplementation");
	}
    }
