...
@WebService(targetNamespace = "http://ricercaattiperprogettollpp.webservices.repository2.auriga.eng.it",  endpointInterface="it.eng.auriga.repository2.jaxws.webservices.ricercaattiperprogettollpp.WSIRicercaAttiPerProgettoLLPP", name = "WSRicercaAttiPerProgettoLLPP")
@MTOM(enabled = true, threshold = 0)

public class WSRicercaAttiPerProgettoLLPP extends JAXWSAbstractAurigaService implements WSIRicercaAttiPerProgettoLLPP{

    private final String K_SAVEPOINTNAME = "INIZIO_WSRicAttiProgLLPP";
   
    static Logger aLogger = Logger.getLogger(WSRicercaAttiPerProgettoLLPP.class.getName());    
    
    public WSRicercaAttiPerProgettoLLPP() {
	super();
    ...
    try {
        ...
        aLogger.error("WSRicercaAttiPerProgettoLLPP: " + excptn.getMessage(), excptn);
	...
	finally
	{
	    ...
	    aLogger.info("Fine WSRicercaAttiPerProgettoLLPP serviceImplementation");
	}
    }
