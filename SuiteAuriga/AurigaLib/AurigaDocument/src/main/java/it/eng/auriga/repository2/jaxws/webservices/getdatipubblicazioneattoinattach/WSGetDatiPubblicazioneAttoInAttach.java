...
import it.eng.auriga.repository2.jaxws.webservices.getdatipubblicazioneatto.RelatePubblBean;
import it.eng.auriga.repository2.jaxws.webservices.getdatipubblicazioneatto.WSGetDatiPubblicazioneAttoBean;

/**
 * @author Ottavio passalacqua
 */

@WebService(targetNamespace = "http://getdatipubblicazioneattoinattach.webservices.repository2.auriga.eng.it",  endpointInterface="it.eng.auriga.repository2.jaxws.webservices.getdatipubblicazioneattoinattach.WSIGetDatiPubblicazioneAttoInAttach", name = "WSGetDatiPubblicazioneAttoInAttach")
@MTOM(enabled = true, threshold = 0)
@HandlerChain(file = "../common/handler.xml")
public class WSGetDatiPubblicazioneAttoInAttach extends JAXWSAbstractAurigaService implements WSIGetDatiPubblicazioneAttoInAttach{	

    private final String K_SAVEPOINTNAME = "INIZIO_WSGetDatiPubbAttoInAtt";
                                            
    static Logger aLogger = Logger.getLogger(WSGetDatiPubblicazioneAttoInAttach.class.getName());    
    
    public WSGetDatiPubblicazioneAttoInAttach() {
	super();
    ...
    try {
        ...
        aLogger.error("WSGetDatiPubblicazioneAttoInAttach: " + excptn.getMessage(), excptn);
	...
	finally
	{
	    ...
	    aLogger.info("Fine WSGetDatiPubblicazioneAttoInAttach serviceImplementation");
	}
