...
public class WSDeleteIstanzaApplEsterna extends JAXWSAbstractAurigaService implements WSIDeleteIstanzaApplEsterna{
    ...
    private String callWS(AurigaLoginBean loginBean, String xmlIn) throws Exception {    	    
    	aLogger.debug("Eseguo il WS DmpkWSDeleteIstanzaApplEsterna.");    	
    	String ret = null;    	
    	try {    		
    		  // Inizializzo l'INPUT    		
    		  ...
    		  StoreResultBean<DmpkWsDelapplicazioneesternaBean> lStoreResultBean = service.execute(loginBean, input);
			 ...
			 if(lStoreResultBean.getResultBean().getFlgtipodelout()!=null)
				ret = lStoreResultBean.getResultBean().getFlgtipodelout();
			 else
