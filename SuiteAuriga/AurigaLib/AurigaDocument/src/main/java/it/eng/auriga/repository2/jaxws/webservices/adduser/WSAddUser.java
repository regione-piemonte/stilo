...
@WebService(targetNamespace = "http://adduser.webservices.repository2.auriga.eng.it",  endpointInterface="it.eng.auriga.repository2.jaxws.webservices.adduser.WSIAddUser", name = "WSAddUser")
@MTOM(enabled = true, threshold = 0)

public class WSAddUser extends JAXWSAbstractAurigaService implements WSIAddUser{

    private final String K_SAVEPOINTNAME = "INIZIO_WSAddUser";
   
    static Logger aLogger = Logger.getLogger(WSAddUser.class.getName());    
    ...
    try {
        ...
        aLogger.error("WSAddUser: " + excptn.getMessage(), excptn);
	...
	finally
	{
	    ...
	    aLogger.info("Fine WSAddUser serviceImplementation");
	}
    }
