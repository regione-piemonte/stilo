 ...
 *
 */
@WebService(targetNamespace = "http://getdatipubblicazioneattoinattach.webservices.repository2.auriga.eng.it")
@SOAPBinding(style = SOAPBinding.Style.DOCUMENT, use=SOAPBinding.Use.LITERAL, parameterStyle = SOAPBinding.ParameterStyle.BARE)
public interface WSIGetDatiPubblicazioneAttoInAttach{
	@WebMethod
