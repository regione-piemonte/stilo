...
@XmlRootElement
public class AttachWSUpdUdBean implements Serializable{
	...
	//-	22: Data e ora della firma digitale della busta crittografica pi� esterna, se presente (nel formato DD/MM/RRR HH24:MI:SS)
	...
	//- 25: ID del documento di cui ri-controllare il file. -1 per indicare che e' un documento nuovo
	@NumeroColonna(numero = "25")
	private BigDecimal idDocumentoRectr;
	
	//-26: 0 se primario, altrimenti il numero di allegato. Se e' un NuovoAllegatoUD con NroAttachmentAssociato valorizzato (ovvero passato in attach) settare -1
	@NumeroColonna(numero = "26")
	private Integer nroAllegRectr; 
	
	//-27: Nro di versione del file da ricontrollare. -1 per indicare che e' un file nuovo passato in attach.
	...
	//- 29: Data e ora a cui controllare la validita' della firma (in formato FMT_STD_TIMESTAMP)
