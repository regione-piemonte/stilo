...
@Service(name = "GestioneFattureScontriniNespresso")
public class GestioneFattureScontriniNespresso extends GestioneDocumenti {
	
	private static Logger mLogger = Logger.getLogger(GestioneFattureScontriniNespresso.class);
	
	/********************************************
	 * Metodo per creare una fattura            *
	 ********************************************/
	
	@Operation(name = "creaFatturaNespresso")
	public CreaModDocumentoOutBean creaFatturaNespresso(AurigaLoginBean pAurigaLoginBean, CreaModFatturaScontrinoNespressoInBean pCreaFatturaInBean,  FilePrimarioBean pFilePrimarioBean, AllegatiBean pAllegatiBean) throws JAXBException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
	...
	/********************************************
	 * Metodo per modificare una fattura        *
	 ********************************************/

	@Operation(name = "modificaFatturaNespresso")
	public CreaModDocumentoOutBean modificaFatturaNespresso(AurigaLoginBean pAurigaLoginBean,  BigDecimal pIdUd, BigDecimal pIdDocPrimario,  CreaModFatturaScontrinoNespressoInBean pModificaDocumentoInBean, FilePrimarioBean pFilePrimarioBean, AllegatiBean pAllegatiBean) throws JAXBException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
		...
		try {
			...
			Transaction lTransaction = session.beginTransaction();
			try {
				manageAddUpdDocs(pAurigaLoginBean, pFilePrimarioBean, pAllegatiBean, lUpddocudBean, lXmlUtilitySerializer, idUd, idDocPrimario, lDocumentoXmlOutBean, versioni,  versioniDaRimuovere, allegatiDaRimuovere, session);
				lTransaction.commit();	
	...
	/********************************************
	 * Metodo per creare uno scontrino          *
	 ********************************************/
	
	@Operation(name = "creaScontrinoNespresso")
	public CreaModDocumentoOutBean creaScontrinoNespresso(AurigaLoginBean pAurigaLoginBean, CreaModFatturaScontrinoNespressoInBean pCreaScontrinoInBean,  FilePrimarioBean pFilePrimarioBean, AllegatiBean pAllegatiBean) throws JAXBException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
