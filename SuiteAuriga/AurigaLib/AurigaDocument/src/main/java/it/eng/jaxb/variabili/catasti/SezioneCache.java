...
public class SezioneCache {

    @XmlElement(name = "Variabile")
    protected List<SezioneCache.Variabile> variabile;
     ...
     * {@link SezioneCache.Variabile }
     * 
     * 
     */
    public List<SezioneCache.Variabile> getVariabile() {
        if (variabile == null) {
            variabile = new ArrayList<SezioneCache.Variabile>();
        }
    ...
    public static class Variabile {
        ...
        protected SezioneCache.Variabile.Lista lista;
         ...
         * @return
         *     possible object is
         *     {@link SezioneCache.Variabile.Lista }
         *     
         */
        public SezioneCache.Variabile.Lista getLista() {
            return lista;
        }
         ...
         *     
         */
        public void setLista(SezioneCache.Variabile.Lista value) {
            this.lista = value;
        }
        ...
        public static class Lista {
            ...
            protected List<SezioneCache.Variabile.Lista.Riga> riga;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link SezioneCache.Variabile.Lista.Riga }
             * 
             * 
             */
            public List<SezioneCache.Variabile.Lista.Riga> getRiga() {
                if (riga == null) {
                    riga = new ArrayList<SezioneCache.Variabile.Lista.Riga>();
                }
                return this.riga;
            }
            ...
            public static class Riga {
                ...
                protected List<SezioneCache.Variabile.Lista.Riga.Colonna> colonna;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link SezioneCache.Variabile.Lista.Riga.Colonna }
                 * 
                 * 
                 */
                public List<SezioneCache.Variabile.Lista.Riga.Colonna> getColonna() {
                    if (colonna == null) {
                        colonna = new ArrayList<SezioneCache.Variabile.Lista.Riga.Colonna>();
                    }
                    return this.colonna;
                }
