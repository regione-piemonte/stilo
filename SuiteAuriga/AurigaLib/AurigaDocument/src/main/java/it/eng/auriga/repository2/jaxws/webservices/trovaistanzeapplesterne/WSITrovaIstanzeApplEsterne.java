...
package it.eng.auriga.repository2.jaxws.webservices.trovaistanzeapplesterne;
 ...
 *
 */
@WebService(targetNamespace = "http://trovaistanzeapplesterne.webservices.repository2.auriga.eng.it")
@SOAPBinding(style = SOAPBinding.Style.DOCUMENT, use=SOAPBinding.Use.LITERAL, parameterStyle = SOAPBinding.ParameterStyle.BARE)
public interface WSITrovaIstanzeApplEsterne{
	@WebMethod
