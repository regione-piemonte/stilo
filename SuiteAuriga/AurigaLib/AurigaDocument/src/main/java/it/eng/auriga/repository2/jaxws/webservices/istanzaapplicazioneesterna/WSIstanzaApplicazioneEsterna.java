...
public class WSIstanzaApplicazioneEsterna extends JAXWSAbstractAurigaService implements WSIIstanzaApplicazioneEsterna{
    ...
    private String callWS(AurigaLoginBean loginBean, String xmlIn) throws Exception {    	    
    	aLogger.debug("Eseguo il WS DmpkWSIstanzaApplicazioneEsterna.");    	
    	String ret = null;    	
    	try {    		
    		  // Inizializzo l'INPUT    		
    		  ...
    		  StoreResultBean<DmpkWsAddupdapplicazioneesternaBean> lStoreResultBean = service.execute(loginBean, input);
