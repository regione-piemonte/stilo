...
package it.eng.auriga.repository2.jaxws.webservices.removeudfromfavourite;
 ...
 *
 */
@WebService(targetNamespace = "http://removeudfromfavourite.webservices.repository2.auriga.eng.it")
@SOAPBinding(style = SOAPBinding.Style.DOCUMENT, use=SOAPBinding.Use.LITERAL, parameterStyle = SOAPBinding.ParameterStyle.BARE)
public interface WSIRemoveUdFromFavourite{
	@WebMethod
