 ...
 *
 */
@Job(type = "CodaEXportJob_YUCCA")
@Named
public class CodaEXportJob_YUCCA extends AbstractJob<String> {
	private static final String fruitore="YUCCA";
	private static final String JOB_CLASS_NAME = CodaEXportJob_YUCCA.class.getName();
