 ...
 *
 */
@Job(type = "CodaEXportJob_GAMBUDGET")
@Named
public class CodaEXportJob_GAMBUDGET extends AbstractJob<String> {
	private static final String fruitore="GAMBUDGET";
	private static final String JOB_CLASS_NAME = CodaEXportJob_GAMBUDGET.class.getName();
