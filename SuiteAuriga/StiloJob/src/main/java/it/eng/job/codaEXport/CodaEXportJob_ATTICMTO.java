 ...
 *
 */
@Job(type = "CodaEXportJob_ATTICMTO")
@Named
public class CodaEXportJob_ATTICMTO extends AbstractJob<String> {
	private static final String fruitore="ATTICMTO";
	private static final String JOB_CLASS_NAME = CodaEXportJob_ATTICMTO.class.getName();
