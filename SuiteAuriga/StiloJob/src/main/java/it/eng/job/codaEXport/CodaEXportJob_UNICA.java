 ...
 *
 */
@Job(type = "CodaEXportJob_UNICA")
@Named
public class CodaEXportJob_UNICA extends AbstractJob<String> {
	private static final String fruitore="UNICA-SR";
	private static final String JOB_CLASS_NAME = CodaEXportJob_UNICA.class.getName();
