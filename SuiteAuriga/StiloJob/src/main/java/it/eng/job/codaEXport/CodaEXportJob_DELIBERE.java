 ...
 *
 */
@Job(type = "CodaEXportJob_DELIBERE")
@Named
public class CodaEXportJob_DELIBERE extends AbstractJob<String> {
	private static final String fruitore="DELIBERE";
	private static final String JOB_CLASS_NAME = CodaEXportJob_DELIBERE.class.getName();
