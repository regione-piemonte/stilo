 ...
 *
 */
@Job(type = "CodaEXportJob_GSA")
@Named
public class CodaEXportJob_GSA extends AbstractJob<String> {
	private static final String fruitore="GSA";
	private static final String JOB_CLASS_NAME = CodaEXportJob_GSA.class.getName();
