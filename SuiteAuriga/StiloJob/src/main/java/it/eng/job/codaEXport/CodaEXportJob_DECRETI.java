 ...
 *
 */
@Job(type = "CodaEXportJob_DECRETI")
@Named
public class CodaEXportJob_DECRETI extends AbstractJob<String> {
	private static final String fruitore="DECRETI";
	private static final String JOB_CLASS_NAME = CodaEXportJob_DECRETI.class.getName();
