 ...
 *
 */
@Job(type = "CodaEXportJob_ATTICOTO")
@Named
public class CodaEXportJob_ATTICOTO extends AbstractJob<String> {
	private static final String fruitore="ATTICOTO";
	private static final String JOB_CLASS_NAME = CodaEXportJob_ATTICOTO.class.getName();
