...
package it.eng.job.avanzamento;
...
public class VerificaAvanzamentoJob extends AbstractJob<String> {
	...
	private void elabora() throws Exception {
		...
		try {
			...
			String results1st = "AvanzamentoTask [COTO/CMTO]: sono presenti in stato EL numero record: "+results1.size();
			String resultsst = "AvanzamentoTask [COTO/CMTO]: sono presenti in stato  is null or 'KO' numero record: "+results.size();
			...
			String allTCodaXExportSTr = "BDC [COTO]: Sono presenti in stato  is null or 'KO' numero record: "+allTCodaXExport.size();
			...
			String allTCodaXExportSTr1 = "ATTI [COTO/CMTO/RP]: Sono presenti in stato  is null or 'KO' numero record: "+allTCodaXExport1.size();
