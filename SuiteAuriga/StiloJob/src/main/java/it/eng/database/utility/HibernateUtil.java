...
package it.eng.database.utility;
...
import it.eng.job.avanzamento.AvanzamentoJob;
...
public class HibernateUtil {
	...
	public static Session openSession(String jobName) throws Exception {
		...
		try {
            ...
            String resultsst ="openSession: "+e.getMessage();
            
            HibernateUtil hb = new HibernateUtil();
          
            String entityPackage = "it.eng.entity";
    		String hibernateConfigFile = "hibernate.cfg.xml";
    		HibernateUtil.setEntitypackage(entityPackage);
    		log.info("setEntitypackage");
    		HibernateUtil.buildSessionFactory(hibernateConfigFile, jobName);
    		log.info("buildSessionFactory: "+jobName);
    		SessionFactory ses =  getSessionFactory(jobName);
	...
	public static void setEntitypackage(String entitypackage) {
		if (HibernateUtil.entitypackage != null) {
			log.warn("s " + HibernateUtil.entitypackage + " to " + entitypackage);
		}
