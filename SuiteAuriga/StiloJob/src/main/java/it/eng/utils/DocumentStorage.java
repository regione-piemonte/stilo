...
public class DocumentStorage {
	...
	public static StorageService getStorage(final String storage) {
		StorageService storageService = StorageServiceImpl.newInstance(new GenericStorageInfo() {
			public String getUtilizzatoreStorageId() {
				...
				ModuleConfig mc = (ModuleConfig) SpringHelper.getMainApplicationContext().getBean("moduleConfigAdd");
