...
@Entity
@Table(name = "T_RICH_NOTIF_EMAIL")
public class TRichNotifEmail implements Serializable {
	...
	public TRichNotifEmail() {
		
	}
	
	public TRichNotifEmail(String idRichNotifica, BigDecimal idSpAoo, String triggerCondition , String destNotifica, 
			String subject, String stato, BigDecimal tryNum, Date tsIns, Date tsLastUpd) {
	...
	public TRichNotifEmail(String idRichNotifica, BigDecimal idSpAoo, BigDecimal IdProcess, BigDecimal idUd,
			...
			String stato, Date tsLastTry, BigDecimal tryNum, String msgErrInvio, Date tsInvio, 
			String mailMessAgeId, Date tsIns, BigDecimal idUserIns, Date tsLastUpd, BigDecimal idUserLastUpd) {
		this.idRichNotifica = idRichNotifica;
		this.idSpAoo = idSpAoo;
