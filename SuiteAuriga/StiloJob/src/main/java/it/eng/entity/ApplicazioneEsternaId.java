 ...
 */
@Embeddable
public class ApplicazioneEsternaId implements java.io.Serializable {
	...
	public ApplicazioneEsternaId() {
	}

	public ApplicazioneEsternaId(BigDecimal idSpAoo, String ciApplicazione) {
		this.idSpAoo = idSpAoo;
		this.ciApplicazione = ciApplicazione;
	}

	public ApplicazioneEsternaId(BigDecimal idSpAoo, String ciApplicazione, String ciIstanzaApplicazione) {
		this.idSpAoo = idSpAoo;
		this.ciApplicazione = ciApplicazione;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ApplicazioneEsternaId))
			return false;
		ApplicazioneEsternaId castOther = (ApplicazioneEsternaId) other;
	...
	public String toString() {
		return String.format("ApplicazioneEsternaId [idSpAoo=%s, ciApplicazione=%s, ciIstanzaApplicazione=%s]", idSpAoo, ciApplicazione,
