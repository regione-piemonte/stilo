 ...
 * Modificato da denis.bragato
 */
@Entity
@Table(name = "DMT_DIZIONARIO", 
	uniqueConstraints = @UniqueConstraint(columnNames = { "ID_SP_AOO", "DICTIONARY_ENTRY", "VALUE" })
)
public class DmtDizionario implements java.io.Serializable {
	...
	public String toString() {
		return String
				.format("DmtDizionario [idSpAoo=%s, dictionaryEntry=%s, value=%s, codValue=%s, explanation=%s, vincolatoAValGen=%s, dtInizioVld=%s, dtFineVld=%s, flgHidden=%s, flgLocked=%s, tsIns=%s, idUserIns=%s, tsLastUpd=%s, idUserLastUpd=%s]",
						idSpAoo, dictionaryEntry, value, codValue, explanation, vincolatoAValGen, dtInizioVld, dtFineVld, flgHidden,
						flgLocked, tsIns, idUserIns, tsLastUpd, idUserLastUpd);
	}
