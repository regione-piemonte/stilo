...
public class AllegatoOrdinanzaRequestBuilder extends DocumentRequestBuilder<DocumentoSemplicePropertiesType> {
    ...
    protected void doBuild(Map<String, String> dynamicAttributesMap, IdStatoDiEfficaciaType idStatoDiEfficaciaNonFirmatoType) {
    	...
    	if( dynamicAttributesMap.containsKey("oggetto") && dynamicAttributesMap.get("oggetto")!=null)
    		...
    		if( ente!=null && ente.equalsIgnoreCase("RP")){
    			documentoPropertiesType.setOggetto(EIntegrationResourceRP.ALLEGATO_ORDINANZA.name().toLowerCase());
    		}
    		if( ente!=null && ente.equalsIgnoreCase("CMTO")){
    			documentoPropertiesType.setOggetto(EIntegrationResourceCMTO.ALLEGATO_ORDINANZA_CMTO.name().toLowerCase());
    		}
    		if( ente!=null && ente.equalsIgnoreCase("COTO")){
    			documentoPropertiesType.setOggetto(EIntegrationResourceCOTO.ALLEGATO_ORDINANZA_COTO.name().toLowerCase());
    		}
    	}
