...
@Named
public class GeneraFileEsportazioneAsincronaJob extends it.eng.job.esportazioneAsincrona.GeneraFileEsportazioneAsincronaJob {
	...
	public String process()
		    throws Exception
		  {
			...
			input.setType("GeneraFileEsportazioneAsincronaJob");
			input.getAttributes().put("LuceneIndexingCategory", "RUBRICA");
