...
public class ImageIOHelper {     
	...
	private static Logger log = Logger.getLogger(ImageIOHelper.class.getName());	
	...
	public static List<File> createTiffFiles(File imageFile, int index) throws IOException { 
		log.debug("creo i file TIFF");
		System.out.println("CLASSPATH PRIMA DEL LANCIO: " + System.getProperty("java.class.path"));
...
//		}
 ...
 // main di test per classpath
  public static void main(String[] args) throws IOException {
	  ...
	  List<File> lista = ImageIOHelper.createTiffFiles(tif, -1);
