...
public class NoLoadScriptSecurity implements ScriptSecurity
{
    ...
    public NoLoadScriptSecurity(final String s) {
        this.se = new SecurityException(Messages.formatMessage("NoLoadScriptSecurity.error.no.script.of.type.allowed", new Object[] { s }));
    }
}
