...
public class DOMKeyboardEvent extends DOMUIEvent implements KeyboardEvent
{
    ...
    public void initKeyboardEvent(final String s, final boolean b, final boolean b2, final AbstractView abstractView, final String keyIdentifier, final int keyLocation, final String s2) {
        this.initUIEvent(s, b, b2, abstractView, 0);
        this.keyIdentifier = keyIdentifier;
        this.keyLocation = keyLocation;
        this.modifierKeys.clear();
        final String[] split = this.split(s2);
        for (int i = 0; i < split.length; ++i) {
            this.modifierKeys.add(split[i]);
        }
    }
    
    public void initKeyboardEventNS(final String s, final String s2, final boolean b, final boolean b2, final AbstractView abstractView, final String keyIdentifier, final int keyLocation, final String s3) {
