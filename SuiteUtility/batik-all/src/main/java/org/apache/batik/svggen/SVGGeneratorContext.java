...
public class SVGGeneratorContext implements ErrorConstants
{
    ...
    public static SVGGeneratorContext createDefault(final Document document) {
    ...
    static {
        ...
        for (int i = 1; i < SVGGeneratorContext.decimalFormats.length; ++i) {
            string += "#";
            SVGGeneratorContext.decimalFormats[i] = new DecimalFormat(string, SVGGeneratorContext.dsf);
        }
    }
