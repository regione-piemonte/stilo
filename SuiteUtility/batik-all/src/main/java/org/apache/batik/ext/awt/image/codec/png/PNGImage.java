...
class PNGImage extends SimpleRenderedImage
{
    ...
    public PNGImage(InputStream inputStream, PNGDecodeParam decodeParam) throws IOException {
    ...
    private static String getChunkType(final DataInputStream dataInputStream) {
        try {
            ...
            return "" + (char)(int1 >> 24) + (char)(int1 >> 16 & 0xFF) + (char)(int1 >> 8 & 0xFF) + (char)(int1 & 0xFF);
        }
        catch (Exception ex) {
            ex.printStackTrace();
            return null;
    ...
    private void parse_IHDR_chunk(final PNGChunk pngChunk) {
        ...
        if (this.emitProperties) {
            this.properties.put("color_type", PNGImage.colorTypeNames[this.colorType]);
        }
    ...
    private void parse_IEND_chunk(final PNGChunk pngChunk) throws Exception {
        ...
        final int n = (this.outputBands * this.width * bitDepth + 7) / 8;
        this.theTile = this.createRaster(this.width, this.height, this.outputBands, (bitDepth == 16) ? (n / 2) : n, bitDepth);
        ...
        if (this.colorType == 3 && !this.expandPalette) {
            ...
            this.colorModel = new IndexColorModel(this.bitDepth, array.length, array, array, array);
        }
        else {
    ...
    public static ColorModel createComponentColorModel(final SampleModel sampleModel) {
        ...
        if (dataType == 0) {
            switch (numBands) {
                case 1: {
                    colorModel = PNGImage.colorModelGray8;
                    break;
                }
                case 2: {
                    colorModel = PNGImage.colorModelGrayAlpha8;
                    break;
                }
                case 3: {
                    colorModel = PNGImage.colorModelRGB8;
                    break;
                }
                case 4: {
                    colorModel = PNGImage.colorModelRGBA8;
                    break;
                }
            }
        }
            ...
            switch (numBands) {
                case 1: {
                    colorModel = PNGImage.colorModelGray16;
                    break;
                }
                case 2: {
                    colorModel = PNGImage.colorModelGrayAlpha16;
                    break;
                }
                case 3: {
                    colorModel = PNGImage.colorModelRGB16;
                    break;
                }
                case 4: {
                    colorModel = PNGImage.colorModelRGBA16;
                    break;
                }
            }
        }
            ...
            switch (numBands) {
                case 1: {
                    colorModel = PNGImage.colorModelGray32;
                    break;
                }
                case 2: {
                    colorModel = PNGImage.colorModelGrayAlpha32;
                    break;
                }
                case 3: {
                    colorModel = PNGImage.colorModelRGB32;
                    break;
                }
                case 4: {
                    colorModel = PNGImage.colorModelRGBA32;
                    break;
                }
            }
        }
    ...
    private static void decodePaethFilter(final byte[] array, final byte[] array2, final int n, final int n2) {
        ...
        for (int j = n2; j < n; ++j) {
            array[j] = (byte)((array[j] & 0xFF) + PNGEncodeParam.paethPredictor(array[j - n2] & 0xFF, array2[j] & 0xFF, array2[j - n2] & 0xFF));
        }
    }
        ...
        switch (n) {
            ...
            case 7: {
                for (int x5 = 0; x5 < n5; ++x5) {
                    ...
                    if (this.performGammaCorrection) {
                        pixel2[0] = this.gammaLut[n11];
                        pixel2[1] = this.gammaLut[n12];
                        pixel2[2] = this.gammaLut[n13];
                    }
                    else {
                        pixel2[0] = n11;
                        pixel2[1] = n12;
    ...
    static {
        ...
        GrayBits8 = new int[] { 8 };
        colorModelGray8 = new ComponentColorModel(ColorSpace.getInstance(1003), PNGImage.GrayBits8, false, false, 1, 0);
        GrayAlphaBits8 = new int[] { 8, 8 };
        colorModelGrayAlpha8 = new ComponentColorModel(ColorSpace.getInstance(1003), PNGImage.GrayAlphaBits8, true, false, 3, 0);
        GrayBits16 = new int[] { 16 };
        colorModelGray16 = new ComponentColorModel(ColorSpace.getInstance(1003), PNGImage.GrayBits16, false, false, 1, 1);
        GrayAlphaBits16 = new int[] { 16, 16 };
        colorModelGrayAlpha16 = new ComponentColorModel(ColorSpace.getInstance(1003), PNGImage.GrayAlphaBits16, true, false, 3, 1);
        GrayBits32 = new int[] { 32 };
        colorModelGray32 = new ComponentColorModel(ColorSpace.getInstance(1003), PNGImage.GrayBits32, false, false, 1, 3);
        GrayAlphaBits32 = new int[] { 32, 32 };
        colorModelGrayAlpha32 = new ComponentColorModel(ColorSpace.getInstance(1003), PNGImage.GrayAlphaBits32, true, false, 3, 3);
        RGBBits8 = new int[] { 8, 8, 8 };
        colorModelRGB8 = new ComponentColorModel(ColorSpace.getInstance(1000), PNGImage.RGBBits8, false, false, 1, 0);
        RGBABits8 = new int[] { 8, 8, 8, 8 };
        colorModelRGBA8 = new ComponentColorModel(ColorSpace.getInstance(1000), PNGImage.RGBABits8, true, false, 3, 0);
        RGBBits16 = new int[] { 16, 16, 16 };
        colorModelRGB16 = new ComponentColorModel(ColorSpace.getInstance(1000), PNGImage.RGBBits16, false, false, 1, 1);
        RGBABits16 = new int[] { 16, 16, 16, 16 };
        colorModelRGBA16 = new ComponentColorModel(ColorSpace.getInstance(1000), PNGImage.RGBABits16, true, false, 3, 1);
        RGBBits32 = new int[] { 32, 32, 32 };
        colorModelRGB32 = new ComponentColorModel(ColorSpace.getInstance(1000), PNGImage.RGBBits32, false, false, 1, 3);
        RGBABits32 = new int[] { 32, 32, 32, 32 };
        colorModelRGBA32 = new ComponentColorModel(ColorSpace.getInstance(1000), PNGImage.RGBABits32, true, false, 3, 3);
    }
}
