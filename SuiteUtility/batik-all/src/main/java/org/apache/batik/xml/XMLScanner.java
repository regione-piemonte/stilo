...
public class XMLScanner implements Localizable
{
    ...
    public XMLScanner(final Reader reader) throws XMLException {
    ...
    public XMLScanner(final InputStream inputStream, final String s) throws XMLException {
        this.localizableSupport = new LocalizableSupport("org.apache.batik.xml.resources.Messages", XMLScanner.class.getClassLoader());
        this.buffer = new char[1024];
        this.context = 0;
        try {
    ...
    public int next(final int i) throws XMLException {
            ...
            case 60: {
                switch (this.nextChar()) {
                    case 63: {
                        ...
                        if (nextChar == -1 || !XMLUtilities.isXMLNameFirstCharacter((char)nextChar)) {
                            throw this.createXMLException("invalid.pi.target");
                        }
                        this.context = 2;
                        final int nextChar2 = this.nextChar();
                        if (nextChar2 == -1 || !XMLUtilities.isXMLNameCharacter((char)nextChar2)) {
                            return 5;
                        }
                        final int nextChar3 = this.nextChar();
                        if (nextChar3 == -1 || !XMLUtilities.isXMLNameCharacter((char)nextChar3)) {
                            return 5;
                        }
                        final int nextChar4 = this.nextChar();
                        ...
                        if (nextChar == 120 && nextChar2 == 109 && nextChar3 == 108) {
                            this.context = 3;
                            return 2;
                        }
                        if ((nextChar == 120 || nextChar == 88) && (nextChar2 == 109 || nextChar2 == 77) && (nextChar3 == 108 || nextChar3 == 76)) {
    ...
    protected int readIdentifier(final String s, final int n, final int n2) throws IOException, XMLException {
    ...
    protected int readName(final int n) throws IOException, XMLException {
        if (this.current == -1) {
            throw this.createXMLException("unexpected.eof");
        }
    ...
    protected int nextInElementDeclaration() throws IOException, XMLException {
        switch (this.current) {
            ...
            case 37: {
                this.nextChar();
                final int name = this.readName(34);
                if (this.current != 59) {
    ...
    protected int readReference() throws IOException, XMLException {
        ...
        if (this.current == 35) {
            ...
            final int name = this.readName(13);
            if (this.current != 59) {
                throw this.createXMLException("character.reference");
            }
            this.nextChar();
    ...
    protected XMLException createXMLException(final String s) {
        String formatMessage;
        try {
            formatMessage = this.formatMessage(s, new Object[] { new Integer(this.reader.getLine()), new Integer(this.reader.getColumn()) });
        }
        catch (MissingResourceException ex) {
            formatMessage = s;
        }
        return new XMLException(formatMessage);
    }
}
