...
public class ColorManager extends AbstractColorManager
{
    ...
    static {
        ...
        ColorManager.computedValues.put("black", ValueConstants.BLACK_RGB_VALUE);
        ColorManager.computedValues.put("silver", ValueConstants.SILVER_RGB_VALUE);
        ColorManager.computedValues.put("gray", ValueConstants.GRAY_RGB_VALUE);
        ColorManager.computedValues.put("white", ValueConstants.WHITE_RGB_VALUE);
        ColorManager.computedValues.put("maroon", ValueConstants.MAROON_RGB_VALUE);
        ColorManager.computedValues.put("red", ValueConstants.RED_RGB_VALUE);
        ColorManager.computedValues.put("purple", ValueConstants.PURPLE_RGB_VALUE);
        ColorManager.computedValues.put("fuchsia", ValueConstants.FUCHSIA_RGB_VALUE);
        ColorManager.computedValues.put("green", ValueConstants.GREEN_RGB_VALUE);
        ColorManager.computedValues.put("lime", ValueConstants.LIME_RGB_VALUE);
        ColorManager.computedValues.put("olive", ValueConstants.OLIVE_RGB_VALUE);
        ColorManager.computedValues.put("yellow", ValueConstants.YELLOW_RGB_VALUE);
        ColorManager.computedValues.put("navy", ValueConstants.NAVY_RGB_VALUE);
        ColorManager.computedValues.put("blue", ValueConstants.BLUE_RGB_VALUE);
        ColorManager.computedValues.put("teal", ValueConstants.TEAL_RGB_VALUE);
        ColorManager.computedValues.put("aqua", ValueConstants.AQUA_RGB_VALUE);
