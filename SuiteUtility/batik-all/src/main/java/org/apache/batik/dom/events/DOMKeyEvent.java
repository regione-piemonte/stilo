...
public class DOMKeyEvent extends DOMUIEvent
{
    ...
    public void initKeyEvent(final String s, final boolean b, final boolean b2, final boolean ctrlKey, final boolean altKey, final boolean shiftKey, final boolean metaKey, final int keyCode, final int charCode, final AbstractView abstractView) {
