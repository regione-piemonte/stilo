...
public class Scanner
{
    ...
    public Scanner(final Reader reader) throws ParseException {
    ...
    public Scanner(final InputStream inputStream, final String s) throws ParseException {
        this.buffer = new char[128];
        try {
                            ...
                            case 43: {
                                ...
                                for (int i = 0; i < 6; ++i) {
                                    ...
                                    switch (this.current) {
                                        ...
                                        default: {
                                            if (b && !ScannerUtilities.isCSSHexadecimalCharacter((char)this.current)) {
                                                throw new ParseException("character", this.reader.getLine(), this.reader.getColumn());
                                            }
                                            break;
                                        }
    ...
    protected int numberUnit(final boolean b) throws IOException {
        switch (this.current) {
            case 37: {
                this.nextChar();
                return 42;
