...
{
    public static SVGStringList getRequiredFeatures(final Element element) {
        throw new UnsupportedOperationException("SVGTests.getRequiredFeatures is not implemented");
    }
    
    public static SVGStringList getRequiredExtensions(final Element element) {
        throw new UnsupportedOperationException("SVGTests.getRequiredExtensions is not implemented");
    }
    
    public static SVGStringList getSystemLanguage(final Element element) {
        throw new UnsupportedOperationException("SVGTests.getSystemLanguage is not implemented");
    }
    
    public static boolean hasExtension(final Element element, final String s) {
