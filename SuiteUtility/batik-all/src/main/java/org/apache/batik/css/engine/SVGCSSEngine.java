...
public class SVGCSSEngine extends CSSEngine
{
    ...
    public SVGCSSEngine(final Document document, final ParsedURL parsedURL, final ExtendedParser extendedParser, final CSSContext cssContext) {
        super(document, parsedURL, extendedParser, SVGCSSEngine.SVG_VALUE_MANAGERS, SVGCSSEngine.SVG_SHORTHAND_MANAGERS, null, null, "style", null, "class", true, null, cssContext);
        this.lineHeightIndex = this.fontSizeIndex;
    }
    
    public SVGCSSEngine(final Document document, final ParsedURL parsedURL, final ExtendedParser extendedParser, final ValueManager[] array, final ShorthandManager[] array2, final CSSContext cssContext) {
        super(document, parsedURL, extendedParser, mergeArrays(SVGCSSEngine.SVG_VALUE_MANAGERS, array), mergeArrays(SVGCSSEngine.SVG_SHORTHAND_MANAGERS, array2), null, null, "style", null, "class", true, null, cssContext);
        this.lineHeightIndex = this.fontSizeIndex;
    }
    
    protected SVGCSSEngine(final Document document, final ParsedURL parsedURL, final ExtendedParser extendedParser, final ValueManager[] array, final ShorthandManager[] array2, final String[] array3, final String s, final String s2, final String s3, final String s4, final boolean b, final String s5, final CSSContext cssContext) {
        super(document, parsedURL, extendedParser, mergeArrays(SVGCSSEngine.SVG_VALUE_MANAGERS, array), mergeArrays(SVGCSSEngine.SVG_SHORTHAND_MANAGERS, array2), array3, s, s2, s3, s4, b, s5, cssContext);
        this.lineHeightIndex = this.fontSizeIndex;
    }
    
    protected static ValueManager[] mergeArrays(final ValueManager[] array, final ValueManager[] array2) {
        final ValueManager[] array3 = new ValueManager[array.length + array2.length];
        System.arraycopy(array, 0, array3, 0, array.length);
        System.arraycopy(array2, 0, array3, array.length, array2.length);
        return array3;
    }
    
    protected static ShorthandManager[] mergeArrays(final ShorthandManager[] array, final ShorthandManager[] array2) {
        final ShorthandManager[] array3 = new ShorthandManager[array.length + array2.length];
        System.arraycopy(array, 0, array3, 0, array.length);
        System.arraycopy(array2, 0, array3, array.length, array2.length);
        return array3;
    }
