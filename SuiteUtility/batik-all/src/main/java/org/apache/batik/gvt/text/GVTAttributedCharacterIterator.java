...
public interface GVTAttributedCharacterIterator extends AttributedCharacterIterator
{
    ...
    public static class TextAttribute extends Attribute
    {
        ...
        public TextAttribute(final String name) {
            super(name);
        }
        ...
        static {
            ...
            WRITING_MODE_LTR = new Integer(1);
            WRITING_MODE_RTL = new Integer(2);
            WRITING_MODE_TTB = new Integer(3);
            ORIENTATION_ANGLE = new Integer(1);
            ORIENTATION_AUTO = new Integer(2);
            SMALL_CAPS = new Integer(16);
