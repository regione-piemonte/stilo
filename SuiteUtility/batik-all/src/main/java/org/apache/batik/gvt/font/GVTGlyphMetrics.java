...
public class GVTGlyphMetrics
{
    ...
    public GVTGlyphMetrics(final float advance, final float verticalAdvance, final Rectangle2D bounds, final byte glyphType) {
        this.gm = new GlyphMetrics(advance, bounds, glyphType);
        this.verticalAdvance = verticalAdvance;
    }
