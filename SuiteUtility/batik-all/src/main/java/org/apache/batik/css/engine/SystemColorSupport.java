...
public class SystemColorSupport implements CSSConstants
{
    ...
    public static Value getSystemColor(String lowerCase) {
        lowerCase = lowerCase.toLowerCase();
        final SystemColor systemColor = SystemColorSupport.factories.get(lowerCase);
        return new RGBColorValue(new FloatValue((short)1, (float)systemColor.getRed()), new FloatValue((short)1, (float)systemColor.getGreen()), new FloatValue((short)1, (float)systemColor.getBlue()));
    }
