...
{
    public static void addSupportedFeatureStrings(final Set set) {
        set.add("org.w3c.svg");
        set.add("org.w3c.svg.static");
        set.add("org.w3c.svg.animation");
        set.add("org.w3c.svg.dynamic");
        set.add("org.w3c.svg.all");
        set.add("org.w3c.dom.svg");
        set.add("org.w3c.dom.svg.static");
        set.add("org.w3c.dom.svg.animation");
        set.add("org.w3c.dom.svg.dynamic");
        set.add("org.w3c.dom.svg.all");
        ...
        set.add("http://www.w3.org/TR/SVG11/feature#Xlink");
