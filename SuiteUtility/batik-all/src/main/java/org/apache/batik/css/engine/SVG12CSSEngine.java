...
public class SVG12CSSEngine extends SVGCSSEngine
{
    ...
    public SVG12CSSEngine(final Document document, final ParsedURL parsedURL, final ExtendedParser extendedParser, final CSSContext cssContext) {
        super(document, parsedURL, extendedParser, SVG12CSSEngine.SVG_VALUE_MANAGERS, SVG12CSSEngine.SVG_SHORTHAND_MANAGERS, cssContext);
        this.lineHeightIndex = 60;
    }
    
    public SVG12CSSEngine(final Document document, final ParsedURL parsedURL, final ExtendedParser extendedParser, final ValueManager[] array, final ShorthandManager[] array2, final CSSContext cssContext) {
        super(document, parsedURL, extendedParser, SVGCSSEngine.mergeArrays(SVG12CSSEngine.SVG_VALUE_MANAGERS, array), SVGCSSEngine.mergeArrays(SVG12CSSEngine.SVG_SHORTHAND_MANAGERS, array2), cssContext);
        this.lineHeightIndex = 60;
    }
