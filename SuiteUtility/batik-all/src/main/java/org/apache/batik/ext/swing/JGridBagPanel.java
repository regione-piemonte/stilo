...
public class JGridBagPanel extends JPanel implements GridBagConstants
{
    ...
    public void add(final Component comp, final int gridx, final int gridy, final int gridwidth, final int gridheight, final int anchor, final int fill, final double weightx, final double weighty) {
