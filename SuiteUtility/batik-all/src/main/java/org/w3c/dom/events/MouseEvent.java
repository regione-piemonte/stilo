...
public interface MouseEvent extends UIEvent
{
    ...
    void initMouseEventNS(final String p0, final String p1, final boolean p2, final boolean p3, final AbstractView p4, final int p5, final int p6, final int p7, final int p8, final int p9, final short p10, final EventTarget p11, final String p12);
}
