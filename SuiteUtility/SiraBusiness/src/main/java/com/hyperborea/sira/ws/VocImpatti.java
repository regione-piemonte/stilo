...
public class VocImpatti  extends com.hyperborea.sira.ws.VocabolariDiDominio  implements java.io.Serializable {
    ...
    /**
     * Gets the codDescrizione value for this VocImpatti.
     * 
    ...
    /**
     * Sets the codDescrizione value for this VocImpatti.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VocImpatti)) return false;
        VocImpatti other = (VocImpatti) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VocImpatti.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.sira.hyperborea.com/", "vocImpatti"));
