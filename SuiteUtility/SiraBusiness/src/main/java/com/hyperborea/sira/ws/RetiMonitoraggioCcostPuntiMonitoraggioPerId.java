/**
 * RetiMonitoraggioCcostPuntiMonitoraggioPerId.java
 *
...
public class RetiMonitoraggioCcostPuntiMonitoraggioPerId  implements java.io.Serializable {
    private com.hyperborea.sira.ws.RetiMonitoraggio retiMonitoraggio;

    public RetiMonitoraggioCcostPuntiMonitoraggioPerId() {
    }
    ...
    /**
     * Gets the retiMonitoraggio value for this RetiMonitoraggioCcostPuntiMonitoraggioPerId.
     * 
    ...
    /**
     * Sets the retiMonitoraggio value for this RetiMonitoraggioCcostPuntiMonitoraggioPerId.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetiMonitoraggioCcostPuntiMonitoraggioPerId)) return false;
        RetiMonitoraggioCcostPuntiMonitoraggioPerId other = (RetiMonitoraggioCcostPuntiMonitoraggioPerId) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetiMonitoraggioCcostPuntiMonitoraggioPerId.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.sira.hyperborea.com/", "retiMonitoraggioCcostPuntiMonitoraggioPerId"));
