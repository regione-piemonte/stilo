...
/**
 * VTipologieProvvedimenti generated by hbm2java
 */
@Entity
@Table(name = "V_TIPOLOGIE_PROVVEDIMENTI")
public class VTipologieProvvedimenti implements java.io.Serializable {
	...
	public VTipologieProvvedimenti() {
	}
