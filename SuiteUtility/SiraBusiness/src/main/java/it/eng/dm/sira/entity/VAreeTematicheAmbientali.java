...
/**
 * VAreeTematicheAmbientali generated by hbm2java
 */
@Entity
@Table(name = "V_AREE_TEMATICHE_AMBIENTALI")
public class VAreeTematicheAmbientali implements java.io.Serializable {
	...
	public VAreeTematicheAmbientali() {
	}
