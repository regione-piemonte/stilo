...
@XmlType(name = "IndUbiType", propOrder = { "codNazione", "desNazione", "codRegione", "desRegione", "codProvincia", "desProvincia", "codComune", "desComune", "codLocalita", "desLocalita", "codCAP", "desCAP", "codTipoVia", "desTipoVia", "codVia", "desVia", "codTipoCiv", "desTipoCiv", "descrizioneCivico", "numeroCivico", "suffisso", "scala", "piano", "interno", "lettera" })
public class IndUbiType
{
