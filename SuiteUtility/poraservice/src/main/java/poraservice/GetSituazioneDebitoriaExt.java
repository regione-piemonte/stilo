...
@XmlType(name = "", propOrder = { "multicompany", "filterTbl", "soggettoCOD", "fornituraCOD", "ruoloSoggettoCod", "nominativo", "podpdrCod", "dataIniEmis", "nonPagati", "ultimaFatt", "codiceFiscale", "partitaIVA", "dataScadenzaIni", "dataScadenzaFin" })
@XmlRootElement(name = "GetSituazioneDebitoriaExt")
public class GetSituazioneDebitoriaExt
{
