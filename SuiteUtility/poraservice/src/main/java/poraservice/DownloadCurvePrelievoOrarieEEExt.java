...
@XmlType(name = "", propOrder = { "multicompany", "soggettoCod", "ruolosoggCod", "nominativo", "codiceFiscale", "partitaIva", "soggCodAmm", "tipoServizioCod", "codicePDRPOD", "fornituraCod", "contrattoNum", "prodottoCod", "elencoStati", "periodoIni", "periodoFin", "tipoFile" })
@XmlRootElement(name = "DownloadCurvePrelievoOrarieEEExt")
public class DownloadCurvePrelievoOrarieEEExt
{
