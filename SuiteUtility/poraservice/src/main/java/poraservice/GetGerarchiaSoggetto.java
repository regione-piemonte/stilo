...
@XmlType(name = "", propOrder = { "multicompany", "soggettoCod", "ruolo" })
@XmlRootElement(name = "GetGerarchiaSoggetto")
public class GetGerarchiaSoggetto
{
    ...
    public void setRuolo(final String value) {
        this.ruolo = value;
    }
}
