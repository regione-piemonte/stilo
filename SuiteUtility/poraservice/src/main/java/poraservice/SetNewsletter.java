...
@XmlType(name = "", propOrder = { "multicompany", "soggettoCOD", "adesioneNewsLetter" })
@XmlRootElement(name = "SetNewsletter")
public class SetNewsletter
{
    @XmlElement(nillable = true)
    protected INFOMULTICOMPANY multicompany;
    @XmlElement(nillable = true)
    protected String soggettoCOD;
    protected Boolean adesioneNewsLetter;
    ...
    public Boolean isAdesioneNewsLetter() {
        return this.adesioneNewsLetter;
    }
    
    public void setAdesioneNewsLetter(final Boolean value) {
        this.adesioneNewsLetter = value;
    }
}
