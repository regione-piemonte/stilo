...
@XmlType(name = "", propOrder = { "multicompany", "soggettoCod", "ruoloSoggettoCod", "nominativo", "codiceFiscale", "fornituraCod", "contrattoNum", "prodottoCod", "elencoStati", "soggettoCodAmm", "partitaIVA", "tipoServizioCod", "codicePODPDR" })
@XmlRootElement(name = "DownloadEstrattoContoGenerale")
public class DownloadEstrattoContoGenerale
{
