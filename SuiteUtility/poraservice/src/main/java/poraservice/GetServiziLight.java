...
@XmlType(name = "", propOrder = { "multicompany", "soggettoCOD", "ruolosoggCOD", "nominativo", "codiceFiscale", "partitaIVA", "soggCodAmm", "tipoServizioCod", "codicePDRPOR", "fornituraCod", "contrattoNum", "prodottoCod", "elencoStati", "filter" })
@XmlRootElement(name = "GetServiziLight")
public class GetServiziLight
{
