...
public class Encryptor {
	...
	/**
	 * Questo metodo codifica il valore del pin che viene passato utilizzato dapprima la codifica in base 64 e, successivamente, codificando ogni valore con la
	 * rispettiva codifica ASCII
	 * 
	 ...
	 * 
	 * Viene passato come parametro il pin codificato e, dapprima si preleva ogni valore numerico, mentre successivamente si decodifica in base 64
	 */
	public static String decodificaConZero(String codifiedPin) {
		...
		String[] charBase64 = new String[codifiedPin.length() / 3]; // 3 è il numero di c aratteri con la quale viene codificato ogni valore
