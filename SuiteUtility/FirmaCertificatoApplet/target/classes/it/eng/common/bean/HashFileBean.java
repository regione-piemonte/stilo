...
public class HashFileBean implements Serializable {
	...
	public String getSubjectX500Principal() {
		return subjectX500Principal;
	}

	public void setSubjectX500Principal(String subjectX500Principal) {
		this.subjectX500Principal = subjectX500Principal;
	}

	@Override
	public String toString() {
		return "HashFileBean [fileName=" + fileName + ", tempFilePath=" + tempFilePath + ", signedFileName=" + signedFileName + ", id=" + id + ", versione="
				+ versione + ", fileType=" + fileType + ", hash=" + Arrays.toString(hash) + ", signedBean=" + signedBean + ", hashPdf="
				+ Arrays.toString(hashPdf) + ", firmatario=" + firmatario + ", status=" + status + ", idSmartCard=" + idSmartCard + ", isFirmaPresente="
				+ isFirmaPresente + ", isFirmaValida=" + isFirmaValida + ", metodoFirma=" + metodoFirma + ", subjectX500Principal=" + subjectX500Principal
				+ "]";
	}
