...
public class SignerObjectBean implements Serializable{
	...
	public String toString() {
		return "SignerObjectBean [digestAlgs=" + Arrays.toString(digestAlgs) + ", signerInfo=" + Arrays.toString(signerInfo) + ", certificates=" + certificates
				+ ", fileType=" + fileType + ", fileName=" + fileName + ", id=" + id + ", cert=" + Arrays.toString(cert) + ", crl=" + Arrays.toString(crl)
				+ ", marca=" + marca + "]";
	}
