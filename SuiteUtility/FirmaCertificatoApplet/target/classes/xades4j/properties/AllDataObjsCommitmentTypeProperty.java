...
/**
 * A commitment type that applies to all the signed data objects. The class has
...
{
    /**
     * Gets an {@code AllDataObjsCommitmentTypeProperty} representing the <i>Proof of origin</i>
    ...
    {
        return new AllDataObjsCommitmentTypeProperty(PROOF_OF_ORIGIN_URI, PROOF_OF_ORIGIN_DESC);
    }

    /**
     * Gets an {@code AllDataObjsCommitmentTypeProperty} representing the <i>Proof of receipt</i>
    ...
    {
        return new AllDataObjsCommitmentTypeProperty(PROOF_OF_RECEIPT_URI, PROOF_OF_RECEIPT_DESC);
    }

    /**
     * Gets an {@code AllDataObjsCommitmentTypeProperty} representing the <i>Proof of delivery</i>
    ...
    {
        return new AllDataObjsCommitmentTypeProperty(PROOF_OF_DELIVERY_URI, PROOF_OF_DELIVERY_DESC);
    }

    /**
     * Gets an {@code AllDataObjsCommitmentTypeProperty} representing the <i>Proof of sender</i>
    ...
    {
        return new AllDataObjsCommitmentTypeProperty(PROOF_OF_SENDER_URI, PROOF_OF_SENDER_DESC);
    }

    /**
     * Gets an {@code AllDataObjsCommitmentTypeProperty} representing the <i>Proof of approval</i>
    ...
    {
        return new AllDataObjsCommitmentTypeProperty(PROOF_OF_APPROVAL_URI, PROOF_OF_APPROVAL_DESC);
    }
    ...
    {
        return new AllDataObjsCommitmentTypeProperty(PROOF_OF_CREATION_URI, PROOF_OF_CREATION_DESC);
    }
    /**/
     ...
     */
    public AllDataObjsCommitmentTypeProperty(String uri, String description)
    {
        super(uri, description, TargetMultiplicity.ALL);
    }
}
