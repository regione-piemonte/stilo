 ...
 * @author Luís
 */
public class SignerBESTokenLess implements XadesSigner
{
    ...
    private byte[] canonicalizedOctetStream;

    @Inject
    protected SignerBESTokenLess(
            ...
            SignatureAppendingStrategy appendingStrategy) throws XAdES4jException
    {
        ...
        try
        {
            ...
            try
            {
                ...
                canonicalizedOctetStream = signature.getSignedInfo().getCanonicalizedOctetStream();
    ...
    public byte[] getCanonicalizedOctetStream() {
      return canonicalizedOctetStream;
    }
