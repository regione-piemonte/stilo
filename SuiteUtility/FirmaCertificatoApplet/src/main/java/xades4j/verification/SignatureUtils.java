   ...
   public  static class KeyInfoRes
    {
	    ...
	    public List<X509Certificate> keyInfoCerts;
        public X509CertSelector certSelector;
        public XMLX509IssuerSerial issuerSerial;
    ...
    public static KeyInfoRes processKeyInfo(
    ...
    /**************************************************************************/
    public static class ReferencesRes
    {
        ...
        public Reference signedPropsReference;
    ...
    public static ReferencesRes processReferences(
    ...
    public static void checkSignedPropertiesIncorporation(Element qualifyingPropsElem, Reference signedPropsRef) throws QualifyingPropertiesIncorporationException
    {
