...
public class AurigaProxyFileOutputProvider implements FileOutputProvider {
	...
	@Override
	public FileOutputProviderOperationResultEnum saveOutputFile(String idFile, InputStream in, String fileInputName, String tipoBusta, X509Certificate certificatoDiFirma, String... params)
	throws Exception {
