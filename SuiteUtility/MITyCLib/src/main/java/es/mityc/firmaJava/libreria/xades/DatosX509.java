...
public class DatosX509 {
	...
	private /*X500Principal*/String issuer = null;
	 ...
	 */
	public DatosX509 (String algMethod, String digestValue, BigInteger serial, /*X500Principal*/String issuer) {		
	 ...
	 * @return issuer
	 */
	public /*X500Principal*/String getIssuer() {
		return issuer;
	}
	 ...
	 * @param issuer
	 */
	public void setIssuer(/*X500Principal*/String issuer) {
		this.issuer = issuer;
	}
