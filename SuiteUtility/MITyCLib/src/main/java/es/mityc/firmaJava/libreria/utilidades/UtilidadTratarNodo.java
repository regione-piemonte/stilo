...
public class UtilidadTratarNodo {
	...
	public static final  Logger log = LogManager.getLogger(UtilidadTratarNodo.class);
	...
	/** Sentencia de selecciÃ³n de nodo por xpointer. */
	public static final String XPOINTER_ID  = "#xpointer(id('";
	/** Sentencia de selecciÃ³n del nodo raÃ­z por xpointer. */
	 ...
	 * 
	 * @param doc documento en el que se buscarÃ¡n los hijos (en cualquier profundidad)
	 ...
	 * @param nombreHijos nombre del tag de los hijos que se buscarÃ¡n
	 ...
	 * 
	 * Equivalente a la ejecuciÃ³n:
	 * <blockquote>
	 * obtenerByteNodo(Element padre, String ns, String nombreHijos, true)
	 * </blockquote>
	 * 
	 * @param padre nodo padre del que se buscarÃ¡n los hijos (en cualquier profundidad)
	 ...
	 * Devuelve en un array de bytes el contenido de los nodos indicados que sean hijos del nodo padre, y que se ajusten al namespace.
	 * 
	 * @param padre nodo padre del que se buscarÃ¡n los hijos (en la profundidad indicada entre 1 y 5)
	 * @param ns namespace en el que deben estar los hijos que se van a buscar (<code>null</code> si el mismo namespace que el nodo padre)
	 * @param nombreHijos nombre del tag de los hijos que se buscarÃ¡n
	 * @param requerido Si el valor es <code>true</code> y no se encuentra ningÃºn hijo lanzarÃ¡ excepciÃ³n
	 * @return byte array con el contenido de los nodos hijos, <code>null</code> si no tiene hijos y no es requerido
	 * @throws FirmaXMLError 
	 */
	 ...
	 * Devuelve en un array de bytes el contenido de los nodos indicados que sean hijos del nodo padre, y que se ajusten al namespace.
	 * 
	 * @param padre nodo padre del que se buscarÃ¡n los hijos (sÃ³lo en un nivel de profundidad)
	 * @param ns namespace en el que deben estar los hijos que se van a buscar (<code>null</code> si el mismo namespace que el nodo padre)
	 * @param nombreHijos nombre del tag de los hijos que se buscarÃ¡n
	 * @param tope Elemento en el que se para la bÃºsqueda (no se incluirÃ¡ en el array de bytes), <code>null</code> si no se quiere tope
	 * @return byte array con el contenido de los nodos hijos, <code>null</code> si no tiene hijos y no es requerido
	 * @throws FirmaXMLError 
	 */
	 ...
	 * 
	 * @param padre nodo padre del que se buscarÃ¡n los hijos (sÃ³lo en un nivel de profundidad)
	 * @param nombreHijos listado de elementos que se buscarÃ¡n (pareja de namespace y nombre del elemento)
	 * @param tope Elemento en el que se para la bÃºsqueda (no se incluirÃ¡ en el array de bytes), <code>null</code> si no se quiere tope
	 * @return byte array con el contenido de los nodos hijos, <code>null</code> si no tiene hijos y no es requerido
	 * @throws FirmaXMLError 
	 */
	...
	/**
	 * Devuelve un listado con los elementos quen siendo hijos del nodo padre tienen el nombre indicado y estÃ¡n antes del elemento tope.
	 * 
	 * @param padre nodo padre del que se buscarÃ¡n los hijos (sÃ³lo en un nivel de profundidad)
	 * @param tope Elemento en el que se para la bÃºsqueda (no se incluirÃ¡ en el listado), <code>null</code> si no se quiere tope
	 * @param nombreHijo Namespace y localname de los hijos que se buscarÃ¡n
	 ...
	 * @param padre nodo padre del que se buscarÃ¡n los hijos (sÃ³lo en un nivel de profundidad)
	 * @param tope Elemento en el que se para la bÃºsqueda (no se incluirÃ¡ en el listado), <code>null</code> si no se quiere tope
	 * @param nombreHijos listado de Namespace y localname de los hijos que se buscarÃ¡n
	 * @return listado con los elementos encontrados
	 * @throws FirmaXMLError 
	 */
	...
	/**
	 * Devuelve un array de bytes con el contenido de los elementos indicados (tras una canonalizaciÃ³n estÃ¡ndar).
	 * 
	...
	/**
	 * Devuelve un array de bytes con el contenido del elemento indicado (tras una canonalizaciÃ³n estÃ¡ndar).
	 * 
	 * @param nodos listado de elementos
	 * @return array de bytes 
	 */
	...
	/**
	 * Busca un nodo que tenga la Id indicada. Busca la id en cualquier atributo que tenga la forma Id, ID, Ã³ id.
	 * 
	 * @param doc Documento en el que buscar
	 * @param id Valor del atributo id del elemento a buscar
	 * @return el elemento con la id indicada, <code>null</code> si no hay ningÃºn elemento con esa id.
	 */
	public static Element getElementById(Document doc, String id) {
		if ((doc == null) || (id == null)) {
			return null;
		}
		// Si es id = "" lo toma como el nodo raÃ­z
		if (id.length() == 0) {
	...
	/**
	 * Busca un nodo que tenga la Id indicada que sea hijo del nodo indicado. Busca la id en cualquier atributo que tenga la forma Id, ID, Ã³ id.
	 * 
	 ...
	 * @param top Tope de elemento padre del que no se pasarÃ¡ buscando padres
	 * @return <code>true</code> si el hijo es hijo del padre 
	 */
	...
	/**
	 * Genera una nueva ID que no estÃ© siendo usada en el documento
	 * 
	 * @param doc
	 * @param prefix
	 * @return
	...
	/**
	 * MÃ©todo para obtener el primer nodo de tipo Element hijo del nodo dado. En la bÃºsqueda se
	 * excluyen los nodos de texto "vacÃ­os" (con caracteres de retorno de carro o espacios), los
	...
	/**
	 * MÃ©todo para obtener el primer nodo de tipo Element vecino del nodo dado. En la bÃºsqueda se
	 * excluyen nodos de texto "vacÃ­os" (con caracteres de retorno de carro o espacios), los
	 * nodos Attribute y los nodos de comentario
	 * 
	...
	/**
	 * Devuelve un listado con los elementos quen siendo hijos del nodo padre tienen el nombre indicado y estÃ¡n dentro del
	 * lÃ­mite establecido por tope.
	 * 
	 * @param padre nodo padre del que se buscarÃ¡n los hijos, nietos, bisnietos, etc... segÃºn el nivel de profundidad
	 * @param tope int Numero de niveles de profundidad para la bÃºsqueda mÃ­nimo 1 y mÃ¡ximo 5.
	 * @param nombreHijos Namespace y localname de los hijos que se buscarÃ¡n
	 * @return listado con los elementos encontrados
	 * @throws FirmaXMLError 
	 */
/*	public static ArrayList<Element> obtenerNodos(Element padre, int tope, NombreNodo nombreHijos) throws FirmaXMLError {
    	...
    	for (int i = 0; i < nodesHijos.getLength(); i++) {
    		...
    		// Busca el siguiente elemento (Se excluyen los demÃ¡s tipos de nodo)
    		if (nodo.getNodeType() != Node.ELEMENT_NODE)
    			continue;
...
/*                
	 ...
	 * @param padre nodo padre del que se buscarÃ¡n los hijos, nietos, bisnietos, etc... segÃºn el nivel de profundidad
	 * @param tope int Numero de niveles de profundidad para la bÃºsqueda mÃ­nimo 1 y mÃ¡ximo 5.
	 * @param nombreHijos localname de los hijos que se buscarÃ¡n
	 * @return listado con los elementos encontrados
	 * @throws FirmaXMLError 
	 */
    ...
    /**
     * <p>
     * Escribe el documento a un flujo de salida. Este mÃ©todo es la exposiciÃ³n
     * pÃºblica de un mÃ©todo de la libreria XMLSec de Apache. Este mÃ©todo no
     * aÃ±ade el preÃ¡mbulo de XML
     * </p>
     * 
     * @param document
     ...
     * <p>
     * Escribe el documento a un flujo de salida. Este mÃ©todo es la exposiciÃ³n
     * pÃºblica de un mÃ©todo de la libreria XMLSec de Apache.
     * </p>
     * 
     * @param document
     *            El documento a salvar
     ...
     *            El flujo de salida path del fichero donde se quiere escribir.
     * @param addPreamble
     *            Si se desea aÃ±adir el preÃ¡mbulo de XML.
     */
