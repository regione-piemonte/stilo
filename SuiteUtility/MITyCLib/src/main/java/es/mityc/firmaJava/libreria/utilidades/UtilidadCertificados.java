...
public class UtilidadCertificados {
     ...
     * @return
     */
    public static boolean isSameName(/*X500Principal*/String prin1, /*X500Principal*/String prin2) {
		//X509Name name1 = new X509Name(prin1.getName());
		//X509Name name2 = new X509Name(prin2.getName());
		return /*name1*/prin1.equals(/*name2*/prin2);
    }
    
    public static boolean isSameName1(/*X500Principal*/String prin1, /*X500Principal*/String prin2) {
		X500PrincipalBean bean1 = X500PrincipalBean.load( prin1 );
		X500PrincipalBean bean2 = X500PrincipalBean.load( prin2 );
