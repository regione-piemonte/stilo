...
/**
 * <p>Classe Java per DosignInvalidAuthenticationException complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="DosignInvalidAuthenticationException">
 *   &lt;complexContent>
...
@XmlType(name = "DosignInvalidAuthenticationException", propOrder = {
    "nestedExcMsg",
    "stackTraceMessage",
    "nestedExcClassName",
    "message"
})
public class DosignInvalidAuthenticationException {
