...
/**
 * <p>Classe Java per remoteAuthDto complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="remoteAuthDto">
 *   &lt;complexContent>
...
@XmlType(name = "remoteAuthDto", propOrder = {
    "username",
    "password",
    "pin"
})
@XmlSeeAlso({
    RemoteStartTransactionDto.class,
    RemoteOtpDto.class,
    RemoteCertsDto.class,
    RemoteEndTransactionDto.class,
    RemoteDigestDto.class,
