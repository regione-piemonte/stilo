...
import it.eng.hybrid.module.firmaCertificato.tool.PasswordHandler;
...
//			} catch(Exception e){}
	...
	public PrivateKeyAndCert getPrivateKeyAndCertByAlias(char[] pin, String alias) throws SmartCardException {
		try {
			provider.login(new Subject(), new PasswordHandler(pin));
