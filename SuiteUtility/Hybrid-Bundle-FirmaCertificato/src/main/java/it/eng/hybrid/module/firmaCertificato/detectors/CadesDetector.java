...
import it.eng.hybrid.module.firmaCertificato.outputFileProvider.LocalFileOutputProvider;
...
public class CadesDetector extends P7MDetector implements EnvelopeDetector{
	...
	public final static Logger logger = Logger.getLogger(CadesDetector.class);
...
//					hash = signer.getContentDigest();
	...
	public SignerType isSignedType(File file) {
		...
		try {
			...
			CMSSignedDataParser parser = InstanceCMSSignedDataParser.getCMSSignedDataParser(stream,false);
