...
import it.eng.hybrid.module.firmaCertificato.detectors.CadesDetector;
import it.eng.hybrid.module.firmaCertificato.detectors.EnvelopeDetector;
import it.eng.hybrid.module.firmaCertificato.detectors.P7MDetector;
import it.eng.hybrid.module.firmaCertificato.detectors.PadesDetetector;
		...
		if(dllFile.isFile()){	
			...
			if( osname.equals("windows") || 
				...
				try {
					...
					logger.info("Errore in init o getSlot - Provider non caricato ", e);
					finalizePkcs(pkcs11);
					throw e;
				}
