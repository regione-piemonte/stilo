package it.eng.hybrid.module.firmaCertificato.preferences;
...
public interface PreferenceKeys {
	...
	public final static String PROPERTY_CALLBACKCANCEL = "callBackCancel";
	public final static String PROPERTY_PIN="pin";
	public final static String PROPERTY_ALIAS="alias";
	public final static String PROPERTY_METODO_FIRMA="metodoFirma";
	...
	public final static String PROPERTY_DISABILITA_CONTROLLO_CERTIFICATO_SCADUTO = "disabilitaControlloCertificatoScaduto";
	
	public final static String PROPERTY_CTRL_USER_VS_CETIF_FIRMA_DIG_ATTIVATO = "ctrlUserVsCertifFirmaDigAttivato";
}
