...
public class OfficeDetector extends MimeDetector {
			...
			if (document==null)
				try {
					...
					if( e1.getMessage()!=null && 
							e1.getMessage().contains("The supplied spreadsheet seems to be an Encrypted .xlsx file")){
						coll.add(new MimeType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"));
					}
	...
	/*public static void main(String[] args) {
		OfficeDetector dt = new OfficeDetector();
		//File file = new File("C:/Users/TESAURO/Desktop/Allegato_1_ DEF_Scheda progetto dinamica PNRR_20200803.xlsx");
		File file = new File("C:/sviluppo/ws-fileop/TestFileop/src/test/resources/verificaFormato/testDocx.docx");
		System.out.println(dt.getMimeTypes(file));
	}
	*/
}
