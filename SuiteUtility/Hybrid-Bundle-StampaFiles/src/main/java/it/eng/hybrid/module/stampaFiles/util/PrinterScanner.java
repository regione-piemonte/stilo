package it.eng.hybrid.module.stampaFiles.util;
...
public class PrinterScanner {
	...
	public final static Logger logger = Logger.getLogger(PrinterScanner.class);
	...
	public List<String> printerAvailable(){
		logger.info("Cerco le stampanti disponibili");
		...
		logger.info("Stampanti disponibili: " + printers);
		return printers;
	}
