...
public class Messages {
	...
	public final static Logger logger = Logger.getLogger(Messages.class);
...
//			 }
			...
			if (input_stream == null)
				logger.info("Unable to open messages.properties from jar");
			...
			e.printStackTrace();
			logger.error("Exception "+e+" loading resource bundle.\n" +
