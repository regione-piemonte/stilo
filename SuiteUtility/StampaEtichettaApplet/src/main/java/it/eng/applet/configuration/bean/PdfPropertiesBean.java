package it.eng.applet.configuration.bean;
...
public class PdfPropertiesBean {
	...
	public String toString() {
		return "PdfPropertiesBean [pageHeight=" + pageHeight + ", pageWidth=" + pageWidth + ", margin=" + margin + ", fontFamily=" + fontFamily
				+ ", labelWithoutCodeVertical=" + labelWithoutCodeVertical + ", barCodeAlign=" + barCodeAlign + ", barcodeModuleWidth=" + barcodeModuleWidth
				+ ", barCodeWideFactor=" + barCodeWideFactor + ", barCodeQuietZoneValue=" + barCodeQuietZoneValue + ", barCodeHumanReadablePlacement="
				+ barCodeHumanReadablePlacement + ", barcodeMarginBottom=" + barcodeMarginBottom + ", barCodeQuietZoneEnabled=" + barCodeQuietZoneEnabled
				+ ", barCodeOrientation=" + barCodeOrientation + ", barCodeHeight=" + barCodeHeight + ", pdf147YHeight=" + pdf147YHeight
				+ ", pdf147AspectRatio=" + pdf147AspectRatio + ", pdf147ScalePercentX=" + pdf147ScalePercentX + ", pdf147ScalePercentY=" + pdf147ScalePercentY
				+ ", datamatrixHeight=" + datamatrixHeight + ", datamatrixWidth=" + datamatrixWidth + ", datamatrixWhitespace=" + datamatrixWhitespace
				+ ", qrCodeHeight=" + qrCodeHeight + ", qrCodeWidth=" + qrCodeWidth + ", qrCodeVertical=" + qrCodeVertical + ", qrCodeFaldoneHeight="
				+ qrCodeFaldoneHeight + ", qrCodeFaldoneWidth=" + qrCodeFaldoneWidth + ", qrCodeFaldoneVertical=" + qrCodeFaldoneVertical
				+ ", metodoStampaEtichette=" + metodoStampaEtichette + ", metodoStampaFile=" + metodoStampaFile + ", printableResolution=" + printableResolution
				+ ", renderImageType=" + renderImageType + ", antialias=" + antialias + ", alphaInterpolation=" + alphaInterpolation + ", colorRender="
				+ colorRender + ", dither=" + dither + ", fractionalMetrics=" + fractionalMetrics + ", interpolation=" + interpolation + ", render=" + render
				+ ", stroke=" + stroke + ", textAntialias=" + textAntialias + ", righe=" + righe + ", secondLabelRighe=" + secondLabelRighe
				+ ", repertorioLabelRighe=" + repertorioLabelRighe + ", faldoneLabelRighe=" + faldoneLabelRighe + "]";
	}
