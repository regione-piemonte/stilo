...
def Main():
    ...
    if len(args) == 0:
        ...
        if options.scan:
            ...
            # return PDFiD2String( PDFiD(args[0], options.all, options.extra, options.disarm, options.force), options.force)
            return PDFiD(args[0], options.all, options.extra, options.disarm, options.force)
    else:
        oParser.print_help()
        print ''
