 ...
 * in esso riferiti
 */
public class ProjectMacroDetector implements DynamicCodeDetector {
	...
	protected void containsMacro(File openOfficeFile, ValidationInfos validationInfos) throws IOException {
