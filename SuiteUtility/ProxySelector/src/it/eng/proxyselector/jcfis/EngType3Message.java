 ...
 */
public class EngType3Message extends EngNtlmMessage {
     ...
     */
    public EngType3Message(EngType2Message type2) {
     ...
     * taking place.
     */
    public EngType3Message(EngType2Message type2, String password, String domain,
...
*/
     ...
     * taking place.
     */
    public EngType3Message(int flags, byte[] lmResponse, byte[] ntResponse,
     ...
     */
    public EngType3Message(byte[] material) throws IOException {
        parse(material);
    }
     ...
     * @return An <code>int</code> containing the default flags.
     */
    public static int getDefaultFlags(EngType2Message type2) {
     ...
     * @return A <code>byte[]</code> containing the LanManager response.
     */
    public static byte[] getLMResponse(EngType2Message type2, String password) {
        if (type2 == null || password == null) return null;
        return NtlmPasswordAuthentication.getPreNTLMResponse(password,
                type2.getChallenge());
    }

    public static byte[] getLMv2Response(EngType2Message type2,
    ...
    public static byte[] getNTLMv2Response(EngType2Message type2,
                    byte[] responseKeyNT,
                    byte[] clientChallenge) {
     ...
     */
    public static byte[] getNTResponse(EngType2Message type2, String password) {
        if (type2 == null || password == null) return null;
