...
public final class MyProvider extends Provider
{
  ...
  /**
	...
	private static final String INFO = "MyXMLDSig (DOM XMLSignatureFactory; DOM KeyInfoFactory)";
	  ...
	  private static final String[] SYMMETRIC_CIPHERS = { "AES", "Camellia", "CAST5", "Grainv1", "Grain128", "IDEA", "Noekeon", "SEED" };
...
public MyProvider()
  {
    ...
    localHashMap.put("XMLSignatureFactory.DOM", "it.eng.utility.cryptosigner.provider.MyDOMXMLSignatureFactory");
...
//    localHashMap.put("TransformService.http://www.w3.org/TR/2001/REC-xml-c14n-20010315", "org.jcp.xml.dsig.internal.dom.DOMCanonicalXMLC14NMethod");
    localHashMap.put("TransformService.http://www.w3.org/TR/2001/REC-xml-c14n-20010315", "it.eng.utility.cryptosigner.provider.dom.DOMCanonicalXMLC14NMethod");
...
//    localHashMap.put("Signature.http://www.w3.org/2001/04/xmldsig-more#rsa-sha256", "org.bouncycastle.jce.provider.JDKDigestSignature$SHA256WithRSAEncryption");
//    localHashMap.put("http://www.w3.org/2001/04/xmldsig-more#rsa-sha384", "it.eng.utility.cryptosigner.provider.MyDOMSignatureMethod");
//    localHashMap.put("http://www.w3.org/2001/04/xmldsig-more#rsa-sha512", "it.eng.utility.cryptosigner.provider.MyDOMSignatureMethod");
    putAll(localHashMap);
    ...
    put("Cipher." + CryptoProObjectIdentifiers.gostR28147_gcfb, "org.bouncycastle.jce.provider.JCEBlockCipher$GOST28147cbc");
    ...
    put("Alg.Alias.KeyGenerator." + CryptoProObjectIdentifiers.gostR28147_gcfb, "GOST28147");
  ...
  private void addHMACAlias(String paramString, ASN1ObjectIdentifier paramDERObjectIdentifier)
  {
  ...
  {
	  /*Aggiunto*/
	  put("Signature.http://www.w3.org/2001/04/xmldsig-more#rsa-sha256", "org.jcp.xml.dsig.internal.dom.DOMSignatureMethod");
  ...
  private void addSignatureAlgorithm(String paramString1, String paramString2, String paramString3, ASN1ObjectIdentifier paramDERObjectIdentifier)
  {
