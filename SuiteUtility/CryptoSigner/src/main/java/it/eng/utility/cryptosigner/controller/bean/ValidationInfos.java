...
//	Object validatedObject;
	...
	List<ErrorBean> warningsBean = new ArrayList<ErrorBean>();
	
	String[] errors = null;
	List<ErrorBean> errorsBean = new ArrayList<ErrorBean>();
	...
	private boolean cannotExecute;//proprieta' che indica che il controllo non può essere eseguito per qualche errore
	...
	public void addWarningWithCode(String code, String message) {
		warningsBean.add( new ErrorBean( code, message ));
	}
	...
	public void addErrorWithCode(String errorCode, String error) {
		errorsBean.add( new ErrorBean(errorCode, error));
	}
	 ...
	 * @return errorsBean 
	 */
	public List<ErrorBean> getErrorsBean() {
		return errorsBean;
	}
	
	public List<ErrorBean> getWarningsBean() {
		return warningsBean;
	}
	...
	public String getErrorsBeanString() {
		...
		if (errors!=null) {
			for (int i=0; i<errorsBean.size(); i++) {
				errorsBuf.append(errorsBean.get(i));
...
//		return "[Validated " + validatedObject +"] warnings: " + warnings +", errors: " + errors +", isValid: " + isValid();
	...
	public boolean isCannotExecute() {
		return cannotExecute;
	}

	public void setWarningsBean(List<ErrorBean> warningsBean) {
		this.warningsBean = warningsBean;
	}

	public void setErrorsBean(List<ErrorBean> errorsBean) {
		this.errorsBean = errorsBean;
	}
	
	

//	public void setCannotEecute(boolean cannotEecute) {
//		this.cannotEecute = cannotEecute;
//	}
