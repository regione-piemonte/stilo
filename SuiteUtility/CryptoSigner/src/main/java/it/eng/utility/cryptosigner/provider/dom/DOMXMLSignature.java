...
public final class DOMXMLSignature extends DOMStructure implements XMLSignature {
	 ...
	 * @param objs
	 *            a list of <code>XMLObject</code>s or <code>null</code> if not specified. The list is copied to protect against subsequent modification.
	 * @param id
	...
	public class DOMSignatureValue extends DOMStructure implements SignatureValue {
		...
		DOMSignatureValue(Element sigValueElem) throws MarshalException {
			try {
				...
				log.warning("Base64DecodingException");
			}
