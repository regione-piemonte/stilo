...
import it.eng.client.applet.operation.detector.EnvelopeDetector;
import it.eng.client.applet.operation.detector.P7MDetector;
import it.eng.client.applet.operation.detector.PadesDetetector;
...
public class Factory {
	...
	private static File lastDll=null;

//	public static void main(String[] args) throws Exception {
//		AbstractSigner signer= Factory.getSigner(DigestAlgorithm.SHA1, SignerType.P7M,"94653500".toCharArray(),1,false);
//		Security.addProvider(new BouncyCastleProvider());
//		System.out.println(signer);
//		HashFileBean bean = new HashFileBean();
//		bean.setFileName("FILENAME");
//		bean.setFileType(SignerType.P7M);
//		bean.setHash("834785349853".getBytes());
//		bean.setHashPdf("4095345".getBytes());
//		signer.signerfile(bean, "94653500".toCharArray());
//	}
	 ...
	 */
	public static AbstractSigner[] getSigner( HashAlgorithm digest, SignerType signerType, char[] pin, int slot, boolean timemark) 
...
//			}
	...
	public static void main(String[] args) {
		...
		int slot = 0;
		SignerType signerType = SignerType.CAdES_BES;
		
		char[] pin = "12345".toCharArray();
		try {
			AbstractSigner[] absSigners = Factory.getSigner(digest , signerType , pin , slot , timemark );
			
			PrivateKeyAndCert[] listaPKC = null;
			for (AbstractSigner absSigner: absSigners) {
				try {
					listaPKC = absSigner.getPrivateKeyAndCert( pin );
