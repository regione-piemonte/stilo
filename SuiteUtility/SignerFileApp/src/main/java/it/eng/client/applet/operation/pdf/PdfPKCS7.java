...
public class PdfPKCS7 {
    ...
    public PdfPKCS7(byte[] contentsKey, String provider) {
        try {
            ...
            X509Principal issuer = new X509Principal(issuerAndSerialNumber.getObjectAt(0).toASN1Primitive().getEncoded(ASN1Encoding.DER));
...
//    }
     ...
     * @since	2.1.6
     */
    public byte[] getEncodedPKCS7(byte secondDigest[], Calendar signingTime, TSABouncy tsaClient) {
        try {
            if (externalDigest != null) {
                digest = externalDigest;
                if (RSAdata != null)
            ...
            if (secondDigest != null && signingTime != null) {
                signerinfo.add(new DERTaggedObject(false, 0, getAuthenticatedAttributeSet(secondDigest, signingTime, null)));
            }
            ...
            if (tsaClient != null) {
                ...
                byte[] tsToken = tsaClient.getTimeStampTokenExt(tsImprint);
                if (tsToken != null) {
            ...
            //TSAClientBouncyCastle dd;
            
//           if(token!=null){
//        	   ASN1EncodableVector unauthAttributes = buildUnauthenticatedAttributes(token.getEncoded());
//        	   if (unauthAttributes != null) {
//                 signerinfo.add(new DERTaggedObject(false, 1, new DERSet(unauthAttributes)));
//        	   }
//           }
