...
public class PdfArray {
    ...
    private static float[] byteStreamToFloatArray(char[] bts) {
        ...
        while(ptr<len){
            ...
            if(debug)
                System.out.println("ptr now="+ptr+ ' '+ bts[ptr]);
            ...
            if(debug)
                System.out.println("start val ptr now="+ptr+ ' '+ bts[ptr]);
            ...
            if(debug && ptr<len)
                System.out.println("end val ptr now="+ptr+ ' '+ bts[ptr]);

            int valLen=ptr-wStart;

            if(debug && ptr<len)
                System.out.println("len ptr now="+ptr+ ' '+ bts[ptr]+" valLen="+valLen);
