...
public interface AnnotationHandler {
    ...
    public void checkLinks(Map objs, boolean mouseClicked, PdfObjectReader pdfObjectReader, int x, int y, org.jpedal.examples.viewer.gui.SwingGUI currentGUI, org.jpedal.examples.viewer.Values commonValues);
