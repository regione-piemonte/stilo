...
public class PdfPageFormat
{
    ...
    /**
     * The purpose of this method is to create a <tt>PageFormat</tt> object that covers the correct printable area
     * of the given device.  Use this method to create paper in order to get Acrobat like results.
     * 
     * The size of the <tt>PageFormat</tt> is based on the given <tt>MediaSize</tt>.  
     * See http://download.oracle.com/javase/1.4.2/docs/api/javax/print/attribute/standard/MediaSize.html
     * 
     * @param mediaSize       The desired paper size (ie <tt>MediaSize.ISO.A4</tt>)
     * @param printingService The device to be printed to
...
//        else {
          ...
          if(areas[useArea]==null)
          	for(int i=0; i!=areas.length && areas[useArea]==null; i++)
          		useArea = i;
...
//        }
    ...
    /**
     * Find the default size for the given printer.  If the printer hasnt got a default it will figure
     * it out based on the locale.
     * 
     * @param printingDevice The <tt>PrintService</tt> to inspect
    ...
    /**
     * Find an the default MediaSizeName from the <tt>PrintService</tt>.  If there isnt a decent default one
     * available get one based on locale.
     * 
    ...
    /**
     * Used to create a set of available <tt>PageFormat</tt> based on what is available
     * on the given device.
     * 
     * @param printingDevice The <tt>PrintService</tt> to examine
     */
     ...
     * 
     * @param p				The page to examine by PDF page number.
     ...
     * 
     * @param cropW The desired paper width
     * @param cropH The desired paper height
     * @return
     */
     ...
     *
     * @param original		The current best fit <tt>PageFormat</tt> may be null.
     * @param newFormat     The <tt>PageFormat</tt> to compare against
     * @param cropW         The width of the PDF page
     * @param cropH         The height of the PDF page
