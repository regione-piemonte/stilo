...
{ 
	...
	private static final String BACK_TEXT = Messages.getMessage("PdfViewer.back");
	private static final String NEXT_TEXT = Messages.getMessage("PdfViewer.next");
	private static final String CANCEL_TEXT = Messages.getMessage("PdfViewer.cancel");
	private static final String FINISH_TEXT = Messages.getMessage("PdfViewer.finish");;
