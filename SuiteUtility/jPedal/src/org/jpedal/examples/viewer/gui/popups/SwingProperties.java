...
//		Switch between idependent and properties dependent 
		...
		public ButtonBarPanel(JPanel toolbar) {
            ...
            addButton(Messages.getMessage("PdfPreferences.NetworkTitle"), "/org/jpedal/examples/viewer/res/interface.png", createNetworkSettings(), toolbar, group);

            addButton(Messages.getMessage("PdfPreferences.SignatureTitle"), "/org/jpedal/examples/viewer/res/buttonsigner.png", createSignatureSettings(), toolbar, group);
