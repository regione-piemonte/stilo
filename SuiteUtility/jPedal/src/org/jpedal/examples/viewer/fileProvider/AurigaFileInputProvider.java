...
public class AurigaFileInputProvider implements FileInputProvider {
	...
	public FileInputResponse getFile(PreferenceManager preferenceManager) throws Exception {
		...
		try {
        	...
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_AURIGAHOST + ": " + aurigaHost );
        } catch (Exception e) {}
		
		String aurigaPort=null;
		try {
			aurigaPort = preferenceManager.getConfiguration().getString( ConfigConstants.PROPERTY_AURIGAPORT );
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_AURIGAPORT + ": " + aurigaPort );
        } catch (Exception e) {}
		...
		try {
        	...
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_CODICEAPPLICAZIONE + ": " + codiceApplicazione );
        } catch (Exception e) {}
		...
		try {
        	...
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_CODICEISTANZAAPPLICAZIONE + ": " + istanzaApplicazione );
        } catch (Exception e) {}
		
		String username = null;
		try {
			username = preferenceManager.getConfiguration().getString( ConfigConstants.PROPERTY_AURIGAUSERNAME );
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_AURIGAUSERNAME + ": " + username );
        } catch (Exception e) {}
		
		String password = null;
		try {
			password = preferenceManager.getConfiguration().getString( ConfigConstants.PROPERTY_AURIGAPASSWORD );
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_AURIGAPASSWORD + ": " + password );
        } catch (Exception e) {}
		
		String idDocumento = null;
		try {
			idDocumento = preferenceManager.getConfiguration().getString( ConfigConstants.PROPERTY_AURIGAIDDOCUMENTO );
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_AURIGAIDDOCUMENTO + ": " + idDocumento );
        } catch (Exception e) {}
		...
		try {
        	...
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_AURIGAIDVERSIONEDOCUMENTO + ": " + idVersione );
        } catch (Exception e) {}
		...
		try {
        	...
        	LogWriter.writeLog("Parametro " + ConfigConstants.PROPERTY_AURIGANUMEROALLEGATO + ": " + numeroAllegato );
        } catch (Exception e) {}
