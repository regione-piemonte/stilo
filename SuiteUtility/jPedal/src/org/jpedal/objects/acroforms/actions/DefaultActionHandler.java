    ...
    public void changeTo(String file, int page, Object location, Integer type,boolean storeView) {
        ...
        if (file != null) {
            try {
                ...
                org.jpedal.examples.viewer.gui.SwingGUI gui = ((org.jpedal.examples.viewer.gui.SwingGUI) decode_pdf.getExternalHandler(Options.SwingContainer));
                if(gui!=null){
                    gui.stopThumbnails();
        ...
        if(type!=null){
            ...
            if(swingGUI!=null){
                if(type <0){
                    ...
                    ((org.jpedal.examples.viewer.gui.SwingGUI)swingGUI).setSelectedComboItem(org.jpedal.examples.viewer.Commands.SCALING,type.toString());
                }
            }
        }
