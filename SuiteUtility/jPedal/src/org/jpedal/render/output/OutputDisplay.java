                ...
                if(fileType.equals("ttf") && !fontName.contains(",")){  //truetype tidied up to TT
                    ...
                    try {
                        ...
                        if(enableOTFConversion){
                            rawFontData=org.jpedal.fonts.HTMLFontUtils.convertPSForHTMLOTF(pdfFont,fontName,rawFontData,fileType, widths.get(fontName));
                            fileType = "otf";
                        }
                        else{
                            rawFontData=org.jpedal.fonts.HTMLFontUtils.convertPSForHTMLWOFF(pdfFont,fontName,rawFontData,fileType, widths.get(fontName));
                            fileType = "woff";
                        }
