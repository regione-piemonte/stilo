...
@XmlRootElement(name = "GetDwsMetaDataResponse")
public class GetDwsMetaDataResponse {

    @XmlElement(name = "GetDwsMetaDataResult")
    ...
    public void setGetDwsMetaDataResult(String value) {
        this.getDwsMetaDataResult = value;
    }
