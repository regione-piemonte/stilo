...
import it.eng.areas.hybrid.module.cryptoLight.signers.CMSSignedHelper;
...
public class CMSUtils
{
	...
	throws NoSuchProviderException
	{
		...
		{
			Provider[] prov = Security.getProviders(providerName);
	 ...
	 * @throws Exception
	 */
//	public static  CMSSignedData buildFileSigned(SignerObjectBean bean,List<HashFileBean> hashFiles )throws Exception{
...
//		for(HashFileBean hashFile : hashFiles){
//        	if(hashFile.getId().equals(bean.getId())){
//        		ret = new FileElaborate();
//        		ret.setId( hashFile.getId() );
//        		ret.setUnsigned( new File( hashFile.getFilePath() ));
//        		break;
//        	}
//        }
//
...
//
//		DLSet digest = (DLSet)new ASN1InputStream(bean.getDigestAlgs()).readObject();
//		DLSet signerInfos = (DLSet)new ASN1InputStream(bean.getSignerInfo()).readObject();
//
//
...
//	}
	...
	public static OutputStream addSignerInfo(File inputFile,
		...
		CMSSignedDataParser cmsSignedData = InstanceCMSSignedDataParser.getCMSSignedDataParser(FileUtils.openInputStream(inputFile),false);
