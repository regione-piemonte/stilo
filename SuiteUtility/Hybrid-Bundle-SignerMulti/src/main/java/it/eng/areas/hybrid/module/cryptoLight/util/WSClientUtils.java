...
public class WSClientUtils {
	...
	public static File sbustaEConvertiFile( File fileInput, String fileName ) throws Exception{
		...
		try {
			...
			logger.info( "Proprietà " + PreferenceKeys.PROPERTY_FILEOPERATION_WSENDPOINT + ": " + wsEndpoint );
			namespace = PreferenceManager.getString( PreferenceKeys.PROPERTY_FILEOPERATION_NAMESPACE );
			logger.info( "Proprietà " + PreferenceKeys.PROPERTY_FILEOPERATION_NAMESPACE + ": " + namespace );
			serviceName = PreferenceManager.getString( PreferenceKeys.PROPERTY_FILEOPERATION_SERVICE );
			logger.info( "Proprietà " + PreferenceKeys.PROPERTY_FILEOPERATION_SERVICE + ": " + serviceName );
		} catch (Exception e) {
		...
		if( wsEndpoint!=null && namespace!=null && serviceName!=null ){
			...
			logger.info("File da sbustare e convertire " + fileInput.getAbsolutePath() );
			try{
				logger.info("Invoco il WS " + wsEndpoint);
	...
	public static FileOperationResponse verificaMacro( File fileInput) throws Exception {
		...
		logger.info("Metodo di verifica Macro");
		...
		try {
			...
			logger.info( "Proprietà " + PreferenceKeys.PROPERTY_FILEOPERATION_WSENDPOINT + ": " + wsEndpointVerificaFirma );
			namespaceVerificaFirma = PreferenceManager.getString( PreferenceKeys.PROPERTY_FILEOPERATION_NAMESPACE );
			logger.info( "Proprietà " + PreferenceKeys.PROPERTY_FILEOPERATION_NAMESPACE + ": " + namespaceVerificaFirma );
			serviceVerificaFirma = PreferenceManager.getString( PreferenceKeys.PROPERTY_FILEOPERATION_SERVICE );
			logger.info( "Proprietà " + PreferenceKeys.PROPERTY_FILEOPERATION_SERVICE + ": " + serviceVerificaFirma );
		} catch (Exception e) {
	...
	public static FileOperationResponse verificaFirme( boolean checkCA, boolean checkCRL, Date dataRif, File fileInput) 
		...
		logger.info("Metodo di verifica Firme sul file " + fileInput );
