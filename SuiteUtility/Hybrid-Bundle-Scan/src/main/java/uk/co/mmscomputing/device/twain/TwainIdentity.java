...
*/
  ...
  void get(TwainIdentity ti){                              // [1] 7-178 valid state 3 - 7
    try{
      jtwain.setINT32(identity,0,ti.getId());
      manager.call(DG_CONTROL,DAT_IDENTITY,MSG_GET,identity);
    }catch(TwainIOException tioe){}                        // operation must succeed
  }

  void get(){                                              // [1] 7-178 valid state 3 - 7
    try{
      manager.call(DG_CONTROL,DAT_IDENTITY,MSG_GET,identity);
    }catch(TwainIOException tioe){}                        // operation must succeed
  }
  ...
  void close()throws TwainIOException{                     // [1] 7-176 state 4: 4 -> 3
    manager.call(DG_CONTROL,DAT_IDENTITY,MSG_CLOSEDS,identity);  // close session
  }

  private void getFirst()throws TwainIOException{          // [1] 7-180 state 3 - 7
    manager.call(DG_CONTROL,DAT_IDENTITY,MSG_GETFIRST,identity);  
  }

  private void getNext()throws TwainIOException{           // [1] 7-182 state 3 - 7
  ...
  static public TwainIdentity[] getIdentities(){
