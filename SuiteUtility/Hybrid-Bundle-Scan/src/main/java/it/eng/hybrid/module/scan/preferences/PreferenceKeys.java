...
public interface PreferenceKeys {
	...
	public final static String PROPERTY_TEMPFOLDER = "tempFolder";
	public final static String PROPERTY_COMPRESSION_QUALITY = "compressionQuality";
	public final static String PROPERTY_RESOLUTION = "resolution";
//	public final static String PROPERTY_PIXELTYPE = "pixelType";
	public final static String PROPERTY_CORRECTEXECUTION = "correctExecution";

	public final static String PROPERTY_SCANNER_RESOLUTION_DEFAULT = "scanner.resolution.default";
	public final static String PROPERTY_SCANNER_RESOLUTION_USER = "scanner.resolution.user";
	public final static String PROPERTY_SCANNER_TIPOSCANSIONE_USER = "scanner.tipoScansione.user";
	...
	public final static String PROPERTY_JSESSIONID = "JSESSIONID";
