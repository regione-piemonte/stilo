...
import it.eng.hybrid.module.jpedal.parser.FontFactory;
...
public class BaseDisplay implements DynamicVectorRenderer {
	...
	public final static Logger logger = Logger.getLogger(BaseDisplay.class);
	...
	if (fillType == GraphicsState.FILL || fillType == GraphicsState.FILLSTROKE) {
	    ...
	    try{
	    	...
	    	logger.info("Exception "+e+" filling shape");
	    }
