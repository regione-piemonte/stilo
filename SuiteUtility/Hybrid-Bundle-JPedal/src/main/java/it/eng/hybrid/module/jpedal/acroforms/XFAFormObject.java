...
public class XFAFormObject extends FormObject {
	...
	public final static Logger logger = Logger.getLogger(XFAFormObject.class);
	...
	public PdfObject duplicate(){
		...
		newObject.scriptType=scriptType;
		...
		//float
		newObject.verticalAlign=verticalAlign;
	...
	public void setVerticalAllign(String attValue) {
		if(attValue.equals("middle")){
			verticalAlign = CENTER_ALIGNMENT;
		}else if(attValue.equals("top")){
			verticalAlign = TOP_ALIGNMENT;
		}else if(attValue.equals("bottom")){
			verticalAlign = BOTTOM_ALIGNMENT;
		}else {
