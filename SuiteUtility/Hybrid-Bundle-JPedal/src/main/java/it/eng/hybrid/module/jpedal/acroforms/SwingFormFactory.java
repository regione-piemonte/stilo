...
public class SwingFormFactory extends GenericFormFactory implements FormFactory{
	...
	public final static Logger logger = Logger.getLogger(SwingFormFactory.class);
            ...
            case PdfDictionary.Text:/* a sticky note which displays a popup when open. */
                ...
                if(name!=null){
                    ...
                    if(name.equals("Comment")){
                        ...
                        try {
                            BufferedImage commentIcon = ImageIO.read(getClass().getResource("/it/eng/hybrid/module/jpedal/acroforms/comment.png"));
