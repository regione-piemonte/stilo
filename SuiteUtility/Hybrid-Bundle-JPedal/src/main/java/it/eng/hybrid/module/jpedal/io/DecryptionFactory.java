...
import it.eng.hybrid.module.jpedal.util.ObjectCloneFactory;
...
public class DecryptionFactory {
	...
	public final static Logger logger = Logger.getLogger(DecryptionFactory.class);
    ...
    private boolean testPassword() throws PdfSecurityException {
        ...
        if (rev==2) {
            ...
            try {
                ...
                logger.info("Exception " + e + " with digest");
            }
        ...
        if(!isOwnerPassword){
            ...
            if(isUserPassword){
                ...
                if(encryptionPassword!=null && encryptionPassword.length>0 )
                    logger.info("Correct user password supplied ");
            ...
            logger.info("Correct owner password supplied");
    ...
    public void readEncryptionObject(PdfObject encyptionObj) throws PdfSecurityException {
       ...
       logger.info("File has encryption settings");
        ...
        if(firstValue==PdfDictionary.Standard){
            try{
                ...
                logger.info("File requires password");
            }
        ...
        if(getBooleanValue(PDFflags.IS_FILE_ENCRYPTED) || isEncryption){
            ...
            if(cacheName!=null){ //this version is used if we cache large object to disk
                ...
                try {
                    ...
                    logger.info("Exception "+e1+" in decrypt");
                }
            }
    ...
    public byte[] decryptString(byte[] newString, String objectRef) throws PdfSecurityException {
        ...
        try{
            ...
            logger.info("Unable to decrypt string in Object "+objectRef+ ' ' +new String(newString));
        }
    ...
    public void flush() {
        ...
        if(cachedObjects!=null){
            for (Object o : cachedObjects.keySet()) {
                ...
                file.delete();
                if (file.exists())
                    logger.info("Unable to delete temp file " + fileName);
            }
        }
