...
public class PropertiesFile {
	...
	public final static Logger logger = Logger.getLogger(PropertiesFile.class);
...
//			"ENDCHILDREN",
			...
			"pageInsets", "25",
			"pageFlowPages", "8",
			"pageFlowExtraCache", "10",
			"pageFlowReflection", "true",
			"pageFlowSideSize", "0.75",
			"pageFlowReflectionHeight", "0.25",
            ...
            "windowTitle","",
            "confirmClose","false",
            "iconLocation","/it/eng/hybrid/module/jpedal/resources/",
			"enhancedGUI","true",
            "showpageflow3dsmessage","true",
            "defaultPrinter","",
            "debugPrinter","false",
            "defaultDPI","600",
            "defaultPagesize","",
...
//			configFile = new File(PropertiesFile.class.getResource(".properties.xml")).getAbsolutePath();
...
//		}
		...
		configInputStream = PropertiesFile.class.getResourceAsStream(".properties.xml");
...
//					writeDoc();
			...
			logger.info("Exception " + e + " generating properties file");
		}
		//<start-wrap>
        /**
        //<end-wrap>
	...
	public String[] getRecentDocuments(){
		...
		try{
			...
			logger.info("Exception " + e + " getting recent documents");
        	return null;
		}
	...
	public void addRecentDocument(String file){
		try{
			...
			logger.info("Exception " + e + " adding recent document to properties file");
		}
	}
	...
	public void setValue(String elementName, String newValue) {
		...
		try {
			...
			logger.info("Exception " + e + " setting value in properties file");
		}
	}
    ...
    public void writeDoc() throws Exception{
    	...
    	if(!isReadOnly  && !getValue("readOnly").toLowerCase().equals("true")){
    		InputStream stylesheet = this.getClass().getResourceAsStream("/it/eng/hybrid/module/jpedal/resources/xmlstyle.xslt");
...
//				}
				...
				if(properties[position].equals("currentversion")){
					...
					if(element==null){
						...
						if(properties[position+1].equals("4.81b30")){
