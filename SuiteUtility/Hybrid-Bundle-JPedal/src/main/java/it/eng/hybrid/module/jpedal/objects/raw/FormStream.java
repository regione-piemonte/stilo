...
public class FormStream {
	...
	public final static Logger logger = Logger.getLogger(FormStream.class);
...
//			System.out.println(tokenValues[i]+" "+i);
            ...
            if(tokenValues[i].equals("g")){ //set color (takes 1 values
                ...
                try{
                    ...
                    logger.info("Error in generating g value "+tokenValues[i]);
                }
...
//						textSize = 0;//TODO check for 0 sizes CHANGE size to best fit on 0
                    ...
                    logger.info("Error in generating Tf size "+tokenValues[i]);
                }
                ...
                try{
                    ...
                    logger.info("Error in generating Tf font "+tokenValues[i]);
                }
