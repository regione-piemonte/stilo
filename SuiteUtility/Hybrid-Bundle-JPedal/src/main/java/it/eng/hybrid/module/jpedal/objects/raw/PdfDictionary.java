...
public class PdfDictionary {
	...
	public final static Logger logger = Logger.getLogger(PdfDictionary.class);
    ...
    public static int getKeyType(int id, int type) {
        ...
        switch(id){
            ...
            case B:
                if(type==PdfDictionary.Sound || type==PdfDictionary.Linearized)
                    return VALUE_IS_INT;
                //else
                  //  return PDFkey;
                break;
