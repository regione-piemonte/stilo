...
public class GenericPanel extends JPanel {
	...
	private static final long serialVersionUID = 6841384266069120792L;
	...
	protected void aggiungiPannello(JPanel panel, JPanel panelContainer, GridBagConstraints c, int x, int y, int width, int anchor){
		c.gridx = x;
		c.gridy = y;
		c.gridwidth = width;
		c.anchor = anchor;//GridBagConstraints.FIRST_LINE_START;
	...
	protected JPanel creaPannelloTab(PreferenceManager preferenceManager, JPanel... pannelli){
