...
import it.eng.hybrid.module.jpedal.io.ArrayDecoder;
...
public class DefaultActionHandler implements ActionHandler {
	...
	public final static Logger logger = Logger.getLogger(DefaultActionHandler.class);
...
//    }
    ...
    public void changeTo(String file, int page, Object location, Integer type,boolean storeView) {
        ...
        if(type!=null){
            ...
            Object swingGUI = this.decode_pdf.getExternalHandler(Options.SwingContainer);
            ...
            if(swingGUI!=null){
                if(type <0){
                    ...
                    ((SwingGUI)swingGUI).setSelectedComboIndex(Commands.SCALING, type +3);
                }else {
                    //set scaling box to actual scaling value
                    ((SwingGUI)swingGUI).setSelectedComboItem(Commands.SCALING,type.toString());
                }
            }
        }
    ...
    public void dispose(){
    	if( swingMouseHandler!=null )
    		swingMouseHandler.dispose();
    	swingMouseHandler = null;
