 ...
 *
  ...
  * ---------------
 */
package it.eng.hybrid.module.jpedal.render;

import it.eng.hybrid.module.jpedal.color.ColorSpaces;
import it.eng.hybrid.module.jpedal.color.PdfColor;
...
import it.eng.hybrid.module.jpedal.external.JPedalCustomDrawObject;
...
import it.eng.hybrid.module.jpedal.fonts.glyph.PdfGlyphs;
...
import it.eng.hybrid.module.jpedal.util.repositories.Vector_Double;
...
import it.eng.hybrid.module.jpedal.util.repositories.Vector_Shape;
...
public class SwingDisplay extends BaseDisplay implements DynamicVectorRenderer{
	...
	public final static Logger logger = Logger.getLogger(SwingDisplay.class);
        ...
        if(image!=null){
            ...
            if(JAIHelper.isJAIused() && type.toLowerCase().startsWith("tif")){
                javax.media.jai.JAI.create("filestore", image, des, type);
                    ...
                    logger.info("Please setup JAI library for Tiffs");
                }else{
                    try {
