...
public class DecodeParmsObject extends PdfObject {
	...
	public final static Logger logger = Logger.getLogger(DecodeParmsObject.class);
	
	boolean EncodedByteAlign=false,EndOfBlock=true, EndOfLine=false, BlackIs1=false,Uncompressed=false;

    PdfObject JBIG2Globals;

    int Blend=-1, Colors=-1, ColorTransform=1, Columns=-1,DamagedRowsBeforeError=0, EarlyChange=1, K=0, Predictor=1, QFactor=-1,Rows=-1;
