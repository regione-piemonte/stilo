...
public class FontMappings {
	...
	public final static Logger logger = Logger.getLogger(FontMappings.class);
...
/**
    ...
    public static void initFonts(){
        ...
        try {
        	...
        	logger.info("Unable to read org.jpedal.fontmaps " + e.getMessage());
        }
        ...
        try {
            ...
            if (failed != null /*&& LogWriter.isOutput()*/)
                logger.info("Could not find " + failed);
        } catch (Exception e) {
        	logger.info("Unable to read FontDirs " + e.getMessage());
        }
    }
    ...
    public static String addFonts(String fontDirs, String failed) {
        ...
        while (fontPaths.hasMoreTokens()) {
            ...
            //logger.info("Looking in " + fontPath + " for TT fonts");
    ...
    public static void setFontReplacements() {
        ...
        if(!fontsSet){
            ...
            fontsSet=true;
            setFontDirs(new String[]{"C:/windows/fonts/","C:/winNT/fonts/",
                    "/Library/Fonts/",
    ...
    public static String setFontDirs(String[] fontDirs) {
        ...
        try {
            if (fontDirs == null) { // idiot safety test
                logger.info("Null font parameter passed");
            ...
            logger.info("Unable to run setFontDirs " + e.getMessage());
        }
    ...
    public static boolean addSubstituteFonts(String fontPath, boolean enforceMapping) {
        ...
        try {
            ...
            logger.info("Looking for root " + fontPath);

            // if it does, look for sub-directories
            if (in != null) {

            	logger.info("Adding fonts fonts found in  tt,t1c,t1 sub-directories of "+ fontPath);
                ...
                for (int i = 0; i < dirs.length; i++) {
                    ...
                    if (in != null) {
                        ...
                        try {
                        	...
                        	logger.info("Exception " + e+ " reading substitute fonts");
                ...
                logger.info("No fonts found at " + fontPath);

        } catch (Exception e) {
        	logger.info("Exception adding substitute fonts "+ e.getMessage());
