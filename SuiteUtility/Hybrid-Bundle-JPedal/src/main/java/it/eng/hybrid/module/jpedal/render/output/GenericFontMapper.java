...
public class GenericFontMapper implements FontMapper { 
	...
	public final static Logger logger = Logger.getLogger(GenericFontMapper.class);
    ...
    private static String defaultFonts = "/it/eng/hybrid/module/jpedal/render/output/defaultFontMap.xml";
