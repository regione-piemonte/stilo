...
import it.eng.hybrid.module.jpedal.constants.CIDEncodings;
...
import it.eng.hybrid.module.jpedal.objects.raw.FontObject;
...
public class PdfFont implements Serializable {
	...
	public final static Logger logger = Logger.getLogger(PdfFont.class);
...
//                    logger.info("1.Problem reading encoding for CID font "+fontID+" encoding="+encodingName+" Check CID.jar installed");
//            }
        ...
        if(CIDstream!=null){
            try{
                ...
                logger.info("2.Problem reading encoding for CID font "+fontID+ ' ' +encodingName+" Check CID.jar installed");
            }
        }
    ...
    private void readCIDCMap(BufferedReader CIDstream) {
        ...
        while (true) {
            ...
            try{
                ...
                logger.info("[PDF] Error reading line from font");
            }
...
//		}
        ...
        if(isJavaFontInstalled)
            ...
            logger.info("No match with "+glyphs.getBaseFontName()+ ' ' + ' ' +testFont+ ' ' +weight+ ' ' +style);
...
//
            ...
            if(substituteFontFile!=null )
                logger.info("Using font "+substituteFontFile+" for "+ordering);
