...
import it.eng.hybrid.module.jpedal.io.PathSerializer;
...
import it.eng.hybrid.module.jpedal.util.repositories.Vector_Path;
import it.eng.hybrid.module.jpedal.util.repositories.Vector_Short;
...
public class TTGlyph implements PdfGlyph, Serializable {
	...
	public final static Logger logger = Logger.getLogger(TTGlyph.class);
            ...
            if(lc==fc && onCurve[p]){
                ...
                if(debug){
                    try{
                        ...
                        ShowGUIMessage.showGUIMessage(key,img,key);
