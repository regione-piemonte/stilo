...
import it.eng.hybrid.module.jpedal.constants.PageInfo;
...
import it.eng.hybrid.module.jpedal.objects.PdfShape;
...
public class PdfStreamDecoder extends BaseDecoder{
	...
	public final static Logger logger = Logger.getLogger(PdfStreamDecoder.class);
        ...
        while (true) {
            ...
            if(dataPointer<0){
                ...
                try{
                    ...
                    logger.info("[PDF] "+ e+" Processing token >" + Cmd.getCommandAsString(commandID)+ "<>" + fileName+" <"+pageNum);
                    ...
                    logger.info("[MEMORY] Memory error - trying to recover");
                }
...
//        else
    ...
    private GraphicsState restoreGraphicsState(GraphicsState gs) {
        ...
        if(!isStackInitialised){
            ...
            logger.info("No GraphicsState saved to retrieve");
