...
import it.eng.hybrid.module.jpedal.sun.LZWDecoder;
import it.eng.hybrid.module.jpedal.sun.LZWDecoder2;
import it.eng.hybrid.module.jpedal.sun.TIFFLZWDecoder;
...
public class LZW extends BaseFilter implements PdfFilter {
	...
	public final static Logger logger = Logger.getLogger(LZW.class);
