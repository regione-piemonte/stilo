...
public class ICCColorSpace
	...
	public final static Logger logger = Logger.getLogger(ICCColorSpace.class);
...
//		cache.clear();
    ...
    public BufferedImage  JPEG2000ToRGBImage(byte[] data,int w,int h,float[] decodeArray,
        ...
        try {
            ...
            logger.info("Problem reading JPEG 2000 with error " + ee2);
    ...
    private BufferedImage algorithmicICCToRGB(
        ...
        try{
        	...
        	logger.info("Problem with color conversion");
        }finally{
