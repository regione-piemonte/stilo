...
public class PdfFontFactory {
	...
	public final static Logger logger = Logger.getLogger(PdfFontFactory.class);
    ...
    public PdfFont createFont(PdfObject pdfObject, String font_id, ObjectStore objectStoreStreamRef, boolean renderPage, ErrorTracker errorTracker, boolean isPrinting) throws PdfException {
        ...
        while(isFontBroken){ //will try to sub font if error in embedded
            ...
            if(fontType==PdfDictionary.Unknown){
            	...
            	logger.info("Font type not supported");
            ...
            try{
            	...
            	logger.info("[PDF] Problem "+e+" reading Font  type "+ StandardFonts.getFontypeAsString(fontType));
    ...
    private int getFontMapping(PdfObject pdfObject, String font_id, int fontType, PdfObject descendantFont) throws PdfException {
        ...
        if(newSubtype!=null && descendantFont==null){
            ...
            logger.info("baseFont="+baseFont+" fonts added= "+FontMappings.fontSubstitutionTable);
