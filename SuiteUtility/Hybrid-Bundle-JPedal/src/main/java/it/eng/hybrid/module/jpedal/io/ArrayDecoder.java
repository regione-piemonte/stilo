...
import it.eng.hybrid.module.jpedal.objects.raw.OCObject;
...
public class ArrayDecoder extends ObjectDecoder{
	...
	public final static Logger logger = Logger.getLogger(ArrayDecoder.class);
        ...
        if((raw[i]==47 || raw[i]=='(' || raw[i]=='<' ||
            ...
            if(isIndirect){
                ...
                if(arrayData==null){
                    ...
                    logger.info("[Linearized] " + pdfObject.getObjectRefAsString() + " not yet available (14)");
