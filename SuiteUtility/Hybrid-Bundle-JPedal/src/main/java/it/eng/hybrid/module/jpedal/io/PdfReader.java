...
import it.eng.hybrid.module.jpedal.objects.PageLookup;
import it.eng.hybrid.module.jpedal.objects.raw.FDFObject;
...
public class PdfReader implements PdfObjectReader, Serializable {
	...
	public final static Logger logger = Logger.getLogger(PdfReader.class);
...
///////////////////////////////////////////////////////////////////////////
    ...
    final public void openPdfFile( InputStream in) throws PdfException
    {
        ...
        try
        {
        	...
        	logger.info( "Exception " + e + " accessing file" );
