...
public interface DynamicVectorRenderer  {
	...
	public abstract void drawEmbeddedText(float[][] Trm, int fontSize,
                                          ...
                                          GraphicsState gs, AffineTransform at, String glyf, PdfFont currentFontData, float glyfWidth);
	...
	public abstract void setCustomImageHandler(ImageHandler customImageHandler);

	public abstract void setCustomColorHandler(ColorHandler colorController);
