...
import it.eng.hybrid.module.jpedal.parser.DefaultSearchListener;
import it.eng.hybrid.module.jpedal.parser.PdfGroupingAlgorithms;
import it.eng.hybrid.module.jpedal.parser.SearchListener;
...
public class SwingSearchWindow extends JFrame implements GUISearchWindow {
	...
	public void init(final PdfDecoder dec, final Values values){
		...
		if(isSetup){ //global variable so do NOT reinitialise
			...
			label = new JLabel("<html><center> " + Messages.getMessage("PdfViewerSearch.ShowOptions"));
			...
			label.addMouseListener(new MouseListener() {
				...
				String text = Messages.getMessage("PdfViewerSearch.ShowOptions");//"Show Advanced";
...
//					System.out.println("seareching pdf = "+decode_pdf.getClass().getName() + "@" + Integer.toHexString(decode_pdf.hashCode()));
					...
					SwingUtilities.invokeLater(new Runnable(){
						public void run() {
                            ...
                            currentGUI.showMessageDialog(Messages.getMessage("PdfViewerSearch.searchStopped"));
							if(!backGroundSearch){
                            currentGUI.nextSearch.setEnabled(true);
							currentGUI.previousSearch.setEnabled(true);
							}
...
//			isSetup = false;
    ...
    public void dispose(){
    	...
    	advancedPanel= null;
    	searchType= null;
    	wholeWordsOnlyBox= null; caseSensitiveBox= null; multiLineBox= null; 
    	highlightAll= null; searchAll= null; useRegEx= null;
