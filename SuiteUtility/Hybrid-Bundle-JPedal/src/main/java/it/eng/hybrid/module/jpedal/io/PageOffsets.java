...
public class PageOffsets {
    ...
    /**width of all pages*/
    public int totalSingleWidth=0,totalDoubleWidth=0,gaps=0,doubleGaps=0;

    /**height of all pages*/
    public int totalSingleHeight=0,totalDoubleHeight=0;
    ...
    public int doublePageWidth=0,doublePageHeight=0,biggestWidth=0,biggestHeight=0,widestPageNR,widestPageR;
