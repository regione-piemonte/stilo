...
public class ImageTransformer {
	...
	public final static Logger logger = Logger.getLogger(ImageTransformer.class);
...
*/
	...
	final public void clipImage(Area current_shape) {
		...
		try {
			...
			logger.info("Exception " + e + " plotting clipping image");
		}
		...
		try {
			...
			logger.info("Exception " + e + " extracting clipped image with values x="+x+" y="+y+" w="+w+" h="+h+" from image ");
		}
