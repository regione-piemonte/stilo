...
public class ColorSpaceConvertor {
	...
	public final static Logger logger = Logger.getLogger(ColorSpaceConvertor.class);
    ...
    public static BufferedImage convertFromICCCMYK(int width,int height,byte[] data) {
        ...
        try {
            ...
            if(1==2){ //left for when they add hardware acceleration
	            ...
	            /**create RGB colorspace and model*/
	            ComponentColorModel rgbModel = new ComponentColorModel(rgbCS, new int[] { 8, 8, 8 }, false, false, ColorModel.OPAQUE, DataBuffer.TYPE_BYTE);
            ...
            logger.info("Exception  " + ee + " converting from ICC colorspace");
            ee.printStackTrace();
        }
    ...
    public static BufferedImage convertToRGB(BufferedImage image) {
        ...
        if ((image.getType() != BufferedImage.TYPE_INT_RGB)) {
            ...
            try{
                ...
                logger.info("Exception " + e.toString() + " converting to RGB");
            } catch (Error ee) {

                ee.printStackTrace();
                logger.info("Error " + ee.toString() + " converting to RGB");
    ...
    public static BufferedImage convertToARGB(BufferedImage image) {
        ...
        if (image.getType() != BufferedImage.TYPE_INT_ARGB) {
            try {
                ...
                logger.info("Exception " + e + " creating argb image");
            }
        }
    ...
    public static BufferedImage algorithmicConvertCMYKImageToRGB(byte[] buffer,int w,int h) {
        ...
        try {
            ...
            logger.info("Exception " + e + " with 24 bit RGB image");
        }
...
//					@itemtoFix
    ...
    public static BufferedImage convertColorspace(BufferedImage image, int newType) {
        ...
        try {
            ...
            logger.info("Exception " + e + " converting image");
