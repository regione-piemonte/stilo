...
public class TiffDecoder {
	...
	public final static Logger logger = Logger.getLogger(TiffDecoder.class);
    ...
    public static void saveAsTIFF(int w, int h,PdfObject DecodeParms,byte[] data, String fileName){
        ...
        for (String headerValue : headerValues) bos.write(Integer.parseInt(headerValue, 16));
        ...
        try{
            ...
            logger.info("[PDF] Tiff exception  "+e);
        }
        ...
        try {
            ...
            logger.info("[PDF] Tiff error "+err);

        } catch (Exception e1) {
            logger.info("[PDF] Tiff exception  "+e1);
        }
    }
