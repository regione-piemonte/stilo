...
import it.eng.hybrid.module.jpedal.viewer.ThumbnailDecoder;
...
public class SwingThumbnailPanel extends JScrollPane implements GUIThumbnailPanel {
	...
	public final static Logger logger = Logger.getLogger(SwingThumbnailPanel.class);
    ...
    public void generateOtherThumbnails(String[] imageFiles, Vector_Object thumbnailsStored) {
        ...
        for (int i = 0; i < pages; i++) {
            ...
            try {
                ...
                logger.info("Exception " + e + " loading " + imageFiles[i]);
            }
        }
