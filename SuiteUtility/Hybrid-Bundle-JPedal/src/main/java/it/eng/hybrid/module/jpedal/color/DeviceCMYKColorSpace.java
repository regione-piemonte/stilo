...
public class DeviceCMYKColorSpace extends  GenericColorSpace{
	...
	public final static Logger logger = Logger.getLogger(DeviceCMYKColorSpace.class);
	...
	private void initColorspace() {
        ...
        try {
			...
			if(profile==null)
				stream=this.getClass().getResourceAsStream("/it/eng/hybrid/module/jpedal/fonts/res/cmyk.icm");
			else{
				try{
