...
import it.eng.hybrid.module.jpedal.io.filter.ASCII85;
import it.eng.hybrid.module.jpedal.io.filter.ASCIIHex;
import it.eng.hybrid.module.jpedal.io.filter.CCITT;
import it.eng.hybrid.module.jpedal.io.filter.Flate;
import it.eng.hybrid.module.jpedal.io.filter.LZW;
import it.eng.hybrid.module.jpedal.io.filter.PdfFilter;
import it.eng.hybrid.module.jpedal.io.filter.RunLength;
import it.eng.hybrid.module.jpedal.io.jbig2.JBIG2;
...
public class PdfFilteredReader {
	...
	public final static Logger logger = Logger.getLogger(PdfFilteredReader.class);
    ...
    public byte[] decodeFilters(PdfObject[] DecodeParmsArray, byte[] data, PdfArrayIterator filters, 
    		...
    		while (filters.hasMoreTokens()) {
                ...
                if(filter!=null){
                    try{
                    	...
                    	logger.info("Exception "+ee+" in "+getFilterName(filterType)+" decompression");
