	 ...
	 */
	 ...
	 public void setCropBox(float[] cropBox) {
         ...
         if(testAlteredCrop && (mediaBox!=null && !(mediaBox.length<4))){
        	 if(cropBox[0]<mediaBox[0])
        		 cropBox[0] = mediaBox[0];
        	 
        	 if(cropBox[1]<mediaBox[1])
        		 cropBox[1] = mediaBox[1];
        	 
        	 if(cropBox[2]>mediaBox[2])
        		 cropBox[2] = mediaBox[2];
        	 
        	 if(cropBox[3]>mediaBox[3])
        		 cropBox[3] = mediaBox[3];
         }
     }
