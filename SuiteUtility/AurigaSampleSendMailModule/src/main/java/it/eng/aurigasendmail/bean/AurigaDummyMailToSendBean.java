...
@XmlRootElement
public class AurigaDummyMailToSendBean implements Serializable {
	private String body;
	...
	private List<AurigaAttachmentMailToSendBean> attachmentMailToSendBeans;
	 ...
	 */
	public List<AurigaAttachmentMailToSendBean> getAttachmentMailToSendBeans() {
	...
	public void setAttachmentMailToSendBeans(
			List<AurigaAttachmentMailToSendBean> attachmentMailToSendBeans) {
